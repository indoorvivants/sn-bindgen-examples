...
object enumerations:
  ...
  object CURLMoption extends _BindgenEnumCUnsignedInt[CURLMoption]:
    ...
    val CURLMOPT_LASTENTRY = define(18)
...
object aliases:
  ...
  opaque type _curl_chunk_bgn_callback1 = CFuncPtr3[Ptr[curl_fileinfo], Ptr[Byte], CInt, CLongInt]
  object _curl_chunk_bgn_callback1:
    given _tag: Tag[_curl_chunk_bgn_callback1] = Tag.materializeCFuncPtr3[Ptr[curl_fileinfo], Ptr[Byte], CInt, CLongInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_chunk_bgn_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[curl_fileinfo], Ptr[Byte], CInt, CLongInt]): _curl_chunk_bgn_callback1 = o
    extension (v: _curl_chunk_bgn_callback1)
      inline def value: CFuncPtr3[Ptr[curl_fileinfo], Ptr[Byte], CInt, CLongInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_chunk_bgn_callback2 = CFuncPtr3[Ptr[Byte], Ptr[Byte], CInt, CLongInt]
  object _curl_chunk_bgn_callback2:
    given _tag: Tag[_curl_chunk_bgn_callback2] = Tag.materializeCFuncPtr3[Ptr[Byte], Ptr[Byte], CInt, CLongInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_chunk_bgn_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], Ptr[Byte], CInt, CLongInt]): _curl_chunk_bgn_callback2 = o
    extension (v: _curl_chunk_bgn_callback2)
      inline def value: CFuncPtr3[Ptr[Byte], Ptr[Byte], CInt, CLongInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_conv_callback1 = CFuncPtr2[CString, size_t, CURLcode]
  object _curl_conv_callback1:
    given _tag: Tag[_curl_conv_callback1] = Tag.materializeCFuncPtr2[CString, size_t, CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_conv_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr2[CString, size_t, CURLcode]): _curl_conv_callback1 = o
    extension (v: _curl_conv_callback1)
      inline def value: CFuncPtr2[CString, size_t, CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_conv_callback2 = CFuncPtr2[CString, size_t, CURLcode]
  object _curl_conv_callback2:
    given _tag: Tag[_curl_conv_callback2] = Tag.materializeCFuncPtr2[CString, size_t, CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_conv_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr2[CString, size_t, CURLcode]): _curl_conv_callback2 = o
    extension (v: _curl_conv_callback2)
      inline def value: CFuncPtr2[CString, size_t, CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_conv_callback3 = CFuncPtr2[Ptr[Byte], size_t, CURLcode]
  object _curl_conv_callback3:
    given _tag: Tag[_curl_conv_callback3] = Tag.materializeCFuncPtr2[Ptr[Byte], size_t, CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_conv_callback3 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr2[Ptr[Byte], size_t, CURLcode]): _curl_conv_callback3 = o
    extension (v: _curl_conv_callback3)
      inline def value: CFuncPtr2[Ptr[Byte], size_t, CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_conv_callback4 = CFuncPtr2[Ptr[Byte], size_t, CURLcode]
  object _curl_conv_callback4:
    given _tag: Tag[_curl_conv_callback4] = Tag.materializeCFuncPtr2[Ptr[Byte], size_t, CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_conv_callback4 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr2[Ptr[Byte], size_t, CURLcode]): _curl_conv_callback4 = o
    extension (v: _curl_conv_callback4)
      inline def value: CFuncPtr2[Ptr[Byte], size_t, CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_debug_callback1 = CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
  object _curl_debug_callback1:
    given _tag: Tag[_curl_debug_callback1] = Tag.materializeCFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_debug_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]): _curl_debug_callback1 = o
    extension (v: _curl_debug_callback1)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_debug_callback2 = CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
  object _curl_debug_callback2:
    given _tag: Tag[_curl_debug_callback2] = Tag.materializeCFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_debug_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]): _curl_debug_callback2 = o
    extension (v: _curl_debug_callback2)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_debug_callback3 = CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
  object _curl_debug_callback3:
    given _tag: Tag[_curl_debug_callback3] = Tag.materializeCFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_debug_callback3 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]): _curl_debug_callback3 = o
    extension (v: _curl_debug_callback3)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_debug_callback4 = CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
  object _curl_debug_callback4:
    given _tag: Tag[_curl_debug_callback4] = Tag.materializeCFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_debug_callback4 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]): _curl_debug_callback4 = o
    extension (v: _curl_debug_callback4)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_debug_callback5 = CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
  object _curl_debug_callback5:
    given _tag: Tag[_curl_debug_callback5] = Tag.materializeCFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_debug_callback5 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]): _curl_debug_callback5 = o
    extension (v: _curl_debug_callback5)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_debug_callback6 = CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
  object _curl_debug_callback6:
    given _tag: Tag[_curl_debug_callback6] = Tag.materializeCFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_debug_callback6 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]): _curl_debug_callback6 = o
    extension (v: _curl_debug_callback6)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_debug_callback7 = CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
  object _curl_debug_callback7:
    given _tag: Tag[_curl_debug_callback7] = Tag.materializeCFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_debug_callback7 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]): _curl_debug_callback7 = o
    extension (v: _curl_debug_callback7)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_debug_callback8 = CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
  object _curl_debug_callback8:
    given _tag: Tag[_curl_debug_callback8] = Tag.materializeCFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_debug_callback8 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]): _curl_debug_callback8 = o
    extension (v: _curl_debug_callback8)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_interleave_callback1 = CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
  object _curl_interleave_callback1:
    given _tag: Tag[_curl_interleave_callback1] = Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_interleave_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]): _curl_interleave_callback1 = o
    extension (v: _curl_interleave_callback1)
      inline def value: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_interleave_callback2 = CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
  object _curl_interleave_callback2:
    given _tag: Tag[_curl_interleave_callback2] = Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_interleave_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]): _curl_interleave_callback2 = o
    extension (v: _curl_interleave_callback2)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_ioctl_callback1 = CFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr]
  object _curl_ioctl_callback1:
    given _tag: Tag[_curl_ioctl_callback1] = Tag.materializeCFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_ioctl_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr]): _curl_ioctl_callback1 = o
    extension (v: _curl_ioctl_callback1)
      inline def value: CFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_ioctl_callback2 = CFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr]
  object _curl_ioctl_callback2:
    given _tag: Tag[_curl_ioctl_callback2] = Tag.materializeCFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_ioctl_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr]): _curl_ioctl_callback2 = o
    extension (v: _curl_ioctl_callback2)
      inline def value: CFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_ioctl_callback3 = CFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr]
  object _curl_ioctl_callback3:
    given _tag: Tag[_curl_ioctl_callback3] = Tag.materializeCFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_ioctl_callback3 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr]): _curl_ioctl_callback3 = o
    extension (v: _curl_ioctl_callback3)
      inline def value: CFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_ioctl_callback4 = CFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr]
  object _curl_ioctl_callback4:
    given _tag: Tag[_curl_ioctl_callback4] = Tag.materializeCFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_ioctl_callback4 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr]): _curl_ioctl_callback4 = o
    extension (v: _curl_ioctl_callback4)
      inline def value: CFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_opensocket_callback1 = CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
  object _curl_opensocket_callback1:
    given _tag: Tag[_curl_opensocket_callback1] = Tag.materializeCFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_opensocket_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]): _curl_opensocket_callback1 = o
    extension (v: _curl_opensocket_callback1)
      inline def value: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_opensocket_callback2 = CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
  object _curl_opensocket_callback2:
    given _tag: Tag[_curl_opensocket_callback2] = Tag.materializeCFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_opensocket_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]): _curl_opensocket_callback2 = o
    extension (v: _curl_opensocket_callback2)
      inline def value: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_opensocket_callback3 = CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
  object _curl_opensocket_callback3:
    given _tag: Tag[_curl_opensocket_callback3] = Tag.materializeCFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_opensocket_callback3 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]): _curl_opensocket_callback3 = o
    extension (v: _curl_opensocket_callback3)
      inline def value: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_opensocket_callback4 = CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
  object _curl_opensocket_callback4:
    given _tag: Tag[_curl_opensocket_callback4] = Tag.materializeCFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_opensocket_callback4 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]): _curl_opensocket_callback4 = o
    extension (v: _curl_opensocket_callback4)
      inline def value: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_progress_callback1 = CFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt]
  object _curl_progress_callback1:
    given _tag: Tag[_curl_progress_callback1] = Tag.materializeCFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_progress_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt]): _curl_progress_callback1 = o
    extension (v: _curl_progress_callback1)
      inline def value: CFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_progress_callback2 = CFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt]
  object _curl_progress_callback2:
    given _tag: Tag[_curl_progress_callback2] = Tag.materializeCFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_progress_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt]): _curl_progress_callback2 = o
    extension (v: _curl_progress_callback2)
      inline def value: CFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_read_callback1 = CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
  object _curl_read_callback1:
    given _tag: Tag[_curl_read_callback1] = Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_read_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]): _curl_read_callback1 = o
    extension (v: _curl_read_callback1)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_read_callback2 = CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
  object _curl_read_callback2:
    given _tag: Tag[_curl_read_callback2] = Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_read_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]): _curl_read_callback2 = o
    extension (v: _curl_read_callback2)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_read_callback3 = CFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t]
  object _curl_read_callback3:
    given _tag: Tag[_curl_read_callback3] = Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_read_callback3 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t]): _curl_read_callback3 = o
    extension (v: _curl_read_callback3)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_read_callback4 = CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
  object _curl_read_callback4:
    given _tag: Tag[_curl_read_callback4] = Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_read_callback4 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]): _curl_read_callback4 = o
    extension (v: _curl_read_callback4)
      inline def value: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_read_callback5 = CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
  object _curl_read_callback5:
    given _tag: Tag[_curl_read_callback5] = Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_read_callback5 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]): _curl_read_callback5 = o
    extension (v: _curl_read_callback5)
      inline def value: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_read_callback6 = CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t]
  object _curl_read_callback6:
    given _tag: Tag[_curl_read_callback6] = Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_read_callback6 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t]): _curl_read_callback6 = o
    extension (v: _curl_read_callback6)
      inline def value: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_seek_callback1 = CFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode]
  object _curl_seek_callback1:
    given _tag: Tag[_curl_seek_callback1] = Tag.materializeCFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_seek_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode]): _curl_seek_callback1 = o
    extension (v: _curl_seek_callback1)
      inline def value: CFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_seek_callback2 = CFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode]
  object _curl_seek_callback2:
    given _tag: Tag[_curl_seek_callback2] = Tag.materializeCFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_seek_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode]): _curl_seek_callback2 = o
    extension (v: _curl_seek_callback2)
      inline def value: CFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_sockopt_callback1 = CFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt]
  object _curl_sockopt_callback1:
    given _tag: Tag[_curl_sockopt_callback1] = Tag.materializeCFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_sockopt_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt]): _curl_sockopt_callback1 = o
    extension (v: _curl_sockopt_callback1)
      inline def value: CFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_sockopt_callback2 = CFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt]
  object _curl_sockopt_callback2:
    given _tag: Tag[_curl_sockopt_callback2] = Tag.materializeCFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_sockopt_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt]): _curl_sockopt_callback2 = o
    extension (v: _curl_sockopt_callback2)
      inline def value: CFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_ssl_ctx_callback1 = CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
  object _curl_ssl_ctx_callback1:
    given _tag: Tag[_curl_ssl_ctx_callback1] = Tag.materializeCFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_ssl_ctx_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]): _curl_ssl_ctx_callback1 = o
    extension (v: _curl_ssl_ctx_callback1)
      inline def value: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_ssl_ctx_callback2 = CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
  object _curl_ssl_ctx_callback2:
    given _tag: Tag[_curl_ssl_ctx_callback2] = Tag.materializeCFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_ssl_ctx_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]): _curl_ssl_ctx_callback2 = o
    extension (v: _curl_ssl_ctx_callback2)
      inline def value: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_ssl_ctx_callback3 = CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
  object _curl_ssl_ctx_callback3:
    given _tag: Tag[_curl_ssl_ctx_callback3] = Tag.materializeCFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_ssl_ctx_callback3 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]): _curl_ssl_ctx_callback3 = o
    extension (v: _curl_ssl_ctx_callback3)
      inline def value: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_ssl_ctx_callback4 = CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
  object _curl_ssl_ctx_callback4:
    given _tag: Tag[_curl_ssl_ctx_callback4] = Tag.materializeCFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_ssl_ctx_callback4 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]): _curl_ssl_ctx_callback4 = o
    extension (v: _curl_ssl_ctx_callback4)
      inline def value: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  type _curl_ssl_ctx_callback5 = _curl_ssl_ctx_callback1
  object _curl_ssl_ctx_callback5:
    given _tag: Tag[_curl_ssl_ctx_callback5] = _curl_ssl_ctx_callback1._tag
    inline def apply(inline o: _curl_ssl_ctx_callback1): _curl_ssl_ctx_callback5 = o
    extension (v: _curl_ssl_ctx_callback5)
      inline def value: _curl_ssl_ctx_callback1 = v

  type _curl_ssl_ctx_callback6 = _curl_ssl_ctx_callback1
  object _curl_ssl_ctx_callback6:
    given _tag: Tag[_curl_ssl_ctx_callback6] = _curl_ssl_ctx_callback1._tag
    inline def apply(inline o: _curl_ssl_ctx_callback1): _curl_ssl_ctx_callback6 = o
    extension (v: _curl_ssl_ctx_callback6)
      inline def value: _curl_ssl_ctx_callback1 = v

  type _curl_ssl_ctx_callback7 = _curl_ssl_ctx_callback1
  object _curl_ssl_ctx_callback7:
    given _tag: Tag[_curl_ssl_ctx_callback7] = _curl_ssl_ctx_callback1._tag
    inline def apply(inline o: _curl_ssl_ctx_callback1): _curl_ssl_ctx_callback7 = o
    extension (v: _curl_ssl_ctx_callback7)
      inline def value: _curl_ssl_ctx_callback1 = v

  type _curl_ssl_ctx_callback8 = _curl_ssl_ctx_callback1
  object _curl_ssl_ctx_callback8:
    given _tag: Tag[_curl_ssl_ctx_callback8] = _curl_ssl_ctx_callback1._tag
    inline def apply(inline o: _curl_ssl_ctx_callback1): _curl_ssl_ctx_callback8 = o
    extension (v: _curl_ssl_ctx_callback8)
      inline def value: _curl_ssl_ctx_callback1 = v

  opaque type _curl_write_callback1 = CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
  object _curl_write_callback1:
    given _tag: Tag[_curl_write_callback1] = Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_write_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]): _curl_write_callback1 = o
    extension (v: _curl_write_callback1)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_write_callback2 = CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
  object _curl_write_callback2:
    given _tag: Tag[_curl_write_callback2] = Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_write_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]): _curl_write_callback2 = o
    extension (v: _curl_write_callback2)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_write_callback3 = CFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t]
  object _curl_write_callback3:
    given _tag: Tag[_curl_write_callback3] = Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_write_callback3 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t]): _curl_write_callback3 = o
    extension (v: _curl_write_callback3)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_write_callback4 = CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
  object _curl_write_callback4:
    given _tag: Tag[_curl_write_callback4] = Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_write_callback4 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]): _curl_write_callback4 = o
    extension (v: _curl_write_callback4)
      inline def value: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_write_callback5 = CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
  object _curl_write_callback5:
    given _tag: Tag[_curl_write_callback5] = Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_write_callback5 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]): _curl_write_callback5 = o
    extension (v: _curl_write_callback5)
      inline def value: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type _curl_write_callback6 = CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t]
  object _curl_write_callback6:
    given _tag: Tag[_curl_write_callback6] = Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_write_callback6 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t]): _curl_write_callback6 = o
    extension (v: _curl_write_callback6)
      inline def value: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
...
object structs:
  ...
  opaque type CURLMsg = CStruct3[CURLMSG, Ptr[CURL], CURLMsg.Data]
  
  object CURLMsg:
    given _tag: Tag[CURLMsg] = Tag.materializeCStruct3Tag[CURLMSG, Ptr[CURL], CURLMsg.Data]
    ...
    def apply(msg : CURLMSG, easy_handle : Ptr[CURL], data : CURLMsg.Data)(using Zone): Ptr[CURLMsg] =
      val ____ptr = apply()
      (!____ptr).msg = msg
  ...
  opaque type curl_fileinfo = CStruct13[CString, curlfiletype, time_t, CUnsignedInt, CInt, CInt, curl_off_t, CLongInt, curl_fileinfo.Strings, CUnsignedInt, CString, size_t, size_t]
  
  object curl_fileinfo:
    given _tag: Tag[curl_fileinfo] = Tag.materializeCStruct13Tag[CString, curlfiletype, time_t, CUnsignedInt, CInt, CInt, curl_off_t, CLongInt, curl_fileinfo.Strings, CUnsignedInt, CString, size_t, size_t]
    ...
    def apply(filename : CString, filetype : curlfiletype, time : time_t, perm : CUnsignedInt, uid : CInt, gid : CInt, size : curl_off_t, hardlinks : CLongInt, strings : curl_fileinfo.Strings, flags : CUnsignedInt, b_data : CString, b_size : size_t, b_used : size_t)(using Zone): Ptr[curl_fileinfo] =
      val ____ptr = apply()
    ...
    extension (struct: curl_fileinfo)
      ...
      def strings : curl_fileinfo.Strings = struct._9
      def strings_=(value: curl_fileinfo.Strings): Unit = !struct.at9 = value
    ...
    opaque type Strings = CStruct5[CString, CString, CString, CString, CString]
    
    object Strings:
      given _tag: Tag[Strings] = Tag.materializeCStruct5Tag[CString, CString, CString, CString, CString]
      
      // Allocates Strings on the heap – fields are not initalised or zeroed out
      def apply()(using Zone): Ptr[Strings] = scala.scalanative.unsafe.alloc[Strings](1)
      def apply(time : CString, perm : CString, user : CString, group : CString, target : CString)(using Zone): Ptr[Strings] =
        val ____ptr = apply()
        (!____ptr).time = time
        (!____ptr).perm = perm
        (!____ptr).user = user
  ...
  object curl_version_info_data:
    ...
    extension (struct: curl_version_info_data)
      ...
      def rtmp_version: CString = !struct.at(offsets(26)).asInstanceOf[Ptr[CString]]
      def rtmp_version_=(value: CString): Unit = !struct.at(offsets(26)).asInstanceOf[Ptr[CString]] = value
...
private[curl] object extern_functions:
  ...
  import _root_.curl.aliases.*
  import _root_.curl.structs.*
  def _curl_easy_getinfo_err_curl_certinfo(): Unit = extern

  def _curl_easy_getinfo_err_curl_off_t(): Unit = extern

  def _curl_easy_getinfo_err_curl_slist(): Unit = extern

  def _curl_easy_getinfo_err_curl_socket(): Unit = extern

  def _curl_easy_getinfo_err_curl_tlssessioninfo(): Unit = extern

  def _curl_easy_getinfo_err_double(): Unit = extern

  def _curl_easy_getinfo_err_long(): Unit = extern

  def _curl_easy_getinfo_err_string(): Unit = extern

  def _curl_easy_setopt_err_CURLSH(): Unit = extern

  def _curl_easy_setopt_err_FILE(): Unit = extern

  def _curl_easy_setopt_err_cb_data(): Unit = extern

  def _curl_easy_setopt_err_chunk_bgn_cb(): Unit = extern

  def _curl_easy_setopt_err_chunk_end_cb(): Unit = extern

  def _curl_easy_setopt_err_close_socket_cb(): Unit = extern

  def _curl_easy_setopt_err_conv_cb(): Unit = extern

  def _curl_easy_setopt_err_curl(): Unit = extern

  def _curl_easy_setopt_err_curl_httpost(): Unit = extern

  def _curl_easy_setopt_err_curl_mimepost(): Unit = extern

  def _curl_easy_setopt_err_curl_off_t(): Unit = extern

  def _curl_easy_setopt_err_curl_slist(): Unit = extern

  def _curl_easy_setopt_err_curlu(): Unit = extern

  def _curl_easy_setopt_err_debug_cb(): Unit = extern

  def _curl_easy_setopt_err_error_buffer(): Unit = extern

  def _curl_easy_setopt_err_fnmatch_cb(): Unit = extern

  def _curl_easy_setopt_err_hstsread_cb(): Unit = extern

  def _curl_easy_setopt_err_hstswrite_cb(): Unit = extern

  def _curl_easy_setopt_err_interleave_cb(): Unit = extern

  def _curl_easy_setopt_err_ioctl_cb(): Unit = extern

  def _curl_easy_setopt_err_long(): Unit = extern

  def _curl_easy_setopt_err_opensocket_cb(): Unit = extern

  def _curl_easy_setopt_err_postfields(): Unit = extern

  def _curl_easy_setopt_err_prereq_cb(): Unit = extern

  def _curl_easy_setopt_err_progress_cb(): Unit = extern

  def _curl_easy_setopt_err_read_cb(): Unit = extern

  def _curl_easy_setopt_err_resolver_start_callback(): Unit = extern

  def _curl_easy_setopt_err_seek_cb(): Unit = extern

  def _curl_easy_setopt_err_sockopt_cb(): Unit = extern

  def _curl_easy_setopt_err_ssh_hostkey_cb(): Unit = extern

  def _curl_easy_setopt_err_ssh_key_cb(): Unit = extern

  def _curl_easy_setopt_err_ssl_ctx_cb(): Unit = extern

  def _curl_easy_setopt_err_string(): Unit = extern

  def _curl_easy_setopt_err_trailer_cb(): Unit = extern

  def _curl_easy_setopt_err_write_callback(): Unit = extern

  def _curl_easy_setopt_err_xferinfo_cb(): Unit = extern

  def _curl_multi_setopt_err_cb_data(): Unit = extern

  def _curl_multi_setopt_err_charpp(): Unit = extern

  def _curl_multi_setopt_err_curl_off_t(): Unit = extern

  def _curl_multi_setopt_err_long(): Unit = extern

  def _curl_multi_setopt_err_pushcb(): Unit = extern

  def _curl_multi_setopt_err_socketcb(): Unit = extern

  def _curl_multi_setopt_err_timercb(): Unit = extern
...
object all:
  ...
  export _root_.curl.aliases._curl_chunk_bgn_callback1
  export _root_.curl.aliases._curl_chunk_bgn_callback2
  export _root_.curl.aliases._curl_conv_callback1
  export _root_.curl.aliases._curl_conv_callback2
  export _root_.curl.aliases._curl_conv_callback3
  export _root_.curl.aliases._curl_conv_callback4
  export _root_.curl.aliases._curl_debug_callback1
  export _root_.curl.aliases._curl_debug_callback2
  export _root_.curl.aliases._curl_debug_callback3
  export _root_.curl.aliases._curl_debug_callback4
  export _root_.curl.aliases._curl_debug_callback5
  export _root_.curl.aliases._curl_debug_callback6
  export _root_.curl.aliases._curl_debug_callback7
  export _root_.curl.aliases._curl_debug_callback8
  export _root_.curl.aliases._curl_interleave_callback1
  export _root_.curl.aliases._curl_interleave_callback2
  export _root_.curl.aliases._curl_ioctl_callback1
  export _root_.curl.aliases._curl_ioctl_callback2
  export _root_.curl.aliases._curl_ioctl_callback3
  export _root_.curl.aliases._curl_ioctl_callback4
  export _root_.curl.aliases._curl_opensocket_callback1
  export _root_.curl.aliases._curl_opensocket_callback2
  export _root_.curl.aliases._curl_opensocket_callback3
  export _root_.curl.aliases._curl_opensocket_callback4
  export _root_.curl.aliases._curl_progress_callback1
  export _root_.curl.aliases._curl_progress_callback2
  export _root_.curl.aliases._curl_read_callback1
  export _root_.curl.aliases._curl_read_callback2
  export _root_.curl.aliases._curl_read_callback3
  export _root_.curl.aliases._curl_read_callback4
  export _root_.curl.aliases._curl_read_callback5
  export _root_.curl.aliases._curl_read_callback6
  export _root_.curl.aliases._curl_seek_callback1
  export _root_.curl.aliases._curl_seek_callback2
  export _root_.curl.aliases._curl_sockopt_callback1
  export _root_.curl.aliases._curl_sockopt_callback2
  export _root_.curl.aliases._curl_ssl_ctx_callback1
  export _root_.curl.aliases._curl_ssl_ctx_callback2
  export _root_.curl.aliases._curl_ssl_ctx_callback3
  export _root_.curl.aliases._curl_ssl_ctx_callback4
  export _root_.curl.aliases._curl_ssl_ctx_callback5
  export _root_.curl.aliases._curl_ssl_ctx_callback6
  export _root_.curl.aliases._curl_ssl_ctx_callback7
  export _root_.curl.aliases._curl_ssl_ctx_callback8
  export _root_.curl.aliases._curl_write_callback1
  export _root_.curl.aliases._curl_write_callback2
  export _root_.curl.aliases._curl_write_callback3
  export _root_.curl.aliases._curl_write_callback4
  export _root_.curl.aliases._curl_write_callback5
  export _root_.curl.aliases._curl_write_callback6
  ...
  export _root_.curl.functions._curl_easy_getinfo_err_curl_certinfo
  export _root_.curl.functions._curl_easy_getinfo_err_curl_off_t
  export _root_.curl.functions._curl_easy_getinfo_err_curl_slist
  export _root_.curl.functions._curl_easy_getinfo_err_curl_socket
  export _root_.curl.functions._curl_easy_getinfo_err_curl_tlssessioninfo
  export _root_.curl.functions._curl_easy_getinfo_err_double
  export _root_.curl.functions._curl_easy_getinfo_err_long
  export _root_.curl.functions._curl_easy_getinfo_err_string
  export _root_.curl.functions._curl_easy_setopt_err_CURLSH
  export _root_.curl.functions._curl_easy_setopt_err_FILE
  export _root_.curl.functions._curl_easy_setopt_err_cb_data
  export _root_.curl.functions._curl_easy_setopt_err_chunk_bgn_cb
  export _root_.curl.functions._curl_easy_setopt_err_chunk_end_cb
  export _root_.curl.functions._curl_easy_setopt_err_close_socket_cb
  export _root_.curl.functions._curl_easy_setopt_err_conv_cb
  export _root_.curl.functions._curl_easy_setopt_err_curl
  export _root_.curl.functions._curl_easy_setopt_err_curl_httpost
  export _root_.curl.functions._curl_easy_setopt_err_curl_mimepost
  export _root_.curl.functions._curl_easy_setopt_err_curl_off_t
  export _root_.curl.functions._curl_easy_setopt_err_curl_slist
  export _root_.curl.functions._curl_easy_setopt_err_curlu
  export _root_.curl.functions._curl_easy_setopt_err_debug_cb
  export _root_.curl.functions._curl_easy_setopt_err_error_buffer
  export _root_.curl.functions._curl_easy_setopt_err_fnmatch_cb
  export _root_.curl.functions._curl_easy_setopt_err_hstsread_cb
  export _root_.curl.functions._curl_easy_setopt_err_hstswrite_cb
  export _root_.curl.functions._curl_easy_setopt_err_interleave_cb
  export _root_.curl.functions._curl_easy_setopt_err_ioctl_cb
  export _root_.curl.functions._curl_easy_setopt_err_long
  export _root_.curl.functions._curl_easy_setopt_err_opensocket_cb
  export _root_.curl.functions._curl_easy_setopt_err_postfields
  export _root_.curl.functions._curl_easy_setopt_err_prereq_cb
  export _root_.curl.functions._curl_easy_setopt_err_progress_cb
  export _root_.curl.functions._curl_easy_setopt_err_read_cb
  export _root_.curl.functions._curl_easy_setopt_err_resolver_start_callback
  export _root_.curl.functions._curl_easy_setopt_err_seek_cb
  export _root_.curl.functions._curl_easy_setopt_err_sockopt_cb
  export _root_.curl.functions._curl_easy_setopt_err_ssh_hostkey_cb
  export _root_.curl.functions._curl_easy_setopt_err_ssh_key_cb
  export _root_.curl.functions._curl_easy_setopt_err_ssl_ctx_cb
  export _root_.curl.functions._curl_easy_setopt_err_string
  export _root_.curl.functions._curl_easy_setopt_err_trailer_cb
  export _root_.curl.functions._curl_easy_setopt_err_write_callback
  export _root_.curl.functions._curl_easy_setopt_err_xferinfo_cb
  export _root_.curl.functions._curl_multi_setopt_err_cb_data
  export _root_.curl.functions._curl_multi_setopt_err_charpp
  export _root_.curl.functions._curl_multi_setopt_err_curl_off_t
  export _root_.curl.functions._curl_multi_setopt_err_long
  export _root_.curl.functions._curl_multi_setopt_err_pushcb
  export _root_.curl.functions._curl_multi_setopt_err_socketcb
  export _root_.curl.functions._curl_multi_setopt_err_timercb
