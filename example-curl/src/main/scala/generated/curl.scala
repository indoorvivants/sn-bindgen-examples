    ...
    def getName(value: CURLFORMcode): Option[String] =
      value match
        ...
        case `CURL_FORMADD_UNKNOWN_OPTION` =>
          Some("CURL_FORMADD_UNKNOWN_OPTION")
    ...
    def getName(value: CURLINFO): Option[String] =
      value match
        ...
        case `CURLINFO_STARTTRANSFER_TIME` =>
          Some("CURLINFO_STARTTRANSFER_TIME")
        ...
        case `CURLINFO_PRETRANSFER_TIME_T` =>
          Some("CURLINFO_PRETRANSFER_TIME_T")
        ...
        case `CURLINFO_POSTTRANSFER_TIME_T` =>
          Some("CURLINFO_POSTTRANSFER_TIME_T")
    ...
    def getName(value: CURLMcode): Option[String] =
      value match
        ...
        case `CURLM_BAD_FUNCTION_ARGUMENT` =>
          Some("CURLM_BAD_FUNCTION_ARGUMENT")
    ...
    def getName(value: CURLMoption): Option[String] =
      value match
        ...
        case `CURLMOPT_PIPELINING_SITE_BL` =>
          Some("CURLMOPT_PIPELINING_SITE_BL")
    ...
    def getName(value: CURLcode): Option[String] =
      value match
        ...
        case `CURLE_COULDNT_RESOLVE_PROXY` =>
          Some("CURLE_COULDNT_RESOLVE_PROXY")
        ...
        case `CURLE_FTP_COULDNT_RETR_FILE` =>
          Some("CURLE_FTP_COULDNT_RETR_FILE")
        ...
        case `CURLE_BAD_FUNCTION_ARGUMENT` =>
          Some("CURLE_BAD_FUNCTION_ARGUMENT")
        ...
        case `CURLE_SSL_ENGINE_INITFAILED` =>
          Some("CURLE_SSL_ENGINE_INITFAILED")
        ...
        case `CURLE_REMOTE_FILE_NOT_FOUND` =>
          Some("CURLE_REMOTE_FILE_NOT_FOUND")
        ...
        case `CURLE_SSL_INVALIDCERTSTATUS` =>
          Some("CURLE_SSL_INVALIDCERTSTATUS")
    ...
    def getName(value: CURLoption): Option[String] =
      value match
        ...
        case `CURLOPT_POSTFIELDSIZE_LARGE` =>
          Some("CURLOPT_POSTFIELDSIZE_LARGE")
        ...
        case `CURLOPT_SSL_SESSIONID_CACHE` =>
          Some("CURLOPT_SSL_SESSIONID_CACHE")
        ...
        case `CURLOPT_SSH_PRIVATE_KEYFILE` =>
          Some("CURLOPT_SSH_PRIVATE_KEYFILE")
        ...
        case `CURLOPT_NEW_DIRECTORY_PERMS` =>
          Some("CURLOPT_NEW_DIRECTORY_PERMS")
        ...
        case `CURLOPT_PROXY_TRANSFER_MODE` =>
          Some("CURLOPT_PROXY_TRANSFER_MODE")
        ...
        case `CURLOPT_CLOSESOCKETFUNCTION` =>
          Some("CURLOPT_CLOSESOCKETFUNCTION")
        ...
        case `CURLOPT_RESOLVER_START_DATA` =>
          Some("CURLOPT_RESOLVER_START_DATA")
        ...
        case `CURLOPT_PROXY_TLS13_CIPHERS` =>
          Some("CURLOPT_PROXY_TLS13_CIPHERS")
        ...
        case `CURLOPT_SERVER_RESPONSE_TIMEOUT_MS` =>
          Some("CURLOPT_SERVER_RESPONSE_TIMEOUT_MS")
        ...
        case `CURLOPT_SSL_SIGNATURE_ALGORITHMS` =>
          Some("CURLOPT_SSL_SIGNATURE_ALGORITHMS")
    ...
    def getName(value: curl_khstat): Option[String] =
      value match
        case `CURLKHSTAT_FINE_ADD_TO_FILE` =>
          Some("CURLKHSTAT_FINE_ADD_TO_FILE")
...
object aliases:
  ...
  opaque type _curl_chunk_bgn_callback1 =
    CFuncPtr3[Ptr[curl_fileinfo], Ptr[Byte], CInt, CLongInt]
  object _curl_chunk_bgn_callback1:
    given _tag: Tag[_curl_chunk_bgn_callback1] =
      Tag.materializeCFuncPtr3[Ptr[curl_fileinfo], Ptr[Byte], CInt, CLongInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_chunk_bgn_callback1 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[curl_fileinfo], Ptr[Byte], CInt, CLongInt]
    ): _curl_chunk_bgn_callback1 = o
    extension (v: _curl_chunk_bgn_callback1)
      inline def value
          : CFuncPtr3[Ptr[curl_fileinfo], Ptr[Byte], CInt, CLongInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_chunk_bgn_callback1

  opaque type _curl_chunk_bgn_callback2 =
    CFuncPtr3[Ptr[Byte], Ptr[Byte], CInt, CLongInt]
  object _curl_chunk_bgn_callback2:
    given _tag: Tag[_curl_chunk_bgn_callback2] =
      Tag.materializeCFuncPtr3[Ptr[Byte], Ptr[Byte], CInt, CLongInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_chunk_bgn_callback2 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[Byte], Ptr[Byte], CInt, CLongInt]
    ): _curl_chunk_bgn_callback2 = o
    extension (v: _curl_chunk_bgn_callback2)
      inline def value: CFuncPtr3[Ptr[Byte], Ptr[Byte], CInt, CLongInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_chunk_bgn_callback2

  opaque type _curl_conv_callback1 = CFuncPtr2[CString, size_t, CURLcode]
  object _curl_conv_callback1:
    given _tag: Tag[_curl_conv_callback1] =
      Tag.materializeCFuncPtr2[CString, size_t, CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_conv_callback1 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr2[CString, size_t, CURLcode]
    ): _curl_conv_callback1 = o
    extension (v: _curl_conv_callback1)
      inline def value: CFuncPtr2[CString, size_t, CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_conv_callback1

  opaque type _curl_conv_callback2 = CFuncPtr2[CString, size_t, CURLcode]
  object _curl_conv_callback2:
    given _tag: Tag[_curl_conv_callback2] =
      Tag.materializeCFuncPtr2[CString, size_t, CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_conv_callback2 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr2[CString, size_t, CURLcode]
    ): _curl_conv_callback2 = o
    extension (v: _curl_conv_callback2)
      inline def value: CFuncPtr2[CString, size_t, CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_conv_callback2

  opaque type _curl_conv_callback3 = CFuncPtr2[Ptr[Byte], size_t, CURLcode]
  object _curl_conv_callback3:
    given _tag: Tag[_curl_conv_callback3] =
      Tag.materializeCFuncPtr2[Ptr[Byte], size_t, CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_conv_callback3 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr2[Ptr[Byte], size_t, CURLcode]
    ): _curl_conv_callback3 = o
    extension (v: _curl_conv_callback3)
      inline def value: CFuncPtr2[Ptr[Byte], size_t, CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_conv_callback3

  opaque type _curl_conv_callback4 = CFuncPtr2[Ptr[Byte], size_t, CURLcode]
  object _curl_conv_callback4:
    given _tag: Tag[_curl_conv_callback4] =
      Tag.materializeCFuncPtr2[Ptr[Byte], size_t, CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_conv_callback4 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr2[Ptr[Byte], size_t, CURLcode]
    ): _curl_conv_callback4 = o
    extension (v: _curl_conv_callback4)
      inline def value: CFuncPtr2[Ptr[Byte], size_t, CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_conv_callback4

  opaque type _curl_debug_callback1 =
    CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
  object _curl_debug_callback1:
    given _tag: Tag[_curl_debug_callback1] = Tag.materializeCFuncPtr5[Ptr[
      CURL
    ], curl_infotype, CString, size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_debug_callback1 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[
          Byte
        ], CInt]
    ): _curl_debug_callback1 = o
    extension (v: _curl_debug_callback1)
      inline def value: CFuncPtr5[Ptr[
        CURL
      ], curl_infotype, CString, size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_debug_callback1

  opaque type _curl_debug_callback2 =
    CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
  object _curl_debug_callback2:
    given _tag: Tag[_curl_debug_callback2] = Tag.materializeCFuncPtr5[Ptr[
      CURL
    ], curl_infotype, CString, size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_debug_callback2 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[
          Byte
        ], CInt]
    ): _curl_debug_callback2 = o
    extension (v: _curl_debug_callback2)
      inline def value: CFuncPtr5[Ptr[
        CURL
      ], curl_infotype, CString, size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_debug_callback2

  opaque type _curl_debug_callback3 =
    CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
  object _curl_debug_callback3:
    given _tag: Tag[_curl_debug_callback3] = Tag.materializeCFuncPtr5[Ptr[
      CURL
    ], curl_infotype, CString, size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_debug_callback3 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[
          Byte
        ], CInt]
    ): _curl_debug_callback3 = o
    extension (v: _curl_debug_callback3)
      inline def value: CFuncPtr5[Ptr[
        CURL
      ], curl_infotype, CString, size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_debug_callback3

  opaque type _curl_debug_callback4 =
    CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
  object _curl_debug_callback4:
    given _tag: Tag[_curl_debug_callback4] = Tag.materializeCFuncPtr5[Ptr[
      CURL
    ], curl_infotype, CString, size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_debug_callback4 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[
          Byte
        ], CInt]
    ): _curl_debug_callback4 = o
    extension (v: _curl_debug_callback4)
      inline def value: CFuncPtr5[Ptr[
        CURL
      ], curl_infotype, CString, size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_debug_callback4

  opaque type _curl_debug_callback5 = CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[
    CUnsignedChar
  ], size_t, Ptr[Byte], CInt]
  object _curl_debug_callback5:
    given _tag: Tag[_curl_debug_callback5] = Tag.materializeCFuncPtr5[Ptr[
      CURL
    ], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_debug_callback5 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[
          CUnsignedChar
        ], size_t, Ptr[Byte], CInt]
    ): _curl_debug_callback5 = o
    extension (v: _curl_debug_callback5)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[
        CUnsignedChar
      ], size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_debug_callback5

  opaque type _curl_debug_callback6 = CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[
    CUnsignedChar
  ], size_t, Ptr[Byte], CInt]
  object _curl_debug_callback6:
    given _tag: Tag[_curl_debug_callback6] = Tag.materializeCFuncPtr5[Ptr[
      CURL
    ], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_debug_callback6 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[
          CUnsignedChar
        ], size_t, Ptr[Byte], CInt]
    ): _curl_debug_callback6 = o
    extension (v: _curl_debug_callback6)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[
        CUnsignedChar
      ], size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_debug_callback6

  opaque type _curl_debug_callback7 = CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[
    CUnsignedChar
  ], size_t, Ptr[Byte], CInt]
  object _curl_debug_callback7:
    given _tag: Tag[_curl_debug_callback7] = Tag.materializeCFuncPtr5[Ptr[
      CURL
    ], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_debug_callback7 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[
          CUnsignedChar
        ], size_t, Ptr[Byte], CInt]
    ): _curl_debug_callback7 = o
    extension (v: _curl_debug_callback7)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[
        CUnsignedChar
      ], size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_debug_callback7

  opaque type _curl_debug_callback8 = CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[
    CUnsignedChar
  ], size_t, Ptr[Byte], CInt]
  object _curl_debug_callback8:
    given _tag: Tag[_curl_debug_callback8] = Tag.materializeCFuncPtr5[Ptr[
      CURL
    ], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_debug_callback8 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[
          CUnsignedChar
        ], size_t, Ptr[Byte], CInt]
    ): _curl_debug_callback8 = o
    extension (v: _curl_debug_callback8)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[
        CUnsignedChar
      ], size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_debug_callback8

  opaque type _curl_interleave_callback1 =
    CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
  object _curl_interleave_callback1:
    given _tag: Tag[_curl_interleave_callback1] =
      Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_interleave_callback1 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    ): _curl_interleave_callback1 = o
    extension (v: _curl_interleave_callback1)
      inline def value
          : CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_interleave_callback1

  opaque type _curl_interleave_callback2 =
    CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
  object _curl_interleave_callback2:
    given _tag: Tag[_curl_interleave_callback2] =
      Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_interleave_callback2 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    ): _curl_interleave_callback2 = o
    extension (v: _curl_interleave_callback2)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t] =
        v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_interleave_callback2

  opaque type _curl_ioctl_callback1 =
    CFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr]
  object _curl_ioctl_callback1:
    given _tag: Tag[_curl_ioctl_callback1] =
      Tag.materializeCFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_ioctl_callback1 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr]
    ): _curl_ioctl_callback1 = o
    extension (v: _curl_ioctl_callback1)
      inline def value: CFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_ioctl_callback1

  opaque type _curl_ioctl_callback2 =
    CFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr]
  object _curl_ioctl_callback2:
    given _tag: Tag[_curl_ioctl_callback2] =
      Tag.materializeCFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_ioctl_callback2 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr]
    ): _curl_ioctl_callback2 = o
    extension (v: _curl_ioctl_callback2)
      inline def value: CFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_ioctl_callback2

  opaque type _curl_ioctl_callback3 =
    CFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr]
  object _curl_ioctl_callback3:
    given _tag: Tag[_curl_ioctl_callback3] =
      Tag.materializeCFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_ioctl_callback3 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr]
    ): _curl_ioctl_callback3 = o
    extension (v: _curl_ioctl_callback3)
      inline def value: CFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr] =
        v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_ioctl_callback3

  opaque type _curl_ioctl_callback4 =
    CFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr]
  object _curl_ioctl_callback4:
    given _tag: Tag[_curl_ioctl_callback4] =
      Tag.materializeCFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_ioctl_callback4 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr]
    ): _curl_ioctl_callback4 = o
    extension (v: _curl_ioctl_callback4)
      inline def value: CFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr] =
        v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_ioctl_callback4

  opaque type _curl_opensocket_callback1 =
    CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
  object _curl_opensocket_callback1:
    given _tag: Tag[_curl_opensocket_callback1] = Tag.materializeCFuncPtr3[Ptr[
      Byte
    ], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_opensocket_callback1 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[
          curl_sockaddr
        ], curl_socket_t]
    ): _curl_opensocket_callback1 = o
    extension (v: _curl_opensocket_callback1)
      inline def value: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[
        curl_sockaddr
      ], curl_socket_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_opensocket_callback1

  opaque type _curl_opensocket_callback2 =
    CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
  object _curl_opensocket_callback2:
    given _tag: Tag[_curl_opensocket_callback2] = Tag.materializeCFuncPtr3[Ptr[
      Byte
    ], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_opensocket_callback2 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[
          curl_sockaddr
        ], curl_socket_t]
    ): _curl_opensocket_callback2 = o
    extension (v: _curl_opensocket_callback2)
      inline def value: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[
        curl_sockaddr
      ], curl_socket_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_opensocket_callback2

  opaque type _curl_opensocket_callback3 =
    CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
  object _curl_opensocket_callback3:
    given _tag: Tag[_curl_opensocket_callback3] = Tag.materializeCFuncPtr3[Ptr[
      Byte
    ], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_opensocket_callback3 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[
          curl_sockaddr
        ], curl_socket_t]
    ): _curl_opensocket_callback3 = o
    extension (v: _curl_opensocket_callback3)
      inline def value: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[
        curl_sockaddr
      ], curl_socket_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_opensocket_callback3

  opaque type _curl_opensocket_callback4 =
    CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
  object _curl_opensocket_callback4:
    given _tag: Tag[_curl_opensocket_callback4] = Tag.materializeCFuncPtr3[Ptr[
      Byte
    ], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_opensocket_callback4 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[
          curl_sockaddr
        ], curl_socket_t]
    ): _curl_opensocket_callback4 = o
    extension (v: _curl_opensocket_callback4)
      inline def value: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[
        curl_sockaddr
      ], curl_socket_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_opensocket_callback4

  opaque type _curl_progress_callback1 =
    CFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt]
  object _curl_progress_callback1:
    given _tag: Tag[_curl_progress_callback1] =
      Tag.materializeCFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_progress_callback1 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt]
    ): _curl_progress_callback1 = o
    extension (v: _curl_progress_callback1)
      inline def value
          : CFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_progress_callback1

  opaque type _curl_progress_callback2 =
    CFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt]
  object _curl_progress_callback2:
    given _tag: Tag[_curl_progress_callback2] =
      Tag.materializeCFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_progress_callback2 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt]
    ): _curl_progress_callback2 = o
    extension (v: _curl_progress_callback2)
      inline def value
          : CFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_progress_callback2

  opaque type _curl_read_callback1 =
    CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
  object _curl_read_callback1:
    given _tag: Tag[_curl_read_callback1] =
      Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_read_callback1 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    ): _curl_read_callback1 = o
    extension (v: _curl_read_callback1)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t] =
        v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_read_callback1

  opaque type _curl_read_callback2 =
    CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
  object _curl_read_callback2:
    given _tag: Tag[_curl_read_callback2] =
      Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_read_callback2 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    ): _curl_read_callback2 = o
    extension (v: _curl_read_callback2)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t] =
        v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_read_callback2

  opaque type _curl_read_callback3 =
    CFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t]
  object _curl_read_callback3:
    given _tag: Tag[_curl_read_callback3] =
      Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_read_callback3 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t]
    ): _curl_read_callback3 = o
    extension (v: _curl_read_callback3)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t] =
        v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_read_callback3

  opaque type _curl_read_callback4 =
    CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
  object _curl_read_callback4:
    given _tag: Tag[_curl_read_callback4] =
      Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_read_callback4 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    ): _curl_read_callback4 = o
    extension (v: _curl_read_callback4)
      inline def value
          : CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_read_callback4

  opaque type _curl_read_callback5 =
    CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
  object _curl_read_callback5:
    given _tag: Tag[_curl_read_callback5] =
      Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_read_callback5 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    ): _curl_read_callback5 = o
    extension (v: _curl_read_callback5)
      inline def value
          : CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_read_callback5

  opaque type _curl_read_callback6 =
    CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t]
  object _curl_read_callback6:
    given _tag: Tag[_curl_read_callback6] =
      Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_read_callback6 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t]
    ): _curl_read_callback6 = o
    extension (v: _curl_read_callback6)
      inline def value
          : CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_read_callback6

  opaque type _curl_seek_callback1 =
    CFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode]
  object _curl_seek_callback1:
    given _tag: Tag[_curl_seek_callback1] =
      Tag.materializeCFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_seek_callback1 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode]
    ): _curl_seek_callback1 = o
    extension (v: _curl_seek_callback1)
      inline def value: CFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_seek_callback1

  opaque type _curl_seek_callback2 =
    CFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode]
  object _curl_seek_callback2:
    given _tag: Tag[_curl_seek_callback2] =
      Tag.materializeCFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_seek_callback2 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode]
    ): _curl_seek_callback2 = o
    extension (v: _curl_seek_callback2)
      inline def value: CFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_seek_callback2

  opaque type _curl_sockopt_callback1 =
    CFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt]
  object _curl_sockopt_callback1:
    given _tag: Tag[_curl_sockopt_callback1] =
      Tag.materializeCFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_sockopt_callback1 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt]
    ): _curl_sockopt_callback1 = o
    extension (v: _curl_sockopt_callback1)
      inline def value
          : CFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_sockopt_callback1

  opaque type _curl_sockopt_callback2 =
    CFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt]
  object _curl_sockopt_callback2:
    given _tag: Tag[_curl_sockopt_callback2] =
      Tag.materializeCFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_sockopt_callback2 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt]
    ): _curl_sockopt_callback2 = o
    extension (v: _curl_sockopt_callback2)
      inline def value
          : CFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_sockopt_callback2

  opaque type _curl_ssl_ctx_callback1 =
    CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
  object _curl_ssl_ctx_callback1:
    given _tag: Tag[_curl_ssl_ctx_callback1] =
      Tag.materializeCFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_ssl_ctx_callback1 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
    ): _curl_ssl_ctx_callback1 = o
    extension (v: _curl_ssl_ctx_callback1)
      inline def value: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_ssl_ctx_callback1

  opaque type _curl_ssl_ctx_callback2 =
    CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
  object _curl_ssl_ctx_callback2:
    given _tag: Tag[_curl_ssl_ctx_callback2] =
      Tag.materializeCFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_ssl_ctx_callback2 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
    ): _curl_ssl_ctx_callback2 = o
    extension (v: _curl_ssl_ctx_callback2)
      inline def value: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_ssl_ctx_callback2

  opaque type _curl_ssl_ctx_callback3 =
    CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
  object _curl_ssl_ctx_callback3:
    given _tag: Tag[_curl_ssl_ctx_callback3] =
      Tag.materializeCFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_ssl_ctx_callback3 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
    ): _curl_ssl_ctx_callback3 = o
    extension (v: _curl_ssl_ctx_callback3)
      inline def value: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_ssl_ctx_callback3

  opaque type _curl_ssl_ctx_callback4 =
    CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
  object _curl_ssl_ctx_callback4:
    given _tag: Tag[_curl_ssl_ctx_callback4] =
      Tag.materializeCFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_ssl_ctx_callback4 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
    ): _curl_ssl_ctx_callback4 = o
    extension (v: _curl_ssl_ctx_callback4)
      inline def value: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_ssl_ctx_callback4
  ...
  object _curl_ssl_ctx_callback5:
    ...
    inline def apply(
        inline o: _curl_ssl_ctx_callback1
    ): _curl_ssl_ctx_callback5 = o
  ...
  object _curl_ssl_ctx_callback8:
    ...
    inline def apply(
        inline o: _curl_ssl_ctx_callback1
    ): _curl_ssl_ctx_callback8 = o
    extension (v: _curl_ssl_ctx_callback8)
      inline def value: _curl_ssl_ctx_callback1 = v

  opaque type _curl_write_callback1 =
    CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
  object _curl_write_callback1:
    given _tag: Tag[_curl_write_callback1] =
      Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_write_callback1 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    ): _curl_write_callback1 = o
    extension (v: _curl_write_callback1)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t] =
        v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_write_callback1

  opaque type _curl_write_callback2 =
    CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
  object _curl_write_callback2:
    given _tag: Tag[_curl_write_callback2] =
      Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_write_callback2 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    ): _curl_write_callback2 = o
    extension (v: _curl_write_callback2)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t] =
        v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_write_callback2

  opaque type _curl_write_callback3 =
    CFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t]
  object _curl_write_callback3:
    given _tag: Tag[_curl_write_callback3] =
      Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_write_callback3 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t]
    ): _curl_write_callback3 = o
    extension (v: _curl_write_callback3)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t] =
        v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_write_callback3

  opaque type _curl_write_callback4 =
    CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
  object _curl_write_callback4:
    given _tag: Tag[_curl_write_callback4] =
      Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_write_callback4 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    ): _curl_write_callback4 = o
    extension (v: _curl_write_callback4)
      inline def value
          : CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_write_callback4

  opaque type _curl_write_callback5 =
    CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
  object _curl_write_callback5:
    given _tag: Tag[_curl_write_callback5] =
      Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_write_callback5 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    ): _curl_write_callback5 = o
    extension (v: _curl_write_callback5)
      inline def value
          : CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_write_callback5

  opaque type _curl_write_callback6 =
    CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t]
  object _curl_write_callback6:
    given _tag: Tag[_curl_write_callback6] =
      Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): _curl_write_callback6 =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t]
    ): _curl_write_callback6 = o
    extension (v: _curl_write_callback6)
      inline def value
          : CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end _curl_write_callback6
  ...
  type curl_ssls_export_cb =
    CFuncPtr11[Ptr[CURL], Ptr[Byte], CString, Ptr[CUnsignedChar], size_t, Ptr[
      CUnsignedChar
    ], size_t, curl_off_t, CInt, CString, size_t, CURLcode]
  object curl_ssls_export_cb:
    given _tag: Tag[curl_ssls_export_cb] = Tag.materializeCFuncPtr11[Ptr[
      CURL
    ], Ptr[Byte], CString, Ptr[CUnsignedChar], size_t, Ptr[
      CUnsignedChar
    ], size_t, curl_off_t, CInt, CString, size_t, CURLcode]
    inline def apply(
        inline o: CFuncPtr11[
    ...
    ): curl_ssls_export_cb = o
    extension (v: curl_ssls_export_cb)
      inline def value: CFuncPtr11[Ptr[CURL], Ptr[Byte], CString, Ptr[
        CUnsignedChar
      ], size_t, Ptr[
        CUnsignedChar
      ], size_t, curl_off_t, CInt, CString, size_t, CURLcode] = v
  end curl_ssls_export_cb
...
object structs:
  ...
  object CURLMsg:
    given _tag: Tag[CURLMsg] =
      Tag.materializeCStruct3Tag[CURLMSG, Ptr[CURL], CURLMsg.Data]
    ...
    def apply(msg: CURLMSG, easy_handle: Ptr[CURL], data: CURLMsg.Data)(using
        Zone
    ): Ptr[CURLMsg] =
      val ____ptr = apply()
      (!____ptr).msg = msg
  ...
  object curl_fileinfo:
    ...
    object Strings:
      ...
      def apply()(using Zone): Ptr[Strings] =
        scala.scalanative.unsafe.alloc[Strings](1)
      def apply(
          time: CString,
          perm: CString,
          user: CString,
  ...
  opaque type curl_httppost = CStruct14[
    Ptr[Byte],
    CString,
    CLongInt,
    CString,
  ...
  object curl_version_info_data:
    ...
    extension (struct: curl_version_info_data)
      def age: CURLversion =
        !struct.at(offsets(0)).asInstanceOf[Ptr[CURLversion]]
      def age_=(value: CURLversion): Unit =
        !struct.at(offsets(0)).asInstanceOf[Ptr[CURLversion]] = value
      def version: CString = !struct.at(offsets(1)).asInstanceOf[Ptr[CString]]
      def version_=(value: CString): Unit =
        !struct.at(offsets(1)).asInstanceOf[Ptr[CString]] = value
      ...
      def features_=(value: CInt): Unit =
        !struct.at(offsets(4)).asInstanceOf[Ptr[CInt]] = value
      def ssl_version: CString =
      ...
      def ssl_version_num: CLongInt =
        !struct.at(offsets(6)).asInstanceOf[Ptr[CLongInt]]
      def ssl_version_num_=(value: CLongInt): Unit =
        !struct.at(offsets(6)).asInstanceOf[Ptr[CLongInt]] = value
      def libz_version: CString =
        !struct.at(offsets(7)).asInstanceOf[Ptr[CString]]
      def libz_version_=(value: CString): Unit =
        !struct.at(offsets(7)).asInstanceOf[Ptr[CString]] = value
      def protocols: Ptr[CString] =
        !struct.at(offsets(8)).asInstanceOf[Ptr[Ptr[CString]]]
      def protocols_=(value: Ptr[CString]): Unit =
        !struct.at(offsets(8)).asInstanceOf[Ptr[Ptr[CString]]] = value
      ...
      def libidn_=(value: CString): Unit =
        !struct.at(offsets(11)).asInstanceOf[Ptr[CString]] = value
      ...
      def nghttp2_version: CString =
        !struct.at(offsets(17)).asInstanceOf[Ptr[CString]]
      def nghttp2_version_=(value: CString): Unit =
        !struct.at(offsets(17)).asInstanceOf[Ptr[CString]] = value
      def quic_version: CString =
        !struct.at(offsets(18)).asInstanceOf[Ptr[CString]]
      ...
      def zstd_ver_num: CUnsignedInt =
        !struct.at(offsets(21)).asInstanceOf[Ptr[CUnsignedInt]]
      def zstd_ver_num_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(21)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def zstd_version: CString =
      ...
      def gsasl_version: CString =
        !struct.at(offsets(24)).asInstanceOf[Ptr[CString]]
      def gsasl_version_=(value: CString): Unit =
        !struct.at(offsets(24)).asInstanceOf[Ptr[CString]] = value
      def feature_names: Ptr[CString] =
        !struct.at(offsets(25)).asInstanceOf[Ptr[Ptr[CString]]]
      def feature_names_=(value: Ptr[CString]): Unit =
        !struct.at(offsets(25)).asInstanceOf[Ptr[Ptr[CString]]] = value
      def rtmp_version: CString =
        !struct.at(offsets(26)).asInstanceOf[Ptr[CString]]
      def rtmp_version_=(value: CString): Unit =
    ...
    val offsets: Array[Int] =
      ...
      res(1) =
        align(res(0) + sizeof[CURLversion].toInt, alignmentof[CString].toInt)
      res(2) =
        align(res(1) + sizeof[CString].toInt, alignmentof[CUnsignedInt].toInt)
      res(3) =
        align(res(2) + sizeof[CUnsignedInt].toInt, alignmentof[CString].toInt)
      ...
      res(6) =
        align(res(5) + sizeof[CString].toInt, alignmentof[CLongInt].toInt)
      res(7) =
        align(res(6) + sizeof[CLongInt].toInt, alignmentof[CString].toInt)
      res(8) =
        align(res(7) + sizeof[CString].toInt, alignmentof[Ptr[CString]].toInt)
      res(9) =
        align(res(8) + sizeof[Ptr[CString]].toInt, alignmentof[CString].toInt)
      ...
      res(14) =
        align(res(13) + sizeof[CString].toInt, alignmentof[CUnsignedInt].toInt)
      res(15) =
        align(res(14) + sizeof[CUnsignedInt].toInt, alignmentof[CString].toInt)
      res(16) =
        align(res(15) + sizeof[CString].toInt, alignmentof[CUnsignedInt].toInt)
      res(17) =
        align(res(16) + sizeof[CUnsignedInt].toInt, alignmentof[CString].toInt)
      res(18) =
      ...
      res(21) =
        align(res(20) + sizeof[CString].toInt, alignmentof[CUnsignedInt].toInt)
      res(22) =
        align(res(21) + sizeof[CUnsignedInt].toInt, alignmentof[CString].toInt)
      res(23) =
        align(res(22) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(24) =
        align(res(23) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(25) =
        align(res(24) + sizeof[CString].toInt, alignmentof[Ptr[CString]].toInt)
      res(26) =
        align(res(25) + sizeof[Ptr[CString]].toInt, alignmentof[CString].toInt)
      res
    end offsets
...
private[curl] object extern_functions:
  ...
  def curl_easy_ssls_export(
      handle: Ptr[CURL],
      export_fn: Ptr[curl_ssls_export_cb],
      userptr: Ptr[Byte]
  ): CURLcode = extern

  def curl_easy_ssls_import(
      handle: Ptr[CURL],
      session_key: CString,
      shmac: Ptr[CUnsignedChar],
      shmac_len: size_t,
      sdata: Ptr[CUnsignedChar],
      sdata_len: size_t
  ): CURLcode = extern
  ...
  def curl_multi_get_offt(
      multi_handle: Ptr[CURLM],
      info: CURLMinfo_offt,
      pvalue: Ptr[curl_off_t]
  ): CURLMcode = extern
  ...
  def curl_multi_waitfds(
      multi: Ptr[CURLM],
      ufds: Ptr[curl_waitfd],
      size: CUnsignedInt,
      fd_count: Ptr[CUnsignedInt]
  ): CURLMcode = extern
  ...
  def curl_mvfprintf(fd: Ptr[FILE], format: CString, args: va_list): CInt =
    extern
  ...
  def curl_mvsprintf(buffer: CString, format: CString, args: va_list): CInt =
    extern
