...
object structs:
  ...
  opaque type curl_httppost = CStruct15[
    Ptr[Byte],
    CString,
    CLongInt,
    CString,
  ...
  object curl_httppost:
    ...
    given _tag: Tag[curl_httppost] = Tag.materializeCStruct15Tag[
      Ptr[Byte],
      CString,
      CLongInt,
      CString,
    ...
    extension (struct: curl_httppost)
      ...
      def contentheader: Ptr[curl_slist] =
        struct._10.asInstanceOf[Ptr[curl_slist]]
      def contentheader_=(value: Ptr[curl_slist]): Unit = !struct.at10 =
        value.asInstanceOf[Ptr[Byte]]
      def more: Ptr[curl_httppost] = struct._11.asInstanceOf[Ptr[curl_httppost]]
      def more_=(value: Ptr[curl_httppost]): Unit = !struct.at11 =
        value.asInstanceOf[Ptr[Byte]]
