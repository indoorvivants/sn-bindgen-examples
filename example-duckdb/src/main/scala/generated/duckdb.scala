...
object predef:
  private[duckdb] trait _BindgenEnumCUnsignedInt[T](using
      eq: T =:= CUnsignedInt
  ):
...
object aliases:
  ...
  object duckdb_delete_callback_t:
    ...
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): duckdb_delete_callback_t =
  ...
  object duckdb_table_function_t:
    ...
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): duckdb_table_function_t =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
