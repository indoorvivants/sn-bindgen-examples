...
object aliases:
  ...
  object s2n_async_pkey_fn:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): s2n_async_pkey_fn =
  ...
  object s2n_cache_delete_callback:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): s2n_cache_delete_callback =
      CFuncPtr.fromPtr(ptr)
    inline def apply(
  ...
  object s2n_cache_retrieve_callback:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): s2n_cache_retrieve_callback =
      CFuncPtr.fromPtr(ptr)
    inline def apply(
  ...
  object s2n_cache_store_callback:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): s2n_cache_store_callback =
      CFuncPtr.fromPtr(ptr)
    inline def apply(
  ...
  object s2n_cert_tiebreak_callback:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): s2n_cert_tiebreak_callback =
      CFuncPtr.fromPtr(ptr)
    inline def apply(
  ...
  object s2n_clock_time_nanoseconds:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): s2n_clock_time_nanoseconds =
      CFuncPtr.fromPtr(ptr)
    inline def apply(
  ...
  object s2n_early_data_cb:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): s2n_early_data_cb =
      CFuncPtr.fromPtr(ptr)
    inline def apply(
  ...
  object s2n_mem_cleanup_callback:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): s2n_mem_cleanup_callback =
      CFuncPtr.fromPtr(ptr)
  ...
  object s2n_mem_free_callback:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): s2n_mem_free_callback =
      CFuncPtr.fromPtr(ptr)
    inline def apply(
  ...
  object s2n_mem_init_callback:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): s2n_mem_init_callback =
      CFuncPtr.fromPtr(ptr)
  ...
  object s2n_mem_malloc_callback:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): s2n_mem_malloc_callback =
      CFuncPtr.fromPtr(ptr)
    inline def apply(
  ...
  object s2n_psk_selection_callback:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): s2n_psk_selection_callback =
      CFuncPtr.fromPtr(ptr)
    inline def apply(
  ...
  object s2n_rand_cleanup_callback:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): s2n_rand_cleanup_callback =
      CFuncPtr.fromPtr(ptr)
  ...
  object s2n_rand_init_callback:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): s2n_rand_init_callback =
      CFuncPtr.fromPtr(ptr)
  ...
  object s2n_rand_mix_callback:
    given _tag: Tag[s2n_rand_mix_callback] =
      Tag.materializeCFuncPtr2[Ptr[Byte], uint32_t, CInt]
    inline def fromPtr(ptr: Ptr[Byte]): s2n_rand_mix_callback =
      CFuncPtr.fromPtr(ptr)
    inline def apply(
        inline o: CFuncPtr2[Ptr[Byte], uint32_t, CInt]
  ...
  object s2n_rand_seed_callback:
    given _tag: Tag[s2n_rand_seed_callback] =
      Tag.materializeCFuncPtr2[Ptr[Byte], uint32_t, CInt]
    inline def fromPtr(ptr: Ptr[Byte]): s2n_rand_seed_callback =
      CFuncPtr.fromPtr(ptr)
    inline def apply(
        inline o: CFuncPtr2[Ptr[Byte], uint32_t, CInt]
  ...
  object s2n_session_ticket_fn:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): s2n_session_ticket_fn =
      CFuncPtr.fromPtr(ptr)
    inline def apply(
        inline o: CFuncPtr3[Ptr[s2n_connection], Ptr[Byte], Ptr[
          s2n_session_ticket
  ...
  object s2n_verify_host_fn:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): s2n_verify_host_fn =
      CFuncPtr.fromPtr(ptr)
    inline def apply(
