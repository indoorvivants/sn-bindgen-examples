...
object predef:
  private[libredis] trait _BindgenEnumCUnsignedInt[T](using
      eq: T =:= CUnsignedInt
  ):
...
object enumerations:
  ...
  object redisConnectionType
      extends _BindgenEnumCUnsignedInt[redisConnectionType]:
...
object structs:
  ...
  object redisContext:
    ...
    def apply(
        ...
        tcp: redisContext.Tcp,
        unix_sock: redisContext.Unix_sock,
        saddr: Ptr[sockaddr],
        addrlen: size_t,
        privdata: Ptr[Byte],
    ...
    extension (struct: redisContext)
      ...
      def unix_sock_=(value: redisContext.Unix_sock): Unit = !struct.at12 =
        value
    ...
    object Unix_sock:
      ...
      def apply()(using Zone): Ptr[Unix_sock] =
        scala.scalanative.unsafe.alloc[Unix_sock](1)
  ...
  opaque type redisOptions =
    CStruct9[CInt, CInt, Ptr[timeval], Ptr[timeval], redisOptions.Endpoint, Ptr[
      Byte
  ...
  object redisOptions:
    given _tag: Tag[redisOptions] =
      Tag.materializeCStruct9Tag[CInt, CInt, Ptr[timeval], Ptr[
        timeval
      ], redisOptions.Endpoint, Ptr[Byte], CFuncPtr1[Ptr[Byte], Unit], Ptr[
        redisPushFn
    ...
    object Endpoint:
      ...
      object Tcp:
        ...
        // Allocates Tcp on the heap – fields are not initalised or zeroed out
        def apply()(using Zone): Ptr[Tcp] =
          scala.scalanative.unsafe.alloc[Tcp](1)
      ...
      given _tag: Tag[Endpoint] = Tag.CArray[CChar, Nat.Digit2[Nat._2, Nat._4]](
        Tag.Byte,
      ...
      extension (struct: Endpoint)
        def tcp: redisOptions.Endpoint.Tcp =
          !struct.at(0).asInstanceOf[Ptr[redisOptions.Endpoint.Tcp]]
        def tcp_=(value: redisOptions.Endpoint.Tcp): Unit =
          !struct.at(0).asInstanceOf[Ptr[redisOptions.Endpoint.Tcp]] = value
...
object functions:
  ...
  def hiredisSetAllocators(ha: Ptr[hiredisAllocFuncs])(using
    ...
    val __ptr_0: Ptr[hiredisAllocFuncs] =
      _root_.scala.scalanative.unsafe.alloc[hiredisAllocFuncs](1)
