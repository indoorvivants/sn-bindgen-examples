...
object enumerations:
  ...
  object CURLFORMcode extends _BindgenEnumCUnsignedInt[CURLFORMcode]:
    ...
    def getName(value: CURLFORMcode): Option[String] =
      value match
  ...
  object CURLHcode extends _BindgenEnumCUnsignedInt[CURLHcode]:
    ...
    def getName(value: CURLHcode): Option[String] =
      value match
  ...
  object CURLINFO extends _BindgenEnumCUnsignedInt[CURLINFO]:
    ...
    val CURLINFO_QUEUE_TIME_T = define(6291521)
    val CURLINFO_USED_PROXY = define(2097218)
    val CURLINFO_POSTTRANSFER_TIME_T = define(6291523)
    val CURLINFO_EARLYDATA_SENT_T = define(6291524)
    val CURLINFO_HTTPAUTH_USED = define(2097221)
    val CURLINFO_PROXYAUTH_USED = define(2097222)
    val CURLINFO_LASTONE = define(70)
    def getName(value: CURLINFO): Option[String] =
      value match
        ...
        case `CURLINFO_CONTENT_LENGTH_DOWNLOAD` => Some("CURLINFO_CONTENT_LENGTH_DOWNLOAD")
        case `CURLINFO_CONTENT_LENGTH_DOWNLOAD_T` => Some("CURLINFO_CONTENT_LENGTH_DOWNLOAD_T")
        case `CURLINFO_CONTENT_LENGTH_UPLOAD` => Some("CURLINFO_CONTENT_LENGTH_UPLOAD")
        case `CURLINFO_CONTENT_LENGTH_UPLOAD_T` => Some("CURLINFO_CONTENT_LENGTH_UPLOAD_T")
        ...
        case `CURLINFO_PROXY_SSL_VERIFYRESULT` => Some("CURLINFO_PROXY_SSL_VERIFYRESULT")
        ...
        case `CURLINFO_STARTTRANSFER_TIME_T` => Some("CURLINFO_STARTTRANSFER_TIME_T")
        ...
        case `CURLINFO_QUEUE_TIME_T` => Some("CURLINFO_QUEUE_TIME_T")
        case `CURLINFO_USED_PROXY` => Some("CURLINFO_USED_PROXY")
        case `CURLINFO_POSTTRANSFER_TIME_T` => Some("CURLINFO_POSTTRANSFER_TIME_T")
        case `CURLINFO_EARLYDATA_SENT_T` => Some("CURLINFO_EARLYDATA_SENT_T")
        case `CURLINFO_HTTPAUTH_USED` => Some("CURLINFO_HTTPAUTH_USED")
        case `CURLINFO_PROXYAUTH_USED` => Some("CURLINFO_PROXYAUTH_USED")
  ...
  object CURLMSG extends _BindgenEnumCUnsignedInt[CURLMSG]:
    ...
    def getName(value: CURLMSG): Option[String] =
      value match
  ...
  object CURLMcode extends _BindgenEnumCInt[CURLMcode]:
    ...
    def getName(value: CURLMcode): Option[String] =
      value match
  ...
  opaque type CURLMinfo_offt = CUnsignedInt
  object CURLMinfo_offt extends _BindgenEnumCUnsignedInt[CURLMinfo_offt]:
    given _tag: Tag[CURLMinfo_offt] = Tag.UInt
    inline def define(inline a: Long): CURLMinfo_offt = a.toUInt
    val CURLMINFO_NONE = define(0)
    val CURLMINFO_XFERS_CURRENT = define(1)
    val CURLMINFO_XFERS_RUNNING = define(2)
    val CURLMINFO_XFERS_PENDING = define(3)
    val CURLMINFO_XFERS_DONE = define(4)
    val CURLMINFO_XFERS_ADDED = define(5)
    val CURLMINFO_LASTENTRY = define(6)
    def getName(value: CURLMinfo_offt): Option[String] =
      value match
        case `CURLMINFO_NONE` => Some("CURLMINFO_NONE")
        case `CURLMINFO_XFERS_CURRENT` => Some("CURLMINFO_XFERS_CURRENT")
        case `CURLMINFO_XFERS_RUNNING` => Some("CURLMINFO_XFERS_RUNNING")
        case `CURLMINFO_XFERS_PENDING` => Some("CURLMINFO_XFERS_PENDING")
        case `CURLMINFO_XFERS_DONE` => Some("CURLMINFO_XFERS_DONE")
        case `CURLMINFO_XFERS_ADDED` => Some("CURLMINFO_XFERS_ADDED")
        case `CURLMINFO_LASTENTRY` => Some("CURLMINFO_LASTENTRY")
        case _ => _root_.scala.None
    extension (a: CURLMinfo_offt)
      inline def &(b: CURLMinfo_offt): CURLMinfo_offt = a & b
      inline def |(b: CURLMinfo_offt): CURLMinfo_offt = a | b
      inline def is(b: CURLMinfo_offt): Boolean = (a & b) == b
  ...
  object CURLMoption extends _BindgenEnumCUnsignedInt[CURLMoption]:
    ...
    val CURLMOPT_NETWORK_CHANGED = define(17)
    val CURLMOPT_NOTIFYFUNCTION = define(20018)
    val CURLMOPT_NOTIFYDATA = define(10019)
    val CURLMOPT_LASTENTRY = define(10020)
    def getName(value: CURLMoption): Option[String] =
      value match
        ...
        case `CURLMOPT_NETWORK_CHANGED` => Some("CURLMOPT_NETWORK_CHANGED")
        case `CURLMOPT_NOTIFYFUNCTION` => Some("CURLMOPT_NOTIFYFUNCTION")
        case `CURLMOPT_NOTIFYDATA` => Some("CURLMOPT_NOTIFYDATA")
  ...
  object CURLSHcode extends _BindgenEnumCUnsignedInt[CURLSHcode]:
    ...
    def getName(value: CURLSHcode): Option[String] =
      value match
  ...
  object CURLSHoption extends _BindgenEnumCUnsignedInt[CURLSHoption]:
    ...
    def getName(value: CURLSHoption): Option[String] =
      value match
  ...
  object CURLSTScode extends _BindgenEnumCUnsignedInt[CURLSTScode]:
    ...
    def getName(value: CURLSTScode): Option[String] =
      value match
  ...
  object CURLUPart extends _BindgenEnumCUnsignedInt[CURLUPart]:
    ...
    def getName(value: CURLUPart): Option[String] =
      value match
  ...
  object CURLUcode extends _BindgenEnumCUnsignedInt[CURLUcode]:
    ...
    val CURLUE_TOO_LARGE = define(31)
    val CURLUE_LAST = define(32)
    def getName(value: CURLUcode): Option[String] =
      value match
        ...
        case `CURLUE_TOO_LARGE` => Some("CURLUE_TOO_LARGE")
  ...
  object CURL_NETRC_OPTION extends _BindgenEnumCUnsignedInt[CURL_NETRC_OPTION]:
    ...
    def getName(value: CURL_NETRC_OPTION): Option[String] =
      value match
  ...
  object CURL_TLSAUTH extends _BindgenEnumCUnsignedInt[CURL_TLSAUTH]:
    ...
    def getName(value: CURL_TLSAUTH): Option[String] =
      value match
  ...
  object CURLcode extends _BindgenEnumCUnsignedInt[CURLcode]:
    ...
    val CURLE_OBSOLETE34 = define(34)
    ...
    val CURLE_OBSOLETE41 = define(41)
    ...
    val CURLE_TOO_LARGE = define(100)
    val CURLE_ECH_REQUIRED = define(101)
    val CURL_LAST = define(102)
    def getName(value: CURLcode): Option[String] =
      value match
        ...
        case `CURLE_OBSOLETE41` => Some("CURLE_OBSOLETE41")
        ...
        case `CURLE_PEER_FAILED_VERIFICATION` => Some("CURLE_PEER_FAILED_VERIFICATION")
        ...
        case `CURLE_NO_CONNECTION_AVAILABLE` => Some("CURLE_NO_CONNECTION_AVAILABLE")
        case `CURLE_SSL_PINNEDPUBKEYNOTMATCH` => Some("CURLE_SSL_PINNEDPUBKEYNOTMATCH")
        ...
        case `CURLE_TOO_LARGE` => Some("CURLE_TOO_LARGE")
        case `CURLE_ECH_REQUIRED` => Some("CURLE_ECH_REQUIRED")
  ...
  object CURLformoption extends _BindgenEnumCUnsignedInt[CURLformoption]:
    ...
    def getName(value: CURLformoption): Option[String] =
      value match
  ...
  object CURLoption extends _BindgenEnumCUnsignedInt[CURLoption]:
    ...
    val CURLOPT_SERVER_RESPONSE_TIMEOUT_MS = define(324)
    val CURLOPT_ECH = define(10325)
    val CURLOPT_TCP_KEEPCNT = define(326)
    val CURLOPT_UPLOAD_FLAGS = define(327)
    val CURLOPT_SSL_SIGNATURE_ALGORITHMS = define(10328)
    val CURLOPT_LASTENTRY = define(10329)
    def getName(value: CURLoption): Option[String] =
      value match
        ...
        case `CURLOPT_DNS_USE_GLOBAL_CACHE` => Some("CURLOPT_DNS_USE_GLOBAL_CACHE")
        ...
        case `CURLOPT_FTP_CREATE_MISSING_DIRS` => Some("CURLOPT_FTP_CREATE_MISSING_DIRS")
        case `CURLOPT_PROXYAUTH` => Some("CURLOPT_PROXYAUTH")
        case `CURLOPT_SERVER_RESPONSE_TIMEOUT` => Some("CURLOPT_SERVER_RESPONSE_TIMEOUT")
        ...
        case `CURLOPT_IGNORE_CONTENT_LENGTH` => Some("CURLOPT_IGNORE_CONTENT_LENGTH")
        ...
        case `CURLOPT_CONV_FROM_NETWORK_FUNCTION` => Some("CURLOPT_CONV_FROM_NETWORK_FUNCTION")
        case `CURLOPT_CONV_TO_NETWORK_FUNCTION` => Some("CURLOPT_CONV_TO_NETWORK_FUNCTION")
        case `CURLOPT_CONV_FROM_UTF8_FUNCTION` => Some("CURLOPT_CONV_FROM_UTF8_FUNCTION")
        case `CURLOPT_MAX_SEND_SPEED_LARGE` => Some("CURLOPT_MAX_SEND_SPEED_LARGE")
        case `CURLOPT_MAX_RECV_SPEED_LARGE` => Some("CURLOPT_MAX_RECV_SPEED_LARGE")
        case `CURLOPT_FTP_ALTERNATIVE_TO_USER` => Some("CURLOPT_FTP_ALTERNATIVE_TO_USER")
        ...
        case `CURLOPT_HTTP_TRANSFER_DECODING` => Some("CURLOPT_HTTP_TRANSFER_DECODING")
        case `CURLOPT_HTTP_CONTENT_DECODING` => Some("CURLOPT_HTTP_CONTENT_DECODING")
        ...
        case `CURLOPT_SSH_HOST_PUBLIC_KEY_MD5` => Some("CURLOPT_SSH_HOST_PUBLIC_KEY_MD5")
        ...
        case `CURLOPT_SOCKS5_GSSAPI_SERVICE` => Some("CURLOPT_SOCKS5_GSSAPI_SERVICE")
        ...
        case `CURLOPT_EXPECT_100_TIMEOUT_MS` => Some("CURLOPT_EXPECT_100_TIMEOUT_MS")
        ...
        case `CURLOPT_KEEP_SENDING_ON_ERROR` => Some("CURLOPT_KEEP_SENDING_ON_ERROR")
        case `CURLOPT_PROXY_CAINFO` => Some("CURLOPT_PROXY_CAINFO")
        case `CURLOPT_PROXY_CAPATH` => Some("CURLOPT_PROXY_CAPATH")
        case `CURLOPT_PROXY_SSL_VERIFYPEER` => Some("CURLOPT_PROXY_SSL_VERIFYPEER")
        case `CURLOPT_PROXY_SSL_VERIFYHOST` => Some("CURLOPT_PROXY_SSL_VERIFYHOST")
        case `CURLOPT_PROXY_SSLVERSION` => Some("CURLOPT_PROXY_SSLVERSION")
        case `CURLOPT_PROXY_TLSAUTH_USERNAME` => Some("CURLOPT_PROXY_TLSAUTH_USERNAME")
        case `CURLOPT_PROXY_TLSAUTH_PASSWORD` => Some("CURLOPT_PROXY_TLSAUTH_PASSWORD")
        ...
        case `CURLOPT_PROXY_SSL_CIPHER_LIST` => Some("CURLOPT_PROXY_SSL_CIPHER_LIST")
        ...
        case `CURLOPT_PROXY_PINNEDPUBLICKEY` => Some("CURLOPT_PROXY_PINNEDPUBLICKEY")
        case `CURLOPT_ABSTRACT_UNIX_SOCKET` => Some("CURLOPT_ABSTRACT_UNIX_SOCKET")
        case `CURLOPT_SUPPRESS_CONNECT_HEADERS` => Some("CURLOPT_SUPPRESS_CONNECT_HEADERS")
        ...
        case `CURLOPT_HAPPY_EYEBALLS_TIMEOUT_MS` => Some("CURLOPT_HAPPY_EYEBALLS_TIMEOUT_MS")
        case `CURLOPT_RESOLVER_START_FUNCTION` => Some("CURLOPT_RESOLVER_START_FUNCTION")
        ...
        case `CURLOPT_DNS_SHUFFLE_ADDRESSES` => Some("CURLOPT_DNS_SHUFFLE_ADDRESSES")
        case `CURLOPT_TLS13_CIPHERS` => Some("CURLOPT_TLS13_CIPHERS")
        case `CURLOPT_PROXY_TLS13_CIPHERS` => Some("CURLOPT_PROXY_TLS13_CIPHERS")
        case `CURLOPT_DISALLOW_USERNAME_IN_URL` => Some("CURLOPT_DISALLOW_USERNAME_IN_URL")
        ...
        case `CURLOPT_PROXY_ISSUERCERT_BLOB` => Some("CURLOPT_PROXY_ISSUERCERT_BLOB")
        ...
        case `CURLOPT_DOH_SSL_VERIFYSTATUS` => Some("CURLOPT_DOH_SSL_VERIFYSTATUS")
        case `CURLOPT_CAINFO_BLOB` => Some("CURLOPT_CAINFO_BLOB")
        case `CURLOPT_PROXY_CAINFO_BLOB` => Some("CURLOPT_PROXY_CAINFO_BLOB")
        case `CURLOPT_SSH_HOST_PUBLIC_KEY_SHA256` => Some("CURLOPT_SSH_HOST_PUBLIC_KEY_SHA256")
        ...
        case `CURLOPT_SERVER_RESPONSE_TIMEOUT_MS` => Some("CURLOPT_SERVER_RESPONSE_TIMEOUT_MS")
        case `CURLOPT_ECH` => Some("CURLOPT_ECH")
        case `CURLOPT_TCP_KEEPCNT` => Some("CURLOPT_TCP_KEEPCNT")
        case `CURLOPT_UPLOAD_FLAGS` => Some("CURLOPT_UPLOAD_FLAGS")
        case `CURLOPT_SSL_SIGNATURE_ALGORITHMS` => Some("CURLOPT_SSL_SIGNATURE_ALGORITHMS")
  ...
  object CURLproxycode extends _BindgenEnumCUnsignedInt[CURLproxycode]:
    ...
    def getName(value: CURLproxycode): Option[String] =
      value match
        ...
        case `CURLPX_REPLY_ADDRESS_TYPE_NOT_SUPPORTED` => Some("CURLPX_REPLY_ADDRESS_TYPE_NOT_SUPPORTED")
        case `CURLPX_REPLY_COMMAND_NOT_SUPPORTED` => Some("CURLPX_REPLY_COMMAND_NOT_SUPPORTED")
        case `CURLPX_REPLY_CONNECTION_REFUSED` => Some("CURLPX_REPLY_CONNECTION_REFUSED")
        case `CURLPX_REPLY_GENERAL_SERVER_FAILURE` => Some("CURLPX_REPLY_GENERAL_SERVER_FAILURE")
        case `CURLPX_REPLY_HOST_UNREACHABLE` => Some("CURLPX_REPLY_HOST_UNREACHABLE")
        case `CURLPX_REPLY_NETWORK_UNREACHABLE` => Some("CURLPX_REPLY_NETWORK_UNREACHABLE")
  ...
  */
  ...
  object CURLversion extends _BindgenEnumCUnsignedInt[CURLversion]:
    ...
    val CURLVERSION_TWELFTH = define(11)
    val CURLVERSION_LAST = define(12)
    def getName(value: CURLversion): Option[String] =
      value match
        ...
        case `CURLVERSION_TWELFTH` => Some("CURLVERSION_TWELFTH")
  ...
  object curl_TimeCond extends _BindgenEnumCUnsignedInt[curl_TimeCond]:
    ...
    def getName(value: curl_TimeCond): Option[String] =
      value match
  ...
  object curl_closepolicy extends _BindgenEnumCUnsignedInt[curl_closepolicy]:
    ...
    def getName(value: curl_closepolicy): Option[String] =
      value match
        ...
        case `CURLCLOSEPOLICY_LEAST_TRAFFIC` => Some("CURLCLOSEPOLICY_LEAST_TRAFFIC")
  ...
  object curl_easytype extends _BindgenEnumCUnsignedInt[curl_easytype]:
    ...
    def getName(value: curl_easytype): Option[String] =
      value match
  ...
  object curl_ftpauth extends _BindgenEnumCUnsignedInt[curl_ftpauth]:
    ...
    def getName(value: curl_ftpauth): Option[String] =
      value match
  ...
  object curl_ftpccc extends _BindgenEnumCUnsignedInt[curl_ftpccc]:
    ...
    def getName(value: curl_ftpccc): Option[String] =
      value match
  ...
  object curl_ftpcreatedir extends _BindgenEnumCUnsignedInt[curl_ftpcreatedir]:
    ...
    def getName(value: curl_ftpcreatedir): Option[String] =
      value match
  ...
  object curl_ftpmethod extends _BindgenEnumCUnsignedInt[curl_ftpmethod]:
    ...
    def getName(value: curl_ftpmethod): Option[String] =
      value match
  ...
  object curl_infotype extends _BindgenEnumCUnsignedInt[curl_infotype]:
    ...
    def getName(value: curl_infotype): Option[String] =
      value match
  ...
  object curl_khmatch extends _BindgenEnumCUnsignedInt[curl_khmatch]:
    ...
    def getName(value: curl_khmatch): Option[String] =
      value match
  ...
  object curl_khstat extends _BindgenEnumCUnsignedInt[curl_khstat]:
    ...
    def getName(value: curl_khstat): Option[String] =
      value match
  ...
  object curl_khtype extends _BindgenEnumCUnsignedInt[curl_khtype]:
    ...
    def getName(value: curl_khtype): Option[String] =
      value match
  ...
  object curl_lock_access extends _BindgenEnumCUnsignedInt[curl_lock_access]:
    ...
    def getName(value: curl_lock_access): Option[String] =
      value match
  ...
  */
  ...
  object curl_lock_data extends _BindgenEnumCUnsignedInt[curl_lock_data]:
    ...
    def getName(value: curl_lock_data): Option[String] =
      value match
  ...
  object curl_proxytype extends _BindgenEnumCUnsignedInt[curl_proxytype]:
    ...
    val CURLPROXY_LAST = define(8)
    def getName(value: curl_proxytype): Option[String] =
      value match
        case `CURLPROXY_LAST` => Some("CURLPROXY_LAST")
        case _ => _root_.scala.None
  ...
  object curl_sslbackend extends _BindgenEnumCUnsignedInt[curl_sslbackend]:
    ...
    def getName(value: curl_sslbackend): Option[String] =
      value match
        ...
        case `CURLSSLBACKEND_SECURETRANSPORT` => Some("CURLSSLBACKEND_SECURETRANSPORT")
  ...
  object curl_usessl extends _BindgenEnumCUnsignedInt[curl_usessl]:
    ...
    def getName(value: curl_usessl): Option[String] =
      value match
  ...
  object curlfiletype extends _BindgenEnumCUnsignedInt[curlfiletype]:
    ...
    def getName(value: curlfiletype): Option[String] =
      value match
...
object aliases:
  ...
  opaque type Wcurl_chunk_bgn_callback1 = CFuncPtr3[Ptr[curl_fileinfo], Ptr[Byte], CInt, CLongInt]
  object Wcurl_chunk_bgn_callback1:
    given _tag: Tag[Wcurl_chunk_bgn_callback1] = Tag.materializeCFuncPtr3[Ptr[curl_fileinfo], Ptr[Byte], CInt, CLongInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_chunk_bgn_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[curl_fileinfo], Ptr[Byte], CInt, CLongInt]): Wcurl_chunk_bgn_callback1 = o
    extension (v: Wcurl_chunk_bgn_callback1)
      inline def value: CFuncPtr3[Ptr[curl_fileinfo], Ptr[Byte], CInt, CLongInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_chunk_bgn_callback2 = CFuncPtr3[Ptr[Byte], Ptr[Byte], CInt, CLongInt]
  object Wcurl_chunk_bgn_callback2:
    given _tag: Tag[Wcurl_chunk_bgn_callback2] = Tag.materializeCFuncPtr3[Ptr[Byte], Ptr[Byte], CInt, CLongInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_chunk_bgn_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], Ptr[Byte], CInt, CLongInt]): Wcurl_chunk_bgn_callback2 = o
    extension (v: Wcurl_chunk_bgn_callback2)
      inline def value: CFuncPtr3[Ptr[Byte], Ptr[Byte], CInt, CLongInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_conv_callback1 = CFuncPtr2[CString, size_t, CURLcode]
  object Wcurl_conv_callback1:
    given _tag: Tag[Wcurl_conv_callback1] = Tag.materializeCFuncPtr2[CString, size_t, CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_conv_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr2[CString, size_t, CURLcode]): Wcurl_conv_callback1 = o
    extension (v: Wcurl_conv_callback1)
      inline def value: CFuncPtr2[CString, size_t, CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_conv_callback2 = CFuncPtr2[CString, size_t, CURLcode]
  object Wcurl_conv_callback2:
    given _tag: Tag[Wcurl_conv_callback2] = Tag.materializeCFuncPtr2[CString, size_t, CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_conv_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr2[CString, size_t, CURLcode]): Wcurl_conv_callback2 = o
    extension (v: Wcurl_conv_callback2)
      inline def value: CFuncPtr2[CString, size_t, CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_conv_callback3 = CFuncPtr2[Ptr[Byte], size_t, CURLcode]
  object Wcurl_conv_callback3:
    given _tag: Tag[Wcurl_conv_callback3] = Tag.materializeCFuncPtr2[Ptr[Byte], size_t, CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_conv_callback3 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr2[Ptr[Byte], size_t, CURLcode]): Wcurl_conv_callback3 = o
    extension (v: Wcurl_conv_callback3)
      inline def value: CFuncPtr2[Ptr[Byte], size_t, CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_conv_callback4 = CFuncPtr2[Ptr[Byte], size_t, CURLcode]
  object Wcurl_conv_callback4:
    given _tag: Tag[Wcurl_conv_callback4] = Tag.materializeCFuncPtr2[Ptr[Byte], size_t, CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_conv_callback4 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr2[Ptr[Byte], size_t, CURLcode]): Wcurl_conv_callback4 = o
    extension (v: Wcurl_conv_callback4)
      inline def value: CFuncPtr2[Ptr[Byte], size_t, CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_debug_callback1 = CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
  object Wcurl_debug_callback1:
    given _tag: Tag[Wcurl_debug_callback1] = Tag.materializeCFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_debug_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]): Wcurl_debug_callback1 = o
    extension (v: Wcurl_debug_callback1)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_debug_callback2 = CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
  object Wcurl_debug_callback2:
    given _tag: Tag[Wcurl_debug_callback2] = Tag.materializeCFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_debug_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]): Wcurl_debug_callback2 = o
    extension (v: Wcurl_debug_callback2)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_debug_callback3 = CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
  object Wcurl_debug_callback3:
    given _tag: Tag[Wcurl_debug_callback3] = Tag.materializeCFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_debug_callback3 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]): Wcurl_debug_callback3 = o
    extension (v: Wcurl_debug_callback3)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_debug_callback4 = CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
  object Wcurl_debug_callback4:
    given _tag: Tag[Wcurl_debug_callback4] = Tag.materializeCFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_debug_callback4 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt]): Wcurl_debug_callback4 = o
    extension (v: Wcurl_debug_callback4)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, CString, size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_debug_callback5 = CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
  object Wcurl_debug_callback5:
    given _tag: Tag[Wcurl_debug_callback5] = Tag.materializeCFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_debug_callback5 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]): Wcurl_debug_callback5 = o
    extension (v: Wcurl_debug_callback5)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_debug_callback6 = CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
  object Wcurl_debug_callback6:
    given _tag: Tag[Wcurl_debug_callback6] = Tag.materializeCFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_debug_callback6 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]): Wcurl_debug_callback6 = o
    extension (v: Wcurl_debug_callback6)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_debug_callback7 = CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
  object Wcurl_debug_callback7:
    given _tag: Tag[Wcurl_debug_callback7] = Tag.materializeCFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_debug_callback7 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]): Wcurl_debug_callback7 = o
    extension (v: Wcurl_debug_callback7)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_debug_callback8 = CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
  object Wcurl_debug_callback8:
    given _tag: Tag[Wcurl_debug_callback8] = Tag.materializeCFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_debug_callback8 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]): Wcurl_debug_callback8 = o
    extension (v: Wcurl_debug_callback8)
      inline def value: CFuncPtr5[Ptr[CURL], curl_infotype, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_interleave_callback1 = CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
  object Wcurl_interleave_callback1:
    given _tag: Tag[Wcurl_interleave_callback1] = Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_interleave_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]): Wcurl_interleave_callback1 = o
    extension (v: Wcurl_interleave_callback1)
      inline def value: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_interleave_callback2 = CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
  object Wcurl_interleave_callback2:
    given _tag: Tag[Wcurl_interleave_callback2] = Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_interleave_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]): Wcurl_interleave_callback2 = o
    extension (v: Wcurl_interleave_callback2)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_ioctl_callback1 = CFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr]
  object Wcurl_ioctl_callback1:
    given _tag: Tag[Wcurl_ioctl_callback1] = Tag.materializeCFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_ioctl_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr]): Wcurl_ioctl_callback1 = o
    extension (v: Wcurl_ioctl_callback1)
      inline def value: CFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_ioctl_callback2 = CFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr]
  object Wcurl_ioctl_callback2:
    given _tag: Tag[Wcurl_ioctl_callback2] = Tag.materializeCFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_ioctl_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr]): Wcurl_ioctl_callback2 = o
    extension (v: Wcurl_ioctl_callback2)
      inline def value: CFuncPtr3[Ptr[CURL], CInt, Ptr[Byte], curlioerr] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_ioctl_callback3 = CFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr]
  object Wcurl_ioctl_callback3:
    given _tag: Tag[Wcurl_ioctl_callback3] = Tag.materializeCFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_ioctl_callback3 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr]): Wcurl_ioctl_callback3 = o
    extension (v: Wcurl_ioctl_callback3)
      inline def value: CFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_ioctl_callback4 = CFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr]
  object Wcurl_ioctl_callback4:
    given _tag: Tag[Wcurl_ioctl_callback4] = Tag.materializeCFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_ioctl_callback4 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr]): Wcurl_ioctl_callback4 = o
    extension (v: Wcurl_ioctl_callback4)
      inline def value: CFuncPtr3[Ptr[CURL], curliocmd, Ptr[Byte], curlioerr] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_opensocket_callback1 = CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
  object Wcurl_opensocket_callback1:
    given _tag: Tag[Wcurl_opensocket_callback1] = Tag.materializeCFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_opensocket_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]): Wcurl_opensocket_callback1 = o
    extension (v: Wcurl_opensocket_callback1)
      inline def value: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_opensocket_callback2 = CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
  object Wcurl_opensocket_callback2:
    given _tag: Tag[Wcurl_opensocket_callback2] = Tag.materializeCFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_opensocket_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]): Wcurl_opensocket_callback2 = o
    extension (v: Wcurl_opensocket_callback2)
      inline def value: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_opensocket_callback3 = CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
  object Wcurl_opensocket_callback3:
    given _tag: Tag[Wcurl_opensocket_callback3] = Tag.materializeCFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_opensocket_callback3 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]): Wcurl_opensocket_callback3 = o
    extension (v: Wcurl_opensocket_callback3)
      inline def value: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_opensocket_callback4 = CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
  object Wcurl_opensocket_callback4:
    given _tag: Tag[Wcurl_opensocket_callback4] = Tag.materializeCFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_opensocket_callback4 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t]): Wcurl_opensocket_callback4 = o
    extension (v: Wcurl_opensocket_callback4)
      inline def value: CFuncPtr3[Ptr[Byte], curlsocktype, Ptr[curl_sockaddr], curl_socket_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_progress_callback1 = CFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt]
  object Wcurl_progress_callback1:
    given _tag: Tag[Wcurl_progress_callback1] = Tag.materializeCFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_progress_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt]): Wcurl_progress_callback1 = o
    extension (v: Wcurl_progress_callback1)
      inline def value: CFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_progress_callback2 = CFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt]
  object Wcurl_progress_callback2:
    given _tag: Tag[Wcurl_progress_callback2] = Tag.materializeCFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_progress_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt]): Wcurl_progress_callback2 = o
    extension (v: Wcurl_progress_callback2)
      inline def value: CFuncPtr5[Ptr[Byte], Double, Double, Double, Double, CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_read_callback1 = CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
  object Wcurl_read_callback1:
    given _tag: Tag[Wcurl_read_callback1] = Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_read_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]): Wcurl_read_callback1 = o
    extension (v: Wcurl_read_callback1)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_read_callback2 = CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
  object Wcurl_read_callback2:
    given _tag: Tag[Wcurl_read_callback2] = Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_read_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]): Wcurl_read_callback2 = o
    extension (v: Wcurl_read_callback2)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_read_callback3 = CFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t]
  object Wcurl_read_callback3:
    given _tag: Tag[Wcurl_read_callback3] = Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_read_callback3 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t]): Wcurl_read_callback3 = o
    extension (v: Wcurl_read_callback3)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_read_callback4 = CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
  object Wcurl_read_callback4:
    given _tag: Tag[Wcurl_read_callback4] = Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_read_callback4 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]): Wcurl_read_callback4 = o
    extension (v: Wcurl_read_callback4)
      inline def value: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_read_callback5 = CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
  object Wcurl_read_callback5:
    given _tag: Tag[Wcurl_read_callback5] = Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_read_callback5 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]): Wcurl_read_callback5 = o
    extension (v: Wcurl_read_callback5)
      inline def value: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_read_callback6 = CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t]
  object Wcurl_read_callback6:
    given _tag: Tag[Wcurl_read_callback6] = Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_read_callback6 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t]): Wcurl_read_callback6 = o
    extension (v: Wcurl_read_callback6)
      inline def value: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_seek_callback1 = CFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode]
  object Wcurl_seek_callback1:
    given _tag: Tag[Wcurl_seek_callback1] = Tag.materializeCFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_seek_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode]): Wcurl_seek_callback1 = o
    extension (v: Wcurl_seek_callback1)
      inline def value: CFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_seek_callback2 = CFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode]
  object Wcurl_seek_callback2:
    given _tag: Tag[Wcurl_seek_callback2] = Tag.materializeCFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_seek_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode]): Wcurl_seek_callback2 = o
    extension (v: Wcurl_seek_callback2)
      inline def value: CFuncPtr3[Ptr[Byte], curl_off_t, CInt, CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_sockopt_callback1 = CFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt]
  object Wcurl_sockopt_callback1:
    given _tag: Tag[Wcurl_sockopt_callback1] = Tag.materializeCFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_sockopt_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt]): Wcurl_sockopt_callback1 = o
    extension (v: Wcurl_sockopt_callback1)
      inline def value: CFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_sockopt_callback2 = CFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt]
  object Wcurl_sockopt_callback2:
    given _tag: Tag[Wcurl_sockopt_callback2] = Tag.materializeCFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_sockopt_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt]): Wcurl_sockopt_callback2 = o
    extension (v: Wcurl_sockopt_callback2)
      inline def value: CFuncPtr3[Ptr[Byte], curl_socket_t, curlsocktype, CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_ssl_ctx_callback1 = CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
  object Wcurl_ssl_ctx_callback1:
    given _tag: Tag[Wcurl_ssl_ctx_callback1] = Tag.materializeCFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_ssl_ctx_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]): Wcurl_ssl_ctx_callback1 = o
    extension (v: Wcurl_ssl_ctx_callback1)
      inline def value: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_ssl_ctx_callback2 = CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
  object Wcurl_ssl_ctx_callback2:
    given _tag: Tag[Wcurl_ssl_ctx_callback2] = Tag.materializeCFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_ssl_ctx_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]): Wcurl_ssl_ctx_callback2 = o
    extension (v: Wcurl_ssl_ctx_callback2)
      inline def value: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_ssl_ctx_callback3 = CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
  object Wcurl_ssl_ctx_callback3:
    given _tag: Tag[Wcurl_ssl_ctx_callback3] = Tag.materializeCFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_ssl_ctx_callback3 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]): Wcurl_ssl_ctx_callback3 = o
    extension (v: Wcurl_ssl_ctx_callback3)
      inline def value: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_ssl_ctx_callback4 = CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
  object Wcurl_ssl_ctx_callback4:
    given _tag: Tag[Wcurl_ssl_ctx_callback4] = Tag.materializeCFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_ssl_ctx_callback4 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode]): Wcurl_ssl_ctx_callback4 = o
    extension (v: Wcurl_ssl_ctx_callback4)
      inline def value: CFuncPtr3[Ptr[CURL], Ptr[Byte], Ptr[Byte], CURLcode] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  type Wcurl_ssl_ctx_callback5 = Wcurl_ssl_ctx_callback1
  object Wcurl_ssl_ctx_callback5:
    given _tag: Tag[Wcurl_ssl_ctx_callback5] = Wcurl_ssl_ctx_callback1._tag
    inline def apply(inline o: Wcurl_ssl_ctx_callback1): Wcurl_ssl_ctx_callback5 = o
    extension (v: Wcurl_ssl_ctx_callback5)
      inline def value: Wcurl_ssl_ctx_callback1 = v

  type Wcurl_ssl_ctx_callback6 = Wcurl_ssl_ctx_callback1
  object Wcurl_ssl_ctx_callback6:
    given _tag: Tag[Wcurl_ssl_ctx_callback6] = Wcurl_ssl_ctx_callback1._tag
    inline def apply(inline o: Wcurl_ssl_ctx_callback1): Wcurl_ssl_ctx_callback6 = o
    extension (v: Wcurl_ssl_ctx_callback6)
      inline def value: Wcurl_ssl_ctx_callback1 = v

  type Wcurl_ssl_ctx_callback7 = Wcurl_ssl_ctx_callback1
  object Wcurl_ssl_ctx_callback7:
    given _tag: Tag[Wcurl_ssl_ctx_callback7] = Wcurl_ssl_ctx_callback1._tag
    inline def apply(inline o: Wcurl_ssl_ctx_callback1): Wcurl_ssl_ctx_callback7 = o
    extension (v: Wcurl_ssl_ctx_callback7)
      inline def value: Wcurl_ssl_ctx_callback1 = v

  type Wcurl_ssl_ctx_callback8 = Wcurl_ssl_ctx_callback1
  object Wcurl_ssl_ctx_callback8:
    given _tag: Tag[Wcurl_ssl_ctx_callback8] = Wcurl_ssl_ctx_callback1._tag
    inline def apply(inline o: Wcurl_ssl_ctx_callback1): Wcurl_ssl_ctx_callback8 = o
    extension (v: Wcurl_ssl_ctx_callback8)
      inline def value: Wcurl_ssl_ctx_callback1 = v

  opaque type Wcurl_write_callback1 = CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
  object Wcurl_write_callback1:
    given _tag: Tag[Wcurl_write_callback1] = Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_write_callback1 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]): Wcurl_write_callback1 = o
    extension (v: Wcurl_write_callback1)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_write_callback2 = CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
  object Wcurl_write_callback2:
    given _tag: Tag[Wcurl_write_callback2] = Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_write_callback2 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t]): Wcurl_write_callback2 = o
    extension (v: Wcurl_write_callback2)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_write_callback3 = CFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t]
  object Wcurl_write_callback3:
    given _tag: Tag[Wcurl_write_callback3] = Tag.materializeCFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_write_callback3 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t]): Wcurl_write_callback3 = o
    extension (v: Wcurl_write_callback3)
      inline def value: CFuncPtr4[CString, size_t, size_t, Ptr[FILE], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_write_callback4 = CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
  object Wcurl_write_callback4:
    given _tag: Tag[Wcurl_write_callback4] = Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_write_callback4 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]): Wcurl_write_callback4 = o
    extension (v: Wcurl_write_callback4)
      inline def value: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_write_callback5 = CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
  object Wcurl_write_callback5:
    given _tag: Tag[Wcurl_write_callback5] = Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_write_callback5 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t]): Wcurl_write_callback5 = o
    extension (v: Wcurl_write_callback5)
      inline def value: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[Byte], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type Wcurl_write_callback6 = CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t]
  object Wcurl_write_callback6:
    given _tag: Tag[Wcurl_write_callback6] = Tag.materializeCFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Wcurl_write_callback6 = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t]): Wcurl_write_callback6 = o
    extension (v: Wcurl_write_callback6)
      inline def value: CFuncPtr4[Ptr[Byte], size_t, size_t, Ptr[FILE], size_t] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  ...
  opaque type curl_notify_callback = CFuncPtr4[Ptr[CURLM], CUnsignedInt, Ptr[CURL], Ptr[Byte], Unit]
  object curl_notify_callback:
    given _tag: Tag[curl_notify_callback] = Tag.materializeCFuncPtr4[Ptr[CURLM], CUnsignedInt, Ptr[CURL], Ptr[Byte], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): curl_notify_callback = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[Ptr[CURLM], CUnsignedInt, Ptr[CURL], Ptr[Byte], Unit]): curl_notify_callback = o
    extension (v: curl_notify_callback)
      inline def value: CFuncPtr4[Ptr[CURLM], CUnsignedInt, Ptr[CURL], Ptr[Byte], Unit] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  ...
  type curl_ssls_export_cb = CFuncPtr11[Ptr[CURL], Ptr[Byte], CString, Ptr[CUnsignedChar], size_t, Ptr[CUnsignedChar], size_t, curl_off_t, CInt, CString, size_t, CURLcode]
  object curl_ssls_export_cb:
    given _tag: Tag[curl_ssls_export_cb] = Tag.materializeCFuncPtr11[Ptr[CURL], Ptr[Byte], CString, Ptr[CUnsignedChar], size_t, Ptr[CUnsignedChar], size_t, curl_off_t, CInt, CString, size_t, CURLcode]
    inline def apply(inline o: CFuncPtr11[Ptr[CURL], Ptr[Byte], CString, Ptr[CUnsignedChar], size_t, Ptr[CUnsignedChar], size_t, curl_off_t, CInt, CString, size_t, CURLcode]): curl_ssls_export_cb = o
    extension (v: curl_ssls_export_cb)
      inline def value: CFuncPtr11[Ptr[CURL], Ptr[Byte], CString, Ptr[CUnsignedChar], size_t, Ptr[CUnsignedChar], size_t, curl_off_t, CInt, CString, size_t, CURLcode] = v
...
object structs:
  ...
  object CURLMsg:
    given _tag: Tag[CURLMsg] = Tag.materializeCStruct3Tag[CURLMSG, Ptr[CURL], CURLMsg_Data]
    
    export fields.*
    private[curl] object fields:
      extension (struct: CURLMsg)
        inline def msg : CURLMSG = struct._1
        inline def msg_=(value: CURLMSG): Unit = (!struct.at1 = value)
        inline def easy_handle : Ptr[CURL] = struct._2
        inline def easy_handle_=(value: Ptr[CURL]): Unit = (!struct.at2 = value)
        inline def data : CURLMsg_Data = struct._3
        inline def data_=(value: CURLMsg_Data): Unit = (!struct.at3 = value)
      end extension
    
    // Allocates CURLMsg on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[CURLMsg] = scala.scalanative.unsafe.alloc[CURLMsg](1)
    def apply(msg : CURLMSG, easy_handle : Ptr[CURL], data : CURLMsg_Data)(using Zone): Ptr[CURLMsg] =
      val ____ptr = apply()
      (!____ptr).msg = msg
  ...
  opaque type CURLMsg_Data = CArray[Byte, Nat._8]
  object CURLMsg_Data:
    given _tag: Tag[CURLMsg_Data] = Tag.CArray[CChar, Nat._8](Tag.Byte, Tag.Nat8)
    
    def apply()(using Zone): Ptr[CURLMsg_Data] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[CURLMsg_Data](1)
      ___ptr
    
    @scala.annotation.targetName("apply_whatever")
    def apply(whatever: Ptr[Byte])(using Zone): Ptr[CURLMsg_Data] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[CURLMsg_Data](1)
      val un = !___ptr
    ...
    def apply(result: CURLcode)(using Zone): Ptr[CURLMsg_Data] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[CURLMsg_Data](1)
      val un = !___ptr
      un.at(0).asInstanceOf[Ptr[CURLcode]].update(0, result)
      ___ptr
    
    extension (struct: CURLMsg_Data)
      inline def whatever : Ptr[Byte] = !struct.at(0).asInstanceOf[Ptr[Ptr[Byte]]]
      inline def whatever_=(value: Ptr[Byte]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[Byte]]] = value
      inline def result : CURLcode = !struct.at(0).asInstanceOf[Ptr[CURLcode]]
      inline def result_=(value: CURLcode): Unit = !struct.at(0).asInstanceOf[Ptr[CURLcode]] = value
  ...
  object curl_blob:
    ...
    // Allocates curl_blob on the heap – fields are not initalised or zeroed out
  ...
  object curl_certinfo:
    ...
    private[curl] object fields:
      extension (struct: curl_certinfo)
        inline def num_of_certs : CInt = struct._1
        inline def num_of_certs_=(value: CInt): Unit = (!struct.at1 = value)
        inline def certinfo : Ptr[Ptr[curl_slist]] = struct._2.asInstanceOf[Ptr[Ptr[curl_slist]]]
        inline def certinfo_=(value: Ptr[Ptr[curl_slist]]): Unit = (!struct.at2 = value.asInstanceOf[Ptr[Byte]])
      end extension
    
    // Allocates curl_certinfo on the heap – fields are not initalised or zeroed out
  ...
  object curl_easyoption:
    ...
    private[curl] object fields:
      extension (struct: curl_easyoption)
        ...
        inline def id : CURLoption = struct._2
        inline def id_=(value: CURLoption): Unit = (!struct.at2 = value)
        inline def `type` : curl_easytype = struct._3
        inline def type_=(value: curl_easytype): Unit = (!struct.at3 = value)
        inline def flags : CUnsignedInt = struct._4
        inline def flags_=(value: CUnsignedInt): Unit = (!struct.at4 = value)
      end extension
    
    // Allocates curl_easyoption on the heap – fields are not initalised or zeroed out
  ...
  opaque type curl_fileinfo = CStruct13[CString, curlfiletype, time_t, CUnsignedInt, CInt, CInt, curl_off_t, CLongInt, curl_fileinfo_Strings, CUnsignedInt, CString, size_t, size_t]
  
  object curl_fileinfo:
    given _tag: Tag[curl_fileinfo] = Tag.materializeCStruct13Tag[CString, curlfiletype, time_t, CUnsignedInt, CInt, CInt, curl_off_t, CLongInt, curl_fileinfo_Strings, CUnsignedInt, CString, size_t, size_t]
    ...
    private[curl] object fields:
      extension (struct: curl_fileinfo)
        ...
        inline def filetype : curlfiletype = struct._2
        inline def filetype_=(value: curlfiletype): Unit = (!struct.at2 = value)
        inline def time : time_t = struct._3
        inline def time_=(value: time_t): Unit = (!struct.at3 = value)
        inline def perm : CUnsignedInt = struct._4
        inline def perm_=(value: CUnsignedInt): Unit = (!struct.at4 = value)
        inline def uid : CInt = struct._5
        inline def uid_=(value: CInt): Unit = (!struct.at5 = value)
        inline def gid : CInt = struct._6
        inline def gid_=(value: CInt): Unit = (!struct.at6 = value)
        inline def size : curl_off_t = struct._7
        inline def size_=(value: curl_off_t): Unit = (!struct.at7 = value)
        inline def hardlinks : CLongInt = struct._8
        inline def hardlinks_=(value: CLongInt): Unit = (!struct.at8 = value)
        inline def strings : curl_fileinfo_Strings = struct._9
        inline def strings_=(value: curl_fileinfo_Strings): Unit = (!struct.at9 = value)
        inline def flags : CUnsignedInt = struct._10
        inline def flags_=(value: CUnsignedInt): Unit = (!struct.at10 = value)
        inline def b_data : CString = struct._11
        inline def b_data_=(value: CString): Unit = (!struct.at11 = value)
        inline def b_size : size_t = struct._12
        inline def b_size_=(value: size_t): Unit = (!struct.at12 = value)
        inline def b_used : size_t = struct._13
        inline def b_used_=(value: size_t): Unit = (!struct.at13 = value)
      end extension
    
    // Allocates curl_fileinfo on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[curl_fileinfo] = scala.scalanative.unsafe.alloc[curl_fileinfo](1)
    def apply(filename : CString, filetype : curlfiletype, time : time_t, perm : CUnsignedInt, uid : CInt, gid : CInt, size : curl_off_t, hardlinks : CLongInt, strings : curl_fileinfo_Strings, flags : CUnsignedInt, b_data : CString, b_size : size_t, b_used : size_t)(using Zone): Ptr[curl_fileinfo] =
      val ____ptr = apply()
  ...
  opaque type curl_fileinfo_Strings = CStruct5[CString, CString, CString, CString, CString]
  
  object curl_fileinfo_Strings:
    given _tag: Tag[curl_fileinfo_Strings] = Tag.materializeCStruct5Tag[CString, CString, CString, CString, CString]
    
    export fields.*
    private[curl] object fields:
      extension (struct: curl_fileinfo_Strings)
        inline def time : CString = struct._1
        inline def time_=(value: CString): Unit = (!struct.at1 = value)
        inline def perm : CString = struct._2
        inline def perm_=(value: CString): Unit = (!struct.at2 = value)
        inline def user : CString = struct._3
        inline def user_=(value: CString): Unit = (!struct.at3 = value)
        inline def group : CString = struct._4
        inline def group_=(value: CString): Unit = (!struct.at4 = value)
        inline def target : CString = struct._5
        inline def target_=(value: CString): Unit = (!struct.at5 = value)
      end extension
    
    // Allocates curl_fileinfo_Strings on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[curl_fileinfo_Strings] = scala.scalanative.unsafe.alloc[curl_fileinfo_Strings](1)
    def apply(time : CString, perm : CString, user : CString, group : CString, target : CString)(using Zone): Ptr[curl_fileinfo_Strings] =
      val ____ptr = apply()
      (!____ptr).time = time
      (!____ptr).perm = perm
      (!____ptr).user = user
  ...
  object curl_forms:
    ...
    private[curl] object fields:
      extension (struct: curl_forms)
        inline def option : CURLformoption = struct._1
        inline def option_=(value: CURLformoption): Unit = (!struct.at1 = value)
        inline def value : CString = struct._2
        inline def value_=(value: CString): Unit = (!struct.at2 = value)
      end extension
    
    // Allocates curl_forms on the heap – fields are not initalised or zeroed out
  ...
  object curl_header:
    ...
    private[curl] object fields:
      extension (struct: curl_header)
        ...
        inline def value : CString = struct._2
        inline def value_=(value: CString): Unit = (!struct.at2 = value)
        inline def amount : size_t = struct._3
        inline def amount_=(value: size_t): Unit = (!struct.at3 = value)
        inline def index : size_t = struct._4
        inline def index_=(value: size_t): Unit = (!struct.at4 = value)
        inline def origin : CUnsignedInt = struct._5
        inline def origin_=(value: CUnsignedInt): Unit = (!struct.at5 = value)
        inline def anchor : Ptr[Byte] = struct._6
        inline def anchor_=(value: Ptr[Byte]): Unit = (!struct.at6 = value)
      end extension
    
    // Allocates curl_header on the heap – fields are not initalised or zeroed out
  ...
  object curl_hstsentry:
    ...
    private[curl] object fields:
      extension (struct: curl_hstsentry)
        inline def name : CString = struct._1
        inline def name_=(value: CString): Unit = (!struct.at1 = value)
        inline def namelen : size_t = struct._2
        inline def namelen_=(value: size_t): Unit = (!struct.at2 = value)
        inline def includeSubDomains : CUnsignedInt = struct._3
        inline def includeSubDomains_=(value: CUnsignedInt): Unit = (!struct.at3 = value)
        inline def expire : CArray[CChar, Nat.Digit2[Nat._1, Nat._8]] = struct._4
        inline def expire_=(value: CArray[CChar, Nat.Digit2[Nat._1, Nat._8]]): Unit = (!struct.at4 = value)
      end extension
    
    // Allocates curl_hstsentry on the heap – fields are not initalised or zeroed out
  ...
  object curl_httppost:
    ...
    private[curl] object fields:
      extension (struct: curl_httppost)
        inline def next : Ptr[curl_httppost] = struct._1.asInstanceOf[Ptr[curl_httppost]]
        inline def next_=(value: Ptr[curl_httppost]): Unit = (!struct.at1 = value.asInstanceOf[Ptr[Byte]])
        inline def name : CString = struct._2
        inline def name_=(value: CString): Unit = (!struct.at2 = value)
        inline def namelength : CLongInt = struct._3
        inline def namelength_=(value: CLongInt): Unit = (!struct.at3 = value)
        inline def contents : CString = struct._4
        inline def contents_=(value: CString): Unit = (!struct.at4 = value)
        inline def contentslength : CLongInt = struct._5
        inline def contentslength_=(value: CLongInt): Unit = (!struct.at5 = value)
        inline def buffer : CString = struct._6
        inline def buffer_=(value: CString): Unit = (!struct.at6 = value)
        inline def bufferlength : CLongInt = struct._7
        inline def bufferlength_=(value: CLongInt): Unit = (!struct.at7 = value)
        inline def contenttype : CString = struct._8
        inline def contenttype_=(value: CString): Unit = (!struct.at8 = value)
        inline def contentheader : Ptr[curl_slist] = struct._9.asInstanceOf[Ptr[curl_slist]]
        inline def contentheader_=(value: Ptr[curl_slist]): Unit = (!struct.at9 = value.asInstanceOf[Ptr[Byte]])
        inline def more : Ptr[curl_httppost] = struct._10.asInstanceOf[Ptr[curl_httppost]]
        inline def more_=(value: Ptr[curl_httppost]): Unit = (!struct.at10 = value.asInstanceOf[Ptr[Byte]])
        inline def flags : CLongInt = struct._11
        inline def flags_=(value: CLongInt): Unit = (!struct.at11 = value)
        inline def showfilename : CString = struct._12
        inline def showfilename_=(value: CString): Unit = (!struct.at12 = value)
        inline def userp : Ptr[Byte] = struct._13
        inline def userp_=(value: Ptr[Byte]): Unit = (!struct.at13 = value)
        inline def contentlen : curl_off_t = struct._14
        inline def contentlen_=(value: curl_off_t): Unit = (!struct.at14 = value)
      end extension
    
    // Allocates curl_httppost on the heap – fields are not initalised or zeroed out
  ...
  object curl_index:
    ...
    private[curl] object fields:
      extension (struct: curl_index)
        inline def index : size_t = struct._1
        inline def index_=(value: size_t): Unit = (!struct.at1 = value)
        inline def total : size_t = struct._2
        inline def total_=(value: size_t): Unit = (!struct.at2 = value)
      end extension
    
    // Allocates curl_index on the heap – fields are not initalised or zeroed out
  ...
  object curl_khkey:
    ...
    private[curl] object fields:
      extension (struct: curl_khkey)
        ...
        inline def len : size_t = struct._2
        inline def len_=(value: size_t): Unit = (!struct.at2 = value)
        inline def keytype : curl_khtype = struct._3
        inline def keytype_=(value: curl_khtype): Unit = (!struct.at3 = value)
      end extension
    
    // Allocates curl_khkey on the heap – fields are not initalised or zeroed out
  ...
  object curl_slist:
    ...
    private[curl] object fields:
      extension (struct: curl_slist)
        ...
        inline def next : Ptr[curl_slist] = struct._2.asInstanceOf[Ptr[curl_slist]]
        inline def next_=(value: Ptr[curl_slist]): Unit = (!struct.at2 = value.asInstanceOf[Ptr[Byte]])
      end extension
    
    // Allocates curl_slist on the heap – fields are not initalised or zeroed out
  ...
  object curl_sockaddr:
    ...
    private[curl] object fields:
      extension (struct: curl_sockaddr)
        inline def family : CInt = struct._1
        inline def family_=(value: CInt): Unit = (!struct.at1 = value)
        inline def socktype : CInt = struct._2
        inline def socktype_=(value: CInt): Unit = (!struct.at2 = value)
        inline def protocol : CInt = struct._3
        inline def protocol_=(value: CInt): Unit = (!struct.at3 = value)
        inline def addrlen : CUnsignedInt = struct._4
        inline def addrlen_=(value: CUnsignedInt): Unit = (!struct.at4 = value)
        inline def addr : sockaddr = struct._5
        inline def addr_=(value: sockaddr): Unit = (!struct.at5 = value)
      end extension
    
    // Allocates curl_sockaddr on the heap – fields are not initalised or zeroed out
  ...
  object curl_ssl_backend:
    ...
    private[curl] object fields:
      extension (struct: curl_ssl_backend)
        inline def id : curl_sslbackend = struct._1
        inline def id_=(value: curl_sslbackend): Unit = (!struct.at1 = value)
        inline def name : CString = struct._2
        inline def name_=(value: CString): Unit = (!struct.at2 = value)
      end extension
    
    // Allocates curl_ssl_backend on the heap – fields are not initalised or zeroed out
  ...
  object curl_tlssessioninfo:
    ...
    private[curl] object fields:
      extension (struct: curl_tlssessioninfo)
        inline def backend : curl_sslbackend = struct._1
        inline def backend_=(value: curl_sslbackend): Unit = (!struct.at1 = value)
        inline def internals : Ptr[Byte] = struct._2
        inline def internals_=(value: Ptr[Byte]): Unit = (!struct.at2 = value)
      end extension
    
    // Allocates curl_tlssessioninfo on the heap – fields are not initalised or zeroed out
  ...
  opaque type curl_version_info_data = CArray[CChar, Nat.Digit3[Nat._2, Nat._1, Nat._6]]
  
  object curl_version_info_data:
    given _tag: Tag[curl_version_info_data] = Tag.CArray[CChar, Nat.Digit3[Nat._2, Nat._1, Nat._6]](Tag.Byte, Tag.Digit3[Nat._2, Nat._1, Nat._6](Tag.Nat2, Tag.Nat1, Tag.Nat6))
    
    export fields.*
    private[curl] object fields:
      extension (struct: curl_version_info_data)
        inline def age: CURLversion = !struct.at(offsets(0)).asInstanceOf[Ptr[CURLversion]]
        inline def age_=(value: CURLversion): Unit = !struct.at(offsets(0)).asInstanceOf[Ptr[CURLversion]] = value
        inline def version: CString = !struct.at(offsets(1)).asInstanceOf[Ptr[CString]]
        inline def version_=(value: CString): Unit = !struct.at(offsets(1)).asInstanceOf[Ptr[CString]] = value
        inline def version_num: CUnsignedInt = !struct.at(offsets(2)).asInstanceOf[Ptr[CUnsignedInt]]
        inline def version_num_=(value: CUnsignedInt): Unit = !struct.at(offsets(2)).asInstanceOf[Ptr[CUnsignedInt]] = value
        inline def host: CString = !struct.at(offsets(3)).asInstanceOf[Ptr[CString]]
        inline def host_=(value: CString): Unit = !struct.at(offsets(3)).asInstanceOf[Ptr[CString]] = value
        inline def features: CInt = !struct.at(offsets(4)).asInstanceOf[Ptr[CInt]]
        inline def features_=(value: CInt): Unit = !struct.at(offsets(4)).asInstanceOf[Ptr[CInt]] = value
        inline def ssl_version: CString = !struct.at(offsets(5)).asInstanceOf[Ptr[CString]]
        inline def ssl_version_=(value: CString): Unit = !struct.at(offsets(5)).asInstanceOf[Ptr[CString]] = value
        inline def ssl_version_num: CLongInt = !struct.at(offsets(6)).asInstanceOf[Ptr[CLongInt]]
        inline def ssl_version_num_=(value: CLongInt): Unit = !struct.at(offsets(6)).asInstanceOf[Ptr[CLongInt]] = value
        inline def libz_version: CString = !struct.at(offsets(7)).asInstanceOf[Ptr[CString]]
        inline def libz_version_=(value: CString): Unit = !struct.at(offsets(7)).asInstanceOf[Ptr[CString]] = value
        inline def protocols: Ptr[CString] = !struct.at(offsets(8)).asInstanceOf[Ptr[Ptr[CString]]]
        inline def protocols_=(value: Ptr[CString]): Unit = !struct.at(offsets(8)).asInstanceOf[Ptr[Ptr[CString]]] = value
        inline def ares: CString = !struct.at(offsets(9)).asInstanceOf[Ptr[CString]]
        inline def ares_=(value: CString): Unit = !struct.at(offsets(9)).asInstanceOf[Ptr[CString]] = value
        inline def ares_num: CInt = !struct.at(offsets(10)).asInstanceOf[Ptr[CInt]]
        inline def ares_num_=(value: CInt): Unit = !struct.at(offsets(10)).asInstanceOf[Ptr[CInt]] = value
        inline def libidn: CString = !struct.at(offsets(11)).asInstanceOf[Ptr[CString]]
        inline def libidn_=(value: CString): Unit = !struct.at(offsets(11)).asInstanceOf[Ptr[CString]] = value
        inline def iconv_ver_num: CInt = !struct.at(offsets(12)).asInstanceOf[Ptr[CInt]]
        inline def iconv_ver_num_=(value: CInt): Unit = !struct.at(offsets(12)).asInstanceOf[Ptr[CInt]] = value
        inline def libssh_version: CString = !struct.at(offsets(13)).asInstanceOf[Ptr[CString]]
        inline def libssh_version_=(value: CString): Unit = !struct.at(offsets(13)).asInstanceOf[Ptr[CString]] = value
        inline def brotli_ver_num: CUnsignedInt = !struct.at(offsets(14)).asInstanceOf[Ptr[CUnsignedInt]]
        inline def brotli_ver_num_=(value: CUnsignedInt): Unit = !struct.at(offsets(14)).asInstanceOf[Ptr[CUnsignedInt]] = value
        inline def brotli_version: CString = !struct.at(offsets(15)).asInstanceOf[Ptr[CString]]
        inline def brotli_version_=(value: CString): Unit = !struct.at(offsets(15)).asInstanceOf[Ptr[CString]] = value
        inline def nghttp2_ver_num: CUnsignedInt = !struct.at(offsets(16)).asInstanceOf[Ptr[CUnsignedInt]]
        inline def nghttp2_ver_num_=(value: CUnsignedInt): Unit = !struct.at(offsets(16)).asInstanceOf[Ptr[CUnsignedInt]] = value
        inline def nghttp2_version: CString = !struct.at(offsets(17)).asInstanceOf[Ptr[CString]]
        inline def nghttp2_version_=(value: CString): Unit = !struct.at(offsets(17)).asInstanceOf[Ptr[CString]] = value
        inline def quic_version: CString = !struct.at(offsets(18)).asInstanceOf[Ptr[CString]]
        inline def quic_version_=(value: CString): Unit = !struct.at(offsets(18)).asInstanceOf[Ptr[CString]] = value
        inline def cainfo: CString = !struct.at(offsets(19)).asInstanceOf[Ptr[CString]]
        inline def cainfo_=(value: CString): Unit = !struct.at(offsets(19)).asInstanceOf[Ptr[CString]] = value
        inline def capath: CString = !struct.at(offsets(20)).asInstanceOf[Ptr[CString]]
        inline def capath_=(value: CString): Unit = !struct.at(offsets(20)).asInstanceOf[Ptr[CString]] = value
        inline def zstd_ver_num: CUnsignedInt = !struct.at(offsets(21)).asInstanceOf[Ptr[CUnsignedInt]]
        inline def zstd_ver_num_=(value: CUnsignedInt): Unit = !struct.at(offsets(21)).asInstanceOf[Ptr[CUnsignedInt]] = value
        inline def zstd_version: CString = !struct.at(offsets(22)).asInstanceOf[Ptr[CString]]
        inline def zstd_version_=(value: CString): Unit = !struct.at(offsets(22)).asInstanceOf[Ptr[CString]] = value
        inline def hyper_version: CString = !struct.at(offsets(23)).asInstanceOf[Ptr[CString]]
        inline def hyper_version_=(value: CString): Unit = !struct.at(offsets(23)).asInstanceOf[Ptr[CString]] = value
        inline def gsasl_version: CString = !struct.at(offsets(24)).asInstanceOf[Ptr[CString]]
        inline def gsasl_version_=(value: CString): Unit = !struct.at(offsets(24)).asInstanceOf[Ptr[CString]] = value
        inline def feature_names: Ptr[CString] = !struct.at(offsets(25)).asInstanceOf[Ptr[Ptr[CString]]]
        inline def feature_names_=(value: Ptr[CString]): Unit = !struct.at(offsets(25)).asInstanceOf[Ptr[Ptr[CString]]] = value
        inline def rtmp_version: CString = !struct.at(offsets(26)).asInstanceOf[Ptr[CString]]
        inline def rtmp_version_=(value: CString): Unit = !struct.at(offsets(26)).asInstanceOf[Ptr[CString]] = value
      end extension
    
    // Allocates curl_version_info_data on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[curl_version_info_data] = scala.scalanative.unsafe.alloc[curl_version_info_data](1)
    def apply(age : CURLversion, version : CString, version_num : CUnsignedInt, host : CString, features : CInt, ssl_version : CString, ssl_version_num : CLongInt, libz_version : CString, protocols : Ptr[CString], ares : CString, ares_num : CInt, libidn : CString, iconv_ver_num : CInt, libssh_version : CString, brotli_ver_num : CUnsignedInt, brotli_version : CString, nghttp2_ver_num : CUnsignedInt, nghttp2_version : CString, quic_version : CString, cainfo : CString, capath : CString, zstd_ver_num : CUnsignedInt, zstd_version : CString, hyper_version : CString, gsasl_version : CString, feature_names : Ptr[CString], rtmp_version : CString)(using Zone): Ptr[curl_version_info_data] =
      val ____ptr = apply()
      (!____ptr).age = age
      ...
      (!____ptr).rtmp_version = rtmp_version
      ____ptr
    ...
    val offsets: Array[Int] =
      ...
      res(26) = align(res(25) + sizeof[Ptr[CString]].toInt, alignmentof[CString].toInt)
      res
    end offsets
  ...
  object curl_waitfd:
    ...
    private[curl] object fields:
      extension (struct: curl_waitfd)
        inline def fd : curl_socket_t = struct._1
        inline def fd_=(value: curl_socket_t): Unit = (!struct.at1 = value)
        inline def events : CShort = struct._2
        inline def events_=(value: CShort): Unit = (!struct.at2 = value)
        inline def revents : CShort = struct._3
        inline def revents_=(value: CShort): Unit = (!struct.at3 = value)
      end extension
    
    // Allocates curl_waitfd on the heap – fields are not initalised or zeroed out
  ...
  object curl_ws_frame:
    ...
    private[curl] object fields:
      extension (struct: curl_ws_frame)
        inline def age : CInt = struct._1
        inline def age_=(value: CInt): Unit = (!struct.at1 = value)
        inline def flags : CInt = struct._2
        inline def flags_=(value: CInt): Unit = (!struct.at2 = value)
        inline def offset : curl_off_t = struct._3
        inline def offset_=(value: curl_off_t): Unit = (!struct.at3 = value)
        inline def bytesleft : curl_off_t = struct._4
        inline def bytesleft_=(value: curl_off_t): Unit = (!struct.at4 = value)
        inline def len : size_t = struct._5
        inline def len_=(value: size_t): Unit = (!struct.at5 = value)
      end extension
    
    // Allocates curl_ws_frame on the heap – fields are not initalised or zeroed out
...
private[curl] object extern_functions:
  ...
  def Wcurl_easy_getinfo_err_curl_off_t(): Unit = extern

  def Wcurl_easy_getinfo_err_curl_slist(): Unit = extern

  def Wcurl_easy_getinfo_err_curl_socket(): Unit = extern

  def Wcurl_easy_getinfo_err_curl_tlssessioninfo(): Unit = extern

  def Wcurl_easy_getinfo_err_double(): Unit = extern

  def Wcurl_easy_getinfo_err_long(): Unit = extern

  def Wcurl_easy_getinfo_err_string(): Unit = extern

  def Wcurl_easy_setopt_err_CURLSH(): Unit = extern

  def Wcurl_easy_setopt_err_FILE(): Unit = extern

  def Wcurl_easy_setopt_err_cb_data(): Unit = extern

  def Wcurl_easy_setopt_err_chunk_bgn_cb(): Unit = extern

  def Wcurl_easy_setopt_err_chunk_end_cb(): Unit = extern

  def Wcurl_easy_setopt_err_close_socket_cb(): Unit = extern

  def Wcurl_easy_setopt_err_conv_cb(): Unit = extern

  def Wcurl_easy_setopt_err_curl(): Unit = extern

  def Wcurl_easy_setopt_err_curl_httpost(): Unit = extern

  def Wcurl_easy_setopt_err_curl_mimepost(): Unit = extern

  def Wcurl_easy_setopt_err_curl_off_t(): Unit = extern

  def Wcurl_easy_setopt_err_curl_slist(): Unit = extern

  def Wcurl_easy_setopt_err_curlu(): Unit = extern

  def Wcurl_easy_setopt_err_debug_cb(): Unit = extern

  def Wcurl_easy_setopt_err_error_buffer(): Unit = extern

  def Wcurl_easy_setopt_err_fnmatch_cb(): Unit = extern

  def Wcurl_easy_setopt_err_hstsread_cb(): Unit = extern

  def Wcurl_easy_setopt_err_hstswrite_cb(): Unit = extern

  def Wcurl_easy_setopt_err_interleave_cb(): Unit = extern

  def Wcurl_easy_setopt_err_ioctl_cb(): Unit = extern

  def Wcurl_easy_setopt_err_long(): Unit = extern

  def Wcurl_easy_setopt_err_opensocket_cb(): Unit = extern

  def Wcurl_easy_setopt_err_postfields(): Unit = extern

  def Wcurl_easy_setopt_err_prereq_cb(): Unit = extern

  def Wcurl_easy_setopt_err_progress_cb(): Unit = extern

  def Wcurl_easy_setopt_err_read_cb(): Unit = extern

  def Wcurl_easy_setopt_err_resolver_start_callback(): Unit = extern

  def Wcurl_easy_setopt_err_seek_cb(): Unit = extern

  def Wcurl_easy_setopt_err_sockopt_cb(): Unit = extern

  def Wcurl_easy_setopt_err_ssh_hostkey_cb(): Unit = extern

  def Wcurl_easy_setopt_err_ssh_key_cb(): Unit = extern

  def Wcurl_easy_setopt_err_ssl_ctx_cb(): Unit = extern

  def Wcurl_easy_setopt_err_string(): Unit = extern

  def Wcurl_easy_setopt_err_trailer_cb(): Unit = extern

  def Wcurl_easy_setopt_err_write_callback(): Unit = extern

  def Wcurl_easy_setopt_err_xferinfo_cb(): Unit = extern

  def Wcurl_multi_setopt_err_cb_data(): Unit = extern

  def Wcurl_multi_setopt_err_charpp(): Unit = extern

  def Wcurl_multi_setopt_err_curl_off_t(): Unit = extern

  def Wcurl_multi_setopt_err_long(): Unit = extern

  def Wcurl_multi_setopt_err_notifycb(): Unit = extern

  def Wcurl_multi_setopt_err_pushcb(): Unit = extern

  def Wcurl_multi_setopt_err_socketcb(): Unit = extern

  def Wcurl_multi_setopt_err_timercb(): Unit = extern
  ...
  def curl_easy_ssls_export(handle : Ptr[CURL], export_fn : Ptr[curl_ssls_export_cb], userptr : Ptr[Byte]): CURLcode = extern

  def curl_easy_ssls_import(handle : Ptr[CURL], session_key : CString, shmac : Ptr[CUnsignedChar], shmac_len : size_t, sdata : Ptr[CUnsignedChar], sdata_len : size_t): CURLcode = extern
  ...
  def curl_multi_get_offt(multi_handle : Ptr[CURLM], info : CURLMinfo_offt, pvalue : Ptr[curl_off_t]): CURLMcode = extern
  ...
  def curl_multi_notify_disable(multi : Ptr[CURLM], notification : CUnsignedInt): CURLMcode = extern

  def curl_multi_notify_enable(multi : Ptr[CURLM], notification : CUnsignedInt): CURLMcode = extern
  ...
  def curl_multi_waitfds(multi : Ptr[CURLM], ufds : Ptr[curl_waitfd], size : CUnsignedInt, fd_count : Ptr[CUnsignedInt]): CURLMcode = extern
  ...
  def curl_ws_start_frame(curl : Ptr[CURL], flags : CUnsignedInt, frame_len : curl_off_t): CURLcode = extern
...
object all:
  ...
  export _root_.curl.enumerations.CURLMinfo_offt
  ...
  export _root_.curl.aliases.Wcurl_chunk_bgn_callback1
  export _root_.curl.aliases.Wcurl_chunk_bgn_callback2
  export _root_.curl.aliases.Wcurl_conv_callback1
  export _root_.curl.aliases.Wcurl_conv_callback2
  export _root_.curl.aliases.Wcurl_conv_callback3
  export _root_.curl.aliases.Wcurl_conv_callback4
  export _root_.curl.aliases.Wcurl_debug_callback1
  export _root_.curl.aliases.Wcurl_debug_callback2
  export _root_.curl.aliases.Wcurl_debug_callback3
  export _root_.curl.aliases.Wcurl_debug_callback4
  export _root_.curl.aliases.Wcurl_debug_callback5
  export _root_.curl.aliases.Wcurl_debug_callback6
  export _root_.curl.aliases.Wcurl_debug_callback7
  export _root_.curl.aliases.Wcurl_debug_callback8
  export _root_.curl.aliases.Wcurl_interleave_callback1
  export _root_.curl.aliases.Wcurl_interleave_callback2
  export _root_.curl.aliases.Wcurl_ioctl_callback1
  export _root_.curl.aliases.Wcurl_ioctl_callback2
  export _root_.curl.aliases.Wcurl_ioctl_callback3
  export _root_.curl.aliases.Wcurl_ioctl_callback4
  export _root_.curl.aliases.Wcurl_opensocket_callback1
  export _root_.curl.aliases.Wcurl_opensocket_callback2
  export _root_.curl.aliases.Wcurl_opensocket_callback3
  export _root_.curl.aliases.Wcurl_opensocket_callback4
  export _root_.curl.aliases.Wcurl_progress_callback1
  export _root_.curl.aliases.Wcurl_progress_callback2
  export _root_.curl.aliases.Wcurl_read_callback1
  export _root_.curl.aliases.Wcurl_read_callback2
  export _root_.curl.aliases.Wcurl_read_callback3
  export _root_.curl.aliases.Wcurl_read_callback4
  export _root_.curl.aliases.Wcurl_read_callback5
  export _root_.curl.aliases.Wcurl_read_callback6
  export _root_.curl.aliases.Wcurl_seek_callback1
  export _root_.curl.aliases.Wcurl_seek_callback2
  export _root_.curl.aliases.Wcurl_sockopt_callback1
  export _root_.curl.aliases.Wcurl_sockopt_callback2
  export _root_.curl.aliases.Wcurl_ssl_ctx_callback1
  export _root_.curl.aliases.Wcurl_ssl_ctx_callback2
  export _root_.curl.aliases.Wcurl_ssl_ctx_callback3
  export _root_.curl.aliases.Wcurl_ssl_ctx_callback4
  export _root_.curl.aliases.Wcurl_ssl_ctx_callback5
  export _root_.curl.aliases.Wcurl_ssl_ctx_callback6
  export _root_.curl.aliases.Wcurl_ssl_ctx_callback7
  export _root_.curl.aliases.Wcurl_ssl_ctx_callback8
  export _root_.curl.aliases.Wcurl_write_callback1
  export _root_.curl.aliases.Wcurl_write_callback2
  export _root_.curl.aliases.Wcurl_write_callback3
  export _root_.curl.aliases.Wcurl_write_callback4
  export _root_.curl.aliases.Wcurl_write_callback5
  export _root_.curl.aliases.Wcurl_write_callback6
  ...
  export _root_.curl.aliases.curl_notify_callback
  ...
  export _root_.curl.aliases.curl_ssls_export_cb
  ...
  export _root_.curl.functions.Wcurl_easy_getinfo_err_curl_certinfo
  export _root_.curl.functions.Wcurl_easy_getinfo_err_curl_off_t
  export _root_.curl.functions.Wcurl_easy_getinfo_err_curl_slist
  export _root_.curl.functions.Wcurl_easy_getinfo_err_curl_socket
  export _root_.curl.functions.Wcurl_easy_getinfo_err_curl_tlssessioninfo
  export _root_.curl.functions.Wcurl_easy_getinfo_err_double
  export _root_.curl.functions.Wcurl_easy_getinfo_err_long
  export _root_.curl.functions.Wcurl_easy_getinfo_err_string
  export _root_.curl.functions.Wcurl_easy_setopt_err_CURLSH
  export _root_.curl.functions.Wcurl_easy_setopt_err_FILE
  export _root_.curl.functions.Wcurl_easy_setopt_err_cb_data
  export _root_.curl.functions.Wcurl_easy_setopt_err_chunk_bgn_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_chunk_end_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_close_socket_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_conv_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_curl
  export _root_.curl.functions.Wcurl_easy_setopt_err_curl_httpost
  export _root_.curl.functions.Wcurl_easy_setopt_err_curl_mimepost
  export _root_.curl.functions.Wcurl_easy_setopt_err_curl_off_t
  export _root_.curl.functions.Wcurl_easy_setopt_err_curl_slist
  export _root_.curl.functions.Wcurl_easy_setopt_err_curlu
  export _root_.curl.functions.Wcurl_easy_setopt_err_debug_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_error_buffer
  export _root_.curl.functions.Wcurl_easy_setopt_err_fnmatch_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_hstsread_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_hstswrite_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_interleave_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_ioctl_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_long
  export _root_.curl.functions.Wcurl_easy_setopt_err_opensocket_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_postfields
  export _root_.curl.functions.Wcurl_easy_setopt_err_prereq_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_progress_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_read_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_resolver_start_callback
  export _root_.curl.functions.Wcurl_easy_setopt_err_seek_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_sockopt_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_ssh_hostkey_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_ssh_key_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_ssl_ctx_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_string
  export _root_.curl.functions.Wcurl_easy_setopt_err_trailer_cb
  export _root_.curl.functions.Wcurl_easy_setopt_err_write_callback
  export _root_.curl.functions.Wcurl_easy_setopt_err_xferinfo_cb
  export _root_.curl.functions.Wcurl_multi_setopt_err_cb_data
  export _root_.curl.functions.Wcurl_multi_setopt_err_charpp
  export _root_.curl.functions.Wcurl_multi_setopt_err_curl_off_t
  export _root_.curl.functions.Wcurl_multi_setopt_err_long
  export _root_.curl.functions.Wcurl_multi_setopt_err_notifycb
  export _root_.curl.functions.Wcurl_multi_setopt_err_pushcb
  export _root_.curl.functions.Wcurl_multi_setopt_err_socketcb
  export _root_.curl.functions.Wcurl_multi_setopt_err_timercb
  ...
  export _root_.curl.functions.curl_easy_ssls_export
  export _root_.curl.functions.curl_easy_ssls_import
  ...
  export _root_.curl.functions.curl_multi_get_offt
  export _root_.curl.functions.curl_multi_info_read
  export _root_.curl.functions.curl_multi_init
  export _root_.curl.functions.curl_multi_notify_disable
  export _root_.curl.functions.curl_multi_notify_enable
  ...
  export _root_.curl.functions.curl_multi_waitfds
  ...
  export _root_.curl.functions.curl_ws_start_frame