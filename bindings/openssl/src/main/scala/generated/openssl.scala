...
object aliases:
  ...
  opaque type OPENSSL_sk_freefunc_thunk = CFuncPtr2[OPENSSL_sk_freefunc, Ptr[Byte], Unit]
  object OPENSSL_sk_freefunc_thunk:
    given _tag: Tag[OPENSSL_sk_freefunc_thunk] = Tag.materializeCFuncPtr2[OPENSSL_sk_freefunc, Ptr[Byte], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): OPENSSL_sk_freefunc_thunk = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr2[OPENSSL_sk_freefunc, Ptr[Byte], Unit]): OPENSSL_sk_freefunc_thunk = o
    extension (v: OPENSSL_sk_freefunc_thunk)
      inline def value: CFuncPtr2[OPENSSL_sk_freefunc, Ptr[Byte], Unit] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  ...
  opaque type OSSL_FUNC = CFuncPtr0[Unit]
  object OSSL_FUNC:
    given _tag: Tag[OSSL_FUNC] = Tag.materializeCFuncPtr0[Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): OSSL_FUNC = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr0[Unit]): OSSL_FUNC = o
    extension (v: OSSL_FUNC)
  ...
  type OSSL_FUNC_SSL_QUIC_TLS_alert_fn = CFuncPtr3[Ptr[SSL], CUnsignedChar, Ptr[Byte], CInt]
  object OSSL_FUNC_SSL_QUIC_TLS_alert_fn:
    given _tag: Tag[OSSL_FUNC_SSL_QUIC_TLS_alert_fn] = Tag.materializeCFuncPtr3[Ptr[SSL], CUnsignedChar, Ptr[Byte], CInt]
    inline def apply(inline o: CFuncPtr3[Ptr[SSL], CUnsignedChar, Ptr[Byte], CInt]): OSSL_FUNC_SSL_QUIC_TLS_alert_fn = o
    extension (v: OSSL_FUNC_SSL_QUIC_TLS_alert_fn)
      inline def value: CFuncPtr3[Ptr[SSL], CUnsignedChar, Ptr[Byte], CInt] = v

  type OSSL_FUNC_SSL_QUIC_TLS_crypto_recv_rcd_fn = CFuncPtr4[Ptr[SSL], Ptr[Ptr[CUnsignedChar]], Ptr[size_t], Ptr[Byte], CInt]
  object OSSL_FUNC_SSL_QUIC_TLS_crypto_recv_rcd_fn:
    given _tag: Tag[OSSL_FUNC_SSL_QUIC_TLS_crypto_recv_rcd_fn] = Tag.materializeCFuncPtr4[Ptr[SSL], Ptr[Ptr[CUnsignedChar]], Ptr[size_t], Ptr[Byte], CInt]
    inline def apply(inline o: CFuncPtr4[Ptr[SSL], Ptr[Ptr[CUnsignedChar]], Ptr[size_t], Ptr[Byte], CInt]): OSSL_FUNC_SSL_QUIC_TLS_crypto_recv_rcd_fn = o
    extension (v: OSSL_FUNC_SSL_QUIC_TLS_crypto_recv_rcd_fn)
      inline def value: CFuncPtr4[Ptr[SSL], Ptr[Ptr[CUnsignedChar]], Ptr[size_t], Ptr[Byte], CInt] = v

  type OSSL_FUNC_SSL_QUIC_TLS_crypto_release_rcd_fn = CFuncPtr3[Ptr[SSL], size_t, Ptr[Byte], CInt]
  object OSSL_FUNC_SSL_QUIC_TLS_crypto_release_rcd_fn:
    given _tag: Tag[OSSL_FUNC_SSL_QUIC_TLS_crypto_release_rcd_fn] = Tag.materializeCFuncPtr3[Ptr[SSL], size_t, Ptr[Byte], CInt]
    inline def apply(inline o: CFuncPtr3[Ptr[SSL], size_t, Ptr[Byte], CInt]): OSSL_FUNC_SSL_QUIC_TLS_crypto_release_rcd_fn = o
    extension (v: OSSL_FUNC_SSL_QUIC_TLS_crypto_release_rcd_fn)
      inline def value: CFuncPtr3[Ptr[SSL], size_t, Ptr[Byte], CInt] = v

  type OSSL_FUNC_SSL_QUIC_TLS_crypto_send_fn = CFuncPtr5[Ptr[SSL], Ptr[CUnsignedChar], size_t, Ptr[size_t], Ptr[Byte], CInt]
  object OSSL_FUNC_SSL_QUIC_TLS_crypto_send_fn:
    given _tag: Tag[OSSL_FUNC_SSL_QUIC_TLS_crypto_send_fn] = Tag.materializeCFuncPtr5[Ptr[SSL], Ptr[CUnsignedChar], size_t, Ptr[size_t], Ptr[Byte], CInt]
    inline def apply(inline o: CFuncPtr5[Ptr[SSL], Ptr[CUnsignedChar], size_t, Ptr[size_t], Ptr[Byte], CInt]): OSSL_FUNC_SSL_QUIC_TLS_crypto_send_fn = o
    extension (v: OSSL_FUNC_SSL_QUIC_TLS_crypto_send_fn)
      inline def value: CFuncPtr5[Ptr[SSL], Ptr[CUnsignedChar], size_t, Ptr[size_t], Ptr[Byte], CInt] = v

  type OSSL_FUNC_SSL_QUIC_TLS_got_transport_params_fn = CFuncPtr4[Ptr[SSL], Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
  object OSSL_FUNC_SSL_QUIC_TLS_got_transport_params_fn:
    given _tag: Tag[OSSL_FUNC_SSL_QUIC_TLS_got_transport_params_fn] = Tag.materializeCFuncPtr4[Ptr[SSL], Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
    inline def apply(inline o: CFuncPtr4[Ptr[SSL], Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]): OSSL_FUNC_SSL_QUIC_TLS_got_transport_params_fn = o
    extension (v: OSSL_FUNC_SSL_QUIC_TLS_got_transport_params_fn)
      inline def value: CFuncPtr4[Ptr[SSL], Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt] = v

  type OSSL_FUNC_SSL_QUIC_TLS_yield_secret_fn = CFuncPtr6[Ptr[SSL], uint32_t, CInt, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
  object OSSL_FUNC_SSL_QUIC_TLS_yield_secret_fn:
    given _tag: Tag[OSSL_FUNC_SSL_QUIC_TLS_yield_secret_fn] = Tag.materializeCFuncPtr6[Ptr[SSL], uint32_t, CInt, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]
    inline def apply(inline o: CFuncPtr6[Ptr[SSL], uint32_t, CInt, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt]): OSSL_FUNC_SSL_QUIC_TLS_yield_secret_fn = o
    extension (v: OSSL_FUNC_SSL_QUIC_TLS_yield_secret_fn)
      inline def value: CFuncPtr6[Ptr[SSL], uint32_t, CInt, Ptr[CUnsignedChar], size_t, Ptr[Byte], CInt] = v
  ...
  type OSSL_FUNC_cipher_decrypt_skey_init_fn = CFuncPtr5[Ptr[Byte], Ptr[Byte], Ptr[CUnsignedChar], size_t, Ptr[OSSL_PARAM], CInt]
  object OSSL_FUNC_cipher_decrypt_skey_init_fn:
    given _tag: Tag[OSSL_FUNC_cipher_decrypt_skey_init_fn] = Tag.materializeCFuncPtr5[Ptr[Byte], Ptr[Byte], Ptr[CUnsignedChar], size_t, Ptr[OSSL_PARAM], CInt]
    inline def apply(inline o: CFuncPtr5[Ptr[Byte], Ptr[Byte], Ptr[CUnsignedChar], size_t, Ptr[OSSL_PARAM], CInt]): OSSL_FUNC_cipher_decrypt_skey_init_fn = o
    extension (v: OSSL_FUNC_cipher_decrypt_skey_init_fn)
      inline def value: CFuncPtr5[Ptr[Byte], Ptr[Byte], Ptr[CUnsignedChar], size_t, Ptr[OSSL_PARAM], CInt] = v
  ...
  type OSSL_FUNC_cipher_encrypt_skey_init_fn = CFuncPtr5[Ptr[Byte], Ptr[Byte], Ptr[CUnsignedChar], size_t, Ptr[OSSL_PARAM], CInt]
  object OSSL_FUNC_cipher_encrypt_skey_init_fn:
    given _tag: Tag[OSSL_FUNC_cipher_encrypt_skey_init_fn] = Tag.materializeCFuncPtr5[Ptr[Byte], Ptr[Byte], Ptr[CUnsignedChar], size_t, Ptr[OSSL_PARAM], CInt]
    inline def apply(inline o: CFuncPtr5[Ptr[Byte], Ptr[Byte], Ptr[CUnsignedChar], size_t, Ptr[OSSL_PARAM], CInt]): OSSL_FUNC_cipher_encrypt_skey_init_fn = o
    extension (v: OSSL_FUNC_cipher_encrypt_skey_init_fn)
      inline def value: CFuncPtr5[Ptr[Byte], Ptr[Byte], Ptr[CUnsignedChar], size_t, Ptr[OSSL_PARAM], CInt] = v
  ...
  type OSSL_FUNC_cipher_pipeline_decrypt_init_fn = CFuncPtr7[Ptr[Byte], Ptr[CUnsignedChar], size_t, size_t, Ptr[Ptr[CUnsignedChar]], size_t, Ptr[OSSL_PARAM], CInt]
  object OSSL_FUNC_cipher_pipeline_decrypt_init_fn:
    given _tag: Tag[OSSL_FUNC_cipher_pipeline_decrypt_init_fn] = Tag.materializeCFuncPtr7[Ptr[Byte], Ptr[CUnsignedChar], size_t, size_t, Ptr[Ptr[CUnsignedChar]], size_t, Ptr[OSSL_PARAM], CInt]
    inline def apply(inline o: CFuncPtr7[Ptr[Byte], Ptr[CUnsignedChar], size_t, size_t, Ptr[Ptr[CUnsignedChar]], size_t, Ptr[OSSL_PARAM], CInt]): OSSL_FUNC_cipher_pipeline_decrypt_init_fn = o
    extension (v: OSSL_FUNC_cipher_pipeline_decrypt_init_fn)
      inline def value: CFuncPtr7[Ptr[Byte], Ptr[CUnsignedChar], size_t, size_t, Ptr[Ptr[CUnsignedChar]], size_t, Ptr[OSSL_PARAM], CInt] = v

  type OSSL_FUNC_cipher_pipeline_encrypt_init_fn = CFuncPtr7[Ptr[Byte], Ptr[CUnsignedChar], size_t, size_t, Ptr[Ptr[CUnsignedChar]], size_t, Ptr[OSSL_PARAM], CInt]
  object OSSL_FUNC_cipher_pipeline_encrypt_init_fn:
    given _tag: Tag[OSSL_FUNC_cipher_pipeline_encrypt_init_fn] = Tag.materializeCFuncPtr7[Ptr[Byte], Ptr[CUnsignedChar], size_t, size_t, Ptr[Ptr[CUnsignedChar]], size_t, Ptr[OSSL_PARAM], CInt]
    inline def apply(inline o: CFuncPtr7[Ptr[Byte], Ptr[CUnsignedChar], size_t, size_t, Ptr[Ptr[CUnsignedChar]], size_t, Ptr[OSSL_PARAM], CInt]): OSSL_FUNC_cipher_pipeline_encrypt_init_fn = o
    extension (v: OSSL_FUNC_cipher_pipeline_encrypt_init_fn)
      inline def value: CFuncPtr7[Ptr[Byte], Ptr[CUnsignedChar], size_t, size_t, Ptr[Ptr[CUnsignedChar]], size_t, Ptr[OSSL_PARAM], CInt] = v

  type OSSL_FUNC_cipher_pipeline_final_fn = CFuncPtr5[Ptr[Byte], size_t, Ptr[Ptr[CUnsignedChar]], Ptr[size_t], Ptr[size_t], CInt]
  object OSSL_FUNC_cipher_pipeline_final_fn:
    given _tag: Tag[OSSL_FUNC_cipher_pipeline_final_fn] = Tag.materializeCFuncPtr5[Ptr[Byte], size_t, Ptr[Ptr[CUnsignedChar]], Ptr[size_t], Ptr[size_t], CInt]
    inline def apply(inline o: CFuncPtr5[Ptr[Byte], size_t, Ptr[Ptr[CUnsignedChar]], Ptr[size_t], Ptr[size_t], CInt]): OSSL_FUNC_cipher_pipeline_final_fn = o
    extension (v: OSSL_FUNC_cipher_pipeline_final_fn)
      inline def value: CFuncPtr5[Ptr[Byte], size_t, Ptr[Ptr[CUnsignedChar]], Ptr[size_t], Ptr[size_t], CInt] = v

  type OSSL_FUNC_cipher_pipeline_update_fn = CFuncPtr7[Ptr[Byte], size_t, Ptr[Ptr[CUnsignedChar]], Ptr[size_t], Ptr[size_t], Ptr[Ptr[CUnsignedChar]], Ptr[size_t], CInt]
  object OSSL_FUNC_cipher_pipeline_update_fn:
    given _tag: Tag[OSSL_FUNC_cipher_pipeline_update_fn] = Tag.materializeCFuncPtr7[Ptr[Byte], size_t, Ptr[Ptr[CUnsignedChar]], Ptr[size_t], Ptr[size_t], Ptr[Ptr[CUnsignedChar]], Ptr[size_t], CInt]
    inline def apply(inline o: CFuncPtr7[Ptr[Byte], size_t, Ptr[Ptr[CUnsignedChar]], Ptr[size_t], Ptr[size_t], Ptr[Ptr[CUnsignedChar]], Ptr[size_t], CInt]): OSSL_FUNC_cipher_pipeline_update_fn = o
    extension (v: OSSL_FUNC_cipher_pipeline_update_fn)
      inline def value: CFuncPtr7[Ptr[Byte], size_t, Ptr[Ptr[CUnsignedChar]], Ptr[size_t], Ptr[size_t], Ptr[Ptr[CUnsignedChar]], Ptr[size_t], CInt] = v
  ...
  type OSSL_FUNC_cleanup_user_entropy_fn = CFuncPtr3[Ptr[OSSL_CORE_HANDLE], Ptr[CUnsignedChar], size_t, Unit]
  object OSSL_FUNC_cleanup_user_entropy_fn:
    given _tag: Tag[OSSL_FUNC_cleanup_user_entropy_fn] = Tag.materializeCFuncPtr3[Ptr[OSSL_CORE_HANDLE], Ptr[CUnsignedChar], size_t, Unit]
    inline def apply(inline o: CFuncPtr3[Ptr[OSSL_CORE_HANDLE], Ptr[CUnsignedChar], size_t, Unit]): OSSL_FUNC_cleanup_user_entropy_fn = o
    extension (v: OSSL_FUNC_cleanup_user_entropy_fn)
      inline def value: CFuncPtr3[Ptr[OSSL_CORE_HANDLE], Ptr[CUnsignedChar], size_t, Unit] = v

  type OSSL_FUNC_cleanup_user_nonce_fn = CFuncPtr3[Ptr[OSSL_CORE_HANDLE], Ptr[CUnsignedChar], size_t, Unit]
  object OSSL_FUNC_cleanup_user_nonce_fn:
    given _tag: Tag[OSSL_FUNC_cleanup_user_nonce_fn] = Tag.materializeCFuncPtr3[Ptr[OSSL_CORE_HANDLE], Ptr[CUnsignedChar], size_t, Unit]
    inline def apply(inline o: CFuncPtr3[Ptr[OSSL_CORE_HANDLE], Ptr[CUnsignedChar], size_t, Unit]): OSSL_FUNC_cleanup_user_nonce_fn = o
    extension (v: OSSL_FUNC_cleanup_user_nonce_fn)
      inline def value: CFuncPtr3[Ptr[OSSL_CORE_HANDLE], Ptr[CUnsignedChar], size_t, Unit] = v
  ...
  type OSSL_FUNC_core_count_to_mark_fn = CFuncPtr1[Ptr[OSSL_CORE_HANDLE], CInt]
  object OSSL_FUNC_core_count_to_mark_fn:
    given _tag: Tag[OSSL_FUNC_core_count_to_mark_fn] = Tag.materializeCFuncPtr1[Ptr[OSSL_CORE_HANDLE], CInt]
    inline def apply(inline o: CFuncPtr1[Ptr[OSSL_CORE_HANDLE], CInt]): OSSL_FUNC_core_count_to_mark_fn = o
    extension (v: OSSL_FUNC_core_count_to_mark_fn)
      inline def value: CFuncPtr1[Ptr[OSSL_CORE_HANDLE], CInt] = v
  ...
  type OSSL_FUNC_digest_copyctx_fn = CFuncPtr2[Ptr[Byte], Ptr[Byte], Unit]
  object OSSL_FUNC_digest_copyctx_fn:
    given _tag: Tag[OSSL_FUNC_digest_copyctx_fn] = Tag.materializeCFuncPtr2[Ptr[Byte], Ptr[Byte], Unit]
    inline def apply(inline o: CFuncPtr2[Ptr[Byte], Ptr[Byte], Unit]): OSSL_FUNC_digest_copyctx_fn = o
    extension (v: OSSL_FUNC_digest_copyctx_fn)
  ...
  type OSSL_FUNC_digest_squeeze_fn = CFuncPtr4[Ptr[Byte], Ptr[CUnsignedChar], Ptr[size_t], size_t, CInt]
  object OSSL_FUNC_digest_squeeze_fn:
    given _tag: Tag[OSSL_FUNC_digest_squeeze_fn] = Tag.materializeCFuncPtr4[Ptr[Byte], Ptr[CUnsignedChar], Ptr[size_t], size_t, CInt]
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], Ptr[CUnsignedChar], Ptr[size_t], size_t, CInt]): OSSL_FUNC_digest_squeeze_fn = o
    extension (v: OSSL_FUNC_digest_squeeze_fn)
      inline def value: CFuncPtr4[Ptr[Byte], Ptr[CUnsignedChar], Ptr[size_t], size_t, CInt] = v
  ...
  type OSSL_FUNC_get_user_entropy_fn = CFuncPtr5[Ptr[OSSL_CORE_HANDLE], Ptr[Ptr[CUnsignedChar]], CInt, size_t, size_t, size_t]
  object OSSL_FUNC_get_user_entropy_fn:
    given _tag: Tag[OSSL_FUNC_get_user_entropy_fn] = Tag.materializeCFuncPtr5[Ptr[OSSL_CORE_HANDLE], Ptr[Ptr[CUnsignedChar]], CInt, size_t, size_t, size_t]
    inline def apply(inline o: CFuncPtr5[Ptr[OSSL_CORE_HANDLE], Ptr[Ptr[CUnsignedChar]], CInt, size_t, size_t, size_t]): OSSL_FUNC_get_user_entropy_fn = o
    extension (v: OSSL_FUNC_get_user_entropy_fn)
      inline def value: CFuncPtr5[Ptr[OSSL_CORE_HANDLE], Ptr[Ptr[CUnsignedChar]], CInt, size_t, size_t, size_t] = v

  type OSSL_FUNC_get_user_nonce_fn = CFuncPtr6[Ptr[OSSL_CORE_HANDLE], Ptr[Ptr[CUnsignedChar]], size_t, size_t, Ptr[Byte], size_t, size_t]
  object OSSL_FUNC_get_user_nonce_fn:
    given _tag: Tag[OSSL_FUNC_get_user_nonce_fn] = Tag.materializeCFuncPtr6[Ptr[OSSL_CORE_HANDLE], Ptr[Ptr[CUnsignedChar]], size_t, size_t, Ptr[Byte], size_t, size_t]
    inline def apply(inline o: CFuncPtr6[Ptr[OSSL_CORE_HANDLE], Ptr[Ptr[CUnsignedChar]], size_t, size_t, Ptr[Byte], size_t, size_t]): OSSL_FUNC_get_user_nonce_fn = o
    extension (v: OSSL_FUNC_get_user_nonce_fn)
      inline def value: CFuncPtr6[Ptr[OSSL_CORE_HANDLE], Ptr[Ptr[CUnsignedChar]], size_t, size_t, Ptr[Byte], size_t, size_t] = v

  type OSSL_FUNC_indicator_cb_fn = CFuncPtr2[Ptr[OPENSSL_CORE_CTX], Ptr[Ptr[OSSL_INDICATOR_CALLBACK]], Unit]
  object OSSL_FUNC_indicator_cb_fn:
    given _tag: Tag[OSSL_FUNC_indicator_cb_fn] = Tag.materializeCFuncPtr2[Ptr[OPENSSL_CORE_CTX], Ptr[Ptr[OSSL_INDICATOR_CALLBACK]], Unit]
    inline def apply(inline o: CFuncPtr2[Ptr[OPENSSL_CORE_CTX], Ptr[Ptr[OSSL_INDICATOR_CALLBACK]], Unit]): OSSL_FUNC_indicator_cb_fn = o
    extension (v: OSSL_FUNC_indicator_cb_fn)
      inline def value: CFuncPtr2[Ptr[OPENSSL_CORE_CTX], Ptr[Ptr[OSSL_INDICATOR_CALLBACK]], Unit] = v
  ...
  type OSSL_FUNC_kdf_derive_skey_fn = CFuncPtr6[Ptr[Byte], CString, Ptr[Byte], Ptr[OSSL_FUNC_skeymgmt_import_fn], size_t, Ptr[OSSL_PARAM], Ptr[Byte]]
  object OSSL_FUNC_kdf_derive_skey_fn:
    given _tag: Tag[OSSL_FUNC_kdf_derive_skey_fn] = Tag.materializeCFuncPtr6[Ptr[Byte], CString, Ptr[Byte], Ptr[OSSL_FUNC_skeymgmt_import_fn], size_t, Ptr[OSSL_PARAM], Ptr[Byte]]
    inline def apply(inline o: CFuncPtr6[Ptr[Byte], CString, Ptr[Byte], Ptr[OSSL_FUNC_skeymgmt_import_fn], size_t, Ptr[OSSL_PARAM], Ptr[Byte]]): OSSL_FUNC_kdf_derive_skey_fn = o
    extension (v: OSSL_FUNC_kdf_derive_skey_fn)
      inline def value: CFuncPtr6[Ptr[Byte], CString, Ptr[Byte], Ptr[OSSL_FUNC_skeymgmt_import_fn], size_t, Ptr[OSSL_PARAM], Ptr[Byte]] = v
  ...
  type OSSL_FUNC_kdf_set_skey_fn = CFuncPtr3[Ptr[Byte], Ptr[Byte], CString, CInt]
  object OSSL_FUNC_kdf_set_skey_fn:
    given _tag: Tag[OSSL_FUNC_kdf_set_skey_fn] = Tag.materializeCFuncPtr3[Ptr[Byte], Ptr[Byte], CString, CInt]
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], Ptr[Byte], CString, CInt]): OSSL_FUNC_kdf_set_skey_fn = o
    extension (v: OSSL_FUNC_kdf_set_skey_fn)
      inline def value: CFuncPtr3[Ptr[Byte], Ptr[Byte], CString, CInt] = v
  ...
  type OSSL_FUNC_kem_auth_decapsulate_init_fn = CFuncPtr4[Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt]
  object OSSL_FUNC_kem_auth_decapsulate_init_fn:
    given _tag: Tag[OSSL_FUNC_kem_auth_decapsulate_init_fn] = Tag.materializeCFuncPtr4[Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt]
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt]): OSSL_FUNC_kem_auth_decapsulate_init_fn = o
    extension (v: OSSL_FUNC_kem_auth_decapsulate_init_fn)
      inline def value: CFuncPtr4[Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt] = v

  type OSSL_FUNC_kem_auth_encapsulate_init_fn = CFuncPtr4[Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt]
  object OSSL_FUNC_kem_auth_encapsulate_init_fn:
    given _tag: Tag[OSSL_FUNC_kem_auth_encapsulate_init_fn] = Tag.materializeCFuncPtr4[Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt]
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt]): OSSL_FUNC_kem_auth_encapsulate_init_fn = o
    extension (v: OSSL_FUNC_kem_auth_encapsulate_init_fn)
      inline def value: CFuncPtr4[Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt] = v
  ...
  type OSSL_FUNC_keyexch_derive_skey_fn = CFuncPtr6[Ptr[Byte], CString, Ptr[Byte], Ptr[OSSL_FUNC_skeymgmt_import_fn], size_t, Ptr[OSSL_PARAM], Ptr[Byte]]
  object OSSL_FUNC_keyexch_derive_skey_fn:
    given _tag: Tag[OSSL_FUNC_keyexch_derive_skey_fn] = Tag.materializeCFuncPtr6[Ptr[Byte], CString, Ptr[Byte], Ptr[OSSL_FUNC_skeymgmt_import_fn], size_t, Ptr[OSSL_PARAM], Ptr[Byte]]
    inline def apply(inline o: CFuncPtr6[Ptr[Byte], CString, Ptr[Byte], Ptr[OSSL_FUNC_skeymgmt_import_fn], size_t, Ptr[OSSL_PARAM], Ptr[Byte]]): OSSL_FUNC_keyexch_derive_skey_fn = o
    extension (v: OSSL_FUNC_keyexch_derive_skey_fn)
      inline def value: CFuncPtr6[Ptr[Byte], CString, Ptr[Byte], Ptr[OSSL_FUNC_skeymgmt_import_fn], size_t, Ptr[OSSL_PARAM], Ptr[Byte]] = v
  ...
  type OSSL_FUNC_keymgmt_export_types_ex_fn = CFuncPtr2[Ptr[Byte], CInt, Ptr[OSSL_PARAM]]
  object OSSL_FUNC_keymgmt_export_types_ex_fn:
    given _tag: Tag[OSSL_FUNC_keymgmt_export_types_ex_fn] = Tag.materializeCFuncPtr2[Ptr[Byte], CInt, Ptr[OSSL_PARAM]]
    inline def apply(inline o: CFuncPtr2[Ptr[Byte], CInt, Ptr[OSSL_PARAM]]): OSSL_FUNC_keymgmt_export_types_ex_fn = o
    extension (v: OSSL_FUNC_keymgmt_export_types_ex_fn)
      inline def value: CFuncPtr2[Ptr[Byte], CInt, Ptr[OSSL_PARAM]] = v
  ...
  type OSSL_FUNC_keymgmt_gen_get_params_fn = CFuncPtr2[Ptr[Byte], Ptr[OSSL_PARAM], CInt]
  object OSSL_FUNC_keymgmt_gen_get_params_fn:
    given _tag: Tag[OSSL_FUNC_keymgmt_gen_get_params_fn] = Tag.materializeCFuncPtr2[Ptr[Byte], Ptr[OSSL_PARAM], CInt]
    inline def apply(inline o: CFuncPtr2[Ptr[Byte], Ptr[OSSL_PARAM], CInt]): OSSL_FUNC_keymgmt_gen_get_params_fn = o
    extension (v: OSSL_FUNC_keymgmt_gen_get_params_fn)
      inline def value: CFuncPtr2[Ptr[Byte], Ptr[OSSL_PARAM], CInt] = v

  type OSSL_FUNC_keymgmt_gen_gettable_params_fn = CFuncPtr2[Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM]]
  object OSSL_FUNC_keymgmt_gen_gettable_params_fn:
    given _tag: Tag[OSSL_FUNC_keymgmt_gen_gettable_params_fn] = Tag.materializeCFuncPtr2[Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM]]
    inline def apply(inline o: CFuncPtr2[Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM]]): OSSL_FUNC_keymgmt_gen_gettable_params_fn = o
    extension (v: OSSL_FUNC_keymgmt_gen_gettable_params_fn)
      inline def value: CFuncPtr2[Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM]] = v
  ...
  type OSSL_FUNC_keymgmt_import_types_ex_fn = CFuncPtr2[Ptr[Byte], CInt, Ptr[OSSL_PARAM]]
  object OSSL_FUNC_keymgmt_import_types_ex_fn:
    given _tag: Tag[OSSL_FUNC_keymgmt_import_types_ex_fn] = Tag.materializeCFuncPtr2[Ptr[Byte], CInt, Ptr[OSSL_PARAM]]
    inline def apply(inline o: CFuncPtr2[Ptr[Byte], CInt, Ptr[OSSL_PARAM]]): OSSL_FUNC_keymgmt_import_types_ex_fn = o
    extension (v: OSSL_FUNC_keymgmt_import_types_ex_fn)
      inline def value: CFuncPtr2[Ptr[Byte], CInt, Ptr[OSSL_PARAM]] = v
  ...
  type OSSL_FUNC_mac_init_skey_fn = CFuncPtr3[Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt]
  object OSSL_FUNC_mac_init_skey_fn:
    given _tag: Tag[OSSL_FUNC_mac_init_skey_fn] = Tag.materializeCFuncPtr3[Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt]
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt]): OSSL_FUNC_mac_init_skey_fn = o
    extension (v: OSSL_FUNC_mac_init_skey_fn)
      inline def value: CFuncPtr3[Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt] = v
  ...
  type OSSL_FUNC_provider_random_bytes_fn = CFuncPtr5[Ptr[Byte], CInt, Ptr[Byte], size_t, CUnsignedInt, CInt]
  object OSSL_FUNC_provider_random_bytes_fn:
    given _tag: Tag[OSSL_FUNC_provider_random_bytes_fn] = Tag.materializeCFuncPtr5[Ptr[Byte], CInt, Ptr[Byte], size_t, CUnsignedInt, CInt]
    inline def apply(inline o: CFuncPtr5[Ptr[Byte], CInt, Ptr[Byte], size_t, CUnsignedInt, CInt]): OSSL_FUNC_provider_random_bytes_fn = o
    extension (v: OSSL_FUNC_provider_random_bytes_fn)
      inline def value: CFuncPtr5[Ptr[Byte], CInt, Ptr[Byte], size_t, CUnsignedInt, CInt] = v
  ...
  type OSSL_FUNC_signature_query_key_types_fn = CFuncPtr0[Ptr[CString]]
  object OSSL_FUNC_signature_query_key_types_fn:
    given _tag: Tag[OSSL_FUNC_signature_query_key_types_fn] = Tag.materializeCFuncPtr0[Ptr[CString]]
    inline def apply(inline o: CFuncPtr0[Ptr[CString]]): OSSL_FUNC_signature_query_key_types_fn = o
    extension (v: OSSL_FUNC_signature_query_key_types_fn)
      inline def value: CFuncPtr0[Ptr[CString]] = v
  ...
  type OSSL_FUNC_signature_sign_message_final_fn = CFuncPtr4[Ptr[Byte], Ptr[CUnsignedChar], Ptr[size_t], size_t, CInt]
  object OSSL_FUNC_signature_sign_message_final_fn:
    given _tag: Tag[OSSL_FUNC_signature_sign_message_final_fn] = Tag.materializeCFuncPtr4[Ptr[Byte], Ptr[CUnsignedChar], Ptr[size_t], size_t, CInt]
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], Ptr[CUnsignedChar], Ptr[size_t], size_t, CInt]): OSSL_FUNC_signature_sign_message_final_fn = o
    extension (v: OSSL_FUNC_signature_sign_message_final_fn)
      inline def value: CFuncPtr4[Ptr[Byte], Ptr[CUnsignedChar], Ptr[size_t], size_t, CInt] = v

  type OSSL_FUNC_signature_sign_message_init_fn = CFuncPtr3[Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt]
  object OSSL_FUNC_signature_sign_message_init_fn:
    given _tag: Tag[OSSL_FUNC_signature_sign_message_init_fn] = Tag.materializeCFuncPtr3[Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt]
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt]): OSSL_FUNC_signature_sign_message_init_fn = o
    extension (v: OSSL_FUNC_signature_sign_message_init_fn)
      inline def value: CFuncPtr3[Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt] = v

  type OSSL_FUNC_signature_sign_message_update_fn = CFuncPtr3[Ptr[Byte], Ptr[CUnsignedChar], size_t, CInt]
  object OSSL_FUNC_signature_sign_message_update_fn:
    given _tag: Tag[OSSL_FUNC_signature_sign_message_update_fn] = Tag.materializeCFuncPtr3[Ptr[Byte], Ptr[CUnsignedChar], size_t, CInt]
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], Ptr[CUnsignedChar], size_t, CInt]): OSSL_FUNC_signature_sign_message_update_fn = o
    extension (v: OSSL_FUNC_signature_sign_message_update_fn)
      inline def value: CFuncPtr3[Ptr[Byte], Ptr[CUnsignedChar], size_t, CInt] = v
  ...
  type OSSL_FUNC_signature_verify_message_final_fn = CFuncPtr1[Ptr[Byte], CInt]
  object OSSL_FUNC_signature_verify_message_final_fn:
    given _tag: Tag[OSSL_FUNC_signature_verify_message_final_fn] = Tag.materializeCFuncPtr1[Ptr[Byte], CInt]
    inline def apply(inline o: CFuncPtr1[Ptr[Byte], CInt]): OSSL_FUNC_signature_verify_message_final_fn = o
    extension (v: OSSL_FUNC_signature_verify_message_final_fn)
      inline def value: CFuncPtr1[Ptr[Byte], CInt] = v

  type OSSL_FUNC_signature_verify_message_init_fn = CFuncPtr3[Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt]
  object OSSL_FUNC_signature_verify_message_init_fn:
    given _tag: Tag[OSSL_FUNC_signature_verify_message_init_fn] = Tag.materializeCFuncPtr3[Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt]
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt]): OSSL_FUNC_signature_verify_message_init_fn = o
    extension (v: OSSL_FUNC_signature_verify_message_init_fn)
      inline def value: CFuncPtr3[Ptr[Byte], Ptr[Byte], Ptr[OSSL_PARAM], CInt] = v

  type OSSL_FUNC_signature_verify_message_update_fn = CFuncPtr3[Ptr[Byte], Ptr[CUnsignedChar], size_t, CInt]
  object OSSL_FUNC_signature_verify_message_update_fn:
    given _tag: Tag[OSSL_FUNC_signature_verify_message_update_fn] = Tag.materializeCFuncPtr3[Ptr[Byte], Ptr[CUnsignedChar], size_t, CInt]
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], Ptr[CUnsignedChar], size_t, CInt]): OSSL_FUNC_signature_verify_message_update_fn = o
    extension (v: OSSL_FUNC_signature_verify_message_update_fn)
      inline def value: CFuncPtr3[Ptr[Byte], Ptr[CUnsignedChar], size_t, CInt] = v
  ...
  type OSSL_FUNC_skeymgmt_export_fn = CFuncPtr4[Ptr[Byte], CInt, Ptr[OSSL_CALLBACK], Ptr[Byte], CInt]
  object OSSL_FUNC_skeymgmt_export_fn:
    given _tag: Tag[OSSL_FUNC_skeymgmt_export_fn] = Tag.materializeCFuncPtr4[Ptr[Byte], CInt, Ptr[OSSL_CALLBACK], Ptr[Byte], CInt]
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], CInt, Ptr[OSSL_CALLBACK], Ptr[Byte], CInt]): OSSL_FUNC_skeymgmt_export_fn = o
    extension (v: OSSL_FUNC_skeymgmt_export_fn)
      inline def value: CFuncPtr4[Ptr[Byte], CInt, Ptr[OSSL_CALLBACK], Ptr[Byte], CInt] = v

  type OSSL_FUNC_skeymgmt_free_fn = CFuncPtr1[Ptr[Byte], Unit]
  object OSSL_FUNC_skeymgmt_free_fn:
    given _tag: Tag[OSSL_FUNC_skeymgmt_free_fn] = Tag.materializeCFuncPtr1[Ptr[Byte], Unit]
    inline def apply(inline o: CFuncPtr1[Ptr[Byte], Unit]): OSSL_FUNC_skeymgmt_free_fn = o
    extension (v: OSSL_FUNC_skeymgmt_free_fn)
      inline def value: CFuncPtr1[Ptr[Byte], Unit] = v

  type OSSL_FUNC_skeymgmt_gen_settable_params_fn = CFuncPtr1[Ptr[Byte], Ptr[OSSL_PARAM]]
  object OSSL_FUNC_skeymgmt_gen_settable_params_fn:
    given _tag: Tag[OSSL_FUNC_skeymgmt_gen_settable_params_fn] = Tag.materializeCFuncPtr1[Ptr[Byte], Ptr[OSSL_PARAM]]
    inline def apply(inline o: CFuncPtr1[Ptr[Byte], Ptr[OSSL_PARAM]]): OSSL_FUNC_skeymgmt_gen_settable_params_fn = o
    extension (v: OSSL_FUNC_skeymgmt_gen_settable_params_fn)
      inline def value: CFuncPtr1[Ptr[Byte], Ptr[OSSL_PARAM]] = v

  type OSSL_FUNC_skeymgmt_generate_fn = CFuncPtr2[Ptr[Byte], Ptr[OSSL_PARAM], Ptr[Byte]]
  object OSSL_FUNC_skeymgmt_generate_fn:
    given _tag: Tag[OSSL_FUNC_skeymgmt_generate_fn] = Tag.materializeCFuncPtr2[Ptr[Byte], Ptr[OSSL_PARAM], Ptr[Byte]]
    inline def apply(inline o: CFuncPtr2[Ptr[Byte], Ptr[OSSL_PARAM], Ptr[Byte]]): OSSL_FUNC_skeymgmt_generate_fn = o
    extension (v: OSSL_FUNC_skeymgmt_generate_fn)
      inline def value: CFuncPtr2[Ptr[Byte], Ptr[OSSL_PARAM], Ptr[Byte]] = v

  type OSSL_FUNC_skeymgmt_get_key_id_fn = CFuncPtr1[Ptr[Byte], CString]
  object OSSL_FUNC_skeymgmt_get_key_id_fn:
    given _tag: Tag[OSSL_FUNC_skeymgmt_get_key_id_fn] = Tag.materializeCFuncPtr1[Ptr[Byte], CString]
    inline def apply(inline o: CFuncPtr1[Ptr[Byte], CString]): OSSL_FUNC_skeymgmt_get_key_id_fn = o
    extension (v: OSSL_FUNC_skeymgmt_get_key_id_fn)
      inline def value: CFuncPtr1[Ptr[Byte], CString] = v

  type OSSL_FUNC_skeymgmt_imp_settable_params_fn = CFuncPtr1[Ptr[Byte], Ptr[OSSL_PARAM]]
  object OSSL_FUNC_skeymgmt_imp_settable_params_fn:
    given _tag: Tag[OSSL_FUNC_skeymgmt_imp_settable_params_fn] = Tag.materializeCFuncPtr1[Ptr[Byte], Ptr[OSSL_PARAM]]
    inline def apply(inline o: CFuncPtr1[Ptr[Byte], Ptr[OSSL_PARAM]]): OSSL_FUNC_skeymgmt_imp_settable_params_fn = o
    extension (v: OSSL_FUNC_skeymgmt_imp_settable_params_fn)
      inline def value: CFuncPtr1[Ptr[Byte], Ptr[OSSL_PARAM]] = v

  type OSSL_FUNC_skeymgmt_import_fn = CFuncPtr3[Ptr[Byte], CInt, Ptr[OSSL_PARAM], Ptr[Byte]]
  object OSSL_FUNC_skeymgmt_import_fn:
    given _tag: Tag[OSSL_FUNC_skeymgmt_import_fn] = Tag.materializeCFuncPtr3[Ptr[Byte], CInt, Ptr[OSSL_PARAM], Ptr[Byte]]
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], CInt, Ptr[OSSL_PARAM], Ptr[Byte]]): OSSL_FUNC_skeymgmt_import_fn = o
    extension (v: OSSL_FUNC_skeymgmt_import_fn)
      inline def value: CFuncPtr3[Ptr[Byte], CInt, Ptr[OSSL_PARAM], Ptr[Byte]] = v
  ...
  type OSSL_FUNC_store_delete_fn = CFuncPtr5[Ptr[Byte], CString, Ptr[OSSL_PARAM], Ptr[OSSL_PASSPHRASE_CALLBACK], Ptr[Byte], CInt]
  object OSSL_FUNC_store_delete_fn:
    given _tag: Tag[OSSL_FUNC_store_delete_fn] = Tag.materializeCFuncPtr5[Ptr[Byte], CString, Ptr[OSSL_PARAM], Ptr[OSSL_PASSPHRASE_CALLBACK], Ptr[Byte], CInt]
    inline def apply(inline o: CFuncPtr5[Ptr[Byte], CString, Ptr[OSSL_PARAM], Ptr[OSSL_PASSPHRASE_CALLBACK], Ptr[Byte], CInt]): OSSL_FUNC_store_delete_fn = o
    extension (v: OSSL_FUNC_store_delete_fn)
      inline def value: CFuncPtr5[Ptr[Byte], CString, Ptr[OSSL_PARAM], Ptr[OSSL_PASSPHRASE_CALLBACK], Ptr[Byte], CInt] = v
  ...
  type OSSL_FUNC_store_open_ex_fn = CFuncPtr5[Ptr[Byte], CString, Ptr[OSSL_PARAM], Ptr[OSSL_PASSPHRASE_CALLBACK], Ptr[Byte], Ptr[Byte]]
  object OSSL_FUNC_store_open_ex_fn:
    given _tag: Tag[OSSL_FUNC_store_open_ex_fn] = Tag.materializeCFuncPtr5[Ptr[Byte], CString, Ptr[OSSL_PARAM], Ptr[OSSL_PASSPHRASE_CALLBACK], Ptr[Byte], Ptr[Byte]]
    inline def apply(inline o: CFuncPtr5[Ptr[Byte], CString, Ptr[OSSL_PARAM], Ptr[OSSL_PASSPHRASE_CALLBACK], Ptr[Byte], Ptr[Byte]]): OSSL_FUNC_store_open_ex_fn = o
    extension (v: OSSL_FUNC_store_open_ex_fn)
      inline def value: CFuncPtr5[Ptr[Byte], CString, Ptr[OSSL_PARAM], Ptr[OSSL_PASSPHRASE_CALLBACK], Ptr[Byte], Ptr[Byte]] = v
  ...
  type OSSL_INDICATOR_CALLBACK = CFuncPtr3[CString, CString, Ptr[OSSL_PARAM], CInt]
  object OSSL_INDICATOR_CALLBACK:
    given _tag: Tag[OSSL_INDICATOR_CALLBACK] = Tag.materializeCFuncPtr3[CString, CString, Ptr[OSSL_PARAM], CInt]
    inline def apply(inline o: CFuncPtr3[CString, CString, Ptr[OSSL_PARAM], CInt]): OSSL_INDICATOR_CALLBACK = o
    extension (v: OSSL_INDICATOR_CALLBACK)
      inline def value: CFuncPtr3[CString, CString, Ptr[OSSL_PARAM], CInt] = v
  ...
  type OSSL_i2d_of_void_ctx = CFuncPtr3[Ptr[Byte], Ptr[Ptr[CUnsignedChar]], Ptr[Byte], CInt]
  object OSSL_i2d_of_void_ctx:
    given _tag: Tag[OSSL_i2d_of_void_ctx] = Tag.materializeCFuncPtr3[Ptr[Byte], Ptr[Ptr[CUnsignedChar]], Ptr[Byte], CInt]
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], Ptr[Ptr[CUnsignedChar]], Ptr[Byte], CInt]): OSSL_i2d_of_void_ctx = o
    extension (v: OSSL_i2d_of_void_ctx)
      inline def value: CFuncPtr3[Ptr[Byte], Ptr[Ptr[CUnsignedChar]], Ptr[Byte], CInt] = v
...
object structs:
  ...
  object ASN1_TYPE_Value:
    ...
    extension (struct: ASN1_TYPE_Value)
      ...
      inline def boolean_=(value: ASN1_BOOLEAN): Unit = !struct.at(0).asInstanceOf[Ptr[ASN1_BOOLEAN]] = value
      inline def asn1_string : Ptr[ASN1_STRING] = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_STRING]]]
      inline def asn1_string_=(value: Ptr[ASN1_STRING]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_STRING]]] = value
      inline def `object` : Ptr[ASN1_OBJECT] = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_OBJECT]]]
      inline def object_=(value: Ptr[ASN1_OBJECT]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_OBJECT]]] = value
      inline def integer : Ptr[ASN1_INTEGER] = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_INTEGER]]]
      inline def integer_=(value: Ptr[ASN1_INTEGER]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_INTEGER]]] = value
      inline def enumerated : Ptr[ASN1_ENUMERATED] = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_ENUMERATED]]]
      inline def enumerated_=(value: Ptr[ASN1_ENUMERATED]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_ENUMERATED]]] = value
      inline def bit_string : Ptr[ASN1_BIT_STRING] = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_BIT_STRING]]]
      inline def bit_string_=(value: Ptr[ASN1_BIT_STRING]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_BIT_STRING]]] = value
      inline def octet_string : Ptr[ASN1_OCTET_STRING] = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_OCTET_STRING]]]
      inline def octet_string_=(value: Ptr[ASN1_OCTET_STRING]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_OCTET_STRING]]] = value
      inline def printablestring : Ptr[ASN1_PRINTABLESTRING] = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_PRINTABLESTRING]]]
      inline def printablestring_=(value: Ptr[ASN1_PRINTABLESTRING]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_PRINTABLESTRING]]] = value
      inline def t61string : Ptr[ASN1_T61STRING] = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_T61STRING]]]
      inline def t61string_=(value: Ptr[ASN1_T61STRING]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_T61STRING]]] = value
      inline def ia5string : Ptr[ASN1_IA5STRING] = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_IA5STRING]]]
      inline def ia5string_=(value: Ptr[ASN1_IA5STRING]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_IA5STRING]]] = value
      inline def generalstring : Ptr[ASN1_GENERALSTRING] = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_GENERALSTRING]]]
      inline def generalstring_=(value: Ptr[ASN1_GENERALSTRING]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_GENERALSTRING]]] = value
      inline def bmpstring : Ptr[ASN1_BMPSTRING] = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_BMPSTRING]]]
      inline def bmpstring_=(value: Ptr[ASN1_BMPSTRING]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_BMPSTRING]]] = value
      inline def universalstring : Ptr[ASN1_UNIVERSALSTRING] = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_UNIVERSALSTRING]]]
      inline def universalstring_=(value: Ptr[ASN1_UNIVERSALSTRING]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_UNIVERSALSTRING]]] = value
      inline def utctime : Ptr[ASN1_UTCTIME] = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_UTCTIME]]]
      inline def utctime_=(value: Ptr[ASN1_UTCTIME]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_UTCTIME]]] = value
      inline def generalizedtime : Ptr[ASN1_GENERALIZEDTIME] = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_GENERALIZEDTIME]]]
      inline def generalizedtime_=(value: Ptr[ASN1_GENERALIZEDTIME]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_GENERALIZEDTIME]]] = value
      inline def visiblestring : Ptr[ASN1_VISIBLESTRING] = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_VISIBLESTRING]]]
      inline def visiblestring_=(value: Ptr[ASN1_VISIBLESTRING]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_VISIBLESTRING]]] = value
      inline def utf8string : Ptr[ASN1_UTF8STRING] = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_UTF8STRING]]]
      inline def utf8string_=(value: Ptr[ASN1_UTF8STRING]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_UTF8STRING]]] = value
      inline def set : Ptr[ASN1_STRING] = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_STRING]]]
      inline def set_=(value: Ptr[ASN1_STRING]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_STRING]]] = value
      inline def sequence : Ptr[ASN1_STRING] = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_STRING]]]
      inline def sequence_=(value: Ptr[ASN1_STRING]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_STRING]]] = value
      inline def asn1_value : Ptr[ASN1_VALUE] = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_VALUE]]]
      inline def asn1_value_=(value: Ptr[ASN1_VALUE]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[ASN1_VALUE]]] = value
  ...
  object BIO_MMSG_CB_ARGS:
    given _tag: Tag[BIO_MMSG_CB_ARGS] = Tag.materializeCStruct5Tag[Ptr[BIO_MSG], size_t, size_t, uint64_t, Ptr[size_t]]
    
    export fields.*
    private[openssl] object fields:
      extension (struct: BIO_MMSG_CB_ARGS)
        inline def msg : Ptr[BIO_MSG] = struct._1
        inline def msg_=(value: Ptr[BIO_MSG]): Unit = (!struct.at1 = value)
        inline def stride : size_t = struct._2
        inline def stride_=(value: size_t): Unit = (!struct.at2 = value)
        inline def num_msg : size_t = struct._3
        inline def num_msg_=(value: size_t): Unit = (!struct.at3 = value)
        inline def flags : uint64_t = struct._4
        inline def flags_=(value: uint64_t): Unit = (!struct.at4 = value)
        inline def msgs_processed : Ptr[size_t] = struct._5
        inline def msgs_processed_=(value: Ptr[size_t]): Unit = (!struct.at5 = value)
      end extension
    
    // Allocates BIO_MMSG_CB_ARGS on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[BIO_MMSG_CB_ARGS] = scala.scalanative.unsafe.alloc[BIO_MMSG_CB_ARGS](1)
    def apply(msg : Ptr[BIO_MSG], stride : size_t, num_msg : size_t, flags : uint64_t, msgs_processed : Ptr[size_t])(using Zone): Ptr[BIO_MMSG_CB_ARGS] =
      val ____ptr = apply()
      (!____ptr).msg = msg
  ...
  object BIO_MSG:
    given _tag: Tag[BIO_MSG] = Tag.materializeCStruct5Tag[Ptr[Byte], size_t, Ptr[BIO_ADDR], Ptr[BIO_ADDR], uint64_t]
    ...
    private[openssl] object fields:
      extension (struct: BIO_MSG)
        ...
        inline def data_len : size_t = struct._2
        inline def data_len_=(value: size_t): Unit = (!struct.at2 = value)
        inline def peer : Ptr[BIO_ADDR] = struct._3
        inline def peer_=(value: Ptr[BIO_ADDR]): Unit = (!struct.at3 = value)
        inline def local : Ptr[BIO_ADDR] = struct._4
        inline def local_=(value: Ptr[BIO_ADDR]): Unit = (!struct.at4 = value)
        inline def flags : uint64_t = struct._5
        inline def flags_=(value: uint64_t): Unit = (!struct.at5 = value)
      end extension
    ...
    def apply(data : Ptr[Byte], data_len : size_t, peer : Ptr[BIO_ADDR], local : Ptr[BIO_ADDR], flags : uint64_t)(using Zone): Ptr[BIO_MSG] =
      val ____ptr = apply()
      (!____ptr).data = data
  ...
  opaque type BIO_POLL_DESCRIPTOR = CStruct2[uint32_t, BIO_POLL_DESCRIPTOR_Value]
  
  object BIO_POLL_DESCRIPTOR:
    given _tag: Tag[BIO_POLL_DESCRIPTOR] = Tag.materializeCStruct2Tag[uint32_t, BIO_POLL_DESCRIPTOR_Value]
    
    export fields.*
    private[openssl] object fields:
      extension (struct: BIO_POLL_DESCRIPTOR)
        inline def `type` : uint32_t = struct._1
        inline def type_=(value: uint32_t): Unit = (!struct.at1 = value)
        inline def value : BIO_POLL_DESCRIPTOR_Value = struct._2
        inline def value_=(value: BIO_POLL_DESCRIPTOR_Value): Unit = (!struct.at2 = value)
      end extension
    
    // Allocates BIO_POLL_DESCRIPTOR on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[BIO_POLL_DESCRIPTOR] = scala.scalanative.unsafe.alloc[BIO_POLL_DESCRIPTOR](1)
    def apply(`type` : uint32_t, value : BIO_POLL_DESCRIPTOR_Value)(using Zone): Ptr[BIO_POLL_DESCRIPTOR] =
      val ____ptr = apply()
      (!____ptr).`type` = `type`
      (!____ptr).value = value
      ____ptr
  ...
  opaque type BIO_POLL_DESCRIPTOR_Value = CArray[Byte, Nat._8]
  object BIO_POLL_DESCRIPTOR_Value:
    given _tag: Tag[BIO_POLL_DESCRIPTOR_Value] = Tag.CArray[CChar, Nat._8](Tag.Byte, Tag.Nat8)
    
    def apply()(using Zone): Ptr[BIO_POLL_DESCRIPTOR_Value] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[BIO_POLL_DESCRIPTOR_Value](1)
      ___ptr
    
    @scala.annotation.targetName("apply_fd")
    def apply(fd: CInt)(using Zone): Ptr[BIO_POLL_DESCRIPTOR_Value] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[BIO_POLL_DESCRIPTOR_Value](1)
      val un = !___ptr
    ...
    def apply(custom: Ptr[Byte])(using Zone): Ptr[BIO_POLL_DESCRIPTOR_Value] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[BIO_POLL_DESCRIPTOR_Value](1)
      val un = !___ptr
    ...
    def apply(custom_ui: uintptr_t)(using Zone): Ptr[BIO_POLL_DESCRIPTOR_Value] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[BIO_POLL_DESCRIPTOR_Value](1)
      val un = !___ptr
    ...
    def apply(ssl: Ptr[SSL])(using Zone): Ptr[BIO_POLL_DESCRIPTOR_Value] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[BIO_POLL_DESCRIPTOR_Value](1)
      val un = !___ptr
      un.at(0).asInstanceOf[Ptr[Ptr[SSL]]].update(0, ssl)
      ___ptr
    
    extension (struct: BIO_POLL_DESCRIPTOR_Value)
      ...
      inline def custom : Ptr[Byte] = !struct.at(0).asInstanceOf[Ptr[Ptr[Byte]]]
      inline def custom_=(value: Ptr[Byte]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[Byte]]] = value
      inline def custom_ui : uintptr_t = !struct.at(0).asInstanceOf[Ptr[uintptr_t]]
      inline def custom_ui_=(value: uintptr_t): Unit = !struct.at(0).asInstanceOf[Ptr[uintptr_t]] = value
      inline def ssl : Ptr[SSL] = !struct.at(0).asInstanceOf[Ptr[Ptr[SSL]]]
      inline def ssl_=(value: Ptr[SSL]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[SSL]]] = value
  ...
  object CRYPTO_EX_DATA:
    ...
    private[openssl] object fields:
      extension (struct: CRYPTO_EX_DATA)
        inline def ctx : Ptr[OSSL_LIB_CTX] = struct._1
        inline def ctx_=(value: Ptr[OSSL_LIB_CTX]): Unit = (!struct.at1 = value)
        inline def sk : Ptr[stack_st_void] = struct._2
        inline def sk_=(value: Ptr[stack_st_void]): Unit = (!struct.at2 = value)
      end extension
  ...
  object CRYPTO_THREADID:
    ...
    private[openssl] object fields:
      extension (struct: CRYPTO_THREADID)
        inline def dummy : CInt = struct._1
        inline def dummy_=(value: CInt): Unit = (!struct.at1 = value)
      end extension
  ...
  object EVP_CIPHER_INFO:
    ...
    private[openssl] object fields:
      extension (struct: EVP_CIPHER_INFO)
        ...
        inline def iv_=(value: CArray[CUnsignedChar, Nat.Digit2[Nat._1, Nat._6]]): Unit = (!struct.at2 = value)
      end extension
  ...
  object EVP_CTRL_TLS1_1_MULTIBLOCK_PARAM:
    ...
    private[openssl] object fields:
      extension (struct: EVP_CTRL_TLS1_1_MULTIBLOCK_PARAM)
        inline def out : Ptr[CUnsignedChar] = struct._1
        inline def out_=(value: Ptr[CUnsignedChar]): Unit = (!struct.at1 = value)
        inline def inp : Ptr[CUnsignedChar] = struct._2
        inline def inp_=(value: Ptr[CUnsignedChar]): Unit = (!struct.at2 = value)
        inline def len : size_t = struct._3
        inline def len_=(value: size_t): Unit = (!struct.at3 = value)
        inline def interleave : CUnsignedInt = struct._4
        inline def interleave_=(value: CUnsignedInt): Unit = (!struct.at4 = value)
      end extension
  ...
  opaque type EVP_SKEY = CStruct0
  
  object EVP_SKEY:
    given _tag: Tag[EVP_SKEY] = Tag.materializeCStruct0Tag
    

  opaque type EVP_SKEYMGMT = CStruct0
  
  object EVP_SKEYMGMT:
    given _tag: Tag[EVP_SKEYMGMT] = Tag.materializeCStruct0Tag
  ...
  object OBJ_NAME:
    ...
    private[openssl] object fields:
      extension (struct: OBJ_NAME)
        inline def `type` : CInt = struct._1
        inline def type_=(value: CInt): Unit = (!struct.at1 = value)
        inline def alias : CInt = struct._2
        inline def alias_=(value: CInt): Unit = (!struct.at2 = value)
        inline def name : CString = struct._3
        inline def name_=(value: CString): Unit = (!struct.at3 = value)
        inline def data : CString = struct._4
        inline def data_=(value: CString): Unit = (!struct.at4 = value)
      end extension
  ...
  object OSSL_ALGORITHM:
    ...
    private[openssl] object fields:
      extension (struct: OSSL_ALGORITHM)
        inline def algorithm_names : CString = struct._1
        inline def algorithm_names_=(value: CString): Unit = (!struct.at1 = value)
        inline def property_definition : CString = struct._2
        inline def property_definition_=(value: CString): Unit = (!struct.at2 = value)
        inline def implementation : Ptr[OSSL_DISPATCH] = struct._3
        inline def implementation_=(value: Ptr[OSSL_DISPATCH]): Unit = (!struct.at3 = value)
        inline def algorithm_description : CString = struct._4
        inline def algorithm_description_=(value: CString): Unit = (!struct.at4 = value)
      end extension
  ...
  object OSSL_DISPATCH:
    ...
    private[openssl] object fields:
      extension (struct: OSSL_DISPATCH)
        inline def function_id : CInt = struct._1
        inline def function_id_=(value: CInt): Unit = (!struct.at1 = value)
        inline def function : CFuncPtr0[Unit] = struct._2
        inline def function_=(value: CFuncPtr0[Unit]): Unit = (!struct.at2 = value)
      end extension
  ...
  object OSSL_ITEM:
    ...
    private[openssl] object fields:
      extension (struct: OSSL_ITEM)
        inline def id : CUnsignedInt = struct._1
        inline def id_=(value: CUnsignedInt): Unit = (!struct.at1 = value)
        inline def ptr : Ptr[Byte] = struct._2
        inline def ptr_=(value: Ptr[Byte]): Unit = (!struct.at2 = value)
      end extension
  ...
  object OSSL_PARAM:
    ...
    private[openssl] object fields:
      extension (struct: OSSL_PARAM)
        ...
        inline def data_type : CUnsignedInt = struct._2
        inline def data_type_=(value: CUnsignedInt): Unit = (!struct.at2 = value)
        inline def data : Ptr[Byte] = struct._3
        inline def data_=(value: Ptr[Byte]): Unit = (!struct.at3 = value)
        inline def data_size : size_t = struct._4
        inline def data_size_=(value: size_t): Unit = (!struct.at4 = value)
        inline def return_size : size_t = struct._5
        inline def return_size_=(value: size_t): Unit = (!struct.at5 = value)
      end extension
  ...
  object SHA256_CTX:
    ...
    private[openssl] object fields:
      extension (struct: SHA256_CTX)
        inline def h : CArray[CUnsignedInt, Nat._8] = struct._1
        inline def h_=(value: CArray[CUnsignedInt, Nat._8]): Unit = (!struct.at1 = value)
        inline def Nl : CUnsignedInt = struct._2
        inline def Nl_=(value: CUnsignedInt): Unit = (!struct.at2 = value)
        inline def Nh : CUnsignedInt = struct._3
        inline def Nh_=(value: CUnsignedInt): Unit = (!struct.at3 = value)
        inline def data : CArray[CUnsignedInt, Nat.Digit2[Nat._1, Nat._6]] = struct._4
        inline def data_=(value: CArray[CUnsignedInt, Nat.Digit2[Nat._1, Nat._6]]): Unit = (!struct.at4 = value)
        inline def num : CUnsignedInt = struct._5
        inline def num_=(value: CUnsignedInt): Unit = (!struct.at5 = value)
        inline def md_len : CUnsignedInt = struct._6
        inline def md_len_=(value: CUnsignedInt): Unit = (!struct.at6 = value)
      end extension
  ...
  opaque type SHA512_CTX = CStruct6[CArray[CUnsignedLongLong, Nat._8], CUnsignedLongLong, CUnsignedLongLong, SHA512_CTX_U, CUnsignedInt, CUnsignedInt]
  
  object SHA512_CTX:
    given _tag: Tag[SHA512_CTX] = Tag.materializeCStruct6Tag[CArray[CUnsignedLongLong, Nat._8], CUnsignedLongLong, CUnsignedLongLong, SHA512_CTX_U, CUnsignedInt, CUnsignedInt]
    
    export fields.*
    private[openssl] object fields:
      extension (struct: SHA512_CTX)
        inline def h : CArray[CUnsignedLongLong, Nat._8] = struct._1
        inline def h_=(value: CArray[CUnsignedLongLong, Nat._8]): Unit = (!struct.at1 = value)
        inline def Nl : CUnsignedLongLong = struct._2
        inline def Nl_=(value: CUnsignedLongLong): Unit = (!struct.at2 = value)
        inline def Nh : CUnsignedLongLong = struct._3
        inline def Nh_=(value: CUnsignedLongLong): Unit = (!struct.at3 = value)
        inline def u : SHA512_CTX_U = struct._4
        inline def u_=(value: SHA512_CTX_U): Unit = (!struct.at4 = value)
        inline def num : CUnsignedInt = struct._5
        inline def num_=(value: CUnsignedInt): Unit = (!struct.at5 = value)
        inline def md_len : CUnsignedInt = struct._6
        inline def md_len_=(value: CUnsignedInt): Unit = (!struct.at6 = value)
    ...
    def apply(h : CArray[CUnsignedLongLong, Nat._8], Nl : CUnsignedLongLong, Nh : CUnsignedLongLong, u : SHA512_CTX_U, num : CUnsignedInt, md_len : CUnsignedInt)(using Zone): Ptr[SHA512_CTX] =
      val ____ptr = apply()
      (!____ptr).h = h
      (!____ptr).Nl = Nl
      (!____ptr).Nh = Nh
  ...
  opaque type SHA512_CTX_U = CArray[Byte, Nat.Digit3[Nat._1, Nat._2, Nat._8]]
  object SHA512_CTX_U:
    given _tag: Tag[SHA512_CTX_U] = Tag.CArray[CChar, Nat.Digit3[Nat._1, Nat._2, Nat._8]](Tag.Byte, Tag.Digit3[Nat._1, Nat._2, Nat._8](Tag.Nat1, Tag.Nat2, Tag.Nat8))
    
    def apply()(using Zone): Ptr[SHA512_CTX_U] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[SHA512_CTX_U](1)
      ___ptr
    
    @scala.annotation.targetName("apply_d")
    def apply(d: CArray[CUnsignedLongLong, Nat.Digit2[Nat._1, Nat._6]])(using Zone): Ptr[SHA512_CTX_U] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[SHA512_CTX_U](1)
      val un = !___ptr
    ...
    def apply(p: CArray[CUnsignedChar, Nat.Digit3[Nat._1, Nat._2, Nat._8]])(using Zone): Ptr[SHA512_CTX_U] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[SHA512_CTX_U](1)
      val un = !___ptr
      un.at(0).asInstanceOf[Ptr[CArray[CUnsignedChar, Nat.Digit3[Nat._1, Nat._2, Nat._8]]]].update(0, p)
      ___ptr
    
    extension (struct: SHA512_CTX_U)
      inline def d : CArray[CUnsignedLongLong, Nat.Digit2[Nat._1, Nat._6]] = !struct.at(0).asInstanceOf[Ptr[CArray[CUnsignedLongLong, Nat.Digit2[Nat._1, Nat._6]]]]
      inline def d_=(value: CArray[CUnsignedLongLong, Nat.Digit2[Nat._1, Nat._6]]): Unit = !struct.at(0).asInstanceOf[Ptr[CArray[CUnsignedLongLong, Nat.Digit2[Nat._1, Nat._6]]]] = value
      inline def p : CArray[CUnsignedChar, Nat.Digit3[Nat._1, Nat._2, Nat._8]] = !struct.at(0).asInstanceOf[Ptr[CArray[CUnsignedChar, Nat.Digit3[Nat._1, Nat._2, Nat._8]]]]
      inline def p_=(value: CArray[CUnsignedChar, Nat.Digit3[Nat._1, Nat._2, Nat._8]]): Unit = !struct.at(0).asInstanceOf[Ptr[CArray[CUnsignedChar, Nat.Digit3[Nat._1, Nat._2, Nat._8]]]] = value

  opaque type SHA512state_st = CStruct6[CArray[CUnsignedLongLong, Nat._8], CUnsignedLongLong, CUnsignedLongLong, SHA512state_st_U, CUnsignedInt, CUnsignedInt]
  
  object SHA512state_st:
    given _tag: Tag[SHA512state_st] = Tag.materializeCStruct6Tag[CArray[CUnsignedLongLong, Nat._8], CUnsignedLongLong, CUnsignedLongLong, SHA512state_st_U, CUnsignedInt, CUnsignedInt]
    ...
    private[openssl] object fields:
      extension (struct: SHA512state_st)
        ...
        inline def Nh : CUnsignedLongLong = struct._3
        inline def Nh_=(value: CUnsignedLongLong): Unit = (!struct.at3 = value)
        inline def u : SHA512state_st_U = struct._4
        inline def u_=(value: SHA512state_st_U): Unit = (!struct.at4 = value)
        inline def num : CUnsignedInt = struct._5
        inline def num_=(value: CUnsignedInt): Unit = (!struct.at5 = value)
        inline def md_len : CUnsignedInt = struct._6
        inline def md_len_=(value: CUnsignedInt): Unit = (!struct.at6 = value)
    ...
    def apply(h : CArray[CUnsignedLongLong, Nat._8], Nl : CUnsignedLongLong, Nh : CUnsignedLongLong, u : SHA512state_st_U, num : CUnsignedInt, md_len : CUnsignedInt)(using Zone): Ptr[SHA512state_st] =
      val ____ptr = apply()
      (!____ptr).h = h
      (!____ptr).Nl = Nl
      (!____ptr).Nh = Nh
  ...
  opaque type SHA512state_st_U = CArray[Byte, Nat.Digit3[Nat._1, Nat._2, Nat._8]]
  object SHA512state_st_U:
    given _tag: Tag[SHA512state_st_U] = Tag.CArray[CChar, Nat.Digit3[Nat._1, Nat._2, Nat._8]](Tag.Byte, Tag.Digit3[Nat._1, Nat._2, Nat._8](Tag.Nat1, Tag.Nat2, Tag.Nat8))
    
    def apply()(using Zone): Ptr[SHA512state_st_U] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[SHA512state_st_U](1)
      ___ptr
    
    @scala.annotation.targetName("apply_d")
    def apply(d: CArray[CUnsignedLongLong, Nat.Digit2[Nat._1, Nat._6]])(using Zone): Ptr[SHA512state_st_U] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[SHA512state_st_U](1)
      val un = !___ptr
      un.at(0).asInstanceOf[Ptr[CArray[CUnsignedLongLong, Nat.Digit2[Nat._1, Nat._6]]]].update(0, d)
      ___ptr
    ...
    @scala.annotation.targetName("apply_p")
    def apply(p: CArray[CUnsignedChar, Nat.Digit3[Nat._1, Nat._2, Nat._8]])(using Zone): Ptr[SHA512state_st_U] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[SHA512state_st_U](1)
      val un = !___ptr
      un.at(0).asInstanceOf[Ptr[CArray[CUnsignedChar, Nat.Digit3[Nat._1, Nat._2, Nat._8]]]].update(0, p)
      ___ptr
    
    extension (struct: SHA512state_st_U)
      inline def d : CArray[CUnsignedLongLong, Nat.Digit2[Nat._1, Nat._6]] = !struct.at(0).asInstanceOf[Ptr[CArray[CUnsignedLongLong, Nat.Digit2[Nat._1, Nat._6]]]]
      inline def d_=(value: CArray[CUnsignedLongLong, Nat.Digit2[Nat._1, Nat._6]]): Unit = !struct.at(0).asInstanceOf[Ptr[CArray[CUnsignedLongLong, Nat.Digit2[Nat._1, Nat._6]]]] = value
      inline def p : CArray[CUnsignedChar, Nat.Digit3[Nat._1, Nat._2, Nat._8]] = !struct.at(0).asInstanceOf[Ptr[CArray[CUnsignedChar, Nat.Digit3[Nat._1, Nat._2, Nat._8]]]]
      inline def p_=(value: CArray[CUnsignedChar, Nat.Digit3[Nat._1, Nat._2, Nat._8]]): Unit = !struct.at(0).asInstanceOf[Ptr[CArray[CUnsignedChar, Nat.Digit3[Nat._1, Nat._2, Nat._8]]]] = value
  ...
  object SHA_CTX:
    ...
    private[openssl] object fields:
      extension (struct: SHA_CTX)
        inline def h0 : CUnsignedInt = struct._1
        inline def h0_=(value: CUnsignedInt): Unit = (!struct.at1 = value)
        inline def h1 : CUnsignedInt = struct._2
        inline def h1_=(value: CUnsignedInt): Unit = (!struct.at2 = value)
        inline def h2 : CUnsignedInt = struct._3
        inline def h2_=(value: CUnsignedInt): Unit = (!struct.at3 = value)
        inline def h3 : CUnsignedInt = struct._4
        inline def h3_=(value: CUnsignedInt): Unit = (!struct.at4 = value)
        inline def h4 : CUnsignedInt = struct._5
        inline def h4_=(value: CUnsignedInt): Unit = (!struct.at5 = value)
        inline def Nl : CUnsignedInt = struct._6
        inline def Nl_=(value: CUnsignedInt): Unit = (!struct.at6 = value)
        inline def Nh : CUnsignedInt = struct._7
        inline def Nh_=(value: CUnsignedInt): Unit = (!struct.at7 = value)
        inline def data : CArray[CUnsignedInt, Nat.Digit2[Nat._1, Nat._6]] = struct._8
        inline def data_=(value: CArray[CUnsignedInt, Nat.Digit2[Nat._1, Nat._6]]): Unit = (!struct.at8 = value)
        inline def num : CUnsignedInt = struct._9
        inline def num_=(value: CUnsignedInt): Unit = (!struct.at9 = value)
      end extension
  ...
  object bio_mmsg_cb_args_st:
    given _tag: Tag[bio_mmsg_cb_args_st] = Tag.materializeCStruct5Tag[Ptr[BIO_MSG], size_t, size_t, uint64_t, Ptr[size_t]]
    ...
    def apply()(using Zone): Ptr[bio_mmsg_cb_args_st] = scala.scalanative.unsafe.alloc[bio_mmsg_cb_args_st](1)
    def apply(msg : Ptr[BIO_MSG], stride : size_t, num_msg : size_t, flags : uint64_t, msgs_processed : Ptr[size_t])(using Zone): Ptr[bio_mmsg_cb_args_st] =
      val ____ptr = apply()
      (!____ptr).msg = msg
      (!____ptr).stride = stride
      (!____ptr).num_msg = num_msg
  ...
  object bio_msg_st:
    given _tag: Tag[bio_msg_st] = Tag.materializeCStruct5Tag[Ptr[Byte], size_t, Ptr[BIO_ADDR], Ptr[BIO_ADDR], uint64_t]
    ...
    def apply(data : Ptr[Byte], data_len : size_t, peer : Ptr[BIO_ADDR], local : Ptr[BIO_ADDR], flags : uint64_t)(using Zone): Ptr[bio_msg_st] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).data_len = data_len
      (!____ptr).peer = peer
  ...
  opaque type bio_poll_descriptor_st = CStruct2[uint32_t, bio_poll_descriptor_st_Value]
  
  object bio_poll_descriptor_st:
    given _tag: Tag[bio_poll_descriptor_st] = Tag.materializeCStruct2Tag[uint32_t, bio_poll_descriptor_st_Value]
    ...
    private[openssl] object fields:
      extension (struct: bio_poll_descriptor_st)
        inline def `type` : uint32_t = struct._1
        inline def type_=(value: uint32_t): Unit = (!struct.at1 = value)
        inline def value : bio_poll_descriptor_st_Value = struct._2
        inline def value_=(value: bio_poll_descriptor_st_Value): Unit = (!struct.at2 = value)
      end extension
    
    // Allocates bio_poll_descriptor_st on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[bio_poll_descriptor_st] = scala.scalanative.unsafe.alloc[bio_poll_descriptor_st](1)
    def apply(`type` : uint32_t, value : bio_poll_descriptor_st_Value)(using Zone): Ptr[bio_poll_descriptor_st] =
      val ____ptr = apply()
      (!____ptr).`type` = `type`
      (!____ptr).value = value
      ____ptr
  ...
  opaque type bio_poll_descriptor_st_Value = CArray[Byte, Nat._8]
  object bio_poll_descriptor_st_Value:
    given _tag: Tag[bio_poll_descriptor_st_Value] = Tag.CArray[CChar, Nat._8](Tag.Byte, Tag.Nat8)
    
    def apply()(using Zone): Ptr[bio_poll_descriptor_st_Value] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[bio_poll_descriptor_st_Value](1)
      ___ptr
    
    @scala.annotation.targetName("apply_fd")
    def apply(fd: CInt)(using Zone): Ptr[bio_poll_descriptor_st_Value] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[bio_poll_descriptor_st_Value](1)
      val un = !___ptr
      un.at(0).asInstanceOf[Ptr[CInt]].update(0, fd)
      ___ptr
    ...
    @scala.annotation.targetName("apply_custom")
    def apply(custom: Ptr[Byte])(using Zone): Ptr[bio_poll_descriptor_st_Value] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[bio_poll_descriptor_st_Value](1)
      val un = !___ptr
      un.at(0).asInstanceOf[Ptr[Ptr[Byte]]].update(0, custom)
      ___ptr
    ...
    @scala.annotation.targetName("apply_custom_ui")
    def apply(custom_ui: uintptr_t)(using Zone): Ptr[bio_poll_descriptor_st_Value] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[bio_poll_descriptor_st_Value](1)
      val un = !___ptr
      un.at(0).asInstanceOf[Ptr[uintptr_t]].update(0, custom_ui)
      ___ptr
    ...
    @scala.annotation.targetName("apply_ssl")
    def apply(ssl: Ptr[SSL])(using Zone): Ptr[bio_poll_descriptor_st_Value] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[bio_poll_descriptor_st_Value](1)
      val un = !___ptr
      un.at(0).asInstanceOf[Ptr[Ptr[SSL]]].update(0, ssl)
      ___ptr
    
    extension (struct: bio_poll_descriptor_st_Value)
      inline def fd : CInt = !struct.at(0).asInstanceOf[Ptr[CInt]]
      inline def fd_=(value: CInt): Unit = !struct.at(0).asInstanceOf[Ptr[CInt]] = value
      inline def custom : Ptr[Byte] = !struct.at(0).asInstanceOf[Ptr[Ptr[Byte]]]
      inline def custom_=(value: Ptr[Byte]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[Byte]]] = value
  ...
  opaque type evp_skey_st = CStruct0
  
  object evp_skey_st:
    given _tag: Tag[evp_skey_st] = Tag.materializeCStruct0Tag
    

  opaque type evp_skeymgmt_st = CStruct0
  
  object evp_skeymgmt_st:
    given _tag: Tag[evp_skeymgmt_st] = Tag.materializeCStruct0Tag
...
object unions:
  ...
  object BIO_sock_info_u:
    ...
    extension (struct: BIO_sock_info_u)
      ...
      inline def addr_=(value: Ptr[BIO_ADDR]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[BIO_ADDR]]] = value
...
private[openssl] object extern_functions:
  ...
  def ASN1_item_unpack_ex(oct : Ptr[ASN1_STRING], it : Ptr[ASN1_ITEM], libctx : Ptr[OSSL_LIB_CTX], propq : CString): Ptr[Byte] = extern
  ...
  def BIO_ADDR_copy(dst : Ptr[BIO_ADDR], src : Ptr[BIO_ADDR]): CInt = extern

  def BIO_ADDR_dup(ap : Ptr[BIO_ADDR]): Ptr[BIO_ADDR] = extern
  ...
  def BIO_err_is_non_fatal(errcode : CUnsignedInt): CInt = extern
  ...
  def BIO_get_rpoll_descriptor(b : Ptr[BIO], desc : Ptr[BIO_POLL_DESCRIPTOR]): CInt = extern

  def BIO_get_shutdown(a : Ptr[BIO]): CInt = extern

  def BIO_get_wpoll_descriptor(b : Ptr[BIO], desc : Ptr[BIO_POLL_DESCRIPTOR]): CInt = extern
  ...
  def BIO_meth_get_recvmmsg(_0 : Ptr[BIO]): CFuncPtr6[Ptr[BIO], Ptr[BIO_MSG], size_t, size_t, uint64_t, Ptr[size_t], CInt] = extern

  def BIO_meth_get_sendmmsg(_0 : Ptr[BIO]): CFuncPtr6[Ptr[BIO], Ptr[BIO_MSG], size_t, size_t, uint64_t, Ptr[size_t], CInt] = extern
  ...
  def BIO_meth_set_gets(biom : Ptr[BIO_METHOD], ossl_gets : CFuncPtr3[Ptr[BIO], CString, CInt, CInt]): CInt = extern
  ...
  def BIO_meth_set_recvmmsg(biom : Ptr[BIO_METHOD], f : CFuncPtr6[Ptr[BIO], Ptr[BIO_MSG], size_t, size_t, uint64_t, Ptr[size_t], CInt]): CInt = extern

  def BIO_meth_set_sendmmsg(biom : Ptr[BIO_METHOD], f : CFuncPtr6[Ptr[BIO], Ptr[BIO_MSG], size_t, size_t, uint64_t, Ptr[size_t], CInt]): CInt = extern
  ...
  def BIO_new_bio_dgram_pair(bio1 : Ptr[Ptr[BIO]], writebuf1 : size_t, bio2 : Ptr[Ptr[BIO]], writebuf2 : size_t): CInt = extern
  ...
  def BIO_recvmmsg(b : Ptr[BIO], msg : Ptr[BIO_MSG], stride : size_t, num_msg : size_t, flags : uint64_t, msgs_processed : Ptr[size_t]): CInt = extern
  ...
  def BIO_s_dgram_mem(): Ptr[BIO_METHOD] = extern

  def BIO_s_dgram_pair(): Ptr[BIO_METHOD] = extern
  ...
  def BIO_sendmmsg(b : Ptr[BIO], msg : Ptr[BIO_MSG], stride : size_t, num_msg : size_t, flags : uint64_t, msgs_processed : Ptr[size_t]): CInt = extern
  ...
  */
  ...
  def BN_signed_bin2bn(s : Ptr[CUnsignedChar], len : CInt, ret : Ptr[BIGNUM]): Ptr[BIGNUM] = extern

  def BN_signed_bn2bin(a : Ptr[BIGNUM], to : Ptr[CUnsignedChar], tolen : CInt): CInt = extern

  def BN_signed_bn2lebin(a : Ptr[BIGNUM], to : Ptr[CUnsignedChar], tolen : CInt): CInt = extern

  def BN_signed_bn2native(a : Ptr[BIGNUM], to : Ptr[CUnsignedChar], tolen : CInt): CInt = extern

  def BN_signed_lebin2bn(s : Ptr[CUnsignedChar], len : CInt, ret : Ptr[BIGNUM]): Ptr[BIGNUM] = extern

  def BN_signed_native2bn(s : Ptr[CUnsignedChar], len : CInt, ret : Ptr[BIGNUM]): Ptr[BIGNUM] = extern
  ...
  def CRYPTO_aligned_alloc(num : size_t, align : size_t, freeptr : Ptr[Ptr[Byte]], file : CString, line : CInt): Ptr[Byte] = extern

  def CRYPTO_aligned_alloc_array(num : size_t, size : size_t, align : size_t, freeptr : Ptr[Ptr[Byte]], file : CString, line : CInt): Ptr[Byte] = extern
  ...
  def CRYPTO_atomic_add64(`val` : Ptr[uint64_t], op : uint64_t, ret : Ptr[uint64_t], lock : Ptr[CRYPTO_RWLOCK]): CInt = extern

  def CRYPTO_atomic_and(`val` : Ptr[uint64_t], op : uint64_t, ret : Ptr[uint64_t], lock : Ptr[CRYPTO_RWLOCK]): CInt = extern

  def CRYPTO_atomic_load(`val` : Ptr[uint64_t], ret : Ptr[uint64_t], lock : Ptr[CRYPTO_RWLOCK]): CInt = extern

  def CRYPTO_atomic_load_int(`val` : Ptr[CInt], ret : Ptr[CInt], lock : Ptr[CRYPTO_RWLOCK]): CInt = extern

  def CRYPTO_atomic_or(`val` : Ptr[uint64_t], op : uint64_t, ret : Ptr[uint64_t], lock : Ptr[CRYPTO_RWLOCK]): CInt = extern

  def CRYPTO_atomic_store(dst : Ptr[uint64_t], `val` : uint64_t, lock : Ptr[CRYPTO_RWLOCK]): CInt = extern

  def CRYPTO_calloc(num : size_t, size : size_t, file : CString, line : CInt): Ptr[Byte] = extern
  ...
  def CRYPTO_clear_realloc_array(addr : Ptr[Byte], old_num : size_t, num : size_t, size : size_t, file : CString, line : CInt): Ptr[Byte] = extern
  ...
  def CRYPTO_malloc_array(num : size_t, size : size_t, file : CString, line : CInt): Ptr[Byte] = extern
  ...
  def CRYPTO_realloc_array(addr : Ptr[Byte], num : size_t, size : size_t, file : CString, line : CInt): Ptr[Byte] = extern

  def CRYPTO_secure_actual_size(ptr : Ptr[Byte]): size_t = extern

  def CRYPTO_secure_allocated(ptr : Ptr[Byte]): CInt = extern

  def CRYPTO_secure_calloc(num : size_t, size : size_t, file : CString, line : CInt): Ptr[Byte] = extern
  ...
  def CRYPTO_secure_malloc_array(num : size_t, size : size_t, file : CString, line : CInt): Ptr[Byte] = extern
  ...
  def EVP_CIPHER_CTX_get_algor(ctx : Ptr[EVP_CIPHER_CTX], alg : Ptr[Ptr[X509_ALGOR]]): CInt = extern

  def EVP_CIPHER_CTX_get_algor_params(ctx : Ptr[EVP_CIPHER_CTX], alg : Ptr[X509_ALGOR]): CInt = extern
  ...
  def EVP_CIPHER_CTX_set_algor_params(ctx : Ptr[EVP_CIPHER_CTX], alg : Ptr[X509_ALGOR]): CInt = extern
  ...
  def EVP_CIPHER_can_pipeline(cipher : Ptr[EVP_CIPHER], enc : CInt): CInt = extern
  ...
  def EVP_CipherInit_SKEY(ctx : Ptr[EVP_CIPHER_CTX], cipher : Ptr[EVP_CIPHER], skey : Ptr[EVP_SKEY], iv : Ptr[CUnsignedChar], iv_len : size_t, enc : CInt, params : Ptr[OSSL_PARAM]): CInt = extern
  ...
  def EVP_CipherPipelineDecryptInit(ctx : Ptr[EVP_CIPHER_CTX], cipher : Ptr[EVP_CIPHER], key : Ptr[CUnsignedChar], keylen : size_t, numpipes : size_t, iv : Ptr[Ptr[CUnsignedChar]], ivlen : size_t): CInt = extern

  def EVP_CipherPipelineEncryptInit(ctx : Ptr[EVP_CIPHER_CTX], cipher : Ptr[EVP_CIPHER], key : Ptr[CUnsignedChar], keylen : size_t, numpipes : size_t, iv : Ptr[Ptr[CUnsignedChar]], ivlen : size_t): CInt = extern

  def EVP_CipherPipelineFinal(ctx : Ptr[EVP_CIPHER_CTX], outm : Ptr[Ptr[CUnsignedChar]], outl : Ptr[size_t], outsize : Ptr[size_t]): CInt = extern

  def EVP_CipherPipelineUpdate(ctx : Ptr[EVP_CIPHER_CTX], out : Ptr[Ptr[CUnsignedChar]], outl : Ptr[size_t], outsize : Ptr[size_t], in : Ptr[Ptr[CUnsignedChar]], inl : Ptr[size_t]): CInt = extern
  ...
  def EVP_DigestFinalXOF(ctx : Ptr[EVP_MD_CTX], out : Ptr[CUnsignedChar], outlen : size_t): CInt = extern
  ...
  def EVP_DigestSqueeze(ctx : Ptr[EVP_MD_CTX], out : Ptr[CUnsignedChar], outlen : size_t): CInt = extern
  ...
  def EVP_KEYMGMT_gen_gettable_params(keymgmt : Ptr[EVP_KEYMGMT]): Ptr[OSSL_PARAM] = extern
  ...
  def EVP_MAC_init_SKEY(ctx : Ptr[EVP_MAC_CTX], skey : Ptr[EVP_SKEY], params : Ptr[OSSL_PARAM]): CInt = extern
  ...
  def EVP_MD_CTX_get_size_ex(ctx : Ptr[EVP_MD_CTX]): CInt = extern
  ...
  def EVP_MD_xof(md : Ptr[EVP_MD]): CInt = extern
  ...
  def EVP_PKEY_CTX_get_algor(ctx : Ptr[EVP_PKEY_CTX], alg : Ptr[Ptr[X509_ALGOR]]): CInt = extern

  def EVP_PKEY_CTX_get_algor_params(ctx : Ptr[EVP_PKEY_CTX], alg : Ptr[X509_ALGOR]): CInt = extern
  ...
  def EVP_PKEY_CTX_set_algor_params(ctx : Ptr[EVP_PKEY_CTX], alg : Ptr[X509_ALGOR]): CInt = extern
  ...
  def EVP_PKEY_CTX_set_signature(pctx : Ptr[EVP_PKEY_CTX], sig : Ptr[CUnsignedChar], siglen : size_t): CInt = extern
  ...
  def EVP_PKEY_auth_decapsulate_init(ctx : Ptr[EVP_PKEY_CTX], authpub : Ptr[EVP_PKEY], params : Ptr[OSSL_PARAM]): CInt = extern

  def EVP_PKEY_auth_encapsulate_init(ctx : Ptr[EVP_PKEY_CTX], authpriv : Ptr[EVP_PKEY], params : Ptr[OSSL_PARAM]): CInt = extern
  ...
  def EVP_PKEY_derive_SKEY(ctx : Ptr[EVP_PKEY_CTX], mgmt : Ptr[EVP_SKEYMGMT], key_type : CString, propquery : CString, keylen : size_t, params : Ptr[OSSL_PARAM]): Ptr[EVP_SKEY] = extern
  ...
  def EVP_PKEY_get_security_category(pkey : Ptr[EVP_PKEY]): CInt = extern
  ...
  def EVP_PKEY_sign_init_ex2(ctx : Ptr[EVP_PKEY_CTX], algo : Ptr[EVP_SIGNATURE], params : Ptr[OSSL_PARAM]): CInt = extern

  def EVP_PKEY_sign_message_final(ctx : Ptr[EVP_PKEY_CTX], sig : Ptr[CUnsignedChar], siglen : Ptr[size_t]): CInt = extern

  def EVP_PKEY_sign_message_init(ctx : Ptr[EVP_PKEY_CTX], algo : Ptr[EVP_SIGNATURE], params : Ptr[OSSL_PARAM]): CInt = extern

  def EVP_PKEY_sign_message_update(ctx : Ptr[EVP_PKEY_CTX], in : Ptr[CUnsignedChar], inlen : size_t): CInt = extern
  ...
  def EVP_PKEY_verify_init_ex2(ctx : Ptr[EVP_PKEY_CTX], algo : Ptr[EVP_SIGNATURE], params : Ptr[OSSL_PARAM]): CInt = extern

  def EVP_PKEY_verify_message_final(ctx : Ptr[EVP_PKEY_CTX]): CInt = extern

  def EVP_PKEY_verify_message_init(ctx : Ptr[EVP_PKEY_CTX], algo : Ptr[EVP_SIGNATURE], params : Ptr[OSSL_PARAM]): CInt = extern

  def EVP_PKEY_verify_message_update(ctx : Ptr[EVP_PKEY_CTX], in : Ptr[CUnsignedChar], inlen : size_t): CInt = extern
  ...
  def EVP_PKEY_verify_recover_init_ex2(ctx : Ptr[EVP_PKEY_CTX], algo : Ptr[EVP_SIGNATURE], params : Ptr[OSSL_PARAM]): CInt = extern
  ...
  def EVP_SKEYMGMT_do_all_provided(libctx : Ptr[OSSL_LIB_CTX], fn : CFuncPtr2[Ptr[EVP_SKEYMGMT], Ptr[Byte], Unit], arg : Ptr[Byte]): Unit = extern

  def EVP_SKEYMGMT_fetch(ctx : Ptr[OSSL_LIB_CTX], algorithm : CString, properties : CString): Ptr[EVP_SKEYMGMT] = extern

  def EVP_SKEYMGMT_free(keymgmt : Ptr[EVP_SKEYMGMT]): Unit = extern

  def EVP_SKEYMGMT_get0_description(keymgmt : Ptr[EVP_SKEYMGMT]): CString = extern

  def EVP_SKEYMGMT_get0_gen_settable_params(skeymgmt : Ptr[EVP_SKEYMGMT]): Ptr[OSSL_PARAM] = extern

  def EVP_SKEYMGMT_get0_imp_settable_params(skeymgmt : Ptr[EVP_SKEYMGMT]): Ptr[OSSL_PARAM] = extern

  def EVP_SKEYMGMT_get0_name(keymgmt : Ptr[EVP_SKEYMGMT]): CString = extern

  def EVP_SKEYMGMT_get0_provider(keymgmt : Ptr[EVP_SKEYMGMT]): Ptr[OSSL_PROVIDER] = extern

  def EVP_SKEYMGMT_is_a(keymgmt : Ptr[EVP_SKEYMGMT], name : CString): CInt = extern

  def EVP_SKEYMGMT_names_do_all(keymgmt : Ptr[EVP_SKEYMGMT], fn : CFuncPtr2[CString, Ptr[Byte], Unit], data : Ptr[Byte]): CInt = extern

  def EVP_SKEYMGMT_up_ref(keymgmt : Ptr[EVP_SKEYMGMT]): CInt = extern

  def EVP_SKEY_export(skey : Ptr[EVP_SKEY], selection : CInt, export_cb : Ptr[OSSL_CALLBACK], export_cbarg : Ptr[Byte]): CInt = extern

  def EVP_SKEY_free(skey : Ptr[EVP_SKEY]): Unit = extern

  def EVP_SKEY_generate(libctx : Ptr[OSSL_LIB_CTX], skeymgmtname : CString, propquery : CString, params : Ptr[OSSL_PARAM]): Ptr[EVP_SKEY] = extern

  def EVP_SKEY_get0_key_id(skey : Ptr[EVP_SKEY]): CString = extern

  def EVP_SKEY_get0_provider_name(skey : Ptr[EVP_SKEY]): CString = extern

  def EVP_SKEY_get0_raw_key(skey : Ptr[EVP_SKEY], key : Ptr[Ptr[CUnsignedChar]], len : Ptr[size_t]): CInt = extern

  def EVP_SKEY_get0_skeymgmt_name(skey : Ptr[EVP_SKEY]): CString = extern

  def EVP_SKEY_import(libctx : Ptr[OSSL_LIB_CTX], skeymgmtname : CString, propquery : CString, selection : CInt, params : Ptr[OSSL_PARAM]): Ptr[EVP_SKEY] = extern

  def EVP_SKEY_import_SKEYMGMT(libctx : Ptr[OSSL_LIB_CTX], skeymgmt : Ptr[EVP_SKEYMGMT], selection : CInt, params : Ptr[OSSL_PARAM]): Ptr[EVP_SKEY] = extern

  def EVP_SKEY_import_raw_key(libctx : Ptr[OSSL_LIB_CTX], skeymgmtname : CString, key : Ptr[CUnsignedChar], keylen : size_t, propquery : CString): Ptr[EVP_SKEY] = extern

  def EVP_SKEY_is_a(skey : Ptr[EVP_SKEY], name : CString): CInt = extern

  def EVP_SKEY_to_provider(skey : Ptr[EVP_SKEY], libctx : Ptr[OSSL_LIB_CTX], prov : Ptr[OSSL_PROVIDER], propquery : CString): Ptr[EVP_SKEY] = extern

  def EVP_SKEY_up_ref(skey : Ptr[EVP_SKEY]): CInt = extern
  ...
  def EVP_get1_default_properties(libctx : Ptr[OSSL_LIB_CTX]): CString = extern
  ...
  def OPENSSL_sk_pop_free(st : Ptr[OPENSSL_STACK], func : OPENSSL_sk_freefunc): Unit = extern
  ...
  def OPENSSL_sk_set_thunks(st : Ptr[OPENSSL_STACK], f_thunk : OPENSSL_sk_freefunc_thunk): Ptr[OPENSSL_STACK] = extern
  ...
  def OPENSSL_strtoul(str : CString, endptr : Ptr[CString], base : CInt, num : Ptr[CUnsignedLongInt]): CInt = extern
  ...
  def OSSL_FUNC_SSL_QUIC_TLS_alert(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_SSL_QUIC_TLS_alert_fn] = extern

  def OSSL_FUNC_SSL_QUIC_TLS_crypto_recv_rcd(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_SSL_QUIC_TLS_crypto_recv_rcd_fn] = extern

  def OSSL_FUNC_SSL_QUIC_TLS_crypto_release_rcd(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_SSL_QUIC_TLS_crypto_release_rcd_fn] = extern

  def OSSL_FUNC_SSL_QUIC_TLS_crypto_send(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_SSL_QUIC_TLS_crypto_send_fn] = extern

  def OSSL_FUNC_SSL_QUIC_TLS_got_transport_params(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_SSL_QUIC_TLS_got_transport_params_fn] = extern

  def OSSL_FUNC_SSL_QUIC_TLS_yield_secret(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_SSL_QUIC_TLS_yield_secret_fn] = extern
  ...
  def OSSL_FUNC_cipher_decrypt_skey_init(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_cipher_decrypt_skey_init_fn] = extern
  ...
  def OSSL_FUNC_cipher_encrypt_skey_init(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_cipher_encrypt_skey_init_fn] = extern
  ...
  def OSSL_FUNC_cipher_pipeline_decrypt_init(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_cipher_pipeline_decrypt_init_fn] = extern

  def OSSL_FUNC_cipher_pipeline_encrypt_init(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_cipher_pipeline_encrypt_init_fn] = extern

  def OSSL_FUNC_cipher_pipeline_final(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_cipher_pipeline_final_fn] = extern

  def OSSL_FUNC_cipher_pipeline_update(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_cipher_pipeline_update_fn] = extern
  ...
  def OSSL_FUNC_cleanup_user_entropy(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_cleanup_user_entropy_fn] = extern

  def OSSL_FUNC_cleanup_user_nonce(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_cleanup_user_nonce_fn] = extern

  def OSSL_FUNC_core_clear_last_error_mark(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_core_clear_last_error_mark_fn] = extern

  def OSSL_FUNC_core_count_to_mark(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_core_count_to_mark_fn] = extern
  ...
  def OSSL_FUNC_digest_copyctx(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_digest_copyctx_fn] = extern
  ...
  def OSSL_FUNC_digest_squeeze(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_digest_squeeze_fn] = extern
  ...
  def OSSL_FUNC_get_user_entropy(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_get_user_entropy_fn] = extern

  def OSSL_FUNC_get_user_nonce(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_get_user_nonce_fn] = extern

  def OSSL_FUNC_indicator_cb(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_indicator_cb_fn] = extern

  def OSSL_FUNC_kdf_derive(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_kdf_derive_fn] = extern

  def OSSL_FUNC_kdf_derive_skey(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_kdf_derive_skey_fn] = extern
  ...
  def OSSL_FUNC_kdf_set_skey(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_kdf_set_skey_fn] = extern

  def OSSL_FUNC_kdf_settable_ctx_params(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_kdf_settable_ctx_params_fn] = extern

  def OSSL_FUNC_kem_auth_decapsulate_init(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_kem_auth_decapsulate_init_fn] = extern

  def OSSL_FUNC_kem_auth_encapsulate_init(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_kem_auth_encapsulate_init_fn] = extern
  ...
  def OSSL_FUNC_keyexch_derive_skey(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_keyexch_derive_skey_fn] = extern
  ...
  def OSSL_FUNC_keymgmt_export_types_ex(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_keymgmt_export_types_ex_fn] = extern
  ...
  def OSSL_FUNC_keymgmt_gen_get_params(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_keymgmt_gen_get_params_fn] = extern

  def OSSL_FUNC_keymgmt_gen_gettable_params(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_keymgmt_gen_gettable_params_fn] = extern
  ...
  def OSSL_FUNC_keymgmt_import_types_ex(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_keymgmt_import_types_ex_fn] = extern
  ...
  def OSSL_FUNC_mac_init_skey(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_mac_init_skey_fn] = extern
  ...
  def OSSL_FUNC_provider_random_bytes(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_provider_random_bytes_fn] = extern
  ...
  def OSSL_FUNC_signature_query_key_types(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_signature_query_key_types_fn] = extern
  ...
  def OSSL_FUNC_signature_sign_message_final(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_signature_sign_message_final_fn] = extern

  def OSSL_FUNC_signature_sign_message_init(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_signature_sign_message_init_fn] = extern

  def OSSL_FUNC_signature_sign_message_update(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_signature_sign_message_update_fn] = extern
  ...
  def OSSL_FUNC_signature_verify_message_final(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_signature_verify_message_final_fn] = extern

  def OSSL_FUNC_signature_verify_message_init(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_signature_verify_message_init_fn] = extern

  def OSSL_FUNC_signature_verify_message_update(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_signature_verify_message_update_fn] = extern
  ...
  def OSSL_FUNC_skeymgmt_export(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_skeymgmt_export_fn] = extern

  def OSSL_FUNC_skeymgmt_free(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_skeymgmt_free_fn] = extern

  def OSSL_FUNC_skeymgmt_gen_settable_params(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_skeymgmt_gen_settable_params_fn] = extern

  def OSSL_FUNC_skeymgmt_generate(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_skeymgmt_generate_fn] = extern

  def OSSL_FUNC_skeymgmt_get_key_id(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_skeymgmt_get_key_id_fn] = extern

  def OSSL_FUNC_skeymgmt_imp_settable_params(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_skeymgmt_imp_settable_params_fn] = extern

  def OSSL_FUNC_skeymgmt_import(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_skeymgmt_import_fn] = extern
  ...
  def OSSL_FUNC_store_delete(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_store_delete_fn] = extern
  ...
  def OSSL_FUNC_store_open_ex(opf : Ptr[OSSL_DISPATCH]): Ptr[OSSL_FUNC_store_open_ex_fn] = extern
  ...
  def OSSL_INDICATOR_get_callback(libctx : Ptr[OSSL_LIB_CTX], cb : Ptr[Ptr[OSSL_INDICATOR_CALLBACK]]): Unit = extern

  def OSSL_INDICATOR_set_callback(libctx : Ptr[OSSL_LIB_CTX], cb : Ptr[OSSL_INDICATOR_CALLBACK]): Unit = extern

  def OSSL_LIB_CTX_free(_0 : Ptr[OSSL_LIB_CTX]): Unit = extern

  def OSSL_LIB_CTX_get0_global_default(): Ptr[OSSL_LIB_CTX] = extern

  def OSSL_LIB_CTX_get_conf_diagnostics(ctx : Ptr[OSSL_LIB_CTX]): CInt = extern

  def OSSL_LIB_CTX_get_data(ctx : Ptr[OSSL_LIB_CTX], index : CInt): Ptr[Byte] = extern
  ...
  def OSSL_LIB_CTX_set_conf_diagnostics(ctx : Ptr[OSSL_LIB_CTX], value : CInt): Unit = extern
  ...
  def OSSL_PARAM_print_to_bio(params : Ptr[OSSL_PARAM], bio : Ptr[BIO], print_values : CInt): CInt = extern
  ...
  def OSSL_PARAM_set_octet_string_or_ptr(p : Ptr[OSSL_PARAM], `val` : Ptr[Byte], len : size_t): CInt = extern
  ...
  def OSSL_sleep(millis : uint64_t): Unit = extern
  ...
  private[openssl] def __sn_wrap_openssl_OSSL_PARAM_construct_BN(key : CString, buf : Ptr[CUnsignedChar], bsize : size_t, __return : Ptr[OSSL_PARAM]): Unit = extern

  private[openssl] def __sn_wrap_openssl_OSSL_PARAM_construct_double(key : CString, buf : Ptr[Double], __return : Ptr[OSSL_PARAM]): Unit = extern

  private[openssl] def __sn_wrap_openssl_OSSL_PARAM_construct_end(__return : Ptr[OSSL_PARAM]): Unit = extern

  private[openssl] def __sn_wrap_openssl_OSSL_PARAM_construct_int(key : CString, buf : Ptr[CInt], __return : Ptr[OSSL_PARAM]): Unit = extern

  private[openssl] def __sn_wrap_openssl_OSSL_PARAM_construct_int32(key : CString, buf : Ptr[int32_t], __return : Ptr[OSSL_PARAM]): Unit = extern

  private[openssl] def __sn_wrap_openssl_OSSL_PARAM_construct_int64(key : CString, buf : Ptr[int64_t], __return : Ptr[OSSL_PARAM]): Unit = extern

  private[openssl] def __sn_wrap_openssl_OSSL_PARAM_construct_long(key : CString, buf : Ptr[CLongInt], __return : Ptr[OSSL_PARAM]): Unit = extern

  private[openssl] def __sn_wrap_openssl_OSSL_PARAM_construct_octet_ptr(key : CString, buf : Ptr[Ptr[Byte]], bsize : size_t, __return : Ptr[OSSL_PARAM]): Unit = extern

  private[openssl] def __sn_wrap_openssl_OSSL_PARAM_construct_octet_string(key : CString, buf : Ptr[Byte], bsize : size_t, __return : Ptr[OSSL_PARAM]): Unit = extern

  private[openssl] def __sn_wrap_openssl_OSSL_PARAM_construct_size_t(key : CString, buf : Ptr[size_t], __return : Ptr[OSSL_PARAM]): Unit = extern

  private[openssl] def __sn_wrap_openssl_OSSL_PARAM_construct_time_t(key : CString, buf : Ptr[time_t], __return : Ptr[OSSL_PARAM]): Unit = extern

  private[openssl] def __sn_wrap_openssl_OSSL_PARAM_construct_uint(key : CString, buf : Ptr[CUnsignedInt], __return : Ptr[OSSL_PARAM]): Unit = extern

  private[openssl] def __sn_wrap_openssl_OSSL_PARAM_construct_uint32(key : CString, buf : Ptr[uint32_t], __return : Ptr[OSSL_PARAM]): Unit = extern

  private[openssl] def __sn_wrap_openssl_OSSL_PARAM_construct_uint64(key : CString, buf : Ptr[uint64_t], __return : Ptr[OSSL_PARAM]): Unit = extern

  private[openssl] def __sn_wrap_openssl_OSSL_PARAM_construct_ulong(key : CString, buf : Ptr[CUnsignedLongInt], __return : Ptr[OSSL_PARAM]): Unit = extern

  private[openssl] def __sn_wrap_openssl_OSSL_PARAM_construct_utf8_ptr(key : CString, buf : Ptr[CString], bsize : size_t, __return : Ptr[OSSL_PARAM]): Unit = extern
  ...
  def i2d_PKCS8PrivateKey(a : Ptr[EVP_PKEY], pp : Ptr[Ptr[CUnsignedChar]]): CInt = extern
  ...
  def sk_ASN1_GENERALSTRING_freefunc_thunk(freefunc_arg : OPENSSL_sk_freefunc, ptr : Ptr[Byte]): Unit = extern

  def sk_ASN1_INTEGER_freefunc_thunk(freefunc_arg : OPENSSL_sk_freefunc, ptr : Ptr[Byte]): Unit = extern

  def sk_ASN1_OBJECT_freefunc_thunk(freefunc_arg : OPENSSL_sk_freefunc, ptr : Ptr[Byte]): Unit = extern

  def sk_ASN1_STRING_TABLE_freefunc_thunk(freefunc_arg : OPENSSL_sk_freefunc, ptr : Ptr[Byte]): Unit = extern

  def sk_ASN1_TYPE_freefunc_thunk(freefunc_arg : OPENSSL_sk_freefunc, ptr : Ptr[Byte]): Unit = extern

  def sk_ASN1_UTF8STRING_freefunc_thunk(freefunc_arg : OPENSSL_sk_freefunc, ptr : Ptr[Byte]): Unit = extern

  def sk_BIO_freefunc_thunk(freefunc_arg : OPENSSL_sk_freefunc, ptr : Ptr[Byte]): Unit = extern

  def sk_OPENSSL_BLOCK_freefunc_thunk(freefunc_arg : OPENSSL_sk_freefunc, ptr : Ptr[Byte]): Unit = extern

  def sk_OPENSSL_CSTRING_freefunc_thunk(freefunc_arg : OPENSSL_sk_freefunc, ptr : Ptr[Byte]): Unit = extern

  def sk_OPENSSL_STRING_freefunc_thunk(freefunc_arg : OPENSSL_sk_freefunc, ptr : Ptr[Byte]): Unit = extern

  def sk_X509_ALGOR_freefunc_thunk(freefunc_arg : OPENSSL_sk_freefunc, ptr : Ptr[Byte]): Unit = extern

  def sk_void_freefunc_thunk(freefunc_arg : OPENSSL_sk_freefunc, ptr : Ptr[Byte]): Unit = extern
...
object all:
  ...
  export _root_.openssl.aliases.OPENSSL_sk_freefunc_thunk
  export _root_.openssl.aliases.OSSL_CALLBACK
  export _root_.openssl.aliases.OSSL_FUNC
  ...
  export _root_.openssl.aliases.OSSL_FUNC_SSL_QUIC_TLS_alert_fn
  export _root_.openssl.aliases.OSSL_FUNC_SSL_QUIC_TLS_crypto_recv_rcd_fn
  export _root_.openssl.aliases.OSSL_FUNC_SSL_QUIC_TLS_crypto_release_rcd_fn
  export _root_.openssl.aliases.OSSL_FUNC_SSL_QUIC_TLS_crypto_send_fn
  export _root_.openssl.aliases.OSSL_FUNC_SSL_QUIC_TLS_got_transport_params_fn
  export _root_.openssl.aliases.OSSL_FUNC_SSL_QUIC_TLS_yield_secret_fn
  ...
  export _root_.openssl.aliases.OSSL_FUNC_cipher_decrypt_skey_init_fn
  export _root_.openssl.aliases.OSSL_FUNC_cipher_dupctx_fn
  export _root_.openssl.aliases.OSSL_FUNC_cipher_encrypt_init_fn
  export _root_.openssl.aliases.OSSL_FUNC_cipher_encrypt_skey_init_fn
  ...
  export _root_.openssl.aliases.OSSL_FUNC_cipher_pipeline_decrypt_init_fn
  export _root_.openssl.aliases.OSSL_FUNC_cipher_pipeline_encrypt_init_fn
  export _root_.openssl.aliases.OSSL_FUNC_cipher_pipeline_final_fn
  export _root_.openssl.aliases.OSSL_FUNC_cipher_pipeline_update_fn
  ...
  export _root_.openssl.aliases.OSSL_FUNC_cleanup_user_entropy_fn
  export _root_.openssl.aliases.OSSL_FUNC_cleanup_user_nonce_fn
  export _root_.openssl.aliases.OSSL_FUNC_core_clear_last_error_mark_fn
  export _root_.openssl.aliases.OSSL_FUNC_core_count_to_mark_fn
  ...
  export _root_.openssl.aliases.OSSL_FUNC_digest_copyctx_fn
  ...
  export _root_.openssl.aliases.OSSL_FUNC_digest_squeeze_fn
  ...
  export _root_.openssl.aliases.OSSL_FUNC_get_user_entropy_fn
  export _root_.openssl.aliases.OSSL_FUNC_get_user_nonce_fn
  export _root_.openssl.aliases.OSSL_FUNC_indicator_cb_fn
  export _root_.openssl.aliases.OSSL_FUNC_kdf_derive_fn
  export _root_.openssl.aliases.OSSL_FUNC_kdf_derive_skey_fn
  ...
  export _root_.openssl.aliases.OSSL_FUNC_kdf_set_skey_fn
  export _root_.openssl.aliases.OSSL_FUNC_kdf_settable_ctx_params_fn
  export _root_.openssl.aliases.OSSL_FUNC_kem_auth_decapsulate_init_fn
  export _root_.openssl.aliases.OSSL_FUNC_kem_auth_encapsulate_init_fn
  ...
  export _root_.openssl.aliases.OSSL_FUNC_keyexch_derive_skey_fn
  ...
  export _root_.openssl.aliases.OSSL_FUNC_keymgmt_export_types_ex_fn
  ...
  export _root_.openssl.aliases.OSSL_FUNC_keymgmt_gen_get_params_fn
  export _root_.openssl.aliases.OSSL_FUNC_keymgmt_gen_gettable_params_fn
  ...
  export _root_.openssl.aliases.OSSL_FUNC_keymgmt_import_types_ex_fn
  ...
  export _root_.openssl.aliases.OSSL_FUNC_mac_init_skey_fn
  ...
  export _root_.openssl.aliases.OSSL_FUNC_provider_random_bytes_fn
  ...
  export _root_.openssl.aliases.OSSL_FUNC_signature_query_key_types_fn
  ...
  export _root_.openssl.aliases.OSSL_FUNC_signature_sign_message_final_fn
  export _root_.openssl.aliases.OSSL_FUNC_signature_sign_message_init_fn
  export _root_.openssl.aliases.OSSL_FUNC_signature_sign_message_update_fn
  ...
  export _root_.openssl.aliases.OSSL_FUNC_signature_verify_message_final_fn
  export _root_.openssl.aliases.OSSL_FUNC_signature_verify_message_init_fn
  export _root_.openssl.aliases.OSSL_FUNC_signature_verify_message_update_fn
  ...
  export _root_.openssl.aliases.OSSL_FUNC_skeymgmt_export_fn
  export _root_.openssl.aliases.OSSL_FUNC_skeymgmt_free_fn
  export _root_.openssl.aliases.OSSL_FUNC_skeymgmt_gen_settable_params_fn
  export _root_.openssl.aliases.OSSL_FUNC_skeymgmt_generate_fn
  export _root_.openssl.aliases.OSSL_FUNC_skeymgmt_get_key_id_fn
  export _root_.openssl.aliases.OSSL_FUNC_skeymgmt_imp_settable_params_fn
  export _root_.openssl.aliases.OSSL_FUNC_skeymgmt_import_fn
  export _root_.openssl.aliases.OSSL_FUNC_store_attach_fn
  export _root_.openssl.aliases.OSSL_FUNC_store_close_fn
  export _root_.openssl.aliases.OSSL_FUNC_store_delete_fn
  ...
  export _root_.openssl.aliases.OSSL_FUNC_store_open_ex_fn
  ...
  export _root_.openssl.aliases.OSSL_INDICATOR_CALLBACK
  export _root_.openssl.aliases.OSSL_INOUT_CALLBACK
  export _root_.openssl.aliases.OSSL_PASSPHRASE_CALLBACK
  export _root_.openssl.aliases.OSSL_i2d_of_void_ctx
  ...
  export _root_.openssl.aliases.uintptr_t
  ...
  export _root_.openssl.structs.BIO_MMSG_CB_ARGS
  export _root_.openssl.structs.BIO_MSG
  export _root_.openssl.structs.BIO_POLL_DESCRIPTOR
  ...
  export _root_.openssl.structs.EVP_SKEY
  export _root_.openssl.structs.EVP_SKEYMGMT
  ...
  export _root_.openssl.structs.bio_mmsg_cb_args_st
  export _root_.openssl.structs.bio_msg_st
  export _root_.openssl.structs.bio_poll_descriptor_st
  ...
  export _root_.openssl.structs.evp_skey_st
  export _root_.openssl.structs.evp_skeymgmt_st
  ...
  export _root_.openssl.functions.ASN1_item_unpack_ex
  ...
  export _root_.openssl.functions.BIO_ADDR_copy
  export _root_.openssl.functions.BIO_ADDR_dup
  ...
  export _root_.openssl.functions.BIO_err_is_non_fatal
  ...
  export _root_.openssl.functions.BIO_get_rpoll_descriptor
  export _root_.openssl.functions.BIO_get_shutdown
  export _root_.openssl.functions.BIO_get_wpoll_descriptor
  ...
  export _root_.openssl.functions.BIO_meth_get_recvmmsg
  export _root_.openssl.functions.BIO_meth_get_sendmmsg
  ...
  export _root_.openssl.functions.BIO_meth_set_recvmmsg
  export _root_.openssl.functions.BIO_meth_set_sendmmsg
  ...
  export _root_.openssl.functions.BIO_new_bio_dgram_pair
  ...
  export _root_.openssl.functions.BIO_recvmmsg
  ...
  export _root_.openssl.functions.BIO_s_dgram_mem
  export _root_.openssl.functions.BIO_s_dgram_pair
  ...
  export _root_.openssl.functions.BIO_sendmmsg
  ...
  export _root_.openssl.functions.BN_signed_bin2bn
  export _root_.openssl.functions.BN_signed_bn2bin
  export _root_.openssl.functions.BN_signed_bn2lebin
  export _root_.openssl.functions.BN_signed_bn2native
  export _root_.openssl.functions.BN_signed_lebin2bn
  export _root_.openssl.functions.BN_signed_native2bn
  ...
  export _root_.openssl.functions.CRYPTO_aligned_alloc
  export _root_.openssl.functions.CRYPTO_aligned_alloc_array
  export _root_.openssl.functions.CRYPTO_alloc_ex_data
  export _root_.openssl.functions.CRYPTO_atomic_add
  export _root_.openssl.functions.CRYPTO_atomic_add64
  export _root_.openssl.functions.CRYPTO_atomic_and
  export _root_.openssl.functions.CRYPTO_atomic_load
  export _root_.openssl.functions.CRYPTO_atomic_load_int
  export _root_.openssl.functions.CRYPTO_atomic_or
  export _root_.openssl.functions.CRYPTO_atomic_store
  export _root_.openssl.functions.CRYPTO_calloc
  export _root_.openssl.functions.CRYPTO_clear_free
  export _root_.openssl.functions.CRYPTO_clear_realloc
  export _root_.openssl.functions.CRYPTO_clear_realloc_array
  ...
  export _root_.openssl.functions.CRYPTO_malloc_array
  ...
  export _root_.openssl.functions.CRYPTO_secure_malloc_array
  ...
  export _root_.openssl.functions.EVP_CIPHER_CTX_get_algor
  export _root_.openssl.functions.EVP_CIPHER_CTX_get_algor_params
  ...
  export _root_.openssl.functions.EVP_CIPHER_CTX_set_algor_params
  ...
  export _root_.openssl.functions.EVP_CIPHER_can_pipeline
  ...
  export _root_.openssl.functions.EVP_CipherInit_SKEY
  export _root_.openssl.functions.EVP_CipherInit_ex
  export _root_.openssl.functions.EVP_CipherInit_ex2
  export _root_.openssl.functions.EVP_CipherPipelineDecryptInit
  export _root_.openssl.functions.EVP_CipherPipelineEncryptInit
  export _root_.openssl.functions.EVP_CipherPipelineFinal
  export _root_.openssl.functions.EVP_CipherPipelineUpdate
  ...
  export _root_.openssl.functions.EVP_DigestSqueeze
  ...
  export _root_.openssl.functions.EVP_KEYMGMT_gen_gettable_params
  ...
  export _root_.openssl.functions.EVP_MAC_init_SKEY
  ...
  export _root_.openssl.functions.EVP_MD_CTX_get_size_ex
  ...
  export _root_.openssl.functions.EVP_MD_xof
  ...
  export _root_.openssl.functions.EVP_PKEY_CTX_get_algor
  export _root_.openssl.functions.EVP_PKEY_CTX_get_algor_params
  ...
  export _root_.openssl.functions.EVP_PKEY_CTX_set_algor_params
  ...
  export _root_.openssl.functions.EVP_PKEY_CTX_set_signature
  ...
  export _root_.openssl.functions.EVP_PKEY_auth_decapsulate_init
  export _root_.openssl.functions.EVP_PKEY_auth_encapsulate_init
  ...
  export _root_.openssl.functions.EVP_PKEY_derive_SKEY
  ...
  export _root_.openssl.functions.EVP_PKEY_get_security_category
  ...
  export _root_.openssl.functions.EVP_PKEY_sign_init_ex2
  export _root_.openssl.functions.EVP_PKEY_sign_message_final
  export _root_.openssl.functions.EVP_PKEY_sign_message_init
  export _root_.openssl.functions.EVP_PKEY_sign_message_update
  ...
  export _root_.openssl.functions.EVP_PKEY_verify_init_ex2
  export _root_.openssl.functions.EVP_PKEY_verify_message_final
  export _root_.openssl.functions.EVP_PKEY_verify_message_init
  export _root_.openssl.functions.EVP_PKEY_verify_message_update
  ...
  export _root_.openssl.functions.EVP_PKEY_verify_recover_init_ex2
  ...
  export _root_.openssl.functions.EVP_SKEYMGMT_do_all_provided
  export _root_.openssl.functions.EVP_SKEYMGMT_fetch
  export _root_.openssl.functions.EVP_SKEYMGMT_free
  export _root_.openssl.functions.EVP_SKEYMGMT_get0_description
  export _root_.openssl.functions.EVP_SKEYMGMT_get0_gen_settable_params
  export _root_.openssl.functions.EVP_SKEYMGMT_get0_imp_settable_params
  export _root_.openssl.functions.EVP_SKEYMGMT_get0_name
  export _root_.openssl.functions.EVP_SKEYMGMT_get0_provider
  export _root_.openssl.functions.EVP_SKEYMGMT_is_a
  export _root_.openssl.functions.EVP_SKEYMGMT_names_do_all
  export _root_.openssl.functions.EVP_SKEYMGMT_up_ref
  export _root_.openssl.functions.EVP_SKEY_export
  export _root_.openssl.functions.EVP_SKEY_free
  export _root_.openssl.functions.EVP_SKEY_generate
  export _root_.openssl.functions.EVP_SKEY_get0_key_id
  export _root_.openssl.functions.EVP_SKEY_get0_provider_name
  export _root_.openssl.functions.EVP_SKEY_get0_raw_key
  export _root_.openssl.functions.EVP_SKEY_get0_skeymgmt_name
  export _root_.openssl.functions.EVP_SKEY_import
  export _root_.openssl.functions.EVP_SKEY_import_SKEYMGMT
  export _root_.openssl.functions.EVP_SKEY_import_raw_key
  export _root_.openssl.functions.EVP_SKEY_is_a
  export _root_.openssl.functions.EVP_SKEY_to_provider
  export _root_.openssl.functions.EVP_SKEY_up_ref
  ...
  export _root_.openssl.functions.EVP_get1_default_properties
  ...
  export _root_.openssl.functions.OPENSSL_sk_set_thunks
  ...
  export _root_.openssl.functions.OPENSSL_strtoul
  ...
  export _root_.openssl.functions.OSSL_FUNC_SSL_QUIC_TLS_alert
  export _root_.openssl.functions.OSSL_FUNC_SSL_QUIC_TLS_crypto_recv_rcd
  export _root_.openssl.functions.OSSL_FUNC_SSL_QUIC_TLS_crypto_release_rcd
  export _root_.openssl.functions.OSSL_FUNC_SSL_QUIC_TLS_crypto_send
  export _root_.openssl.functions.OSSL_FUNC_SSL_QUIC_TLS_got_transport_params
  export _root_.openssl.functions.OSSL_FUNC_SSL_QUIC_TLS_yield_secret
  ...
  export _root_.openssl.functions.OSSL_FUNC_cipher_decrypt_skey_init
  export _root_.openssl.functions.OSSL_FUNC_cipher_dupctx
  export _root_.openssl.functions.OSSL_FUNC_cipher_encrypt_init
  export _root_.openssl.functions.OSSL_FUNC_cipher_encrypt_skey_init
  ...
  export _root_.openssl.functions.OSSL_FUNC_cipher_pipeline_decrypt_init
  export _root_.openssl.functions.OSSL_FUNC_cipher_pipeline_encrypt_init
  export _root_.openssl.functions.OSSL_FUNC_cipher_pipeline_final
  export _root_.openssl.functions.OSSL_FUNC_cipher_pipeline_update
  ...
  export _root_.openssl.functions.OSSL_FUNC_cleanup_user_entropy
  export _root_.openssl.functions.OSSL_FUNC_cleanup_user_nonce
  export _root_.openssl.functions.OSSL_FUNC_core_clear_last_error_mark
  export _root_.openssl.functions.OSSL_FUNC_core_count_to_mark
  ...
  export _root_.openssl.functions.OSSL_FUNC_digest_copyctx
  ...
  export _root_.openssl.functions.OSSL_FUNC_digest_squeeze
  ...
  export _root_.openssl.functions.OSSL_FUNC_get_user_entropy
  export _root_.openssl.functions.OSSL_FUNC_get_user_nonce
  export _root_.openssl.functions.OSSL_FUNC_indicator_cb
  export _root_.openssl.functions.OSSL_FUNC_kdf_derive
  export _root_.openssl.functions.OSSL_FUNC_kdf_derive_skey
  ...
  export _root_.openssl.functions.OSSL_FUNC_kdf_set_skey
  export _root_.openssl.functions.OSSL_FUNC_kdf_settable_ctx_params
  export _root_.openssl.functions.OSSL_FUNC_kem_auth_decapsulate_init
  export _root_.openssl.functions.OSSL_FUNC_kem_auth_encapsulate_init
  ...
  export _root_.openssl.functions.OSSL_FUNC_keyexch_derive_skey
  ...
  export _root_.openssl.functions.OSSL_FUNC_keymgmt_export_types_ex
  ...
  export _root_.openssl.functions.OSSL_FUNC_keymgmt_gen_get_params
  export _root_.openssl.functions.OSSL_FUNC_keymgmt_gen_gettable_params
  ...
  export _root_.openssl.functions.OSSL_FUNC_keymgmt_import_types_ex
  ...
  export _root_.openssl.functions.OSSL_FUNC_mac_init_skey
  ...
  export _root_.openssl.functions.OSSL_FUNC_provider_random_bytes
  ...
  export _root_.openssl.functions.OSSL_FUNC_signature_query_key_types
  ...
  export _root_.openssl.functions.OSSL_FUNC_signature_sign_message_final
  export _root_.openssl.functions.OSSL_FUNC_signature_sign_message_init
  export _root_.openssl.functions.OSSL_FUNC_signature_sign_message_update
  ...
  export _root_.openssl.functions.OSSL_FUNC_signature_verify_message_final
  export _root_.openssl.functions.OSSL_FUNC_signature_verify_message_init
  export _root_.openssl.functions.OSSL_FUNC_signature_verify_message_update
  ...
  export _root_.openssl.functions.OSSL_FUNC_skeymgmt_export
  export _root_.openssl.functions.OSSL_FUNC_skeymgmt_free
  export _root_.openssl.functions.OSSL_FUNC_skeymgmt_gen_settable_params
  export _root_.openssl.functions.OSSL_FUNC_skeymgmt_generate
  export _root_.openssl.functions.OSSL_FUNC_skeymgmt_get_key_id
  export _root_.openssl.functions.OSSL_FUNC_skeymgmt_imp_settable_params
  export _root_.openssl.functions.OSSL_FUNC_skeymgmt_import
  export _root_.openssl.functions.OSSL_FUNC_store_attach
  export _root_.openssl.functions.OSSL_FUNC_store_close
  export _root_.openssl.functions.OSSL_FUNC_store_delete
  ...
  export _root_.openssl.functions.OSSL_FUNC_store_open_ex
  ...
  export _root_.openssl.functions.OSSL_INDICATOR_get_callback
  export _root_.openssl.functions.OSSL_INDICATOR_set_callback
  export _root_.openssl.functions.OSSL_LIB_CTX_free
  export _root_.openssl.functions.OSSL_LIB_CTX_get0_global_default
  export _root_.openssl.functions.OSSL_LIB_CTX_get_conf_diagnostics
  export _root_.openssl.functions.OSSL_LIB_CTX_get_data
  ...
  export _root_.openssl.functions.OSSL_LIB_CTX_set_conf_diagnostics
  ...
  export _root_.openssl.functions.OSSL_PARAM_print_to_bio
  ...
  export _root_.openssl.functions.OSSL_PARAM_set_octet_string_or_ptr
  ...
  export _root_.openssl.functions.OSSL_sleep
  ...
  export _root_.openssl.functions.i2d_PKCS8PrivateKey
  ...
  export _root_.openssl.functions.sk_ASN1_GENERALSTRING_freefunc_thunk
  export _root_.openssl.functions.sk_ASN1_INTEGER_freefunc_thunk
  export _root_.openssl.functions.sk_ASN1_OBJECT_freefunc_thunk
  export _root_.openssl.functions.sk_ASN1_STRING_TABLE_freefunc_thunk
  export _root_.openssl.functions.sk_ASN1_TYPE_freefunc_thunk
  export _root_.openssl.functions.sk_ASN1_UTF8STRING_freefunc_thunk
  export _root_.openssl.functions.sk_BIO_freefunc_thunk
  export _root_.openssl.functions.sk_OPENSSL_BLOCK_freefunc_thunk
  export _root_.openssl.functions.sk_OPENSSL_CSTRING_freefunc_thunk
  export _root_.openssl.functions.sk_OPENSSL_STRING_freefunc_thunk
  export _root_.openssl.functions.sk_X509_ALGOR_freefunc_thunk
  export _root_.openssl.functions.sk_void_freefunc_thunk
