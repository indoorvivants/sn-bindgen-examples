...
object structs:
  ...
  */
  ...
  object cmark_mem:
    ...
    export fields.*
    private[cmark] object fields:
      extension (struct: cmark_mem)
        inline def calloc : CFuncPtr2[size_t, size_t, Ptr[Byte]] = struct._1
        inline def calloc_=(value: CFuncPtr2[size_t, size_t, Ptr[Byte]]): Unit = (!struct.at1 = value)
        inline def realloc : CFuncPtr2[Ptr[Byte], size_t, Ptr[Byte]] = struct._2
        inline def realloc_=(value: CFuncPtr2[Ptr[Byte], size_t, Ptr[Byte]]): Unit = (!struct.at2 = value)
        inline def free : CFuncPtr1[Ptr[Byte], Unit] = struct._3
        inline def free_=(value: CFuncPtr1[Ptr[Byte], Unit]): Unit = (!struct.at3 = value)
      end extension
...
private[cmark] object extern_functions:
  ...
  */
  def cmark_node_is_block(node : Ptr[cmark_node]): Boolean = extern

  /**
   * Returns true if the node is an inline node.
  */
  def cmark_node_is_inline(node : Ptr[cmark_node]): Boolean = extern

  /**
   * Returns true if the node is a leaf node (a node that cannot contain children).
  */
  def cmark_node_is_leaf(node : Ptr[cmark_node]): Boolean = extern
...
object all:
  ...
  export _root_.cmark.functions.cmark_node_is_block
  export _root_.cmark.functions.cmark_node_is_inline
  export _root_.cmark.functions.cmark_node_is_leaf
