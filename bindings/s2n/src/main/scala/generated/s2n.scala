...
object enumerations:
  ...
  */
  ...
  /**
   * A metric to determine whether or not the server found a certificate that matched the client's SNI extension.
  */
  opaque type s2n_cert_sni_match = CUnsignedInt
  object s2n_cert_sni_match extends _BindgenEnumCUnsignedInt[s2n_cert_sni_match]:
    given _tag: Tag[s2n_cert_sni_match] = Tag.UInt
    inline def define(inline a: Long): s2n_cert_sni_match = a.toUInt
    val S2N_SNI_NONE = define(1)
    val S2N_SNI_EXACT_MATCH = define(2)
    val S2N_SNI_WILDCARD_MATCH = define(3)
    val S2N_SNI_NO_MATCH = define(4)
    def getName(value: s2n_cert_sni_match): Option[String] =
      value match
        case `S2N_SNI_NONE` => Some("S2N_SNI_NONE")
        case `S2N_SNI_EXACT_MATCH` => Some("S2N_SNI_EXACT_MATCH")
        case `S2N_SNI_WILDCARD_MATCH` => Some("S2N_SNI_WILDCARD_MATCH")
        case `S2N_SNI_NO_MATCH` => Some("S2N_SNI_NO_MATCH")
        case _ => _root_.scala.None
    extension (a: s2n_cert_sni_match)
      inline def &(b: s2n_cert_sni_match): s2n_cert_sni_match = a & b
      inline def |(b: s2n_cert_sni_match): s2n_cert_sni_match = a | b
      inline def is(b: s2n_cert_sni_match): Boolean = (a & b) == b
  ...
  */
  ...
  opaque type s2n_fips_mode = CUnsignedInt
  object s2n_fips_mode extends _BindgenEnumCUnsignedInt[s2n_fips_mode]:
    given _tag: Tag[s2n_fips_mode] = Tag.UInt
    inline def define(inline a: Long): s2n_fips_mode = a.toUInt
    val S2N_FIPS_MODE_DISABLED = define(0)
    val S2N_FIPS_MODE_ENABLED = define(1)
    def getName(value: s2n_fips_mode): Option[String] =
      value match
        case `S2N_FIPS_MODE_DISABLED` => Some("S2N_FIPS_MODE_DISABLED")
        case `S2N_FIPS_MODE_ENABLED` => Some("S2N_FIPS_MODE_ENABLED")
        case _ => _root_.scala.None
    extension (a: s2n_fips_mode)
      inline def &(b: s2n_fips_mode): s2n_fips_mode = a & b
      inline def |(b: s2n_fips_mode): s2n_fips_mode = a | b
      inline def is(b: s2n_fips_mode): Boolean = (a & b) == b
  ...
  */
  opaque type s2n_peer_key_update = CUnsignedInt
  object s2n_peer_key_update extends _BindgenEnumCUnsignedInt[s2n_peer_key_update]:
    given _tag: Tag[s2n_peer_key_update] = Tag.UInt
    inline def define(inline a: Long): s2n_peer_key_update = a.toUInt
    val S2N_KEY_UPDATE_NOT_REQUESTED = define(0)
    val S2N_KEY_UPDATE_REQUESTED = define(1)
    def getName(value: s2n_peer_key_update): Option[String] =
      value match
        case `S2N_KEY_UPDATE_NOT_REQUESTED` => Some("S2N_KEY_UPDATE_NOT_REQUESTED")
        case `S2N_KEY_UPDATE_REQUESTED` => Some("S2N_KEY_UPDATE_REQUESTED")
        case _ => _root_.scala.None
    extension (a: s2n_peer_key_update)
      inline def &(b: s2n_peer_key_update): s2n_peer_key_update = a & b
      inline def |(b: s2n_peer_key_update): s2n_peer_key_update = a | b
      inline def is(b: s2n_peer_key_update): Boolean = (a & b) == b
  ...
  */
  ...
  opaque type s2n_serialization_version = CUnsignedInt
  object s2n_serialization_version extends _BindgenEnumCUnsignedInt[s2n_serialization_version]:
    given _tag: Tag[s2n_serialization_version] = Tag.UInt
    inline def define(inline a: Long): s2n_serialization_version = a.toUInt
    val S2N_SERIALIZED_CONN_NONE = define(0)
    val S2N_SERIALIZED_CONN_V1 = define(1)
    def getName(value: s2n_serialization_version): Option[String] =
      value match
        case `S2N_SERIALIZED_CONN_NONE` => Some("S2N_SERIALIZED_CONN_NONE")
        case `S2N_SERIALIZED_CONN_V1` => Some("S2N_SERIALIZED_CONN_V1")
        case _ => _root_.scala.None
    extension (a: s2n_serialization_version)
      inline def &(b: s2n_serialization_version): s2n_serialization_version = a & b
      inline def |(b: s2n_serialization_version): s2n_serialization_version = a | b
      inline def is(b: s2n_serialization_version): Boolean = (a & b) == b
  ...
  */
  ...
  object s2n_tls_extension_type extends _BindgenEnumCUnsignedInt[s2n_tls_extension_type]:
    ...
    val S2N_EXTENSION_SUPPORTED_VERSIONS = define(43)
    ...
    def getName(value: s2n_tls_extension_type): Option[String] =
      value match
        ...
        case `S2N_EXTENSION_SUPPORTED_VERSIONS` => Some("S2N_EXTENSION_SUPPORTED_VERSIONS")
  ...
  */
  ...
  object s2n_tls_signature_algorithm extends _BindgenEnumCUnsignedInt[s2n_tls_signature_algorithm]:
    ...
    val S2N_TLS_SIGNATURE_MLDSA = define(9)
    ...
    def getName(value: s2n_tls_signature_algorithm): Option[String] =
      value match
        ...
        case `S2N_TLS_SIGNATURE_MLDSA` => Some("S2N_TLS_SIGNATURE_MLDSA")
...
private[s2n] object extern_functions:
  ...
  */
  ...
  /**
   * Associates a public certificate chain with a `s2n_cert_chain_and_key` object. It does NOT set a private key, so the connection will need to be configured to [offload private key operations](https://github.com/aws/s2n-tls/blob/main/docs/usage-guide/topics/ch12-private-key-ops.md).
  */
  ...
  */
  ...
  def s2n_cleanup_final(): CInt = extern
  ...
  */
  def s2n_client_hello_free(ch : Ptr[Ptr[s2n_client_hello]]): CInt = extern
  ...
  */
  def s2n_client_hello_get_compression_methods(ch : Ptr[s2n_client_hello], list : Ptr[uint8_t], list_length : uint32_t, out_length : Ptr[uint32_t]): CInt = extern

  /**
   * Get the length of the compression methods list sent in the Client Hello.
  */
  def s2n_client_hello_get_compression_methods_length(ch : Ptr[s2n_client_hello], out_length : Ptr[uint32_t]): CInt = extern
  ...
  */
  def s2n_client_hello_get_legacy_protocol_version(ch : Ptr[s2n_client_hello], out : Ptr[uint8_t]): CInt = extern

  /**
   * Access the protocol version from the header of the first record that contained the ClientHello message.
  */
  def s2n_client_hello_get_legacy_record_version(ch : Ptr[s2n_client_hello], out : Ptr[uint8_t]): CInt = extern

  /**
   * Retrieves the client random value from the Client Hello.
  */
  def s2n_client_hello_get_random(ch : Ptr[s2n_client_hello], out : Ptr[uint8_t], max_length : uint32_t): CInt = extern
  ...
  */
  def s2n_client_hello_get_server_name(ch : Ptr[s2n_client_hello], server_name : Ptr[uint8_t], length : uint16_t, out_length : Ptr[uint16_t]): CInt = extern

  /**
   * Gets the length of the first server name in a Client Hello.
  */
  def s2n_client_hello_get_server_name_length(ch : Ptr[s2n_client_hello], length : Ptr[uint16_t]): CInt = extern
  ...
  */
  def s2n_client_hello_get_supported_groups(ch : Ptr[s2n_client_hello], groups : Ptr[uint16_t], groups_count_max : uint16_t, groups_count : Ptr[uint16_t]): CInt = extern
  ...
  */
  def s2n_client_hello_parse_message(bytes : Ptr[uint8_t], size : uint32_t): Ptr[s2n_client_hello] = extern
  ...
  */
  ...
  def s2n_config_disable_x509_intent_verification(config : Ptr[s2n_config]): CInt = extern

  /**
   * Disables timestamp validation for received certificates.
  */
  def s2n_config_disable_x509_time_verification(config : Ptr[s2n_config]): CInt = extern
  ...
  */
  def s2n_config_get_supported_groups(config : Ptr[s2n_config], groups : Ptr[uint16_t], groups_count_max : uint16_t, groups_count : Ptr[uint16_t]): CInt = extern

  /**
   * Loads default system certificates into the trust store.
  */
  def s2n_config_load_system_certs(config : Ptr[s2n_config]): CInt = extern
  ...
  */
  def s2n_config_new_minimal(): Ptr[s2n_config] = extern

  /**
   * Requires that session tickets are only used when forward secrecy is possible.
  */
  def s2n_config_require_ticket_forward_secrecy(config : Ptr[s2n_config], enabled : Boolean): CInt = extern
  ...
  */
  ...
  def s2n_config_set_cert_authorities_from_trust_store(config : Ptr[s2n_config]): CInt = extern
  ...
  */
  def s2n_config_set_max_blinding_delay(config : Ptr[s2n_config], seconds : uint32_t): CInt = extern
  ...
  */
  def s2n_config_set_serialization_version(config : Ptr[s2n_config], version : s2n_serialization_version): CInt = extern
  ...
  */
  def s2n_connection_deserialize(conn : Ptr[s2n_connection], buffer : Ptr[uint8_t], buffer_length : uint32_t): CInt = extern
  ...
  */
  def s2n_connection_get_certificate_match(conn : Ptr[s2n_connection], match_status : Ptr[s2n_cert_sni_match]): CInt = extern
  ...
  */
  def s2n_connection_get_key_exchange_group(conn : Ptr[s2n_connection], group_name : Ptr[CString]): CInt = extern
  ...
  */
  def s2n_connection_get_master_secret(conn : Ptr[s2n_connection], secret_bytes : Ptr[uint8_t], max_size : size_t): CInt = extern
  ...
  */
  def s2n_connection_get_signature_scheme(conn : Ptr[s2n_connection], scheme_name : Ptr[CString]): CInt = extern
  ...
  */
  def s2n_connection_request_key_update(conn : Ptr[s2n_connection], peer_request : s2n_peer_key_update): CInt = extern
  ...
  */
  def s2n_connection_serialization_length(conn : Ptr[s2n_connection], length : Ptr[uint32_t]): CInt = extern

  /**
   * Serializes the s2n_connection into the provided buffer.
  */
  def s2n_connection_serialize(conn : Ptr[s2n_connection], buffer : Ptr[uint8_t], buffer_length : uint32_t): CInt = extern
  ...
  */
  def s2n_connection_set_recv_buffering(conn : Ptr[s2n_connection], enabled : Boolean): CInt = extern
  ...
  */
  def s2n_connection_tls_exporter(conn : Ptr[s2n_connection], label : Ptr[uint8_t], label_length : uint32_t, context : Ptr[uint8_t], context_length : uint32_t, output : Ptr[uint8_t], output_length : uint32_t): CInt = extern
  ...
  */
  def s2n_get_fips_mode(fips_mode : Ptr[s2n_fips_mode]): CInt = extern
  ...
  */
  def s2n_peek_buffered(conn : Ptr[s2n_connection]): uint32_t = extern
  ...
  */
  def s2n_shutdown_send(conn : Ptr[s2n_connection], blocked : Ptr[s2n_blocked_status]): CInt = extern
  ...
  */
  def s2n_strerror_source(error : CInt): CString = extern
...
object all:
  ...
  export _root_.s2n.enumerations.s2n_cert_sni_match
  ...
  export _root_.s2n.functions.s2n_cleanup_final
  export _root_.s2n.functions.s2n_client_hello_cb_done
  export _root_.s2n.functions.s2n_client_hello_free
  ...
  export _root_.s2n.functions.s2n_client_hello_get_compression_methods
  export _root_.s2n.functions.s2n_client_hello_get_compression_methods_length
  ...
  export _root_.s2n.functions.s2n_client_hello_get_legacy_protocol_version
  export _root_.s2n.functions.s2n_client_hello_get_legacy_record_version
  export _root_.s2n.functions.s2n_client_hello_get_random
  ...
  export _root_.s2n.functions.s2n_client_hello_get_server_name
  export _root_.s2n.functions.s2n_client_hello_get_server_name_length
  ...
  export _root_.s2n.functions.s2n_client_hello_get_supported_groups
  export _root_.s2n.functions.s2n_client_hello_has_extension
  export _root_.s2n.functions.s2n_client_hello_parse_message
  ...
  export _root_.s2n.functions.s2n_config_disable_x509_intent_verification
  export _root_.s2n.functions.s2n_config_disable_x509_time_verification
  ...
  export _root_.s2n.functions.s2n_config_get_supported_groups
  export _root_.s2n.functions.s2n_config_load_system_certs
  export _root_.s2n.functions.s2n_config_new
  export _root_.s2n.functions.s2n_config_new_minimal
  export _root_.s2n.functions.s2n_config_require_ticket_forward_secrecy
  ...
  export _root_.s2n.functions.s2n_config_set_cert_authorities_from_trust_store
  ...
  export _root_.s2n.functions.s2n_config_set_max_blinding_delay
  ...
  export _root_.s2n.functions.s2n_config_set_serialization_version
  ...
  export _root_.s2n.functions.s2n_connection_deserialize
  ...
  export _root_.s2n.functions.s2n_connection_get_certificate_match
  ...
  export _root_.s2n.functions.s2n_connection_get_key_exchange_group
  export _root_.s2n.functions.s2n_connection_get_last_message_name
  export _root_.s2n.functions.s2n_connection_get_master_secret
  ...
  export _root_.s2n.functions.s2n_connection_get_signature_scheme
  ...
  export _root_.s2n.functions.s2n_connection_request_key_update
  export _root_.s2n.functions.s2n_connection_serialization_length
  export _root_.s2n.functions.s2n_connection_serialize
  ...
  export _root_.s2n.functions.s2n_connection_set_recv_buffering
  ...
  export _root_.s2n.functions.s2n_connection_tls_exporter
  ...
  export _root_.s2n.functions.s2n_get_fips_mode
  ...
  export _root_.s2n.functions.s2n_peek_buffered
  ...
  export _root_.s2n.functions.s2n_shutdown_send
  ...
  export _root_.s2n.functions.s2n_strerror_source