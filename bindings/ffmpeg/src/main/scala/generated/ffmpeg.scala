...
object predef:
    private[ffmpeg] trait _BindgenEnumCUnsignedInt[T](using eq: T =:= CUnsignedInt):
...
object enumerations:
  ...
  object AVActiveFormatDescription extends _BindgenEnumCUnsignedInt[AVActiveFormatDescription]:
    ...
    extension (a: AVActiveFormatDescription)
      inline def &(b: AVActiveFormatDescription): AVActiveFormatDescription = a & b
      inline def |(b: AVActiveFormatDescription): AVActiveFormatDescription = a | b
      inline def is(b: AVActiveFormatDescription): Boolean = (a & b) == b

  opaque type AVAudioServiceType = CUnsignedInt
  object AVAudioServiceType extends _BindgenEnumCUnsignedInt[AVAudioServiceType]:
    ...
    def getName(value: AVAudioServiceType): Option[String] =
      value match
        ...
        case `AV_AUDIO_SERVICE_TYPE_EFFECTS` => Some("AV_AUDIO_SERVICE_TYPE_EFFECTS")
        case `AV_AUDIO_SERVICE_TYPE_VISUALLY_IMPAIRED` => Some("AV_AUDIO_SERVICE_TYPE_VISUALLY_IMPAIRED")
        case `AV_AUDIO_SERVICE_TYPE_HEARING_IMPAIRED` => Some("AV_AUDIO_SERVICE_TYPE_HEARING_IMPAIRED")
        case `AV_AUDIO_SERVICE_TYPE_DIALOGUE` => Some("AV_AUDIO_SERVICE_TYPE_DIALOGUE")
        case `AV_AUDIO_SERVICE_TYPE_COMMENTARY` => Some("AV_AUDIO_SERVICE_TYPE_COMMENTARY")
        case `AV_AUDIO_SERVICE_TYPE_EMERGENCY` => Some("AV_AUDIO_SERVICE_TYPE_EMERGENCY")
        case `AV_AUDIO_SERVICE_TYPE_VOICE_OVER` => Some("AV_AUDIO_SERVICE_TYPE_VOICE_OVER")
        case `AV_AUDIO_SERVICE_TYPE_KARAOKE` => Some("AV_AUDIO_SERVICE_TYPE_KARAOKE")
  ...
  */
  ...
  object AVChannel extends _BindgenEnumCInt[AVChannel]:
    ...
    val AV_CHAN_BINAURAL_LEFT = define(61)
    val AV_CHAN_BINAURAL_RIGHT = define(62)
    ...
    def getName(value: AVChannel): Option[String] =
      value match
        ...
        case `AV_CHAN_FRONT_LEFT_OF_CENTER` => Some("AV_CHAN_FRONT_LEFT_OF_CENTER")
        case `AV_CHAN_FRONT_RIGHT_OF_CENTER` => Some("AV_CHAN_FRONT_RIGHT_OF_CENTER")
        ...
        case `AV_CHAN_SURROUND_DIRECT_LEFT` => Some("AV_CHAN_SURROUND_DIRECT_LEFT")
        case `AV_CHAN_SURROUND_DIRECT_RIGHT` => Some("AV_CHAN_SURROUND_DIRECT_RIGHT")
        ...
        case `AV_CHAN_BOTTOM_FRONT_CENTER` => Some("AV_CHAN_BOTTOM_FRONT_CENTER")
        ...
        case `AV_CHAN_SIDE_SURROUND_RIGHT` => Some("AV_CHAN_SIDE_SURROUND_RIGHT")
        ...
        case `AV_CHAN_BINAURAL_LEFT` => Some("AV_CHAN_BINAURAL_LEFT")
        case `AV_CHAN_BINAURAL_RIGHT` => Some("AV_CHAN_BINAURAL_RIGHT")
  ...
  */
  ...
  object AVClassCategory extends _BindgenEnumCUnsignedInt[AVClassCategory]:
    ...
    val AV_CLASS_CATEGORY_HWDEVICE = define(11)
    ...
    def getName(value: AVClassCategory): Option[String] =
      value match
        ...
        case `AV_CLASS_CATEGORY_BITSTREAM_FILTER` => Some("AV_CLASS_CATEGORY_BITSTREAM_FILTER")
        case `AV_CLASS_CATEGORY_SWSCALER` => Some("AV_CLASS_CATEGORY_SWSCALER")
        case `AV_CLASS_CATEGORY_SWRESAMPLER` => Some("AV_CLASS_CATEGORY_SWRESAMPLER")
        case `AV_CLASS_CATEGORY_HWDEVICE` => Some("AV_CLASS_CATEGORY_HWDEVICE")
        case `AV_CLASS_CATEGORY_DEVICE_VIDEO_OUTPUT` => Some("AV_CLASS_CATEGORY_DEVICE_VIDEO_OUTPUT")
        case `AV_CLASS_CATEGORY_DEVICE_VIDEO_INPUT` => Some("AV_CLASS_CATEGORY_DEVICE_VIDEO_INPUT")
        case `AV_CLASS_CATEGORY_DEVICE_AUDIO_OUTPUT` => Some("AV_CLASS_CATEGORY_DEVICE_AUDIO_OUTPUT")
        case `AV_CLASS_CATEGORY_DEVICE_AUDIO_INPUT` => Some("AV_CLASS_CATEGORY_DEVICE_AUDIO_INPUT")
        case `AV_CLASS_CATEGORY_DEVICE_OUTPUT` => Some("AV_CLASS_CATEGORY_DEVICE_OUTPUT")
        case `AV_CLASS_CATEGORY_DEVICE_INPUT` => Some("AV_CLASS_CATEGORY_DEVICE_INPUT")
  ...
  opaque type AVClassStateFlags = CUnsignedInt
  object AVClassStateFlags extends _BindgenEnumCUnsignedInt[AVClassStateFlags]:
    given _tag: Tag[AVClassStateFlags] = Tag.UInt
    inline def define(inline a: Long): AVClassStateFlags = a.toUInt
    val AV_CLASS_STATE_INITIALIZED = define(1)
    def getName(value: AVClassStateFlags): Option[String] =
      value match
        case `AV_CLASS_STATE_INITIALIZED` => Some("AV_CLASS_STATE_INITIALIZED")
        case _ => _root_.scala.None
    extension (a: AVClassStateFlags)
      inline def &(b: AVClassStateFlags): AVClassStateFlags = a & b
      inline def |(b: AVClassStateFlags): AVClassStateFlags = a | b
      inline def is(b: AVClassStateFlags): Boolean = (a & b) == b
  ...
  object AVCodecConfig extends _BindgenEnumCUnsignedInt[AVCodecConfig]:
    ...
    def getName(value: AVCodecConfig): Option[String] =
      value match
        ...
        case `AV_CODEC_CONFIG_SAMPLE_RATE` => Some("AV_CODEC_CONFIG_SAMPLE_RATE")
        case `AV_CODEC_CONFIG_SAMPLE_FORMAT` => Some("AV_CODEC_CONFIG_SAMPLE_FORMAT")
        case `AV_CODEC_CONFIG_CHANNEL_LAYOUT` => Some("AV_CODEC_CONFIG_CHANNEL_LAYOUT")
        case `AV_CODEC_CONFIG_COLOR_RANGE` => Some("AV_CODEC_CONFIG_COLOR_RANGE")
        case `AV_CODEC_CONFIG_COLOR_SPACE` => Some("AV_CODEC_CONFIG_COLOR_SPACE")
        case _ => _root_.scala.None
  ...
  */
  ...
  object AVCodecID extends _BindgenEnumCUnsignedInt[AVCodecID]:
    ...
    val AV_CODEC_ID_DNXUC = define(270)
    val AV_CODEC_ID_RV60 = define(271)
    val AV_CODEC_ID_JPEGXL_ANIM = define(272)
    val AV_CODEC_ID_APV = define(273)
    val AV_CODEC_ID_PRORES_RAW = define(274)
    ...
    val AV_CODEC_ID_ADPCM_IMA_XBOX = define(69684)
    val AV_CODEC_ID_ADPCM_SANYO = define(69685)
    ...
    val AV_CODEC_ID_G728 = define(86123)
    ...
    val AV_CODEC_ID_IVTV_VBI = define(94234)
    ...
    val AV_CODEC_ID_SMPTE_436M_ANC = define(98317)
    ...
    def getName(value: AVCodecID): Option[String] =
      value match
        ...
        case `AV_CODEC_ID_INTERPLAY_VIDEO` => Some("AV_CODEC_ID_INTERPLAY_VIDEO")
        ...
        case `AV_CODEC_ID_TIERTEXSEQVIDEO` => Some("AV_CODEC_ID_TIERTEXSEQVIDEO")
        ...
        case `AV_CODEC_ID_DNXUC` => Some("AV_CODEC_ID_DNXUC")
        case `AV_CODEC_ID_RV60` => Some("AV_CODEC_ID_RV60")
        case `AV_CODEC_ID_JPEGXL_ANIM` => Some("AV_CODEC_ID_JPEGXL_ANIM")
        case `AV_CODEC_ID_APV` => Some("AV_CODEC_ID_APV")
        case `AV_CODEC_ID_PRORES_RAW` => Some("AV_CODEC_ID_PRORES_RAW")
        ...
        case `AV_CODEC_ID_PCM_S16LE_PLANAR` => Some("AV_CODEC_ID_PCM_S16LE_PLANAR")
        ...
        case `AV_CODEC_ID_PCM_S24LE_PLANAR` => Some("AV_CODEC_ID_PCM_S24LE_PLANAR")
        case `AV_CODEC_ID_PCM_S32LE_PLANAR` => Some("AV_CODEC_ID_PCM_S32LE_PLANAR")
        case `AV_CODEC_ID_PCM_S16BE_PLANAR` => Some("AV_CODEC_ID_PCM_S16BE_PLANAR")
        ...
        case `AV_CODEC_ID_ADPCM_IMA_SMJPEG` => Some("AV_CODEC_ID_ADPCM_IMA_SMJPEG")
        ...
        case `AV_CODEC_ID_ADPCM_IMA_EA_SEAD` => Some("AV_CODEC_ID_ADPCM_IMA_EA_SEAD")
        case `AV_CODEC_ID_ADPCM_IMA_EA_EACS` => Some("AV_CODEC_ID_ADPCM_IMA_EA_EACS")
        case `AV_CODEC_ID_ADPCM_EA_XAS` => Some("AV_CODEC_ID_ADPCM_EA_XAS")
        case `AV_CODEC_ID_ADPCM_EA_MAXIS_XA` => Some("AV_CODEC_ID_ADPCM_EA_MAXIS_XA")
        ...
        case `AV_CODEC_ID_ADPCM_IMA_CUNNING` => Some("AV_CODEC_ID_ADPCM_IMA_CUNNING")
        case `AV_CODEC_ID_ADPCM_IMA_MOFLEX` => Some("AV_CODEC_ID_ADPCM_IMA_MOFLEX")
        case `AV_CODEC_ID_ADPCM_IMA_ACORN` => Some("AV_CODEC_ID_ADPCM_IMA_ACORN")
        case `AV_CODEC_ID_ADPCM_XMD` => Some("AV_CODEC_ID_ADPCM_XMD")
        case `AV_CODEC_ID_ADPCM_IMA_XBOX` => Some("AV_CODEC_ID_ADPCM_IMA_XBOX")
        case `AV_CODEC_ID_ADPCM_SANYO` => Some("AV_CODEC_ID_ADPCM_SANYO")
        ...
        case `AV_CODEC_ID_DSD_LSBF_PLANAR` => Some("AV_CODEC_ID_DSD_LSBF_PLANAR")
        case `AV_CODEC_ID_DSD_MSBF_PLANAR` => Some("AV_CODEC_ID_DSD_MSBF_PLANAR")
        ...
        case `AV_CODEC_ID_G728` => Some("AV_CODEC_ID_G728")
        ...
        case `AV_CODEC_ID_HDMV_PGS_SUBTITLE` => Some("AV_CODEC_ID_HDMV_PGS_SUBTITLE")
        ...
        case `AV_CODEC_ID_HDMV_TEXT_SUBTITLE` => Some("AV_CODEC_ID_HDMV_TEXT_SUBTITLE")
        case `AV_CODEC_ID_TTML` => Some("AV_CODEC_ID_TTML")
        case `AV_CODEC_ID_ARIB_CAPTION` => Some("AV_CODEC_ID_ARIB_CAPTION")
        case `AV_CODEC_ID_IVTV_VBI` => Some("AV_CODEC_ID_IVTV_VBI")
        ...
        case `AV_CODEC_ID_SMPTE_436M_ANC` => Some("AV_CODEC_ID_SMPTE_436M_ANC")
        ...
        case `AV_CODEC_ID_WRAPPED_AVFRAME` => Some("AV_CODEC_ID_WRAPPED_AVFRAME")
  ...
  object AVColorSpace extends _BindgenEnumCUnsignedInt[AVColorSpace]:
    ...
    def getName(value: AVColorSpace): Option[String] =
      value match
        ...
        case `AVCOL_SPC_CHROMA_DERIVED_NCL` => Some("AVCOL_SPC_CHROMA_DERIVED_NCL")
        case `AVCOL_SPC_CHROMA_DERIVED_CL` => Some("AVCOL_SPC_CHROMA_DERIVED_CL")
  ...
  */
  ...
  object AVColorTransferCharacteristic extends _BindgenEnumCUnsignedInt[AVColorTransferCharacteristic]:
    ...
    extension (a: AVColorTransferCharacteristic)
      inline def &(b: AVColorTransferCharacteristic): AVColorTransferCharacteristic = a & b
      inline def |(b: AVColorTransferCharacteristic): AVColorTransferCharacteristic = a | b
  ...
  */
  ...
  object AVDurationEstimationMethod extends _BindgenEnumCUnsignedInt[AVDurationEstimationMethod]:
    ...
    def getName(value: AVDurationEstimationMethod): Option[String] =
      value match
        ...
        case `AVFMT_DURATION_FROM_BITRATE` => Some("AVFMT_DURATION_FROM_BITRATE")
        case _ => _root_.scala.None
    extension (a: AVDurationEstimationMethod)
      inline def &(b: AVDurationEstimationMethod): AVDurationEstimationMethod = a & b
      inline def |(b: AVDurationEstimationMethod): AVDurationEstimationMethod = a | b
  ...
  */
  ...
  object AVFrameSideDataType extends _BindgenEnumCUnsignedInt[AVFrameSideDataType]:
    ...
    val AV_FRAME_DATA_3D_REFERENCE_DISPLAYS = define(30)
    def getName(value: AVFrameSideDataType): Option[String] =
      value match
        ...
        case `AV_FRAME_DATA_MATRIXENCODING` => Some("AV_FRAME_DATA_MATRIXENCODING")
        ...
        case `AV_FRAME_DATA_DISPLAYMATRIX` => Some("AV_FRAME_DATA_DISPLAYMATRIX")
        case `AV_FRAME_DATA_AFD` => Some("AV_FRAME_DATA_AFD")
        case `AV_FRAME_DATA_MOTION_VECTORS` => Some("AV_FRAME_DATA_MOTION_VECTORS")
        case `AV_FRAME_DATA_SKIP_SAMPLES` => Some("AV_FRAME_DATA_SKIP_SAMPLES")
        case `AV_FRAME_DATA_AUDIO_SERVICE_TYPE` => Some("AV_FRAME_DATA_AUDIO_SERVICE_TYPE")
        case `AV_FRAME_DATA_MASTERING_DISPLAY_METADATA` => Some("AV_FRAME_DATA_MASTERING_DISPLAY_METADATA")
        case `AV_FRAME_DATA_GOP_TIMECODE` => Some("AV_FRAME_DATA_GOP_TIMECODE")
        case `AV_FRAME_DATA_SPHERICAL` => Some("AV_FRAME_DATA_SPHERICAL")
        case `AV_FRAME_DATA_CONTENT_LIGHT_LEVEL` => Some("AV_FRAME_DATA_CONTENT_LIGHT_LEVEL")
        case `AV_FRAME_DATA_ICC_PROFILE` => Some("AV_FRAME_DATA_ICC_PROFILE")
        case `AV_FRAME_DATA_S12M_TIMECODE` => Some("AV_FRAME_DATA_S12M_TIMECODE")
        case `AV_FRAME_DATA_DYNAMIC_HDR_PLUS` => Some("AV_FRAME_DATA_DYNAMIC_HDR_PLUS")
        case `AV_FRAME_DATA_REGIONS_OF_INTEREST` => Some("AV_FRAME_DATA_REGIONS_OF_INTEREST")
        case `AV_FRAME_DATA_VIDEO_ENC_PARAMS` => Some("AV_FRAME_DATA_VIDEO_ENC_PARAMS")
        case `AV_FRAME_DATA_SEI_UNREGISTERED` => Some("AV_FRAME_DATA_SEI_UNREGISTERED")
        case `AV_FRAME_DATA_FILM_GRAIN_PARAMS` => Some("AV_FRAME_DATA_FILM_GRAIN_PARAMS")
        case `AV_FRAME_DATA_DETECTION_BBOXES` => Some("AV_FRAME_DATA_DETECTION_BBOXES")
        case `AV_FRAME_DATA_DOVI_RPU_BUFFER` => Some("AV_FRAME_DATA_DOVI_RPU_BUFFER")
        case `AV_FRAME_DATA_DOVI_METADATA` => Some("AV_FRAME_DATA_DOVI_METADATA")
        case `AV_FRAME_DATA_DYNAMIC_HDR_VIVID` => Some("AV_FRAME_DATA_DYNAMIC_HDR_VIVID")
        case `AV_FRAME_DATA_AMBIENT_VIEWING_ENVIRONMENT` => Some("AV_FRAME_DATA_AMBIENT_VIEWING_ENVIRONMENT")
        ...
        case `AV_FRAME_DATA_3D_REFERENCE_DISPLAYS` => Some("AV_FRAME_DATA_3D_REFERENCE_DISPLAYS")
        case _ => _root_.scala.None
  ...
  object AVHWDeviceType extends _BindgenEnumCUnsignedInt[AVHWDeviceType]:
    ...
    val AV_HWDEVICE_TYPE_AMF = define(13)
    val AV_HWDEVICE_TYPE_OHCODEC = define(14)
    def getName(value: AVHWDeviceType): Option[String] =
      value match
        ...
        case `AV_HWDEVICE_TYPE_VIDEOTOOLBOX` => Some("AV_HWDEVICE_TYPE_VIDEOTOOLBOX")
        ...
        case `AV_HWDEVICE_TYPE_MEDIACODEC` => Some("AV_HWDEVICE_TYPE_MEDIACODEC")
        case `AV_HWDEVICE_TYPE_VULKAN` => Some("AV_HWDEVICE_TYPE_VULKAN")
        case `AV_HWDEVICE_TYPE_D3D12VA` => Some("AV_HWDEVICE_TYPE_D3D12VA")
        case `AV_HWDEVICE_TYPE_AMF` => Some("AV_HWDEVICE_TYPE_AMF")
        case `AV_HWDEVICE_TYPE_OHCODEC` => Some("AV_HWDEVICE_TYPE_OHCODEC")
        case _ => _root_.scala.None
  ...
  object AVHWFrameTransferDirection extends _BindgenEnumCUnsignedInt[AVHWFrameTransferDirection]:
    ...
    def getName(value: AVHWFrameTransferDirection): Option[String] =
      value match
        case `AV_HWFRAME_TRANSFER_DIRECTION_FROM` => Some("AV_HWFRAME_TRANSFER_DIRECTION_FROM")
        case `AV_HWFRAME_TRANSFER_DIRECTION_TO` => Some("AV_HWFRAME_TRANSFER_DIRECTION_TO")
        case _ => _root_.scala.None
    extension (a: AVHWFrameTransferDirection)
      inline def &(b: AVHWFrameTransferDirection): AVHWFrameTransferDirection = a & b
      inline def |(b: AVHWFrameTransferDirection): AVHWFrameTransferDirection = a | b
  ...
  */
  ...
  object AVIODataMarkerType extends _BindgenEnumCUnsignedInt[AVIODataMarkerType]:
    ...
    def getName(value: AVIODataMarkerType): Option[String] =
      value match
        ...
        case `AVIO_DATA_MARKER_SYNC_POINT` => Some("AVIO_DATA_MARKER_SYNC_POINT")
        case `AVIO_DATA_MARKER_BOUNDARY_POINT` => Some("AVIO_DATA_MARKER_BOUNDARY_POINT")
        case `AVIO_DATA_MARKER_UNKNOWN` => Some("AVIO_DATA_MARKER_UNKNOWN")
        case `AVIO_DATA_MARKER_TRAILER` => Some("AVIO_DATA_MARKER_TRAILER")
        case `AVIO_DATA_MARKER_FLUSH_POINT` => Some("AVIO_DATA_MARKER_FLUSH_POINT")
        case _ => _root_.scala.None
  ...
  object AVIODirEntryType extends _BindgenEnumCUnsignedInt[AVIODirEntryType]:
    ...
    def getName(value: AVIODirEntryType): Option[String] =
      value match
        ...
        case `AVIO_ENTRY_CHARACTER_DEVICE` => Some("AVIO_ENTRY_CHARACTER_DEVICE")
  ...
  object AVMatrixEncoding extends _BindgenEnumCUnsignedInt[AVMatrixEncoding]:
    ...
    def getName(value: AVMatrixEncoding): Option[String] =
      value match
        ...
        case `AV_MATRIX_ENCODING_DOLBYHEADPHONE` => Some("AV_MATRIX_ENCODING_DOLBYHEADPHONE")
  ...
  */
  ...
  object AVPacketSideDataType extends _BindgenEnumCUnsignedInt[AVPacketSideDataType]:
    ...
    val AV_PKT_DATA_3D_REFERENCE_DISPLAYS = define(38)
    val AV_PKT_DATA_RTCP_SR = define(39)
    val AV_PKT_DATA_NB = define(40)
    def getName(value: AVPacketSideDataType): Option[String] =
      value match
        ...
        case `AV_PKT_DATA_AUDIO_SERVICE_TYPE` => Some("AV_PKT_DATA_AUDIO_SERVICE_TYPE")
        ...
        case `AV_PKT_DATA_STRINGS_METADATA` => Some("AV_PKT_DATA_STRINGS_METADATA")
        case `AV_PKT_DATA_SUBTITLE_POSITION` => Some("AV_PKT_DATA_SUBTITLE_POSITION")
        case `AV_PKT_DATA_MATROSKA_BLOCKADDITIONAL` => Some("AV_PKT_DATA_MATROSKA_BLOCKADDITIONAL")
        case `AV_PKT_DATA_WEBVTT_IDENTIFIER` => Some("AV_PKT_DATA_WEBVTT_IDENTIFIER")
        case `AV_PKT_DATA_WEBVTT_SETTINGS` => Some("AV_PKT_DATA_WEBVTT_SETTINGS")
        case `AV_PKT_DATA_METADATA_UPDATE` => Some("AV_PKT_DATA_METADATA_UPDATE")
        case `AV_PKT_DATA_MPEGTS_STREAM_ID` => Some("AV_PKT_DATA_MPEGTS_STREAM_ID")
        case `AV_PKT_DATA_MASTERING_DISPLAY_METADATA` => Some("AV_PKT_DATA_MASTERING_DISPLAY_METADATA")
        case `AV_PKT_DATA_SPHERICAL` => Some("AV_PKT_DATA_SPHERICAL")
        case `AV_PKT_DATA_CONTENT_LIGHT_LEVEL` => Some("AV_PKT_DATA_CONTENT_LIGHT_LEVEL")
        case `AV_PKT_DATA_A53_CC` => Some("AV_PKT_DATA_A53_CC")
        case `AV_PKT_DATA_ENCRYPTION_INIT_INFO` => Some("AV_PKT_DATA_ENCRYPTION_INIT_INFO")
        case `AV_PKT_DATA_ENCRYPTION_INFO` => Some("AV_PKT_DATA_ENCRYPTION_INFO")
        ...
        case `AV_PKT_DATA_DYNAMIC_HDR10_PLUS` => Some("AV_PKT_DATA_DYNAMIC_HDR10_PLUS")
        case `AV_PKT_DATA_IAMF_MIX_GAIN_PARAM` => Some("AV_PKT_DATA_IAMF_MIX_GAIN_PARAM")
        case `AV_PKT_DATA_IAMF_DEMIXING_INFO_PARAM` => Some("AV_PKT_DATA_IAMF_DEMIXING_INFO_PARAM")
        case `AV_PKT_DATA_IAMF_RECON_GAIN_INFO_PARAM` => Some("AV_PKT_DATA_IAMF_RECON_GAIN_INFO_PARAM")
        case `AV_PKT_DATA_AMBIENT_VIEWING_ENVIRONMENT` => Some("AV_PKT_DATA_AMBIENT_VIEWING_ENVIRONMENT")
        case `AV_PKT_DATA_FRAME_CROPPING` => Some("AV_PKT_DATA_FRAME_CROPPING")
        case `AV_PKT_DATA_LCEVC` => Some("AV_PKT_DATA_LCEVC")
        case `AV_PKT_DATA_3D_REFERENCE_DISPLAYS` => Some("AV_PKT_DATA_3D_REFERENCE_DISPLAYS")
        case `AV_PKT_DATA_RTCP_SR` => Some("AV_PKT_DATA_RTCP_SR")
  ...
  */
  ...
  object AVPictureStructure extends _BindgenEnumCUnsignedInt[AVPictureStructure]:
    ...
    def getName(value: AVPictureStructure): Option[String] =
      value match
        case `AV_PICTURE_STRUCTURE_UNKNOWN` => Some("AV_PICTURE_STRUCTURE_UNKNOWN")
        case `AV_PICTURE_STRUCTURE_TOP_FIELD` => Some("AV_PICTURE_STRUCTURE_TOP_FIELD")
        case `AV_PICTURE_STRUCTURE_BOTTOM_FIELD` => Some("AV_PICTURE_STRUCTURE_BOTTOM_FIELD")
  ...
  */
  ...
  object AVPixelFormat extends _BindgenEnumCInt[AVPixelFormat]:
    ...
    val AV_PIX_FMT_AYUV = define(228)
    val AV_PIX_FMT_UYVA = define(229)
    val AV_PIX_FMT_VYU444 = define(230)
    val AV_PIX_FMT_V30XBE = define(231)
    val AV_PIX_FMT_V30XLE = define(232)
    val AV_PIX_FMT_RGBF16BE = define(233)
    val AV_PIX_FMT_RGBF16LE = define(234)
    val AV_PIX_FMT_RGBA128BE = define(235)
    val AV_PIX_FMT_RGBA128LE = define(236)
    val AV_PIX_FMT_RGB96BE = define(237)
    val AV_PIX_FMT_RGB96LE = define(238)
    val AV_PIX_FMT_Y216BE = define(239)
    val AV_PIX_FMT_Y216LE = define(240)
    val AV_PIX_FMT_XV48BE = define(241)
    val AV_PIX_FMT_XV48LE = define(242)
    val AV_PIX_FMT_GBRPF16BE = define(243)
    val AV_PIX_FMT_GBRPF16LE = define(244)
    val AV_PIX_FMT_GBRAPF16BE = define(245)
    val AV_PIX_FMT_GBRAPF16LE = define(246)
    val AV_PIX_FMT_GRAYF16BE = define(247)
    val AV_PIX_FMT_GRAYF16LE = define(248)
    val AV_PIX_FMT_AMF_SURFACE = define(249)
    val AV_PIX_FMT_GRAY32BE = define(250)
    val AV_PIX_FMT_GRAY32LE = define(251)
    val AV_PIX_FMT_YAF32BE = define(252)
    val AV_PIX_FMT_YAF32LE = define(253)
    val AV_PIX_FMT_YAF16BE = define(254)
    val AV_PIX_FMT_YAF16LE = define(255)
    val AV_PIX_FMT_GBRAP32BE = define(256)
    val AV_PIX_FMT_GBRAP32LE = define(257)
    val AV_PIX_FMT_YUV444P10MSBBE = define(258)
    val AV_PIX_FMT_YUV444P10MSBLE = define(259)
    val AV_PIX_FMT_YUV444P12MSBBE = define(260)
    val AV_PIX_FMT_YUV444P12MSBLE = define(261)
    val AV_PIX_FMT_GBRP10MSBBE = define(262)
    val AV_PIX_FMT_GBRP10MSBLE = define(263)
    val AV_PIX_FMT_GBRP12MSBBE = define(264)
    val AV_PIX_FMT_GBRP12MSBLE = define(265)
    val AV_PIX_FMT_OHCODEC = define(266)
    val AV_PIX_FMT_NB = define(267)
    def getName(value: AVPixelFormat): Option[String] =
      value match
        ...
        case `AV_PIX_FMT_AYUV` => Some("AV_PIX_FMT_AYUV")
        case `AV_PIX_FMT_UYVA` => Some("AV_PIX_FMT_UYVA")
        case `AV_PIX_FMT_VYU444` => Some("AV_PIX_FMT_VYU444")
        case `AV_PIX_FMT_V30XBE` => Some("AV_PIX_FMT_V30XBE")
        case `AV_PIX_FMT_V30XLE` => Some("AV_PIX_FMT_V30XLE")
        case `AV_PIX_FMT_RGBF16BE` => Some("AV_PIX_FMT_RGBF16BE")
        case `AV_PIX_FMT_RGBF16LE` => Some("AV_PIX_FMT_RGBF16LE")
        case `AV_PIX_FMT_RGBA128BE` => Some("AV_PIX_FMT_RGBA128BE")
        case `AV_PIX_FMT_RGBA128LE` => Some("AV_PIX_FMT_RGBA128LE")
        case `AV_PIX_FMT_RGB96BE` => Some("AV_PIX_FMT_RGB96BE")
        case `AV_PIX_FMT_RGB96LE` => Some("AV_PIX_FMT_RGB96LE")
        case `AV_PIX_FMT_Y216BE` => Some("AV_PIX_FMT_Y216BE")
        case `AV_PIX_FMT_Y216LE` => Some("AV_PIX_FMT_Y216LE")
        case `AV_PIX_FMT_XV48BE` => Some("AV_PIX_FMT_XV48BE")
        case `AV_PIX_FMT_XV48LE` => Some("AV_PIX_FMT_XV48LE")
        case `AV_PIX_FMT_GBRPF16BE` => Some("AV_PIX_FMT_GBRPF16BE")
        case `AV_PIX_FMT_GBRPF16LE` => Some("AV_PIX_FMT_GBRPF16LE")
        case `AV_PIX_FMT_GBRAPF16BE` => Some("AV_PIX_FMT_GBRAPF16BE")
        case `AV_PIX_FMT_GBRAPF16LE` => Some("AV_PIX_FMT_GBRAPF16LE")
        case `AV_PIX_FMT_GRAYF16BE` => Some("AV_PIX_FMT_GRAYF16BE")
        case `AV_PIX_FMT_GRAYF16LE` => Some("AV_PIX_FMT_GRAYF16LE")
        case `AV_PIX_FMT_AMF_SURFACE` => Some("AV_PIX_FMT_AMF_SURFACE")
        case `AV_PIX_FMT_GRAY32BE` => Some("AV_PIX_FMT_GRAY32BE")
        case `AV_PIX_FMT_GRAY32LE` => Some("AV_PIX_FMT_GRAY32LE")
        case `AV_PIX_FMT_YAF32BE` => Some("AV_PIX_FMT_YAF32BE")
        case `AV_PIX_FMT_YAF32LE` => Some("AV_PIX_FMT_YAF32LE")
        case `AV_PIX_FMT_YAF16BE` => Some("AV_PIX_FMT_YAF16BE")
        case `AV_PIX_FMT_YAF16LE` => Some("AV_PIX_FMT_YAF16LE")
        case `AV_PIX_FMT_GBRAP32BE` => Some("AV_PIX_FMT_GBRAP32BE")
        case `AV_PIX_FMT_GBRAP32LE` => Some("AV_PIX_FMT_GBRAP32LE")
        case `AV_PIX_FMT_YUV444P10MSBBE` => Some("AV_PIX_FMT_YUV444P10MSBBE")
        case `AV_PIX_FMT_YUV444P10MSBLE` => Some("AV_PIX_FMT_YUV444P10MSBLE")
        case `AV_PIX_FMT_YUV444P12MSBBE` => Some("AV_PIX_FMT_YUV444P12MSBBE")
        case `AV_PIX_FMT_YUV444P12MSBLE` => Some("AV_PIX_FMT_YUV444P12MSBLE")
        case `AV_PIX_FMT_GBRP10MSBBE` => Some("AV_PIX_FMT_GBRP10MSBBE")
        case `AV_PIX_FMT_GBRP10MSBLE` => Some("AV_PIX_FMT_GBRP10MSBLE")
        case `AV_PIX_FMT_GBRP12MSBBE` => Some("AV_PIX_FMT_GBRP12MSBBE")
        case `AV_PIX_FMT_GBRP12MSBLE` => Some("AV_PIX_FMT_GBRP12MSBLE")
        case `AV_PIX_FMT_OHCODEC` => Some("AV_PIX_FMT_OHCODEC")
  ...
  */
  ...
  object AVSideDataParamChangeFlags extends _BindgenEnumCUnsignedInt[AVSideDataParamChangeFlags]:
    ...
    def getName(value: AVSideDataParamChangeFlags): Option[String] =
      value match
        case `AV_SIDE_DATA_PARAM_CHANGE_SAMPLE_RATE` => Some("AV_SIDE_DATA_PARAM_CHANGE_SAMPLE_RATE")
        case `AV_SIDE_DATA_PARAM_CHANGE_DIMENSIONS` => Some("AV_SIDE_DATA_PARAM_CHANGE_DIMENSIONS")
        case _ => _root_.scala.None
    extension (a: AVSideDataParamChangeFlags)
      inline def &(b: AVSideDataParamChangeFlags): AVSideDataParamChangeFlags = a & b
      inline def |(b: AVSideDataParamChangeFlags): AVSideDataParamChangeFlags = a | b
  ...
  object AVSideDataProps extends _BindgenEnumCUnsignedInt[AVSideDataProps]:
    ...
    val AV_SIDE_DATA_PROP_SIZE_DEPENDENT = define(4)
    val AV_SIDE_DATA_PROP_COLOR_DEPENDENT = define(8)
    val AV_SIDE_DATA_PROP_CHANNEL_DEPENDENT = define(16)
    def getName(value: AVSideDataProps): Option[String] =
      value match
        ...
        case `AV_SIDE_DATA_PROP_SIZE_DEPENDENT` => Some("AV_SIDE_DATA_PROP_SIZE_DEPENDENT")
        case `AV_SIDE_DATA_PROP_COLOR_DEPENDENT` => Some("AV_SIDE_DATA_PROP_COLOR_DEPENDENT")
        case `AV_SIDE_DATA_PROP_CHANNEL_DEPENDENT` => Some("AV_SIDE_DATA_PROP_CHANNEL_DEPENDENT")
        case _ => _root_.scala.None
  ...
  object AVStreamGroupParamsType extends _BindgenEnumCUnsignedInt[AVStreamGroupParamsType]:
    ...
    def getName(value: AVStreamGroupParamsType): Option[String] =
      value match
        case `AV_STREAM_GROUP_PARAMS_NONE` => Some("AV_STREAM_GROUP_PARAMS_NONE")
        case `AV_STREAM_GROUP_PARAMS_IAMF_AUDIO_ELEMENT` => Some("AV_STREAM_GROUP_PARAMS_IAMF_AUDIO_ELEMENT")
        case `AV_STREAM_GROUP_PARAMS_IAMF_MIX_PRESENTATION` => Some("AV_STREAM_GROUP_PARAMS_IAMF_MIX_PRESENTATION")
        case `AV_STREAM_GROUP_PARAMS_TILE_GRID` => Some("AV_STREAM_GROUP_PARAMS_TILE_GRID")
        case `AV_STREAM_GROUP_PARAMS_LCEVC` => Some("AV_STREAM_GROUP_PARAMS_LCEVC")
        case _ => _root_.scala.None
...
object aliases:
  ...
  opaque type AVOpenCallback = CFuncPtr6[Ptr[AVFormatContext], Ptr[Ptr[AVIOContext]], CString, CInt, Ptr[AVIOInterruptCB], Ptr[Ptr[AVDictionary]], CInt]
  object AVOpenCallback:
    given _tag: Tag[AVOpenCallback] = Tag.materializeCFuncPtr6[Ptr[AVFormatContext], Ptr[Ptr[AVIOContext]], CString, CInt, Ptr[AVIOInterruptCB], Ptr[Ptr[AVDictionary]], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): AVOpenCallback = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr6[Ptr[AVFormatContext], Ptr[Ptr[AVIOContext]], CString, CInt, Ptr[AVIOInterruptCB], Ptr[Ptr[AVDictionary]], CInt]): AVOpenCallback = o
    extension (v: AVOpenCallback)
      inline def value: CFuncPtr6[Ptr[AVFormatContext], Ptr[Ptr[AVIOContext]], CString, CInt, Ptr[AVIOInterruptCB], Ptr[Ptr[AVDictionary]], CInt] = v
  ...
  */
  opaque type av_format_control_message = CFuncPtr4[Ptr[AVFormatContext], CInt, Ptr[Byte], size_t, CInt]
  object av_format_control_message:
    given _tag: Tag[av_format_control_message] = Tag.materializeCFuncPtr4[Ptr[AVFormatContext], CInt, Ptr[Byte], size_t, CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): av_format_control_message = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[Ptr[AVFormatContext], CInt, Ptr[Byte], size_t, CInt]): av_format_control_message = o
    extension (v: av_format_control_message)
      inline def value: CFuncPtr4[Ptr[AVFormatContext], CInt, Ptr[Byte], size_t, CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
...
object structs:
  ...
  */
  ...
  object AVBufferRef:
    given _tag: Tag[AVBufferRef] = Tag.materializeCStruct3Tag[Ptr[AVBuffer], Ptr[uint8_t], size_t]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVBufferRef)
        inline def buffer : Ptr[AVBuffer] = struct._1
        inline def buffer_=(value: Ptr[AVBuffer]): Unit = (!struct.at1 = value)
        inline def data : Ptr[uint8_t] = struct._2
        inline def data_=(value: Ptr[uint8_t]): Unit = (!struct.at2 = value)
    ...
    def apply()(using Zone): Ptr[AVBufferRef] = scala.scalanative.unsafe.alloc[AVBufferRef](1)
    def apply(buffer : Ptr[AVBuffer], data : Ptr[uint8_t], size : size_t)(using Zone): Ptr[AVBufferRef] =
      val ____ptr = apply()
  ...
  */
  opaque type AVCPBProperties = CStruct5[int64_t, int64_t, int64_t, int64_t, uint64_t]
  
  object AVCPBProperties:
    given _tag: Tag[AVCPBProperties] = Tag.materializeCStruct5Tag[int64_t, int64_t, int64_t, int64_t, uint64_t]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVCPBProperties)
        inline def max_bitrate : int64_t = struct._1
        inline def max_bitrate_=(value: int64_t): Unit = (!struct.at1 = value)
        inline def min_bitrate : int64_t = struct._2
        inline def min_bitrate_=(value: int64_t): Unit = (!struct.at2 = value)
        inline def avg_bitrate : int64_t = struct._3
        inline def avg_bitrate_=(value: int64_t): Unit = (!struct.at3 = value)
        inline def buffer_size : int64_t = struct._4
        inline def buffer_size_=(value: int64_t): Unit = (!struct.at4 = value)
        inline def vbv_delay : uint64_t = struct._5
        inline def vbv_delay_=(value: uint64_t): Unit = (!struct.at5 = value)
      end extension
    
    // Allocates AVCPBProperties on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVCPBProperties] = scala.scalanative.unsafe.alloc[AVCPBProperties](1)
    def apply(max_bitrate : int64_t, min_bitrate : int64_t, avg_bitrate : int64_t, buffer_size : int64_t, vbv_delay : uint64_t)(using Zone): Ptr[AVCPBProperties] =
      val ____ptr = apply()
  ...
  */
  opaque type AVChannelCustom = CStruct3[AVChannel, CArray[CChar, Nat.Digit2[Nat._1, Nat._6]], Ptr[Byte]]
  
  object AVChannelCustom:
    given _tag: Tag[AVChannelCustom] = Tag.materializeCStruct3Tag[AVChannel, CArray[CChar, Nat.Digit2[Nat._1, Nat._6]], Ptr[Byte]]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVChannelCustom)
        inline def id : AVChannel = struct._1
        inline def id_=(value: AVChannel): Unit = (!struct.at1 = value)
        inline def name : CArray[CChar, Nat.Digit2[Nat._1, Nat._6]] = struct._2
        inline def name_=(value: CArray[CChar, Nat.Digit2[Nat._1, Nat._6]]): Unit = (!struct.at2 = value)
        inline def opaque : Ptr[Byte] = struct._3
        inline def opaque_=(value: Ptr[Byte]): Unit = (!struct.at3 = value)
      end extension
    
    // Allocates AVChannelCustom on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVChannelCustom] = scala.scalanative.unsafe.alloc[AVChannelCustom](1)
    def apply(id : AVChannel, name : CArray[CChar, Nat.Digit2[Nat._1, Nat._6]], opaque : Ptr[Byte])(using Zone): Ptr[AVChannelCustom] =
      val ____ptr = apply()
      (!____ptr).id = id
      (!____ptr).name = name
  ...
  */
  opaque type AVChannelLayout = CStruct4[AVChannelOrder, CInt, AVChannelLayout_U, Ptr[Byte]]
  
  object AVChannelLayout:
    given _tag: Tag[AVChannelLayout] = Tag.materializeCStruct4Tag[AVChannelOrder, CInt, AVChannelLayout_U, Ptr[Byte]]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVChannelLayout)
        inline def order : AVChannelOrder = struct._1
        inline def order_=(value: AVChannelOrder): Unit = (!struct.at1 = value)
        inline def nb_channels : CInt = struct._2
        inline def nb_channels_=(value: CInt): Unit = (!struct.at2 = value)
        inline def u : AVChannelLayout_U = struct._3
        inline def u_=(value: AVChannelLayout_U): Unit = (!struct.at3 = value)
        inline def opaque : Ptr[Byte] = struct._4
        inline def opaque_=(value: Ptr[Byte]): Unit = (!struct.at4 = value)
      end extension
    
    // Allocates AVChannelLayout on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVChannelLayout] = scala.scalanative.unsafe.alloc[AVChannelLayout](1)
    def apply(order : AVChannelOrder, nb_channels : CInt, u : AVChannelLayout_U, opaque : Ptr[Byte])(using Zone): Ptr[AVChannelLayout] =
      val ____ptr = apply()
      (!____ptr).order = order
  ...
  */
  opaque type AVChannelLayout_U = CArray[Byte, Nat._8]
  object AVChannelLayout_U:
    given _tag: Tag[AVChannelLayout_U] = Tag.CArray[CChar, Nat._8](Tag.Byte, Tag.Nat8)
    
    def apply()(using Zone): Ptr[AVChannelLayout_U] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[AVChannelLayout_U](1)
      ___ptr
    
    @scala.annotation.targetName("apply_mask")
    def apply(mask: uint64_t)(using Zone): Ptr[AVChannelLayout_U] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[AVChannelLayout_U](1)
      val un = !___ptr
    ...
    def apply(map: Ptr[AVChannelCustom])(using Zone): Ptr[AVChannelLayout_U] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[AVChannelLayout_U](1)
      val un = !___ptr
      un.at(0).asInstanceOf[Ptr[Ptr[AVChannelCustom]]].update(0, map)
      ___ptr
    
    extension (struct: AVChannelLayout_U)
      inline def mask : uint64_t = !struct.at(0).asInstanceOf[Ptr[uint64_t]]
      inline def mask_=(value: uint64_t): Unit = !struct.at(0).asInstanceOf[Ptr[uint64_t]] = value
      inline def map : Ptr[AVChannelCustom] = !struct.at(0).asInstanceOf[Ptr[Ptr[AVChannelCustom]]]
      inline def map_=(value: Ptr[AVChannelCustom]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[AVChannelCustom]]] = value

  opaque type AVChapter = CStruct5[int64_t, AVRational, int64_t, int64_t, Ptr[AVDictionary]]
  
  object AVChapter:
    given _tag: Tag[AVChapter] = Tag.materializeCStruct5Tag[int64_t, AVRational, int64_t, int64_t, Ptr[AVDictionary]]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVChapter)
        inline def id : int64_t = struct._1
        inline def id_=(value: int64_t): Unit = (!struct.at1 = value)
        inline def time_base : AVRational = struct._2
        inline def time_base_=(value: AVRational): Unit = (!struct.at2 = value)
        inline def start : int64_t = struct._3
        inline def start_=(value: int64_t): Unit = (!struct.at3 = value)
        inline def end : int64_t = struct._4
        inline def end_=(value: int64_t): Unit = (!struct.at4 = value)
        inline def metadata : Ptr[AVDictionary] = struct._5
        inline def metadata_=(value: Ptr[AVDictionary]): Unit = (!struct.at5 = value)
      end extension
    
    // Allocates AVChapter on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVChapter] = scala.scalanative.unsafe.alloc[AVChapter](1)
    def apply(id : int64_t, time_base : AVRational, start : int64_t, end : int64_t, metadata : Ptr[AVDictionary])(using Zone): Ptr[AVChapter] =
      val ____ptr = apply()
      (!____ptr).id = id
  ...
  */
  opaque type AVClass = CStruct12[CString, CFuncPtr1[Ptr[Byte], CString], Ptr[AVOption], CInt, CInt, CInt, AVClassCategory, CFuncPtr1[Ptr[Byte], AVClassCategory], CFuncPtr4[Ptr[Ptr[AVOptionRanges]], Ptr[Byte], CString, CInt, CInt], CFuncPtr2[Ptr[Byte], Ptr[Byte], Ptr[Byte]], CFuncPtr1[Ptr[Ptr[Byte]], Ptr[Byte]], CInt]
  
  object AVClass:
    given _tag: Tag[AVClass] = Tag.materializeCStruct12Tag[CString, CFuncPtr1[Ptr[Byte], CString], Ptr[AVOption], CInt, CInt, CInt, AVClassCategory, CFuncPtr1[Ptr[Byte], AVClassCategory], CFuncPtr4[Ptr[Ptr[AVOptionRanges]], Ptr[Byte], CString, CInt, CInt], CFuncPtr2[Ptr[Byte], Ptr[Byte], Ptr[Byte]], CFuncPtr1[Ptr[Ptr[Byte]], Ptr[Byte]], CInt]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVClass)
        inline def class_name : CString = struct._1
        inline def class_name_=(value: CString): Unit = (!struct.at1 = value)
        inline def item_name : CFuncPtr1[Ptr[Byte], CString] = struct._2
        inline def item_name_=(value: CFuncPtr1[Ptr[Byte], CString]): Unit = (!struct.at2 = value)
        inline def option : Ptr[AVOption] = struct._3
        inline def option_=(value: Ptr[AVOption]): Unit = (!struct.at3 = value)
        inline def version : CInt = struct._4
        inline def version_=(value: CInt): Unit = (!struct.at4 = value)
        inline def log_level_offset_offset : CInt = struct._5
        inline def log_level_offset_offset_=(value: CInt): Unit = (!struct.at5 = value)
        inline def parent_log_context_offset : CInt = struct._6
        inline def parent_log_context_offset_=(value: CInt): Unit = (!struct.at6 = value)
        inline def category : AVClassCategory = struct._7
        inline def category_=(value: AVClassCategory): Unit = (!struct.at7 = value)
        inline def get_category : CFuncPtr1[Ptr[Byte], AVClassCategory] = struct._8
        inline def get_category_=(value: CFuncPtr1[Ptr[Byte], AVClassCategory]): Unit = (!struct.at8 = value)
        inline def query_ranges : CFuncPtr4[Ptr[Ptr[AVOptionRanges]], Ptr[Byte], CString, CInt, CInt] = struct._9
        inline def query_ranges_=(value: CFuncPtr4[Ptr[Ptr[AVOptionRanges]], Ptr[Byte], CString, CInt, CInt]): Unit = (!struct.at9 = value)
        inline def child_next : CFuncPtr2[Ptr[Byte], Ptr[Byte], Ptr[Byte]] = struct._10
        inline def child_next_=(value: CFuncPtr2[Ptr[Byte], Ptr[Byte], Ptr[Byte]]): Unit = (!struct.at10 = value)
        inline def child_class_iterate : CFuncPtr1[Ptr[Ptr[Byte]], Ptr[AVClass]] = struct._11.asInstanceOf[CFuncPtr1[Ptr[Ptr[Byte]], Ptr[AVClass]]]
        inline def child_class_iterate_=(value: CFuncPtr1[Ptr[Ptr[Byte]], Ptr[AVClass]]): Unit = (!struct.at11 = value.asInstanceOf[CFuncPtr1[Ptr[Ptr[Byte]], Ptr[Byte]]])
        inline def state_flags_offset : CInt = struct._12
        inline def state_flags_offset_=(value: CInt): Unit = (!struct.at12 = value)
      end extension
    
    // Allocates AVClass on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVClass] = scala.scalanative.unsafe.alloc[AVClass](1)
    def apply(class_name : CString, item_name : CFuncPtr1[Ptr[Byte], CString], option : Ptr[AVOption], version : CInt, log_level_offset_offset : CInt, parent_log_context_offset : CInt, category : AVClassCategory, get_category : CFuncPtr1[Ptr[Byte], AVClassCategory], query_ranges : CFuncPtr4[Ptr[Ptr[AVOptionRanges]], Ptr[Byte], CString, CInt, CInt], child_next : CFuncPtr2[Ptr[Byte], Ptr[Byte], Ptr[Byte]], child_class_iterate : CFuncPtr1[Ptr[Ptr[Byte]], Ptr[AVClass]], state_flags_offset : CInt)(using Zone): Ptr[AVClass] =
      val ____ptr = apply()
      ...
      (!____ptr).state_flags_offset = state_flags_offset
      ____ptr
   ...
   * AVCodec.
  */
  opaque type AVCodec = CStruct14[CString, CString, AVMediaType, AVCodecID, CInt, uint8_t, Ptr[AVRational], Ptr[AVPixelFormat], Ptr[CInt], Ptr[AVSampleFormat], Ptr[Byte], Ptr[AVProfile], CString, Ptr[AVChannelLayout]]
  
  object AVCodec:
    given _tag: Tag[AVCodec] = Tag.materializeCStruct14Tag[CString, CString, AVMediaType, AVCodecID, CInt, uint8_t, Ptr[AVRational], Ptr[AVPixelFormat], Ptr[CInt], Ptr[AVSampleFormat], Ptr[Byte], Ptr[AVProfile], CString, Ptr[AVChannelLayout]]
    ...
    private[ffmpeg] object fields:
      extension (struct: AVCodec)
        ...
        inline def long_name : CString = struct._2
        inline def long_name_=(value: CString): Unit = (!struct.at2 = value)
        inline def `type` : AVMediaType = struct._3
        inline def type_=(value: AVMediaType): Unit = (!struct.at3 = value)
        inline def id : AVCodecID = struct._4
        inline def id_=(value: AVCodecID): Unit = (!struct.at4 = value)
        inline def capabilities : CInt = struct._5
        inline def capabilities_=(value: CInt): Unit = (!struct.at5 = value)
        inline def max_lowres : uint8_t = struct._6
        inline def max_lowres_=(value: uint8_t): Unit = (!struct.at6 = value)
        inline def supported_framerates : Ptr[AVRational] = struct._7
        inline def supported_framerates_=(value: Ptr[AVRational]): Unit = (!struct.at7 = value)
        inline def pix_fmts : Ptr[AVPixelFormat] = struct._8
        inline def pix_fmts_=(value: Ptr[AVPixelFormat]): Unit = (!struct.at8 = value)
        inline def supported_samplerates : Ptr[CInt] = struct._9
        inline def supported_samplerates_=(value: Ptr[CInt]): Unit = (!struct.at9 = value)
        inline def sample_fmts : Ptr[AVSampleFormat] = struct._10
        inline def sample_fmts_=(value: Ptr[AVSampleFormat]): Unit = (!struct.at10 = value)
        inline def priv_class : Ptr[AVClass] = struct._11.asInstanceOf[Ptr[AVClass]]
        inline def priv_class_=(value: Ptr[AVClass]): Unit = (!struct.at11 = value.asInstanceOf[Ptr[Byte]])
        inline def profiles : Ptr[AVProfile] = struct._12
        inline def profiles_=(value: Ptr[AVProfile]): Unit = (!struct.at12 = value)
        inline def wrapper_name : CString = struct._13
        inline def wrapper_name_=(value: CString): Unit = (!struct.at13 = value)
        inline def ch_layouts : Ptr[AVChannelLayout] = struct._14
        inline def ch_layouts_=(value: Ptr[AVChannelLayout]): Unit = (!struct.at14 = value)
      end extension
    
    // Allocates AVCodec on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVCodec] = scala.scalanative.unsafe.alloc[AVCodec](1)
    def apply(name : CString, long_name : CString, `type` : AVMediaType, id : AVCodecID, capabilities : CInt, max_lowres : uint8_t, supported_framerates : Ptr[AVRational], pix_fmts : Ptr[AVPixelFormat], supported_samplerates : Ptr[CInt], sample_fmts : Ptr[AVSampleFormat], priv_class : Ptr[AVClass], profiles : Ptr[AVProfile], wrapper_name : CString, ch_layouts : Ptr[AVChannelLayout])(using Zone): Ptr[AVCodec] =
      val ____ptr = apply()
      (!____ptr).name = name
  ...
  */
  ...
  object AVCodecContext:
    given _tag: Tag[AVCodecContext] = Tag.CArray[CChar, Nat.Digit3[Nat._8, Nat._6, Nat._4]](Tag.Byte, Tag.Digit3[Nat._8, Nat._6, Nat._4](Tag.Nat8, Tag.Nat6, Tag.Nat4))
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVCodecContext)
        inline def av_class: Ptr[AVClass] = !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[AVClass]]]
        inline def av_class_=(value: Ptr[AVClass]): Unit = !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[AVClass]]] = value
        inline def log_level_offset: CInt = !struct.at(offsets(1)).asInstanceOf[Ptr[CInt]]
        inline def log_level_offset_=(value: CInt): Unit = !struct.at(offsets(1)).asInstanceOf[Ptr[CInt]] = value
        inline def codec_type: AVMediaType = !struct.at(offsets(2)).asInstanceOf[Ptr[AVMediaType]]
        inline def codec_type_=(value: AVMediaType): Unit = !struct.at(offsets(2)).asInstanceOf[Ptr[AVMediaType]] = value
        inline def codec: Ptr[AVCodec] = !struct.at(offsets(3)).asInstanceOf[Ptr[Ptr[AVCodec]]]
        inline def codec_=(value: Ptr[AVCodec]): Unit = !struct.at(offsets(3)).asInstanceOf[Ptr[Ptr[AVCodec]]] = value
        inline def codec_id: AVCodecID = !struct.at(offsets(4)).asInstanceOf[Ptr[AVCodecID]]
        inline def codec_id_=(value: AVCodecID): Unit = !struct.at(offsets(4)).asInstanceOf[Ptr[AVCodecID]] = value
        inline def codec_tag: CUnsignedInt = !struct.at(offsets(5)).asInstanceOf[Ptr[CUnsignedInt]]
        inline def codec_tag_=(value: CUnsignedInt): Unit = !struct.at(offsets(5)).asInstanceOf[Ptr[CUnsignedInt]] = value
        inline def priv_data: Ptr[Byte] = !struct.at(offsets(6)).asInstanceOf[Ptr[Ptr[Byte]]]
        inline def priv_data_=(value: Ptr[Byte]): Unit = !struct.at(offsets(6)).asInstanceOf[Ptr[Ptr[Byte]]] = value
        inline def internal: Ptr[AVCodecInternal] = !struct.at(offsets(7)).asInstanceOf[Ptr[Ptr[AVCodecInternal]]]
        inline def internal_=(value: Ptr[AVCodecInternal]): Unit = !struct.at(offsets(7)).asInstanceOf[Ptr[Ptr[AVCodecInternal]]] = value
        inline def opaque: Ptr[Byte] = !struct.at(offsets(8)).asInstanceOf[Ptr[Ptr[Byte]]]
        inline def opaque_=(value: Ptr[Byte]): Unit = !struct.at(offsets(8)).asInstanceOf[Ptr[Ptr[Byte]]] = value
        inline def bit_rate: int64_t = !struct.at(offsets(9)).asInstanceOf[Ptr[int64_t]]
        inline def bit_rate_=(value: int64_t): Unit = !struct.at(offsets(9)).asInstanceOf[Ptr[int64_t]] = value
        inline def flags: CInt = !struct.at(offsets(10)).asInstanceOf[Ptr[CInt]]
        inline def flags_=(value: CInt): Unit = !struct.at(offsets(10)).asInstanceOf[Ptr[CInt]] = value
        inline def flags2: CInt = !struct.at(offsets(11)).asInstanceOf[Ptr[CInt]]
        inline def flags2_=(value: CInt): Unit = !struct.at(offsets(11)).asInstanceOf[Ptr[CInt]] = value
        inline def extradata: Ptr[uint8_t] = !struct.at(offsets(12)).asInstanceOf[Ptr[Ptr[uint8_t]]]
        inline def extradata_=(value: Ptr[uint8_t]): Unit = !struct.at(offsets(12)).asInstanceOf[Ptr[Ptr[uint8_t]]] = value
        inline def extradata_size: CInt = !struct.at(offsets(13)).asInstanceOf[Ptr[CInt]]
        inline def extradata_size_=(value: CInt): Unit = !struct.at(offsets(13)).asInstanceOf[Ptr[CInt]] = value
        inline def time_base: AVRational = !struct.at(offsets(14)).asInstanceOf[Ptr[AVRational]]
        inline def time_base_=(value: AVRational): Unit = !struct.at(offsets(14)).asInstanceOf[Ptr[AVRational]] = value
        inline def pkt_timebase: AVRational = !struct.at(offsets(15)).asInstanceOf[Ptr[AVRational]]
        inline def pkt_timebase_=(value: AVRational): Unit = !struct.at(offsets(15)).asInstanceOf[Ptr[AVRational]] = value
        inline def framerate: AVRational = !struct.at(offsets(16)).asInstanceOf[Ptr[AVRational]]
        inline def framerate_=(value: AVRational): Unit = !struct.at(offsets(16)).asInstanceOf[Ptr[AVRational]] = value
        inline def delay: CInt = !struct.at(offsets(17)).asInstanceOf[Ptr[CInt]]
        inline def delay_=(value: CInt): Unit = !struct.at(offsets(17)).asInstanceOf[Ptr[CInt]] = value
        inline def width: CInt = !struct.at(offsets(18)).asInstanceOf[Ptr[CInt]]
        inline def width_=(value: CInt): Unit = !struct.at(offsets(18)).asInstanceOf[Ptr[CInt]] = value
        inline def height: CInt = !struct.at(offsets(19)).asInstanceOf[Ptr[CInt]]
        inline def height_=(value: CInt): Unit = !struct.at(offsets(19)).asInstanceOf[Ptr[CInt]] = value
        inline def coded_width: CInt = !struct.at(offsets(20)).asInstanceOf[Ptr[CInt]]
        inline def coded_width_=(value: CInt): Unit = !struct.at(offsets(20)).asInstanceOf[Ptr[CInt]] = value
        inline def coded_height: CInt = !struct.at(offsets(21)).asInstanceOf[Ptr[CInt]]
        inline def coded_height_=(value: CInt): Unit = !struct.at(offsets(21)).asInstanceOf[Ptr[CInt]] = value
        inline def sample_aspect_ratio: AVRational = !struct.at(offsets(22)).asInstanceOf[Ptr[AVRational]]
        inline def sample_aspect_ratio_=(value: AVRational): Unit = !struct.at(offsets(22)).asInstanceOf[Ptr[AVRational]] = value
        inline def pix_fmt: AVPixelFormat = !struct.at(offsets(23)).asInstanceOf[Ptr[AVPixelFormat]]
        inline def pix_fmt_=(value: AVPixelFormat): Unit = !struct.at(offsets(23)).asInstanceOf[Ptr[AVPixelFormat]] = value
        inline def sw_pix_fmt: AVPixelFormat = !struct.at(offsets(24)).asInstanceOf[Ptr[AVPixelFormat]]
        inline def sw_pix_fmt_=(value: AVPixelFormat): Unit = !struct.at(offsets(24)).asInstanceOf[Ptr[AVPixelFormat]] = value
        inline def color_primaries: AVColorPrimaries = !struct.at(offsets(25)).asInstanceOf[Ptr[AVColorPrimaries]]
        inline def color_primaries_=(value: AVColorPrimaries): Unit = !struct.at(offsets(25)).asInstanceOf[Ptr[AVColorPrimaries]] = value
        inline def color_trc: AVColorTransferCharacteristic = !struct.at(offsets(26)).asInstanceOf[Ptr[AVColorTransferCharacteristic]]
        inline def color_trc_=(value: AVColorTransferCharacteristic): Unit = !struct.at(offsets(26)).asInstanceOf[Ptr[AVColorTransferCharacteristic]] = value
        inline def colorspace: AVColorSpace = !struct.at(offsets(27)).asInstanceOf[Ptr[AVColorSpace]]
        inline def colorspace_=(value: AVColorSpace): Unit = !struct.at(offsets(27)).asInstanceOf[Ptr[AVColorSpace]] = value
        inline def color_range: AVColorRange = !struct.at(offsets(28)).asInstanceOf[Ptr[AVColorRange]]
        inline def color_range_=(value: AVColorRange): Unit = !struct.at(offsets(28)).asInstanceOf[Ptr[AVColorRange]] = value
        inline def chroma_sample_location: AVChromaLocation = !struct.at(offsets(29)).asInstanceOf[Ptr[AVChromaLocation]]
        inline def chroma_sample_location_=(value: AVChromaLocation): Unit = !struct.at(offsets(29)).asInstanceOf[Ptr[AVChromaLocation]] = value
        inline def field_order: AVFieldOrder = !struct.at(offsets(30)).asInstanceOf[Ptr[AVFieldOrder]]
        inline def field_order_=(value: AVFieldOrder): Unit = !struct.at(offsets(30)).asInstanceOf[Ptr[AVFieldOrder]] = value
        inline def refs: CInt = !struct.at(offsets(31)).asInstanceOf[Ptr[CInt]]
        inline def refs_=(value: CInt): Unit = !struct.at(offsets(31)).asInstanceOf[Ptr[CInt]] = value
        inline def has_b_frames: CInt = !struct.at(offsets(32)).asInstanceOf[Ptr[CInt]]
        inline def has_b_frames_=(value: CInt): Unit = !struct.at(offsets(32)).asInstanceOf[Ptr[CInt]] = value
        inline def slice_flags: CInt = !struct.at(offsets(33)).asInstanceOf[Ptr[CInt]]
        inline def slice_flags_=(value: CInt): Unit = !struct.at(offsets(33)).asInstanceOf[Ptr[CInt]] = value
        inline def draw_horiz_band: CFuncPtr6[Ptr[AVCodecContext], Ptr[AVFrame], CArray[CInt, Nat._8], CInt, CInt, CInt, Unit] = !struct.at(offsets(34)).asInstanceOf[Ptr[CFuncPtr6[Ptr[AVCodecContext], Ptr[AVFrame], CArray[CInt, Nat._8], CInt, CInt, CInt, Unit]]]
        inline def draw_horiz_band_=(value: CFuncPtr6[Ptr[AVCodecContext], Ptr[AVFrame], CArray[CInt, Nat._8], CInt, CInt, CInt, Unit]): Unit = !struct.at(offsets(34)).asInstanceOf[Ptr[CFuncPtr6[Ptr[AVCodecContext], Ptr[AVFrame], CArray[CInt, Nat._8], CInt, CInt, CInt, Unit]]] = value
        inline def get_format: CFuncPtr2[Ptr[AVCodecContext], Ptr[AVPixelFormat], AVPixelFormat] = !struct.at(offsets(35)).asInstanceOf[Ptr[CFuncPtr2[Ptr[AVCodecContext], Ptr[AVPixelFormat], AVPixelFormat]]]
        inline def get_format_=(value: CFuncPtr2[Ptr[AVCodecContext], Ptr[AVPixelFormat], AVPixelFormat]): Unit = !struct.at(offsets(35)).asInstanceOf[Ptr[CFuncPtr2[Ptr[AVCodecContext], Ptr[AVPixelFormat], AVPixelFormat]]] = value
        inline def max_b_frames: CInt = !struct.at(offsets(36)).asInstanceOf[Ptr[CInt]]
        inline def max_b_frames_=(value: CInt): Unit = !struct.at(offsets(36)).asInstanceOf[Ptr[CInt]] = value
        inline def b_quant_factor: Float = !struct.at(offsets(37)).asInstanceOf[Ptr[Float]]
        inline def b_quant_factor_=(value: Float): Unit = !struct.at(offsets(37)).asInstanceOf[Ptr[Float]] = value
        inline def b_quant_offset: Float = !struct.at(offsets(38)).asInstanceOf[Ptr[Float]]
        inline def b_quant_offset_=(value: Float): Unit = !struct.at(offsets(38)).asInstanceOf[Ptr[Float]] = value
        inline def i_quant_factor: Float = !struct.at(offsets(39)).asInstanceOf[Ptr[Float]]
        inline def i_quant_factor_=(value: Float): Unit = !struct.at(offsets(39)).asInstanceOf[Ptr[Float]] = value
        inline def i_quant_offset: Float = !struct.at(offsets(40)).asInstanceOf[Ptr[Float]]
        inline def i_quant_offset_=(value: Float): Unit = !struct.at(offsets(40)).asInstanceOf[Ptr[Float]] = value
        inline def lumi_masking: Float = !struct.at(offsets(41)).asInstanceOf[Ptr[Float]]
        inline def lumi_masking_=(value: Float): Unit = !struct.at(offsets(41)).asInstanceOf[Ptr[Float]] = value
        inline def temporal_cplx_masking: Float = !struct.at(offsets(42)).asInstanceOf[Ptr[Float]]
        inline def temporal_cplx_masking_=(value: Float): Unit = !struct.at(offsets(42)).asInstanceOf[Ptr[Float]] = value
        inline def spatial_cplx_masking: Float = !struct.at(offsets(43)).asInstanceOf[Ptr[Float]]
        inline def spatial_cplx_masking_=(value: Float): Unit = !struct.at(offsets(43)).asInstanceOf[Ptr[Float]] = value
        inline def p_masking: Float = !struct.at(offsets(44)).asInstanceOf[Ptr[Float]]
        inline def p_masking_=(value: Float): Unit = !struct.at(offsets(44)).asInstanceOf[Ptr[Float]] = value
        inline def dark_masking: Float = !struct.at(offsets(45)).asInstanceOf[Ptr[Float]]
        inline def dark_masking_=(value: Float): Unit = !struct.at(offsets(45)).asInstanceOf[Ptr[Float]] = value
        inline def nsse_weight: CInt = !struct.at(offsets(46)).asInstanceOf[Ptr[CInt]]
        inline def nsse_weight_=(value: CInt): Unit = !struct.at(offsets(46)).asInstanceOf[Ptr[CInt]] = value
        inline def me_cmp: CInt = !struct.at(offsets(47)).asInstanceOf[Ptr[CInt]]
        inline def me_cmp_=(value: CInt): Unit = !struct.at(offsets(47)).asInstanceOf[Ptr[CInt]] = value
        inline def me_sub_cmp: CInt = !struct.at(offsets(48)).asInstanceOf[Ptr[CInt]]
        inline def me_sub_cmp_=(value: CInt): Unit = !struct.at(offsets(48)).asInstanceOf[Ptr[CInt]] = value
        inline def mb_cmp: CInt = !struct.at(offsets(49)).asInstanceOf[Ptr[CInt]]
        inline def mb_cmp_=(value: CInt): Unit = !struct.at(offsets(49)).asInstanceOf[Ptr[CInt]] = value
        inline def ildct_cmp: CInt = !struct.at(offsets(50)).asInstanceOf[Ptr[CInt]]
        inline def ildct_cmp_=(value: CInt): Unit = !struct.at(offsets(50)).asInstanceOf[Ptr[CInt]] = value
        inline def dia_size: CInt = !struct.at(offsets(51)).asInstanceOf[Ptr[CInt]]
        inline def dia_size_=(value: CInt): Unit = !struct.at(offsets(51)).asInstanceOf[Ptr[CInt]] = value
        inline def last_predictor_count: CInt = !struct.at(offsets(52)).asInstanceOf[Ptr[CInt]]
        inline def last_predictor_count_=(value: CInt): Unit = !struct.at(offsets(52)).asInstanceOf[Ptr[CInt]] = value
        inline def me_pre_cmp: CInt = !struct.at(offsets(53)).asInstanceOf[Ptr[CInt]]
        inline def me_pre_cmp_=(value: CInt): Unit = !struct.at(offsets(53)).asInstanceOf[Ptr[CInt]] = value
        inline def pre_dia_size: CInt = !struct.at(offsets(54)).asInstanceOf[Ptr[CInt]]
        inline def pre_dia_size_=(value: CInt): Unit = !struct.at(offsets(54)).asInstanceOf[Ptr[CInt]] = value
        inline def me_subpel_quality: CInt = !struct.at(offsets(55)).asInstanceOf[Ptr[CInt]]
        inline def me_subpel_quality_=(value: CInt): Unit = !struct.at(offsets(55)).asInstanceOf[Ptr[CInt]] = value
        inline def me_range: CInt = !struct.at(offsets(56)).asInstanceOf[Ptr[CInt]]
        inline def me_range_=(value: CInt): Unit = !struct.at(offsets(56)).asInstanceOf[Ptr[CInt]] = value
        inline def mb_decision: CInt = !struct.at(offsets(57)).asInstanceOf[Ptr[CInt]]
        inline def mb_decision_=(value: CInt): Unit = !struct.at(offsets(57)).asInstanceOf[Ptr[CInt]] = value
        inline def intra_matrix: Ptr[uint16_t] = !struct.at(offsets(58)).asInstanceOf[Ptr[Ptr[uint16_t]]]
        inline def intra_matrix_=(value: Ptr[uint16_t]): Unit = !struct.at(offsets(58)).asInstanceOf[Ptr[Ptr[uint16_t]]] = value
        inline def inter_matrix: Ptr[uint16_t] = !struct.at(offsets(59)).asInstanceOf[Ptr[Ptr[uint16_t]]]
        inline def inter_matrix_=(value: Ptr[uint16_t]): Unit = !struct.at(offsets(59)).asInstanceOf[Ptr[Ptr[uint16_t]]] = value
        inline def chroma_intra_matrix: Ptr[uint16_t] = !struct.at(offsets(60)).asInstanceOf[Ptr[Ptr[uint16_t]]]
        inline def chroma_intra_matrix_=(value: Ptr[uint16_t]): Unit = !struct.at(offsets(60)).asInstanceOf[Ptr[Ptr[uint16_t]]] = value
        inline def intra_dc_precision: CInt = !struct.at(offsets(61)).asInstanceOf[Ptr[CInt]]
        inline def intra_dc_precision_=(value: CInt): Unit = !struct.at(offsets(61)).asInstanceOf[Ptr[CInt]] = value
        inline def mb_lmin: CInt = !struct.at(offsets(62)).asInstanceOf[Ptr[CInt]]
        inline def mb_lmin_=(value: CInt): Unit = !struct.at(offsets(62)).asInstanceOf[Ptr[CInt]] = value
        inline def mb_lmax: CInt = !struct.at(offsets(63)).asInstanceOf[Ptr[CInt]]
        inline def mb_lmax_=(value: CInt): Unit = !struct.at(offsets(63)).asInstanceOf[Ptr[CInt]] = value
        inline def bidir_refine: CInt = !struct.at(offsets(64)).asInstanceOf[Ptr[CInt]]
        inline def bidir_refine_=(value: CInt): Unit = !struct.at(offsets(64)).asInstanceOf[Ptr[CInt]] = value
        inline def keyint_min: CInt = !struct.at(offsets(65)).asInstanceOf[Ptr[CInt]]
        inline def keyint_min_=(value: CInt): Unit = !struct.at(offsets(65)).asInstanceOf[Ptr[CInt]] = value
        inline def gop_size: CInt = !struct.at(offsets(66)).asInstanceOf[Ptr[CInt]]
        inline def gop_size_=(value: CInt): Unit = !struct.at(offsets(66)).asInstanceOf[Ptr[CInt]] = value
        inline def mv0_threshold: CInt = !struct.at(offsets(67)).asInstanceOf[Ptr[CInt]]
        inline def mv0_threshold_=(value: CInt): Unit = !struct.at(offsets(67)).asInstanceOf[Ptr[CInt]] = value
        inline def slices: CInt = !struct.at(offsets(68)).asInstanceOf[Ptr[CInt]]
        inline def slices_=(value: CInt): Unit = !struct.at(offsets(68)).asInstanceOf[Ptr[CInt]] = value
        inline def sample_rate: CInt = !struct.at(offsets(69)).asInstanceOf[Ptr[CInt]]
        inline def sample_rate_=(value: CInt): Unit = !struct.at(offsets(69)).asInstanceOf[Ptr[CInt]] = value
        inline def sample_fmt: AVSampleFormat = !struct.at(offsets(70)).asInstanceOf[Ptr[AVSampleFormat]]
        inline def sample_fmt_=(value: AVSampleFormat): Unit = !struct.at(offsets(70)).asInstanceOf[Ptr[AVSampleFormat]] = value
        inline def ch_layout: AVChannelLayout = !struct.at(offsets(71)).asInstanceOf[Ptr[AVChannelLayout]]
        inline def ch_layout_=(value: AVChannelLayout): Unit = !struct.at(offsets(71)).asInstanceOf[Ptr[AVChannelLayout]] = value
        inline def frame_size: CInt = !struct.at(offsets(72)).asInstanceOf[Ptr[CInt]]
        inline def frame_size_=(value: CInt): Unit = !struct.at(offsets(72)).asInstanceOf[Ptr[CInt]] = value
        inline def block_align: CInt = !struct.at(offsets(73)).asInstanceOf[Ptr[CInt]]
        inline def block_align_=(value: CInt): Unit = !struct.at(offsets(73)).asInstanceOf[Ptr[CInt]] = value
        inline def cutoff: CInt = !struct.at(offsets(74)).asInstanceOf[Ptr[CInt]]
        inline def cutoff_=(value: CInt): Unit = !struct.at(offsets(74)).asInstanceOf[Ptr[CInt]] = value
        inline def audio_service_type: AVAudioServiceType = !struct.at(offsets(75)).asInstanceOf[Ptr[AVAudioServiceType]]
        inline def audio_service_type_=(value: AVAudioServiceType): Unit = !struct.at(offsets(75)).asInstanceOf[Ptr[AVAudioServiceType]] = value
        inline def request_sample_fmt: AVSampleFormat = !struct.at(offsets(76)).asInstanceOf[Ptr[AVSampleFormat]]
        inline def request_sample_fmt_=(value: AVSampleFormat): Unit = !struct.at(offsets(76)).asInstanceOf[Ptr[AVSampleFormat]] = value
        inline def initial_padding: CInt = !struct.at(offsets(77)).asInstanceOf[Ptr[CInt]]
        inline def initial_padding_=(value: CInt): Unit = !struct.at(offsets(77)).asInstanceOf[Ptr[CInt]] = value
        inline def trailing_padding: CInt = !struct.at(offsets(78)).asInstanceOf[Ptr[CInt]]
        inline def trailing_padding_=(value: CInt): Unit = !struct.at(offsets(78)).asInstanceOf[Ptr[CInt]] = value
        inline def seek_preroll: CInt = !struct.at(offsets(79)).asInstanceOf[Ptr[CInt]]
        inline def seek_preroll_=(value: CInt): Unit = !struct.at(offsets(79)).asInstanceOf[Ptr[CInt]] = value
        inline def get_buffer2: CFuncPtr3[Ptr[AVCodecContext], Ptr[AVFrame], CInt, CInt] = !struct.at(offsets(80)).asInstanceOf[Ptr[CFuncPtr3[Ptr[AVCodecContext], Ptr[AVFrame], CInt, CInt]]]
        inline def get_buffer2_=(value: CFuncPtr3[Ptr[AVCodecContext], Ptr[AVFrame], CInt, CInt]): Unit = !struct.at(offsets(80)).asInstanceOf[Ptr[CFuncPtr3[Ptr[AVCodecContext], Ptr[AVFrame], CInt, CInt]]] = value
        inline def bit_rate_tolerance: CInt = !struct.at(offsets(81)).asInstanceOf[Ptr[CInt]]
        inline def bit_rate_tolerance_=(value: CInt): Unit = !struct.at(offsets(81)).asInstanceOf[Ptr[CInt]] = value
        inline def global_quality: CInt = !struct.at(offsets(82)).asInstanceOf[Ptr[CInt]]
        inline def global_quality_=(value: CInt): Unit = !struct.at(offsets(82)).asInstanceOf[Ptr[CInt]] = value
        inline def compression_level: CInt = !struct.at(offsets(83)).asInstanceOf[Ptr[CInt]]
        inline def compression_level_=(value: CInt): Unit = !struct.at(offsets(83)).asInstanceOf[Ptr[CInt]] = value
        inline def qcompress: Float = !struct.at(offsets(84)).asInstanceOf[Ptr[Float]]
        inline def qcompress_=(value: Float): Unit = !struct.at(offsets(84)).asInstanceOf[Ptr[Float]] = value
        inline def qblur: Float = !struct.at(offsets(85)).asInstanceOf[Ptr[Float]]
        inline def qblur_=(value: Float): Unit = !struct.at(offsets(85)).asInstanceOf[Ptr[Float]] = value
        inline def qmin: CInt = !struct.at(offsets(86)).asInstanceOf[Ptr[CInt]]
        inline def qmin_=(value: CInt): Unit = !struct.at(offsets(86)).asInstanceOf[Ptr[CInt]] = value
        inline def qmax: CInt = !struct.at(offsets(87)).asInstanceOf[Ptr[CInt]]
        inline def qmax_=(value: CInt): Unit = !struct.at(offsets(87)).asInstanceOf[Ptr[CInt]] = value
        inline def max_qdiff: CInt = !struct.at(offsets(88)).asInstanceOf[Ptr[CInt]]
        inline def max_qdiff_=(value: CInt): Unit = !struct.at(offsets(88)).asInstanceOf[Ptr[CInt]] = value
        inline def rc_buffer_size: CInt = !struct.at(offsets(89)).asInstanceOf[Ptr[CInt]]
        inline def rc_buffer_size_=(value: CInt): Unit = !struct.at(offsets(89)).asInstanceOf[Ptr[CInt]] = value
        inline def rc_override_count: CInt = !struct.at(offsets(90)).asInstanceOf[Ptr[CInt]]
        inline def rc_override_count_=(value: CInt): Unit = !struct.at(offsets(90)).asInstanceOf[Ptr[CInt]] = value
        inline def rc_override: Ptr[RcOverride] = !struct.at(offsets(91)).asInstanceOf[Ptr[Ptr[RcOverride]]]
        inline def rc_override_=(value: Ptr[RcOverride]): Unit = !struct.at(offsets(91)).asInstanceOf[Ptr[Ptr[RcOverride]]] = value
        inline def rc_max_rate: int64_t = !struct.at(offsets(92)).asInstanceOf[Ptr[int64_t]]
        inline def rc_max_rate_=(value: int64_t): Unit = !struct.at(offsets(92)).asInstanceOf[Ptr[int64_t]] = value
        inline def rc_min_rate: int64_t = !struct.at(offsets(93)).asInstanceOf[Ptr[int64_t]]
        inline def rc_min_rate_=(value: int64_t): Unit = !struct.at(offsets(93)).asInstanceOf[Ptr[int64_t]] = value
        inline def rc_max_available_vbv_use: Float = !struct.at(offsets(94)).asInstanceOf[Ptr[Float]]
        inline def rc_max_available_vbv_use_=(value: Float): Unit = !struct.at(offsets(94)).asInstanceOf[Ptr[Float]] = value
        inline def rc_min_vbv_overflow_use: Float = !struct.at(offsets(95)).asInstanceOf[Ptr[Float]]
        inline def rc_min_vbv_overflow_use_=(value: Float): Unit = !struct.at(offsets(95)).asInstanceOf[Ptr[Float]] = value
        inline def rc_initial_buffer_occupancy: CInt = !struct.at(offsets(96)).asInstanceOf[Ptr[CInt]]
        inline def rc_initial_buffer_occupancy_=(value: CInt): Unit = !struct.at(offsets(96)).asInstanceOf[Ptr[CInt]] = value
        inline def trellis: CInt = !struct.at(offsets(97)).asInstanceOf[Ptr[CInt]]
        inline def trellis_=(value: CInt): Unit = !struct.at(offsets(97)).asInstanceOf[Ptr[CInt]] = value
        inline def stats_out: CString = !struct.at(offsets(98)).asInstanceOf[Ptr[CString]]
        inline def stats_out_=(value: CString): Unit = !struct.at(offsets(98)).asInstanceOf[Ptr[CString]] = value
        inline def stats_in: CString = !struct.at(offsets(99)).asInstanceOf[Ptr[CString]]
        inline def stats_in_=(value: CString): Unit = !struct.at(offsets(99)).asInstanceOf[Ptr[CString]] = value
        inline def workaround_bugs: CInt = !struct.at(offsets(100)).asInstanceOf[Ptr[CInt]]
        inline def workaround_bugs_=(value: CInt): Unit = !struct.at(offsets(100)).asInstanceOf[Ptr[CInt]] = value
        inline def strict_std_compliance: CInt = !struct.at(offsets(101)).asInstanceOf[Ptr[CInt]]
        inline def strict_std_compliance_=(value: CInt): Unit = !struct.at(offsets(101)).asInstanceOf[Ptr[CInt]] = value
        inline def error_concealment: CInt = !struct.at(offsets(102)).asInstanceOf[Ptr[CInt]]
        inline def error_concealment_=(value: CInt): Unit = !struct.at(offsets(102)).asInstanceOf[Ptr[CInt]] = value
        inline def debug: CInt = !struct.at(offsets(103)).asInstanceOf[Ptr[CInt]]
        inline def debug_=(value: CInt): Unit = !struct.at(offsets(103)).asInstanceOf[Ptr[CInt]] = value
        inline def err_recognition: CInt = !struct.at(offsets(104)).asInstanceOf[Ptr[CInt]]
        inline def err_recognition_=(value: CInt): Unit = !struct.at(offsets(104)).asInstanceOf[Ptr[CInt]] = value
        inline def hwaccel: Ptr[AVHWAccel] = !struct.at(offsets(105)).asInstanceOf[Ptr[Ptr[AVHWAccel]]]
        inline def hwaccel_=(value: Ptr[AVHWAccel]): Unit = !struct.at(offsets(105)).asInstanceOf[Ptr[Ptr[AVHWAccel]]] = value
        inline def hwaccel_context: Ptr[Byte] = !struct.at(offsets(106)).asInstanceOf[Ptr[Ptr[Byte]]]
        inline def hwaccel_context_=(value: Ptr[Byte]): Unit = !struct.at(offsets(106)).asInstanceOf[Ptr[Ptr[Byte]]] = value
        inline def hw_frames_ctx: Ptr[AVBufferRef] = !struct.at(offsets(107)).asInstanceOf[Ptr[Ptr[AVBufferRef]]]
        inline def hw_frames_ctx_=(value: Ptr[AVBufferRef]): Unit = !struct.at(offsets(107)).asInstanceOf[Ptr[Ptr[AVBufferRef]]] = value
        inline def hw_device_ctx: Ptr[AVBufferRef] = !struct.at(offsets(108)).asInstanceOf[Ptr[Ptr[AVBufferRef]]]
        inline def hw_device_ctx_=(value: Ptr[AVBufferRef]): Unit = !struct.at(offsets(108)).asInstanceOf[Ptr[Ptr[AVBufferRef]]] = value
        inline def hwaccel_flags: CInt = !struct.at(offsets(109)).asInstanceOf[Ptr[CInt]]
        inline def hwaccel_flags_=(value: CInt): Unit = !struct.at(offsets(109)).asInstanceOf[Ptr[CInt]] = value
        inline def extra_hw_frames: CInt = !struct.at(offsets(110)).asInstanceOf[Ptr[CInt]]
        inline def extra_hw_frames_=(value: CInt): Unit = !struct.at(offsets(110)).asInstanceOf[Ptr[CInt]] = value
        inline def error: CArray[uint64_t, Nat._8] = !struct.at(offsets(111)).asInstanceOf[Ptr[CArray[uint64_t, Nat._8]]]
        inline def error_=(value: CArray[uint64_t, Nat._8]): Unit = !struct.at(offsets(111)).asInstanceOf[Ptr[CArray[uint64_t, Nat._8]]] = value
        inline def dct_algo: CInt = !struct.at(offsets(112)).asInstanceOf[Ptr[CInt]]
        inline def dct_algo_=(value: CInt): Unit = !struct.at(offsets(112)).asInstanceOf[Ptr[CInt]] = value
        inline def idct_algo: CInt = !struct.at(offsets(113)).asInstanceOf[Ptr[CInt]]
        inline def idct_algo_=(value: CInt): Unit = !struct.at(offsets(113)).asInstanceOf[Ptr[CInt]] = value
        inline def bits_per_coded_sample: CInt = !struct.at(offsets(114)).asInstanceOf[Ptr[CInt]]
        inline def bits_per_coded_sample_=(value: CInt): Unit = !struct.at(offsets(114)).asInstanceOf[Ptr[CInt]] = value
        inline def bits_per_raw_sample: CInt = !struct.at(offsets(115)).asInstanceOf[Ptr[CInt]]
        inline def bits_per_raw_sample_=(value: CInt): Unit = !struct.at(offsets(115)).asInstanceOf[Ptr[CInt]] = value
        inline def thread_count: CInt = !struct.at(offsets(116)).asInstanceOf[Ptr[CInt]]
        inline def thread_count_=(value: CInt): Unit = !struct.at(offsets(116)).asInstanceOf[Ptr[CInt]] = value
        inline def thread_type: CInt = !struct.at(offsets(117)).asInstanceOf[Ptr[CInt]]
        inline def thread_type_=(value: CInt): Unit = !struct.at(offsets(117)).asInstanceOf[Ptr[CInt]] = value
        inline def active_thread_type: CInt = !struct.at(offsets(118)).asInstanceOf[Ptr[CInt]]
        inline def active_thread_type_=(value: CInt): Unit = !struct.at(offsets(118)).asInstanceOf[Ptr[CInt]] = value
        inline def execute: CFuncPtr6[Ptr[AVCodecContext], CFuncPtr2[Ptr[AVCodecContext], Ptr[Byte], CInt], Ptr[Byte], Ptr[CInt], CInt, CInt, CInt] = !struct.at(offsets(119)).asInstanceOf[Ptr[CFuncPtr6[Ptr[AVCodecContext], CFuncPtr2[Ptr[AVCodecContext], Ptr[Byte], CInt], Ptr[Byte], Ptr[CInt], CInt, CInt, CInt]]]
        inline def execute_=(value: CFuncPtr6[Ptr[AVCodecContext], CFuncPtr2[Ptr[AVCodecContext], Ptr[Byte], CInt], Ptr[Byte], Ptr[CInt], CInt, CInt, CInt]): Unit = !struct.at(offsets(119)).asInstanceOf[Ptr[CFuncPtr6[Ptr[AVCodecContext], CFuncPtr2[Ptr[AVCodecContext], Ptr[Byte], CInt], Ptr[Byte], Ptr[CInt], CInt, CInt, CInt]]] = value
        inline def execute2: CFuncPtr5[Ptr[AVCodecContext], CFuncPtr4[Ptr[AVCodecContext], Ptr[Byte], CInt, CInt, CInt], Ptr[Byte], Ptr[CInt], CInt, CInt] = !struct.at(offsets(120)).asInstanceOf[Ptr[CFuncPtr5[Ptr[AVCodecContext], CFuncPtr4[Ptr[AVCodecContext], Ptr[Byte], CInt, CInt, CInt], Ptr[Byte], Ptr[CInt], CInt, CInt]]]
        inline def execute2_=(value: CFuncPtr5[Ptr[AVCodecContext], CFuncPtr4[Ptr[AVCodecContext], Ptr[Byte], CInt, CInt, CInt], Ptr[Byte], Ptr[CInt], CInt, CInt]): Unit = !struct.at(offsets(120)).asInstanceOf[Ptr[CFuncPtr5[Ptr[AVCodecContext], CFuncPtr4[Ptr[AVCodecContext], Ptr[Byte], CInt, CInt, CInt], Ptr[Byte], Ptr[CInt], CInt, CInt]]] = value
        inline def profile: CInt = !struct.at(offsets(121)).asInstanceOf[Ptr[CInt]]
        inline def profile_=(value: CInt): Unit = !struct.at(offsets(121)).asInstanceOf[Ptr[CInt]] = value
        inline def level: CInt = !struct.at(offsets(122)).asInstanceOf[Ptr[CInt]]
        inline def level_=(value: CInt): Unit = !struct.at(offsets(122)).asInstanceOf[Ptr[CInt]] = value
        inline def properties: CUnsignedInt = !struct.at(offsets(123)).asInstanceOf[Ptr[CUnsignedInt]]
        inline def properties_=(value: CUnsignedInt): Unit = !struct.at(offsets(123)).asInstanceOf[Ptr[CUnsignedInt]] = value
        inline def skip_loop_filter: AVDiscard = !struct.at(offsets(124)).asInstanceOf[Ptr[AVDiscard]]
        inline def skip_loop_filter_=(value: AVDiscard): Unit = !struct.at(offsets(124)).asInstanceOf[Ptr[AVDiscard]] = value
        inline def skip_idct: AVDiscard = !struct.at(offsets(125)).asInstanceOf[Ptr[AVDiscard]]
        inline def skip_idct_=(value: AVDiscard): Unit = !struct.at(offsets(125)).asInstanceOf[Ptr[AVDiscard]] = value
        inline def skip_frame: AVDiscard = !struct.at(offsets(126)).asInstanceOf[Ptr[AVDiscard]]
        inline def skip_frame_=(value: AVDiscard): Unit = !struct.at(offsets(126)).asInstanceOf[Ptr[AVDiscard]] = value
        inline def skip_alpha: CInt = !struct.at(offsets(127)).asInstanceOf[Ptr[CInt]]
        inline def skip_alpha_=(value: CInt): Unit = !struct.at(offsets(127)).asInstanceOf[Ptr[CInt]] = value
        inline def skip_top: CInt = !struct.at(offsets(128)).asInstanceOf[Ptr[CInt]]
        inline def skip_top_=(value: CInt): Unit = !struct.at(offsets(128)).asInstanceOf[Ptr[CInt]] = value
        inline def skip_bottom: CInt = !struct.at(offsets(129)).asInstanceOf[Ptr[CInt]]
        inline def skip_bottom_=(value: CInt): Unit = !struct.at(offsets(129)).asInstanceOf[Ptr[CInt]] = value
        inline def lowres: CInt = !struct.at(offsets(130)).asInstanceOf[Ptr[CInt]]
        inline def lowres_=(value: CInt): Unit = !struct.at(offsets(130)).asInstanceOf[Ptr[CInt]] = value
        inline def codec_descriptor: Ptr[AVCodecDescriptor] = !struct.at(offsets(131)).asInstanceOf[Ptr[Ptr[AVCodecDescriptor]]]
        inline def codec_descriptor_=(value: Ptr[AVCodecDescriptor]): Unit = !struct.at(offsets(131)).asInstanceOf[Ptr[Ptr[AVCodecDescriptor]]] = value
        inline def sub_charenc: CString = !struct.at(offsets(132)).asInstanceOf[Ptr[CString]]
        inline def sub_charenc_=(value: CString): Unit = !struct.at(offsets(132)).asInstanceOf[Ptr[CString]] = value
        inline def sub_charenc_mode: CInt = !struct.at(offsets(133)).asInstanceOf[Ptr[CInt]]
        inline def sub_charenc_mode_=(value: CInt): Unit = !struct.at(offsets(133)).asInstanceOf[Ptr[CInt]] = value
        inline def subtitle_header_size: CInt = !struct.at(offsets(134)).asInstanceOf[Ptr[CInt]]
        inline def subtitle_header_size_=(value: CInt): Unit = !struct.at(offsets(134)).asInstanceOf[Ptr[CInt]] = value
        inline def subtitle_header: Ptr[uint8_t] = !struct.at(offsets(135)).asInstanceOf[Ptr[Ptr[uint8_t]]]
        inline def subtitle_header_=(value: Ptr[uint8_t]): Unit = !struct.at(offsets(135)).asInstanceOf[Ptr[Ptr[uint8_t]]] = value
        inline def dump_separator: Ptr[uint8_t] = !struct.at(offsets(136)).asInstanceOf[Ptr[Ptr[uint8_t]]]
        inline def dump_separator_=(value: Ptr[uint8_t]): Unit = !struct.at(offsets(136)).asInstanceOf[Ptr[Ptr[uint8_t]]] = value
        inline def codec_whitelist: CString = !struct.at(offsets(137)).asInstanceOf[Ptr[CString]]
        inline def codec_whitelist_=(value: CString): Unit = !struct.at(offsets(137)).asInstanceOf[Ptr[CString]] = value
        inline def coded_side_data: Ptr[AVPacketSideData] = !struct.at(offsets(138)).asInstanceOf[Ptr[Ptr[AVPacketSideData]]]
        inline def coded_side_data_=(value: Ptr[AVPacketSideData]): Unit = !struct.at(offsets(138)).asInstanceOf[Ptr[Ptr[AVPacketSideData]]] = value
        inline def nb_coded_side_data: CInt = !struct.at(offsets(139)).asInstanceOf[Ptr[CInt]]
        inline def nb_coded_side_data_=(value: CInt): Unit = !struct.at(offsets(139)).asInstanceOf[Ptr[CInt]] = value
        inline def export_side_data: CInt = !struct.at(offsets(140)).asInstanceOf[Ptr[CInt]]
        inline def export_side_data_=(value: CInt): Unit = !struct.at(offsets(140)).asInstanceOf[Ptr[CInt]] = value
        inline def max_pixels: int64_t = !struct.at(offsets(141)).asInstanceOf[Ptr[int64_t]]
        inline def max_pixels_=(value: int64_t): Unit = !struct.at(offsets(141)).asInstanceOf[Ptr[int64_t]] = value
        inline def apply_cropping: CInt = !struct.at(offsets(142)).asInstanceOf[Ptr[CInt]]
        inline def apply_cropping_=(value: CInt): Unit = !struct.at(offsets(142)).asInstanceOf[Ptr[CInt]] = value
        inline def discard_damaged_percentage: CInt = !struct.at(offsets(143)).asInstanceOf[Ptr[CInt]]
        inline def discard_damaged_percentage_=(value: CInt): Unit = !struct.at(offsets(143)).asInstanceOf[Ptr[CInt]] = value
        inline def max_samples: int64_t = !struct.at(offsets(144)).asInstanceOf[Ptr[int64_t]]
        inline def max_samples_=(value: int64_t): Unit = !struct.at(offsets(144)).asInstanceOf[Ptr[int64_t]] = value
        inline def get_encode_buffer: CFuncPtr3[Ptr[AVCodecContext], Ptr[AVPacket], CInt, CInt] = !struct.at(offsets(145)).asInstanceOf[Ptr[CFuncPtr3[Ptr[AVCodecContext], Ptr[AVPacket], CInt, CInt]]]
        inline def get_encode_buffer_=(value: CFuncPtr3[Ptr[AVCodecContext], Ptr[AVPacket], CInt, CInt]): Unit = !struct.at(offsets(145)).asInstanceOf[Ptr[CFuncPtr3[Ptr[AVCodecContext], Ptr[AVPacket], CInt, CInt]]] = value
        inline def frame_num: int64_t = !struct.at(offsets(146)).asInstanceOf[Ptr[int64_t]]
        inline def frame_num_=(value: int64_t): Unit = !struct.at(offsets(146)).asInstanceOf[Ptr[int64_t]] = value
        inline def side_data_prefer_packet: Ptr[CInt] = !struct.at(offsets(147)).asInstanceOf[Ptr[Ptr[CInt]]]
        inline def side_data_prefer_packet_=(value: Ptr[CInt]): Unit = !struct.at(offsets(147)).asInstanceOf[Ptr[Ptr[CInt]]] = value
        inline def nb_side_data_prefer_packet: CUnsignedInt = !struct.at(offsets(148)).asInstanceOf[Ptr[CUnsignedInt]]
        inline def nb_side_data_prefer_packet_=(value: CUnsignedInt): Unit = !struct.at(offsets(148)).asInstanceOf[Ptr[CUnsignedInt]] = value
        inline def decoded_side_data: Ptr[Ptr[AVFrameSideData]] = !struct.at(offsets(149)).asInstanceOf[Ptr[Ptr[Ptr[AVFrameSideData]]]]
        inline def decoded_side_data_=(value: Ptr[Ptr[AVFrameSideData]]): Unit = !struct.at(offsets(149)).asInstanceOf[Ptr[Ptr[Ptr[AVFrameSideData]]]] = value
        inline def nb_decoded_side_data: CInt = !struct.at(offsets(150)).asInstanceOf[Ptr[CInt]]
        inline def nb_decoded_side_data_=(value: CInt): Unit = !struct.at(offsets(150)).asInstanceOf[Ptr[CInt]] = value
      end extension
    
    // Allocates AVCodecContext on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVCodecContext] = scala.scalanative.unsafe.alloc[AVCodecContext](1)
    def apply(av_class : Ptr[AVClass], log_level_offset : CInt, codec_type : AVMediaType, codec : Ptr[AVCodec], codec_id : AVCodecID, codec_tag : CUnsignedInt, priv_data : Ptr[Byte], internal : Ptr[AVCodecInternal], opaque : Ptr[Byte], bit_rate : int64_t, flags : CInt, flags2 : CInt, extradata : Ptr[uint8_t], extradata_size : CInt, time_base : AVRational, pkt_timebase : AVRational, framerate : AVRational, delay : CInt, width : CInt, height : CInt, coded_width : CInt, coded_height : CInt, sample_aspect_ratio : AVRational, pix_fmt : AVPixelFormat, sw_pix_fmt : AVPixelFormat, color_primaries : AVColorPrimaries, color_trc : AVColorTransferCharacteristic, colorspace : AVColorSpace, color_range : AVColorRange, chroma_sample_location : AVChromaLocation, field_order : AVFieldOrder, refs : CInt, has_b_frames : CInt, slice_flags : CInt, draw_horiz_band : CFuncPtr6[Ptr[AVCodecContext], Ptr[AVFrame], CArray[CInt, Nat._8], CInt, CInt, CInt, Unit], get_format : CFuncPtr2[Ptr[AVCodecContext], Ptr[AVPixelFormat], AVPixelFormat], max_b_frames : CInt, b_quant_factor : Float, b_quant_offset : Float, i_quant_factor : Float, i_quant_offset : Float, lumi_masking : Float, temporal_cplx_masking : Float, spatial_cplx_masking : Float, p_masking : Float, dark_masking : Float, nsse_weight : CInt, me_cmp : CInt, me_sub_cmp : CInt, mb_cmp : CInt, ildct_cmp : CInt, dia_size : CInt, last_predictor_count : CInt, me_pre_cmp : CInt, pre_dia_size : CInt, me_subpel_quality : CInt, me_range : CInt, mb_decision : CInt, intra_matrix : Ptr[uint16_t], inter_matrix : Ptr[uint16_t], chroma_intra_matrix : Ptr[uint16_t], intra_dc_precision : CInt, mb_lmin : CInt, mb_lmax : CInt, bidir_refine : CInt, keyint_min : CInt, gop_size : CInt, mv0_threshold : CInt, slices : CInt, sample_rate : CInt, sample_fmt : AVSampleFormat, ch_layout : AVChannelLayout, frame_size : CInt, block_align : CInt, cutoff : CInt, audio_service_type : AVAudioServiceType, request_sample_fmt : AVSampleFormat, initial_padding : CInt, trailing_padding : CInt, seek_preroll : CInt, get_buffer2 : CFuncPtr3[Ptr[AVCodecContext], Ptr[AVFrame], CInt, CInt], bit_rate_tolerance : CInt, global_quality : CInt, compression_level : CInt, qcompress : Float, qblur : Float, qmin : CInt, qmax : CInt, max_qdiff : CInt, rc_buffer_size : CInt, rc_override_count : CInt, rc_override : Ptr[RcOverride], rc_max_rate : int64_t, rc_min_rate : int64_t, rc_max_available_vbv_use : Float, rc_min_vbv_overflow_use : Float, rc_initial_buffer_occupancy : CInt, trellis : CInt, stats_out : CString, stats_in : CString, workaround_bugs : CInt, strict_std_compliance : CInt, error_concealment : CInt, debug : CInt, err_recognition : CInt, hwaccel : Ptr[AVHWAccel], hwaccel_context : Ptr[Byte], hw_frames_ctx : Ptr[AVBufferRef], hw_device_ctx : Ptr[AVBufferRef], hwaccel_flags : CInt, extra_hw_frames : CInt, error : CArray[uint64_t, Nat._8], dct_algo : CInt, idct_algo : CInt, bits_per_coded_sample : CInt, bits_per_raw_sample : CInt, thread_count : CInt, thread_type : CInt, active_thread_type : CInt, execute : CFuncPtr6[Ptr[AVCodecContext], CFuncPtr2[Ptr[AVCodecContext], Ptr[Byte], CInt], Ptr[Byte], Ptr[CInt], CInt, CInt, CInt], execute2 : CFuncPtr5[Ptr[AVCodecContext], CFuncPtr4[Ptr[AVCodecContext], Ptr[Byte], CInt, CInt, CInt], Ptr[Byte], Ptr[CInt], CInt, CInt], profile : CInt, level : CInt, properties : CUnsignedInt, skip_loop_filter : AVDiscard, skip_idct : AVDiscard, skip_frame : AVDiscard, skip_alpha : CInt, skip_top : CInt, skip_bottom : CInt, lowres : CInt, codec_descriptor : Ptr[AVCodecDescriptor], sub_charenc : CString, sub_charenc_mode : CInt, subtitle_header_size : CInt, subtitle_header : Ptr[uint8_t], dump_separator : Ptr[uint8_t], codec_whitelist : CString, coded_side_data : Ptr[AVPacketSideData], nb_coded_side_data : CInt, export_side_data : CInt, max_pixels : int64_t, apply_cropping : CInt, discard_damaged_percentage : CInt, max_samples : int64_t, get_encode_buffer : CFuncPtr3[Ptr[AVCodecContext], Ptr[AVPacket], CInt, CInt], frame_num : int64_t, side_data_prefer_packet : Ptr[CInt], nb_side_data_prefer_packet : CUnsignedInt, decoded_side_data : Ptr[Ptr[AVFrameSideData]], nb_decoded_side_data : CInt)(using Zone): Ptr[AVCodecContext] =
      val ____ptr = apply()
    ...
    val offsets: Array[Int] =
      ...
      res(1) = align(res(0) + sizeof[Ptr[AVClass]].toInt, alignmentof[CInt].toInt)
      res(2) = align(res(1) + sizeof[CInt].toInt, alignmentof[AVMediaType].toInt)
      res(3) = align(res(2) + sizeof[AVMediaType].toInt, alignmentof[Ptr[AVCodec]].toInt)
      res(4) = align(res(3) + sizeof[Ptr[AVCodec]].toInt, alignmentof[AVCodecID].toInt)
      res(5) = align(res(4) + sizeof[AVCodecID].toInt, alignmentof[CUnsignedInt].toInt)
      res(6) = align(res(5) + sizeof[CUnsignedInt].toInt, alignmentof[Ptr[Byte]].toInt)
      res(7) = align(res(6) + sizeof[Ptr[Byte]].toInt, alignmentof[Ptr[AVCodecInternal]].toInt)
      res(8) = align(res(7) + sizeof[Ptr[AVCodecInternal]].toInt, alignmentof[Ptr[Byte]].toInt)
      res(9) = align(res(8) + sizeof[Ptr[Byte]].toInt, alignmentof[int64_t].toInt)
      ...
      res(12) = align(res(11) + sizeof[CInt].toInt, alignmentof[Ptr[uint8_t]].toInt)
      res(13) = align(res(12) + sizeof[Ptr[uint8_t]].toInt, alignmentof[CInt].toInt)
      res(14) = align(res(13) + sizeof[CInt].toInt, alignmentof[AVRational].toInt)
      res(15) = align(res(14) + sizeof[AVRational].toInt, alignmentof[AVRational].toInt)
      res(16) = align(res(15) + sizeof[AVRational].toInt, alignmentof[AVRational].toInt)
      res(17) = align(res(16) + sizeof[AVRational].toInt, alignmentof[CInt].toInt)
      ...
      res(22) = align(res(21) + sizeof[CInt].toInt, alignmentof[AVRational].toInt)
      res(23) = align(res(22) + sizeof[AVRational].toInt, alignmentof[AVPixelFormat].toInt)
      res(24) = align(res(23) + sizeof[AVPixelFormat].toInt, alignmentof[AVPixelFormat].toInt)
      res(25) = align(res(24) + sizeof[AVPixelFormat].toInt, alignmentof[AVColorPrimaries].toInt)
      res(26) = align(res(25) + sizeof[AVColorPrimaries].toInt, alignmentof[AVColorTransferCharacteristic].toInt)
      res(27) = align(res(26) + sizeof[AVColorTransferCharacteristic].toInt, alignmentof[AVColorSpace].toInt)
      res(28) = align(res(27) + sizeof[AVColorSpace].toInt, alignmentof[AVColorRange].toInt)
      res(29) = align(res(28) + sizeof[AVColorRange].toInt, alignmentof[AVChromaLocation].toInt)
      res(30) = align(res(29) + sizeof[AVChromaLocation].toInt, alignmentof[AVFieldOrder].toInt)
      res(31) = align(res(30) + sizeof[AVFieldOrder].toInt, alignmentof[CInt].toInt)
      res(32) = align(res(31) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(33) = align(res(32) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(34) = align(res(33) + sizeof[CInt].toInt, alignmentof[CFuncPtr6[Ptr[AVCodecContext], Ptr[AVFrame], CArray[CInt, Nat._8], CInt, CInt, CInt, Unit]].toInt)
      res(35) = align(res(34) + sizeof[CFuncPtr6[Ptr[AVCodecContext], Ptr[AVFrame], CArray[CInt, Nat._8], CInt, CInt, CInt, Unit]].toInt, alignmentof[CFuncPtr2[Ptr[AVCodecContext], Ptr[AVPixelFormat], AVPixelFormat]].toInt)
      res(36) = align(res(35) + sizeof[CFuncPtr2[Ptr[AVCodecContext], Ptr[AVPixelFormat], AVPixelFormat]].toInt, alignmentof[CInt].toInt)
      res(37) = align(res(36) + sizeof[CInt].toInt, alignmentof[Float].toInt)
      res(38) = align(res(37) + sizeof[Float].toInt, alignmentof[Float].toInt)
      ...
      res(46) = align(res(45) + sizeof[Float].toInt, alignmentof[CInt].toInt)
      ...
      res(58) = align(res(57) + sizeof[CInt].toInt, alignmentof[Ptr[uint16_t]].toInt)
      res(59) = align(res(58) + sizeof[Ptr[uint16_t]].toInt, alignmentof[Ptr[uint16_t]].toInt)
      res(60) = align(res(59) + sizeof[Ptr[uint16_t]].toInt, alignmentof[Ptr[uint16_t]].toInt)
      res(61) = align(res(60) + sizeof[Ptr[uint16_t]].toInt, alignmentof[CInt].toInt)
      res(62) = align(res(61) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      ...
      res(70) = align(res(69) + sizeof[CInt].toInt, alignmentof[AVSampleFormat].toInt)
      res(71) = align(res(70) + sizeof[AVSampleFormat].toInt, alignmentof[AVChannelLayout].toInt)
      res(72) = align(res(71) + sizeof[AVChannelLayout].toInt, alignmentof[CInt].toInt)
      res(73) = align(res(72) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(74) = align(res(73) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(75) = align(res(74) + sizeof[CInt].toInt, alignmentof[AVAudioServiceType].toInt)
      res(76) = align(res(75) + sizeof[AVAudioServiceType].toInt, alignmentof[AVSampleFormat].toInt)
      res(77) = align(res(76) + sizeof[AVSampleFormat].toInt, alignmentof[CInt].toInt)
      res(78) = align(res(77) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(79) = align(res(78) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(80) = align(res(79) + sizeof[CInt].toInt, alignmentof[CFuncPtr3[Ptr[AVCodecContext], Ptr[AVFrame], CInt, CInt]].toInt)
      res(81) = align(res(80) + sizeof[CFuncPtr3[Ptr[AVCodecContext], Ptr[AVFrame], CInt, CInt]].toInt, alignmentof[CInt].toInt)
      res(82) = align(res(81) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(83) = align(res(82) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(84) = align(res(83) + sizeof[CInt].toInt, alignmentof[Float].toInt)
      res(85) = align(res(84) + sizeof[Float].toInt, alignmentof[Float].toInt)
      res(86) = align(res(85) + sizeof[Float].toInt, alignmentof[CInt].toInt)
      res(87) = align(res(86) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      ...
      res(91) = align(res(90) + sizeof[CInt].toInt, alignmentof[Ptr[RcOverride]].toInt)
      res(92) = align(res(91) + sizeof[Ptr[RcOverride]].toInt, alignmentof[int64_t].toInt)
      res(93) = align(res(92) + sizeof[int64_t].toInt, alignmentof[int64_t].toInt)
      res(94) = align(res(93) + sizeof[int64_t].toInt, alignmentof[Float].toInt)
      res(95) = align(res(94) + sizeof[Float].toInt, alignmentof[Float].toInt)
      res(96) = align(res(95) + sizeof[Float].toInt, alignmentof[CInt].toInt)
      res(97) = align(res(96) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(98) = align(res(97) + sizeof[CInt].toInt, alignmentof[CString].toInt)
      res(99) = align(res(98) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(100) = align(res(99) + sizeof[CString].toInt, alignmentof[CInt].toInt)
      res(101) = align(res(100) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      ...
      res(105) = align(res(104) + sizeof[CInt].toInt, alignmentof[Ptr[AVHWAccel]].toInt)
      res(106) = align(res(105) + sizeof[Ptr[AVHWAccel]].toInt, alignmentof[Ptr[Byte]].toInt)
      res(107) = align(res(106) + sizeof[Ptr[Byte]].toInt, alignmentof[Ptr[AVBufferRef]].toInt)
      res(108) = align(res(107) + sizeof[Ptr[AVBufferRef]].toInt, alignmentof[Ptr[AVBufferRef]].toInt)
      res(109) = align(res(108) + sizeof[Ptr[AVBufferRef]].toInt, alignmentof[CInt].toInt)
      res(110) = align(res(109) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(111) = align(res(110) + sizeof[CInt].toInt, alignmentof[uint64_t].toInt)
      res(112) = align(res(111) + sizeof[CArray[uint64_t, Nat._8]].toInt, alignmentof[CInt].toInt)
      res(113) = align(res(112) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      ...
      res(119) = align(res(118) + sizeof[CInt].toInt, alignmentof[CFuncPtr6[Ptr[AVCodecContext], CFuncPtr2[Ptr[AVCodecContext], Ptr[Byte], CInt], Ptr[Byte], Ptr[CInt], CInt, CInt, CInt]].toInt)
      res(120) = align(res(119) + sizeof[CFuncPtr6[Ptr[AVCodecContext], CFuncPtr2[Ptr[AVCodecContext], Ptr[Byte], CInt], Ptr[Byte], Ptr[CInt], CInt, CInt, CInt]].toInt, alignmentof[CFuncPtr5[Ptr[AVCodecContext], CFuncPtr4[Ptr[AVCodecContext], Ptr[Byte], CInt, CInt, CInt], Ptr[Byte], Ptr[CInt], CInt, CInt]].toInt)
      res(121) = align(res(120) + sizeof[CFuncPtr5[Ptr[AVCodecContext], CFuncPtr4[Ptr[AVCodecContext], Ptr[Byte], CInt, CInt, CInt], Ptr[Byte], Ptr[CInt], CInt, CInt]].toInt, alignmentof[CInt].toInt)
      res(122) = align(res(121) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(123) = align(res(122) + sizeof[CInt].toInt, alignmentof[CUnsignedInt].toInt)
      res(124) = align(res(123) + sizeof[CUnsignedInt].toInt, alignmentof[AVDiscard].toInt)
      res(125) = align(res(124) + sizeof[AVDiscard].toInt, alignmentof[AVDiscard].toInt)
      res(126) = align(res(125) + sizeof[AVDiscard].toInt, alignmentof[AVDiscard].toInt)
      res(127) = align(res(126) + sizeof[AVDiscard].toInt, alignmentof[CInt].toInt)
      res(128) = align(res(127) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      ...
      res(131) = align(res(130) + sizeof[CInt].toInt, alignmentof[Ptr[AVCodecDescriptor]].toInt)
      res(132) = align(res(131) + sizeof[Ptr[AVCodecDescriptor]].toInt, alignmentof[CString].toInt)
      res(133) = align(res(132) + sizeof[CString].toInt, alignmentof[CInt].toInt)
      res(134) = align(res(133) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(135) = align(res(134) + sizeof[CInt].toInt, alignmentof[Ptr[uint8_t]].toInt)
      res(136) = align(res(135) + sizeof[Ptr[uint8_t]].toInt, alignmentof[Ptr[uint8_t]].toInt)
      res(137) = align(res(136) + sizeof[Ptr[uint8_t]].toInt, alignmentof[CString].toInt)
      res(138) = align(res(137) + sizeof[CString].toInt, alignmentof[Ptr[AVPacketSideData]].toInt)
      res(139) = align(res(138) + sizeof[Ptr[AVPacketSideData]].toInt, alignmentof[CInt].toInt)
      res(140) = align(res(139) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(141) = align(res(140) + sizeof[CInt].toInt, alignmentof[int64_t].toInt)
      res(142) = align(res(141) + sizeof[int64_t].toInt, alignmentof[CInt].toInt)
      res(143) = align(res(142) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(144) = align(res(143) + sizeof[CInt].toInt, alignmentof[int64_t].toInt)
      res(145) = align(res(144) + sizeof[int64_t].toInt, alignmentof[CFuncPtr3[Ptr[AVCodecContext], Ptr[AVPacket], CInt, CInt]].toInt)
      res(146) = align(res(145) + sizeof[CFuncPtr3[Ptr[AVCodecContext], Ptr[AVPacket], CInt, CInt]].toInt, alignmentof[int64_t].toInt)
      res(147) = align(res(146) + sizeof[int64_t].toInt, alignmentof[Ptr[CInt]].toInt)
      res(148) = align(res(147) + sizeof[Ptr[CInt]].toInt, alignmentof[CUnsignedInt].toInt)
      res(149) = align(res(148) + sizeof[CUnsignedInt].toInt, alignmentof[Ptr[Ptr[AVFrameSideData]]].toInt)
      res(150) = align(res(149) + sizeof[Ptr[Ptr[AVFrameSideData]]].toInt, alignmentof[CInt].toInt)
      res
    end offsets
  ...
  */
  opaque type AVCodecDescriptor = CStruct7[AVCodecID, AVMediaType, CString, CString, CInt, Ptr[CString], Ptr[AVProfile]]
  
  object AVCodecDescriptor:
    given _tag: Tag[AVCodecDescriptor] = Tag.materializeCStruct7Tag[AVCodecID, AVMediaType, CString, CString, CInt, Ptr[CString], Ptr[AVProfile]]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVCodecDescriptor)
        inline def id : AVCodecID = struct._1
        inline def id_=(value: AVCodecID): Unit = (!struct.at1 = value)
        inline def `type` : AVMediaType = struct._2
        inline def type_=(value: AVMediaType): Unit = (!struct.at2 = value)
        inline def name : CString = struct._3
        inline def name_=(value: CString): Unit = (!struct.at3 = value)
        inline def long_name : CString = struct._4
        inline def long_name_=(value: CString): Unit = (!struct.at4 = value)
        inline def props : CInt = struct._5
        inline def props_=(value: CInt): Unit = (!struct.at5 = value)
        inline def mime_types : Ptr[CString] = struct._6
        inline def mime_types_=(value: Ptr[CString]): Unit = (!struct.at6 = value)
        inline def profiles : Ptr[AVProfile] = struct._7
        inline def profiles_=(value: Ptr[AVProfile]): Unit = (!struct.at7 = value)
      end extension
    
    // Allocates AVCodecDescriptor on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVCodecDescriptor] = scala.scalanative.unsafe.alloc[AVCodecDescriptor](1)
    def apply(id : AVCodecID, `type` : AVMediaType, name : CString, long_name : CString, props : CInt, mime_types : Ptr[CString], profiles : Ptr[AVProfile])(using Zone): Ptr[AVCodecDescriptor] =
      val ____ptr = apply()
      (!____ptr).id = id
      (!____ptr).`type` = `type`
      (!____ptr).name = name
  ...
  object AVCodecHWConfig:
    given _tag: Tag[AVCodecHWConfig] = Tag.materializeCStruct3Tag[AVPixelFormat, CInt, AVHWDeviceType]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVCodecHWConfig)
        inline def pix_fmt : AVPixelFormat = struct._1
        inline def pix_fmt_=(value: AVPixelFormat): Unit = (!struct.at1 = value)
        inline def methods : CInt = struct._2
        inline def methods_=(value: CInt): Unit = (!struct.at2 = value)
        inline def device_type : AVHWDeviceType = struct._3
        inline def device_type_=(value: AVHWDeviceType): Unit = (!struct.at3 = value)
      end extension
    
    // Allocates AVCodecHWConfig on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVCodecHWConfig] = scala.scalanative.unsafe.alloc[AVCodecHWConfig](1)
    def apply(pix_fmt : AVPixelFormat, methods : CInt, device_type : AVHWDeviceType)(using Zone): Ptr[AVCodecHWConfig] =
      val ____ptr = apply()
      (!____ptr).pix_fmt = pix_fmt
  ...
  */
  ...
  opaque type AVCodecParser = CStruct6[CArray[CInt, Nat._7], CInt, CFuncPtr1[Ptr[AVCodecParserContext], CInt], CFuncPtr6[Ptr[AVCodecParserContext], Ptr[AVCodecContext], Ptr[Ptr[uint8_t]], Ptr[CInt], Ptr[uint8_t], CInt, CInt], CFuncPtr1[Ptr[AVCodecParserContext], Unit], CFuncPtr3[Ptr[AVCodecContext], Ptr[uint8_t], CInt, CInt]]
  
  object AVCodecParser:
    given _tag: Tag[AVCodecParser] = Tag.materializeCStruct6Tag[CArray[CInt, Nat._7], CInt, CFuncPtr1[Ptr[AVCodecParserContext], CInt], CFuncPtr6[Ptr[AVCodecParserContext], Ptr[AVCodecContext], Ptr[Ptr[uint8_t]], Ptr[CInt], Ptr[uint8_t], CInt, CInt], CFuncPtr1[Ptr[AVCodecParserContext], Unit], CFuncPtr3[Ptr[AVCodecContext], Ptr[uint8_t], CInt, CInt]]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVCodecParser)
        inline def codec_ids : CArray[CInt, Nat._7] = struct._1
        inline def codec_ids_=(value: CArray[CInt, Nat._7]): Unit = (!struct.at1 = value)
        inline def priv_data_size : CInt = struct._2
        inline def priv_data_size_=(value: CInt): Unit = (!struct.at2 = value)
        inline def parser_init : CFuncPtr1[Ptr[AVCodecParserContext], CInt] = struct._3
        inline def parser_init_=(value: CFuncPtr1[Ptr[AVCodecParserContext], CInt]): Unit = (!struct.at3 = value)
        inline def parser_parse : CFuncPtr6[Ptr[AVCodecParserContext], Ptr[AVCodecContext], Ptr[Ptr[uint8_t]], Ptr[CInt], Ptr[uint8_t], CInt, CInt] = struct._4
        inline def parser_parse_=(value: CFuncPtr6[Ptr[AVCodecParserContext], Ptr[AVCodecContext], Ptr[Ptr[uint8_t]], Ptr[CInt], Ptr[uint8_t], CInt, CInt]): Unit = (!struct.at4 = value)
        inline def parser_close : CFuncPtr1[Ptr[AVCodecParserContext], Unit] = struct._5
        inline def parser_close_=(value: CFuncPtr1[Ptr[AVCodecParserContext], Unit]): Unit = (!struct.at5 = value)
        inline def split : CFuncPtr3[Ptr[AVCodecContext], Ptr[uint8_t], CInt, CInt] = struct._6
        inline def split_=(value: CFuncPtr3[Ptr[AVCodecContext], Ptr[uint8_t], CInt, CInt]): Unit = (!struct.at6 = value)
      end extension
    
    // Allocates AVCodecParser on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVCodecParser] = scala.scalanative.unsafe.alloc[AVCodecParser](1)
    def apply(codec_ids : CArray[CInt, Nat._7], priv_data_size : CInt, parser_init : CFuncPtr1[Ptr[AVCodecParserContext], CInt], parser_parse : CFuncPtr6[Ptr[AVCodecParserContext], Ptr[AVCodecContext], Ptr[Ptr[uint8_t]], Ptr[CInt], Ptr[uint8_t], CInt, CInt], parser_close : CFuncPtr1[Ptr[AVCodecParserContext], Unit], split : CFuncPtr3[Ptr[AVCodecContext], Ptr[uint8_t], CInt, CInt])(using Zone): Ptr[AVCodecParser] =
      val ____ptr = apply()
  ...
  opaque type AVCodecParserContext = CArray[CChar, Nat.Digit3[Nat._3, Nat._3, Nat._6]]
  
  object AVCodecParserContext:
    given _tag: Tag[AVCodecParserContext] = Tag.CArray[CChar, Nat.Digit3[Nat._3, Nat._3, Nat._6]](Tag.Byte, Tag.Digit3[Nat._3, Nat._3, Nat._6](Tag.Nat3, Tag.Nat3, Tag.Nat6))
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVCodecParserContext)
        inline def priv_data: Ptr[Byte] = !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[Byte]]]
        inline def priv_data_=(value: Ptr[Byte]): Unit = !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[Byte]]] = value
        inline def parser: Ptr[AVCodecParser] = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[AVCodecParser]]]
        inline def parser_=(value: Ptr[AVCodecParser]): Unit = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[AVCodecParser]]] = value
        inline def frame_offset: int64_t = !struct.at(offsets(2)).asInstanceOf[Ptr[int64_t]]
        inline def frame_offset_=(value: int64_t): Unit = !struct.at(offsets(2)).asInstanceOf[Ptr[int64_t]] = value
        inline def cur_offset: int64_t = !struct.at(offsets(3)).asInstanceOf[Ptr[int64_t]]
        inline def cur_offset_=(value: int64_t): Unit = !struct.at(offsets(3)).asInstanceOf[Ptr[int64_t]] = value
        inline def next_frame_offset: int64_t = !struct.at(offsets(4)).asInstanceOf[Ptr[int64_t]]
        inline def next_frame_offset_=(value: int64_t): Unit = !struct.at(offsets(4)).asInstanceOf[Ptr[int64_t]] = value
        inline def pict_type: CInt = !struct.at(offsets(5)).asInstanceOf[Ptr[CInt]]
        inline def pict_type_=(value: CInt): Unit = !struct.at(offsets(5)).asInstanceOf[Ptr[CInt]] = value
        inline def repeat_pict: CInt = !struct.at(offsets(6)).asInstanceOf[Ptr[CInt]]
        inline def repeat_pict_=(value: CInt): Unit = !struct.at(offsets(6)).asInstanceOf[Ptr[CInt]] = value
        inline def pts: int64_t = !struct.at(offsets(7)).asInstanceOf[Ptr[int64_t]]
        inline def pts_=(value: int64_t): Unit = !struct.at(offsets(7)).asInstanceOf[Ptr[int64_t]] = value
        inline def dts: int64_t = !struct.at(offsets(8)).asInstanceOf[Ptr[int64_t]]
        inline def dts_=(value: int64_t): Unit = !struct.at(offsets(8)).asInstanceOf[Ptr[int64_t]] = value
        inline def last_pts: int64_t = !struct.at(offsets(9)).asInstanceOf[Ptr[int64_t]]
        inline def last_pts_=(value: int64_t): Unit = !struct.at(offsets(9)).asInstanceOf[Ptr[int64_t]] = value
        inline def last_dts: int64_t = !struct.at(offsets(10)).asInstanceOf[Ptr[int64_t]]
        inline def last_dts_=(value: int64_t): Unit = !struct.at(offsets(10)).asInstanceOf[Ptr[int64_t]] = value
        inline def fetch_timestamp: CInt = !struct.at(offsets(11)).asInstanceOf[Ptr[CInt]]
        inline def fetch_timestamp_=(value: CInt): Unit = !struct.at(offsets(11)).asInstanceOf[Ptr[CInt]] = value
        inline def cur_frame_start_index: CInt = !struct.at(offsets(12)).asInstanceOf[Ptr[CInt]]
        inline def cur_frame_start_index_=(value: CInt): Unit = !struct.at(offsets(12)).asInstanceOf[Ptr[CInt]] = value
        inline def cur_frame_offset: CArray[int64_t, Nat._4] = !struct.at(offsets(13)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]]
        inline def cur_frame_offset_=(value: CArray[int64_t, Nat._4]): Unit = !struct.at(offsets(13)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]] = value
        inline def cur_frame_pts: CArray[int64_t, Nat._4] = !struct.at(offsets(14)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]]
        inline def cur_frame_pts_=(value: CArray[int64_t, Nat._4]): Unit = !struct.at(offsets(14)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]] = value
        inline def cur_frame_dts: CArray[int64_t, Nat._4] = !struct.at(offsets(15)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]]
        inline def cur_frame_dts_=(value: CArray[int64_t, Nat._4]): Unit = !struct.at(offsets(15)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]] = value
        inline def flags: CInt = !struct.at(offsets(16)).asInstanceOf[Ptr[CInt]]
        inline def flags_=(value: CInt): Unit = !struct.at(offsets(16)).asInstanceOf[Ptr[CInt]] = value
        inline def offset: int64_t = !struct.at(offsets(17)).asInstanceOf[Ptr[int64_t]]
        inline def offset_=(value: int64_t): Unit = !struct.at(offsets(17)).asInstanceOf[Ptr[int64_t]] = value
        inline def cur_frame_end: CArray[int64_t, Nat._4] = !struct.at(offsets(18)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]]
        inline def cur_frame_end_=(value: CArray[int64_t, Nat._4]): Unit = !struct.at(offsets(18)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]] = value
        inline def key_frame: CInt = !struct.at(offsets(19)).asInstanceOf[Ptr[CInt]]
        inline def key_frame_=(value: CInt): Unit = !struct.at(offsets(19)).asInstanceOf[Ptr[CInt]] = value
        inline def dts_sync_point: CInt = !struct.at(offsets(20)).asInstanceOf[Ptr[CInt]]
        inline def dts_sync_point_=(value: CInt): Unit = !struct.at(offsets(20)).asInstanceOf[Ptr[CInt]] = value
        inline def dts_ref_dts_delta: CInt = !struct.at(offsets(21)).asInstanceOf[Ptr[CInt]]
        inline def dts_ref_dts_delta_=(value: CInt): Unit = !struct.at(offsets(21)).asInstanceOf[Ptr[CInt]] = value
        inline def pts_dts_delta: CInt = !struct.at(offsets(22)).asInstanceOf[Ptr[CInt]]
        inline def pts_dts_delta_=(value: CInt): Unit = !struct.at(offsets(22)).asInstanceOf[Ptr[CInt]] = value
        inline def cur_frame_pos: CArray[int64_t, Nat._4] = !struct.at(offsets(23)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]]
        inline def cur_frame_pos_=(value: CArray[int64_t, Nat._4]): Unit = !struct.at(offsets(23)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]] = value
        inline def pos: int64_t = !struct.at(offsets(24)).asInstanceOf[Ptr[int64_t]]
        inline def pos_=(value: int64_t): Unit = !struct.at(offsets(24)).asInstanceOf[Ptr[int64_t]] = value
        inline def last_pos: int64_t = !struct.at(offsets(25)).asInstanceOf[Ptr[int64_t]]
        inline def last_pos_=(value: int64_t): Unit = !struct.at(offsets(25)).asInstanceOf[Ptr[int64_t]] = value
        inline def duration: CInt = !struct.at(offsets(26)).asInstanceOf[Ptr[CInt]]
        inline def duration_=(value: CInt): Unit = !struct.at(offsets(26)).asInstanceOf[Ptr[CInt]] = value
        inline def field_order: AVFieldOrder = !struct.at(offsets(27)).asInstanceOf[Ptr[AVFieldOrder]]
        inline def field_order_=(value: AVFieldOrder): Unit = !struct.at(offsets(27)).asInstanceOf[Ptr[AVFieldOrder]] = value
        inline def picture_structure: AVPictureStructure = !struct.at(offsets(28)).asInstanceOf[Ptr[AVPictureStructure]]
        inline def picture_structure_=(value: AVPictureStructure): Unit = !struct.at(offsets(28)).asInstanceOf[Ptr[AVPictureStructure]] = value
        inline def output_picture_number: CInt = !struct.at(offsets(29)).asInstanceOf[Ptr[CInt]]
        inline def output_picture_number_=(value: CInt): Unit = !struct.at(offsets(29)).asInstanceOf[Ptr[CInt]] = value
        inline def width: CInt = !struct.at(offsets(30)).asInstanceOf[Ptr[CInt]]
        inline def width_=(value: CInt): Unit = !struct.at(offsets(30)).asInstanceOf[Ptr[CInt]] = value
        inline def height: CInt = !struct.at(offsets(31)).asInstanceOf[Ptr[CInt]]
        inline def height_=(value: CInt): Unit = !struct.at(offsets(31)).asInstanceOf[Ptr[CInt]] = value
        inline def coded_width: CInt = !struct.at(offsets(32)).asInstanceOf[Ptr[CInt]]
        inline def coded_width_=(value: CInt): Unit = !struct.at(offsets(32)).asInstanceOf[Ptr[CInt]] = value
        inline def coded_height: CInt = !struct.at(offsets(33)).asInstanceOf[Ptr[CInt]]
        inline def coded_height_=(value: CInt): Unit = !struct.at(offsets(33)).asInstanceOf[Ptr[CInt]] = value
        inline def format: CInt = !struct.at(offsets(34)).asInstanceOf[Ptr[CInt]]
        inline def format_=(value: CInt): Unit = !struct.at(offsets(34)).asInstanceOf[Ptr[CInt]] = value
      end extension
    
    // Allocates AVCodecParserContext on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVCodecParserContext] = scala.scalanative.unsafe.alloc[AVCodecParserContext](1)
    def apply(priv_data : Ptr[Byte], parser : Ptr[AVCodecParser], frame_offset : int64_t, cur_offset : int64_t, next_frame_offset : int64_t, pict_type : CInt, repeat_pict : CInt, pts : int64_t, dts : int64_t, last_pts : int64_t, last_dts : int64_t, fetch_timestamp : CInt, cur_frame_start_index : CInt, cur_frame_offset : CArray[int64_t, Nat._4], cur_frame_pts : CArray[int64_t, Nat._4], cur_frame_dts : CArray[int64_t, Nat._4], flags : CInt, offset : int64_t, cur_frame_end : CArray[int64_t, Nat._4], key_frame : CInt, dts_sync_point : CInt, dts_ref_dts_delta : CInt, pts_dts_delta : CInt, cur_frame_pos : CArray[int64_t, Nat._4], pos : int64_t, last_pos : int64_t, duration : CInt, field_order : AVFieldOrder, picture_structure : AVPictureStructure, output_picture_number : CInt, width : CInt, height : CInt, coded_width : CInt, coded_height : CInt, format : CInt)(using Zone): Ptr[AVCodecParserContext] =
      val ____ptr = apply()
      (!____ptr).priv_data = priv_data
    ...
    val offsets: Array[Int] =
      ...
      res(1) = align(res(0) + sizeof[Ptr[Byte]].toInt, alignmentof[Ptr[AVCodecParser]].toInt)
      res(2) = align(res(1) + sizeof[Ptr[AVCodecParser]].toInt, alignmentof[int64_t].toInt)
      ...
      res(14) = align(res(13) + sizeof[CArray[int64_t, Nat._4]].toInt, alignmentof[int64_t].toInt)
      res(15) = align(res(14) + sizeof[CArray[int64_t, Nat._4]].toInt, alignmentof[int64_t].toInt)
      res(16) = align(res(15) + sizeof[CArray[int64_t, Nat._4]].toInt, alignmentof[CInt].toInt)
      ...
      res(19) = align(res(18) + sizeof[CArray[int64_t, Nat._4]].toInt, alignmentof[CInt].toInt)
      res(20) = align(res(19) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(21) = align(res(20) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      ...
      res(24) = align(res(23) + sizeof[CArray[int64_t, Nat._4]].toInt, alignmentof[int64_t].toInt)
      ...
      res(27) = align(res(26) + sizeof[CInt].toInt, alignmentof[AVFieldOrder].toInt)
      res(28) = align(res(27) + sizeof[AVFieldOrder].toInt, alignmentof[AVPictureStructure].toInt)
      res(29) = align(res(28) + sizeof[AVPictureStructure].toInt, alignmentof[CInt].toInt)
  ...
  */
  ...
  opaque type AVContainerFifo = CStruct0
  
  object AVContainerFifo:
    given _tag: Tag[AVContainerFifo] = Tag.materializeCStruct0Tag
  ...
  */
  ...
  object AVDictionaryEntry:
    given _tag: Tag[AVDictionaryEntry] = Tag.materializeCStruct2Tag[CString, CString]
    ...
    def apply()(using Zone): Ptr[AVDictionaryEntry] = scala.scalanative.unsafe.alloc[AVDictionaryEntry](1)
    def apply(key : CString, value : CString)(using Zone): Ptr[AVDictionaryEntry] =
      val ____ptr = apply()
      (!____ptr).key = key
      (!____ptr).value = value
      ____ptr
  ...
  */
  opaque type AVFormatContext = CArray[CChar, Nat.Digit3[Nat._4, Nat._7, Nat._2]]
  
  object AVFormatContext:
    given _tag: Tag[AVFormatContext] = Tag.CArray[CChar, Nat.Digit3[Nat._4, Nat._7, Nat._2]](Tag.Byte, Tag.Digit3[Nat._4, Nat._7, Nat._2](Tag.Nat4, Tag.Nat7, Tag.Nat2))
    ...
    private[ffmpeg] object fields:
      extension (struct: AVFormatContext)
        inline def av_class: Ptr[AVClass] = !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[AVClass]]]
        inline def av_class_=(value: Ptr[AVClass]): Unit = !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[AVClass]]] = value
        inline def iformat: Ptr[AVInputFormat] = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[AVInputFormat]]]
        inline def iformat_=(value: Ptr[AVInputFormat]): Unit = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[AVInputFormat]]] = value
        inline def oformat: Ptr[AVOutputFormat] = !struct.at(offsets(2)).asInstanceOf[Ptr[Ptr[AVOutputFormat]]]
        inline def oformat_=(value: Ptr[AVOutputFormat]): Unit = !struct.at(offsets(2)).asInstanceOf[Ptr[Ptr[AVOutputFormat]]] = value
        inline def priv_data: Ptr[Byte] = !struct.at(offsets(3)).asInstanceOf[Ptr[Ptr[Byte]]]
        inline def priv_data_=(value: Ptr[Byte]): Unit = !struct.at(offsets(3)).asInstanceOf[Ptr[Ptr[Byte]]] = value
        inline def pb: Ptr[AVIOContext] = !struct.at(offsets(4)).asInstanceOf[Ptr[Ptr[AVIOContext]]]
        inline def pb_=(value: Ptr[AVIOContext]): Unit = !struct.at(offsets(4)).asInstanceOf[Ptr[Ptr[AVIOContext]]] = value
        inline def ctx_flags: CInt = !struct.at(offsets(5)).asInstanceOf[Ptr[CInt]]
        inline def ctx_flags_=(value: CInt): Unit = !struct.at(offsets(5)).asInstanceOf[Ptr[CInt]] = value
        inline def nb_streams: CUnsignedInt = !struct.at(offsets(6)).asInstanceOf[Ptr[CUnsignedInt]]
        inline def nb_streams_=(value: CUnsignedInt): Unit = !struct.at(offsets(6)).asInstanceOf[Ptr[CUnsignedInt]] = value
        inline def streams: Ptr[Ptr[AVStream]] = !struct.at(offsets(7)).asInstanceOf[Ptr[Ptr[Ptr[AVStream]]]]
        inline def streams_=(value: Ptr[Ptr[AVStream]]): Unit = !struct.at(offsets(7)).asInstanceOf[Ptr[Ptr[Ptr[AVStream]]]] = value
        inline def nb_stream_groups: CUnsignedInt = !struct.at(offsets(8)).asInstanceOf[Ptr[CUnsignedInt]]
        inline def nb_stream_groups_=(value: CUnsignedInt): Unit = !struct.at(offsets(8)).asInstanceOf[Ptr[CUnsignedInt]] = value
        inline def stream_groups: Ptr[Ptr[AVStreamGroup]] = !struct.at(offsets(9)).asInstanceOf[Ptr[Ptr[Ptr[AVStreamGroup]]]]
        inline def stream_groups_=(value: Ptr[Ptr[AVStreamGroup]]): Unit = !struct.at(offsets(9)).asInstanceOf[Ptr[Ptr[Ptr[AVStreamGroup]]]] = value
        inline def nb_chapters: CUnsignedInt = !struct.at(offsets(10)).asInstanceOf[Ptr[CUnsignedInt]]
        inline def nb_chapters_=(value: CUnsignedInt): Unit = !struct.at(offsets(10)).asInstanceOf[Ptr[CUnsignedInt]] = value
        inline def chapters: Ptr[Ptr[AVChapter]] = !struct.at(offsets(11)).asInstanceOf[Ptr[Ptr[Ptr[AVChapter]]]]
        inline def chapters_=(value: Ptr[Ptr[AVChapter]]): Unit = !struct.at(offsets(11)).asInstanceOf[Ptr[Ptr[Ptr[AVChapter]]]] = value
        inline def url: CString = !struct.at(offsets(12)).asInstanceOf[Ptr[CString]]
        inline def url_=(value: CString): Unit = !struct.at(offsets(12)).asInstanceOf[Ptr[CString]] = value
        inline def start_time: int64_t = !struct.at(offsets(13)).asInstanceOf[Ptr[int64_t]]
        inline def start_time_=(value: int64_t): Unit = !struct.at(offsets(13)).asInstanceOf[Ptr[int64_t]] = value
        inline def duration: int64_t = !struct.at(offsets(14)).asInstanceOf[Ptr[int64_t]]
        inline def duration_=(value: int64_t): Unit = !struct.at(offsets(14)).asInstanceOf[Ptr[int64_t]] = value
        inline def bit_rate: int64_t = !struct.at(offsets(15)).asInstanceOf[Ptr[int64_t]]
        inline def bit_rate_=(value: int64_t): Unit = !struct.at(offsets(15)).asInstanceOf[Ptr[int64_t]] = value
        inline def packet_size: CUnsignedInt = !struct.at(offsets(16)).asInstanceOf[Ptr[CUnsignedInt]]
        inline def packet_size_=(value: CUnsignedInt): Unit = !struct.at(offsets(16)).asInstanceOf[Ptr[CUnsignedInt]] = value
        inline def max_delay: CInt = !struct.at(offsets(17)).asInstanceOf[Ptr[CInt]]
        inline def max_delay_=(value: CInt): Unit = !struct.at(offsets(17)).asInstanceOf[Ptr[CInt]] = value
        inline def flags: CInt = !struct.at(offsets(18)).asInstanceOf[Ptr[CInt]]
        inline def flags_=(value: CInt): Unit = !struct.at(offsets(18)).asInstanceOf[Ptr[CInt]] = value
        inline def probesize: int64_t = !struct.at(offsets(19)).asInstanceOf[Ptr[int64_t]]
        inline def probesize_=(value: int64_t): Unit = !struct.at(offsets(19)).asInstanceOf[Ptr[int64_t]] = value
        inline def max_analyze_duration: int64_t = !struct.at(offsets(20)).asInstanceOf[Ptr[int64_t]]
        inline def max_analyze_duration_=(value: int64_t): Unit = !struct.at(offsets(20)).asInstanceOf[Ptr[int64_t]] = value
        inline def key: Ptr[uint8_t] = !struct.at(offsets(21)).asInstanceOf[Ptr[Ptr[uint8_t]]]
        inline def key_=(value: Ptr[uint8_t]): Unit = !struct.at(offsets(21)).asInstanceOf[Ptr[Ptr[uint8_t]]] = value
        inline def keylen: CInt = !struct.at(offsets(22)).asInstanceOf[Ptr[CInt]]
        inline def keylen_=(value: CInt): Unit = !struct.at(offsets(22)).asInstanceOf[Ptr[CInt]] = value
        inline def nb_programs: CUnsignedInt = !struct.at(offsets(23)).asInstanceOf[Ptr[CUnsignedInt]]
        inline def nb_programs_=(value: CUnsignedInt): Unit = !struct.at(offsets(23)).asInstanceOf[Ptr[CUnsignedInt]] = value
        inline def programs: Ptr[Ptr[AVProgram]] = !struct.at(offsets(24)).asInstanceOf[Ptr[Ptr[Ptr[AVProgram]]]]
        inline def programs_=(value: Ptr[Ptr[AVProgram]]): Unit = !struct.at(offsets(24)).asInstanceOf[Ptr[Ptr[Ptr[AVProgram]]]] = value
        inline def video_codec_id: AVCodecID = !struct.at(offsets(25)).asInstanceOf[Ptr[AVCodecID]]
        inline def video_codec_id_=(value: AVCodecID): Unit = !struct.at(offsets(25)).asInstanceOf[Ptr[AVCodecID]] = value
        inline def audio_codec_id: AVCodecID = !struct.at(offsets(26)).asInstanceOf[Ptr[AVCodecID]]
        inline def audio_codec_id_=(value: AVCodecID): Unit = !struct.at(offsets(26)).asInstanceOf[Ptr[AVCodecID]] = value
        inline def subtitle_codec_id: AVCodecID = !struct.at(offsets(27)).asInstanceOf[Ptr[AVCodecID]]
        inline def subtitle_codec_id_=(value: AVCodecID): Unit = !struct.at(offsets(27)).asInstanceOf[Ptr[AVCodecID]] = value
        inline def data_codec_id: AVCodecID = !struct.at(offsets(28)).asInstanceOf[Ptr[AVCodecID]]
        inline def data_codec_id_=(value: AVCodecID): Unit = !struct.at(offsets(28)).asInstanceOf[Ptr[AVCodecID]] = value
        inline def metadata: Ptr[AVDictionary] = !struct.at(offsets(29)).asInstanceOf[Ptr[Ptr[AVDictionary]]]
        inline def metadata_=(value: Ptr[AVDictionary]): Unit = !struct.at(offsets(29)).asInstanceOf[Ptr[Ptr[AVDictionary]]] = value
        inline def start_time_realtime: int64_t = !struct.at(offsets(30)).asInstanceOf[Ptr[int64_t]]
        inline def start_time_realtime_=(value: int64_t): Unit = !struct.at(offsets(30)).asInstanceOf[Ptr[int64_t]] = value
        inline def fps_probe_size: CInt = !struct.at(offsets(31)).asInstanceOf[Ptr[CInt]]
        inline def fps_probe_size_=(value: CInt): Unit = !struct.at(offsets(31)).asInstanceOf[Ptr[CInt]] = value
        inline def error_recognition: CInt = !struct.at(offsets(32)).asInstanceOf[Ptr[CInt]]
        inline def error_recognition_=(value: CInt): Unit = !struct.at(offsets(32)).asInstanceOf[Ptr[CInt]] = value
        inline def interrupt_callback: AVIOInterruptCB = !struct.at(offsets(33)).asInstanceOf[Ptr[AVIOInterruptCB]]
        inline def interrupt_callback_=(value: AVIOInterruptCB): Unit = !struct.at(offsets(33)).asInstanceOf[Ptr[AVIOInterruptCB]] = value
        inline def debug: CInt = !struct.at(offsets(34)).asInstanceOf[Ptr[CInt]]
        inline def debug_=(value: CInt): Unit = !struct.at(offsets(34)).asInstanceOf[Ptr[CInt]] = value
        inline def max_streams: CInt = !struct.at(offsets(35)).asInstanceOf[Ptr[CInt]]
        inline def max_streams_=(value: CInt): Unit = !struct.at(offsets(35)).asInstanceOf[Ptr[CInt]] = value
        inline def max_index_size: CUnsignedInt = !struct.at(offsets(36)).asInstanceOf[Ptr[CUnsignedInt]]
        inline def max_index_size_=(value: CUnsignedInt): Unit = !struct.at(offsets(36)).asInstanceOf[Ptr[CUnsignedInt]] = value
        inline def max_picture_buffer: CUnsignedInt = !struct.at(offsets(37)).asInstanceOf[Ptr[CUnsignedInt]]
        inline def max_picture_buffer_=(value: CUnsignedInt): Unit = !struct.at(offsets(37)).asInstanceOf[Ptr[CUnsignedInt]] = value
        inline def max_interleave_delta: int64_t = !struct.at(offsets(38)).asInstanceOf[Ptr[int64_t]]
        inline def max_interleave_delta_=(value: int64_t): Unit = !struct.at(offsets(38)).asInstanceOf[Ptr[int64_t]] = value
        inline def max_ts_probe: CInt = !struct.at(offsets(39)).asInstanceOf[Ptr[CInt]]
        inline def max_ts_probe_=(value: CInt): Unit = !struct.at(offsets(39)).asInstanceOf[Ptr[CInt]] = value
        inline def max_chunk_duration: CInt = !struct.at(offsets(40)).asInstanceOf[Ptr[CInt]]
        inline def max_chunk_duration_=(value: CInt): Unit = !struct.at(offsets(40)).asInstanceOf[Ptr[CInt]] = value
        inline def max_chunk_size: CInt = !struct.at(offsets(41)).asInstanceOf[Ptr[CInt]]
        inline def max_chunk_size_=(value: CInt): Unit = !struct.at(offsets(41)).asInstanceOf[Ptr[CInt]] = value
        inline def max_probe_packets: CInt = !struct.at(offsets(42)).asInstanceOf[Ptr[CInt]]
        inline def max_probe_packets_=(value: CInt): Unit = !struct.at(offsets(42)).asInstanceOf[Ptr[CInt]] = value
        inline def strict_std_compliance: CInt = !struct.at(offsets(43)).asInstanceOf[Ptr[CInt]]
        inline def strict_std_compliance_=(value: CInt): Unit = !struct.at(offsets(43)).asInstanceOf[Ptr[CInt]] = value
        inline def event_flags: CInt = !struct.at(offsets(44)).asInstanceOf[Ptr[CInt]]
        inline def event_flags_=(value: CInt): Unit = !struct.at(offsets(44)).asInstanceOf[Ptr[CInt]] = value
        inline def avoid_negative_ts: CInt = !struct.at(offsets(45)).asInstanceOf[Ptr[CInt]]
        inline def avoid_negative_ts_=(value: CInt): Unit = !struct.at(offsets(45)).asInstanceOf[Ptr[CInt]] = value
        inline def audio_preload: CInt = !struct.at(offsets(46)).asInstanceOf[Ptr[CInt]]
        inline def audio_preload_=(value: CInt): Unit = !struct.at(offsets(46)).asInstanceOf[Ptr[CInt]] = value
        inline def use_wallclock_as_timestamps: CInt = !struct.at(offsets(47)).asInstanceOf[Ptr[CInt]]
        inline def use_wallclock_as_timestamps_=(value: CInt): Unit = !struct.at(offsets(47)).asInstanceOf[Ptr[CInt]] = value
        inline def skip_estimate_duration_from_pts: CInt = !struct.at(offsets(48)).asInstanceOf[Ptr[CInt]]
        inline def skip_estimate_duration_from_pts_=(value: CInt): Unit = !struct.at(offsets(48)).asInstanceOf[Ptr[CInt]] = value
        inline def avio_flags: CInt = !struct.at(offsets(49)).asInstanceOf[Ptr[CInt]]
        inline def avio_flags_=(value: CInt): Unit = !struct.at(offsets(49)).asInstanceOf[Ptr[CInt]] = value
        inline def duration_estimation_method: AVDurationEstimationMethod = !struct.at(offsets(50)).asInstanceOf[Ptr[AVDurationEstimationMethod]]
        inline def duration_estimation_method_=(value: AVDurationEstimationMethod): Unit = !struct.at(offsets(50)).asInstanceOf[Ptr[AVDurationEstimationMethod]] = value
        inline def skip_initial_bytes: int64_t = !struct.at(offsets(51)).asInstanceOf[Ptr[int64_t]]
        inline def skip_initial_bytes_=(value: int64_t): Unit = !struct.at(offsets(51)).asInstanceOf[Ptr[int64_t]] = value
        inline def correct_ts_overflow: CUnsignedInt = !struct.at(offsets(52)).asInstanceOf[Ptr[CUnsignedInt]]
        inline def correct_ts_overflow_=(value: CUnsignedInt): Unit = !struct.at(offsets(52)).asInstanceOf[Ptr[CUnsignedInt]] = value
        inline def seek2any: CInt = !struct.at(offsets(53)).asInstanceOf[Ptr[CInt]]
        inline def seek2any_=(value: CInt): Unit = !struct.at(offsets(53)).asInstanceOf[Ptr[CInt]] = value
        inline def flush_packets: CInt = !struct.at(offsets(54)).asInstanceOf[Ptr[CInt]]
        inline def flush_packets_=(value: CInt): Unit = !struct.at(offsets(54)).asInstanceOf[Ptr[CInt]] = value
        inline def probe_score: CInt = !struct.at(offsets(55)).asInstanceOf[Ptr[CInt]]
        inline def probe_score_=(value: CInt): Unit = !struct.at(offsets(55)).asInstanceOf[Ptr[CInt]] = value
        inline def format_probesize: CInt = !struct.at(offsets(56)).asInstanceOf[Ptr[CInt]]
        inline def format_probesize_=(value: CInt): Unit = !struct.at(offsets(56)).asInstanceOf[Ptr[CInt]] = value
        inline def codec_whitelist: CString = !struct.at(offsets(57)).asInstanceOf[Ptr[CString]]
        inline def codec_whitelist_=(value: CString): Unit = !struct.at(offsets(57)).asInstanceOf[Ptr[CString]] = value
        inline def format_whitelist: CString = !struct.at(offsets(58)).asInstanceOf[Ptr[CString]]
        inline def format_whitelist_=(value: CString): Unit = !struct.at(offsets(58)).asInstanceOf[Ptr[CString]] = value
        inline def protocol_whitelist: CString = !struct.at(offsets(59)).asInstanceOf[Ptr[CString]]
        inline def protocol_whitelist_=(value: CString): Unit = !struct.at(offsets(59)).asInstanceOf[Ptr[CString]] = value
        inline def protocol_blacklist: CString = !struct.at(offsets(60)).asInstanceOf[Ptr[CString]]
        inline def protocol_blacklist_=(value: CString): Unit = !struct.at(offsets(60)).asInstanceOf[Ptr[CString]] = value
        inline def io_repositioned: CInt = !struct.at(offsets(61)).asInstanceOf[Ptr[CInt]]
        inline def io_repositioned_=(value: CInt): Unit = !struct.at(offsets(61)).asInstanceOf[Ptr[CInt]] = value
        inline def video_codec: Ptr[AVCodec] = !struct.at(offsets(62)).asInstanceOf[Ptr[Ptr[AVCodec]]]
        inline def video_codec_=(value: Ptr[AVCodec]): Unit = !struct.at(offsets(62)).asInstanceOf[Ptr[Ptr[AVCodec]]] = value
        inline def audio_codec: Ptr[AVCodec] = !struct.at(offsets(63)).asInstanceOf[Ptr[Ptr[AVCodec]]]
        inline def audio_codec_=(value: Ptr[AVCodec]): Unit = !struct.at(offsets(63)).asInstanceOf[Ptr[Ptr[AVCodec]]] = value
        inline def subtitle_codec: Ptr[AVCodec] = !struct.at(offsets(64)).asInstanceOf[Ptr[Ptr[AVCodec]]]
        inline def subtitle_codec_=(value: Ptr[AVCodec]): Unit = !struct.at(offsets(64)).asInstanceOf[Ptr[Ptr[AVCodec]]] = value
        inline def data_codec: Ptr[AVCodec] = !struct.at(offsets(65)).asInstanceOf[Ptr[Ptr[AVCodec]]]
        inline def data_codec_=(value: Ptr[AVCodec]): Unit = !struct.at(offsets(65)).asInstanceOf[Ptr[Ptr[AVCodec]]] = value
        inline def metadata_header_padding: CInt = !struct.at(offsets(66)).asInstanceOf[Ptr[CInt]]
        inline def metadata_header_padding_=(value: CInt): Unit = !struct.at(offsets(66)).asInstanceOf[Ptr[CInt]] = value
        inline def opaque: Ptr[Byte] = !struct.at(offsets(67)).asInstanceOf[Ptr[Ptr[Byte]]]
        inline def opaque_=(value: Ptr[Byte]): Unit = !struct.at(offsets(67)).asInstanceOf[Ptr[Ptr[Byte]]] = value
        inline def control_message_cb: av_format_control_message = !struct.at(offsets(68)).asInstanceOf[Ptr[av_format_control_message]]
        inline def control_message_cb_=(value: av_format_control_message): Unit = !struct.at(offsets(68)).asInstanceOf[Ptr[av_format_control_message]] = value
        inline def output_ts_offset: int64_t = !struct.at(offsets(69)).asInstanceOf[Ptr[int64_t]]
        inline def output_ts_offset_=(value: int64_t): Unit = !struct.at(offsets(69)).asInstanceOf[Ptr[int64_t]] = value
        inline def dump_separator: Ptr[uint8_t] = !struct.at(offsets(70)).asInstanceOf[Ptr[Ptr[uint8_t]]]
        inline def dump_separator_=(value: Ptr[uint8_t]): Unit = !struct.at(offsets(70)).asInstanceOf[Ptr[Ptr[uint8_t]]] = value
        inline def io_open: CFuncPtr5[Ptr[AVFormatContext], Ptr[Ptr[AVIOContext]], CString, CInt, Ptr[Ptr[AVDictionary]], CInt] = !struct.at(offsets(71)).asInstanceOf[Ptr[CFuncPtr5[Ptr[AVFormatContext], Ptr[Ptr[AVIOContext]], CString, CInt, Ptr[Ptr[AVDictionary]], CInt]]]
        inline def io_open_=(value: CFuncPtr5[Ptr[AVFormatContext], Ptr[Ptr[AVIOContext]], CString, CInt, Ptr[Ptr[AVDictionary]], CInt]): Unit = !struct.at(offsets(71)).asInstanceOf[Ptr[CFuncPtr5[Ptr[AVFormatContext], Ptr[Ptr[AVIOContext]], CString, CInt, Ptr[Ptr[AVDictionary]], CInt]]] = value
        inline def io_close2: CFuncPtr2[Ptr[AVFormatContext], Ptr[AVIOContext], CInt] = !struct.at(offsets(72)).asInstanceOf[Ptr[CFuncPtr2[Ptr[AVFormatContext], Ptr[AVIOContext], CInt]]]
        inline def io_close2_=(value: CFuncPtr2[Ptr[AVFormatContext], Ptr[AVIOContext], CInt]): Unit = !struct.at(offsets(72)).asInstanceOf[Ptr[CFuncPtr2[Ptr[AVFormatContext], Ptr[AVIOContext], CInt]]] = value
        inline def duration_probesize: int64_t = !struct.at(offsets(73)).asInstanceOf[Ptr[int64_t]]
        inline def duration_probesize_=(value: int64_t): Unit = !struct.at(offsets(73)).asInstanceOf[Ptr[int64_t]] = value
      end extension
    
    // Allocates AVFormatContext on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVFormatContext] = scala.scalanative.unsafe.alloc[AVFormatContext](1)
    def apply(av_class : Ptr[AVClass], iformat : Ptr[AVInputFormat], oformat : Ptr[AVOutputFormat], priv_data : Ptr[Byte], pb : Ptr[AVIOContext], ctx_flags : CInt, nb_streams : CUnsignedInt, streams : Ptr[Ptr[AVStream]], nb_stream_groups : CUnsignedInt, stream_groups : Ptr[Ptr[AVStreamGroup]], nb_chapters : CUnsignedInt, chapters : Ptr[Ptr[AVChapter]], url : CString, start_time : int64_t, duration : int64_t, bit_rate : int64_t, packet_size : CUnsignedInt, max_delay : CInt, flags : CInt, probesize : int64_t, max_analyze_duration : int64_t, key : Ptr[uint8_t], keylen : CInt, nb_programs : CUnsignedInt, programs : Ptr[Ptr[AVProgram]], video_codec_id : AVCodecID, audio_codec_id : AVCodecID, subtitle_codec_id : AVCodecID, data_codec_id : AVCodecID, metadata : Ptr[AVDictionary], start_time_realtime : int64_t, fps_probe_size : CInt, error_recognition : CInt, interrupt_callback : AVIOInterruptCB, debug : CInt, max_streams : CInt, max_index_size : CUnsignedInt, max_picture_buffer : CUnsignedInt, max_interleave_delta : int64_t, max_ts_probe : CInt, max_chunk_duration : CInt, max_chunk_size : CInt, max_probe_packets : CInt, strict_std_compliance : CInt, event_flags : CInt, avoid_negative_ts : CInt, audio_preload : CInt, use_wallclock_as_timestamps : CInt, skip_estimate_duration_from_pts : CInt, avio_flags : CInt, duration_estimation_method : AVDurationEstimationMethod, skip_initial_bytes : int64_t, correct_ts_overflow : CUnsignedInt, seek2any : CInt, flush_packets : CInt, probe_score : CInt, format_probesize : CInt, codec_whitelist : CString, format_whitelist : CString, protocol_whitelist : CString, protocol_blacklist : CString, io_repositioned : CInt, video_codec : Ptr[AVCodec], audio_codec : Ptr[AVCodec], subtitle_codec : Ptr[AVCodec], data_codec : Ptr[AVCodec], metadata_header_padding : CInt, opaque : Ptr[Byte], control_message_cb : av_format_control_message, output_ts_offset : int64_t, dump_separator : Ptr[uint8_t], io_open : CFuncPtr5[Ptr[AVFormatContext], Ptr[Ptr[AVIOContext]], CString, CInt, Ptr[Ptr[AVDictionary]], CInt], io_close2 : CFuncPtr2[Ptr[AVFormatContext], Ptr[AVIOContext], CInt], duration_probesize : int64_t)(using Zone): Ptr[AVFormatContext] =
      val ____ptr = apply()
      (!____ptr).av_class = av_class
      ...
      (!____ptr).skip_estimate_duration_from_pts = skip_estimate_duration_from_pts
    ...
    val offsets: Array[Int] =
      ...
      res(0) = align(0, alignmentof[Ptr[AVClass]].toInt)
      res(1) = align(res(0) + sizeof[Ptr[AVClass]].toInt, alignmentof[Ptr[AVInputFormat]].toInt)
      res(2) = align(res(1) + sizeof[Ptr[AVInputFormat]].toInt, alignmentof[Ptr[AVOutputFormat]].toInt)
      res(3) = align(res(2) + sizeof[Ptr[AVOutputFormat]].toInt, alignmentof[Ptr[Byte]].toInt)
      res(4) = align(res(3) + sizeof[Ptr[Byte]].toInt, alignmentof[Ptr[AVIOContext]].toInt)
      res(5) = align(res(4) + sizeof[Ptr[AVIOContext]].toInt, alignmentof[CInt].toInt)
      res(6) = align(res(5) + sizeof[CInt].toInt, alignmentof[CUnsignedInt].toInt)
      res(7) = align(res(6) + sizeof[CUnsignedInt].toInt, alignmentof[Ptr[Ptr[AVStream]]].toInt)
      res(8) = align(res(7) + sizeof[Ptr[Ptr[AVStream]]].toInt, alignmentof[CUnsignedInt].toInt)
      res(9) = align(res(8) + sizeof[CUnsignedInt].toInt, alignmentof[Ptr[Ptr[AVStreamGroup]]].toInt)
      res(10) = align(res(9) + sizeof[Ptr[Ptr[AVStreamGroup]]].toInt, alignmentof[CUnsignedInt].toInt)
      res(11) = align(res(10) + sizeof[CUnsignedInt].toInt, alignmentof[Ptr[Ptr[AVChapter]]].toInt)
      res(12) = align(res(11) + sizeof[Ptr[Ptr[AVChapter]]].toInt, alignmentof[CString].toInt)
      res(13) = align(res(12) + sizeof[CString].toInt, alignmentof[int64_t].toInt)
      ...
      res(16) = align(res(15) + sizeof[int64_t].toInt, alignmentof[CUnsignedInt].toInt)
      res(17) = align(res(16) + sizeof[CUnsignedInt].toInt, alignmentof[CInt].toInt)
      res(18) = align(res(17) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      ...
      res(21) = align(res(20) + sizeof[int64_t].toInt, alignmentof[Ptr[uint8_t]].toInt)
      res(22) = align(res(21) + sizeof[Ptr[uint8_t]].toInt, alignmentof[CInt].toInt)
      res(23) = align(res(22) + sizeof[CInt].toInt, alignmentof[CUnsignedInt].toInt)
      res(24) = align(res(23) + sizeof[CUnsignedInt].toInt, alignmentof[Ptr[Ptr[AVProgram]]].toInt)
      res(25) = align(res(24) + sizeof[Ptr[Ptr[AVProgram]]].toInt, alignmentof[AVCodecID].toInt)
      res(26) = align(res(25) + sizeof[AVCodecID].toInt, alignmentof[AVCodecID].toInt)
      res(27) = align(res(26) + sizeof[AVCodecID].toInt, alignmentof[AVCodecID].toInt)
      res(28) = align(res(27) + sizeof[AVCodecID].toInt, alignmentof[AVCodecID].toInt)
      res(29) = align(res(28) + sizeof[AVCodecID].toInt, alignmentof[Ptr[AVDictionary]].toInt)
      res(30) = align(res(29) + sizeof[Ptr[AVDictionary]].toInt, alignmentof[int64_t].toInt)
      res(31) = align(res(30) + sizeof[int64_t].toInt, alignmentof[CInt].toInt)
      res(32) = align(res(31) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(33) = align(res(32) + sizeof[CInt].toInt, alignmentof[AVIOInterruptCB].toInt)
      res(34) = align(res(33) + sizeof[AVIOInterruptCB].toInt, alignmentof[CInt].toInt)
      res(35) = align(res(34) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(36) = align(res(35) + sizeof[CInt].toInt, alignmentof[CUnsignedInt].toInt)
      res(37) = align(res(36) + sizeof[CUnsignedInt].toInt, alignmentof[CUnsignedInt].toInt)
      res(38) = align(res(37) + sizeof[CUnsignedInt].toInt, alignmentof[int64_t].toInt)
      ...
      res(48) = align(res(47) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(49) = align(res(48) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(50) = align(res(49) + sizeof[CInt].toInt, alignmentof[AVDurationEstimationMethod].toInt)
      res(51) = align(res(50) + sizeof[AVDurationEstimationMethod].toInt, alignmentof[int64_t].toInt)
      res(52) = align(res(51) + sizeof[int64_t].toInt, alignmentof[CUnsignedInt].toInt)
      res(53) = align(res(52) + sizeof[CUnsignedInt].toInt, alignmentof[CInt].toInt)
      res(54) = align(res(53) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(55) = align(res(54) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(56) = align(res(55) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(57) = align(res(56) + sizeof[CInt].toInt, alignmentof[CString].toInt)
      res(58) = align(res(57) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(59) = align(res(58) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(60) = align(res(59) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(61) = align(res(60) + sizeof[CString].toInt, alignmentof[CInt].toInt)
      res(62) = align(res(61) + sizeof[CInt].toInt, alignmentof[Ptr[AVCodec]].toInt)
      res(63) = align(res(62) + sizeof[Ptr[AVCodec]].toInt, alignmentof[Ptr[AVCodec]].toInt)
      res(64) = align(res(63) + sizeof[Ptr[AVCodec]].toInt, alignmentof[Ptr[AVCodec]].toInt)
      res(65) = align(res(64) + sizeof[Ptr[AVCodec]].toInt, alignmentof[Ptr[AVCodec]].toInt)
      res(66) = align(res(65) + sizeof[Ptr[AVCodec]].toInt, alignmentof[CInt].toInt)
      res(67) = align(res(66) + sizeof[CInt].toInt, alignmentof[Ptr[Byte]].toInt)
      res(68) = align(res(67) + sizeof[Ptr[Byte]].toInt, alignmentof[av_format_control_message].toInt)
      res(69) = align(res(68) + sizeof[av_format_control_message].toInt, alignmentof[int64_t].toInt)
      res(70) = align(res(69) + sizeof[int64_t].toInt, alignmentof[Ptr[uint8_t]].toInt)
      res(71) = align(res(70) + sizeof[Ptr[uint8_t]].toInt, alignmentof[CFuncPtr5[Ptr[AVFormatContext], Ptr[Ptr[AVIOContext]], CString, CInt, Ptr[Ptr[AVDictionary]], CInt]].toInt)
      res(72) = align(res(71) + sizeof[CFuncPtr5[Ptr[AVFormatContext], Ptr[Ptr[AVIOContext]], CString, CInt, Ptr[Ptr[AVDictionary]], CInt]].toInt, alignmentof[CFuncPtr2[Ptr[AVFormatContext], Ptr[AVIOContext], CInt]].toInt)
      res(73) = align(res(72) + sizeof[CFuncPtr2[Ptr[AVFormatContext], Ptr[AVIOContext], CInt]].toInt, alignmentof[int64_t].toInt)
      res
    end offsets
  ...
  */
  opaque type AVFrameSideData = CStruct5[AVFrameSideDataType, Ptr[uint8_t], size_t, Ptr[AVDictionary], Ptr[AVBufferRef]]
  
  object AVFrameSideData:
    given _tag: Tag[AVFrameSideData] = Tag.materializeCStruct5Tag[AVFrameSideDataType, Ptr[uint8_t], size_t, Ptr[AVDictionary], Ptr[AVBufferRef]]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVFrameSideData)
        inline def `type` : AVFrameSideDataType = struct._1
        inline def type_=(value: AVFrameSideDataType): Unit = (!struct.at1 = value)
        inline def data : Ptr[uint8_t] = struct._2
        inline def data_=(value: Ptr[uint8_t]): Unit = (!struct.at2 = value)
        inline def size : size_t = struct._3
        inline def size_=(value: size_t): Unit = (!struct.at3 = value)
        inline def metadata : Ptr[AVDictionary] = struct._4
        inline def metadata_=(value: Ptr[AVDictionary]): Unit = (!struct.at4 = value)
        inline def buf : Ptr[AVBufferRef] = struct._5
        inline def buf_=(value: Ptr[AVBufferRef]): Unit = (!struct.at5 = value)
      end extension
    
    // Allocates AVFrameSideData on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVFrameSideData] = scala.scalanative.unsafe.alloc[AVFrameSideData](1)
    def apply(`type` : AVFrameSideDataType, data : Ptr[uint8_t], size : size_t, metadata : Ptr[AVDictionary], buf : Ptr[AVBufferRef])(using Zone): Ptr[AVFrameSideData] =
      val ____ptr = apply()
      (!____ptr).`type` = `type`
      (!____ptr).data = data
      (!____ptr).size = size
  ...
  opaque type AVHWAccel = CStruct5[CString, AVMediaType, AVCodecID, AVPixelFormat, CInt]
  
  object AVHWAccel:
    given _tag: Tag[AVHWAccel] = Tag.materializeCStruct5Tag[CString, AVMediaType, AVCodecID, AVPixelFormat, CInt]
    ...
    private[ffmpeg] object fields:
      extension (struct: AVHWAccel)
        ...
        inline def `type` : AVMediaType = struct._2
        inline def type_=(value: AVMediaType): Unit = (!struct.at2 = value)
        inline def id : AVCodecID = struct._3
        inline def id_=(value: AVCodecID): Unit = (!struct.at3 = value)
        inline def pix_fmt : AVPixelFormat = struct._4
        inline def pix_fmt_=(value: AVPixelFormat): Unit = (!struct.at4 = value)
        inline def capabilities : CInt = struct._5
        inline def capabilities_=(value: CInt): Unit = (!struct.at5 = value)
      end extension
    
    // Allocates AVHWAccel on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVHWAccel] = scala.scalanative.unsafe.alloc[AVHWAccel](1)
    def apply(name : CString, `type` : AVMediaType, id : AVCodecID, pix_fmt : AVPixelFormat, capabilities : CInt)(using Zone): Ptr[AVHWAccel] =
      val ____ptr = apply()
      (!____ptr).name = name
      (!____ptr).`type` = `type`
      (!____ptr).id = id
  ...
  */
  opaque type AVHWDeviceContext = CStruct5[Ptr[Byte], AVHWDeviceType, Ptr[Byte], CFuncPtr1[Ptr[Byte], Unit], Ptr[Byte]]
  
  object AVHWDeviceContext:
    given _tag: Tag[AVHWDeviceContext] = Tag.materializeCStruct5Tag[Ptr[Byte], AVHWDeviceType, Ptr[Byte], CFuncPtr1[Ptr[Byte], Unit], Ptr[Byte]]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVHWDeviceContext)
        inline def av_class : Ptr[AVClass] = struct._1.asInstanceOf[Ptr[AVClass]]
        inline def av_class_=(value: Ptr[AVClass]): Unit = (!struct.at1 = value.asInstanceOf[Ptr[Byte]])
        inline def `type` : AVHWDeviceType = struct._2
        inline def type_=(value: AVHWDeviceType): Unit = (!struct.at2 = value)
        inline def hwctx : Ptr[Byte] = struct._3
        inline def hwctx_=(value: Ptr[Byte]): Unit = (!struct.at3 = value)
        inline def free : CFuncPtr1[Ptr[AVHWDeviceContext], Unit] = struct._4.asInstanceOf[CFuncPtr1[Ptr[AVHWDeviceContext], Unit]]
        inline def free_=(value: CFuncPtr1[Ptr[AVHWDeviceContext], Unit]): Unit = (!struct.at4 = value.asInstanceOf[CFuncPtr1[Ptr[Byte], Unit]])
        inline def user_opaque : Ptr[Byte] = struct._5
        inline def user_opaque_=(value: Ptr[Byte]): Unit = (!struct.at5 = value)
      end extension
    
    // Allocates AVHWDeviceContext on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVHWDeviceContext] = scala.scalanative.unsafe.alloc[AVHWDeviceContext](1)
    def apply(av_class : Ptr[AVClass], `type` : AVHWDeviceType, hwctx : Ptr[Byte], free : CFuncPtr1[Ptr[AVHWDeviceContext], Unit], user_opaque : Ptr[Byte])(using Zone): Ptr[AVHWDeviceContext] =
      val ____ptr = apply()
      (!____ptr).av_class = av_class
      (!____ptr).`type` = `type`
      (!____ptr).hwctx = hwctx
  ...
  */
  opaque type AVHWFramesConstraints = CStruct6[Ptr[AVPixelFormat], Ptr[AVPixelFormat], CInt, CInt, CInt, CInt]
  
  object AVHWFramesConstraints:
    given _tag: Tag[AVHWFramesConstraints] = Tag.materializeCStruct6Tag[Ptr[AVPixelFormat], Ptr[AVPixelFormat], CInt, CInt, CInt, CInt]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVHWFramesConstraints)
        inline def valid_hw_formats : Ptr[AVPixelFormat] = struct._1
        inline def valid_hw_formats_=(value: Ptr[AVPixelFormat]): Unit = (!struct.at1 = value)
        inline def valid_sw_formats : Ptr[AVPixelFormat] = struct._2
        inline def valid_sw_formats_=(value: Ptr[AVPixelFormat]): Unit = (!struct.at2 = value)
        inline def min_width : CInt = struct._3
        inline def min_width_=(value: CInt): Unit = (!struct.at3 = value)
        inline def min_height : CInt = struct._4
        inline def min_height_=(value: CInt): Unit = (!struct.at4 = value)
        inline def max_width : CInt = struct._5
        inline def max_width_=(value: CInt): Unit = (!struct.at5 = value)
        inline def max_height : CInt = struct._6
        inline def max_height_=(value: CInt): Unit = (!struct.at6 = value)
      end extension
    
    // Allocates AVHWFramesConstraints on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVHWFramesConstraints] = scala.scalanative.unsafe.alloc[AVHWFramesConstraints](1)
    def apply(valid_hw_formats : Ptr[AVPixelFormat], valid_sw_formats : Ptr[AVPixelFormat], min_width : CInt, min_height : CInt, max_width : CInt, max_height : CInt)(using Zone): Ptr[AVHWFramesConstraints] =
      val ____ptr = apply()
  ...
  */
  opaque type AVHWFramesContext = CStruct12[Ptr[Byte], Ptr[AVBufferRef], Ptr[Byte], Ptr[Byte], CFuncPtr1[Ptr[Byte], Unit], Ptr[Byte], Ptr[AVBufferPool], CInt, AVPixelFormat, AVPixelFormat, CInt, CInt]
  
  object AVHWFramesContext:
    given _tag: Tag[AVHWFramesContext] = Tag.materializeCStruct12Tag[Ptr[Byte], Ptr[AVBufferRef], Ptr[Byte], Ptr[Byte], CFuncPtr1[Ptr[Byte], Unit], Ptr[Byte], Ptr[AVBufferPool], CInt, AVPixelFormat, AVPixelFormat, CInt, CInt]
    ...
    private[ffmpeg] object fields:
      extension (struct: AVHWFramesContext)
        inline def av_class : Ptr[AVClass] = struct._1.asInstanceOf[Ptr[AVClass]]
        inline def av_class_=(value: Ptr[AVClass]): Unit = (!struct.at1 = value.asInstanceOf[Ptr[Byte]])
        inline def device_ref : Ptr[AVBufferRef] = struct._2
        inline def device_ref_=(value: Ptr[AVBufferRef]): Unit = (!struct.at2 = value)
        inline def device_ctx : Ptr[AVHWDeviceContext] = struct._3.asInstanceOf[Ptr[AVHWDeviceContext]]
        inline def device_ctx_=(value: Ptr[AVHWDeviceContext]): Unit = (!struct.at3 = value.asInstanceOf[Ptr[Byte]])
        inline def hwctx : Ptr[Byte] = struct._4
        inline def hwctx_=(value: Ptr[Byte]): Unit = (!struct.at4 = value)
        inline def free : CFuncPtr1[Ptr[AVHWFramesContext], Unit] = struct._5.asInstanceOf[CFuncPtr1[Ptr[AVHWFramesContext], Unit]]
        inline def free_=(value: CFuncPtr1[Ptr[AVHWFramesContext], Unit]): Unit = (!struct.at5 = value.asInstanceOf[CFuncPtr1[Ptr[Byte], Unit]])
        inline def user_opaque : Ptr[Byte] = struct._6
        inline def user_opaque_=(value: Ptr[Byte]): Unit = (!struct.at6 = value)
        inline def pool : Ptr[AVBufferPool] = struct._7
        inline def pool_=(value: Ptr[AVBufferPool]): Unit = (!struct.at7 = value)
        inline def initial_pool_size : CInt = struct._8
        inline def initial_pool_size_=(value: CInt): Unit = (!struct.at8 = value)
        inline def format : AVPixelFormat = struct._9
        inline def format_=(value: AVPixelFormat): Unit = (!struct.at9 = value)
        inline def sw_format : AVPixelFormat = struct._10
        inline def sw_format_=(value: AVPixelFormat): Unit = (!struct.at10 = value)
        inline def width : CInt = struct._11
        inline def width_=(value: CInt): Unit = (!struct.at11 = value)
        inline def height : CInt = struct._12
        inline def height_=(value: CInt): Unit = (!struct.at12 = value)
      end extension
    
    // Allocates AVHWFramesContext on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVHWFramesContext] = scala.scalanative.unsafe.alloc[AVHWFramesContext](1)
    def apply(av_class : Ptr[AVClass], device_ref : Ptr[AVBufferRef], device_ctx : Ptr[AVHWDeviceContext], hwctx : Ptr[Byte], free : CFuncPtr1[Ptr[AVHWFramesContext], Unit], user_opaque : Ptr[Byte], pool : Ptr[AVBufferPool], initial_pool_size : CInt, format : AVPixelFormat, sw_format : AVPixelFormat, width : CInt, height : CInt)(using Zone): Ptr[AVHWFramesContext] =
      val ____ptr = apply()
      (!____ptr).av_class = av_class
  ...
  */
  ...
  object AVIOContext:
    given _tag: Tag[AVIOContext] = Tag.CArray[CChar, Nat.Digit3[Nat._2, Nat._0, Nat._8]](Tag.Byte, Tag.Digit3[Nat._2, Nat._0, Nat._8](Tag.Nat2, Tag.Nat0, Tag.Nat8))
    ...
    private[ffmpeg] object fields:
      extension (struct: AVIOContext)
        inline def av_class: Ptr[AVClass] = !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[AVClass]]]
        inline def av_class_=(value: Ptr[AVClass]): Unit = !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[AVClass]]] = value
        inline def buffer: Ptr[CUnsignedChar] = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]]
        inline def buffer_=(value: Ptr[CUnsignedChar]): Unit = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]] = value
        inline def buffer_size: CInt = !struct.at(offsets(2)).asInstanceOf[Ptr[CInt]]
        inline def buffer_size_=(value: CInt): Unit = !struct.at(offsets(2)).asInstanceOf[Ptr[CInt]] = value
        inline def buf_ptr: Ptr[CUnsignedChar] = !struct.at(offsets(3)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]]
        inline def buf_ptr_=(value: Ptr[CUnsignedChar]): Unit = !struct.at(offsets(3)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]] = value
        inline def buf_end: Ptr[CUnsignedChar] = !struct.at(offsets(4)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]]
        inline def buf_end_=(value: Ptr[CUnsignedChar]): Unit = !struct.at(offsets(4)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]] = value
        inline def opaque: Ptr[Byte] = !struct.at(offsets(5)).asInstanceOf[Ptr[Ptr[Byte]]]
        inline def opaque_=(value: Ptr[Byte]): Unit = !struct.at(offsets(5)).asInstanceOf[Ptr[Ptr[Byte]]] = value
        inline def read_packet: CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt] = !struct.at(offsets(6)).asInstanceOf[Ptr[CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt]]]
        inline def read_packet_=(value: CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt]): Unit = !struct.at(offsets(6)).asInstanceOf[Ptr[CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt]]] = value
        inline def write_packet: CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt] = !struct.at(offsets(7)).asInstanceOf[Ptr[CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt]]]
        inline def write_packet_=(value: CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt]): Unit = !struct.at(offsets(7)).asInstanceOf[Ptr[CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt]]] = value
        inline def seek: CFuncPtr3[Ptr[Byte], int64_t, CInt, int64_t] = !struct.at(offsets(8)).asInstanceOf[Ptr[CFuncPtr3[Ptr[Byte], int64_t, CInt, int64_t]]]
        inline def seek_=(value: CFuncPtr3[Ptr[Byte], int64_t, CInt, int64_t]): Unit = !struct.at(offsets(8)).asInstanceOf[Ptr[CFuncPtr3[Ptr[Byte], int64_t, CInt, int64_t]]] = value
        inline def pos: int64_t = !struct.at(offsets(9)).asInstanceOf[Ptr[int64_t]]
        inline def pos_=(value: int64_t): Unit = !struct.at(offsets(9)).asInstanceOf[Ptr[int64_t]] = value
        inline def eof_reached: CInt = !struct.at(offsets(10)).asInstanceOf[Ptr[CInt]]
        inline def eof_reached_=(value: CInt): Unit = !struct.at(offsets(10)).asInstanceOf[Ptr[CInt]] = value
        inline def error: CInt = !struct.at(offsets(11)).asInstanceOf[Ptr[CInt]]
        inline def error_=(value: CInt): Unit = !struct.at(offsets(11)).asInstanceOf[Ptr[CInt]] = value
        inline def write_flag: CInt = !struct.at(offsets(12)).asInstanceOf[Ptr[CInt]]
        inline def write_flag_=(value: CInt): Unit = !struct.at(offsets(12)).asInstanceOf[Ptr[CInt]] = value
        inline def max_packet_size: CInt = !struct.at(offsets(13)).asInstanceOf[Ptr[CInt]]
        inline def max_packet_size_=(value: CInt): Unit = !struct.at(offsets(13)).asInstanceOf[Ptr[CInt]] = value
        inline def min_packet_size: CInt = !struct.at(offsets(14)).asInstanceOf[Ptr[CInt]]
        inline def min_packet_size_=(value: CInt): Unit = !struct.at(offsets(14)).asInstanceOf[Ptr[CInt]] = value
        inline def checksum: CUnsignedLongInt = !struct.at(offsets(15)).asInstanceOf[Ptr[CUnsignedLongInt]]
        inline def checksum_=(value: CUnsignedLongInt): Unit = !struct.at(offsets(15)).asInstanceOf[Ptr[CUnsignedLongInt]] = value
        inline def checksum_ptr: Ptr[CUnsignedChar] = !struct.at(offsets(16)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]]
        inline def checksum_ptr_=(value: Ptr[CUnsignedChar]): Unit = !struct.at(offsets(16)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]] = value
        inline def update_checksum: CFuncPtr3[CUnsignedLongInt, Ptr[uint8_t], CUnsignedInt, CUnsignedLongInt] = !struct.at(offsets(17)).asInstanceOf[Ptr[CFuncPtr3[CUnsignedLongInt, Ptr[uint8_t], CUnsignedInt, CUnsignedLongInt]]]
        inline def update_checksum_=(value: CFuncPtr3[CUnsignedLongInt, Ptr[uint8_t], CUnsignedInt, CUnsignedLongInt]): Unit = !struct.at(offsets(17)).asInstanceOf[Ptr[CFuncPtr3[CUnsignedLongInt, Ptr[uint8_t], CUnsignedInt, CUnsignedLongInt]]] = value
        inline def read_pause: CFuncPtr2[Ptr[Byte], CInt, CInt] = !struct.at(offsets(18)).asInstanceOf[Ptr[CFuncPtr2[Ptr[Byte], CInt, CInt]]]
        inline def read_pause_=(value: CFuncPtr2[Ptr[Byte], CInt, CInt]): Unit = !struct.at(offsets(18)).asInstanceOf[Ptr[CFuncPtr2[Ptr[Byte], CInt, CInt]]] = value
        inline def read_seek: CFuncPtr4[Ptr[Byte], CInt, int64_t, CInt, int64_t] = !struct.at(offsets(19)).asInstanceOf[Ptr[CFuncPtr4[Ptr[Byte], CInt, int64_t, CInt, int64_t]]]
        inline def read_seek_=(value: CFuncPtr4[Ptr[Byte], CInt, int64_t, CInt, int64_t]): Unit = !struct.at(offsets(19)).asInstanceOf[Ptr[CFuncPtr4[Ptr[Byte], CInt, int64_t, CInt, int64_t]]] = value
        inline def seekable: CInt = !struct.at(offsets(20)).asInstanceOf[Ptr[CInt]]
        inline def seekable_=(value: CInt): Unit = !struct.at(offsets(20)).asInstanceOf[Ptr[CInt]] = value
        inline def direct: CInt = !struct.at(offsets(21)).asInstanceOf[Ptr[CInt]]
        inline def direct_=(value: CInt): Unit = !struct.at(offsets(21)).asInstanceOf[Ptr[CInt]] = value
        inline def protocol_whitelist: CString = !struct.at(offsets(22)).asInstanceOf[Ptr[CString]]
        inline def protocol_whitelist_=(value: CString): Unit = !struct.at(offsets(22)).asInstanceOf[Ptr[CString]] = value
        inline def protocol_blacklist: CString = !struct.at(offsets(23)).asInstanceOf[Ptr[CString]]
        inline def protocol_blacklist_=(value: CString): Unit = !struct.at(offsets(23)).asInstanceOf[Ptr[CString]] = value
        inline def write_data_type: CFuncPtr5[Ptr[Byte], Ptr[uint8_t], CInt, AVIODataMarkerType, int64_t, CInt] = !struct.at(offsets(24)).asInstanceOf[Ptr[CFuncPtr5[Ptr[Byte], Ptr[uint8_t], CInt, AVIODataMarkerType, int64_t, CInt]]]
        inline def write_data_type_=(value: CFuncPtr5[Ptr[Byte], Ptr[uint8_t], CInt, AVIODataMarkerType, int64_t, CInt]): Unit = !struct.at(offsets(24)).asInstanceOf[Ptr[CFuncPtr5[Ptr[Byte], Ptr[uint8_t], CInt, AVIODataMarkerType, int64_t, CInt]]] = value
        inline def ignore_boundary_point: CInt = !struct.at(offsets(25)).asInstanceOf[Ptr[CInt]]
        inline def ignore_boundary_point_=(value: CInt): Unit = !struct.at(offsets(25)).asInstanceOf[Ptr[CInt]] = value
        inline def buf_ptr_max: Ptr[CUnsignedChar] = !struct.at(offsets(26)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]]
        inline def buf_ptr_max_=(value: Ptr[CUnsignedChar]): Unit = !struct.at(offsets(26)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]] = value
        inline def bytes_read: int64_t = !struct.at(offsets(27)).asInstanceOf[Ptr[int64_t]]
        inline def bytes_read_=(value: int64_t): Unit = !struct.at(offsets(27)).asInstanceOf[Ptr[int64_t]] = value
        inline def bytes_written: int64_t = !struct.at(offsets(28)).asInstanceOf[Ptr[int64_t]]
        inline def bytes_written_=(value: int64_t): Unit = !struct.at(offsets(28)).asInstanceOf[Ptr[int64_t]] = value
      end extension
    
    // Allocates AVIOContext on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVIOContext] = scala.scalanative.unsafe.alloc[AVIOContext](1)
    def apply(av_class : Ptr[AVClass], buffer : Ptr[CUnsignedChar], buffer_size : CInt, buf_ptr : Ptr[CUnsignedChar], buf_end : Ptr[CUnsignedChar], opaque : Ptr[Byte], read_packet : CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt], write_packet : CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt], seek : CFuncPtr3[Ptr[Byte], int64_t, CInt, int64_t], pos : int64_t, eof_reached : CInt, error : CInt, write_flag : CInt, max_packet_size : CInt, min_packet_size : CInt, checksum : CUnsignedLongInt, checksum_ptr : Ptr[CUnsignedChar], update_checksum : CFuncPtr3[CUnsignedLongInt, Ptr[uint8_t], CUnsignedInt, CUnsignedLongInt], read_pause : CFuncPtr2[Ptr[Byte], CInt, CInt], read_seek : CFuncPtr4[Ptr[Byte], CInt, int64_t, CInt, int64_t], seekable : CInt, direct : CInt, protocol_whitelist : CString, protocol_blacklist : CString, write_data_type : CFuncPtr5[Ptr[Byte], Ptr[uint8_t], CInt, AVIODataMarkerType, int64_t, CInt], ignore_boundary_point : CInt, buf_ptr_max : Ptr[CUnsignedChar], bytes_read : int64_t, bytes_written : int64_t)(using Zone): Ptr[AVIOContext] =
      val ____ptr = apply()
      (!____ptr).av_class = av_class
      (!____ptr).buffer = buffer
      (!____ptr).buffer_size = buffer_size
    ...
    val offsets: Array[Int] =
      ...
      res(0) = align(0, alignmentof[Ptr[AVClass]].toInt)
      res(1) = align(res(0) + sizeof[Ptr[AVClass]].toInt, alignmentof[Ptr[CUnsignedChar]].toInt)
      res(2) = align(res(1) + sizeof[Ptr[CUnsignedChar]].toInt, alignmentof[CInt].toInt)
      res(3) = align(res(2) + sizeof[CInt].toInt, alignmentof[Ptr[CUnsignedChar]].toInt)
      res(4) = align(res(3) + sizeof[Ptr[CUnsignedChar]].toInt, alignmentof[Ptr[CUnsignedChar]].toInt)
      res(5) = align(res(4) + sizeof[Ptr[CUnsignedChar]].toInt, alignmentof[Ptr[Byte]].toInt)
      res(6) = align(res(5) + sizeof[Ptr[Byte]].toInt, alignmentof[CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt]].toInt)
      res(7) = align(res(6) + sizeof[CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt]].toInt, alignmentof[CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt]].toInt)
      res(8) = align(res(7) + sizeof[CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt]].toInt, alignmentof[CFuncPtr3[Ptr[Byte], int64_t, CInt, int64_t]].toInt)
      res(9) = align(res(8) + sizeof[CFuncPtr3[Ptr[Byte], int64_t, CInt, int64_t]].toInt, alignmentof[int64_t].toInt)
      res(10) = align(res(9) + sizeof[int64_t].toInt, alignmentof[CInt].toInt)
      res(11) = align(res(10) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(12) = align(res(11) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(13) = align(res(12) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(14) = align(res(13) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(15) = align(res(14) + sizeof[CInt].toInt, alignmentof[CUnsignedLongInt].toInt)
      res(16) = align(res(15) + sizeof[CUnsignedLongInt].toInt, alignmentof[Ptr[CUnsignedChar]].toInt)
      res(17) = align(res(16) + sizeof[Ptr[CUnsignedChar]].toInt, alignmentof[CFuncPtr3[CUnsignedLongInt, Ptr[uint8_t], CUnsignedInt, CUnsignedLongInt]].toInt)
      res(18) = align(res(17) + sizeof[CFuncPtr3[CUnsignedLongInt, Ptr[uint8_t], CUnsignedInt, CUnsignedLongInt]].toInt, alignmentof[CFuncPtr2[Ptr[Byte], CInt, CInt]].toInt)
      res(19) = align(res(18) + sizeof[CFuncPtr2[Ptr[Byte], CInt, CInt]].toInt, alignmentof[CFuncPtr4[Ptr[Byte], CInt, int64_t, CInt, int64_t]].toInt)
      res(20) = align(res(19) + sizeof[CFuncPtr4[Ptr[Byte], CInt, int64_t, CInt, int64_t]].toInt, alignmentof[CInt].toInt)
      res(21) = align(res(20) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      ...
      res(24) = align(res(23) + sizeof[CString].toInt, alignmentof[CFuncPtr5[Ptr[Byte], Ptr[uint8_t], CInt, AVIODataMarkerType, int64_t, CInt]].toInt)
      res(25) = align(res(24) + sizeof[CFuncPtr5[Ptr[Byte], Ptr[uint8_t], CInt, AVIODataMarkerType, int64_t, CInt]].toInt, alignmentof[CInt].toInt)
      res(26) = align(res(25) + sizeof[CInt].toInt, alignmentof[Ptr[CUnsignedChar]].toInt)
      res(27) = align(res(26) + sizeof[Ptr[CUnsignedChar]].toInt, alignmentof[int64_t].toInt)
      res(28) = align(res(27) + sizeof[int64_t].toInt, alignmentof[int64_t].toInt)
      res
    end offsets
  ...
  */
  opaque type AVIODirEntry = CStruct10[CString, CInt, CInt, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t]
  
  object AVIODirEntry:
    given _tag: Tag[AVIODirEntry] = Tag.materializeCStruct10Tag[CString, CInt, CInt, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t, int64_t]
    ...
    private[ffmpeg] object fields:
      extension (struct: AVIODirEntry)
        ...
        inline def utf8 : CInt = struct._3
        inline def utf8_=(value: CInt): Unit = (!struct.at3 = value)
        inline def size : int64_t = struct._4
        inline def size_=(value: int64_t): Unit = (!struct.at4 = value)
        inline def modification_timestamp : int64_t = struct._5
        inline def modification_timestamp_=(value: int64_t): Unit = (!struct.at5 = value)
        inline def access_timestamp : int64_t = struct._6
        inline def access_timestamp_=(value: int64_t): Unit = (!struct.at6 = value)
        inline def status_change_timestamp : int64_t = struct._7
        inline def status_change_timestamp_=(value: int64_t): Unit = (!struct.at7 = value)
        inline def user_id : int64_t = struct._8
        inline def user_id_=(value: int64_t): Unit = (!struct.at8 = value)
        inline def group_id : int64_t = struct._9
        inline def group_id_=(value: int64_t): Unit = (!struct.at9 = value)
        inline def filemode : int64_t = struct._10
        inline def filemode_=(value: int64_t): Unit = (!struct.at10 = value)
      end extension
    
    // Allocates AVIODirEntry on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVIODirEntry] = scala.scalanative.unsafe.alloc[AVIODirEntry](1)
    def apply(name : CString, `type` : CInt, utf8 : CInt, size : int64_t, modification_timestamp : int64_t, access_timestamp : int64_t, status_change_timestamp : int64_t, user_id : int64_t, group_id : int64_t, filemode : int64_t)(using Zone): Ptr[AVIODirEntry] =
      val ____ptr = apply()
      (!____ptr).name = name
      (!____ptr).`type` = `type`
      (!____ptr).utf8 = utf8
  ...
  */
  ...
  object AVIOInterruptCB:
    given _tag: Tag[AVIOInterruptCB] = Tag.materializeCStruct2Tag[CFuncPtr1[Ptr[Byte], CInt], Ptr[Byte]]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVIOInterruptCB)
        inline def callback : CFuncPtr1[Ptr[Byte], CInt] = struct._1
        inline def callback_=(value: CFuncPtr1[Ptr[Byte], CInt]): Unit = (!struct.at1 = value)
        inline def opaque : Ptr[Byte] = struct._2
        inline def opaque_=(value: Ptr[Byte]): Unit = (!struct.at2 = value)
      end extension
    
    // Allocates AVIOInterruptCB on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVIOInterruptCB] = scala.scalanative.unsafe.alloc[AVIOInterruptCB](1)
    def apply(callback : CFuncPtr1[Ptr[Byte], CInt], opaque : Ptr[Byte])(using Zone): Ptr[AVIOInterruptCB] =
      val ____ptr = apply()
  ...
  object AVIndexEntry:
    given _tag: Tag[AVIndexEntry] = Tag.materializeCStruct5Tag[int64_t, int64_t, CInt, CInt, CInt]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVIndexEntry)
        inline def pos : int64_t = struct._1
        inline def pos_=(value: int64_t): Unit = (!struct.at1 = value)
        inline def timestamp : int64_t = struct._2
        inline def timestamp_=(value: int64_t): Unit = (!struct.at2 = value)
        inline def flags : CInt = struct._3
        inline def flags_=(value: CInt): Unit = (!struct.at3 = value)
        inline def size : CInt = struct._4
        inline def size_=(value: CInt): Unit = (!struct.at4 = value)
        inline def min_distance : CInt = struct._5
        inline def min_distance_=(value: CInt): Unit = (!struct.at5 = value)
      end extension
    
    // Allocates AVIndexEntry on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVIndexEntry] = scala.scalanative.unsafe.alloc[AVIndexEntry](1)
    def apply(pos : int64_t, timestamp : int64_t, flags : CInt, size : CInt, min_distance : CInt)(using Zone): Ptr[AVIndexEntry] =
      val ____ptr = apply()
      (!____ptr).pos = pos
   ...
   * @{
  */
  opaque type AVInputFormat = CStruct7[CString, CString, CInt, CString, Ptr[Ptr[AVCodecTag]], Ptr[Byte], CString]
  
  object AVInputFormat:
    given _tag: Tag[AVInputFormat] = Tag.materializeCStruct7Tag[CString, CString, CInt, CString, Ptr[Ptr[AVCodecTag]], Ptr[Byte], CString]
    ...
    private[ffmpeg] object fields:
      extension (struct: AVInputFormat)
        ...
        inline def flags : CInt = struct._3
        inline def flags_=(value: CInt): Unit = (!struct.at3 = value)
        inline def extensions : CString = struct._4
        inline def extensions_=(value: CString): Unit = (!struct.at4 = value)
        inline def codec_tag : Ptr[Ptr[AVCodecTag]] = struct._5
        inline def codec_tag_=(value: Ptr[Ptr[AVCodecTag]]): Unit = (!struct.at5 = value)
        inline def priv_class : Ptr[AVClass] = struct._6.asInstanceOf[Ptr[AVClass]]
        inline def priv_class_=(value: Ptr[AVClass]): Unit = (!struct.at6 = value.asInstanceOf[Ptr[Byte]])
        inline def mime_type : CString = struct._7
        inline def mime_type_=(value: CString): Unit = (!struct.at7 = value)
      end extension
    
    // Allocates AVInputFormat on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVInputFormat] = scala.scalanative.unsafe.alloc[AVInputFormat](1)
    def apply(name : CString, long_name : CString, flags : CInt, extensions : CString, codec_tag : Ptr[Ptr[AVCodecTag]], priv_class : Ptr[AVClass], mime_type : CString)(using Zone): Ptr[AVInputFormat] =
      val ____ptr = apply()
      (!____ptr).name = name
      (!____ptr).long_name = long_name
      (!____ptr).flags = flags
   ...
   * @{
  */
  opaque type AVOutputFormat = CStruct10[CString, CString, CString, CString, AVCodecID, AVCodecID, AVCodecID, CInt, Ptr[Ptr[AVCodecTag]], Ptr[Byte]]
  
  object AVOutputFormat:
    given _tag: Tag[AVOutputFormat] = Tag.materializeCStruct10Tag[CString, CString, CString, CString, AVCodecID, AVCodecID, AVCodecID, CInt, Ptr[Ptr[AVCodecTag]], Ptr[Byte]]
    ...
    private[ffmpeg] object fields:
      extension (struct: AVOutputFormat)
        ...
        inline def extensions : CString = struct._4
        inline def extensions_=(value: CString): Unit = (!struct.at4 = value)
        inline def audio_codec : AVCodecID = struct._5
        inline def audio_codec_=(value: AVCodecID): Unit = (!struct.at5 = value)
        inline def video_codec : AVCodecID = struct._6
        inline def video_codec_=(value: AVCodecID): Unit = (!struct.at6 = value)
        inline def subtitle_codec : AVCodecID = struct._7
        inline def subtitle_codec_=(value: AVCodecID): Unit = (!struct.at7 = value)
        inline def flags : CInt = struct._8
        inline def flags_=(value: CInt): Unit = (!struct.at8 = value)
        inline def codec_tag : Ptr[Ptr[AVCodecTag]] = struct._9
        inline def codec_tag_=(value: Ptr[Ptr[AVCodecTag]]): Unit = (!struct.at9 = value)
        inline def priv_class : Ptr[AVClass] = struct._10.asInstanceOf[Ptr[AVClass]]
        inline def priv_class_=(value: Ptr[AVClass]): Unit = (!struct.at10 = value.asInstanceOf[Ptr[Byte]])
      end extension
    
    // Allocates AVOutputFormat on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVOutputFormat] = scala.scalanative.unsafe.alloc[AVOutputFormat](1)
    def apply(name : CString, long_name : CString, mime_type : CString, extensions : CString, audio_codec : AVCodecID, video_codec : AVCodecID, subtitle_codec : AVCodecID, flags : CInt, codec_tag : Ptr[Ptr[AVCodecTag]], priv_class : Ptr[AVClass])(using Zone): Ptr[AVOutputFormat] =
      val ____ptr = apply()
      (!____ptr).name = name
      (!____ptr).long_name = long_name
      (!____ptr).mime_type = mime_type
  ...
  */
  opaque type AVPacket = CStruct14[Ptr[AVBufferRef], int64_t, int64_t, Ptr[uint8_t], CInt, CInt, CInt, Ptr[AVPacketSideData], CInt, int64_t, int64_t, Ptr[Byte], Ptr[AVBufferRef], AVRational]
  
  object AVPacket:
    given _tag: Tag[AVPacket] = Tag.materializeCStruct14Tag[Ptr[AVBufferRef], int64_t, int64_t, Ptr[uint8_t], CInt, CInt, CInt, Ptr[AVPacketSideData], CInt, int64_t, int64_t, Ptr[Byte], Ptr[AVBufferRef], AVRational]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVPacket)
        inline def buf : Ptr[AVBufferRef] = struct._1
        inline def buf_=(value: Ptr[AVBufferRef]): Unit = (!struct.at1 = value)
        inline def pts : int64_t = struct._2
        inline def pts_=(value: int64_t): Unit = (!struct.at2 = value)
        inline def dts : int64_t = struct._3
        inline def dts_=(value: int64_t): Unit = (!struct.at3 = value)
        inline def data : Ptr[uint8_t] = struct._4
        inline def data_=(value: Ptr[uint8_t]): Unit = (!struct.at4 = value)
        inline def size : CInt = struct._5
        inline def size_=(value: CInt): Unit = (!struct.at5 = value)
        inline def stream_index : CInt = struct._6
        inline def stream_index_=(value: CInt): Unit = (!struct.at6 = value)
        inline def flags : CInt = struct._7
        inline def flags_=(value: CInt): Unit = (!struct.at7 = value)
        inline def side_data : Ptr[AVPacketSideData] = struct._8
        inline def side_data_=(value: Ptr[AVPacketSideData]): Unit = (!struct.at8 = value)
        inline def side_data_elems : CInt = struct._9
        inline def side_data_elems_=(value: CInt): Unit = (!struct.at9 = value)
        inline def duration : int64_t = struct._10
        inline def duration_=(value: int64_t): Unit = (!struct.at10 = value)
        inline def pos : int64_t = struct._11
        inline def pos_=(value: int64_t): Unit = (!struct.at11 = value)
        inline def opaque : Ptr[Byte] = struct._12
        inline def opaque_=(value: Ptr[Byte]): Unit = (!struct.at12 = value)
        inline def opaque_ref : Ptr[AVBufferRef] = struct._13
        inline def opaque_ref_=(value: Ptr[AVBufferRef]): Unit = (!struct.at13 = value)
        inline def time_base : AVRational = struct._14
        inline def time_base_=(value: AVRational): Unit = (!struct.at14 = value)
      end extension
    
    // Allocates AVPacket on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVPacket] = scala.scalanative.unsafe.alloc[AVPacket](1)
    def apply(buf : Ptr[AVBufferRef], pts : int64_t, dts : int64_t, data : Ptr[uint8_t], size : CInt, stream_index : CInt, flags : CInt, side_data : Ptr[AVPacketSideData], side_data_elems : CInt, duration : int64_t, pos : int64_t, opaque : Ptr[Byte], opaque_ref : Ptr[AVBufferRef], time_base : AVRational)(using Zone): Ptr[AVPacket] =
      val ____ptr = apply()
      (!____ptr).buf = buf
      (!____ptr).pts = pts
      (!____ptr).dts = dts
  ...
  object AVPacketList:
    given _tag: Tag[AVPacketList] = Tag.materializeCStruct2Tag[AVPacket, Ptr[Byte]]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVPacketList)
        inline def pkt : AVPacket = struct._1
        inline def pkt_=(value: AVPacket): Unit = (!struct.at1 = value)
        inline def next : Ptr[AVPacketList] = struct._2.asInstanceOf[Ptr[AVPacketList]]
        inline def next_=(value: Ptr[AVPacketList]): Unit = (!struct.at2 = value.asInstanceOf[Ptr[Byte]])
      end extension
    
    // Allocates AVPacketList on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVPacketList] = scala.scalanative.unsafe.alloc[AVPacketList](1)
    def apply(pkt : AVPacket, next : Ptr[AVPacketList])(using Zone): Ptr[AVPacketList] =
      val ____ptr = apply()
      (!____ptr).pkt = pkt
      (!____ptr).next = next
      ____ptr
  ...
  */
  opaque type AVPacketSideData = CStruct3[Ptr[uint8_t], size_t, AVPacketSideDataType]
  
  object AVPacketSideData:
    given _tag: Tag[AVPacketSideData] = Tag.materializeCStruct3Tag[Ptr[uint8_t], size_t, AVPacketSideDataType]
    ...
    private[ffmpeg] object fields:
      extension (struct: AVPacketSideData)
        ...
        inline def `type` : AVPacketSideDataType = struct._3
        inline def type_=(value: AVPacketSideDataType): Unit = (!struct.at3 = value)
      end extension
    
    // Allocates AVPacketSideData on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVPacketSideData] = scala.scalanative.unsafe.alloc[AVPacketSideData](1)
    def apply(data : Ptr[uint8_t], size : size_t, `type` : AVPacketSideDataType)(using Zone): Ptr[AVPacketSideData] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).size = size
      (!____ptr).`type` = `type`
  ...
  */
  opaque type AVPanScan = CStruct4[CInt, CInt, CInt, CArray[CArray[int16_t, Nat._2], Nat._3]]
  
  object AVPanScan:
    given _tag: Tag[AVPanScan] = Tag.materializeCStruct4Tag[CInt, CInt, CInt, CArray[CArray[int16_t, Nat._2], Nat._3]]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVPanScan)
        inline def id : CInt = struct._1
        inline def id_=(value: CInt): Unit = (!struct.at1 = value)
        inline def width : CInt = struct._2
        inline def width_=(value: CInt): Unit = (!struct.at2 = value)
        inline def height : CInt = struct._3
        inline def height_=(value: CInt): Unit = (!struct.at3 = value)
        inline def position : CArray[CArray[int16_t, Nat._2], Nat._3] = struct._4
        inline def position_=(value: CArray[CArray[int16_t, Nat._2], Nat._3]): Unit = (!struct.at4 = value)
      end extension
    
    // Allocates AVPanScan on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVPanScan] = scala.scalanative.unsafe.alloc[AVPanScan](1)
    def apply(id : CInt, width : CInt, height : CInt, position : CArray[CArray[int16_t, Nat._2], Nat._3])(using Zone): Ptr[AVPanScan] =
      val ____ptr = apply()
      (!____ptr).id = id
      (!____ptr).width = width
      (!____ptr).height = height
  ...
  */
  ...
  object AVProbeData:
    given _tag: Tag[AVProbeData] = Tag.materializeCStruct4Tag[CString, Ptr[CUnsignedChar], CInt, CString]
    ...
    private[ffmpeg] object fields:
      extension (struct: AVProbeData)
        ...
        inline def buf : Ptr[CUnsignedChar] = struct._2
        inline def buf_=(value: Ptr[CUnsignedChar]): Unit = (!struct.at2 = value)
        inline def buf_size : CInt = struct._3
        inline def buf_size_=(value: CInt): Unit = (!struct.at3 = value)
        inline def mime_type : CString = struct._4
        inline def mime_type_=(value: CString): Unit = (!struct.at4 = value)
      end extension
    
    // Allocates AVProbeData on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVProbeData] = scala.scalanative.unsafe.alloc[AVProbeData](1)
    def apply(filename : CString, buf : Ptr[CUnsignedChar], buf_size : CInt, mime_type : CString)(using Zone): Ptr[AVProbeData] =
      val ____ptr = apply()
  ...
  */
  ...
  object AVProducerReferenceTime:
    given _tag: Tag[AVProducerReferenceTime] = Tag.materializeCStruct2Tag[int64_t, CInt]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVProducerReferenceTime)
        inline def wallclock : int64_t = struct._1
        inline def wallclock_=(value: int64_t): Unit = (!struct.at1 = value)
        inline def flags : CInt = struct._2
        inline def flags_=(value: CInt): Unit = (!struct.at2 = value)
      end extension
    
    // Allocates AVProducerReferenceTime on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVProducerReferenceTime] = scala.scalanative.unsafe.alloc[AVProducerReferenceTime](1)
    def apply(wallclock : int64_t, flags : CInt)(using Zone): Ptr[AVProducerReferenceTime] =
      val ____ptr = apply()
  ...
  object AVProfile:
    ...
    private[ffmpeg] object fields:
      extension (struct: AVProfile)
        inline def profile : CInt = struct._1
        inline def profile_=(value: CInt): Unit = (!struct.at1 = value)
    ...
    def apply()(using Zone): Ptr[AVProfile] = scala.scalanative.unsafe.alloc[AVProfile](1)
  ...
  */
  opaque type AVProgram = CStruct14[CInt, CInt, AVDiscard, Ptr[CUnsignedInt], CUnsignedInt, Ptr[AVDictionary], CInt, CInt, CInt, CInt, int64_t, int64_t, int64_t, CInt]
  
  object AVProgram:
    given _tag: Tag[AVProgram] = Tag.materializeCStruct14Tag[CInt, CInt, AVDiscard, Ptr[CUnsignedInt], CUnsignedInt, Ptr[AVDictionary], CInt, CInt, CInt, CInt, int64_t, int64_t, int64_t, CInt]
    ...
    private[ffmpeg] object fields:
      extension (struct: AVProgram)
        ...
        inline def flags : CInt = struct._2
        inline def flags_=(value: CInt): Unit = (!struct.at2 = value)
        inline def discard : AVDiscard = struct._3
        inline def discard_=(value: AVDiscard): Unit = (!struct.at3 = value)
        inline def stream_index : Ptr[CUnsignedInt] = struct._4
        inline def stream_index_=(value: Ptr[CUnsignedInt]): Unit = (!struct.at4 = value)
        inline def nb_stream_indexes : CUnsignedInt = struct._5
        inline def nb_stream_indexes_=(value: CUnsignedInt): Unit = (!struct.at5 = value)
        inline def metadata : Ptr[AVDictionary] = struct._6
        inline def metadata_=(value: Ptr[AVDictionary]): Unit = (!struct.at6 = value)
        inline def program_num : CInt = struct._7
        inline def program_num_=(value: CInt): Unit = (!struct.at7 = value)
        inline def pmt_pid : CInt = struct._8
        inline def pmt_pid_=(value: CInt): Unit = (!struct.at8 = value)
        inline def pcr_pid : CInt = struct._9
        inline def pcr_pid_=(value: CInt): Unit = (!struct.at9 = value)
        inline def pmt_version : CInt = struct._10
        inline def pmt_version_=(value: CInt): Unit = (!struct.at10 = value)
        inline def start_time : int64_t = struct._11
        inline def start_time_=(value: int64_t): Unit = (!struct.at11 = value)
        inline def end_time : int64_t = struct._12
        inline def end_time_=(value: int64_t): Unit = (!struct.at12 = value)
        inline def pts_wrap_reference : int64_t = struct._13
        inline def pts_wrap_reference_=(value: int64_t): Unit = (!struct.at13 = value)
        inline def pts_wrap_behavior : CInt = struct._14
        inline def pts_wrap_behavior_=(value: CInt): Unit = (!struct.at14 = value)
      end extension
    
    // Allocates AVProgram on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVProgram] = scala.scalanative.unsafe.alloc[AVProgram](1)
    def apply(id : CInt, flags : CInt, discard : AVDiscard, stream_index : Ptr[CUnsignedInt], nb_stream_indexes : CUnsignedInt, metadata : Ptr[AVDictionary], program_num : CInt, pmt_pid : CInt, pcr_pid : CInt, pmt_version : CInt, start_time : int64_t, end_time : int64_t, pts_wrap_reference : int64_t, pts_wrap_behavior : CInt)(using Zone): Ptr[AVProgram] =
      val ____ptr = apply()
      (!____ptr).id = id
      (!____ptr).flags = flags
  ...
  */
  opaque type AVRTCPSenderReport = CStruct5[uint32_t, uint64_t, uint32_t, uint32_t, uint32_t]
  
  object AVRTCPSenderReport:
    given _tag: Tag[AVRTCPSenderReport] = Tag.materializeCStruct5Tag[uint32_t, uint64_t, uint32_t, uint32_t, uint32_t]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVRTCPSenderReport)
        inline def ssrc : uint32_t = struct._1
        inline def ssrc_=(value: uint32_t): Unit = (!struct.at1 = value)
        inline def ntp_timestamp : uint64_t = struct._2
        inline def ntp_timestamp_=(value: uint64_t): Unit = (!struct.at2 = value)
        inline def rtp_timestamp : uint32_t = struct._3
        inline def rtp_timestamp_=(value: uint32_t): Unit = (!struct.at3 = value)
        inline def sender_nb_packets : uint32_t = struct._4
        inline def sender_nb_packets_=(value: uint32_t): Unit = (!struct.at4 = value)
        inline def sender_nb_bytes : uint32_t = struct._5
        inline def sender_nb_bytes_=(value: uint32_t): Unit = (!struct.at5 = value)
      end extension
    
    // Allocates AVRTCPSenderReport on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVRTCPSenderReport] = scala.scalanative.unsafe.alloc[AVRTCPSenderReport](1)
    def apply(ssrc : uint32_t, ntp_timestamp : uint64_t, rtp_timestamp : uint32_t, sender_nb_packets : uint32_t, sender_nb_bytes : uint32_t)(using Zone): Ptr[AVRTCPSenderReport] =
      val ____ptr = apply()
      (!____ptr).ssrc = ssrc
      (!____ptr).ntp_timestamp = ntp_timestamp
      (!____ptr).rtp_timestamp = rtp_timestamp
      (!____ptr).sender_nb_packets = sender_nb_packets
      (!____ptr).sender_nb_bytes = sender_nb_bytes
      ____ptr
  ...
  object AVRational:
    ...
    private[ffmpeg] object fields:
      extension (struct: AVRational)
        inline def num : CInt = struct._1
        inline def num_=(value: CInt): Unit = (!struct.at1 = value)
        inline def den : CInt = struct._2
        inline def den_=(value: CInt): Unit = (!struct.at2 = value)
      end extension
    
    // Allocates AVRational on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVRational] = scala.scalanative.unsafe.alloc[AVRational](1)
  ...
  */
  opaque type AVRegionOfInterest = CStruct6[uint32_t, CInt, CInt, CInt, CInt, AVRational]
  
  object AVRegionOfInterest:
    given _tag: Tag[AVRegionOfInterest] = Tag.materializeCStruct6Tag[uint32_t, CInt, CInt, CInt, CInt, AVRational]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVRegionOfInterest)
        inline def self_size : uint32_t = struct._1
        inline def self_size_=(value: uint32_t): Unit = (!struct.at1 = value)
        inline def top : CInt = struct._2
        inline def top_=(value: CInt): Unit = (!struct.at2 = value)
        inline def bottom : CInt = struct._3
        inline def bottom_=(value: CInt): Unit = (!struct.at3 = value)
        inline def left : CInt = struct._4
        inline def left_=(value: CInt): Unit = (!struct.at4 = value)
        inline def right : CInt = struct._5
        inline def right_=(value: CInt): Unit = (!struct.at5 = value)
        inline def qoffset : AVRational = struct._6
        inline def qoffset_=(value: AVRational): Unit = (!struct.at6 = value)
      end extension
    
    // Allocates AVRegionOfInterest on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVRegionOfInterest] = scala.scalanative.unsafe.alloc[AVRegionOfInterest](1)
    def apply(self_size : uint32_t, top : CInt, bottom : CInt, left : CInt, right : CInt, qoffset : AVRational)(using Zone): Ptr[AVRegionOfInterest] =
      val ____ptr = apply()
  ...
  */
  ...
  object AVSideDataDescriptor:
    given _tag: Tag[AVSideDataDescriptor] = Tag.materializeCStruct2Tag[CString, CUnsignedInt]
    ...
    private[ffmpeg] object fields:
      extension (struct: AVSideDataDescriptor)
        inline def name : CString = struct._1
        inline def name_=(value: CString): Unit = (!struct.at1 = value)
        inline def props : CUnsignedInt = struct._2
        inline def props_=(value: CUnsignedInt): Unit = (!struct.at2 = value)
      end extension
    
    // Allocates AVSideDataDescriptor on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVSideDataDescriptor] = scala.scalanative.unsafe.alloc[AVSideDataDescriptor](1)
    def apply(name : CString, props : CUnsignedInt)(using Zone): Ptr[AVSideDataDescriptor] =
      val ____ptr = apply()
      (!____ptr).name = name
      (!____ptr).props = props
      ____ptr
  ...
  */
  opaque type AVStream = CStruct18[Ptr[Byte], CInt, CInt, Ptr[AVCodecParameters], Ptr[Byte], AVRational, int64_t, int64_t, int64_t, CInt, AVDiscard, AVRational, Ptr[AVDictionary], AVRational, AVPacket, CInt, AVRational, CInt]
  
  object AVStream:
    given _tag: Tag[AVStream] = Tag.materializeCStruct18Tag[Ptr[Byte], CInt, CInt, Ptr[AVCodecParameters], Ptr[Byte], AVRational, int64_t, int64_t, int64_t, CInt, AVDiscard, AVRational, Ptr[AVDictionary], AVRational, AVPacket, CInt, AVRational, CInt]
    ...
    private[ffmpeg] object fields:
      extension (struct: AVStream)
        ...
        inline def id : CInt = struct._3
        inline def id_=(value: CInt): Unit = (!struct.at3 = value)
        inline def codecpar : Ptr[AVCodecParameters] = struct._4
        inline def codecpar_=(value: Ptr[AVCodecParameters]): Unit = (!struct.at4 = value)
        inline def priv_data : Ptr[Byte] = struct._5
        inline def priv_data_=(value: Ptr[Byte]): Unit = (!struct.at5 = value)
        inline def time_base : AVRational = struct._6
        inline def time_base_=(value: AVRational): Unit = (!struct.at6 = value)
        inline def start_time : int64_t = struct._7
        inline def start_time_=(value: int64_t): Unit = (!struct.at7 = value)
        inline def duration : int64_t = struct._8
        inline def duration_=(value: int64_t): Unit = (!struct.at8 = value)
        inline def nb_frames : int64_t = struct._9
        inline def nb_frames_=(value: int64_t): Unit = (!struct.at9 = value)
        inline def disposition : CInt = struct._10
        inline def disposition_=(value: CInt): Unit = (!struct.at10 = value)
        inline def discard : AVDiscard = struct._11
        inline def discard_=(value: AVDiscard): Unit = (!struct.at11 = value)
        inline def sample_aspect_ratio : AVRational = struct._12
        inline def sample_aspect_ratio_=(value: AVRational): Unit = (!struct.at12 = value)
        inline def metadata : Ptr[AVDictionary] = struct._13
        inline def metadata_=(value: Ptr[AVDictionary]): Unit = (!struct.at13 = value)
        inline def avg_frame_rate : AVRational = struct._14
        inline def avg_frame_rate_=(value: AVRational): Unit = (!struct.at14 = value)
        inline def attached_pic : AVPacket = struct._15
        inline def attached_pic_=(value: AVPacket): Unit = (!struct.at15 = value)
        inline def event_flags : CInt = struct._16
        inline def event_flags_=(value: CInt): Unit = (!struct.at16 = value)
        inline def r_frame_rate : AVRational = struct._17
        inline def r_frame_rate_=(value: AVRational): Unit = (!struct.at17 = value)
        inline def pts_wrap_bits : CInt = struct._18
        inline def pts_wrap_bits_=(value: CInt): Unit = (!struct.at18 = value)
      end extension
    
    // Allocates AVStream on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVStream] = scala.scalanative.unsafe.alloc[AVStream](1)
    def apply(av_class : Ptr[AVClass], index : CInt, id : CInt, codecpar : Ptr[AVCodecParameters], priv_data : Ptr[Byte], time_base : AVRational, start_time : int64_t, duration : int64_t, nb_frames : int64_t, disposition : CInt, discard : AVDiscard, sample_aspect_ratio : AVRational, metadata : Ptr[AVDictionary], avg_frame_rate : AVRational, attached_pic : AVPacket, event_flags : CInt, r_frame_rate : AVRational, pts_wrap_bits : CInt)(using Zone): Ptr[AVStream] =
      val ____ptr = apply()
      (!____ptr).av_class = av_class
      (!____ptr).index = index
      (!____ptr).id = id
  ...
  opaque type AVStreamGroup = CStruct10[Ptr[Byte], Ptr[Byte], CUnsignedInt, int64_t, AVStreamGroupParamsType, AVStreamGroup_Params, Ptr[AVDictionary], CUnsignedInt, Ptr[Byte], CInt]
  
  object AVStreamGroup:
    given _tag: Tag[AVStreamGroup] = Tag.materializeCStruct10Tag[Ptr[Byte], Ptr[Byte], CUnsignedInt, int64_t, AVStreamGroupParamsType, AVStreamGroup_Params, Ptr[AVDictionary], CUnsignedInt, Ptr[Byte], CInt]
    ...
    private[ffmpeg] object fields:
      extension (struct: AVStreamGroup)
        inline def av_class : Ptr[AVClass] = struct._1.asInstanceOf[Ptr[AVClass]]
        inline def av_class_=(value: Ptr[AVClass]): Unit = (!struct.at1 = value.asInstanceOf[Ptr[Byte]])
        inline def priv_data : Ptr[Byte] = struct._2
        inline def priv_data_=(value: Ptr[Byte]): Unit = (!struct.at2 = value)
        inline def index : CUnsignedInt = struct._3
        inline def index_=(value: CUnsignedInt): Unit = (!struct.at3 = value)
        inline def id : int64_t = struct._4
        inline def id_=(value: int64_t): Unit = (!struct.at4 = value)
        inline def `type` : AVStreamGroupParamsType = struct._5
        inline def type_=(value: AVStreamGroupParamsType): Unit = (!struct.at5 = value)
        inline def params : AVStreamGroup_Params = struct._6
        inline def params_=(value: AVStreamGroup_Params): Unit = (!struct.at6 = value)
        inline def metadata : Ptr[AVDictionary] = struct._7
        inline def metadata_=(value: Ptr[AVDictionary]): Unit = (!struct.at7 = value)
        inline def nb_streams : CUnsignedInt = struct._8
        inline def nb_streams_=(value: CUnsignedInt): Unit = (!struct.at8 = value)
        inline def streams : Ptr[Ptr[AVStream]] = struct._9.asInstanceOf[Ptr[Ptr[AVStream]]]
        inline def streams_=(value: Ptr[Ptr[AVStream]]): Unit = (!struct.at9 = value.asInstanceOf[Ptr[Byte]])
        inline def disposition : CInt = struct._10
        inline def disposition_=(value: CInt): Unit = (!struct.at10 = value)
      end extension
    
    // Allocates AVStreamGroup on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVStreamGroup] = scala.scalanative.unsafe.alloc[AVStreamGroup](1)
    def apply(av_class : Ptr[AVClass], priv_data : Ptr[Byte], index : CUnsignedInt, id : int64_t, `type` : AVStreamGroupParamsType, params : AVStreamGroup_Params, metadata : Ptr[AVDictionary], nb_streams : CUnsignedInt, streams : Ptr[Ptr[AVStream]], disposition : CInt)(using Zone): Ptr[AVStreamGroup] =
      val ____ptr = apply()
      (!____ptr).av_class = av_class
      (!____ptr).priv_data = priv_data
      (!____ptr).index = index
  ...
  */
  opaque type AVStreamGroup_Params = CArray[Byte, Nat._8]
  object AVStreamGroup_Params:
    given _tag: Tag[AVStreamGroup_Params] = Tag.CArray[CChar, Nat._8](Tag.Byte, Tag.Nat8)
    
    def apply()(using Zone): Ptr[AVStreamGroup_Params] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[AVStreamGroup_Params](1)
      ___ptr
    
    @scala.annotation.targetName("apply_iamf_audio_element")
    def apply(iamf_audio_element: Ptr[AVIAMFAudioElement])(using Zone): Ptr[AVStreamGroup_Params] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[AVStreamGroup_Params](1)
      val un = !___ptr
      un.at(0).asInstanceOf[Ptr[Ptr[AVIAMFAudioElement]]].update(0, iamf_audio_element)
      ___ptr
    
    @scala.annotation.targetName("apply_iamf_mix_presentation")
    def apply(iamf_mix_presentation: Ptr[AVIAMFMixPresentation])(using Zone): Ptr[AVStreamGroup_Params] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[AVStreamGroup_Params](1)
      val un = !___ptr
      un.at(0).asInstanceOf[Ptr[Ptr[AVIAMFMixPresentation]]].update(0, iamf_mix_presentation)
      ___ptr
    
    @scala.annotation.targetName("apply_tile_grid")
    def apply(tile_grid: Ptr[AVStreamGroupTileGrid])(using Zone): Ptr[AVStreamGroup_Params] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[AVStreamGroup_Params](1)
      val un = !___ptr
      un.at(0).asInstanceOf[Ptr[Ptr[AVStreamGroupTileGrid]]].update(0, tile_grid)
      ___ptr
    
    @scala.annotation.targetName("apply_lcevc")
    def apply(lcevc: Ptr[AVStreamGroupLCEVC])(using Zone): Ptr[AVStreamGroup_Params] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[AVStreamGroup_Params](1)
      val un = !___ptr
      un.at(0).asInstanceOf[Ptr[Ptr[AVStreamGroupLCEVC]]].update(0, lcevc)
      ___ptr
    
    extension (struct: AVStreamGroup_Params)
      inline def iamf_audio_element : Ptr[AVIAMFAudioElement] = !struct.at(0).asInstanceOf[Ptr[Ptr[AVIAMFAudioElement]]]
      inline def iamf_audio_element_=(value: Ptr[AVIAMFAudioElement]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[AVIAMFAudioElement]]] = value
      inline def iamf_mix_presentation : Ptr[AVIAMFMixPresentation] = !struct.at(0).asInstanceOf[Ptr[Ptr[AVIAMFMixPresentation]]]
      inline def iamf_mix_presentation_=(value: Ptr[AVIAMFMixPresentation]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[AVIAMFMixPresentation]]] = value
      inline def tile_grid : Ptr[AVStreamGroupTileGrid] = !struct.at(0).asInstanceOf[Ptr[Ptr[AVStreamGroupTileGrid]]]
      inline def tile_grid_=(value: Ptr[AVStreamGroupTileGrid]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[AVStreamGroupTileGrid]]] = value
      inline def lcevc : Ptr[AVStreamGroupLCEVC] = !struct.at(0).asInstanceOf[Ptr[Ptr[AVStreamGroupLCEVC]]]
      inline def lcevc_=(value: Ptr[AVStreamGroupLCEVC]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[AVStreamGroupLCEVC]]] = value
  ...
  */
  ...
  object AVStreamGroupLCEVC:
    given _tag: Tag[AVStreamGroupLCEVC] = Tag.materializeCStruct4Tag[Ptr[Byte], CUnsignedInt, CInt, CInt]
    ...
    private[ffmpeg] object fields:
      extension (struct: AVStreamGroupLCEVC)
        inline def av_class : Ptr[AVClass] = struct._1.asInstanceOf[Ptr[AVClass]]
        inline def av_class_=(value: Ptr[AVClass]): Unit = (!struct.at1 = value.asInstanceOf[Ptr[Byte]])
        inline def lcevc_index : CUnsignedInt = struct._2
        inline def lcevc_index_=(value: CUnsignedInt): Unit = (!struct.at2 = value)
    ...
    def apply()(using Zone): Ptr[AVStreamGroupLCEVC] = scala.scalanative.unsafe.alloc[AVStreamGroupLCEVC](1)
    def apply(av_class : Ptr[AVClass], lcevc_index : CUnsignedInt, width : CInt, height : CInt)(using Zone): Ptr[AVStreamGroupLCEVC] =
      val ____ptr = apply()
      (!____ptr).av_class = av_class
  ...
  */
  opaque type AVStreamGroupTileGrid = CStruct12[Ptr[Byte], CUnsignedInt, CInt, CInt, Ptr[AVStreamGroupTileGrid_Offsets], CArray[uint8_t, Nat._4], CInt, CInt, CInt, CInt, Ptr[AVPacketSideData], CInt]
  
  object AVStreamGroupTileGrid:
    given _tag: Tag[AVStreamGroupTileGrid] = Tag.materializeCStruct12Tag[Ptr[Byte], CUnsignedInt, CInt, CInt, Ptr[AVStreamGroupTileGrid_Offsets], CArray[uint8_t, Nat._4], CInt, CInt, CInt, CInt, Ptr[AVPacketSideData], CInt]
    ...
    private[ffmpeg] object fields:
      extension (struct: AVStreamGroupTileGrid)
        inline def av_class : Ptr[AVClass] = struct._1.asInstanceOf[Ptr[AVClass]]
        inline def av_class_=(value: Ptr[AVClass]): Unit = (!struct.at1 = value.asInstanceOf[Ptr[Byte]])
        inline def nb_tiles : CUnsignedInt = struct._2
        inline def nb_tiles_=(value: CUnsignedInt): Unit = (!struct.at2 = value)
        inline def coded_width : CInt = struct._3
        inline def coded_width_=(value: CInt): Unit = (!struct.at3 = value)
        inline def coded_height : CInt = struct._4
        inline def coded_height_=(value: CInt): Unit = (!struct.at4 = value)
        inline def offsets : Ptr[AVStreamGroupTileGrid_Offsets] = struct._5
        inline def offsets_=(value: Ptr[AVStreamGroupTileGrid_Offsets]): Unit = (!struct.at5 = value)
        inline def background : CArray[uint8_t, Nat._4] = struct._6
        inline def background_=(value: CArray[uint8_t, Nat._4]): Unit = (!struct.at6 = value)
        inline def horizontal_offset : CInt = struct._7
        inline def horizontal_offset_=(value: CInt): Unit = (!struct.at7 = value)
        inline def vertical_offset : CInt = struct._8
        inline def vertical_offset_=(value: CInt): Unit = (!struct.at8 = value)
        inline def width : CInt = struct._9
        inline def width_=(value: CInt): Unit = (!struct.at9 = value)
        inline def height : CInt = struct._10
        inline def height_=(value: CInt): Unit = (!struct.at10 = value)
        inline def coded_side_data : Ptr[AVPacketSideData] = struct._11
        inline def coded_side_data_=(value: Ptr[AVPacketSideData]): Unit = (!struct.at11 = value)
        inline def nb_coded_side_data : CInt = struct._12
        inline def nb_coded_side_data_=(value: CInt): Unit = (!struct.at12 = value)
      end extension
    
    // Allocates AVStreamGroupTileGrid on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVStreamGroupTileGrid] = scala.scalanative.unsafe.alloc[AVStreamGroupTileGrid](1)
    def apply(av_class : Ptr[AVClass], nb_tiles : CUnsignedInt, coded_width : CInt, coded_height : CInt, offsets : Ptr[AVStreamGroupTileGrid_Offsets], background : CArray[uint8_t, Nat._4], horizontal_offset : CInt, vertical_offset : CInt, width : CInt, height : CInt, coded_side_data : Ptr[AVPacketSideData], nb_coded_side_data : CInt)(using Zone): Ptr[AVStreamGroupTileGrid] =
      val ____ptr = apply()
      (!____ptr).av_class = av_class
  ...
  */
  opaque type AVStreamGroupTileGrid_Offsets = CStruct3[CUnsignedInt, CInt, CInt]
  
  object AVStreamGroupTileGrid_Offsets:
    given _tag: Tag[AVStreamGroupTileGrid_Offsets] = Tag.materializeCStruct3Tag[CUnsignedInt, CInt, CInt]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVStreamGroupTileGrid_Offsets)
        inline def idx : CUnsignedInt = struct._1
        inline def idx_=(value: CUnsignedInt): Unit = (!struct.at1 = value)
        inline def horizontal : CInt = struct._2
        inline def horizontal_=(value: CInt): Unit = (!struct.at2 = value)
        inline def vertical : CInt = struct._3
        inline def vertical_=(value: CInt): Unit = (!struct.at3 = value)
      end extension
    
    // Allocates AVStreamGroupTileGrid_Offsets on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVStreamGroupTileGrid_Offsets] = scala.scalanative.unsafe.alloc[AVStreamGroupTileGrid_Offsets](1)
    def apply(idx : CUnsignedInt, horizontal : CInt, vertical : CInt)(using Zone): Ptr[AVStreamGroupTileGrid_Offsets] =
      val ____ptr = apply()
      (!____ptr).idx = idx
  ...
  opaque type AVSubtitle = CStruct6[uint16_t, uint32_t, uint32_t, CUnsignedInt, Ptr[Ptr[AVSubtitleRect]], int64_t]
  
  object AVSubtitle:
    given _tag: Tag[AVSubtitle] = Tag.materializeCStruct6Tag[uint16_t, uint32_t, uint32_t, CUnsignedInt, Ptr[Ptr[AVSubtitleRect]], int64_t]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: AVSubtitle)
        inline def format : uint16_t = struct._1
        inline def format_=(value: uint16_t): Unit = (!struct.at1 = value)
        inline def start_display_time : uint32_t = struct._2
        inline def start_display_time_=(value: uint32_t): Unit = (!struct.at2 = value)
        inline def end_display_time : uint32_t = struct._3
        inline def end_display_time_=(value: uint32_t): Unit = (!struct.at3 = value)
        inline def num_rects : CUnsignedInt = struct._4
        inline def num_rects_=(value: CUnsignedInt): Unit = (!struct.at4 = value)
        inline def rects : Ptr[Ptr[AVSubtitleRect]] = struct._5
        inline def rects_=(value: Ptr[Ptr[AVSubtitleRect]]): Unit = (!struct.at5 = value)
        inline def pts : int64_t = struct._6
        inline def pts_=(value: int64_t): Unit = (!struct.at6 = value)
      end extension
    
    // Allocates AVSubtitle on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVSubtitle] = scala.scalanative.unsafe.alloc[AVSubtitle](1)
    def apply(format : uint16_t, start_display_time : uint32_t, end_display_time : uint32_t, num_rects : CUnsignedInt, rects : Ptr[Ptr[AVSubtitleRect]], pts : int64_t)(using Zone): Ptr[AVSubtitle] =
      val ____ptr = apply()
      (!____ptr).format = format
  ...
  opaque type AVSubtitleRect = CStruct11[CInt, CInt, CInt, CInt, CInt, CArray[Ptr[uint8_t], Nat._4], CArray[CInt, Nat._4], CInt, AVSubtitleType, CString, CString]
  
  object AVSubtitleRect:
    given _tag: Tag[AVSubtitleRect] = Tag.materializeCStruct11Tag[CInt, CInt, CInt, CInt, CInt, CArray[Ptr[uint8_t], Nat._4], CArray[CInt, Nat._4], CInt, AVSubtitleType, CString, CString]
    ...
    private[ffmpeg] object fields:
      extension (struct: AVSubtitleRect)
        ...
        inline def nb_colors : CInt = struct._5
        inline def nb_colors_=(value: CInt): Unit = (!struct.at5 = value)
        inline def data : CArray[Ptr[uint8_t], Nat._4] = struct._6
        inline def data_=(value: CArray[Ptr[uint8_t], Nat._4]): Unit = (!struct.at6 = value)
        inline def linesize : CArray[CInt, Nat._4] = struct._7
        inline def linesize_=(value: CArray[CInt, Nat._4]): Unit = (!struct.at7 = value)
        inline def flags : CInt = struct._8
        inline def flags_=(value: CInt): Unit = (!struct.at8 = value)
        inline def `type` : AVSubtitleType = struct._9
        inline def type_=(value: AVSubtitleType): Unit = (!struct.at9 = value)
        inline def text : CString = struct._10
        inline def text_=(value: CString): Unit = (!struct.at10 = value)
        inline def ass : CString = struct._11
        inline def ass_=(value: CString): Unit = (!struct.at11 = value)
      end extension
    
    // Allocates AVSubtitleRect on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[AVSubtitleRect] = scala.scalanative.unsafe.alloc[AVSubtitleRect](1)
    def apply(x : CInt, y : CInt, w : CInt, h : CInt, nb_colors : CInt, data : CArray[Ptr[uint8_t], Nat._4], linesize : CArray[CInt, Nat._4], flags : CInt, `type` : AVSubtitleType, text : CString, ass : CString)(using Zone): Ptr[AVSubtitleRect] =
      val ____ptr = apply()
      (!____ptr).x = x
      (!____ptr).y = y
      (!____ptr).w = w
  ...
  object RcOverride:
    given _tag: Tag[RcOverride] = Tag.materializeCStruct4Tag[CInt, CInt, CInt, Float]
    
    export fields.*
    private[ffmpeg] object fields:
      extension (struct: RcOverride)
        inline def start_frame : CInt = struct._1
        inline def start_frame_=(value: CInt): Unit = (!struct.at1 = value)
        inline def end_frame : CInt = struct._2
        inline def end_frame_=(value: CInt): Unit = (!struct.at2 = value)
        inline def qscale : CInt = struct._3
        inline def qscale_=(value: CInt): Unit = (!struct.at3 = value)
        inline def quality_factor : Float = struct._4
        inline def quality_factor_=(value: Float): Unit = (!struct.at4 = value)
      end extension
    
    // Allocates RcOverride on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[RcOverride] = scala.scalanative.unsafe.alloc[RcOverride](1)
    def apply(start_frame : CInt, end_frame : CInt, qscale : CInt, quality_factor : Float)(using Zone): Ptr[RcOverride] =
      val ____ptr = apply()
...
object unions:
  ...
  object av_intfloat32:
    given _tag: Tag[av_intfloat32] = Tag.CArray[CChar, Nat._4](Tag.Byte, Tag.Nat4)
    ...
    extension (struct: av_intfloat32)
      inline def i : uint32_t = !struct.at(0).asInstanceOf[Ptr[uint32_t]]
      inline def i_=(value: uint32_t): Unit = !struct.at(0).asInstanceOf[Ptr[uint32_t]] = value
  ...
  object av_intfloat64:
    given _tag: Tag[av_intfloat64] = Tag.CArray[CChar, Nat._8](Tag.Byte, Tag.Nat8)
    ...
    extension (struct: av_intfloat64)
      inline def i : uint64_t = !struct.at(0).asInstanceOf[Ptr[uint64_t]]
      inline def i_=(value: uint64_t): Unit = !struct.at(0).asInstanceOf[Ptr[uint64_t]] = value
      inline def f : Double = !struct.at(0).asInstanceOf[Ptr[Double]]
      inline def f_=(value: Double): Unit = !struct.at(0).asInstanceOf[Ptr[Double]] = value
...
private[ffmpeg] object extern_functions:
  ...
  import _root_.ffmpeg.structs.*
  import _root_.ffmpeg.unions.*
  private[ffmpeg] def __sn_wrap_ffmpeg_av_add_q(b : Ptr[AVRational], c : Ptr[AVRational], __return : Ptr[AVRational]): Unit = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_add_stable(ts_tb : Ptr[AVRational], ts : int64_t, inc_tb : Ptr[AVRational], inc : int64_t): int64_t = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_cmp_q(a : Ptr[AVRational], b : Ptr[AVRational]): CInt = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_compare_ts(ts_a : int64_t, tb_a : Ptr[AVRational], ts_b : int64_t, tb_b : Ptr[AVRational]): CInt = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_d2q(d : Double, max : CInt, __return : Ptr[AVRational]): Unit = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_div_q(b : Ptr[AVRational], c : Ptr[AVRational], __return : Ptr[AVRational]): Unit = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_find_nearest_q_idx(q : Ptr[AVRational], q_list : Ptr[AVRational]): CInt = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_gcd_q(a : Ptr[AVRational], b : Ptr[AVRational], max_den : CInt, `def` : Ptr[AVRational], __return : Ptr[AVRational]): Unit = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_get_time_base_q(__return : Ptr[AVRational]): Unit = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_guess_frame_rate(ctx : Ptr[AVFormatContext], stream : Ptr[AVStream], frame : Ptr[AVFrame], __return : Ptr[AVRational]): Unit = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_guess_sample_aspect_ratio(format : Ptr[AVFormatContext], stream : Ptr[AVStream], frame : Ptr[AVFrame], __return : Ptr[AVRational]): Unit = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_inv_q(q : Ptr[AVRational], __return : Ptr[AVRational]): Unit = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_make_q(num : CInt, den : CInt, __return : Ptr[AVRational]): Unit = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_mul_q(b : Ptr[AVRational], c : Ptr[AVRational], __return : Ptr[AVRational]): Unit = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_nearer_q(q : Ptr[AVRational], q1 : Ptr[AVRational], q2 : Ptr[AVRational]): CInt = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_packet_rescale_ts(pkt : Ptr[AVPacket], tb_src : Ptr[AVRational], tb_dst : Ptr[AVRational]): Unit = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_q2d(a : Ptr[AVRational]): Double = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_q2intfloat(q : Ptr[AVRational]): uint32_t = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_rescale_delta(in_tb : Ptr[AVRational], in_ts : int64_t, fs_tb : Ptr[AVRational], duration : CInt, last : Ptr[int64_t], out_tb : Ptr[AVRational]): int64_t = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_rescale_q(a : int64_t, bq : Ptr[AVRational], cq : Ptr[AVRational]): int64_t = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_rescale_q_rnd(a : int64_t, bq : Ptr[AVRational], cq : Ptr[AVRational], rnd : AVRounding): int64_t = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_stream_get_codec_timebase(st : Ptr[AVStream], __return : Ptr[AVRational]): Unit = extern

  private[ffmpeg] def __sn_wrap_ffmpeg_av_sub_q(b : Ptr[AVRational], c : Ptr[AVRational], __return : Ptr[AVRational]): Unit = extern

  /**
   * Add an index entry into a sorted list. Update the entry if the list already contains it.
  */
  def av_add_index_entry(st : Ptr[AVStream], pos : int64_t, timestamp : int64_t, size : CInt, distance : CInt, flags : CInt): CInt = extern
  ...
  */
  def av_append_packet(s : Ptr[AVIOContext], pkt : Ptr[AVPacket], size : CInt): CInt = extern
  ...
  */
  def av_buffer_create(data : Ptr[uint8_t], size : size_t, free : CFuncPtr2[Ptr[Byte], Ptr[uint8_t], Unit], opaque : Ptr[Byte], flags : CInt): Ptr[AVBufferRef] = extern
  ...
  */
  def av_buffer_default_free(opaque : Ptr[Byte], data : Ptr[uint8_t]): Unit = extern
  ...
  */
  def av_buffer_pool_buffer_get_opaque(ref : Ptr[AVBufferRef]): Ptr[Byte] = extern
  ...
  */
  def av_buffer_pool_init(size : size_t, alloc : CFuncPtr1[size_t, Ptr[AVBufferRef]]): Ptr[AVBufferPool] = extern

  /**
   * Allocate and initialize a buffer pool with a more complex allocator.
  */
  def av_buffer_pool_init2(size : size_t, opaque : Ptr[Byte], alloc : CFuncPtr2[Ptr[Byte], size_t, Ptr[AVBufferRef]], pool_free : CFuncPtr1[Ptr[Byte], Unit]): Ptr[AVBufferPool] = extern
  ...
  */
  def av_buffer_replace(dst : Ptr[Ptr[AVBufferRef]], src : Ptr[AVBufferRef]): CInt = extern
  ...
  */
  def av_channel_description(buf : CString, buf_size : size_t, channel : AVChannel): CInt = extern

  /**
   * bprint variant of av_channel_description().
  */
  def av_channel_description_bprint(bp : Ptr[AVBPrint], channel_id : AVChannel): Unit = extern
  ...
  */
  def av_channel_layout_ambisonic_order(channel_layout : Ptr[AVChannelLayout]): CInt = extern

  /**
   * Get the channel with the given index in a channel layout.
  */
  def av_channel_layout_channel_from_index(channel_layout : Ptr[AVChannelLayout], idx : CUnsignedInt): AVChannel = extern

  /**
   * Get a channel described by the given string.
  */
  def av_channel_layout_channel_from_string(channel_layout : Ptr[AVChannelLayout], name : CString): AVChannel = extern

  /**
   * Check whether a channel layout is valid, i.e. can possibly describe audio data.
  */
  def av_channel_layout_check(channel_layout : Ptr[AVChannelLayout]): CInt = extern
  ...
  */
  def av_channel_layout_compare(chl : Ptr[AVChannelLayout], chl1 : Ptr[AVChannelLayout]): CInt = extern
  ...
  */
  def av_channel_layout_copy(dst : Ptr[AVChannelLayout], src : Ptr[AVChannelLayout]): CInt = extern
  ...
  */
  def av_channel_layout_custom_init(channel_layout : Ptr[AVChannelLayout], nb_channels : CInt): CInt = extern

  /**
   * Get the default channel layout for a given number of channels.
  */
  def av_channel_layout_default(ch_layout : Ptr[AVChannelLayout], nb_channels : CInt): Unit = extern
  ...
  */
  def av_channel_layout_describe(channel_layout : Ptr[AVChannelLayout], buf : CString, buf_size : size_t): CInt = extern

  /**
   * bprint variant of av_channel_layout_describe().
  */
  def av_channel_layout_describe_bprint(channel_layout : Ptr[AVChannelLayout], bp : Ptr[AVBPrint]): CInt = extern

  /**
   * Initialize a native channel layout from a bitmask indicating which channels are present.
  */
  def av_channel_layout_from_mask(channel_layout : Ptr[AVChannelLayout], mask : uint64_t): CInt = extern
  ...
  */
  def av_channel_layout_from_string(channel_layout : Ptr[AVChannelLayout], str : CString): CInt = extern
  ...
  */
  def av_channel_layout_index_from_channel(channel_layout : Ptr[AVChannelLayout], channel : AVChannel): CInt = extern
  ...
  */
  def av_channel_layout_index_from_string(channel_layout : Ptr[AVChannelLayout], name : CString): CInt = extern

  /**
   * Change the AVChannelOrder of a channel layout.
  */
  def av_channel_layout_retype(channel_layout : Ptr[AVChannelLayout], order : AVChannelOrder, flags : CInt): CInt = extern

  /**
   * Iterate over all standard channel layouts.
  */
  def av_channel_layout_standard(opaque : Ptr[Ptr[Byte]]): Ptr[AVChannelLayout] = extern

  /**
   * Find out what channels from a given set are present in a channel layout, without regard for their positions.
  */
  def av_channel_layout_subset(channel_layout : Ptr[AVChannelLayout], mask : uint64_t): uint64_t = extern

  /**
   * Free any allocated data in the channel layout and reset the channel count to 0.
  */
  def av_channel_layout_uninit(channel_layout : Ptr[AVChannelLayout]): Unit = extern
  ...
  */
  def av_channel_name(buf : CString, buf_size : size_t, channel : AVChannel): CInt = extern

  /**
   * bprint variant of av_channel_name().
  */
  def av_channel_name_bprint(bp : Ptr[AVBPrint], channel_id : AVChannel): Unit = extern
  ...
  */
  def av_codec_get_id(tags : Ptr[Ptr[AVCodecTag]], tag : CUnsignedInt): AVCodecID = extern

  /**
   * Get the codec tag for the given codec id id. If no codec tag is found returns 0.
  */
  def av_codec_get_tag(tags : Ptr[Ptr[AVCodecTag]], id : AVCodecID): CUnsignedInt = extern

  /**
   * Get the codec tag for the given codec id.
  */
  def av_codec_get_tag2(tags : Ptr[Ptr[AVCodecTag]], id : AVCodecID, tag : Ptr[CUnsignedInt]): CInt = extern
  ...
  */
  def av_container_fifo_alloc_avpacket(flags : CUnsignedInt): Ptr[AVContainerFifo] = extern
  ...
  */
  def av_dict_copy(dst : Ptr[Ptr[AVDictionary]], src : Ptr[AVDictionary], flags : CInt): CInt = extern
  ...
  */
  def av_dict_get(m : Ptr[AVDictionary], key : CString, prev : Ptr[AVDictionaryEntry], flags : CInt): Ptr[AVDictionaryEntry] = extern

  /**
   * Get dictionary entries as a string.
  */
  def av_dict_get_string(m : Ptr[AVDictionary], buffer : Ptr[CString], key_val_sep : CChar, pairs_sep : CChar): CInt = extern

  /**
   * Iterate over a dictionary
  */
  def av_dict_iterate(m : Ptr[AVDictionary], prev : Ptr[AVDictionaryEntry]): Ptr[AVDictionaryEntry] = extern

  /**
   * Parse the key/value pairs list and add the parsed entries to a dictionary.
  */
  def av_dict_parse_string(pm : Ptr[Ptr[AVDictionary]], str : CString, key_val_sep : CString, pairs_sep : CString, flags : CInt): CInt = extern

  /**
   * Set the given entry in *pm, overwriting an existing entry.
  */
  def av_dict_set(pm : Ptr[Ptr[AVDictionary]], key : CString, value : CString, flags : CInt): CInt = extern

  /**
   * Convenience wrapper for av_dict_set() that converts the value to a string and stores it.
  */
  def av_dict_set_int(pm : Ptr[Ptr[AVDictionary]], key : CString, value : int64_t, flags : CInt): CInt = extern
  ...
  */
  def av_dump_format(ic : Ptr[AVFormatContext], index : CInt, url : CString, is_output : CInt): Unit = extern

  /**
   * Add an element of size `elem_size` to a dynamic array.
  */
  def av_dynarray2_add(tab_ptr : Ptr[Ptr[Byte]], nb_ptr : Ptr[CInt], elem_size : size_t, elem_data : Ptr[uint8_t]): Ptr[Byte] = extern

  /**
   * Add the pointer to an element to a dynamic array.
  */
  def av_dynarray_add(tab_ptr : Ptr[Byte], nb_ptr : Ptr[CInt], elem : Ptr[Byte]): Unit = extern

  /**
   * Add an element to a dynamic array.
  */
  def av_dynarray_add_nofree(tab_ptr : Ptr[Byte], nb_ptr : Ptr[CInt], elem : Ptr[Byte]): CInt = extern

  /**
   * Allocate a buffer, reusing the given one if large enough.
  */
  def av_fast_malloc(ptr : Ptr[Byte], size : Ptr[CUnsignedInt], min_size : size_t): Unit = extern

  /**
   * Allocate and clear a buffer, reusing the given one if large enough.
  */
  def av_fast_mallocz(ptr : Ptr[Byte], size : Ptr[CUnsignedInt], min_size : size_t): Unit = extern
  ...
  */
  def av_fast_padded_malloc(ptr : Ptr[Byte], size : Ptr[CUnsignedInt], min_size : size_t): Unit = extern

  /**
   * Same behaviour av_fast_padded_malloc except that buffer will always be 0-initialized after call.
  */
  def av_fast_padded_mallocz(ptr : Ptr[Byte], size : Ptr[CUnsignedInt], min_size : size_t): Unit = extern

  /**
   * Reallocate the given buffer if it is not large enough, otherwise do nothing.
  */
  def av_fast_realloc(ptr : Ptr[Byte], size : Ptr[CUnsignedInt], min_size : size_t): Ptr[Byte] = extern
  ...
  */
  def av_find_best_stream(ic : Ptr[AVFormatContext], `type` : AVMediaType, wanted_stream_nb : CInt, related_stream : CInt, decoder_ret : Ptr[Ptr[AVCodec]], flags : CInt): CInt = extern
  ...
  */
  def av_find_program_from_stream(ic : Ptr[AVFormatContext], last : Ptr[AVProgram], s : CInt): Ptr[AVProgram] = extern
  ...
  */
  def av_frame_get_plane_buffer(frame : Ptr[AVFrame], plane : CInt): Ptr[AVBufferRef] = extern

  /**
   * Returns a pointer to the side data of a given type on success, NULL if there is no side data with such type in this frame.
  */
  def av_frame_get_side_data(frame : Ptr[AVFrame], `type` : AVFrameSideDataType): Ptr[AVFrameSideData] = extern
  ...
  */
  def av_frame_new_side_data(frame : Ptr[AVFrame], `type` : AVFrameSideDataType, size : size_t): Ptr[AVFrameSideData] = extern

  /**
   * Add a new side data to a frame from an existing AVBufferRef
  */
  def av_frame_new_side_data_from_buf(frame : Ptr[AVFrame], `type` : AVFrameSideDataType, buf : Ptr[AVBufferRef]): Ptr[AVFrameSideData] = extern
  ...
  */
  def av_frame_remove_side_data(frame : Ptr[AVFrame], `type` : AVFrameSideDataType): Unit = extern
  ...
  */
  def av_frame_side_data_add(sd : Ptr[Ptr[Ptr[AVFrameSideData]]], nb_sd : Ptr[CInt], `type` : AVFrameSideDataType, buf : Ptr[Ptr[AVBufferRef]], flags : CUnsignedInt): Ptr[AVFrameSideData] = extern

  /**
   * Add a new side data entry to an array based on existing side data, taking a reference towards the contained AVBufferRef.
  */
  def av_frame_side_data_clone(sd : Ptr[Ptr[Ptr[AVFrameSideData]]], nb_sd : Ptr[CInt], src : Ptr[AVFrameSideData], flags : CUnsignedInt): CInt = extern

  /**
   * Returns side data descriptor corresponding to a given side data type, NULL when not available.
  */
  def av_frame_side_data_desc(`type` : AVFrameSideDataType): Ptr[AVSideDataDescriptor] = extern

  /**
   * Free all side data entries and their contents, then zeroes out the values which the pointers are pointing to.
  */
  def av_frame_side_data_free(sd : Ptr[Ptr[Ptr[AVFrameSideData]]], nb_sd : Ptr[CInt]): Unit = extern
  ...
  */
  def av_frame_side_data_get(sd : Ptr[Ptr[AVFrameSideData]], nb_sd : CInt, `type` : AVFrameSideDataType): Ptr[AVFrameSideData] = extern

  /**
   * Get a side data entry of a specific type from an array.
  */
  def av_frame_side_data_get_c(sd : Ptr[Ptr[AVFrameSideData]], nb_sd : CInt, `type` : AVFrameSideDataType): Ptr[AVFrameSideData] = extern
  ...
  */
  def av_frame_side_data_new(sd : Ptr[Ptr[Ptr[AVFrameSideData]]], nb_sd : Ptr[CInt], `type` : AVFrameSideDataType, size : size_t, flags : CUnsignedInt): Ptr[AVFrameSideData] = extern

  /**
   * Remove and free all side data instances of the given type from an array.
  */
  def av_frame_side_data_remove(sd : Ptr[Ptr[Ptr[AVFrameSideData]]], nb_sd : Ptr[CInt], `type` : AVFrameSideDataType): Unit = extern

  /**
   * Remove and free all side data instances that match any of the given side data properties. (See enum AVSideDataProps)
  */
  def av_frame_side_data_remove_by_props(sd : Ptr[Ptr[Ptr[AVFrameSideData]]], nb_sd : Ptr[CInt], props : CInt): Unit = extern
  ...
  */
  def av_get_alt_sample_fmt(sample_fmt : AVSampleFormat, planar : CInt): AVSampleFormat = extern

  /**
   * Return audio frame duration.
  */
  def av_get_audio_frame_duration(avctx : Ptr[AVCodecContext], frame_bytes : CInt): CInt = extern
  ...
  */
  def av_get_audio_frame_duration2(par : Ptr[AVCodecParameters], frame_bytes : CInt): CInt = extern
  ...
  */
  ...
  def av_get_frame_filename(buf : CString, buf_size : CInt, path : CString, number : CInt): CInt = extern

  /**
   * Return in 'buf' the path with '%d' replaced by a number.
  */
  def av_get_frame_filename2(buf : CString, buf_size : CInt, path : CString, number : CInt, flags : CInt): CInt = extern
  ...
  */
  def av_get_output_timestamp(s : Ptr[AVFormatContext], stream : CInt, dts : Ptr[int64_t], wall : Ptr[int64_t]): CInt = extern

  /**
   * Get the packed alternative form of the given sample format.
  */
  def av_get_packed_sample_fmt(sample_fmt : AVSampleFormat): AVSampleFormat = extern

  /**
   * Allocate and read the payload of a packet and initialize its fields with default values.
  */
  def av_get_packet(s : Ptr[AVIOContext], pkt : Ptr[AVPacket], size : CInt): CInt = extern
  ...
  */
  def av_get_planar_sample_fmt(sample_fmt : AVSampleFormat): AVSampleFormat = extern
  ...
  */
  def av_get_sample_fmt_string(buf : CString, buf_size : CInt, sample_fmt : AVSampleFormat): CString = extern
  ...
  */
  def av_guess_codec(fmt : Ptr[AVOutputFormat], short_name : CString, filename : CString, mime_type : CString, `type` : AVMediaType): AVCodecID = extern

  /**
   * Return the output format in the list of registered output formats which best matches the provided parameters, or return NULL if there is no match.
  */
  def av_guess_format(short_name : CString, filename : CString, mime_type : CString): Ptr[AVOutputFormat] = extern
  ...
  */
  def av_hex_dump_log(avcl : Ptr[Byte], level : CInt, buf : Ptr[uint8_t], size : CInt): Unit = extern
  ...
  */
  def av_hwdevice_ctx_create(device_ctx : Ptr[Ptr[AVBufferRef]], `type` : AVHWDeviceType, device : CString, opts : Ptr[AVDictionary], flags : CInt): CInt = extern

  /**
   * Create a new device of the specified type from an existing device.
  */
  def av_hwdevice_ctx_create_derived(dst_ctx : Ptr[Ptr[AVBufferRef]], `type` : AVHWDeviceType, src_ctx : Ptr[AVBufferRef], flags : CInt): CInt = extern

  /**
   * Create a new device of the specified type from an existing device.
  */
  def av_hwdevice_ctx_create_derived_opts(dst_ctx : Ptr[Ptr[AVBufferRef]], `type` : AVHWDeviceType, src_ctx : Ptr[AVBufferRef], options : Ptr[AVDictionary], flags : CInt): CInt = extern
  ...
  */
  def av_hwdevice_get_hwframe_constraints(ref : Ptr[AVBufferRef], hwconfig : Ptr[Byte]): Ptr[AVHWFramesConstraints] = extern
  ...
  */
  def av_hwdevice_hwconfig_alloc(device_ctx : Ptr[AVBufferRef]): Ptr[Byte] = extern
  ...
  */
  def av_hwframe_constraints_free(constraints : Ptr[Ptr[AVHWFramesConstraints]]): Unit = extern

  /**
   * Allocate an AVHWFramesContext tied to a given device context.
  */
  def av_hwframe_ctx_alloc(device_ctx : Ptr[AVBufferRef]): Ptr[AVBufferRef] = extern

  /**
   * Create and initialise an AVHWFramesContext as a mapping of another existing AVHWFramesContext on a different device.
  */
  def av_hwframe_ctx_create_derived(derived_frame_ctx : Ptr[Ptr[AVBufferRef]], format : AVPixelFormat, derived_device_ctx : Ptr[AVBufferRef], source_frame_ctx : Ptr[AVBufferRef], flags : CInt): CInt = extern
  ...
  */
  def av_hwframe_get_buffer(hwframe_ctx : Ptr[AVBufferRef], frame : Ptr[AVFrame], flags : CInt): CInt = extern

  /**
   * Map a hardware frame.
  */
  def av_hwframe_map(dst : Ptr[AVFrame], src : Ptr[AVFrame], flags : CInt): CInt = extern

  /**
   * Copy data to or from a hw surface. At least one of dst/src must have an AVHWFramesContext attached.
  */
  def av_hwframe_transfer_data(dst : Ptr[AVFrame], src : Ptr[AVFrame], flags : CInt): CInt = extern

  /**
   * Get a list of possible source or target formats usable in av_hwframe_transfer_data().
  */
  def av_hwframe_transfer_get_formats(hwframe_ctx : Ptr[AVBufferRef], dir : AVHWFrameTransferDirection, formats : Ptr[Ptr[AVPixelFormat]], flags : CInt): CInt = extern

  /**
   * Get the index for a specific timestamp.
  */
  def av_index_search_timestamp(st : Ptr[AVStream], timestamp : int64_t, flags : CInt): CInt = extern
  ...
  */
  def av_int_list_length_for_size(elsize : CUnsignedInt, list : Ptr[Byte], term : uint64_t): CUnsignedInt = extern

  /**
   * Write a packet to an output media file ensuring correct interleaving.
  */
  def av_interleaved_write_frame(s : Ptr[AVFormatContext], pkt : Ptr[AVPacket]): CInt = extern

  /**
   * Write an uncoded frame to an output media file.
  */
  def av_interleaved_write_uncoded_frame(s : Ptr[AVFormatContext], stream_index : CInt, frame : Ptr[AVFrame]): CInt = extern
  ...
  */
  def av_log(avcl : Ptr[Byte], level : CInt, fmt : CString, rest: Any*): Unit = extern
  ...
  */
  def av_log_default_callback(avcl : Ptr[Byte], level : CInt, fmt : CString, vl : va_list): Unit = extern

  /**
   * Format a line of log the same way as the default callback.
  */
  def av_log_format_line(ptr : Ptr[Byte], level : CInt, fmt : CString, vl : va_list, line : CString, line_size : CInt, print_prefix : Ptr[CInt]): Unit = extern

  /**
   * Format a line of log the same way as the default callback.
  */
  def av_log_format_line2(ptr : Ptr[Byte], level : CInt, fmt : CString, vl : va_list, line : CString, line_size : CInt, print_prefix : Ptr[CInt]): CInt = extern
  ...
  */
  def av_log_once(avcl : Ptr[Byte], initial_level : CInt, subsequent_level : CInt, state : Ptr[CInt], fmt : CString, rest: Any*): Unit = extern

  /**
   * Set the logging callback
  */
  def av_log_set_callback(callback : CFuncPtr4[Ptr[Byte], CInt, CString, va_list, Unit]): Unit = extern
  ...
  */
  def av_make_error_string(errbuf : CString, errbuf_size : size_t, errnum : CInt): CString = extern
  ...
  */
  def av_packet_add_side_data(pkt : Ptr[AVPacket], `type` : AVPacketSideDataType, data : Ptr[uint8_t], size : size_t): CInt = extern
  ...
  */
  def av_packet_copy_props(dst : Ptr[AVPacket], src : Ptr[AVPacket]): CInt = extern
  ...
  */
  def av_packet_from_data(pkt : Ptr[AVPacket], data : Ptr[uint8_t], size : CInt): CInt = extern

  /**
   * Get side information from packet.
  */
  def av_packet_get_side_data(pkt : Ptr[AVPacket], `type` : AVPacketSideDataType, size : Ptr[size_t]): Ptr[uint8_t] = extern
  ...
  */
  def av_packet_new_side_data(pkt : Ptr[AVPacket], `type` : AVPacketSideDataType, size : size_t): Ptr[uint8_t] = extern

  /**
   * Pack a dictionary for use in side_data.
  */
  def av_packet_pack_dictionary(dict : Ptr[AVDictionary], size : Ptr[size_t]): Ptr[uint8_t] = extern
  ...
  */
  def av_packet_shrink_side_data(pkt : Ptr[AVPacket], `type` : AVPacketSideDataType, size : size_t): CInt = extern

  /**
   * Wrap existing data as packet side data.
  */
  def av_packet_side_data_add(sd : Ptr[Ptr[AVPacketSideData]], nb_sd : Ptr[CInt], `type` : AVPacketSideDataType, data : Ptr[Byte], size : size_t, flags : CInt): Ptr[AVPacketSideData] = extern

  /**
   * Convenience function to free all the side data stored in an array, and the array itself.
  */
  def av_packet_side_data_free(sd : Ptr[Ptr[AVPacketSideData]], nb_sd : Ptr[CInt]): Unit = extern

  /**
   * Get side information from a side data array.
  */
  def av_packet_side_data_get(sd : Ptr[AVPacketSideData], nb_sd : CInt, `type` : AVPacketSideDataType): Ptr[AVPacketSideData] = extern
  ...
  */
  def av_packet_side_data_new(psd : Ptr[Ptr[AVPacketSideData]], pnb_sd : Ptr[CInt], `type` : AVPacketSideDataType, size : size_t, flags : CInt): Ptr[AVPacketSideData] = extern

  /**
   * Remove side data of the given type from a side data array.
  */
  def av_packet_side_data_remove(sd : Ptr[AVPacketSideData], nb_sd : Ptr[CInt], `type` : AVPacketSideDataType): Unit = extern

  /**
   * Unpack a dictionary from side_data.
  */
  def av_packet_unpack_dictionary(data : Ptr[uint8_t], size : size_t, dict : Ptr[Ptr[AVDictionary]]): CInt = extern
  ...
  */
   ...
   * Parse a packet.
  */
  def av_parser_parse2(s : Ptr[AVCodecParserContext], avctx : Ptr[AVCodecContext], poutbuf : Ptr[Ptr[uint8_t]], poutbuf_size : Ptr[CInt], buf : Ptr[uint8_t], buf_size : CInt, pts : int64_t, dts : int64_t, pos : int64_t): CInt = extern

  /**
   * Send a nice dump of a packet to the specified file stream.
  */
  def av_pkt_dump2(f : Ptr[FILE], pkt : Ptr[AVPacket], dump_payload : CInt, st : Ptr[AVStream]): Unit = extern

  /**
   * Send a nice dump of a packet to the log.
  */
  def av_pkt_dump_log2(avcl : Ptr[Byte], level : CInt, pkt : Ptr[AVPacket], dump_payload : CInt, st : Ptr[AVStream]): Unit = extern
  ...
  */
  def av_probe_input_buffer(pb : Ptr[AVIOContext], fmt : Ptr[Ptr[AVInputFormat]], url : CString, logctx : Ptr[Byte], offset : CUnsignedInt, max_probe_size : CUnsignedInt): CInt = extern
  ...
  */
  def av_probe_input_buffer2(pb : Ptr[AVIOContext], fmt : Ptr[Ptr[AVInputFormat]], url : CString, logctx : Ptr[Byte], offset : CUnsignedInt, max_probe_size : CUnsignedInt): CInt = extern

  /**
   * Guess the file format.
  */
  def av_probe_input_format(pd : Ptr[AVProbeData], is_opened : CInt): Ptr[AVInputFormat] = extern

  /**
   * Guess the file format.
  */
  def av_probe_input_format2(pd : Ptr[AVProbeData], is_opened : CInt, score_max : Ptr[CInt]): Ptr[AVInputFormat] = extern

  /**
   * Guess the file format.
  */
  def av_probe_input_format3(pd : Ptr[AVProbeData], is_opened : CInt, score_ret : Ptr[CInt]): Ptr[AVInputFormat] = extern

  def av_program_add_stream_index(ac : Ptr[AVFormatContext], progid : CInt, idx : CUnsignedInt): Unit = extern
  ...
  */
  def av_realloc_array(ptr : Ptr[Byte], nmemb : size_t, size : size_t): Ptr[Byte] = extern

  /**
   * Allocate, reallocate, or free a block of memory.
  */
  def av_realloc_f(ptr : Ptr[Byte], nelem : size_t, elsize : size_t): Ptr[Byte] = extern
  ...
  */
  def av_reallocp_array(ptr : Ptr[Byte], nmemb : size_t, size : size_t): CInt = extern

  /**
   * Reduce a fraction.
  */
  def av_reduce(dst_num : Ptr[CInt], dst_den : Ptr[CInt], num : int64_t, den : int64_t, max : int64_t): CInt = extern
  ...
  */
  def av_rescale_rnd(a : int64_t, b : int64_t, c : int64_t, rnd : AVRounding): int64_t = extern
  ...
  */
  def av_samples_alloc(audio_data : Ptr[Ptr[uint8_t]], linesize : Ptr[CInt], nb_channels : CInt, nb_samples : CInt, sample_fmt : AVSampleFormat, align : CInt): CInt = extern

  /**
   * Allocate a data pointers array, samples buffer for nb_samples samples, and fill data pointers and linesize accordingly.
  */
  def av_samples_alloc_array_and_samples(audio_data : Ptr[Ptr[Ptr[uint8_t]]], linesize : Ptr[CInt], nb_channels : CInt, nb_samples : CInt, sample_fmt : AVSampleFormat, align : CInt): CInt = extern

  /**
   * Copy samples from src to dst.
  */
  def av_samples_copy(dst : Ptr[Ptr[uint8_t]], src : Ptr[Ptr[uint8_t]], dst_offset : CInt, src_offset : CInt, nb_samples : CInt, nb_channels : CInt, sample_fmt : AVSampleFormat): CInt = extern

  /**
   * Fill plane data pointers and linesize for samples with sample format sample_fmt.
  */
  def av_samples_fill_arrays(audio_data : Ptr[Ptr[uint8_t]], linesize : Ptr[CInt], buf : Ptr[uint8_t], nb_channels : CInt, nb_samples : CInt, sample_fmt : AVSampleFormat, align : CInt): CInt = extern

  /**
   * Get the required buffer size for the given audio parameters.
  */
  def av_samples_get_buffer_size(linesize : Ptr[CInt], nb_channels : CInt, nb_samples : CInt, sample_fmt : AVSampleFormat, align : CInt): CInt = extern

  /**
   * Fill an audio buffer with silence.
  */
  def av_samples_set_silence(audio_data : Ptr[Ptr[uint8_t]], offset : CInt, nb_samples : CInt, nb_channels : CInt, sample_fmt : AVSampleFormat): CInt = extern
  ...
  */
  def av_sdp_create(ac : Ptr[Ptr[AVFormatContext]], n_files : CInt, buf : CString, size : CInt): CInt = extern

  /**
   * Seek to the keyframe at timestamp. 'timestamp' in 'stream_index'.
  */
  def av_seek_frame(s : Ptr[AVFormatContext], stream_index : CInt, timestamp : int64_t, flags : CInt): CInt = extern
  ...
  */
  def av_strerror(errnum : CInt, errbuf : CString, errbuf_size : size_t): CInt = extern
  ...
  */
  def av_url_split(proto : CString, proto_size : CInt, authorization : CString, authorization_size : CInt, hostname : CString, hostname_size : CInt, port_ptr : Ptr[CInt], path : CString, path_size : CInt, url : CString): Unit = extern
  ...
  */
   ...
   * Send the specified message to the log if the level is less than or equal to the current av_log_level. By default, all logging messages are sent to stderr. This behavior can be altered by setting a different logging callback function.
  */
  def av_vlog(avcl : Ptr[Byte], level : CInt, fmt : CString, vl : va_list): Unit = extern
  ...
  */
   ...
   * Write an uncoded frame to an output media file.
  */
  def av_write_uncoded_frame(s : Ptr[AVFormatContext], stream_index : CInt, frame : Ptr[AVFrame]): CInt = extern

  /**
   * Test whether a muxer supports uncoded frame.
  */
  def av_write_uncoded_frame_query(s : Ptr[AVFormatContext], stream_index : CInt): CInt = extern
  ...
  */
  def av_xiphlacing(s : Ptr[CUnsignedChar], v : CUnsignedInt): CUnsignedInt = extern
  ...
  */
  def avcodec_align_dimensions(s : Ptr[AVCodecContext], width : Ptr[CInt], height : Ptr[CInt]): Unit = extern

  /**
   * Modify width and height values so that they will result in a memory buffer that is acceptable for the codec if you also ensure that all line sizes are a multiple of the respective linesize_align[i].
  */
  def avcodec_align_dimensions2(s : Ptr[AVCodecContext], width : Ptr[CInt], height : Ptr[CInt], linesize_align : CArray[CInt, Nat._8]): Unit = extern
  ...
  */
  def avcodec_decode_subtitle2(avctx : Ptr[AVCodecContext], sub : Ptr[AVSubtitle], got_sub_ptr : Ptr[CInt], avpkt : Ptr[AVPacket]): CInt = extern

  def avcodec_default_execute(c : Ptr[AVCodecContext], func : CFuncPtr2[Ptr[AVCodecContext], Ptr[Byte], CInt], arg : Ptr[Byte], ret : Ptr[CInt], count : CInt, size : CInt): CInt = extern

  def avcodec_default_execute2(c : Ptr[AVCodecContext], func : CFuncPtr4[Ptr[AVCodecContext], Ptr[Byte], CInt, CInt, CInt], arg : Ptr[Byte], ret : Ptr[CInt], count : CInt): CInt = extern
  ...
  */
  def avcodec_default_get_buffer2(s : Ptr[AVCodecContext], frame : Ptr[AVFrame], flags : CInt): CInt = extern
  ...
  */
  def avcodec_default_get_encode_buffer(s : Ptr[AVCodecContext], pkt : Ptr[AVPacket], flags : CInt): CInt = extern

  def avcodec_default_get_format(s : Ptr[AVCodecContext], fmt : Ptr[AVPixelFormat]): AVPixelFormat = extern
  ...
  */
  def avcodec_descriptor_get_by_name(name : CString): Ptr[AVCodecDescriptor] = extern

  /**
   * Iterate over all codec descriptors known to libavcodec.
  */
  def avcodec_descriptor_next(prev : Ptr[AVCodecDescriptor]): Ptr[AVCodecDescriptor] = extern

  /**
   * @{
  */
  def avcodec_encode_subtitle(avctx : Ptr[AVCodecContext], buf : Ptr[uint8_t], buf_size : CInt, sub : Ptr[AVSubtitle]): CInt = extern

  /**
   * Fill AVFrame audio data and linesize pointers.
  */
  def avcodec_fill_audio_frame(frame : Ptr[AVFrame], nb_channels : CInt, sample_fmt : AVSampleFormat, buf : Ptr[uint8_t], buf_size : CInt, align : CInt): CInt = extern
  ...
  */
  def avcodec_find_best_pix_fmt_of_list(pix_fmt_list : Ptr[AVPixelFormat], src_pix_fmt : AVPixelFormat, has_alpha : CInt, loss_ptr : Ptr[CInt]): AVPixelFormat = extern
  ...
  */
  def avcodec_get_hw_config(codec : Ptr[AVCodec], index : CInt): Ptr[AVCodecHWConfig] = extern
  ...
  */
  def avcodec_get_hw_frames_parameters(avctx : Ptr[AVCodecContext], device_ref : Ptr[AVBufferRef], hw_pix_fmt : AVPixelFormat, out_frames_ref : Ptr[Ptr[AVBufferRef]]): CInt = extern
  ...
  */
  def avcodec_get_supported_config(avctx : Ptr[AVCodecContext], codec : Ptr[AVCodec], config : AVCodecConfig, flags : CUnsignedInt, out_configs : Ptr[Ptr[Byte]], out_num_configs : Ptr[CInt]): CInt = extern
  ...
  */
  def avcodec_open2(avctx : Ptr[AVCodecContext], codec : Ptr[AVCodec], options : Ptr[Ptr[AVDictionary]]): CInt = extern
  ...
  */
  def avcodec_parameters_copy(dst : Ptr[AVCodecParameters], src : Ptr[AVCodecParameters]): CInt = extern
  ...
  */
  def avcodec_parameters_from_context(par : Ptr[AVCodecParameters], codec : Ptr[AVCodecContext]): CInt = extern
  ...
  */
  def avcodec_parameters_to_context(codec : Ptr[AVCodecContext], par : Ptr[AVCodecParameters]): CInt = extern

  /**
   * Return a value representing the fourCC code associated to the pixel format pix_fmt, or 0 if no associated fourCC code can be found.
  */
  def avcodec_pix_fmt_to_codec_tag(pix_fmt : AVPixelFormat): CUnsignedInt = extern
  ...
  */
  def avcodec_receive_frame(avctx : Ptr[AVCodecContext], frame : Ptr[AVFrame]): CInt = extern

  /**
   * Read encoded data from the encoder.
  */
  def avcodec_receive_packet(avctx : Ptr[AVCodecContext], avpkt : Ptr[AVPacket]): CInt = extern

  /**
   * Supply a raw video or audio frame to the encoder. Use avcodec_receive_packet() to retrieve buffered output packets.
  */
  def avcodec_send_frame(avctx : Ptr[AVCodecContext], frame : Ptr[AVFrame]): CInt = extern

  /**
   * Supply raw packet data as input to a decoder.
  */
  def avcodec_send_packet(avctx : Ptr[AVCodecContext], avpkt : Ptr[AVPacket]): CInt = extern

  /**
   * @}
  */
  def avcodec_string(buf : CString, buf_size : CInt, enc : Ptr[AVCodecContext], encode : CInt): Unit = extern
  ...
  */
  def avformat_alloc_output_context2(ctx : Ptr[Ptr[AVFormatContext]], oformat : Ptr[AVOutputFormat], format_name : CString, filename : CString): CInt = extern
  ...
  */
  def avformat_find_stream_info(ic : Ptr[AVFormatContext], options : Ptr[Ptr[AVDictionary]]): CInt = extern
  ...
  */
  def avformat_index_get_entry(st : Ptr[AVStream], idx : CInt): Ptr[AVIndexEntry] = extern

  /**
   * Get the AVIndexEntry corresponding to the given timestamp.
  */
  def avformat_index_get_entry_from_timestamp(st : Ptr[AVStream], wanted_timestamp : int64_t, flags : CInt): Ptr[AVIndexEntry] = extern
  ...
  */
  def avformat_init_output(s : Ptr[AVFormatContext], options : Ptr[Ptr[AVDictionary]]): CInt = extern
  ...
  */
  def avformat_match_stream_specifier(s : Ptr[AVFormatContext], st : Ptr[AVStream], spec : CString): CInt = extern
  ...
  */
  def avformat_new_stream(s : Ptr[AVFormatContext], c : Ptr[AVCodec]): Ptr[AVStream] = extern

  /**
   * Open an input stream and read the header. The codecs are not opened. The stream must be closed with avformat_close_input().
  */
  def avformat_open_input(ps : Ptr[Ptr[AVFormatContext]], url : CString, fmt : Ptr[AVInputFormat], options : Ptr[Ptr[AVDictionary]]): CInt = extern

  /**
   * Test if the given container can store a codec.
  */
  def avformat_query_codec(ofmt : Ptr[AVOutputFormat], codec_id : AVCodecID, std_compliance : CInt): CInt = extern
  ...
  */
  def avformat_seek_file(s : Ptr[AVFormatContext], stream_index : CInt, min_ts : int64_t, ts : int64_t, max_ts : int64_t, flags : CInt): CInt = extern

  /**
   * Add an already allocated stream to a stream group.
  */
  def avformat_stream_group_add_stream(stg : Ptr[AVStreamGroup], st : Ptr[AVStream]): CInt = extern

  /**
   * Add a new empty stream group to a media file.
  */
  def avformat_stream_group_create(s : Ptr[AVFormatContext], `type` : AVStreamGroupParamsType, options : Ptr[Ptr[AVDictionary]]): Ptr[AVStreamGroup] = extern

  /**
   * Returns a string identifying the stream group type, or NULL if unknown
  */
  def avformat_stream_group_name(`type` : AVStreamGroupParamsType): CString = extern

  def avformat_transfer_internal_stream_timing_info(ofmt : Ptr[AVOutputFormat], ost : Ptr[AVStream], ist : Ptr[AVStream], copy_tb : AVTimebaseSource): CInt = extern
  ...
  */
  def avformat_write_header(s : Ptr[AVFormatContext], options : Ptr[Ptr[AVDictionary]]): CInt = extern
  ...
  */
  def avio_alloc_context(buffer : Ptr[CUnsignedChar], buffer_size : CInt, write_flag : CInt, opaque : Ptr[Byte], read_packet : CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt], write_packet : CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt], seek : CFuncPtr3[Ptr[Byte], int64_t, CInt, int64_t]): Ptr[AVIOContext] = extern
  ...
  */
  def avio_close_dyn_buf(s : Ptr[AVIOContext], pbuffer : Ptr[Ptr[uint8_t]]): CInt = extern
  ...
  */
  def avio_enum_protocols(opaque : Ptr[Ptr[Byte]], output : CInt): CString = extern
  ...
  */
  def avio_get_dyn_buf(s : Ptr[AVIOContext], pbuffer : Ptr[Ptr[uint8_t]]): CInt = extern
  ...
  */
  def avio_get_str(pb : Ptr[AVIOContext], maxlen : CInt, buf : CString, buflen : CInt): CInt = extern

  def avio_get_str16be(pb : Ptr[AVIOContext], maxlen : CInt, buf : CString, buflen : CInt): CInt = extern
  ...
  */
  def avio_get_str16le(pb : Ptr[AVIOContext], maxlen : CInt, buf : CString, buflen : CInt): CInt = extern
  ...
  */
  def avio_open(s : Ptr[Ptr[AVIOContext]], url : CString, flags : CInt): CInt = extern

  /**
   * Create and initialize a AVIOContext for accessing the resource indicated by url.
  */
  def avio_open2(s : Ptr[Ptr[AVIOContext]], url : CString, flags : CInt, int_cb : Ptr[AVIOInterruptCB], options : Ptr[Ptr[AVDictionary]]): CInt = extern

  /**
   * Open directory for reading.
  */
  def avio_open_dir(s : Ptr[Ptr[AVIODirContext]], url : CString, options : Ptr[Ptr[AVDictionary]]): CInt = extern
  ...
  */
  def avio_print_string_array(s : Ptr[AVIOContext], strings : Ptr[CString]): Unit = extern
  ...
  */
  def avio_read(s : Ptr[AVIOContext], buf : Ptr[CUnsignedChar], size : CInt): CInt = extern

  /**
   * Get next directory entry.
  */
  def avio_read_dir(s : Ptr[AVIODirContext], next : Ptr[Ptr[AVIODirEntry]]): CInt = extern
  ...
  */
  def avio_read_partial(s : Ptr[AVIOContext], buf : Ptr[CUnsignedChar], size : CInt): CInt = extern

  /**
   * Read contents of h into print buffer, up to max_size bytes, or up to EOF.
  */
  def avio_read_to_bprint(h : Ptr[AVIOContext], pb : Ptr[AVBPrint], max_size : size_t): CInt = extern
  ...
  */
  def avio_seek(s : Ptr[AVIOContext], offset : int64_t, whence : CInt): int64_t = extern
  ...
  */
  def avio_seek_time(h : Ptr[AVIOContext], stream_index : CInt, timestamp : int64_t, flags : CInt): int64_t = extern
  ...
  */
  def avio_vprintf(s : Ptr[AVIOContext], fmt : CString, ap : va_list): CInt = extern
  ...
  def avio_write(s : Ptr[AVIOContext], buf : Ptr[CUnsignedChar], size : CInt): Unit = extern

  /**
   * Mark the written bytestream as a specific type.
  */
  def avio_write_marker(s : Ptr[AVIOContext], time : int64_t, `type` : AVIODataMarkerType): Unit = extern
...
object functions:
  ...
  */
  def av_add_stable(ts_tb : Ptr[AVRational], ts : int64_t, inc_tb : Ptr[AVRational], inc : int64_t): int64_t =
    __sn_wrap_ffmpeg_av_add_stable(ts_tb, ts, inc_tb, inc)

  /**
   * Add a value to a timestamp.
  */
  def av_add_stable(ts_tb : AVRational, ts : int64_t, inc_tb : AVRational, inc : int64_t)(using Zone): int64_t =
  ...
  */
  def av_div_q(b : Ptr[AVRational], c : Ptr[AVRational])(__return : Ptr[AVRational]): Unit =
  ...
  */
   ...
   * Return the best rational so that a and b are multiple of it. If the resulting denominator is larger than max_den, return def.
  */
  def av_gcd_q(a : Ptr[AVRational], b : Ptr[AVRational], max_den : CInt, `def` : Ptr[AVRational])(using Zone): AVRational =
    val __ptr_0: Ptr[AVRational] = _root_.scala.scalanative.unsafe.alloc[AVRational](1)
   ...
   * Return the best rational so that a and b are multiple of it. If the resulting denominator is larger than max_den, return def.
  */
  def av_gcd_q(a : AVRational, b : AVRational, max_den : CInt, `def` : AVRational)(using Zone): AVRational =
    val __ptr_0: Ptr[AVRational] = _root_.scala.scalanative.unsafe.alloc[AVRational](4)
    !(__ptr_0 + 0) = a
    !(__ptr_0 + 1) = b
    !(__ptr_0 + 2) = `def`
    __sn_wrap_ffmpeg_av_gcd_q((__ptr_0 + 0), (__ptr_0 + 1), max_den, (__ptr_0 + 2), (__ptr_0 + 3))
    !(__ptr_0 + 3)
  ...
  */
  def av_guess_sample_aspect_ratio(format : Ptr[AVFormatContext], stream : Ptr[AVStream], frame : Ptr[AVFrame])(using Zone): AVRational =
    val __ptr_0: Ptr[AVRational] = _root_.scala.scalanative.unsafe.alloc[AVRational](1)
    __sn_wrap_ffmpeg_av_guess_sample_aspect_ratio(format, stream, frame, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  /**
   * Guess the sample aspect ratio of a frame, based on both the stream and the frame aspect ratio.
  */
  def av_guess_sample_aspect_ratio(format : Ptr[AVFormatContext], stream : Ptr[AVStream], frame : Ptr[AVFrame])(__return : Ptr[AVRational]): Unit =
    __sn_wrap_ffmpeg_av_guess_sample_aspect_ratio(format, stream, frame, __return)
  ...
  */
   ...
   * Multiply two rationals.
  */
  def av_mul_q(b : Ptr[AVRational], c : Ptr[AVRational])(__return : Ptr[AVRational]): Unit =
  ...
  */
  def av_nearer_q(q : AVRational, q1 : AVRational, q2 : AVRational)(using Zone): CInt =
    val __ptr_0: Ptr[AVRational] = _root_.scala.scalanative.unsafe.alloc[AVRational](3)
    !(__ptr_0 + 0) = q
    !(__ptr_0 + 1) = q1
    !(__ptr_0 + 2) = q2
  ...
  */
  def av_rescale_delta(in_tb : Ptr[AVRational], in_ts : int64_t, fs_tb : Ptr[AVRational], duration : CInt, last : Ptr[int64_t], out_tb : Ptr[AVRational]): int64_t =
    __sn_wrap_ffmpeg_av_rescale_delta(in_tb, in_ts, fs_tb, duration, last, out_tb)

  /**
   * Rescale a timestamp while preserving known durations.
  */
  def av_rescale_delta(in_tb : AVRational, in_ts : int64_t, fs_tb : AVRational, duration : CInt, last : Ptr[int64_t], out_tb : AVRational)(using Zone): int64_t =
    val __ptr_0: Ptr[AVRational] = _root_.scala.scalanative.unsafe.alloc[AVRational](3)
    !(__ptr_0 + 0) = in_tb
    !(__ptr_0 + 1) = fs_tb
    !(__ptr_0 + 2) = out_tb
    __sn_wrap_ffmpeg_av_rescale_delta((__ptr_0 + 0), in_ts, (__ptr_0 + 1), duration, last, (__ptr_0 + 2))
  ...
  */
  def av_rescale_q_rnd(a : int64_t, bq : AVRational, cq : AVRational, rnd : AVRounding)(using Zone): int64_t =
    val __ptr_0: Ptr[AVRational] = _root_.scala.scalanative.unsafe.alloc[AVRational](2)
    !(__ptr_0 + 0) = bq
    !(__ptr_0 + 1) = cq
  ...
  */
  ...
  def av_stream_get_codec_timebase(st : Ptr[AVStream])(__return : Ptr[AVRational]): Unit =
...
object all:
  ...
  export _root_.ffmpeg.enumerations.AVClassStateFlags
  ...
  export _root_.ffmpeg.structs.AVContainerFifo
  ...
  export _root_.ffmpeg.structs.AVRTCPSenderReport
  ...
  export _root_.ffmpeg.functions.av_container_fifo_alloc_avpacket
  ...
  export _root_.ffmpeg.functions.av_frame_side_data_remove_by_props
  ...
  export _root_.ffmpeg.constants.AV_FRAME_CROP_UNALIGNED
  export _root_.ffmpeg.constants.AV_HWFRAME_MAP_READ
  export _root_.ffmpeg.constants.AV_HWFRAME_MAP_WRITE
  export _root_.ffmpeg.constants.AV_HWFRAME_MAP_OVERWRITE
  export _root_.ffmpeg.constants.AV_HWFRAME_MAP_DIRECT
  export _root_.ffmpeg.constants.AV_CODEC_HW_CONFIG_METHOD_HW_DEVICE_CTX
  export _root_.ffmpeg.constants.AV_CODEC_HW_CONFIG_METHOD_HW_FRAMES_CTX
  export _root_.ffmpeg.constants.AV_CODEC_HW_CONFIG_METHOD_INTERNAL
  export _root_.ffmpeg.constants.AV_CODEC_HW_CONFIG_METHOD_AD_HOC