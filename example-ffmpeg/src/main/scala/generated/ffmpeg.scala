...
object structs:
  ...
  */
  ...
  object AVChannelCustom:
    ...
    extension (struct: AVChannelCustom)
      ...
      def name_=(value: CArray[CChar, Nat.Digit2[Nat._1, Nat._6]]): Unit = !struct.at2 = value
  ...
  */
  opaque type AVChannelLayout = CStruct4[AVChannelOrder, CInt, AVChannelLayout.U, Ptr[Byte]]
  
  object AVChannelLayout:
    given _tag: Tag[AVChannelLayout] = Tag.materializeCStruct4Tag[AVChannelOrder, CInt, AVChannelLayout.U, Ptr[Byte]]
    ...
    def apply(order : AVChannelOrder, nb_channels : CInt, u : AVChannelLayout.U, opaque : Ptr[Byte])(using Zone): Ptr[AVChannelLayout] =
      val ____ptr = apply()
      (!____ptr).order = order
    ...
    */
    ...
    object U:
      ...
      extension (struct: U)
        ...
        def mask_=(value: uint64_t): Unit = !struct.at(0).asInstanceOf[Ptr[uint64_t]] = value
        def map : Ptr[AVChannelCustom] = !struct.at(0).asInstanceOf[Ptr[Ptr[AVChannelCustom]]]
        def map_=(value: Ptr[AVChannelCustom]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[AVChannelCustom]]] = value
  ...
  */
  opaque type AVClass = CStruct11[CString, CFuncPtr1[Ptr[Byte], CString], Ptr[AVOption], CInt, CInt, CInt, AVClassCategory, CFuncPtr1[Ptr[Byte], AVClassCategory], CFuncPtr4[Ptr[Ptr[AVOptionRanges]], Ptr[Byte], CString, CInt, CInt], CFuncPtr2[Ptr[Byte], Ptr[Byte], Ptr[Byte]], CFuncPtr1[Ptr[Ptr[Byte]], Ptr[Byte]]]
  
  object AVClass:
    given _tag: Tag[AVClass] = Tag.materializeCStruct11Tag[CString, CFuncPtr1[Ptr[Byte], CString], Ptr[AVOption], CInt, CInt, CInt, AVClassCategory, CFuncPtr1[Ptr[Byte], AVClassCategory], CFuncPtr4[Ptr[Ptr[AVOptionRanges]], Ptr[Byte], CString, CInt, CInt], CFuncPtr2[Ptr[Byte], Ptr[Byte], Ptr[Byte]], CFuncPtr1[Ptr[Ptr[Byte]], Ptr[Byte]]]
    ...
    def apply(class_name : CString, item_name : CFuncPtr1[Ptr[Byte], CString], option : Ptr[AVOption], version : CInt, log_level_offset_offset : CInt, parent_log_context_offset : CInt, category : AVClassCategory, get_category : CFuncPtr1[Ptr[Byte], AVClassCategory], query_ranges : CFuncPtr4[Ptr[Ptr[AVOptionRanges]], Ptr[Byte], CString, CInt, CInt], child_next : CFuncPtr2[Ptr[Byte], Ptr[Byte], Ptr[Byte]], child_class_iterate : CFuncPtr1[Ptr[Ptr[Byte]], Ptr[AVClass]])(using Zone): Ptr[AVClass] =
      val ____ptr = apply()
    ...
    extension (struct: AVClass)
      ...
      def item_name_=(value: CFuncPtr1[Ptr[Byte], CString]): Unit = !struct.at2 = value
      ...
      def get_category_=(value: CFuncPtr1[Ptr[Byte], AVClassCategory]): Unit = !struct.at8 = value
      def query_ranges : CFuncPtr4[Ptr[Ptr[AVOptionRanges]], Ptr[Byte], CString, CInt, CInt] = struct._9
      def query_ranges_=(value: CFuncPtr4[Ptr[Ptr[AVOptionRanges]], Ptr[Byte], CString, CInt, CInt]): Unit = !struct.at9 = value
      def child_next : CFuncPtr2[Ptr[Byte], Ptr[Byte], Ptr[Byte]] = struct._10
      def child_next_=(value: CFuncPtr2[Ptr[Byte], Ptr[Byte], Ptr[Byte]]): Unit = !struct.at10 = value
      def child_class_iterate : CFuncPtr1[Ptr[Ptr[Byte]], Ptr[AVClass]] = struct._11.asInstanceOf[CFuncPtr1[Ptr[Ptr[Byte]], Ptr[AVClass]]]
      def child_class_iterate_=(value: CFuncPtr1[Ptr[Ptr[Byte]], Ptr[AVClass]]): Unit = !struct.at11 = value.asInstanceOf[CFuncPtr1[Ptr[Ptr[Byte]], Ptr[Byte]]]
  ...
  */
  ...
  object AVCodec:
    ...
    extension (struct: AVCodec)
      ...
      def supported_framerates_=(value: Ptr[AVRational]): Unit = !struct.at7 = value
      ...
      def priv_class_=(value: Ptr[AVClass]): Unit = !struct.at11 = value.asInstanceOf[Ptr[Byte]]
  ...
  */
  ...
  object AVCodecContext:
    ...
    extension (struct: AVCodecContext)
      def av_class: Ptr[AVClass] = !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[AVClass]]]
      def av_class_=(value: Ptr[AVClass]): Unit = !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[AVClass]]] = value
      def log_level_offset: CInt = !struct.at(offsets(1)).asInstanceOf[Ptr[CInt]]
      def log_level_offset_=(value: CInt): Unit = !struct.at(offsets(1)).asInstanceOf[Ptr[CInt]] = value
      def codec_type: AVMediaType = !struct.at(offsets(2)).asInstanceOf[Ptr[AVMediaType]]
      def codec_type_=(value: AVMediaType): Unit = !struct.at(offsets(2)).asInstanceOf[Ptr[AVMediaType]] = value
      def codec: Ptr[AVCodec] = !struct.at(offsets(3)).asInstanceOf[Ptr[Ptr[AVCodec]]]
      def codec_=(value: Ptr[AVCodec]): Unit = !struct.at(offsets(3)).asInstanceOf[Ptr[Ptr[AVCodec]]] = value
      def codec_id: AVCodecID = !struct.at(offsets(4)).asInstanceOf[Ptr[AVCodecID]]
      def codec_id_=(value: AVCodecID): Unit = !struct.at(offsets(4)).asInstanceOf[Ptr[AVCodecID]] = value
      def codec_tag: CUnsignedInt = !struct.at(offsets(5)).asInstanceOf[Ptr[CUnsignedInt]]
      def codec_tag_=(value: CUnsignedInt): Unit = !struct.at(offsets(5)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def priv_data: Ptr[Byte] = !struct.at(offsets(6)).asInstanceOf[Ptr[Ptr[Byte]]]
      def priv_data_=(value: Ptr[Byte]): Unit = !struct.at(offsets(6)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def internal: Ptr[AVCodecInternal] = !struct.at(offsets(7)).asInstanceOf[Ptr[Ptr[AVCodecInternal]]]
      def internal_=(value: Ptr[AVCodecInternal]): Unit = !struct.at(offsets(7)).asInstanceOf[Ptr[Ptr[AVCodecInternal]]] = value
      def opaque: Ptr[Byte] = !struct.at(offsets(8)).asInstanceOf[Ptr[Ptr[Byte]]]
      def opaque_=(value: Ptr[Byte]): Unit = !struct.at(offsets(8)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def bit_rate: int64_t = !struct.at(offsets(9)).asInstanceOf[Ptr[int64_t]]
      def bit_rate_=(value: int64_t): Unit = !struct.at(offsets(9)).asInstanceOf[Ptr[int64_t]] = value
      def flags: CInt = !struct.at(offsets(10)).asInstanceOf[Ptr[CInt]]
      def flags_=(value: CInt): Unit = !struct.at(offsets(10)).asInstanceOf[Ptr[CInt]] = value
      def flags2: CInt = !struct.at(offsets(11)).asInstanceOf[Ptr[CInt]]
      def flags2_=(value: CInt): Unit = !struct.at(offsets(11)).asInstanceOf[Ptr[CInt]] = value
      def extradata: Ptr[uint8_t] = !struct.at(offsets(12)).asInstanceOf[Ptr[Ptr[uint8_t]]]
      def extradata_=(value: Ptr[uint8_t]): Unit = !struct.at(offsets(12)).asInstanceOf[Ptr[Ptr[uint8_t]]] = value
      def extradata_size: CInt = !struct.at(offsets(13)).asInstanceOf[Ptr[CInt]]
      def extradata_size_=(value: CInt): Unit = !struct.at(offsets(13)).asInstanceOf[Ptr[CInt]] = value
      def time_base: AVRational = !struct.at(offsets(14)).asInstanceOf[Ptr[AVRational]]
      def time_base_=(value: AVRational): Unit = !struct.at(offsets(14)).asInstanceOf[Ptr[AVRational]] = value
      def pkt_timebase: AVRational = !struct.at(offsets(15)).asInstanceOf[Ptr[AVRational]]
      def pkt_timebase_=(value: AVRational): Unit = !struct.at(offsets(15)).asInstanceOf[Ptr[AVRational]] = value
      def framerate: AVRational = !struct.at(offsets(16)).asInstanceOf[Ptr[AVRational]]
      def framerate_=(value: AVRational): Unit = !struct.at(offsets(16)).asInstanceOf[Ptr[AVRational]] = value
      def ticks_per_frame: CInt = !struct.at(offsets(17)).asInstanceOf[Ptr[CInt]]
      def ticks_per_frame_=(value: CInt): Unit = !struct.at(offsets(17)).asInstanceOf[Ptr[CInt]] = value
      def delay: CInt = !struct.at(offsets(18)).asInstanceOf[Ptr[CInt]]
      def delay_=(value: CInt): Unit = !struct.at(offsets(18)).asInstanceOf[Ptr[CInt]] = value
      def width: CInt = !struct.at(offsets(19)).asInstanceOf[Ptr[CInt]]
      def width_=(value: CInt): Unit = !struct.at(offsets(19)).asInstanceOf[Ptr[CInt]] = value
      def height: CInt = !struct.at(offsets(20)).asInstanceOf[Ptr[CInt]]
      def height_=(value: CInt): Unit = !struct.at(offsets(20)).asInstanceOf[Ptr[CInt]] = value
      def coded_width: CInt = !struct.at(offsets(21)).asInstanceOf[Ptr[CInt]]
      def coded_width_=(value: CInt): Unit = !struct.at(offsets(21)).asInstanceOf[Ptr[CInt]] = value
      def coded_height: CInt = !struct.at(offsets(22)).asInstanceOf[Ptr[CInt]]
      def coded_height_=(value: CInt): Unit = !struct.at(offsets(22)).asInstanceOf[Ptr[CInt]] = value
      def sample_aspect_ratio: AVRational = !struct.at(offsets(23)).asInstanceOf[Ptr[AVRational]]
      def sample_aspect_ratio_=(value: AVRational): Unit = !struct.at(offsets(23)).asInstanceOf[Ptr[AVRational]] = value
      def pix_fmt: AVPixelFormat = !struct.at(offsets(24)).asInstanceOf[Ptr[AVPixelFormat]]
      def pix_fmt_=(value: AVPixelFormat): Unit = !struct.at(offsets(24)).asInstanceOf[Ptr[AVPixelFormat]] = value
      def sw_pix_fmt: AVPixelFormat = !struct.at(offsets(25)).asInstanceOf[Ptr[AVPixelFormat]]
      def sw_pix_fmt_=(value: AVPixelFormat): Unit = !struct.at(offsets(25)).asInstanceOf[Ptr[AVPixelFormat]] = value
      def color_primaries: AVColorPrimaries = !struct.at(offsets(26)).asInstanceOf[Ptr[AVColorPrimaries]]
      def color_primaries_=(value: AVColorPrimaries): Unit = !struct.at(offsets(26)).asInstanceOf[Ptr[AVColorPrimaries]] = value
      def color_trc: AVColorTransferCharacteristic = !struct.at(offsets(27)).asInstanceOf[Ptr[AVColorTransferCharacteristic]]
      def color_trc_=(value: AVColorTransferCharacteristic): Unit = !struct.at(offsets(27)).asInstanceOf[Ptr[AVColorTransferCharacteristic]] = value
      def colorspace: AVColorSpace = !struct.at(offsets(28)).asInstanceOf[Ptr[AVColorSpace]]
      def colorspace_=(value: AVColorSpace): Unit = !struct.at(offsets(28)).asInstanceOf[Ptr[AVColorSpace]] = value
      def color_range: AVColorRange = !struct.at(offsets(29)).asInstanceOf[Ptr[AVColorRange]]
      def color_range_=(value: AVColorRange): Unit = !struct.at(offsets(29)).asInstanceOf[Ptr[AVColorRange]] = value
      def chroma_sample_location: AVChromaLocation = !struct.at(offsets(30)).asInstanceOf[Ptr[AVChromaLocation]]
      def chroma_sample_location_=(value: AVChromaLocation): Unit = !struct.at(offsets(30)).asInstanceOf[Ptr[AVChromaLocation]] = value
      def field_order: AVFieldOrder = !struct.at(offsets(31)).asInstanceOf[Ptr[AVFieldOrder]]
      def field_order_=(value: AVFieldOrder): Unit = !struct.at(offsets(31)).asInstanceOf[Ptr[AVFieldOrder]] = value
      def refs: CInt = !struct.at(offsets(32)).asInstanceOf[Ptr[CInt]]
      def refs_=(value: CInt): Unit = !struct.at(offsets(32)).asInstanceOf[Ptr[CInt]] = value
      def has_b_frames: CInt = !struct.at(offsets(33)).asInstanceOf[Ptr[CInt]]
      def has_b_frames_=(value: CInt): Unit = !struct.at(offsets(33)).asInstanceOf[Ptr[CInt]] = value
      def slice_flags: CInt = !struct.at(offsets(34)).asInstanceOf[Ptr[CInt]]
      def slice_flags_=(value: CInt): Unit = !struct.at(offsets(34)).asInstanceOf[Ptr[CInt]] = value
      def draw_horiz_band: CFuncPtr6[Ptr[AVCodecContext], Ptr[AVFrame], CArray[CInt, Nat._8], CInt, CInt, CInt, Unit] = !struct.at(offsets(35)).asInstanceOf[Ptr[CFuncPtr6[Ptr[AVCodecContext], Ptr[AVFrame], CArray[CInt, Nat._8], CInt, CInt, CInt, Unit]]]
      def draw_horiz_band_=(value: CFuncPtr6[Ptr[AVCodecContext], Ptr[AVFrame], CArray[CInt, Nat._8], CInt, CInt, CInt, Unit]): Unit = !struct.at(offsets(35)).asInstanceOf[Ptr[CFuncPtr6[Ptr[AVCodecContext], Ptr[AVFrame], CArray[CInt, Nat._8], CInt, CInt, CInt, Unit]]] = value
      def get_format: CFuncPtr2[Ptr[AVCodecContext], Ptr[AVPixelFormat], AVPixelFormat] = !struct.at(offsets(36)).asInstanceOf[Ptr[CFuncPtr2[Ptr[AVCodecContext], Ptr[AVPixelFormat], AVPixelFormat]]]
      def get_format_=(value: CFuncPtr2[Ptr[AVCodecContext], Ptr[AVPixelFormat], AVPixelFormat]): Unit = !struct.at(offsets(36)).asInstanceOf[Ptr[CFuncPtr2[Ptr[AVCodecContext], Ptr[AVPixelFormat], AVPixelFormat]]] = value
      def max_b_frames: CInt = !struct.at(offsets(37)).asInstanceOf[Ptr[CInt]]
      def max_b_frames_=(value: CInt): Unit = !struct.at(offsets(37)).asInstanceOf[Ptr[CInt]] = value
      def b_quant_factor: Float = !struct.at(offsets(38)).asInstanceOf[Ptr[Float]]
      def b_quant_factor_=(value: Float): Unit = !struct.at(offsets(38)).asInstanceOf[Ptr[Float]] = value
      def b_quant_offset: Float = !struct.at(offsets(39)).asInstanceOf[Ptr[Float]]
      def b_quant_offset_=(value: Float): Unit = !struct.at(offsets(39)).asInstanceOf[Ptr[Float]] = value
      def i_quant_factor: Float = !struct.at(offsets(40)).asInstanceOf[Ptr[Float]]
      def i_quant_factor_=(value: Float): Unit = !struct.at(offsets(40)).asInstanceOf[Ptr[Float]] = value
      def i_quant_offset: Float = !struct.at(offsets(41)).asInstanceOf[Ptr[Float]]
      def i_quant_offset_=(value: Float): Unit = !struct.at(offsets(41)).asInstanceOf[Ptr[Float]] = value
      def lumi_masking: Float = !struct.at(offsets(42)).asInstanceOf[Ptr[Float]]
      def lumi_masking_=(value: Float): Unit = !struct.at(offsets(42)).asInstanceOf[Ptr[Float]] = value
      def temporal_cplx_masking: Float = !struct.at(offsets(43)).asInstanceOf[Ptr[Float]]
      def temporal_cplx_masking_=(value: Float): Unit = !struct.at(offsets(43)).asInstanceOf[Ptr[Float]] = value
      def spatial_cplx_masking: Float = !struct.at(offsets(44)).asInstanceOf[Ptr[Float]]
      def spatial_cplx_masking_=(value: Float): Unit = !struct.at(offsets(44)).asInstanceOf[Ptr[Float]] = value
      def p_masking: Float = !struct.at(offsets(45)).asInstanceOf[Ptr[Float]]
      def p_masking_=(value: Float): Unit = !struct.at(offsets(45)).asInstanceOf[Ptr[Float]] = value
      def dark_masking: Float = !struct.at(offsets(46)).asInstanceOf[Ptr[Float]]
      def dark_masking_=(value: Float): Unit = !struct.at(offsets(46)).asInstanceOf[Ptr[Float]] = value
      def nsse_weight: CInt = !struct.at(offsets(47)).asInstanceOf[Ptr[CInt]]
      def nsse_weight_=(value: CInt): Unit = !struct.at(offsets(47)).asInstanceOf[Ptr[CInt]] = value
      def me_cmp: CInt = !struct.at(offsets(48)).asInstanceOf[Ptr[CInt]]
      def me_cmp_=(value: CInt): Unit = !struct.at(offsets(48)).asInstanceOf[Ptr[CInt]] = value
      def me_sub_cmp: CInt = !struct.at(offsets(49)).asInstanceOf[Ptr[CInt]]
      def me_sub_cmp_=(value: CInt): Unit = !struct.at(offsets(49)).asInstanceOf[Ptr[CInt]] = value
      def mb_cmp: CInt = !struct.at(offsets(50)).asInstanceOf[Ptr[CInt]]
      def mb_cmp_=(value: CInt): Unit = !struct.at(offsets(50)).asInstanceOf[Ptr[CInt]] = value
      def ildct_cmp: CInt = !struct.at(offsets(51)).asInstanceOf[Ptr[CInt]]
      def ildct_cmp_=(value: CInt): Unit = !struct.at(offsets(51)).asInstanceOf[Ptr[CInt]] = value
      def dia_size: CInt = !struct.at(offsets(52)).asInstanceOf[Ptr[CInt]]
      def dia_size_=(value: CInt): Unit = !struct.at(offsets(52)).asInstanceOf[Ptr[CInt]] = value
      def last_predictor_count: CInt = !struct.at(offsets(53)).asInstanceOf[Ptr[CInt]]
      def last_predictor_count_=(value: CInt): Unit = !struct.at(offsets(53)).asInstanceOf[Ptr[CInt]] = value
      def me_pre_cmp: CInt = !struct.at(offsets(54)).asInstanceOf[Ptr[CInt]]
      def me_pre_cmp_=(value: CInt): Unit = !struct.at(offsets(54)).asInstanceOf[Ptr[CInt]] = value
      def pre_dia_size: CInt = !struct.at(offsets(55)).asInstanceOf[Ptr[CInt]]
      def pre_dia_size_=(value: CInt): Unit = !struct.at(offsets(55)).asInstanceOf[Ptr[CInt]] = value
      def me_subpel_quality: CInt = !struct.at(offsets(56)).asInstanceOf[Ptr[CInt]]
      def me_subpel_quality_=(value: CInt): Unit = !struct.at(offsets(56)).asInstanceOf[Ptr[CInt]] = value
      def me_range: CInt = !struct.at(offsets(57)).asInstanceOf[Ptr[CInt]]
      def me_range_=(value: CInt): Unit = !struct.at(offsets(57)).asInstanceOf[Ptr[CInt]] = value
      def mb_decision: CInt = !struct.at(offsets(58)).asInstanceOf[Ptr[CInt]]
      def mb_decision_=(value: CInt): Unit = !struct.at(offsets(58)).asInstanceOf[Ptr[CInt]] = value
      def intra_matrix: Ptr[uint16_t] = !struct.at(offsets(59)).asInstanceOf[Ptr[Ptr[uint16_t]]]
      def intra_matrix_=(value: Ptr[uint16_t]): Unit = !struct.at(offsets(59)).asInstanceOf[Ptr[Ptr[uint16_t]]] = value
      def inter_matrix: Ptr[uint16_t] = !struct.at(offsets(60)).asInstanceOf[Ptr[Ptr[uint16_t]]]
      def inter_matrix_=(value: Ptr[uint16_t]): Unit = !struct.at(offsets(60)).asInstanceOf[Ptr[Ptr[uint16_t]]] = value
      def chroma_intra_matrix: Ptr[uint16_t] = !struct.at(offsets(61)).asInstanceOf[Ptr[Ptr[uint16_t]]]
      def chroma_intra_matrix_=(value: Ptr[uint16_t]): Unit = !struct.at(offsets(61)).asInstanceOf[Ptr[Ptr[uint16_t]]] = value
      def intra_dc_precision: CInt = !struct.at(offsets(62)).asInstanceOf[Ptr[CInt]]
      def intra_dc_precision_=(value: CInt): Unit = !struct.at(offsets(62)).asInstanceOf[Ptr[CInt]] = value
      def mb_lmin: CInt = !struct.at(offsets(63)).asInstanceOf[Ptr[CInt]]
      def mb_lmin_=(value: CInt): Unit = !struct.at(offsets(63)).asInstanceOf[Ptr[CInt]] = value
      def mb_lmax: CInt = !struct.at(offsets(64)).asInstanceOf[Ptr[CInt]]
      def mb_lmax_=(value: CInt): Unit = !struct.at(offsets(64)).asInstanceOf[Ptr[CInt]] = value
      def bidir_refine: CInt = !struct.at(offsets(65)).asInstanceOf[Ptr[CInt]]
      def bidir_refine_=(value: CInt): Unit = !struct.at(offsets(65)).asInstanceOf[Ptr[CInt]] = value
      def keyint_min: CInt = !struct.at(offsets(66)).asInstanceOf[Ptr[CInt]]
      def keyint_min_=(value: CInt): Unit = !struct.at(offsets(66)).asInstanceOf[Ptr[CInt]] = value
      def gop_size: CInt = !struct.at(offsets(67)).asInstanceOf[Ptr[CInt]]
      def gop_size_=(value: CInt): Unit = !struct.at(offsets(67)).asInstanceOf[Ptr[CInt]] = value
      def mv0_threshold: CInt = !struct.at(offsets(68)).asInstanceOf[Ptr[CInt]]
      def mv0_threshold_=(value: CInt): Unit = !struct.at(offsets(68)).asInstanceOf[Ptr[CInt]] = value
      def slices: CInt = !struct.at(offsets(69)).asInstanceOf[Ptr[CInt]]
      def slices_=(value: CInt): Unit = !struct.at(offsets(69)).asInstanceOf[Ptr[CInt]] = value
      def sample_rate: CInt = !struct.at(offsets(70)).asInstanceOf[Ptr[CInt]]
      def sample_rate_=(value: CInt): Unit = !struct.at(offsets(70)).asInstanceOf[Ptr[CInt]] = value
      def sample_fmt: AVSampleFormat = !struct.at(offsets(71)).asInstanceOf[Ptr[AVSampleFormat]]
      def sample_fmt_=(value: AVSampleFormat): Unit = !struct.at(offsets(71)).asInstanceOf[Ptr[AVSampleFormat]] = value
      def ch_layout: AVChannelLayout = !struct.at(offsets(72)).asInstanceOf[Ptr[AVChannelLayout]]
      def ch_layout_=(value: AVChannelLayout): Unit = !struct.at(offsets(72)).asInstanceOf[Ptr[AVChannelLayout]] = value
      def frame_size: CInt = !struct.at(offsets(73)).asInstanceOf[Ptr[CInt]]
      def frame_size_=(value: CInt): Unit = !struct.at(offsets(73)).asInstanceOf[Ptr[CInt]] = value
      def block_align: CInt = !struct.at(offsets(74)).asInstanceOf[Ptr[CInt]]
      def block_align_=(value: CInt): Unit = !struct.at(offsets(74)).asInstanceOf[Ptr[CInt]] = value
      def cutoff: CInt = !struct.at(offsets(75)).asInstanceOf[Ptr[CInt]]
      def cutoff_=(value: CInt): Unit = !struct.at(offsets(75)).asInstanceOf[Ptr[CInt]] = value
      def audio_service_type: AVAudioServiceType = !struct.at(offsets(76)).asInstanceOf[Ptr[AVAudioServiceType]]
      def audio_service_type_=(value: AVAudioServiceType): Unit = !struct.at(offsets(76)).asInstanceOf[Ptr[AVAudioServiceType]] = value
      def request_sample_fmt: AVSampleFormat = !struct.at(offsets(77)).asInstanceOf[Ptr[AVSampleFormat]]
      def request_sample_fmt_=(value: AVSampleFormat): Unit = !struct.at(offsets(77)).asInstanceOf[Ptr[AVSampleFormat]] = value
      def initial_padding: CInt = !struct.at(offsets(78)).asInstanceOf[Ptr[CInt]]
      def initial_padding_=(value: CInt): Unit = !struct.at(offsets(78)).asInstanceOf[Ptr[CInt]] = value
      def trailing_padding: CInt = !struct.at(offsets(79)).asInstanceOf[Ptr[CInt]]
      def trailing_padding_=(value: CInt): Unit = !struct.at(offsets(79)).asInstanceOf[Ptr[CInt]] = value
      def seek_preroll: CInt = !struct.at(offsets(80)).asInstanceOf[Ptr[CInt]]
      def seek_preroll_=(value: CInt): Unit = !struct.at(offsets(80)).asInstanceOf[Ptr[CInt]] = value
      def get_buffer2: CFuncPtr3[Ptr[AVCodecContext], Ptr[AVFrame], CInt, CInt] = !struct.at(offsets(81)).asInstanceOf[Ptr[CFuncPtr3[Ptr[AVCodecContext], Ptr[AVFrame], CInt, CInt]]]
      def get_buffer2_=(value: CFuncPtr3[Ptr[AVCodecContext], Ptr[AVFrame], CInt, CInt]): Unit = !struct.at(offsets(81)).asInstanceOf[Ptr[CFuncPtr3[Ptr[AVCodecContext], Ptr[AVFrame], CInt, CInt]]] = value
      def bit_rate_tolerance: CInt = !struct.at(offsets(82)).asInstanceOf[Ptr[CInt]]
      def bit_rate_tolerance_=(value: CInt): Unit = !struct.at(offsets(82)).asInstanceOf[Ptr[CInt]] = value
      def global_quality: CInt = !struct.at(offsets(83)).asInstanceOf[Ptr[CInt]]
      def global_quality_=(value: CInt): Unit = !struct.at(offsets(83)).asInstanceOf[Ptr[CInt]] = value
      def compression_level: CInt = !struct.at(offsets(84)).asInstanceOf[Ptr[CInt]]
      def compression_level_=(value: CInt): Unit = !struct.at(offsets(84)).asInstanceOf[Ptr[CInt]] = value
      def qcompress: Float = !struct.at(offsets(85)).asInstanceOf[Ptr[Float]]
      def qcompress_=(value: Float): Unit = !struct.at(offsets(85)).asInstanceOf[Ptr[Float]] = value
      def qblur: Float = !struct.at(offsets(86)).asInstanceOf[Ptr[Float]]
      def qblur_=(value: Float): Unit = !struct.at(offsets(86)).asInstanceOf[Ptr[Float]] = value
      def qmin: CInt = !struct.at(offsets(87)).asInstanceOf[Ptr[CInt]]
      def qmin_=(value: CInt): Unit = !struct.at(offsets(87)).asInstanceOf[Ptr[CInt]] = value
      def qmax: CInt = !struct.at(offsets(88)).asInstanceOf[Ptr[CInt]]
      def qmax_=(value: CInt): Unit = !struct.at(offsets(88)).asInstanceOf[Ptr[CInt]] = value
      def max_qdiff: CInt = !struct.at(offsets(89)).asInstanceOf[Ptr[CInt]]
      def max_qdiff_=(value: CInt): Unit = !struct.at(offsets(89)).asInstanceOf[Ptr[CInt]] = value
      def rc_buffer_size: CInt = !struct.at(offsets(90)).asInstanceOf[Ptr[CInt]]
      def rc_buffer_size_=(value: CInt): Unit = !struct.at(offsets(90)).asInstanceOf[Ptr[CInt]] = value
      def rc_override_count: CInt = !struct.at(offsets(91)).asInstanceOf[Ptr[CInt]]
      def rc_override_count_=(value: CInt): Unit = !struct.at(offsets(91)).asInstanceOf[Ptr[CInt]] = value
      def rc_override: Ptr[RcOverride] = !struct.at(offsets(92)).asInstanceOf[Ptr[Ptr[RcOverride]]]
      def rc_override_=(value: Ptr[RcOverride]): Unit = !struct.at(offsets(92)).asInstanceOf[Ptr[Ptr[RcOverride]]] = value
      def rc_max_rate: int64_t = !struct.at(offsets(93)).asInstanceOf[Ptr[int64_t]]
      def rc_max_rate_=(value: int64_t): Unit = !struct.at(offsets(93)).asInstanceOf[Ptr[int64_t]] = value
      def rc_min_rate: int64_t = !struct.at(offsets(94)).asInstanceOf[Ptr[int64_t]]
      def rc_min_rate_=(value: int64_t): Unit = !struct.at(offsets(94)).asInstanceOf[Ptr[int64_t]] = value
      def rc_max_available_vbv_use: Float = !struct.at(offsets(95)).asInstanceOf[Ptr[Float]]
      def rc_max_available_vbv_use_=(value: Float): Unit = !struct.at(offsets(95)).asInstanceOf[Ptr[Float]] = value
      def rc_min_vbv_overflow_use: Float = !struct.at(offsets(96)).asInstanceOf[Ptr[Float]]
      def rc_min_vbv_overflow_use_=(value: Float): Unit = !struct.at(offsets(96)).asInstanceOf[Ptr[Float]] = value
      def rc_initial_buffer_occupancy: CInt = !struct.at(offsets(97)).asInstanceOf[Ptr[CInt]]
      def rc_initial_buffer_occupancy_=(value: CInt): Unit = !struct.at(offsets(97)).asInstanceOf[Ptr[CInt]] = value
      def trellis: CInt = !struct.at(offsets(98)).asInstanceOf[Ptr[CInt]]
      def trellis_=(value: CInt): Unit = !struct.at(offsets(98)).asInstanceOf[Ptr[CInt]] = value
      def stats_out: CString = !struct.at(offsets(99)).asInstanceOf[Ptr[CString]]
      def stats_out_=(value: CString): Unit = !struct.at(offsets(99)).asInstanceOf[Ptr[CString]] = value
      def stats_in: CString = !struct.at(offsets(100)).asInstanceOf[Ptr[CString]]
      def stats_in_=(value: CString): Unit = !struct.at(offsets(100)).asInstanceOf[Ptr[CString]] = value
      def workaround_bugs: CInt = !struct.at(offsets(101)).asInstanceOf[Ptr[CInt]]
      def workaround_bugs_=(value: CInt): Unit = !struct.at(offsets(101)).asInstanceOf[Ptr[CInt]] = value
      def strict_std_compliance: CInt = !struct.at(offsets(102)).asInstanceOf[Ptr[CInt]]
      def strict_std_compliance_=(value: CInt): Unit = !struct.at(offsets(102)).asInstanceOf[Ptr[CInt]] = value
      def error_concealment: CInt = !struct.at(offsets(103)).asInstanceOf[Ptr[CInt]]
      def error_concealment_=(value: CInt): Unit = !struct.at(offsets(103)).asInstanceOf[Ptr[CInt]] = value
      def debug: CInt = !struct.at(offsets(104)).asInstanceOf[Ptr[CInt]]
      def debug_=(value: CInt): Unit = !struct.at(offsets(104)).asInstanceOf[Ptr[CInt]] = value
      def err_recognition: CInt = !struct.at(offsets(105)).asInstanceOf[Ptr[CInt]]
      def err_recognition_=(value: CInt): Unit = !struct.at(offsets(105)).asInstanceOf[Ptr[CInt]] = value
      def hwaccel: Ptr[AVHWAccel] = !struct.at(offsets(106)).asInstanceOf[Ptr[Ptr[AVHWAccel]]]
      def hwaccel_=(value: Ptr[AVHWAccel]): Unit = !struct.at(offsets(106)).asInstanceOf[Ptr[Ptr[AVHWAccel]]] = value
      def hwaccel_context: Ptr[Byte] = !struct.at(offsets(107)).asInstanceOf[Ptr[Ptr[Byte]]]
      def hwaccel_context_=(value: Ptr[Byte]): Unit = !struct.at(offsets(107)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def hw_frames_ctx: Ptr[AVBufferRef] = !struct.at(offsets(108)).asInstanceOf[Ptr[Ptr[AVBufferRef]]]
      def hw_frames_ctx_=(value: Ptr[AVBufferRef]): Unit = !struct.at(offsets(108)).asInstanceOf[Ptr[Ptr[AVBufferRef]]] = value
      def hw_device_ctx: Ptr[AVBufferRef] = !struct.at(offsets(109)).asInstanceOf[Ptr[Ptr[AVBufferRef]]]
      def hw_device_ctx_=(value: Ptr[AVBufferRef]): Unit = !struct.at(offsets(109)).asInstanceOf[Ptr[Ptr[AVBufferRef]]] = value
      def hwaccel_flags: CInt = !struct.at(offsets(110)).asInstanceOf[Ptr[CInt]]
      def hwaccel_flags_=(value: CInt): Unit = !struct.at(offsets(110)).asInstanceOf[Ptr[CInt]] = value
      def extra_hw_frames: CInt = !struct.at(offsets(111)).asInstanceOf[Ptr[CInt]]
      def extra_hw_frames_=(value: CInt): Unit = !struct.at(offsets(111)).asInstanceOf[Ptr[CInt]] = value
      def error: CArray[uint64_t, Nat._8] = !struct.at(offsets(112)).asInstanceOf[Ptr[CArray[uint64_t, Nat._8]]]
      def error_=(value: CArray[uint64_t, Nat._8]): Unit = !struct.at(offsets(112)).asInstanceOf[Ptr[CArray[uint64_t, Nat._8]]] = value
      def dct_algo: CInt = !struct.at(offsets(113)).asInstanceOf[Ptr[CInt]]
      def dct_algo_=(value: CInt): Unit = !struct.at(offsets(113)).asInstanceOf[Ptr[CInt]] = value
      def idct_algo: CInt = !struct.at(offsets(114)).asInstanceOf[Ptr[CInt]]
      def idct_algo_=(value: CInt): Unit = !struct.at(offsets(114)).asInstanceOf[Ptr[CInt]] = value
      def bits_per_coded_sample: CInt = !struct.at(offsets(115)).asInstanceOf[Ptr[CInt]]
      def bits_per_coded_sample_=(value: CInt): Unit = !struct.at(offsets(115)).asInstanceOf[Ptr[CInt]] = value
      def bits_per_raw_sample: CInt = !struct.at(offsets(116)).asInstanceOf[Ptr[CInt]]
      def bits_per_raw_sample_=(value: CInt): Unit = !struct.at(offsets(116)).asInstanceOf[Ptr[CInt]] = value
      def thread_count: CInt = !struct.at(offsets(117)).asInstanceOf[Ptr[CInt]]
      def thread_count_=(value: CInt): Unit = !struct.at(offsets(117)).asInstanceOf[Ptr[CInt]] = value
      def thread_type: CInt = !struct.at(offsets(118)).asInstanceOf[Ptr[CInt]]
      def thread_type_=(value: CInt): Unit = !struct.at(offsets(118)).asInstanceOf[Ptr[CInt]] = value
      def active_thread_type: CInt = !struct.at(offsets(119)).asInstanceOf[Ptr[CInt]]
      def active_thread_type_=(value: CInt): Unit = !struct.at(offsets(119)).asInstanceOf[Ptr[CInt]] = value
      def execute: CFuncPtr6[Ptr[AVCodecContext], CFuncPtr2[Ptr[AVCodecContext], Ptr[Byte], CInt], Ptr[Byte], Ptr[CInt], CInt, CInt, CInt] = !struct.at(offsets(120)).asInstanceOf[Ptr[CFuncPtr6[Ptr[AVCodecContext], CFuncPtr2[Ptr[AVCodecContext], Ptr[Byte], CInt], Ptr[Byte], Ptr[CInt], CInt, CInt, CInt]]]
      def execute_=(value: CFuncPtr6[Ptr[AVCodecContext], CFuncPtr2[Ptr[AVCodecContext], Ptr[Byte], CInt], Ptr[Byte], Ptr[CInt], CInt, CInt, CInt]): Unit = !struct.at(offsets(120)).asInstanceOf[Ptr[CFuncPtr6[Ptr[AVCodecContext], CFuncPtr2[Ptr[AVCodecContext], Ptr[Byte], CInt], Ptr[Byte], Ptr[CInt], CInt, CInt, CInt]]] = value
      def execute2: CFuncPtr5[Ptr[AVCodecContext], CFuncPtr4[Ptr[AVCodecContext], Ptr[Byte], CInt, CInt, CInt], Ptr[Byte], Ptr[CInt], CInt, CInt] = !struct.at(offsets(121)).asInstanceOf[Ptr[CFuncPtr5[Ptr[AVCodecContext], CFuncPtr4[Ptr[AVCodecContext], Ptr[Byte], CInt, CInt, CInt], Ptr[Byte], Ptr[CInt], CInt, CInt]]]
      def execute2_=(value: CFuncPtr5[Ptr[AVCodecContext], CFuncPtr4[Ptr[AVCodecContext], Ptr[Byte], CInt, CInt, CInt], Ptr[Byte], Ptr[CInt], CInt, CInt]): Unit = !struct.at(offsets(121)).asInstanceOf[Ptr[CFuncPtr5[Ptr[AVCodecContext], CFuncPtr4[Ptr[AVCodecContext], Ptr[Byte], CInt, CInt, CInt], Ptr[Byte], Ptr[CInt], CInt, CInt]]] = value
      def profile: CInt = !struct.at(offsets(122)).asInstanceOf[Ptr[CInt]]
      def profile_=(value: CInt): Unit = !struct.at(offsets(122)).asInstanceOf[Ptr[CInt]] = value
      def level: CInt = !struct.at(offsets(123)).asInstanceOf[Ptr[CInt]]
      def level_=(value: CInt): Unit = !struct.at(offsets(123)).asInstanceOf[Ptr[CInt]] = value
      def properties: CUnsignedInt = !struct.at(offsets(124)).asInstanceOf[Ptr[CUnsignedInt]]
      def properties_=(value: CUnsignedInt): Unit = !struct.at(offsets(124)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def skip_loop_filter: AVDiscard = !struct.at(offsets(125)).asInstanceOf[Ptr[AVDiscard]]
      def skip_loop_filter_=(value: AVDiscard): Unit = !struct.at(offsets(125)).asInstanceOf[Ptr[AVDiscard]] = value
      def skip_idct: AVDiscard = !struct.at(offsets(126)).asInstanceOf[Ptr[AVDiscard]]
      def skip_idct_=(value: AVDiscard): Unit = !struct.at(offsets(126)).asInstanceOf[Ptr[AVDiscard]] = value
      def skip_frame: AVDiscard = !struct.at(offsets(127)).asInstanceOf[Ptr[AVDiscard]]
      def skip_frame_=(value: AVDiscard): Unit = !struct.at(offsets(127)).asInstanceOf[Ptr[AVDiscard]] = value
      def skip_alpha: CInt = !struct.at(offsets(128)).asInstanceOf[Ptr[CInt]]
      def skip_alpha_=(value: CInt): Unit = !struct.at(offsets(128)).asInstanceOf[Ptr[CInt]] = value
      def skip_top: CInt = !struct.at(offsets(129)).asInstanceOf[Ptr[CInt]]
      def skip_top_=(value: CInt): Unit = !struct.at(offsets(129)).asInstanceOf[Ptr[CInt]] = value
      def skip_bottom: CInt = !struct.at(offsets(130)).asInstanceOf[Ptr[CInt]]
      def skip_bottom_=(value: CInt): Unit = !struct.at(offsets(130)).asInstanceOf[Ptr[CInt]] = value
      def lowres: CInt = !struct.at(offsets(131)).asInstanceOf[Ptr[CInt]]
      def lowres_=(value: CInt): Unit = !struct.at(offsets(131)).asInstanceOf[Ptr[CInt]] = value
      def codec_descriptor: Ptr[AVCodecDescriptor] = !struct.at(offsets(132)).asInstanceOf[Ptr[Ptr[AVCodecDescriptor]]]
      def codec_descriptor_=(value: Ptr[AVCodecDescriptor]): Unit = !struct.at(offsets(132)).asInstanceOf[Ptr[Ptr[AVCodecDescriptor]]] = value
      def sub_charenc: CString = !struct.at(offsets(133)).asInstanceOf[Ptr[CString]]
      def sub_charenc_=(value: CString): Unit = !struct.at(offsets(133)).asInstanceOf[Ptr[CString]] = value
      def sub_charenc_mode: CInt = !struct.at(offsets(134)).asInstanceOf[Ptr[CInt]]
      def sub_charenc_mode_=(value: CInt): Unit = !struct.at(offsets(134)).asInstanceOf[Ptr[CInt]] = value
      def subtitle_header_size: CInt = !struct.at(offsets(135)).asInstanceOf[Ptr[CInt]]
      def subtitle_header_size_=(value: CInt): Unit = !struct.at(offsets(135)).asInstanceOf[Ptr[CInt]] = value
      def subtitle_header: Ptr[uint8_t] = !struct.at(offsets(136)).asInstanceOf[Ptr[Ptr[uint8_t]]]
      def subtitle_header_=(value: Ptr[uint8_t]): Unit = !struct.at(offsets(136)).asInstanceOf[Ptr[Ptr[uint8_t]]] = value
      def dump_separator: Ptr[uint8_t] = !struct.at(offsets(137)).asInstanceOf[Ptr[Ptr[uint8_t]]]
      def dump_separator_=(value: Ptr[uint8_t]): Unit = !struct.at(offsets(137)).asInstanceOf[Ptr[Ptr[uint8_t]]] = value
      def codec_whitelist: CString = !struct.at(offsets(138)).asInstanceOf[Ptr[CString]]
      def codec_whitelist_=(value: CString): Unit = !struct.at(offsets(138)).asInstanceOf[Ptr[CString]] = value
      def coded_side_data: Ptr[AVPacketSideData] = !struct.at(offsets(139)).asInstanceOf[Ptr[Ptr[AVPacketSideData]]]
      def coded_side_data_=(value: Ptr[AVPacketSideData]): Unit = !struct.at(offsets(139)).asInstanceOf[Ptr[Ptr[AVPacketSideData]]] = value
      def nb_coded_side_data: CInt = !struct.at(offsets(140)).asInstanceOf[Ptr[CInt]]
      def nb_coded_side_data_=(value: CInt): Unit = !struct.at(offsets(140)).asInstanceOf[Ptr[CInt]] = value
      def export_side_data: CInt = !struct.at(offsets(141)).asInstanceOf[Ptr[CInt]]
      def export_side_data_=(value: CInt): Unit = !struct.at(offsets(141)).asInstanceOf[Ptr[CInt]] = value
      def max_pixels: int64_t = !struct.at(offsets(142)).asInstanceOf[Ptr[int64_t]]
      def max_pixels_=(value: int64_t): Unit = !struct.at(offsets(142)).asInstanceOf[Ptr[int64_t]] = value
      def apply_cropping: CInt = !struct.at(offsets(143)).asInstanceOf[Ptr[CInt]]
      def apply_cropping_=(value: CInt): Unit = !struct.at(offsets(143)).asInstanceOf[Ptr[CInt]] = value
      def discard_damaged_percentage: CInt = !struct.at(offsets(144)).asInstanceOf[Ptr[CInt]]
      def discard_damaged_percentage_=(value: CInt): Unit = !struct.at(offsets(144)).asInstanceOf[Ptr[CInt]] = value
      def max_samples: int64_t = !struct.at(offsets(145)).asInstanceOf[Ptr[int64_t]]
      def max_samples_=(value: int64_t): Unit = !struct.at(offsets(145)).asInstanceOf[Ptr[int64_t]] = value
      def get_encode_buffer: CFuncPtr3[Ptr[AVCodecContext], Ptr[AVPacket], CInt, CInt] = !struct.at(offsets(146)).asInstanceOf[Ptr[CFuncPtr3[Ptr[AVCodecContext], Ptr[AVPacket], CInt, CInt]]]
      def get_encode_buffer_=(value: CFuncPtr3[Ptr[AVCodecContext], Ptr[AVPacket], CInt, CInt]): Unit = !struct.at(offsets(146)).asInstanceOf[Ptr[CFuncPtr3[Ptr[AVCodecContext], Ptr[AVPacket], CInt, CInt]]] = value
      def frame_num: int64_t = !struct.at(offsets(147)).asInstanceOf[Ptr[int64_t]]
      def frame_num_=(value: int64_t): Unit = !struct.at(offsets(147)).asInstanceOf[Ptr[int64_t]] = value
      def side_data_prefer_packet: Ptr[CInt] = !struct.at(offsets(148)).asInstanceOf[Ptr[Ptr[CInt]]]
      def side_data_prefer_packet_=(value: Ptr[CInt]): Unit = !struct.at(offsets(148)).asInstanceOf[Ptr[Ptr[CInt]]] = value
      def nb_side_data_prefer_packet: CUnsignedInt = !struct.at(offsets(149)).asInstanceOf[Ptr[CUnsignedInt]]
      def nb_side_data_prefer_packet_=(value: CUnsignedInt): Unit = !struct.at(offsets(149)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def decoded_side_data: Ptr[Ptr[AVFrameSideData]] = !struct.at(offsets(150)).asInstanceOf[Ptr[Ptr[Ptr[AVFrameSideData]]]]
      def decoded_side_data_=(value: Ptr[Ptr[AVFrameSideData]]): Unit = !struct.at(offsets(150)).asInstanceOf[Ptr[Ptr[Ptr[AVFrameSideData]]]] = value
      def nb_decoded_side_data: CInt = !struct.at(offsets(151)).asInstanceOf[Ptr[CInt]]
      def nb_decoded_side_data_=(value: CInt): Unit = !struct.at(offsets(151)).asInstanceOf[Ptr[CInt]] = value
    val offsets: Array[Int] =
      ...
      res(23) = align(res(22) + sizeof[CInt].toInt, alignmentof[AVRational].toInt)
      res(24) = align(res(23) + sizeof[AVRational].toInt, alignmentof[AVPixelFormat].toInt)
      res(25) = align(res(24) + sizeof[AVPixelFormat].toInt, alignmentof[AVPixelFormat].toInt)
      res(26) = align(res(25) + sizeof[AVPixelFormat].toInt, alignmentof[AVColorPrimaries].toInt)
      res(27) = align(res(26) + sizeof[AVColorPrimaries].toInt, alignmentof[AVColorTransferCharacteristic].toInt)
      res(28) = align(res(27) + sizeof[AVColorTransferCharacteristic].toInt, alignmentof[AVColorSpace].toInt)
      res(29) = align(res(28) + sizeof[AVColorSpace].toInt, alignmentof[AVColorRange].toInt)
      res(30) = align(res(29) + sizeof[AVColorRange].toInt, alignmentof[AVChromaLocation].toInt)
      res(31) = align(res(30) + sizeof[AVChromaLocation].toInt, alignmentof[AVFieldOrder].toInt)
      res(32) = align(res(31) + sizeof[AVFieldOrder].toInt, alignmentof[CInt].toInt)
      res(33) = align(res(32) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(34) = align(res(33) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(35) = align(res(34) + sizeof[CInt].toInt, alignmentof[CFuncPtr6[Ptr[AVCodecContext], Ptr[AVFrame], CArray[CInt, Nat._8], CInt, CInt, CInt, Unit]].toInt)
      res(36) = align(res(35) + sizeof[CFuncPtr6[Ptr[AVCodecContext], Ptr[AVFrame], CArray[CInt, Nat._8], CInt, CInt, CInt, Unit]].toInt, alignmentof[CFuncPtr2[Ptr[AVCodecContext], Ptr[AVPixelFormat], AVPixelFormat]].toInt)
      res(37) = align(res(36) + sizeof[CFuncPtr2[Ptr[AVCodecContext], Ptr[AVPixelFormat], AVPixelFormat]].toInt, alignmentof[CInt].toInt)
      ...
      res(59) = align(res(58) + sizeof[CInt].toInt, alignmentof[Ptr[uint16_t]].toInt)
      res(60) = align(res(59) + sizeof[Ptr[uint16_t]].toInt, alignmentof[Ptr[uint16_t]].toInt)
      res(61) = align(res(60) + sizeof[Ptr[uint16_t]].toInt, alignmentof[Ptr[uint16_t]].toInt)
      res(62) = align(res(61) + sizeof[Ptr[uint16_t]].toInt, alignmentof[CInt].toInt)
      ...
      res(71) = align(res(70) + sizeof[CInt].toInt, alignmentof[AVSampleFormat].toInt)
      res(72) = align(res(71) + sizeof[AVSampleFormat].toInt, alignmentof[AVChannelLayout].toInt)
      res(73) = align(res(72) + sizeof[AVChannelLayout].toInt, alignmentof[CInt].toInt)
      res(74) = align(res(73) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(75) = align(res(74) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(76) = align(res(75) + sizeof[CInt].toInt, alignmentof[AVAudioServiceType].toInt)
      res(77) = align(res(76) + sizeof[AVAudioServiceType].toInt, alignmentof[AVSampleFormat].toInt)
      res(78) = align(res(77) + sizeof[AVSampleFormat].toInt, alignmentof[CInt].toInt)
      res(79) = align(res(78) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(80) = align(res(79) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(81) = align(res(80) + sizeof[CInt].toInt, alignmentof[CFuncPtr3[Ptr[AVCodecContext], Ptr[AVFrame], CInt, CInt]].toInt)
      res(82) = align(res(81) + sizeof[CFuncPtr3[Ptr[AVCodecContext], Ptr[AVFrame], CInt, CInt]].toInt, alignmentof[CInt].toInt)
      ...
      res(92) = align(res(91) + sizeof[CInt].toInt, alignmentof[Ptr[RcOverride]].toInt)
      res(93) = align(res(92) + sizeof[Ptr[RcOverride]].toInt, alignmentof[int64_t].toInt)
      res(94) = align(res(93) + sizeof[int64_t].toInt, alignmentof[int64_t].toInt)
      ...
      res(100) = align(res(99) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(101) = align(res(100) + sizeof[CString].toInt, alignmentof[CInt].toInt)
      ...
      res(106) = align(res(105) + sizeof[CInt].toInt, alignmentof[Ptr[AVHWAccel]].toInt)
      res(107) = align(res(106) + sizeof[Ptr[AVHWAccel]].toInt, alignmentof[Ptr[Byte]].toInt)
      res(108) = align(res(107) + sizeof[Ptr[Byte]].toInt, alignmentof[Ptr[AVBufferRef]].toInt)
      res(109) = align(res(108) + sizeof[Ptr[AVBufferRef]].toInt, alignmentof[Ptr[AVBufferRef]].toInt)
      res(110) = align(res(109) + sizeof[Ptr[AVBufferRef]].toInt, alignmentof[CInt].toInt)
      res(111) = align(res(110) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(112) = align(res(111) + sizeof[CInt].toInt, alignmentof[uint64_t].toInt)
      res(113) = align(res(112) + sizeof[CArray[uint64_t, Nat._8]].toInt, alignmentof[CInt].toInt)
      ...
      res(120) = align(res(119) + sizeof[CInt].toInt, alignmentof[CFuncPtr6[Ptr[AVCodecContext], CFuncPtr2[Ptr[AVCodecContext], Ptr[Byte], CInt], Ptr[Byte], Ptr[CInt], CInt, CInt, CInt]].toInt)
      res(121) = align(res(120) + sizeof[CFuncPtr6[Ptr[AVCodecContext], CFuncPtr2[Ptr[AVCodecContext], Ptr[Byte], CInt], Ptr[Byte], Ptr[CInt], CInt, CInt, CInt]].toInt, alignmentof[CFuncPtr5[Ptr[AVCodecContext], CFuncPtr4[Ptr[AVCodecContext], Ptr[Byte], CInt, CInt, CInt], Ptr[Byte], Ptr[CInt], CInt, CInt]].toInt)
      res(122) = align(res(121) + sizeof[CFuncPtr5[Ptr[AVCodecContext], CFuncPtr4[Ptr[AVCodecContext], Ptr[Byte], CInt, CInt, CInt], Ptr[Byte], Ptr[CInt], CInt, CInt]].toInt, alignmentof[CInt].toInt)
      res(123) = align(res(122) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(124) = align(res(123) + sizeof[CInt].toInt, alignmentof[CUnsignedInt].toInt)
      res(125) = align(res(124) + sizeof[CUnsignedInt].toInt, alignmentof[AVDiscard].toInt)
      res(126) = align(res(125) + sizeof[AVDiscard].toInt, alignmentof[AVDiscard].toInt)
      res(127) = align(res(126) + sizeof[AVDiscard].toInt, alignmentof[AVDiscard].toInt)
      res(128) = align(res(127) + sizeof[AVDiscard].toInt, alignmentof[CInt].toInt)
      ...
      res(132) = align(res(131) + sizeof[CInt].toInt, alignmentof[Ptr[AVCodecDescriptor]].toInt)
      res(133) = align(res(132) + sizeof[Ptr[AVCodecDescriptor]].toInt, alignmentof[CString].toInt)
      res(134) = align(res(133) + sizeof[CString].toInt, alignmentof[CInt].toInt)
      res(135) = align(res(134) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(136) = align(res(135) + sizeof[CInt].toInt, alignmentof[Ptr[uint8_t]].toInt)
      res(137) = align(res(136) + sizeof[Ptr[uint8_t]].toInt, alignmentof[Ptr[uint8_t]].toInt)
      res(138) = align(res(137) + sizeof[Ptr[uint8_t]].toInt, alignmentof[CString].toInt)
      res(139) = align(res(138) + sizeof[CString].toInt, alignmentof[Ptr[AVPacketSideData]].toInt)
      res(140) = align(res(139) + sizeof[Ptr[AVPacketSideData]].toInt, alignmentof[CInt].toInt)
      res(141) = align(res(140) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(142) = align(res(141) + sizeof[CInt].toInt, alignmentof[int64_t].toInt)
      res(143) = align(res(142) + sizeof[int64_t].toInt, alignmentof[CInt].toInt)
      res(144) = align(res(143) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(145) = align(res(144) + sizeof[CInt].toInt, alignmentof[int64_t].toInt)
      res(146) = align(res(145) + sizeof[int64_t].toInt, alignmentof[CFuncPtr3[Ptr[AVCodecContext], Ptr[AVPacket], CInt, CInt]].toInt)
      res(147) = align(res(146) + sizeof[CFuncPtr3[Ptr[AVCodecContext], Ptr[AVPacket], CInt, CInt]].toInt, alignmentof[int64_t].toInt)
      res(148) = align(res(147) + sizeof[int64_t].toInt, alignmentof[Ptr[CInt]].toInt)
      res(149) = align(res(148) + sizeof[Ptr[CInt]].toInt, alignmentof[CUnsignedInt].toInt)
      res(150) = align(res(149) + sizeof[CUnsignedInt].toInt, alignmentof[Ptr[Ptr[AVFrameSideData]]].toInt)
      res(151) = align(res(150) + sizeof[Ptr[Ptr[AVFrameSideData]]].toInt, alignmentof[CInt].toInt)
      res
    end offsets
  ...
  */
  ...
  object AVCodecParser:
    ...
    extension (struct: AVCodecParser)
      ...
      def parser_init_=(value: CFuncPtr1[Ptr[AVCodecParserContext], CInt]): Unit = !struct.at3 = value
      def parser_parse : CFuncPtr6[Ptr[AVCodecParserContext], Ptr[AVCodecContext], Ptr[Ptr[uint8_t]], Ptr[CInt], Ptr[uint8_t], CInt, CInt] = struct._4
      def parser_parse_=(value: CFuncPtr6[Ptr[AVCodecParserContext], Ptr[AVCodecContext], Ptr[Ptr[uint8_t]], Ptr[CInt], Ptr[uint8_t], CInt, CInt]): Unit = !struct.at4 = value
      def parser_close : CFuncPtr1[Ptr[AVCodecParserContext], Unit] = struct._5
      def parser_close_=(value: CFuncPtr1[Ptr[AVCodecParserContext], Unit]): Unit = !struct.at5 = value
      def split : CFuncPtr3[Ptr[AVCodecContext], Ptr[uint8_t], CInt, CInt] = struct._6
      def split_=(value: CFuncPtr3[Ptr[AVCodecContext], Ptr[uint8_t], CInt, CInt]): Unit = !struct.at6 = value
  ...
  object AVCodecParserContext:
    ...
    extension (struct: AVCodecParserContext)
      def priv_data: Ptr[Byte] = !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[Byte]]]
      def priv_data_=(value: Ptr[Byte]): Unit = !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def parser: Ptr[AVCodecParser] = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[AVCodecParser]]]
      def parser_=(value: Ptr[AVCodecParser]): Unit = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[AVCodecParser]]] = value
      def frame_offset: int64_t = !struct.at(offsets(2)).asInstanceOf[Ptr[int64_t]]
      def frame_offset_=(value: int64_t): Unit = !struct.at(offsets(2)).asInstanceOf[Ptr[int64_t]] = value
      def cur_offset: int64_t = !struct.at(offsets(3)).asInstanceOf[Ptr[int64_t]]
      def cur_offset_=(value: int64_t): Unit = !struct.at(offsets(3)).asInstanceOf[Ptr[int64_t]] = value
      def next_frame_offset: int64_t = !struct.at(offsets(4)).asInstanceOf[Ptr[int64_t]]
      def next_frame_offset_=(value: int64_t): Unit = !struct.at(offsets(4)).asInstanceOf[Ptr[int64_t]] = value
      def pict_type: CInt = !struct.at(offsets(5)).asInstanceOf[Ptr[CInt]]
      def pict_type_=(value: CInt): Unit = !struct.at(offsets(5)).asInstanceOf[Ptr[CInt]] = value
      def repeat_pict: CInt = !struct.at(offsets(6)).asInstanceOf[Ptr[CInt]]
      def repeat_pict_=(value: CInt): Unit = !struct.at(offsets(6)).asInstanceOf[Ptr[CInt]] = value
      def pts: int64_t = !struct.at(offsets(7)).asInstanceOf[Ptr[int64_t]]
      def pts_=(value: int64_t): Unit = !struct.at(offsets(7)).asInstanceOf[Ptr[int64_t]] = value
      def dts: int64_t = !struct.at(offsets(8)).asInstanceOf[Ptr[int64_t]]
      def dts_=(value: int64_t): Unit = !struct.at(offsets(8)).asInstanceOf[Ptr[int64_t]] = value
      def last_pts: int64_t = !struct.at(offsets(9)).asInstanceOf[Ptr[int64_t]]
      def last_pts_=(value: int64_t): Unit = !struct.at(offsets(9)).asInstanceOf[Ptr[int64_t]] = value
      def last_dts: int64_t = !struct.at(offsets(10)).asInstanceOf[Ptr[int64_t]]
      def last_dts_=(value: int64_t): Unit = !struct.at(offsets(10)).asInstanceOf[Ptr[int64_t]] = value
      def fetch_timestamp: CInt = !struct.at(offsets(11)).asInstanceOf[Ptr[CInt]]
      def fetch_timestamp_=(value: CInt): Unit = !struct.at(offsets(11)).asInstanceOf[Ptr[CInt]] = value
      def cur_frame_start_index: CInt = !struct.at(offsets(12)).asInstanceOf[Ptr[CInt]]
      def cur_frame_start_index_=(value: CInt): Unit = !struct.at(offsets(12)).asInstanceOf[Ptr[CInt]] = value
      def cur_frame_offset: CArray[int64_t, Nat._4] = !struct.at(offsets(13)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]]
      def cur_frame_offset_=(value: CArray[int64_t, Nat._4]): Unit = !struct.at(offsets(13)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]] = value
      def cur_frame_pts: CArray[int64_t, Nat._4] = !struct.at(offsets(14)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]]
      def cur_frame_pts_=(value: CArray[int64_t, Nat._4]): Unit = !struct.at(offsets(14)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]] = value
      def cur_frame_dts: CArray[int64_t, Nat._4] = !struct.at(offsets(15)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]]
      def cur_frame_dts_=(value: CArray[int64_t, Nat._4]): Unit = !struct.at(offsets(15)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]] = value
      def flags: CInt = !struct.at(offsets(16)).asInstanceOf[Ptr[CInt]]
      def flags_=(value: CInt): Unit = !struct.at(offsets(16)).asInstanceOf[Ptr[CInt]] = value
      def offset: int64_t = !struct.at(offsets(17)).asInstanceOf[Ptr[int64_t]]
      def offset_=(value: int64_t): Unit = !struct.at(offsets(17)).asInstanceOf[Ptr[int64_t]] = value
      def cur_frame_end: CArray[int64_t, Nat._4] = !struct.at(offsets(18)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]]
      def cur_frame_end_=(value: CArray[int64_t, Nat._4]): Unit = !struct.at(offsets(18)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]] = value
      def key_frame: CInt = !struct.at(offsets(19)).asInstanceOf[Ptr[CInt]]
      def key_frame_=(value: CInt): Unit = !struct.at(offsets(19)).asInstanceOf[Ptr[CInt]] = value
      def dts_sync_point: CInt = !struct.at(offsets(20)).asInstanceOf[Ptr[CInt]]
      def dts_sync_point_=(value: CInt): Unit = !struct.at(offsets(20)).asInstanceOf[Ptr[CInt]] = value
      def dts_ref_dts_delta: CInt = !struct.at(offsets(21)).asInstanceOf[Ptr[CInt]]
      def dts_ref_dts_delta_=(value: CInt): Unit = !struct.at(offsets(21)).asInstanceOf[Ptr[CInt]] = value
      def pts_dts_delta: CInt = !struct.at(offsets(22)).asInstanceOf[Ptr[CInt]]
      def pts_dts_delta_=(value: CInt): Unit = !struct.at(offsets(22)).asInstanceOf[Ptr[CInt]] = value
      def cur_frame_pos: CArray[int64_t, Nat._4] = !struct.at(offsets(23)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]]
      def cur_frame_pos_=(value: CArray[int64_t, Nat._4]): Unit = !struct.at(offsets(23)).asInstanceOf[Ptr[CArray[int64_t, Nat._4]]] = value
      def pos: int64_t = !struct.at(offsets(24)).asInstanceOf[Ptr[int64_t]]
      def pos_=(value: int64_t): Unit = !struct.at(offsets(24)).asInstanceOf[Ptr[int64_t]] = value
      def last_pos: int64_t = !struct.at(offsets(25)).asInstanceOf[Ptr[int64_t]]
      def last_pos_=(value: int64_t): Unit = !struct.at(offsets(25)).asInstanceOf[Ptr[int64_t]] = value
      def duration: CInt = !struct.at(offsets(26)).asInstanceOf[Ptr[CInt]]
      def duration_=(value: CInt): Unit = !struct.at(offsets(26)).asInstanceOf[Ptr[CInt]] = value
      def field_order: AVFieldOrder = !struct.at(offsets(27)).asInstanceOf[Ptr[AVFieldOrder]]
      def field_order_=(value: AVFieldOrder): Unit = !struct.at(offsets(27)).asInstanceOf[Ptr[AVFieldOrder]] = value
      def picture_structure: AVPictureStructure = !struct.at(offsets(28)).asInstanceOf[Ptr[AVPictureStructure]]
      def picture_structure_=(value: AVPictureStructure): Unit = !struct.at(offsets(28)).asInstanceOf[Ptr[AVPictureStructure]] = value
      def output_picture_number: CInt = !struct.at(offsets(29)).asInstanceOf[Ptr[CInt]]
      def output_picture_number_=(value: CInt): Unit = !struct.at(offsets(29)).asInstanceOf[Ptr[CInt]] = value
      def width: CInt = !struct.at(offsets(30)).asInstanceOf[Ptr[CInt]]
      def width_=(value: CInt): Unit = !struct.at(offsets(30)).asInstanceOf[Ptr[CInt]] = value
      def height: CInt = !struct.at(offsets(31)).asInstanceOf[Ptr[CInt]]
      def height_=(value: CInt): Unit = !struct.at(offsets(31)).asInstanceOf[Ptr[CInt]] = value
      def coded_width: CInt = !struct.at(offsets(32)).asInstanceOf[Ptr[CInt]]
      def coded_width_=(value: CInt): Unit = !struct.at(offsets(32)).asInstanceOf[Ptr[CInt]] = value
      def coded_height: CInt = !struct.at(offsets(33)).asInstanceOf[Ptr[CInt]]
      def coded_height_=(value: CInt): Unit = !struct.at(offsets(33)).asInstanceOf[Ptr[CInt]] = value
      def format: CInt = !struct.at(offsets(34)).asInstanceOf[Ptr[CInt]]
      def format_=(value: CInt): Unit = !struct.at(offsets(34)).asInstanceOf[Ptr[CInt]] = value
    val offsets: Array[Int] =
  ...
  */
  ...
  object AVFormatContext:
    ...
    extension (struct: AVFormatContext)
      def av_class: Ptr[AVClass] = !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[AVClass]]]
      def av_class_=(value: Ptr[AVClass]): Unit = !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[AVClass]]] = value
      def iformat: Ptr[AVInputFormat] = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[AVInputFormat]]]
      def iformat_=(value: Ptr[AVInputFormat]): Unit = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[AVInputFormat]]] = value
      def oformat: Ptr[AVOutputFormat] = !struct.at(offsets(2)).asInstanceOf[Ptr[Ptr[AVOutputFormat]]]
      def oformat_=(value: Ptr[AVOutputFormat]): Unit = !struct.at(offsets(2)).asInstanceOf[Ptr[Ptr[AVOutputFormat]]] = value
      def priv_data: Ptr[Byte] = !struct.at(offsets(3)).asInstanceOf[Ptr[Ptr[Byte]]]
      def priv_data_=(value: Ptr[Byte]): Unit = !struct.at(offsets(3)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def pb: Ptr[AVIOContext] = !struct.at(offsets(4)).asInstanceOf[Ptr[Ptr[AVIOContext]]]
      def pb_=(value: Ptr[AVIOContext]): Unit = !struct.at(offsets(4)).asInstanceOf[Ptr[Ptr[AVIOContext]]] = value
      def ctx_flags: CInt = !struct.at(offsets(5)).asInstanceOf[Ptr[CInt]]
      def ctx_flags_=(value: CInt): Unit = !struct.at(offsets(5)).asInstanceOf[Ptr[CInt]] = value
      def nb_streams: CUnsignedInt = !struct.at(offsets(6)).asInstanceOf[Ptr[CUnsignedInt]]
      def nb_streams_=(value: CUnsignedInt): Unit = !struct.at(offsets(6)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def streams: Ptr[Ptr[AVStream]] = !struct.at(offsets(7)).asInstanceOf[Ptr[Ptr[Ptr[AVStream]]]]
      def streams_=(value: Ptr[Ptr[AVStream]]): Unit = !struct.at(offsets(7)).asInstanceOf[Ptr[Ptr[Ptr[AVStream]]]] = value
      def nb_stream_groups: CUnsignedInt = !struct.at(offsets(8)).asInstanceOf[Ptr[CUnsignedInt]]
      def nb_stream_groups_=(value: CUnsignedInt): Unit = !struct.at(offsets(8)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def stream_groups: Ptr[Ptr[AVStreamGroup]] = !struct.at(offsets(9)).asInstanceOf[Ptr[Ptr[Ptr[AVStreamGroup]]]]
      def stream_groups_=(value: Ptr[Ptr[AVStreamGroup]]): Unit = !struct.at(offsets(9)).asInstanceOf[Ptr[Ptr[Ptr[AVStreamGroup]]]] = value
      def nb_chapters: CUnsignedInt = !struct.at(offsets(10)).asInstanceOf[Ptr[CUnsignedInt]]
      def nb_chapters_=(value: CUnsignedInt): Unit = !struct.at(offsets(10)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def chapters: Ptr[Ptr[AVChapter]] = !struct.at(offsets(11)).asInstanceOf[Ptr[Ptr[Ptr[AVChapter]]]]
      def chapters_=(value: Ptr[Ptr[AVChapter]]): Unit = !struct.at(offsets(11)).asInstanceOf[Ptr[Ptr[Ptr[AVChapter]]]] = value
      def url: CString = !struct.at(offsets(12)).asInstanceOf[Ptr[CString]]
      def url_=(value: CString): Unit = !struct.at(offsets(12)).asInstanceOf[Ptr[CString]] = value
      def start_time: int64_t = !struct.at(offsets(13)).asInstanceOf[Ptr[int64_t]]
      def start_time_=(value: int64_t): Unit = !struct.at(offsets(13)).asInstanceOf[Ptr[int64_t]] = value
      def duration: int64_t = !struct.at(offsets(14)).asInstanceOf[Ptr[int64_t]]
      def duration_=(value: int64_t): Unit = !struct.at(offsets(14)).asInstanceOf[Ptr[int64_t]] = value
      def bit_rate: int64_t = !struct.at(offsets(15)).asInstanceOf[Ptr[int64_t]]
      def bit_rate_=(value: int64_t): Unit = !struct.at(offsets(15)).asInstanceOf[Ptr[int64_t]] = value
      def packet_size: CUnsignedInt = !struct.at(offsets(16)).asInstanceOf[Ptr[CUnsignedInt]]
      def packet_size_=(value: CUnsignedInt): Unit = !struct.at(offsets(16)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def max_delay: CInt = !struct.at(offsets(17)).asInstanceOf[Ptr[CInt]]
      def max_delay_=(value: CInt): Unit = !struct.at(offsets(17)).asInstanceOf[Ptr[CInt]] = value
      def flags: CInt = !struct.at(offsets(18)).asInstanceOf[Ptr[CInt]]
      def flags_=(value: CInt): Unit = !struct.at(offsets(18)).asInstanceOf[Ptr[CInt]] = value
      def probesize: int64_t = !struct.at(offsets(19)).asInstanceOf[Ptr[int64_t]]
      def probesize_=(value: int64_t): Unit = !struct.at(offsets(19)).asInstanceOf[Ptr[int64_t]] = value
      def max_analyze_duration: int64_t = !struct.at(offsets(20)).asInstanceOf[Ptr[int64_t]]
      def max_analyze_duration_=(value: int64_t): Unit = !struct.at(offsets(20)).asInstanceOf[Ptr[int64_t]] = value
      def key: Ptr[uint8_t] = !struct.at(offsets(21)).asInstanceOf[Ptr[Ptr[uint8_t]]]
      def key_=(value: Ptr[uint8_t]): Unit = !struct.at(offsets(21)).asInstanceOf[Ptr[Ptr[uint8_t]]] = value
      def keylen: CInt = !struct.at(offsets(22)).asInstanceOf[Ptr[CInt]]
      def keylen_=(value: CInt): Unit = !struct.at(offsets(22)).asInstanceOf[Ptr[CInt]] = value
      def nb_programs: CUnsignedInt = !struct.at(offsets(23)).asInstanceOf[Ptr[CUnsignedInt]]
      def nb_programs_=(value: CUnsignedInt): Unit = !struct.at(offsets(23)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def programs: Ptr[Ptr[AVProgram]] = !struct.at(offsets(24)).asInstanceOf[Ptr[Ptr[Ptr[AVProgram]]]]
      def programs_=(value: Ptr[Ptr[AVProgram]]): Unit = !struct.at(offsets(24)).asInstanceOf[Ptr[Ptr[Ptr[AVProgram]]]] = value
      def video_codec_id: AVCodecID = !struct.at(offsets(25)).asInstanceOf[Ptr[AVCodecID]]
      def video_codec_id_=(value: AVCodecID): Unit = !struct.at(offsets(25)).asInstanceOf[Ptr[AVCodecID]] = value
      def audio_codec_id: AVCodecID = !struct.at(offsets(26)).asInstanceOf[Ptr[AVCodecID]]
      def audio_codec_id_=(value: AVCodecID): Unit = !struct.at(offsets(26)).asInstanceOf[Ptr[AVCodecID]] = value
      def subtitle_codec_id: AVCodecID = !struct.at(offsets(27)).asInstanceOf[Ptr[AVCodecID]]
      def subtitle_codec_id_=(value: AVCodecID): Unit = !struct.at(offsets(27)).asInstanceOf[Ptr[AVCodecID]] = value
      def data_codec_id: AVCodecID = !struct.at(offsets(28)).asInstanceOf[Ptr[AVCodecID]]
      def data_codec_id_=(value: AVCodecID): Unit = !struct.at(offsets(28)).asInstanceOf[Ptr[AVCodecID]] = value
      def metadata: Ptr[AVDictionary] = !struct.at(offsets(29)).asInstanceOf[Ptr[Ptr[AVDictionary]]]
      def metadata_=(value: Ptr[AVDictionary]): Unit = !struct.at(offsets(29)).asInstanceOf[Ptr[Ptr[AVDictionary]]] = value
      def start_time_realtime: int64_t = !struct.at(offsets(30)).asInstanceOf[Ptr[int64_t]]
      def start_time_realtime_=(value: int64_t): Unit = !struct.at(offsets(30)).asInstanceOf[Ptr[int64_t]] = value
      def fps_probe_size: CInt = !struct.at(offsets(31)).asInstanceOf[Ptr[CInt]]
      def fps_probe_size_=(value: CInt): Unit = !struct.at(offsets(31)).asInstanceOf[Ptr[CInt]] = value
      def error_recognition: CInt = !struct.at(offsets(32)).asInstanceOf[Ptr[CInt]]
      def error_recognition_=(value: CInt): Unit = !struct.at(offsets(32)).asInstanceOf[Ptr[CInt]] = value
      def interrupt_callback: AVIOInterruptCB = !struct.at(offsets(33)).asInstanceOf[Ptr[AVIOInterruptCB]]
      def interrupt_callback_=(value: AVIOInterruptCB): Unit = !struct.at(offsets(33)).asInstanceOf[Ptr[AVIOInterruptCB]] = value
      def debug: CInt = !struct.at(offsets(34)).asInstanceOf[Ptr[CInt]]
      def debug_=(value: CInt): Unit = !struct.at(offsets(34)).asInstanceOf[Ptr[CInt]] = value
      def max_streams: CInt = !struct.at(offsets(35)).asInstanceOf[Ptr[CInt]]
      def max_streams_=(value: CInt): Unit = !struct.at(offsets(35)).asInstanceOf[Ptr[CInt]] = value
      def max_index_size: CUnsignedInt = !struct.at(offsets(36)).asInstanceOf[Ptr[CUnsignedInt]]
      def max_index_size_=(value: CUnsignedInt): Unit = !struct.at(offsets(36)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def max_picture_buffer: CUnsignedInt = !struct.at(offsets(37)).asInstanceOf[Ptr[CUnsignedInt]]
      def max_picture_buffer_=(value: CUnsignedInt): Unit = !struct.at(offsets(37)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def max_interleave_delta: int64_t = !struct.at(offsets(38)).asInstanceOf[Ptr[int64_t]]
      def max_interleave_delta_=(value: int64_t): Unit = !struct.at(offsets(38)).asInstanceOf[Ptr[int64_t]] = value
      def max_ts_probe: CInt = !struct.at(offsets(39)).asInstanceOf[Ptr[CInt]]
      def max_ts_probe_=(value: CInt): Unit = !struct.at(offsets(39)).asInstanceOf[Ptr[CInt]] = value
      def max_chunk_duration: CInt = !struct.at(offsets(40)).asInstanceOf[Ptr[CInt]]
      def max_chunk_duration_=(value: CInt): Unit = !struct.at(offsets(40)).asInstanceOf[Ptr[CInt]] = value
      def max_chunk_size: CInt = !struct.at(offsets(41)).asInstanceOf[Ptr[CInt]]
      def max_chunk_size_=(value: CInt): Unit = !struct.at(offsets(41)).asInstanceOf[Ptr[CInt]] = value
      def max_probe_packets: CInt = !struct.at(offsets(42)).asInstanceOf[Ptr[CInt]]
      def max_probe_packets_=(value: CInt): Unit = !struct.at(offsets(42)).asInstanceOf[Ptr[CInt]] = value
      def strict_std_compliance: CInt = !struct.at(offsets(43)).asInstanceOf[Ptr[CInt]]
      def strict_std_compliance_=(value: CInt): Unit = !struct.at(offsets(43)).asInstanceOf[Ptr[CInt]] = value
      def event_flags: CInt = !struct.at(offsets(44)).asInstanceOf[Ptr[CInt]]
      def event_flags_=(value: CInt): Unit = !struct.at(offsets(44)).asInstanceOf[Ptr[CInt]] = value
      def avoid_negative_ts: CInt = !struct.at(offsets(45)).asInstanceOf[Ptr[CInt]]
      def avoid_negative_ts_=(value: CInt): Unit = !struct.at(offsets(45)).asInstanceOf[Ptr[CInt]] = value
      def audio_preload: CInt = !struct.at(offsets(46)).asInstanceOf[Ptr[CInt]]
      def audio_preload_=(value: CInt): Unit = !struct.at(offsets(46)).asInstanceOf[Ptr[CInt]] = value
      def use_wallclock_as_timestamps: CInt = !struct.at(offsets(47)).asInstanceOf[Ptr[CInt]]
      def use_wallclock_as_timestamps_=(value: CInt): Unit = !struct.at(offsets(47)).asInstanceOf[Ptr[CInt]] = value
      def skip_estimate_duration_from_pts: CInt = !struct.at(offsets(48)).asInstanceOf[Ptr[CInt]]
      def skip_estimate_duration_from_pts_=(value: CInt): Unit = !struct.at(offsets(48)).asInstanceOf[Ptr[CInt]] = value
      def avio_flags: CInt = !struct.at(offsets(49)).asInstanceOf[Ptr[CInt]]
      def avio_flags_=(value: CInt): Unit = !struct.at(offsets(49)).asInstanceOf[Ptr[CInt]] = value
      def duration_estimation_method: AVDurationEstimationMethod = !struct.at(offsets(50)).asInstanceOf[Ptr[AVDurationEstimationMethod]]
      def duration_estimation_method_=(value: AVDurationEstimationMethod): Unit = !struct.at(offsets(50)).asInstanceOf[Ptr[AVDurationEstimationMethod]] = value
      def skip_initial_bytes: int64_t = !struct.at(offsets(51)).asInstanceOf[Ptr[int64_t]]
      def skip_initial_bytes_=(value: int64_t): Unit = !struct.at(offsets(51)).asInstanceOf[Ptr[int64_t]] = value
      def correct_ts_overflow: CUnsignedInt = !struct.at(offsets(52)).asInstanceOf[Ptr[CUnsignedInt]]
      def correct_ts_overflow_=(value: CUnsignedInt): Unit = !struct.at(offsets(52)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def seek2any: CInt = !struct.at(offsets(53)).asInstanceOf[Ptr[CInt]]
      def seek2any_=(value: CInt): Unit = !struct.at(offsets(53)).asInstanceOf[Ptr[CInt]] = value
      def flush_packets: CInt = !struct.at(offsets(54)).asInstanceOf[Ptr[CInt]]
      def flush_packets_=(value: CInt): Unit = !struct.at(offsets(54)).asInstanceOf[Ptr[CInt]] = value
      def probe_score: CInt = !struct.at(offsets(55)).asInstanceOf[Ptr[CInt]]
      def probe_score_=(value: CInt): Unit = !struct.at(offsets(55)).asInstanceOf[Ptr[CInt]] = value
      def format_probesize: CInt = !struct.at(offsets(56)).asInstanceOf[Ptr[CInt]]
      def format_probesize_=(value: CInt): Unit = !struct.at(offsets(56)).asInstanceOf[Ptr[CInt]] = value
      def codec_whitelist: CString = !struct.at(offsets(57)).asInstanceOf[Ptr[CString]]
      def codec_whitelist_=(value: CString): Unit = !struct.at(offsets(57)).asInstanceOf[Ptr[CString]] = value
      def format_whitelist: CString = !struct.at(offsets(58)).asInstanceOf[Ptr[CString]]
      def format_whitelist_=(value: CString): Unit = !struct.at(offsets(58)).asInstanceOf[Ptr[CString]] = value
      def protocol_whitelist: CString = !struct.at(offsets(59)).asInstanceOf[Ptr[CString]]
      def protocol_whitelist_=(value: CString): Unit = !struct.at(offsets(59)).asInstanceOf[Ptr[CString]] = value
      def protocol_blacklist: CString = !struct.at(offsets(60)).asInstanceOf[Ptr[CString]]
      def protocol_blacklist_=(value: CString): Unit = !struct.at(offsets(60)).asInstanceOf[Ptr[CString]] = value
      def io_repositioned: CInt = !struct.at(offsets(61)).asInstanceOf[Ptr[CInt]]
      def io_repositioned_=(value: CInt): Unit = !struct.at(offsets(61)).asInstanceOf[Ptr[CInt]] = value
      def video_codec: Ptr[AVCodec] = !struct.at(offsets(62)).asInstanceOf[Ptr[Ptr[AVCodec]]]
      def video_codec_=(value: Ptr[AVCodec]): Unit = !struct.at(offsets(62)).asInstanceOf[Ptr[Ptr[AVCodec]]] = value
      def audio_codec: Ptr[AVCodec] = !struct.at(offsets(63)).asInstanceOf[Ptr[Ptr[AVCodec]]]
      def audio_codec_=(value: Ptr[AVCodec]): Unit = !struct.at(offsets(63)).asInstanceOf[Ptr[Ptr[AVCodec]]] = value
      def subtitle_codec: Ptr[AVCodec] = !struct.at(offsets(64)).asInstanceOf[Ptr[Ptr[AVCodec]]]
      def subtitle_codec_=(value: Ptr[AVCodec]): Unit = !struct.at(offsets(64)).asInstanceOf[Ptr[Ptr[AVCodec]]] = value
      def data_codec: Ptr[AVCodec] = !struct.at(offsets(65)).asInstanceOf[Ptr[Ptr[AVCodec]]]
      def data_codec_=(value: Ptr[AVCodec]): Unit = !struct.at(offsets(65)).asInstanceOf[Ptr[Ptr[AVCodec]]] = value
      def metadata_header_padding: CInt = !struct.at(offsets(66)).asInstanceOf[Ptr[CInt]]
      def metadata_header_padding_=(value: CInt): Unit = !struct.at(offsets(66)).asInstanceOf[Ptr[CInt]] = value
      def opaque: Ptr[Byte] = !struct.at(offsets(67)).asInstanceOf[Ptr[Ptr[Byte]]]
      def opaque_=(value: Ptr[Byte]): Unit = !struct.at(offsets(67)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def control_message_cb: av_format_control_message = !struct.at(offsets(68)).asInstanceOf[Ptr[av_format_control_message]]
      def control_message_cb_=(value: av_format_control_message): Unit = !struct.at(offsets(68)).asInstanceOf[Ptr[av_format_control_message]] = value
      def output_ts_offset: int64_t = !struct.at(offsets(69)).asInstanceOf[Ptr[int64_t]]
      def output_ts_offset_=(value: int64_t): Unit = !struct.at(offsets(69)).asInstanceOf[Ptr[int64_t]] = value
      def dump_separator: Ptr[uint8_t] = !struct.at(offsets(70)).asInstanceOf[Ptr[Ptr[uint8_t]]]
      def dump_separator_=(value: Ptr[uint8_t]): Unit = !struct.at(offsets(70)).asInstanceOf[Ptr[Ptr[uint8_t]]] = value
      def io_open: CFuncPtr5[Ptr[AVFormatContext], Ptr[Ptr[AVIOContext]], CString, CInt, Ptr[Ptr[AVDictionary]], CInt] = !struct.at(offsets(71)).asInstanceOf[Ptr[CFuncPtr5[Ptr[AVFormatContext], Ptr[Ptr[AVIOContext]], CString, CInt, Ptr[Ptr[AVDictionary]], CInt]]]
      def io_open_=(value: CFuncPtr5[Ptr[AVFormatContext], Ptr[Ptr[AVIOContext]], CString, CInt, Ptr[Ptr[AVDictionary]], CInt]): Unit = !struct.at(offsets(71)).asInstanceOf[Ptr[CFuncPtr5[Ptr[AVFormatContext], Ptr[Ptr[AVIOContext]], CString, CInt, Ptr[Ptr[AVDictionary]], CInt]]] = value
      def io_close2: CFuncPtr2[Ptr[AVFormatContext], Ptr[AVIOContext], CInt] = !struct.at(offsets(72)).asInstanceOf[Ptr[CFuncPtr2[Ptr[AVFormatContext], Ptr[AVIOContext], CInt]]]
      def io_close2_=(value: CFuncPtr2[Ptr[AVFormatContext], Ptr[AVIOContext], CInt]): Unit = !struct.at(offsets(72)).asInstanceOf[Ptr[CFuncPtr2[Ptr[AVFormatContext], Ptr[AVIOContext], CInt]]] = value
      def duration_probesize: int64_t = !struct.at(offsets(73)).asInstanceOf[Ptr[int64_t]]
      def duration_probesize_=(value: int64_t): Unit = !struct.at(offsets(73)).asInstanceOf[Ptr[int64_t]] = value
    val offsets: Array[Int] =
  ...
  */
  ...
  object AVHWDeviceContext:
    ...
    extension (struct: AVHWDeviceContext)
      ...
      def av_class_=(value: Ptr[AVClass]): Unit = !struct.at1 = value.asInstanceOf[Ptr[Byte]]
      ...
      def free : CFuncPtr1[Ptr[AVHWDeviceContext], Unit] = struct._4.asInstanceOf[CFuncPtr1[Ptr[AVHWDeviceContext], Unit]]
      def free_=(value: CFuncPtr1[Ptr[AVHWDeviceContext], Unit]): Unit = !struct.at4 = value.asInstanceOf[CFuncPtr1[Ptr[Byte], Unit]]
  ...
  */
  ...
  object AVHWFramesConstraints:
    ...
    extension (struct: AVHWFramesConstraints)
      ...
      def valid_hw_formats_=(value: Ptr[AVPixelFormat]): Unit = !struct.at1 = value
      def valid_sw_formats : Ptr[AVPixelFormat] = struct._2
      def valid_sw_formats_=(value: Ptr[AVPixelFormat]): Unit = !struct.at2 = value
  ...
  */
  ...
  object AVHWFramesContext:
    ...
    extension (struct: AVHWFramesContext)
      ...
      def device_ctx : Ptr[AVHWDeviceContext] = struct._3.asInstanceOf[Ptr[AVHWDeviceContext]]
      def device_ctx_=(value: Ptr[AVHWDeviceContext]): Unit = !struct.at3 = value.asInstanceOf[Ptr[Byte]]
      def hwctx : Ptr[Byte] = struct._4
      def hwctx_=(value: Ptr[Byte]): Unit = !struct.at4 = value
      def free : CFuncPtr1[Ptr[AVHWFramesContext], Unit] = struct._5.asInstanceOf[CFuncPtr1[Ptr[AVHWFramesContext], Unit]]
      def free_=(value: CFuncPtr1[Ptr[AVHWFramesContext], Unit]): Unit = !struct.at5 = value.asInstanceOf[CFuncPtr1[Ptr[Byte], Unit]]
  ...
  */
  ...
  object AVIOContext:
    ...
    extension (struct: AVIOContext)
      def av_class: Ptr[AVClass] = !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[AVClass]]]
      def av_class_=(value: Ptr[AVClass]): Unit = !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[AVClass]]] = value
      def buffer: Ptr[CUnsignedChar] = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]]
      def buffer_=(value: Ptr[CUnsignedChar]): Unit = !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]] = value
      def buffer_size: CInt = !struct.at(offsets(2)).asInstanceOf[Ptr[CInt]]
      def buffer_size_=(value: CInt): Unit = !struct.at(offsets(2)).asInstanceOf[Ptr[CInt]] = value
      def buf_ptr: Ptr[CUnsignedChar] = !struct.at(offsets(3)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]]
      def buf_ptr_=(value: Ptr[CUnsignedChar]): Unit = !struct.at(offsets(3)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]] = value
      def buf_end: Ptr[CUnsignedChar] = !struct.at(offsets(4)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]]
      def buf_end_=(value: Ptr[CUnsignedChar]): Unit = !struct.at(offsets(4)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]] = value
      def opaque: Ptr[Byte] = !struct.at(offsets(5)).asInstanceOf[Ptr[Ptr[Byte]]]
      def opaque_=(value: Ptr[Byte]): Unit = !struct.at(offsets(5)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def read_packet: CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt] = !struct.at(offsets(6)).asInstanceOf[Ptr[CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt]]]
      def read_packet_=(value: CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt]): Unit = !struct.at(offsets(6)).asInstanceOf[Ptr[CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt]]] = value
      def write_packet: CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt] = !struct.at(offsets(7)).asInstanceOf[Ptr[CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt]]]
      def write_packet_=(value: CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt]): Unit = !struct.at(offsets(7)).asInstanceOf[Ptr[CFuncPtr3[Ptr[Byte], Ptr[uint8_t], CInt, CInt]]] = value
      def seek: CFuncPtr3[Ptr[Byte], int64_t, CInt, int64_t] = !struct.at(offsets(8)).asInstanceOf[Ptr[CFuncPtr3[Ptr[Byte], int64_t, CInt, int64_t]]]
      def seek_=(value: CFuncPtr3[Ptr[Byte], int64_t, CInt, int64_t]): Unit = !struct.at(offsets(8)).asInstanceOf[Ptr[CFuncPtr3[Ptr[Byte], int64_t, CInt, int64_t]]] = value
      def pos: int64_t = !struct.at(offsets(9)).asInstanceOf[Ptr[int64_t]]
      def pos_=(value: int64_t): Unit = !struct.at(offsets(9)).asInstanceOf[Ptr[int64_t]] = value
      def eof_reached: CInt = !struct.at(offsets(10)).asInstanceOf[Ptr[CInt]]
      def eof_reached_=(value: CInt): Unit = !struct.at(offsets(10)).asInstanceOf[Ptr[CInt]] = value
      def error: CInt = !struct.at(offsets(11)).asInstanceOf[Ptr[CInt]]
      def error_=(value: CInt): Unit = !struct.at(offsets(11)).asInstanceOf[Ptr[CInt]] = value
      def write_flag: CInt = !struct.at(offsets(12)).asInstanceOf[Ptr[CInt]]
      def write_flag_=(value: CInt): Unit = !struct.at(offsets(12)).asInstanceOf[Ptr[CInt]] = value
      def max_packet_size: CInt = !struct.at(offsets(13)).asInstanceOf[Ptr[CInt]]
      def max_packet_size_=(value: CInt): Unit = !struct.at(offsets(13)).asInstanceOf[Ptr[CInt]] = value
      def min_packet_size: CInt = !struct.at(offsets(14)).asInstanceOf[Ptr[CInt]]
      def min_packet_size_=(value: CInt): Unit = !struct.at(offsets(14)).asInstanceOf[Ptr[CInt]] = value
      def checksum: CUnsignedLongInt = !struct.at(offsets(15)).asInstanceOf[Ptr[CUnsignedLongInt]]
      def checksum_=(value: CUnsignedLongInt): Unit = !struct.at(offsets(15)).asInstanceOf[Ptr[CUnsignedLongInt]] = value
      def checksum_ptr: Ptr[CUnsignedChar] = !struct.at(offsets(16)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]]
      def checksum_ptr_=(value: Ptr[CUnsignedChar]): Unit = !struct.at(offsets(16)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]] = value
      def update_checksum: CFuncPtr3[CUnsignedLongInt, Ptr[uint8_t], CUnsignedInt, CUnsignedLongInt] = !struct.at(offsets(17)).asInstanceOf[Ptr[CFuncPtr3[CUnsignedLongInt, Ptr[uint8_t], CUnsignedInt, CUnsignedLongInt]]]
      def update_checksum_=(value: CFuncPtr3[CUnsignedLongInt, Ptr[uint8_t], CUnsignedInt, CUnsignedLongInt]): Unit = !struct.at(offsets(17)).asInstanceOf[Ptr[CFuncPtr3[CUnsignedLongInt, Ptr[uint8_t], CUnsignedInt, CUnsignedLongInt]]] = value
      def read_pause: CFuncPtr2[Ptr[Byte], CInt, CInt] = !struct.at(offsets(18)).asInstanceOf[Ptr[CFuncPtr2[Ptr[Byte], CInt, CInt]]]
      def read_pause_=(value: CFuncPtr2[Ptr[Byte], CInt, CInt]): Unit = !struct.at(offsets(18)).asInstanceOf[Ptr[CFuncPtr2[Ptr[Byte], CInt, CInt]]] = value
      def read_seek: CFuncPtr4[Ptr[Byte], CInt, int64_t, CInt, int64_t] = !struct.at(offsets(19)).asInstanceOf[Ptr[CFuncPtr4[Ptr[Byte], CInt, int64_t, CInt, int64_t]]]
      def read_seek_=(value: CFuncPtr4[Ptr[Byte], CInt, int64_t, CInt, int64_t]): Unit = !struct.at(offsets(19)).asInstanceOf[Ptr[CFuncPtr4[Ptr[Byte], CInt, int64_t, CInt, int64_t]]] = value
      def seekable: CInt = !struct.at(offsets(20)).asInstanceOf[Ptr[CInt]]
      def seekable_=(value: CInt): Unit = !struct.at(offsets(20)).asInstanceOf[Ptr[CInt]] = value
      def direct: CInt = !struct.at(offsets(21)).asInstanceOf[Ptr[CInt]]
      def direct_=(value: CInt): Unit = !struct.at(offsets(21)).asInstanceOf[Ptr[CInt]] = value
      def protocol_whitelist: CString = !struct.at(offsets(22)).asInstanceOf[Ptr[CString]]
      def protocol_whitelist_=(value: CString): Unit = !struct.at(offsets(22)).asInstanceOf[Ptr[CString]] = value
      def protocol_blacklist: CString = !struct.at(offsets(23)).asInstanceOf[Ptr[CString]]
      def protocol_blacklist_=(value: CString): Unit = !struct.at(offsets(23)).asInstanceOf[Ptr[CString]] = value
      def write_data_type: CFuncPtr5[Ptr[Byte], Ptr[uint8_t], CInt, AVIODataMarkerType, int64_t, CInt] = !struct.at(offsets(24)).asInstanceOf[Ptr[CFuncPtr5[Ptr[Byte], Ptr[uint8_t], CInt, AVIODataMarkerType, int64_t, CInt]]]
      def write_data_type_=(value: CFuncPtr5[Ptr[Byte], Ptr[uint8_t], CInt, AVIODataMarkerType, int64_t, CInt]): Unit = !struct.at(offsets(24)).asInstanceOf[Ptr[CFuncPtr5[Ptr[Byte], Ptr[uint8_t], CInt, AVIODataMarkerType, int64_t, CInt]]] = value
      def ignore_boundary_point: CInt = !struct.at(offsets(25)).asInstanceOf[Ptr[CInt]]
      def ignore_boundary_point_=(value: CInt): Unit = !struct.at(offsets(25)).asInstanceOf[Ptr[CInt]] = value
      def buf_ptr_max: Ptr[CUnsignedChar] = !struct.at(offsets(26)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]]
      def buf_ptr_max_=(value: Ptr[CUnsignedChar]): Unit = !struct.at(offsets(26)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]] = value
      def bytes_read: int64_t = !struct.at(offsets(27)).asInstanceOf[Ptr[int64_t]]
      def bytes_read_=(value: int64_t): Unit = !struct.at(offsets(27)).asInstanceOf[Ptr[int64_t]] = value
      def bytes_written: int64_t = !struct.at(offsets(28)).asInstanceOf[Ptr[int64_t]]
      def bytes_written_=(value: int64_t): Unit = !struct.at(offsets(28)).asInstanceOf[Ptr[int64_t]] = value
    val offsets: Array[Int] =
  ...
  */
  ...
  object AVIOInterruptCB:
    ...
    extension (struct: AVIOInterruptCB)
      ...
      def callback_=(value: CFuncPtr1[Ptr[Byte], CInt]): Unit = !struct.at1 = value
  ...
  */
  ...
  object AVInputFormat:
    ...
    extension (struct: AVInputFormat)
      ...
      def priv_class_=(value: Ptr[AVClass]): Unit = !struct.at6 = value.asInstanceOf[Ptr[Byte]]
  ...
  */
  ...
  object AVOutputFormat:
    ...
    extension (struct: AVOutputFormat)
      ...
      def priv_class_=(value: Ptr[AVClass]): Unit = !struct.at10 = value.asInstanceOf[Ptr[Byte]]
  ...
  */
  ...
  object AVPacketList:
    ...
    extension (struct: AVPacketList)
      ...
      def next_=(value: Ptr[AVPacketList]): Unit = !struct.at2 = value.asInstanceOf[Ptr[Byte]]
  ...
  */
  ...
  object AVPanScan:
    ...
    extension (struct: AVPanScan)
      ...
      def position_=(value: CArray[CArray[int16_t, Nat._2], Nat._3]): Unit = !struct.at4 = value
  ...
  */
  opaque type AVStream = CStruct20[Ptr[Byte], CInt, CInt, Ptr[AVCodecParameters], Ptr[Byte], AVRational, int64_t, int64_t, int64_t, CInt, AVDiscard, AVRational, Ptr[AVDictionary], AVRational, AVPacket, Ptr[AVPacketSideData], CInt, CInt, AVRational, CInt]
  
  object AVStream:
    given _tag: Tag[AVStream] = Tag.materializeCStruct20Tag[Ptr[Byte], CInt, CInt, Ptr[AVCodecParameters], Ptr[Byte], AVRational, int64_t, int64_t, int64_t, CInt, AVDiscard, AVRational, Ptr[AVDictionary], AVRational, AVPacket, Ptr[AVPacketSideData], CInt, CInt, AVRational, CInt]
  ...
  opaque type AVStreamGroup = CStruct10[Ptr[Byte], Ptr[Byte], CUnsignedInt, int64_t, AVStreamGroupParamsType, AVStreamGroup.Params, Ptr[AVDictionary], CUnsignedInt, Ptr[Byte], CInt]
  
  object AVStreamGroup:
    given _tag: Tag[AVStreamGroup] = Tag.materializeCStruct10Tag[Ptr[Byte], Ptr[Byte], CUnsignedInt, int64_t, AVStreamGroupParamsType, AVStreamGroup.Params, Ptr[AVDictionary], CUnsignedInt, Ptr[Byte], CInt]
    ...
    def apply(av_class : Ptr[AVClass], priv_data : Ptr[Byte], index : CUnsignedInt, id : int64_t, `type` : AVStreamGroupParamsType, params : AVStreamGroup.Params, metadata : Ptr[AVDictionary], nb_streams : CUnsignedInt, streams : Ptr[Ptr[AVStream]], disposition : CInt)(using Zone): Ptr[AVStreamGroup] =
      val ____ptr = apply()
      (!____ptr).av_class = av_class
      (!____ptr).priv_data = priv_data
      (!____ptr).index = index
    ...
    extension (struct: AVStreamGroup)
      ...
      def streams : Ptr[Ptr[AVStream]] = struct._9.asInstanceOf[Ptr[Ptr[AVStream]]]
      def streams_=(value: Ptr[Ptr[AVStream]]): Unit = !struct.at9 = value.asInstanceOf[Ptr[Byte]]
      def disposition : CInt = struct._10
      def disposition_=(value: CInt): Unit = !struct.at10 = value
    ...
    */
    ...
    object Params:
      ...
      def apply(iamf_audio_element: Ptr[AVIAMFAudioElement])(using Zone): Ptr[Params] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Params](1)
        val un = !___ptr
      ...
      def apply(iamf_mix_presentation: Ptr[AVIAMFMixPresentation])(using Zone): Ptr[Params] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Params](1)
        val un = !___ptr
      ...
      def apply(tile_grid: Ptr[AVStreamGroupTileGrid])(using Zone): Ptr[Params] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Params](1)
        val un = !___ptr
      ...
      extension (struct: Params)
        def iamf_audio_element : Ptr[AVIAMFAudioElement] = !struct.at(0).asInstanceOf[Ptr[Ptr[AVIAMFAudioElement]]]
        def iamf_audio_element_=(value: Ptr[AVIAMFAudioElement]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[AVIAMFAudioElement]]] = value
        def iamf_mix_presentation : Ptr[AVIAMFMixPresentation] = !struct.at(0).asInstanceOf[Ptr[Ptr[AVIAMFMixPresentation]]]
        def iamf_mix_presentation_=(value: Ptr[AVIAMFMixPresentation]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[AVIAMFMixPresentation]]] = value
        def tile_grid : Ptr[AVStreamGroupTileGrid] = !struct.at(0).asInstanceOf[Ptr[Ptr[AVStreamGroupTileGrid]]]
        def tile_grid_=(value: Ptr[AVStreamGroupTileGrid]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[AVStreamGroupTileGrid]]] = value
        def lcevc : Ptr[AVStreamGroupLCEVC] = !struct.at(0).asInstanceOf[Ptr[Ptr[AVStreamGroupLCEVC]]]
        def lcevc_=(value: Ptr[AVStreamGroupLCEVC]): Unit = !struct.at(0).asInstanceOf[Ptr[Ptr[AVStreamGroupLCEVC]]] = value
  ...
  */
  opaque type AVStreamGroupTileGrid = CStruct10[Ptr[Byte], CUnsignedInt, CInt, CInt, Ptr[AVStreamGroupTileGrid.Offsets], CArray[uint8_t, Nat._4], CInt, CInt, CInt, CInt]
  
  object AVStreamGroupTileGrid:
    given _tag: Tag[AVStreamGroupTileGrid] = Tag.materializeCStruct10Tag[Ptr[Byte], CUnsignedInt, CInt, CInt, Ptr[AVStreamGroupTileGrid.Offsets], CArray[uint8_t, Nat._4], CInt, CInt, CInt, CInt]
    ...
    def apply(av_class : Ptr[AVClass], nb_tiles : CUnsignedInt, coded_width : CInt, coded_height : CInt, offsets : Ptr[AVStreamGroupTileGrid.Offsets], background : CArray[uint8_t, Nat._4], horizontal_offset : CInt, vertical_offset : CInt, width : CInt, height : CInt)(using Zone): Ptr[AVStreamGroupTileGrid] =
      val ____ptr = apply()
      (!____ptr).av_class = av_class
    ...
    extension (struct: AVStreamGroupTileGrid)
      ...
      def offsets_=(value: Ptr[AVStreamGroupTileGrid.Offsets]): Unit = !struct.at5 = value
      def background : CArray[uint8_t, Nat._4] = struct._6
      def background_=(value: CArray[uint8_t, Nat._4]): Unit = !struct.at6 = value
    ...
    */
    ...
    object Offsets:
      given _tag: Tag[Offsets] = Tag.materializeCStruct3Tag[CUnsignedInt, CInt, CInt]
      
      // Allocates Offsets on the heap – fields are not initalised or zeroed out
      def apply()(using Zone): Ptr[Offsets] = scala.scalanative.unsafe.alloc[Offsets](1)
      def apply(idx : CUnsignedInt, horizontal : CInt, vertical : CInt)(using Zone): Ptr[Offsets] =
        val ____ptr = apply()
        (!____ptr).idx = idx
  ...
  object AVSubtitleRect:
    ...
    extension (struct: AVSubtitleRect)
      ...
      def data_=(value: CArray[Ptr[uint8_t], Nat._4]): Unit = !struct.at6 = value
...
object unions:
  ...
  object av_intfloat32:
    ...
    extension (struct: av_intfloat32)
      ...
      def i_=(value: uint32_t): Unit = !struct.at(0).asInstanceOf[Ptr[uint32_t]] = value
  ...
  object av_intfloat64:
    ...
    extension (struct: av_intfloat64)
      ...
      def i_=(value: uint64_t): Unit = !struct.at(0).asInstanceOf[Ptr[uint64_t]] = value
...
private[ffmpeg] object extern_functions:
  ...
  */
  def av_fmt_ctx_get_duration_estimation_method(ctx : Ptr[AVFormatContext]): AVDurationEstimationMethod = extern
  ...
  */
  def av_stream_add_side_data(st : Ptr[AVStream], `type` : AVPacketSideDataType, data : Ptr[uint8_t], size : size_t): CInt = extern
  ...
  */
  def av_stream_get_side_data(stream : Ptr[AVStream], `type` : AVPacketSideDataType, size : Ptr[size_t]): Ptr[uint8_t] = extern
  ...
  */
  def av_stream_new_side_data(stream : Ptr[AVStream], `type` : AVPacketSideDataType, size : size_t): Ptr[uint8_t] = extern
