...
object enumerations:
  ...
  */
  ...
  object Item_result extends _BindgenEnumCInt[Item_result]:
    ...
    def getName(value: Item_result): Option[String] =
      value match
  ...
  object Item_udftype extends _BindgenEnumCUnsignedInt[Item_udftype]:
    ...
    def getName(value: Item_udftype): Option[String] =
      value match
  ...
  */
  ...
  object SERVER_STATUS_flags_enum extends _BindgenEnumCUnsignedInt[SERVER_STATUS_flags_enum]:
    ...
    def getName(value: SERVER_STATUS_flags_enum): Option[String] =
      value match
  ...
  object enum_compression_algorithm extends _BindgenEnumCUnsignedInt[enum_compression_algorithm]:
    ...
    def getName(value: enum_compression_algorithm): Option[String] =
      value match
  ...
  object enum_cursor_type extends _BindgenEnumCUnsignedInt[enum_cursor_type]:
    ...
    def getName(value: enum_cursor_type): Option[String] =
      value match
  ...
  */
  ...
  object enum_field_types extends _BindgenEnumCUnsignedInt[enum_field_types]:
    ...
    def getName(value: enum_field_types): Option[String] =
      value match
  ...
  */
  ...
  object enum_mysql_set_option extends _BindgenEnumCUnsignedInt[enum_mysql_set_option]:
    ...
    def getName(value: enum_mysql_set_option): Option[String] =
      value match
  ...
  object enum_mysql_stmt_state extends _BindgenEnumCUnsignedInt[enum_mysql_stmt_state]:
    ...
    def getName(value: enum_mysql_stmt_state): Option[String] =
      value match
  ...
  */
  ...
  object enum_mysql_timestamp_type extends _BindgenEnumCInt[enum_mysql_timestamp_type]:
    ...
    def getName(value: enum_mysql_timestamp_type): Option[String] =
      value match
  ...
  */
  ...
  object enum_resultset_metadata extends _BindgenEnumCUnsignedInt[enum_resultset_metadata]:
    ...
    def getName(value: enum_resultset_metadata): Option[String] =
      value match
  ...
  */
  ...
  object enum_server_command extends _BindgenEnumCUnsignedInt[enum_server_command]:
    ...
    def getName(value: enum_server_command): Option[String] =
      value match
  ...
  */
  ...
  object enum_session_state_type extends _BindgenEnumCUnsignedInt[enum_session_state_type]:
    ...
    def getName(value: enum_session_state_type): Option[String] =
      value match
  ...
  object enum_stmt_attr_type extends _BindgenEnumCUnsignedInt[enum_stmt_attr_type]:
    ...
    def getName(value: enum_stmt_attr_type): Option[String] =
      value match
  ...
  */
  ...
  object mysql_enum_shutdown_level extends _BindgenEnumCUnsignedInt[mysql_enum_shutdown_level]:
    ...
    def getName(value: mysql_enum_shutdown_level): Option[String] =
      value match
  ...
  object mysql_option extends _BindgenEnumCUnsignedInt[mysql_option]:
    ...
    def getName(value: mysql_option): Option[String] =
      value match
  ...
  object mysql_protocol_type extends _BindgenEnumCUnsignedInt[mysql_protocol_type]:
    ...
    def getName(value: mysql_protocol_type): Option[String] =
      value match
  ...
  object mysql_ssl_fips_mode extends _BindgenEnumCUnsignedInt[mysql_ssl_fips_mode]:
    ...
    def getName(value: mysql_ssl_fips_mode): Option[String] =
      value match
  ...
  object mysql_ssl_mode extends _BindgenEnumCUnsignedInt[mysql_ssl_mode]:
    ...
    def getName(value: mysql_ssl_mode): Option[String] =
      value match
  ...
  object mysql_status extends _BindgenEnumCUnsignedInt[mysql_status]:
    ...
    def getName(value: mysql_status): Option[String] =
      value match
  ...
  object net_async_status extends _BindgenEnumCUnsignedInt[net_async_status]:
    ...
    def getName(value: net_async_status): Option[String] =
      value match
...
object structs:
  ...
  object MYSQL:
    ...
    val offsets: Array[Int] =
      ...
      res(10) = align(res(9) + sizeof[CString].toInt, alignmentof[Ptr[CHARSET_INFO]].toInt)
      res(11) = align(res(10) + sizeof[Ptr[CHARSET_INFO]].toInt, alignmentof[Ptr[MYSQL_FIELD]].toInt)
      res(12) = align(res(11) + sizeof[Ptr[MYSQL_FIELD]].toInt, alignmentof[Ptr[MEM_ROOT]].toInt)
      res(13) = align(res(12) + sizeof[Ptr[MEM_ROOT]].toInt, alignmentof[uint64_t].toInt)
      res(14) = align(res(13) + sizeof[uint64_t].toInt, alignmentof[uint64_t].toInt)
      res(15) = align(res(14) + sizeof[uint64_t].toInt, alignmentof[uint64_t].toInt)
      res(16) = align(res(15) + sizeof[uint64_t].toInt, alignmentof[CUnsignedLongInt].toInt)
      res(17) = align(res(16) + sizeof[CUnsignedLongInt].toInt, alignmentof[CUnsignedLongInt].toInt)
      res(18) = align(res(17) + sizeof[CUnsignedLongInt].toInt, alignmentof[CUnsignedInt].toInt)
      res(19) = align(res(18) + sizeof[CUnsignedInt].toInt, alignmentof[CUnsignedLongInt].toInt)
      res(20) = align(res(19) + sizeof[CUnsignedLongInt].toInt, alignmentof[CUnsignedLongInt].toInt)
      res(21) = align(res(20) + sizeof[CUnsignedLongInt].toInt, alignmentof[CUnsignedInt].toInt)
      ...
      res(26) = align(res(25) + sizeof[CUnsignedInt].toInt, alignmentof[st_mysql_options].toInt)
      res(27) = align(res(26) + sizeof[st_mysql_options].toInt, alignmentof[mysql_status].toInt)
      res(28) = align(res(27) + sizeof[mysql_status].toInt, alignmentof[enum_resultset_metadata].toInt)
      res(29) = align(res(28) + sizeof[enum_resultset_metadata].toInt, alignmentof[Boolean].toInt)
      res(30) = align(res(29) + sizeof[Boolean].toInt, alignmentof[Boolean].toInt)
      res(31) = align(res(30) + sizeof[Boolean].toInt, alignmentof[CChar].toInt)
      res(32) = align(res(31) + sizeof[CArray[CChar, Nat.Digit2[Nat._2, Nat._1]]].toInt, alignmentof[Ptr[LIST]].toInt)
      res(33) = align(res(32) + sizeof[Ptr[LIST]].toInt, alignmentof[Ptr[MYSQL_METHODS]].toInt)
      res(34) = align(res(33) + sizeof[Ptr[MYSQL_METHODS]].toInt, alignmentof[Ptr[Byte]].toInt)
      res(35) = align(res(34) + sizeof[Ptr[Byte]].toInt, alignmentof[Ptr[Boolean]].toInt)
      res(36) = align(res(35) + sizeof[Ptr[Boolean]].toInt, alignmentof[Ptr[Byte]].toInt)
      res
    end offsets
  ...
  */
  ...
  object st_mysql_options:
    ...
    val offsets: Array[Int] =
      ...
      res(11) = align(res(10) + sizeof[CString].toInt, alignmentof[Ptr[Init_commands_array]].toInt)
      res(12) = align(res(11) + sizeof[Ptr[Init_commands_array]].toInt, alignmentof[CString].toInt)
      res(13) = align(res(12) + sizeof[CString].toInt, alignmentof[CString].toInt)
      ...
      res(22) = align(res(21) + sizeof[CString].toInt, alignmentof[CUnsignedLongInt].toInt)
      res(23) = align(res(22) + sizeof[CUnsignedLongInt].toInt, alignmentof[Boolean].toInt)
      res(24) = align(res(23) + sizeof[Boolean].toInt, alignmentof[Boolean].toInt)
      res(25) = align(res(24) + sizeof[Boolean].toInt, alignmentof[CString].toInt)
      res(26) = align(res(25) + sizeof[CString].toInt, alignmentof[Boolean].toInt)
      res(27) = align(res(26) + sizeof[Boolean].toInt, alignmentof[CFuncPtr3[Ptr[Ptr[Byte]], CString, Ptr[Byte], CInt]].toInt)
      res(28) = align(res(27) + sizeof[CFuncPtr3[Ptr[Ptr[Byte]], CString, Ptr[Byte], CInt]].toInt, alignmentof[CFuncPtr3[Ptr[Byte], CString, CUnsignedInt, CInt]].toInt)
      res(29) = align(res(28) + sizeof[CFuncPtr3[Ptr[Byte], CString, CUnsignedInt, CInt]].toInt, alignmentof[CFuncPtr1[Ptr[Byte], Unit]].toInt)
      res(30) = align(res(29) + sizeof[CFuncPtr1[Ptr[Byte], Unit]].toInt, alignmentof[CFuncPtr3[Ptr[Byte], CString, CUnsignedInt, CInt]].toInt)
      res(31) = align(res(30) + sizeof[CFuncPtr3[Ptr[Byte], CString, CUnsignedInt, CInt]].toInt, alignmentof[Ptr[Byte]].toInt)
      res(32) = align(res(31) + sizeof[Ptr[Byte]].toInt, alignmentof[Ptr[st_mysql_options_extention]].toInt)
      res
    end offsets
