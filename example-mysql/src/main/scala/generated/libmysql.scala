...
object predef:
  ...
  private[libmysql] trait _BindgenEnumCUnsignedInt[T](using
      eq: T =:= CUnsignedInt
  ):
...
object enumerations:
  ...
  object SERVER_STATUS_flags_enum
      extends _BindgenEnumCUnsignedInt[SERVER_STATUS_flags_enum]:
    ...
    inline def getName(inline value: SERVER_STATUS_flags_enum): Option[String] =
      inline value match
        ...
        case SERVER_QUERY_NO_GOOD_INDEX_USED =>
          Some("SERVER_QUERY_NO_GOOD_INDEX_USED")
        ...
        case SERVER_STATUS_NO_BACKSLASH_ESCAPES =>
          Some("SERVER_STATUS_NO_BACKSLASH_ESCAPES")
        case SERVER_STATUS_METADATA_CHANGED =>
          Some("SERVER_STATUS_METADATA_CHANGED")
        ...
        case SERVER_STATUS_IN_TRANS_READONLY =>
          Some("SERVER_STATUS_IN_TRANS_READONLY")
        case SERVER_SESSION_STATE_CHANGED =>
          Some("SERVER_SESSION_STATE_CHANGED")
        case _ => _root_.scala.None
    extension (a: SERVER_STATUS_flags_enum)
      inline def &(b: SERVER_STATUS_flags_enum): SERVER_STATUS_flags_enum =
        a & b
      inline def |(b: SERVER_STATUS_flags_enum): SERVER_STATUS_flags_enum =
        a | b
      inline def is(b: SERVER_STATUS_flags_enum): Boolean = (a & b) == b
  end SERVER_STATUS_flags_enum

  opaque type enum_compression_algorithm = CUnsignedInt
  object enum_compression_algorithm
      extends _BindgenEnumCUnsignedInt[enum_compression_algorithm]:
    ...
    inline def getName(
        inline value: enum_compression_algorithm
    ): Option[String] =
      inline value match
    ...
    extension (a: enum_compression_algorithm)
      inline def &(b: enum_compression_algorithm): enum_compression_algorithm =
        a & b
      inline def |(b: enum_compression_algorithm): enum_compression_algorithm =
        a | b
      inline def is(b: enum_compression_algorithm): Boolean = (a & b) == b
  end enum_compression_algorithm
  ...
  end enum_field_types

  /** options for ::mysql_options()
    */
  opaque type enum_mysql_set_option = CUnsignedInt
  object enum_mysql_set_option
      extends _BindgenEnumCUnsignedInt[enum_mysql_set_option]:
    ...
    inline def getName(inline value: enum_mysql_set_option): Option[String] =
      inline value match
        case MYSQL_OPTION_MULTI_STATEMENTS_ON =>
          Some("MYSQL_OPTION_MULTI_STATEMENTS_ON")
        case MYSQL_OPTION_MULTI_STATEMENTS_OFF =>
          Some("MYSQL_OPTION_MULTI_STATEMENTS_OFF")
        case _ => _root_.scala.None
  ...
  end enum_mysql_set_option

  opaque type enum_mysql_stmt_state = CUnsignedInt
  object enum_mysql_stmt_state
      extends _BindgenEnumCUnsignedInt[enum_mysql_stmt_state]:
  ...
  end enum_mysql_stmt_state

  /** Time declarations shared between the server and client API: you should not
    * add anything to this header unless it's used (and hence should be visible)
    * in mysql.h. If you're looking for a place to add new time-related
    * declaration, it's most likely my_time.h. See also "C API Handling of Date
    * and Time Values" chapter in documentation.
    */
  opaque type enum_mysql_timestamp_type = CInt
  object enum_mysql_timestamp_type
      extends _BindgenEnumCInt[enum_mysql_timestamp_type]:
    ...
    inline def getName(
        inline value: enum_mysql_timestamp_type
    ): Option[String] =
      inline value match
    ...
    extension (a: enum_mysql_timestamp_type)
      inline def &(b: enum_mysql_timestamp_type): enum_mysql_timestamp_type =
        a & b
      inline def |(b: enum_mysql_timestamp_type): enum_mysql_timestamp_type =
        a | b
      inline def is(b: enum_mysql_timestamp_type): Boolean = (a & b) == b
  end enum_mysql_timestamp_type

  /** @}
    */
  opaque type enum_resultset_metadata = CUnsignedInt
  object enum_resultset_metadata
      extends _BindgenEnumCUnsignedInt[enum_resultset_metadata]:
  ...
  end enum_resultset_metadata

  /** A list of all MySQL protocol commands.
    */
  opaque type enum_server_command = CUnsignedInt
  object enum_server_command
      extends _BindgenEnumCUnsignedInt[enum_server_command]:
    ...
    inline def getName(inline value: enum_server_command): Option[String] =
      inline value match
        ...
        case COM_SUBSCRIBE_GROUP_REPLICATION_STREAM =>
          Some("COM_SUBSCRIBE_GROUP_REPLICATION_STREAM")
  ...
  end enum_server_command

  /** Type of state change information that the server can include in the Ok
    * packet.
    */
  opaque type enum_session_state_type = CUnsignedInt
  object enum_session_state_type
      extends _BindgenEnumCUnsignedInt[enum_session_state_type]:
    ...
    inline def getName(inline value: enum_session_state_type): Option[String] =
      inline value match
        case SESSION_TRACK_SYSTEM_VARIABLES =>
          Some("SESSION_TRACK_SYSTEM_VARIABLES")
        ...
        case SESSION_TRACK_TRANSACTION_CHARACTERISTICS =>
          Some("SESSION_TRACK_TRANSACTION_CHARACTERISTICS")
        case SESSION_TRACK_TRANSACTION_STATE =>
          Some("SESSION_TRACK_TRANSACTION_STATE")
        case _ => _root_.scala.None
  ...
  end enum_session_state_type

  opaque type enum_stmt_attr_type = CUnsignedInt
  object enum_stmt_attr_type
      extends _BindgenEnumCUnsignedInt[enum_stmt_attr_type]:
  ...
  end enum_stmt_attr_type

  /** We want levels to be in growing order of hardness (because we use number
    * comparisons).
    */
  opaque type mysql_enum_shutdown_level = CUnsignedInt
  object mysql_enum_shutdown_level
      extends _BindgenEnumCUnsignedInt[mysql_enum_shutdown_level]:
    ...
    inline def getName(
        inline value: mysql_enum_shutdown_level
    ): Option[String] =
      inline value match
    ...
    inline def getName(inline value: mysql_option): Option[String] =
      inline value match
        ...
        case MYSQL_SHARED_MEMORY_BASE_NAME =>
          Some("MYSQL_SHARED_MEMORY_BASE_NAME")
        ...
        case MYSQL_REPORT_DATA_TRUNCATION =>
          Some("MYSQL_REPORT_DATA_TRUNCATION")
        ...
        case MYSQL_OPT_CONNECT_ATTR_RESET =>
          Some("MYSQL_OPT_CONNECT_ATTR_RESET")
        case MYSQL_OPT_CONNECT_ATTR_ADD => Some("MYSQL_OPT_CONNECT_ATTR_ADD")
        case MYSQL_OPT_CONNECT_ATTR_DELETE =>
          Some("MYSQL_OPT_CONNECT_ATTR_DELETE")
        case MYSQL_SERVER_PUBLIC_KEY => Some("MYSQL_SERVER_PUBLIC_KEY")
        case MYSQL_ENABLE_CLEARTEXT_PLUGIN =>
          Some("MYSQL_ENABLE_CLEARTEXT_PLUGIN")
        case MYSQL_OPT_CAN_HANDLE_EXPIRED_PASSWORDS =>
          Some("MYSQL_OPT_CAN_HANDLE_EXPIRED_PASSWORDS")
        case MYSQL_OPT_MAX_ALLOWED_PACKET =>
          Some("MYSQL_OPT_MAX_ALLOWED_PACKET")
        ...
        case MYSQL_OPT_COMPRESSION_ALGORITHMS =>
          Some("MYSQL_OPT_COMPRESSION_ALGORITHMS")
        case MYSQL_OPT_ZSTD_COMPRESSION_LEVEL =>
          Some("MYSQL_OPT_ZSTD_COMPRESSION_LEVEL")
        case MYSQL_OPT_LOAD_DATA_LOCAL_DIR =>
          Some("MYSQL_OPT_LOAD_DATA_LOCAL_DIR")
  ...
  object mysql_protocol_type
      extends _BindgenEnumCUnsignedInt[mysql_protocol_type]:
  ...
  end mysql_protocol_type

  opaque type mysql_ssl_fips_mode = CUnsignedInt
  object mysql_ssl_fips_mode
      extends _BindgenEnumCUnsignedInt[mysql_ssl_fips_mode]:
  ...
  object mysql_status extends _BindgenEnumCUnsignedInt[mysql_status]:
    ...
    inline def getName(inline value: mysql_status): Option[String] =
      inline value match
        ...
        case MYSQL_STATUS_STATEMENT_GET_RESULT =>
          Some("MYSQL_STATUS_STATEMENT_GET_RESULT")
        case _ => _root_.scala.None
    ...
    inline def getName(inline value: net_async_status): Option[String] =
      inline value match
        ...
        case NET_ASYNC_COMPLETE_NO_MORE_RESULTS =>
          Some("NET_ASYNC_COMPLETE_NO_MORE_RESULTS")
        case _ => _root_.scala.None
...
object aliases:
  ...
  object MYSQL_FIELD_OFFSET:
    ...
    extension (v: MYSQL_FIELD_OFFSET) inline def value: CUnsignedInt = v
  ...
  object MYSQL_ROW:
    ...
    extension (v: MYSQL_ROW) inline def value: Ptr[CString] = v
  ...
  object MYSQL_ROW_OFFSET:
    ...
    extension (v: MYSQL_ROW_OFFSET) inline def value: Ptr[MYSQL_ROWS] = v

  opaque type Udf_func_add = CFuncPtr4[Ptr[UDF_INIT], Ptr[UDF_ARGS], Ptr[
    CUnsignedChar
  ], Ptr[CUnsignedChar], Unit]
  object Udf_func_add:
    given _tag: Tag[Udf_func_add] = Tag.materializeCFuncPtr4[Ptr[UDF_INIT], Ptr[
      UDF_ARGS
    ], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Udf_func_add =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[Ptr[UDF_INIT], Ptr[UDF_ARGS], Ptr[
          CUnsignedChar
        ], Ptr[CUnsignedChar], Unit]
    ): Udf_func_add = o
    extension (v: Udf_func_add)
      inline def value: CFuncPtr4[Ptr[UDF_INIT], Ptr[UDF_ARGS], Ptr[
        CUnsignedChar
      ], Ptr[CUnsignedChar], Unit] = v
  ...
  object Udf_func_any:
    ...
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Udf_func_any =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
  ...
  opaque type Udf_func_clear =
    CFuncPtr3[Ptr[UDF_INIT], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Unit]
  object Udf_func_clear:
    given _tag: Tag[Udf_func_clear] = Tag.materializeCFuncPtr3[Ptr[
      UDF_INIT
    ], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Udf_func_clear =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[UDF_INIT], Ptr[CUnsignedChar], Ptr[
          CUnsignedChar
        ], Unit]
    ): Udf_func_clear = o
    extension (v: Udf_func_clear)
      inline def value: CFuncPtr3[Ptr[UDF_INIT], Ptr[CUnsignedChar], Ptr[
        CUnsignedChar
      ], Unit] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end Udf_func_clear
  ...
  object Udf_func_deinit:
    given _tag: Tag[Udf_func_deinit] =
      Tag.materializeCFuncPtr1[Ptr[UDF_INIT], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Udf_func_deinit =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr1[Ptr[UDF_INIT], Unit]
    ): Udf_func_deinit = o
  ...
  opaque type Udf_func_double = CFuncPtr4[Ptr[UDF_INIT], Ptr[UDF_ARGS], Ptr[
    CUnsignedChar
  ], Ptr[CUnsignedChar], Double]
  object Udf_func_double:
    given _tag: Tag[Udf_func_double] = Tag.materializeCFuncPtr4[Ptr[
      UDF_INIT
    ], Ptr[UDF_ARGS], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Double]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Udf_func_double =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[Ptr[UDF_INIT], Ptr[UDF_ARGS], Ptr[
          CUnsignedChar
    ...
    extension (v: Udf_func_double)
      inline def value: CFuncPtr4[Ptr[UDF_INIT], Ptr[UDF_ARGS], Ptr[
        CUnsignedChar
      ], Ptr[CUnsignedChar], Double] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end Udf_func_double

  opaque type Udf_func_init =
    CFuncPtr3[Ptr[UDF_INIT], Ptr[UDF_ARGS], CString, Boolean]
  object Udf_func_init:
    given _tag: Tag[Udf_func_init] =
      Tag.materializeCFuncPtr3[Ptr[UDF_INIT], Ptr[UDF_ARGS], CString, Boolean]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Udf_func_init =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[UDF_INIT], Ptr[UDF_ARGS], CString, Boolean]
    ): Udf_func_init = o
    extension (v: Udf_func_init)
      inline def value
          : CFuncPtr3[Ptr[UDF_INIT], Ptr[UDF_ARGS], CString, Boolean] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end Udf_func_init

  opaque type Udf_func_longlong = CFuncPtr4[Ptr[UDF_INIT], Ptr[UDF_ARGS], Ptr[
    CUnsignedChar
  ], Ptr[CUnsignedChar], CLongLong]
  object Udf_func_longlong:
    given _tag: Tag[Udf_func_longlong] = Tag.materializeCFuncPtr4[Ptr[
      UDF_INIT
    ], Ptr[UDF_ARGS], Ptr[CUnsignedChar], Ptr[CUnsignedChar], CLongLong]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Udf_func_longlong =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[Ptr[UDF_INIT], Ptr[UDF_ARGS], Ptr[
          CUnsignedChar
    ...
    extension (v: Udf_func_longlong)
      inline def value: CFuncPtr4[Ptr[UDF_INIT], Ptr[UDF_ARGS], Ptr[
        CUnsignedChar
      ], Ptr[CUnsignedChar], CLongLong] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end Udf_func_longlong

  opaque type Udf_func_string =
    CFuncPtr6[Ptr[UDF_INIT], Ptr[UDF_ARGS], CString, Ptr[CUnsignedLongInt], Ptr[
      CUnsignedChar
    ], Ptr[CUnsignedChar], CString]
  object Udf_func_string:
    given _tag: Tag[Udf_func_string] =
      Tag.materializeCFuncPtr6[Ptr[UDF_INIT], Ptr[UDF_ARGS], CString, Ptr[
        CUnsignedLongInt
      ], Ptr[CUnsignedChar], Ptr[CUnsignedChar], CString]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): Udf_func_string =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr6[Ptr[UDF_INIT], Ptr[UDF_ARGS], CString, Ptr[
          CUnsignedLongInt
        ], Ptr[CUnsignedChar], Ptr[CUnsignedChar], CString]
    ): Udf_func_string = o
    extension (v: Udf_func_string)
      inline def value: CFuncPtr6[Ptr[UDF_INIT], Ptr[UDF_ARGS], CString, Ptr[
        CUnsignedLongInt
      ], Ptr[CUnsignedChar], Ptr[CUnsignedChar], CString] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end Udf_func_string

  opaque type list_walk_action = CFuncPtr2[Ptr[Byte], Ptr[Byte], CInt]
  object list_walk_action:
    given _tag: Tag[list_walk_action] =
      Tag.materializeCFuncPtr2[Ptr[Byte], Ptr[Byte], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): list_walk_action =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
...
object structs:
  ...
  object LIST:
    given _tag: Tag[LIST] =
      Tag.materializeCStruct3Tag[Ptr[Byte], Ptr[Byte], Ptr[Byte]]
    def apply()(using Zone): Ptr[LIST] = scala.scalanative.unsafe.alloc[LIST](1)
    def apply(prev: Ptr[LIST], next: Ptr[LIST], data: Ptr[Byte])(using
        Zone
    ): Ptr[LIST] =
      val ____ptr = apply()
      (!____ptr).prev = prev
    ...
    extension (struct: LIST)
      ...
      def prev_=(value: Ptr[LIST]): Unit = !struct.at1 =
        value.asInstanceOf[Ptr[Byte]]
      def next: Ptr[LIST] = struct._2.asInstanceOf[Ptr[LIST]]
      def next_=(value: Ptr[LIST]): Unit = !struct.at2 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type MYSQL = CArray[CChar, Nat.Digit4[Nat._1, Nat._1, Nat._6, Nat._0]]
  object MYSQL:
    opaque type Struct0 = CStruct0
    object Struct0:
      given _tag: Tag[Struct0] = Tag.materializeCStruct0Tag
    given _tag: Tag[MYSQL] =
      Tag.CArray[CChar, Nat.Digit4[Nat._1, Nat._1, Nat._6, Nat._0]](
        Tag.Byte,
        Tag.Digit4[Nat._1, Nat._1, Nat._6, Nat._0](
          Tag.Nat1,
          Tag.Nat1,
          Tag.Nat6,
          Tag.Nat0
    ...
    def apply()(using Zone): Ptr[MYSQL] =
      scala.scalanative.unsafe.alloc[MYSQL](1)
    def apply(
        net: NET,
        connector_fd: Ptr[CUnsignedChar],
        host: CString,
        user: CString,
        passwd: CString,
        unix_socket: CString,
        ...
        insert_id: uint64_t,
        extra_info: uint64_t,
        thread_id: CUnsignedLongInt,
        packet_length: CUnsignedLongInt,
        port: CUnsignedInt,
        client_flag: CUnsignedLongInt,
        server_capabilities: CUnsignedLongInt,
        protocol_version: CUnsignedInt,
        field_count: CUnsignedInt,
        server_status: CUnsignedInt,
        server_language: CUnsignedInt,
        warning_count: CUnsignedInt,
        options: st_mysql_options,
        status: mysql_status,
        resultset_metadata: enum_resultset_metadata,
        free_me: Boolean,
        reconnect: Boolean,
        scramble: CArray[CChar, Nat.Digit2[Nat._2, Nat._1]],
        stmts: Ptr[LIST],
        methods: Ptr[MYSQL_METHODS],
        thd: Ptr[Byte],
        unbuffered_fetch_owner: Ptr[Boolean],
        extension: Ptr[Byte]
    )(using Zone): Ptr[MYSQL] =
      val ____ptr = apply()
      (!____ptr).net = net
    ...
    extension (struct: MYSQL)
      ...
      def net_=(value: NET): Unit =
        !struct.at(offsets(0)).asInstanceOf[Ptr[NET]] = value
      def connector_fd: Ptr[CUnsignedChar] =
        !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]]
      def connector_fd_=(value: Ptr[CUnsignedChar]): Unit =
      ...
      def host_=(value: CString): Unit =
        !struct.at(offsets(2)).asInstanceOf[Ptr[CString]] = value
      def user: CString = !struct.at(offsets(3)).asInstanceOf[Ptr[CString]]
      def user_=(value: CString): Unit =
        !struct.at(offsets(3)).asInstanceOf[Ptr[CString]] = value
      def passwd: CString = !struct.at(offsets(4)).asInstanceOf[Ptr[CString]]
      def passwd_=(value: CString): Unit =
        !struct.at(offsets(4)).asInstanceOf[Ptr[CString]] = value
      def unix_socket: CString =
        !struct.at(offsets(5)).asInstanceOf[Ptr[CString]]
      def unix_socket_=(value: CString): Unit =
        !struct.at(offsets(5)).asInstanceOf[Ptr[CString]] = value
      def server_version: CString =
        !struct.at(offsets(6)).asInstanceOf[Ptr[CString]]
      def server_version_=(value: CString): Unit =
        !struct.at(offsets(6)).asInstanceOf[Ptr[CString]] = value
      def host_info: CString = !struct.at(offsets(7)).asInstanceOf[Ptr[CString]]
      def host_info_=(value: CString): Unit =
        !struct.at(offsets(7)).asInstanceOf[Ptr[CString]] = value
      def info: CString = !struct.at(offsets(8)).asInstanceOf[Ptr[CString]]
      def info_=(value: CString): Unit =
        !struct.at(offsets(8)).asInstanceOf[Ptr[CString]] = value
      def db: CString = !struct.at(offsets(9)).asInstanceOf[Ptr[CString]]
      def db_=(value: CString): Unit =
        !struct.at(offsets(9)).asInstanceOf[Ptr[CString]] = value
      def charset: Ptr[CHARSET_INFO] =
        !struct.at(offsets(11)).asInstanceOf[Ptr[Ptr[CHARSET_INFO]]]
      def charset_=(value: Ptr[CHARSET_INFO]): Unit =
        !struct.at(offsets(11)).asInstanceOf[Ptr[Ptr[CHARSET_INFO]]] = value
      def fields: Ptr[MYSQL_FIELD] =
        !struct.at(offsets(12)).asInstanceOf[Ptr[Ptr[MYSQL_FIELD]]]
      def fields_=(value: Ptr[MYSQL_FIELD]): Unit =
        !struct.at(offsets(12)).asInstanceOf[Ptr[Ptr[MYSQL_FIELD]]] = value
      def field_alloc: Ptr[MEM_ROOT] =
        !struct.at(offsets(13)).asInstanceOf[Ptr[Ptr[MEM_ROOT]]]
      def field_alloc_=(value: Ptr[MEM_ROOT]): Unit =
        !struct.at(offsets(13)).asInstanceOf[Ptr[Ptr[MEM_ROOT]]] = value
      def affected_rows: uint64_t =
        !struct.at(offsets(14)).asInstanceOf[Ptr[uint64_t]]
      def affected_rows_=(value: uint64_t): Unit =
        !struct.at(offsets(14)).asInstanceOf[Ptr[uint64_t]] = value
      def insert_id: uint64_t =
        !struct.at(offsets(15)).asInstanceOf[Ptr[uint64_t]]
      def insert_id_=(value: uint64_t): Unit =
        !struct.at(offsets(15)).asInstanceOf[Ptr[uint64_t]] = value
      def extra_info: uint64_t =
        !struct.at(offsets(16)).asInstanceOf[Ptr[uint64_t]]
      def extra_info_=(value: uint64_t): Unit =
        !struct.at(offsets(16)).asInstanceOf[Ptr[uint64_t]] = value
      def thread_id: CUnsignedLongInt =
        !struct.at(offsets(17)).asInstanceOf[Ptr[CUnsignedLongInt]]
      def thread_id_=(value: CUnsignedLongInt): Unit =
        !struct.at(offsets(17)).asInstanceOf[Ptr[CUnsignedLongInt]] = value
      def packet_length: CUnsignedLongInt =
        !struct.at(offsets(18)).asInstanceOf[Ptr[CUnsignedLongInt]]
      def packet_length_=(value: CUnsignedLongInt): Unit =
        !struct.at(offsets(18)).asInstanceOf[Ptr[CUnsignedLongInt]] = value
      def port: CUnsignedInt =
        !struct.at(offsets(19)).asInstanceOf[Ptr[CUnsignedInt]]
      def port_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(19)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def client_flag: CUnsignedLongInt =
        !struct.at(offsets(20)).asInstanceOf[Ptr[CUnsignedLongInt]]
      def client_flag_=(value: CUnsignedLongInt): Unit =
        !struct.at(offsets(20)).asInstanceOf[Ptr[CUnsignedLongInt]] = value
      def server_capabilities: CUnsignedLongInt =
        !struct.at(offsets(21)).asInstanceOf[Ptr[CUnsignedLongInt]]
      def server_capabilities_=(value: CUnsignedLongInt): Unit =
        !struct.at(offsets(21)).asInstanceOf[Ptr[CUnsignedLongInt]] = value
      def protocol_version: CUnsignedInt =
        !struct.at(offsets(22)).asInstanceOf[Ptr[CUnsignedInt]]
      def protocol_version_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(22)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def field_count: CUnsignedInt =
        !struct.at(offsets(23)).asInstanceOf[Ptr[CUnsignedInt]]
      def field_count_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(23)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def server_status: CUnsignedInt =
        !struct.at(offsets(24)).asInstanceOf[Ptr[CUnsignedInt]]
      def server_status_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(24)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def server_language: CUnsignedInt =
        !struct.at(offsets(25)).asInstanceOf[Ptr[CUnsignedInt]]
      def server_language_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(25)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def warning_count: CUnsignedInt =
        !struct.at(offsets(26)).asInstanceOf[Ptr[CUnsignedInt]]
      def warning_count_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(26)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def options: st_mysql_options =
        !struct.at(offsets(27)).asInstanceOf[Ptr[st_mysql_options]]
      def options_=(value: st_mysql_options): Unit =
        !struct.at(offsets(27)).asInstanceOf[Ptr[st_mysql_options]] = value
      def status: mysql_status =
        !struct.at(offsets(28)).asInstanceOf[Ptr[mysql_status]]
      def status_=(value: mysql_status): Unit =
        !struct.at(offsets(28)).asInstanceOf[Ptr[mysql_status]] = value
      def resultset_metadata: enum_resultset_metadata =
        !struct.at(offsets(29)).asInstanceOf[Ptr[enum_resultset_metadata]]
      def resultset_metadata_=(value: enum_resultset_metadata): Unit =
        !struct.at(offsets(29)).asInstanceOf[Ptr[enum_resultset_metadata]] =
          value
      def free_me: Boolean = !struct.at(offsets(30)).asInstanceOf[Ptr[Boolean]]
      def free_me_=(value: Boolean): Unit =
        !struct.at(offsets(30)).asInstanceOf[Ptr[Boolean]] = value
      def reconnect: Boolean =
        !struct.at(offsets(31)).asInstanceOf[Ptr[Boolean]]
      def reconnect_=(value: Boolean): Unit =
        !struct.at(offsets(31)).asInstanceOf[Ptr[Boolean]] = value
      def scramble: CArray[CChar, Nat.Digit2[Nat._2, Nat._1]] = !struct
        .at(offsets(32))
        .asInstanceOf[Ptr[CArray[CChar, Nat.Digit2[Nat._2, Nat._1]]]]
      def scramble_=(value: CArray[CChar, Nat.Digit2[Nat._2, Nat._1]]): Unit =
        !struct
          .at(offsets(32))
          .asInstanceOf[Ptr[CArray[CChar, Nat.Digit2[Nat._2, Nat._1]]]] = value
      def stmts: Ptr[LIST] =
        !struct.at(offsets(33)).asInstanceOf[Ptr[Ptr[LIST]]]
      def stmts_=(value: Ptr[LIST]): Unit =
        !struct.at(offsets(33)).asInstanceOf[Ptr[Ptr[LIST]]] = value
      def methods: Ptr[MYSQL_METHODS] =
        !struct.at(offsets(34)).asInstanceOf[Ptr[Ptr[MYSQL_METHODS]]]
      def methods_=(value: Ptr[MYSQL_METHODS]): Unit =
        !struct.at(offsets(34)).asInstanceOf[Ptr[Ptr[MYSQL_METHODS]]] = value
      def thd: Ptr[Byte] = !struct.at(offsets(35)).asInstanceOf[Ptr[Ptr[Byte]]]
      def thd_=(value: Ptr[Byte]): Unit =
        !struct.at(offsets(35)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def unbuffered_fetch_owner: Ptr[Boolean] =
        !struct.at(offsets(36)).asInstanceOf[Ptr[Ptr[Boolean]]]
      def unbuffered_fetch_owner_=(value: Ptr[Boolean]): Unit =
        !struct.at(offsets(36)).asInstanceOf[Ptr[Ptr[Boolean]]] = value
      def extension: Ptr[Byte] =
        !struct.at(offsets(37)).asInstanceOf[Ptr[Ptr[Byte]]]
      def extension_=(value: Ptr[Byte]): Unit =
        !struct.at(offsets(37)).asInstanceOf[Ptr[Ptr[Byte]]] = value
    end extension
    val offsets: Array[Int] =
      val res = Array.ofDim[Int](38)
      ...
      res(0) = align(0, alignmentof[NET].toInt)
      res(1) =
        align(res(0) + sizeof[NET].toInt, alignmentof[Ptr[CUnsignedChar]].toInt)
      res(2) = align(
        res(1) + sizeof[Ptr[CUnsignedChar]].toInt,
        alignmentof[CString].toInt
      )
      res(3) = align(res(2) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(4) = align(res(3) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(5) = align(res(4) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(6) = align(res(5) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(7) = align(res(6) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(8) = align(res(7) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(9) = align(res(8) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(10) =
        align(res(9) + sizeof[CString].toInt, alignmentof[CStruct0].toInt)
      res(11) = align(
        res(10) + sizeof[CStruct0].toInt,
        alignmentof[Ptr[CHARSET_INFO]].toInt
      )
      res(12) = align(
        res(11) + sizeof[Ptr[CHARSET_INFO]].toInt,
        alignmentof[Ptr[MYSQL_FIELD]].toInt
      )
      res(13) = align(
        res(12) + sizeof[Ptr[MYSQL_FIELD]].toInt,
        alignmentof[Ptr[MEM_ROOT]].toInt
      )
      res(14) = align(
        res(13) + sizeof[Ptr[MEM_ROOT]].toInt,
        alignmentof[uint64_t].toInt
      )
      res(15) =
        align(res(14) + sizeof[uint64_t].toInt, alignmentof[uint64_t].toInt)
      res(16) =
        align(res(15) + sizeof[uint64_t].toInt, alignmentof[uint64_t].toInt)
      res(17) = align(
        res(16) + sizeof[uint64_t].toInt,
        alignmentof[CUnsignedLongInt].toInt
      )
      res(18) = align(
        res(17) + sizeof[CUnsignedLongInt].toInt,
        alignmentof[CUnsignedLongInt].toInt
      )
      res(19) = align(
        res(18) + sizeof[CUnsignedLongInt].toInt,
        alignmentof[CUnsignedInt].toInt
      )
      res(20) = align(
        res(19) + sizeof[CUnsignedInt].toInt,
        alignmentof[CUnsignedLongInt].toInt
      )
      res(21) = align(
        res(20) + sizeof[CUnsignedLongInt].toInt,
        alignmentof[CUnsignedLongInt].toInt
      )
      res(22) = align(
        res(21) + sizeof[CUnsignedLongInt].toInt,
        alignmentof[CUnsignedInt].toInt
      )
      res(23) = align(
        res(22) + sizeof[CUnsignedInt].toInt,
        alignmentof[CUnsignedInt].toInt
      )
      res(24) = align(
      ...
      res(25) = align(
        res(24) + sizeof[CUnsignedInt].toInt,
        alignmentof[CUnsignedInt].toInt
      )
      res(26) = align(
        res(25) + sizeof[CUnsignedInt].toInt,
        alignmentof[CUnsignedInt].toInt
      )
      res(27) = align(
        res(26) + sizeof[CUnsignedInt].toInt,
        alignmentof[st_mysql_options].toInt
      )
      res(28) = align(
        res(27) + sizeof[st_mysql_options].toInt,
        alignmentof[mysql_status].toInt
      )
      res(29) = align(
        res(28) + sizeof[mysql_status].toInt,
        alignmentof[enum_resultset_metadata].toInt
      )
      res(30) = align(
        res(29) + sizeof[enum_resultset_metadata].toInt,
        alignmentof[Boolean].toInt
      )
      res(31) =
        align(res(30) + sizeof[Boolean].toInt, alignmentof[Boolean].toInt)
      res(32) = align(res(31) + sizeof[Boolean].toInt, alignmentof[CChar].toInt)
      res(33) = align(
        res(32) + sizeof[CArray[CChar, Nat.Digit2[Nat._2, Nat._1]]].toInt,
        alignmentof[Ptr[LIST]].toInt
      )
      res(34) = align(
        res(33) + sizeof[Ptr[LIST]].toInt,
        alignmentof[Ptr[MYSQL_METHODS]].toInt
      )
      res(35) = align(
        res(34) + sizeof[Ptr[MYSQL_METHODS]].toInt,
        alignmentof[Ptr[Byte]].toInt
      )
      res(36) = align(
        res(35) + sizeof[Ptr[Byte]].toInt,
        alignmentof[Ptr[Boolean]].toInt
      )
      res(37) = align(
        res(36) + sizeof[Ptr[Boolean]].toInt,
        alignmentof[Ptr[Byte]].toInt
      )
      res
    end offsets
  ...
  opaque type MYSQL_BIND = CStruct19[
    Ptr[CUnsignedLongInt],
    Ptr[Boolean],
    Ptr[Byte],
    Ptr[Boolean],
    Ptr[CUnsignedChar],
    CFuncPtr2[Ptr[NET], Ptr[Byte], Unit],
    CFuncPtr3[Ptr[Byte], Ptr[MYSQL_FIELD], Ptr[Ptr[CUnsignedChar]], Unit],
    CFuncPtr3[Ptr[Byte], Ptr[MYSQL_FIELD], Ptr[Ptr[CUnsignedChar]], Unit],
    CUnsignedLongInt,
    CUnsignedLongInt,
    CUnsignedLongInt,
  ...
  object MYSQL_BIND:
    ...
    def apply()(using Zone): Ptr[MYSQL_BIND] =
      scala.scalanative.unsafe.alloc[MYSQL_BIND](1)
    def apply(
        length: Ptr[CUnsignedLongInt],
        is_null: Ptr[Boolean],
        buffer: Ptr[Byte],
        error: Ptr[Boolean],
        row_ptr: Ptr[CUnsignedChar],
        store_param_func: CFuncPtr2[Ptr[NET], Ptr[MYSQL_BIND], Unit],
        fetch_result: CFuncPtr3[Ptr[MYSQL_BIND], Ptr[MYSQL_FIELD], Ptr[
          Ptr[CUnsignedChar]
        ], Unit],
        skip_result: CFuncPtr3[Ptr[MYSQL_BIND], Ptr[MYSQL_FIELD], Ptr[
          Ptr[CUnsignedChar]
        ], Unit],
        buffer_length: CUnsignedLongInt,
        offset: CUnsignedLongInt,
        length_value: CUnsignedLongInt,
        param_number: CUnsignedInt,
        pack_length: CUnsignedInt,
        buffer_type: enum_field_types,
        error_value: Boolean,
        is_unsigned: Boolean,
        long_data_used: Boolean,
        is_null_value: Boolean,
        extension: Ptr[Byte]
    )(using Zone): Ptr[MYSQL_BIND] =
      val ____ptr = apply()
    ...
    extension (struct: MYSQL_BIND)
      ...
      def store_param_func: CFuncPtr2[Ptr[NET], Ptr[MYSQL_BIND], Unit] =
        struct._6.asInstanceOf[CFuncPtr2[Ptr[NET], Ptr[MYSQL_BIND], Unit]]
      def store_param_func_=(
          value: CFuncPtr2[Ptr[NET], Ptr[MYSQL_BIND], Unit]
      ): Unit = !struct.at6 =
        value.asInstanceOf[CFuncPtr2[Ptr[NET], Ptr[Byte], Unit]]
      def fetch_result: CFuncPtr3[Ptr[MYSQL_BIND], Ptr[MYSQL_FIELD], Ptr[
        Ptr[CUnsignedChar]
      ], Unit] = struct._7.asInstanceOf[CFuncPtr3[Ptr[MYSQL_BIND], Ptr[
        MYSQL_FIELD
      ], Ptr[Ptr[CUnsignedChar]], Unit]]
      def fetch_result_=(
          value: CFuncPtr3[Ptr[MYSQL_BIND], Ptr[MYSQL_FIELD], Ptr[
            Ptr[CUnsignedChar]
          ], Unit]
      ): Unit = !struct.at7 = value.asInstanceOf[CFuncPtr3[Ptr[Byte], Ptr[
        MYSQL_FIELD
      ], Ptr[Ptr[CUnsignedChar]], Unit]]
      def skip_result: CFuncPtr3[Ptr[MYSQL_BIND], Ptr[MYSQL_FIELD], Ptr[
        Ptr[CUnsignedChar]
      ], Unit] = struct._8.asInstanceOf[CFuncPtr3[Ptr[MYSQL_BIND], Ptr[
        MYSQL_FIELD
      ], Ptr[Ptr[CUnsignedChar]], Unit]]
      def skip_result_=(
          value: CFuncPtr3[Ptr[MYSQL_BIND], Ptr[MYSQL_FIELD], Ptr[
      ...
      ): Unit = !struct.at8 = value.asInstanceOf[CFuncPtr3[Ptr[Byte], Ptr[
        MYSQL_FIELD
      ], Ptr[Ptr[CUnsignedChar]], Unit]]
  ...
  opaque type MYSQL_DATA =
    CStruct4[Ptr[Byte], Ptr[MEM_ROOT], uint64_t, CUnsignedInt]
  object MYSQL_DATA:
    given _tag: Tag[MYSQL_DATA] = Tag
      .materializeCStruct4Tag[Ptr[Byte], Ptr[MEM_ROOT], uint64_t, CUnsignedInt]
    def apply()(using Zone): Ptr[MYSQL_DATA] =
      scala.scalanative.unsafe.alloc[MYSQL_DATA](1)
    def apply(
        data: Ptr[MYSQL_ROWS],
        alloc: Ptr[MEM_ROOT],
        rows: uint64_t,
        fields: CUnsignedInt
    )(using Zone): Ptr[MYSQL_DATA] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).alloc = alloc
      (!____ptr).rows = rows
    ...
    extension (struct: MYSQL_DATA)
      ...
      def data_=(value: Ptr[MYSQL_ROWS]): Unit = !struct.at1 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type MYSQL_FIELD = CStruct21[
    CString,
    CString,
    CString,
    CString,
  ...
  object MYSQL_FIELD:
    given _tag: Tag[MYSQL_FIELD] = Tag.materializeCStruct21Tag[
      CString,
      CString,
      CString,
      CString,
    ...
    def apply()(using Zone): Ptr[MYSQL_FIELD] =
      scala.scalanative.unsafe.alloc[MYSQL_FIELD](1)
    def apply(
        name: CString,
        org_name: CString,
        table: CString,
        ...
        max_length: CUnsignedLongInt,
        name_length: CUnsignedInt,
        org_name_length: CUnsignedInt,
        table_length: CUnsignedInt,
        org_table_length: CUnsignedInt,
        db_length: CUnsignedInt,
        catalog_length: CUnsignedInt,
        def_length: CUnsignedInt,
        flags: CUnsignedInt,
        decimals: CUnsignedInt,
        charsetnr: CUnsignedInt,
        `type`: enum_field_types,
        extension: Ptr[Byte]
    )(using Zone): Ptr[MYSQL_FIELD] =
      val ____ptr = apply()
      (!____ptr).name = name
  ...
  /** Provides plugin access to communication channel
    */
  opaque type MYSQL_PLUGIN_VIO = CStruct5[
    CFuncPtr2[Ptr[Byte], Ptr[Ptr[CUnsignedChar]], CInt],
    CFuncPtr3[Ptr[Byte], Ptr[CUnsignedChar], CInt, CInt],
    CFuncPtr2[Ptr[Byte], Ptr[MYSQL_PLUGIN_VIO_INFO], Unit],
    CFuncPtr3[Ptr[Byte], Ptr[Ptr[CUnsignedChar]], Ptr[CInt], net_async_status],
    CFuncPtr4[Ptr[Byte], Ptr[CUnsignedChar], CInt, Ptr[CInt], net_async_status]
  ]
  object MYSQL_PLUGIN_VIO:
    given _tag: Tag[MYSQL_PLUGIN_VIO] = Tag.materializeCStruct5Tag[
      ...
      CFuncPtr3[Ptr[Byte], Ptr[CUnsignedChar], CInt, CInt],
      CFuncPtr2[Ptr[Byte], Ptr[MYSQL_PLUGIN_VIO_INFO], Unit],
      CFuncPtr3[Ptr[Byte], Ptr[Ptr[CUnsignedChar]], Ptr[
        CInt
      ], net_async_status],
      CFuncPtr4[Ptr[Byte], Ptr[CUnsignedChar], CInt, Ptr[
        CInt
      ], net_async_status]
    ]
    def apply()(using Zone): Ptr[MYSQL_PLUGIN_VIO] =
      scala.scalanative.unsafe.alloc[MYSQL_PLUGIN_VIO](1)
    def apply(
        read_packet: CFuncPtr2[Ptr[MYSQL_PLUGIN_VIO], Ptr[
          Ptr[CUnsignedChar]
        ], CInt],
        write_packet: CFuncPtr3[Ptr[MYSQL_PLUGIN_VIO], Ptr[
          CUnsignedChar
        ], CInt, CInt],
        info: CFuncPtr2[Ptr[MYSQL_PLUGIN_VIO], Ptr[
          MYSQL_PLUGIN_VIO_INFO
        ], Unit],
        read_packet_nonblocking: CFuncPtr3[Ptr[MYSQL_PLUGIN_VIO], Ptr[
          Ptr[CUnsignedChar]
        ], Ptr[CInt], net_async_status],
        write_packet_nonblocking: CFuncPtr4[Ptr[MYSQL_PLUGIN_VIO], Ptr[
          CUnsignedChar
        ], CInt, Ptr[CInt], net_async_status]
    )(using Zone): Ptr[MYSQL_PLUGIN_VIO] =
      val ____ptr = apply()
    ...
    extension (struct: MYSQL_PLUGIN_VIO)
      def read_packet
          : CFuncPtr2[Ptr[MYSQL_PLUGIN_VIO], Ptr[Ptr[CUnsignedChar]], CInt] =
        struct._1.asInstanceOf[CFuncPtr2[Ptr[MYSQL_PLUGIN_VIO], Ptr[
          Ptr[CUnsignedChar]
        ], CInt]]
      def read_packet_=(
          value: CFuncPtr2[Ptr[MYSQL_PLUGIN_VIO], Ptr[Ptr[CUnsignedChar]], CInt]
      ): Unit = !struct.at1 =
        value.asInstanceOf[CFuncPtr2[Ptr[Byte], Ptr[Ptr[CUnsignedChar]], CInt]]
      def write_packet
          : CFuncPtr3[Ptr[MYSQL_PLUGIN_VIO], Ptr[CUnsignedChar], CInt, CInt] =
        struct._2.asInstanceOf[CFuncPtr3[Ptr[MYSQL_PLUGIN_VIO], Ptr[
          CUnsignedChar
        ], CInt, CInt]]
      def write_packet_=(
          value: CFuncPtr3[Ptr[MYSQL_PLUGIN_VIO], Ptr[
            CUnsignedChar
          ], CInt, CInt]
      ): Unit = !struct.at2 =
        value.asInstanceOf[CFuncPtr3[Ptr[Byte], Ptr[CUnsignedChar], CInt, CInt]]
      def info
          : CFuncPtr2[Ptr[MYSQL_PLUGIN_VIO], Ptr[MYSQL_PLUGIN_VIO_INFO], Unit] =
        struct._3.asInstanceOf[CFuncPtr2[Ptr[MYSQL_PLUGIN_VIO], Ptr[
          MYSQL_PLUGIN_VIO_INFO
        ], Unit]]
      def info_=(
          value: CFuncPtr2[Ptr[MYSQL_PLUGIN_VIO], Ptr[
            MYSQL_PLUGIN_VIO_INFO
          ], Unit]
      ): Unit = !struct.at3 = value
        .asInstanceOf[CFuncPtr2[Ptr[Byte], Ptr[MYSQL_PLUGIN_VIO_INFO], Unit]]
      def read_packet_nonblocking: CFuncPtr3[Ptr[MYSQL_PLUGIN_VIO], Ptr[
        Ptr[CUnsignedChar]
      ], Ptr[CInt], net_async_status] = struct._4.asInstanceOf[CFuncPtr3[Ptr[
        MYSQL_PLUGIN_VIO
      ], Ptr[Ptr[CUnsignedChar]], Ptr[CInt], net_async_status]]
      def read_packet_nonblocking_=(
          value: CFuncPtr3[Ptr[MYSQL_PLUGIN_VIO], Ptr[Ptr[CUnsignedChar]], Ptr[
            CInt
          ], net_async_status]
      ): Unit = !struct.at4 = value.asInstanceOf[CFuncPtr3[Ptr[Byte], Ptr[
        Ptr[CUnsignedChar]
      ], Ptr[CInt], net_async_status]]
      def write_packet_nonblocking: CFuncPtr4[Ptr[MYSQL_PLUGIN_VIO], Ptr[
        CUnsignedChar
      ], CInt, Ptr[CInt], net_async_status] =
        struct._5.asInstanceOf[CFuncPtr4[Ptr[MYSQL_PLUGIN_VIO], Ptr[
          CUnsignedChar
        ], CInt, Ptr[CInt], net_async_status]]
      def write_packet_nonblocking_=(
          value: CFuncPtr4[Ptr[MYSQL_PLUGIN_VIO], Ptr[CUnsignedChar], CInt, Ptr[
            CInt
          ], net_async_status]
      ): Unit = !struct.at5 = value.asInstanceOf[CFuncPtr4[Ptr[Byte], Ptr[
        CUnsignedChar
      ], CInt, Ptr[CInt], net_async_status]]
    end extension
  end MYSQL_PLUGIN_VIO

  opaque type MYSQL_PLUGIN_VIO_INFO =
    CStruct2[MYSQL_PLUGIN_VIO_INFO.Enum0, CInt]
  object MYSQL_PLUGIN_VIO_INFO:
    ...
    given _tag: Tag[MYSQL_PLUGIN_VIO_INFO] =
      Tag.materializeCStruct2Tag[MYSQL_PLUGIN_VIO_INFO.Enum0, CInt]
    def apply()(using Zone): Ptr[MYSQL_PLUGIN_VIO_INFO] =
      scala.scalanative.unsafe.alloc[MYSQL_PLUGIN_VIO_INFO](1)
    def apply(protocol: MYSQL_PLUGIN_VIO_INFO.Enum0, socket: CInt)(using
        Zone
    ): Ptr[MYSQL_PLUGIN_VIO_INFO] =
      val ____ptr = apply()
    ...
    extension (struct: MYSQL_PLUGIN_VIO_INFO)
      ...
      def protocol_=(value: MYSQL_PLUGIN_VIO_INFO.Enum0): Unit = !struct.at1 =
        value
      def socket: CInt = struct._2
      def socket_=(value: CInt): Unit = !struct.at2 = value
  end MYSQL_PLUGIN_VIO_INFO

  opaque type MYSQL_RES = CStruct16[
    uint64_t,
    Ptr[MYSQL_FIELD],
    Ptr[Byte],
    Ptr[Byte],
  ...
  object MYSQL_RES:
    given _tag: Tag[MYSQL_RES] = Tag.materializeCStruct16Tag[
      uint64_t,
      Ptr[MYSQL_FIELD],
      Ptr[Byte],
      Ptr[Byte],
    ...
    def apply()(using Zone): Ptr[MYSQL_RES] =
      scala.scalanative.unsafe.alloc[MYSQL_RES](1)
    def apply(
        row_count: uint64_t,
        fields: Ptr[MYSQL_FIELD],
        data: Ptr[MYSQL_DATA],
        data_cursor: Ptr[MYSQL_ROWS],
        lengths: Ptr[CUnsignedLongInt],
        handle: Ptr[MYSQL],
        methods: Ptr[MYSQL_METHODS],
        row: MYSQL_ROW,
        ...
        field_alloc: Ptr[MEM_ROOT],
        field_count: CUnsignedInt,
        current_field: CUnsignedInt,
        eof: Boolean,
        unbuffered_fetch_cancelled: Boolean,
        metadata: enum_resultset_metadata,
        extension: Ptr[Byte]
    )(using Zone): Ptr[MYSQL_RES] =
      val ____ptr = apply()
    ...
    extension (struct: MYSQL_RES)
      ...
      def data_=(value: Ptr[MYSQL_DATA]): Unit = !struct.at3 =
        value.asInstanceOf[Ptr[Byte]]
      def data_cursor: Ptr[MYSQL_ROWS] = struct._4.asInstanceOf[Ptr[MYSQL_ROWS]]
      def data_cursor_=(value: Ptr[MYSQL_ROWS]): Unit = !struct.at4 =
        value.asInstanceOf[Ptr[Byte]]
      ...
      def unbuffered_fetch_cancelled_=(value: Boolean): Unit = !struct.at14 =
        value
      def metadata: enum_resultset_metadata = struct._15
      def metadata_=(value: enum_resultset_metadata): Unit = !struct.at15 =
        value
  ...
  object MYSQL_ROWS:
    given _tag: Tag[MYSQL_ROWS] =
      Tag.materializeCStruct3Tag[Ptr[Byte], MYSQL_ROW, CUnsignedLongInt]
    def apply()(using Zone): Ptr[MYSQL_ROWS] =
      scala.scalanative.unsafe.alloc[MYSQL_ROWS](1)
    def apply(next: Ptr[MYSQL_ROWS], data: MYSQL_ROW, length: CUnsignedLongInt)(
        using Zone
    ): Ptr[MYSQL_ROWS] =
      val ____ptr = apply()
      (!____ptr).next = next
    ...
    extension (struct: MYSQL_ROWS)
      ...
      def next_=(value: Ptr[MYSQL_ROWS]): Unit = !struct.at1 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  /** Struct for information about a replication stream.
    */
  opaque type MYSQL_RPL = CStruct10[
    size_t,
    CString,
    uint64_t,
    CUnsignedInt,
    CUnsignedInt,
    size_t,
    CFuncPtr2[Ptr[Byte], Ptr[CUnsignedChar], Unit],
    Ptr[Byte],
    CUnsignedLongInt,
    Ptr[CUnsignedChar]
  ]
  object MYSQL_RPL:
    given _tag: Tag[MYSQL_RPL] = Tag.materializeCStruct10Tag[
      size_t,
      CString,
      uint64_t,
      CUnsignedInt,
    ...
    def apply()(using Zone): Ptr[MYSQL_RPL] =
      scala.scalanative.unsafe.alloc[MYSQL_RPL](1)
    def apply(
        file_name_length: size_t,
        file_name: CString,
        start_position: uint64_t,
        server_id: CUnsignedInt,
        flags: CUnsignedInt,
        gtid_set_encoded_size: size_t,
        fix_gtid_set: CFuncPtr2[Ptr[MYSQL_RPL], Ptr[CUnsignedChar], Unit],
        gtid_set_arg: Ptr[Byte],
        size: CUnsignedLongInt,
        buffer: Ptr[CUnsignedChar]
    )(using Zone): Ptr[MYSQL_RPL] =
      val ____ptr = apply()
    ...
    extension (struct: MYSQL_RPL)
      ...
      def fix_gtid_set: CFuncPtr2[Ptr[MYSQL_RPL], Ptr[CUnsignedChar], Unit] =
        struct._7
          .asInstanceOf[CFuncPtr2[Ptr[MYSQL_RPL], Ptr[CUnsignedChar], Unit]]
      def fix_gtid_set_=(
          value: CFuncPtr2[Ptr[MYSQL_RPL], Ptr[CUnsignedChar], Unit]
      ): Unit = !struct.at7 =
        value.asInstanceOf[CFuncPtr2[Ptr[Byte], Ptr[CUnsignedChar], Unit]]
  ...
  object MYSQL_STMT:
    given _tag: Tag[MYSQL_STMT] =
      Tag.CArray[CChar, Nat.Digit3[Nat._7, Nat._0, Nat._4]](
        Tag.Byte,
        Tag.Digit3[Nat._7, Nat._0, Nat._4](Tag.Nat7, Tag.Nat0, Tag.Nat4)
      )
    def apply()(using Zone): Ptr[MYSQL_STMT] =
      scala.scalanative.unsafe.alloc[MYSQL_STMT](1)
    def apply(
        ...
        result: MYSQL_DATA,
        data_cursor: Ptr[MYSQL_ROWS],
        read_row_func: CFuncPtr2[Ptr[MYSQL_STMT], Ptr[
          Ptr[CUnsignedChar]
        ], CInt],
        affected_rows: uint64_t,
        insert_id: uint64_t,
        stmt_id: CUnsignedLongInt,
        flags: CUnsignedLongInt,
        prefetch_rows: CUnsignedLongInt,
        server_status: CUnsignedInt,
        last_errno: CUnsignedInt,
        param_count: CUnsignedInt,
        field_count: CUnsignedInt,
        state: enum_mysql_stmt_state,
        last_error: CArray[CChar, Nat.Digit3[Nat._5, Nat._1, Nat._2]],
        sqlstate: CArray[CChar, Nat._6],
        send_types_to_server: Boolean,
        bind_param_done: Boolean,
        bind_result_done: CUnsignedChar,
        unbuffered_fetch_cancelled: Boolean,
        update_max_length: Boolean,
        extension: Ptr[MYSQL_STMT_EXT]
    )(using Zone): Ptr[MYSQL_STMT] =
      val ____ptr = apply()
    ...
    extension (struct: MYSQL_STMT)
      def mem_root: Ptr[MEM_ROOT] =
        !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[MEM_ROOT]]]
      def mem_root_=(value: Ptr[MEM_ROOT]): Unit =
        !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[MEM_ROOT]]] = value
      def list: LIST = !struct.at(offsets(1)).asInstanceOf[Ptr[LIST]]
      def list_=(value: LIST): Unit =
        !struct.at(offsets(1)).asInstanceOf[Ptr[LIST]] = value
      def mysql: Ptr[MYSQL] =
        !struct.at(offsets(2)).asInstanceOf[Ptr[Ptr[MYSQL]]]
      def mysql_=(value: Ptr[MYSQL]): Unit =
        !struct.at(offsets(2)).asInstanceOf[Ptr[Ptr[MYSQL]]] = value
      def params: Ptr[MYSQL_BIND] =
        !struct.at(offsets(3)).asInstanceOf[Ptr[Ptr[MYSQL_BIND]]]
      def params_=(value: Ptr[MYSQL_BIND]): Unit =
        !struct.at(offsets(3)).asInstanceOf[Ptr[Ptr[MYSQL_BIND]]] = value
      def bind: Ptr[MYSQL_BIND] =
        !struct.at(offsets(4)).asInstanceOf[Ptr[Ptr[MYSQL_BIND]]]
      def bind_=(value: Ptr[MYSQL_BIND]): Unit =
        !struct.at(offsets(4)).asInstanceOf[Ptr[Ptr[MYSQL_BIND]]] = value
      def fields: Ptr[MYSQL_FIELD] =
        !struct.at(offsets(5)).asInstanceOf[Ptr[Ptr[MYSQL_FIELD]]]
      def fields_=(value: Ptr[MYSQL_FIELD]): Unit =
        !struct.at(offsets(5)).asInstanceOf[Ptr[Ptr[MYSQL_FIELD]]] = value
      def result: MYSQL_DATA =
        !struct.at(offsets(6)).asInstanceOf[Ptr[MYSQL_DATA]]
      def result_=(value: MYSQL_DATA): Unit =
        !struct.at(offsets(6)).asInstanceOf[Ptr[MYSQL_DATA]] = value
      def data_cursor: Ptr[MYSQL_ROWS] =
        !struct.at(offsets(7)).asInstanceOf[Ptr[Ptr[MYSQL_ROWS]]]
      def data_cursor_=(value: Ptr[MYSQL_ROWS]): Unit =
        !struct.at(offsets(7)).asInstanceOf[Ptr[Ptr[MYSQL_ROWS]]] = value
      def read_row_func
          : CFuncPtr2[Ptr[MYSQL_STMT], Ptr[Ptr[CUnsignedChar]], CInt] = !struct
        .at(offsets(8))
        .asInstanceOf[Ptr[
          CFuncPtr2[Ptr[MYSQL_STMT], Ptr[Ptr[CUnsignedChar]], CInt]
        ]]
      def read_row_func_=(
          value: CFuncPtr2[Ptr[MYSQL_STMT], Ptr[Ptr[CUnsignedChar]], CInt]
      ): Unit = !struct
        .at(offsets(8))
        .asInstanceOf[Ptr[
          CFuncPtr2[Ptr[MYSQL_STMT], Ptr[Ptr[CUnsignedChar]], CInt]
      ...
      def affected_rows: uint64_t =
        !struct.at(offsets(9)).asInstanceOf[Ptr[uint64_t]]
      def affected_rows_=(value: uint64_t): Unit =
        !struct.at(offsets(9)).asInstanceOf[Ptr[uint64_t]] = value
      def insert_id: uint64_t =
        !struct.at(offsets(10)).asInstanceOf[Ptr[uint64_t]]
      def insert_id_=(value: uint64_t): Unit =
        !struct.at(offsets(10)).asInstanceOf[Ptr[uint64_t]] = value
      def stmt_id: CUnsignedLongInt =
        !struct.at(offsets(11)).asInstanceOf[Ptr[CUnsignedLongInt]]
      def stmt_id_=(value: CUnsignedLongInt): Unit =
        !struct.at(offsets(11)).asInstanceOf[Ptr[CUnsignedLongInt]] = value
      def flags: CUnsignedLongInt =
        !struct.at(offsets(12)).asInstanceOf[Ptr[CUnsignedLongInt]]
      def flags_=(value: CUnsignedLongInt): Unit =
        !struct.at(offsets(12)).asInstanceOf[Ptr[CUnsignedLongInt]] = value
      def prefetch_rows: CUnsignedLongInt =
        !struct.at(offsets(13)).asInstanceOf[Ptr[CUnsignedLongInt]]
      def prefetch_rows_=(value: CUnsignedLongInt): Unit =
        !struct.at(offsets(13)).asInstanceOf[Ptr[CUnsignedLongInt]] = value
      def server_status: CUnsignedInt =
        !struct.at(offsets(14)).asInstanceOf[Ptr[CUnsignedInt]]
      def server_status_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(14)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def last_errno: CUnsignedInt =
        !struct.at(offsets(15)).asInstanceOf[Ptr[CUnsignedInt]]
      def last_errno_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(15)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def param_count: CUnsignedInt =
        !struct.at(offsets(16)).asInstanceOf[Ptr[CUnsignedInt]]
      def param_count_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(16)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def field_count: CUnsignedInt =
        !struct.at(offsets(17)).asInstanceOf[Ptr[CUnsignedInt]]
      def field_count_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(17)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def state: enum_mysql_stmt_state =
        !struct.at(offsets(18)).asInstanceOf[Ptr[enum_mysql_stmt_state]]
      def state_=(value: enum_mysql_stmt_state): Unit =
        !struct.at(offsets(18)).asInstanceOf[Ptr[enum_mysql_stmt_state]] = value
      def last_error: CArray[CChar, Nat.Digit3[Nat._5, Nat._1, Nat._2]] =
        !struct
          .at(offsets(19))
          .asInstanceOf[Ptr[CArray[CChar, Nat.Digit3[Nat._5, Nat._1, Nat._2]]]]
      def last_error_=(
          value: CArray[CChar, Nat.Digit3[Nat._5, Nat._1, Nat._2]]
      ): Unit = !struct
        .at(offsets(19))
        .asInstanceOf[Ptr[CArray[CChar, Nat.Digit3[Nat._5, Nat._1, Nat._2]]]] =
        value
      def sqlstate: CArray[CChar, Nat._6] =
        !struct.at(offsets(20)).asInstanceOf[Ptr[CArray[CChar, Nat._6]]]
      def sqlstate_=(value: CArray[CChar, Nat._6]): Unit =
        !struct.at(offsets(20)).asInstanceOf[Ptr[CArray[CChar, Nat._6]]] = value
      def send_types_to_server: Boolean =
        !struct.at(offsets(21)).asInstanceOf[Ptr[Boolean]]
      def send_types_to_server_=(value: Boolean): Unit =
        !struct.at(offsets(21)).asInstanceOf[Ptr[Boolean]] = value
      def bind_param_done: Boolean =
        !struct.at(offsets(22)).asInstanceOf[Ptr[Boolean]]
      def bind_param_done_=(value: Boolean): Unit =
        !struct.at(offsets(22)).asInstanceOf[Ptr[Boolean]] = value
      def bind_result_done: CUnsignedChar =
        !struct.at(offsets(23)).asInstanceOf[Ptr[CUnsignedChar]]
      def bind_result_done_=(value: CUnsignedChar): Unit =
        !struct.at(offsets(23)).asInstanceOf[Ptr[CUnsignedChar]] = value
      def unbuffered_fetch_cancelled: Boolean =
        !struct.at(offsets(24)).asInstanceOf[Ptr[Boolean]]
      def unbuffered_fetch_cancelled_=(value: Boolean): Unit =
        !struct.at(offsets(24)).asInstanceOf[Ptr[Boolean]] = value
      def update_max_length: Boolean =
        !struct.at(offsets(25)).asInstanceOf[Ptr[Boolean]]
      def update_max_length_=(value: Boolean): Unit =
        !struct.at(offsets(25)).asInstanceOf[Ptr[Boolean]] = value
      def extension: Ptr[MYSQL_STMT_EXT] =
        !struct.at(offsets(26)).asInstanceOf[Ptr[Ptr[MYSQL_STMT_EXT]]]
      def extension_=(value: Ptr[MYSQL_STMT_EXT]): Unit =
        !struct.at(offsets(26)).asInstanceOf[Ptr[Ptr[MYSQL_STMT_EXT]]] = value
    end extension
    val offsets: Array[Int] =
      ...
      res(0) = align(0, alignmentof[Ptr[MEM_ROOT]].toInt)
      res(1) =
        align(res(0) + sizeof[Ptr[MEM_ROOT]].toInt, alignmentof[LIST].toInt)
      res(2) = align(res(1) + sizeof[LIST].toInt, alignmentof[Ptr[MYSQL]].toInt)
      res(3) = align(
        res(2) + sizeof[Ptr[MYSQL]].toInt,
        alignmentof[Ptr[MYSQL_BIND]].toInt
      )
      res(4) = align(
        res(3) + sizeof[Ptr[MYSQL_BIND]].toInt,
        alignmentof[Ptr[MYSQL_BIND]].toInt
      )
      res(5) = align(
        res(4) + sizeof[Ptr[MYSQL_BIND]].toInt,
        alignmentof[Ptr[MYSQL_FIELD]].toInt
      )
      res(6) = align(
        res(5) + sizeof[Ptr[MYSQL_FIELD]].toInt,
        alignmentof[MYSQL_DATA].toInt
      )
      res(7) = align(
        res(6) + sizeof[MYSQL_DATA].toInt,
        alignmentof[Ptr[MYSQL_ROWS]].toInt
      )
      res(8) = align(
        res(7) + sizeof[Ptr[MYSQL_ROWS]].toInt,
        alignmentof[
          CFuncPtr2[Ptr[MYSQL_STMT], Ptr[Ptr[CUnsignedChar]], CInt]
        ].toInt
      )
      ...
      res(10) =
        align(res(9) + sizeof[uint64_t].toInt, alignmentof[uint64_t].toInt)
      res(11) = align(
        res(10) + sizeof[uint64_t].toInt,
        alignmentof[CUnsignedLongInt].toInt
      )
      res(12) = align(
        res(11) + sizeof[CUnsignedLongInt].toInt,
        alignmentof[CUnsignedLongInt].toInt
      )
      res(13) = align(
        res(12) + sizeof[CUnsignedLongInt].toInt,
        alignmentof[CUnsignedLongInt].toInt
      )
      res(14) = align(
        res(13) + sizeof[CUnsignedLongInt].toInt,
        alignmentof[CUnsignedInt].toInt
      )
      res(15) = align(
      ...
      res(16) = align(
        res(15) + sizeof[CUnsignedInt].toInt,
        alignmentof[CUnsignedInt].toInt
      )
      res(17) = align(
        res(16) + sizeof[CUnsignedInt].toInt,
        alignmentof[CUnsignedInt].toInt
      )
      res(18) = align(
        res(17) + sizeof[CUnsignedInt].toInt,
        alignmentof[enum_mysql_stmt_state].toInt
      )
      res(19) = align(
        res(18) + sizeof[enum_mysql_stmt_state].toInt,
        alignmentof[CChar].toInt
      )
      res(20) = align(
        res(19) + sizeof[
          CArray[CChar, Nat.Digit3[Nat._5, Nat._1, Nat._2]]
        ].toInt,
        alignmentof[CChar].toInt
      )
      res(21) = align(
        res(20) + sizeof[CArray[CChar, Nat._6]].toInt,
        alignmentof[Boolean].toInt
      )
      res(22) =
        align(res(21) + sizeof[Boolean].toInt, alignmentof[Boolean].toInt)
      res(23) =
        align(res(22) + sizeof[Boolean].toInt, alignmentof[CUnsignedChar].toInt)
      res(24) =
        align(res(23) + sizeof[CUnsignedChar].toInt, alignmentof[Boolean].toInt)
      res(25) =
        align(res(24) + sizeof[Boolean].toInt, alignmentof[Boolean].toInt)
      res(26) = align(
        res(25) + sizeof[Boolean].toInt,
        alignmentof[Ptr[MYSQL_STMT_EXT]].toInt
      )
      res
    end offsets
  end MYSQL_STMT
  ...
  opaque type MYSQL_TIME = CStruct10[
    CUnsignedInt,
    CUnsignedInt,
    CUnsignedInt,
    CUnsignedInt,
  ...
  object MYSQL_TIME:
    given _tag: Tag[MYSQL_TIME] = Tag.materializeCStruct10Tag[
      CUnsignedInt,
      CUnsignedInt,
      CUnsignedInt,
      CUnsignedInt,
    ...
    def apply()(using Zone): Ptr[MYSQL_TIME] =
      scala.scalanative.unsafe.alloc[MYSQL_TIME](1)
    def apply(
        year: CUnsignedInt,
        month: CUnsignedInt,
        day: CUnsignedInt,
        ...
        minute: CUnsignedInt,
        second: CUnsignedInt,
        second_part: CUnsignedLongInt,
        neg: Boolean,
        time_type: enum_mysql_timestamp_type,
        time_zone_displacement: CInt
    )(using Zone): Ptr[MYSQL_TIME] =
      val ____ptr = apply()
      (!____ptr).year = year
      (!____ptr).month = month
      (!____ptr).day = day
    ...
    extension (struct: MYSQL_TIME)
      ...
      def time_type_=(value: enum_mysql_timestamp_type): Unit = !struct.at9 =
        value
  ...
  opaque type MY_CHARSET_INFO = CStruct8[
    CUnsignedInt,
    CUnsignedInt,
    CString,
    CString,
  ...
  object MY_CHARSET_INFO:
    given _tag: Tag[MY_CHARSET_INFO] = Tag.materializeCStruct8Tag[
      CUnsignedInt,
      CUnsignedInt,
      CString,
      CString,
    ...
    def apply()(using Zone): Ptr[MY_CHARSET_INFO] =
      scala.scalanative.unsafe.alloc[MY_CHARSET_INFO](1)
    def apply(
        number: CUnsignedInt,
        state: CUnsignedInt,
        csname: CString,
        ...
        comment: CString,
        dir: CString,
        mbminlen: CUnsignedInt,
        mbmaxlen: CUnsignedInt
    )(using Zone): Ptr[MY_CHARSET_INFO] =
      val ____ptr = apply()
  ...
  object NET:
    given _tag: Tag[NET] =
      Tag.CArray[CChar, Nat.Digit3[Nat._6, Nat._6, Nat._4]](
        Tag.Byte,
        Tag.Digit3[Nat._6, Nat._6, Nat._4](Tag.Nat6, Tag.Nat6, Tag.Nat4)
      )
    def apply()(using Zone): Ptr[NET] = scala.scalanative.unsafe.alloc[NET](1)
    def apply(
        vio: Ptr[Vio],
        buff: Ptr[CUnsignedChar],
        buff_end: Ptr[CUnsignedChar],
        write_pos: Ptr[CUnsignedChar],
        read_pos: Ptr[CUnsignedChar],
        fd: my_socket,
        remain_in_buf: CUnsignedLongInt,
        _length: CUnsignedLongInt,
        buf_length: CUnsignedLongInt,
        where_b: CUnsignedLongInt,
        max_packet: CUnsignedLongInt,
        max_packet_size: CUnsignedLongInt,
        pkt_nr: CUnsignedInt,
        compress_pkt_nr: CUnsignedInt,
        write_timeout: CUnsignedInt,
        read_timeout: CUnsignedInt,
        retry_count: CUnsignedInt,
        fcntl: CInt,
        return_status: Ptr[CUnsignedInt],
        reading_or_writing: CUnsignedChar,
        save_char: CUnsignedChar,
        compress: Boolean,
        last_errno: CUnsignedInt,
        error: CUnsignedChar,
        last_error: CArray[CChar, Nat.Digit3[Nat._5, Nat._1, Nat._2]],
    ...
    extension (struct: NET)
      ...
      def vio_=(value: Ptr[Vio]): Unit =
        !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[Vio]]] = value
      def buff: Ptr[CUnsignedChar] =
        !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]]
      def buff_=(value: Ptr[CUnsignedChar]): Unit =
        !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]] = value
      def buff_end: Ptr[CUnsignedChar] =
        !struct.at(offsets(2)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]]
      def buff_end_=(value: Ptr[CUnsignedChar]): Unit =
        !struct.at(offsets(2)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]] = value
      def write_pos: Ptr[CUnsignedChar] =
        !struct.at(offsets(3)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]]
      def write_pos_=(value: Ptr[CUnsignedChar]): Unit =
        !struct.at(offsets(3)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]] = value
      def read_pos: Ptr[CUnsignedChar] =
        !struct.at(offsets(4)).asInstanceOf[Ptr[Ptr[CUnsignedChar]]]
      def read_pos_=(value: Ptr[CUnsignedChar]): Unit =
      ...
      def fd_=(value: my_socket): Unit =
        !struct.at(offsets(5)).asInstanceOf[Ptr[my_socket]] = value
      def remain_in_buf: CUnsignedLongInt =
        !struct.at(offsets(6)).asInstanceOf[Ptr[CUnsignedLongInt]]
      def remain_in_buf_=(value: CUnsignedLongInt): Unit =
        !struct.at(offsets(6)).asInstanceOf[Ptr[CUnsignedLongInt]] = value
      def _length: CUnsignedLongInt =
        !struct.at(offsets(7)).asInstanceOf[Ptr[CUnsignedLongInt]]
      def _length_=(value: CUnsignedLongInt): Unit =
        !struct.at(offsets(7)).asInstanceOf[Ptr[CUnsignedLongInt]] = value
      def buf_length: CUnsignedLongInt =
        !struct.at(offsets(8)).asInstanceOf[Ptr[CUnsignedLongInt]]
      def buf_length_=(value: CUnsignedLongInt): Unit =
        !struct.at(offsets(8)).asInstanceOf[Ptr[CUnsignedLongInt]] = value
      def where_b: CUnsignedLongInt =
        !struct.at(offsets(9)).asInstanceOf[Ptr[CUnsignedLongInt]]
      def where_b_=(value: CUnsignedLongInt): Unit =
        !struct.at(offsets(9)).asInstanceOf[Ptr[CUnsignedLongInt]] = value
      def max_packet: CUnsignedLongInt =
        !struct.at(offsets(10)).asInstanceOf[Ptr[CUnsignedLongInt]]
      def max_packet_=(value: CUnsignedLongInt): Unit =
        !struct.at(offsets(10)).asInstanceOf[Ptr[CUnsignedLongInt]] = value
      def max_packet_size: CUnsignedLongInt =
        !struct.at(offsets(11)).asInstanceOf[Ptr[CUnsignedLongInt]]
      def max_packet_size_=(value: CUnsignedLongInt): Unit =
        !struct.at(offsets(11)).asInstanceOf[Ptr[CUnsignedLongInt]] = value
      def pkt_nr: CUnsignedInt =
        !struct.at(offsets(12)).asInstanceOf[Ptr[CUnsignedInt]]
      def pkt_nr_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(12)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def compress_pkt_nr: CUnsignedInt =
        !struct.at(offsets(13)).asInstanceOf[Ptr[CUnsignedInt]]
      def compress_pkt_nr_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(13)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def write_timeout: CUnsignedInt =
        !struct.at(offsets(14)).asInstanceOf[Ptr[CUnsignedInt]]
      def write_timeout_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(14)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def read_timeout: CUnsignedInt =
        !struct.at(offsets(15)).asInstanceOf[Ptr[CUnsignedInt]]
      def read_timeout_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(15)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def retry_count: CUnsignedInt =
        !struct.at(offsets(16)).asInstanceOf[Ptr[CUnsignedInt]]
      def retry_count_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(16)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def fcntl: CInt = !struct.at(offsets(17)).asInstanceOf[Ptr[CInt]]
      def fcntl_=(value: CInt): Unit =
        !struct.at(offsets(17)).asInstanceOf[Ptr[CInt]] = value
      def return_status: Ptr[CUnsignedInt] =
        !struct.at(offsets(18)).asInstanceOf[Ptr[Ptr[CUnsignedInt]]]
      def return_status_=(value: Ptr[CUnsignedInt]): Unit =
        !struct.at(offsets(18)).asInstanceOf[Ptr[Ptr[CUnsignedInt]]] = value
      def reading_or_writing: CUnsignedChar =
        !struct.at(offsets(19)).asInstanceOf[Ptr[CUnsignedChar]]
      def reading_or_writing_=(value: CUnsignedChar): Unit =
        !struct.at(offsets(19)).asInstanceOf[Ptr[CUnsignedChar]] = value
      def save_char: CUnsignedChar =
        !struct.at(offsets(20)).asInstanceOf[Ptr[CUnsignedChar]]
      def save_char_=(value: CUnsignedChar): Unit =
        !struct.at(offsets(20)).asInstanceOf[Ptr[CUnsignedChar]] = value
      def compress: Boolean = !struct.at(offsets(21)).asInstanceOf[Ptr[Boolean]]
      def compress_=(value: Boolean): Unit =
        !struct.at(offsets(21)).asInstanceOf[Ptr[Boolean]] = value
      def last_errno: CUnsignedInt =
        !struct.at(offsets(22)).asInstanceOf[Ptr[CUnsignedInt]]
      def last_errno_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(22)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def error: CUnsignedChar =
        !struct.at(offsets(23)).asInstanceOf[Ptr[CUnsignedChar]]
      def error_=(value: CUnsignedChar): Unit =
        !struct.at(offsets(23)).asInstanceOf[Ptr[CUnsignedChar]] = value
      def last_error: CArray[CChar, Nat.Digit3[Nat._5, Nat._1, Nat._2]] =
        !struct
          .at(offsets(24))
      ...
      def last_error_=(
        ...
        value
      def sqlstate: CArray[CChar, Nat._6] =
        !struct.at(offsets(25)).asInstanceOf[Ptr[CArray[CChar, Nat._6]]]
      def sqlstate_=(value: CArray[CChar, Nat._6]): Unit =
        !struct.at(offsets(25)).asInstanceOf[Ptr[CArray[CChar, Nat._6]]] = value
      def extension: Ptr[Byte] =
        !struct.at(offsets(26)).asInstanceOf[Ptr[Ptr[Byte]]]
      def extension_=(value: Ptr[Byte]): Unit =
        !struct.at(offsets(26)).asInstanceOf[Ptr[Ptr[Byte]]] = value
    end extension
    val offsets: Array[Int] =
      val res = Array.ofDim[Int](27)
      def align(offset: Int, alignment: Int) =
      ...
      res(0) = align(0, alignmentof[Ptr[Vio]].toInt)
      res(1) = align(
        res(0) + sizeof[Ptr[Vio]].toInt,
      ...
      res(3) = align(
        res(2) + sizeof[Ptr[CUnsignedChar]].toInt,
        alignmentof[Ptr[CUnsignedChar]].toInt
      )
      res(4) = align(
      ...
      res(5) = align(
        ...
        alignmentof[my_socket].toInt
      )
      res(6) = align(
        res(5) + sizeof[my_socket].toInt,
        alignmentof[CUnsignedLongInt].toInt
      )
      res(7) = align(
        res(6) + sizeof[CUnsignedLongInt].toInt,
        alignmentof[CUnsignedLongInt].toInt
      )
      res(8) = align(
        res(7) + sizeof[CUnsignedLongInt].toInt,
        alignmentof[CUnsignedLongInt].toInt
      )
      res(9) = align(
        res(8) + sizeof[CUnsignedLongInt].toInt,
        alignmentof[CUnsignedLongInt].toInt
      )
      res(10) = align(
        res(9) + sizeof[CUnsignedLongInt].toInt,
        alignmentof[CUnsignedLongInt].toInt
      )
      res(11) = align(
        res(10) + sizeof[CUnsignedLongInt].toInt,
        alignmentof[CUnsignedLongInt].toInt
      )
      res(12) = align(
        res(11) + sizeof[CUnsignedLongInt].toInt,
      ...
      res(14) = align(
        res(13) + sizeof[CUnsignedInt].toInt,
        alignmentof[CUnsignedInt].toInt
      )
      res(15) = align(
        res(14) + sizeof[CUnsignedInt].toInt,
      ...
      res(18) = align(
        res(17) + sizeof[CInt].toInt,
        alignmentof[Ptr[CUnsignedInt]].toInt
      )
      res(19) = align(
        res(18) + sizeof[Ptr[CUnsignedInt]].toInt,
        alignmentof[CUnsignedChar].toInt
      )
      res(20) = align(
        res(19) + sizeof[CUnsignedChar].toInt,
        alignmentof[CUnsignedChar].toInt
      )
      res(21) =
        align(res(20) + sizeof[CUnsignedChar].toInt, alignmentof[Boolean].toInt)
      res(22) =
        align(res(21) + sizeof[Boolean].toInt, alignmentof[CUnsignedInt].toInt)
      res(23) = align(
        res(22) + sizeof[CUnsignedInt].toInt,
        alignmentof[CUnsignedChar].toInt
      )
      res(24) =
        align(res(23) + sizeof[CUnsignedChar].toInt, alignmentof[CChar].toInt)
      res(25) = align(
        res(24) + sizeof[
          CArray[CChar, Nat.Digit3[Nat._5, Nat._1, Nat._2]]
        ].toInt,
      ...
      res(26) = align(
        res(25) + sizeof[CArray[CChar, Nat._6]].toInt,
        alignmentof[Ptr[Byte]].toInt
      )
      res
    end offsets
  ...
  opaque type UDF_ARGS =
    CStruct8[CUnsignedInt, Ptr[Item_result], Ptr[CString], Ptr[
      CUnsignedLongInt
    ], CString, Ptr[CString], Ptr[CUnsignedLongInt], Ptr[Byte]]
  object UDF_ARGS:
    given _tag: Tag[UDF_ARGS] = Tag
      .materializeCStruct8Tag[CUnsignedInt, Ptr[Item_result], Ptr[CString], Ptr[
        CUnsignedLongInt
      ], CString, Ptr[CString], Ptr[CUnsignedLongInt], Ptr[Byte]]
    def apply()(using Zone): Ptr[UDF_ARGS] =
      scala.scalanative.unsafe.alloc[UDF_ARGS](1)
    def apply(
        arg_count: CUnsignedInt,
        arg_type: Ptr[Item_result],
        args: Ptr[CString],
        lengths: Ptr[CUnsignedLongInt],
        maybe_null: CString,
        attributes: Ptr[CString],
        attribute_lengths: Ptr[CUnsignedLongInt],
        extension: Ptr[Byte]
    )(using Zone): Ptr[UDF_ARGS] =
      val ____ptr = apply()
    ...
    extension (struct: UDF_ARGS)
      ...
      def attribute_lengths_=(value: Ptr[CUnsignedLongInt]): Unit =
        !struct.at7 = value
  ...
  /** Information about the result of a user defined function
    */
  opaque type UDF_INIT =
    CStruct6[Boolean, CUnsignedInt, CUnsignedLongInt, CString, Boolean, Ptr[
      Byte
    ]]
  object UDF_INIT:
    given _tag: Tag[UDF_INIT] = Tag.materializeCStruct6Tag[
      Boolean,
      CUnsignedInt,
      CUnsignedLongInt,
      CString,
    ...
    def apply()(using Zone): Ptr[UDF_INIT] =
      scala.scalanative.unsafe.alloc[UDF_INIT](1)
    def apply(
        maybe_null: Boolean,
        decimals: CUnsignedInt,
        max_length: CUnsignedLongInt,
  ...
  opaque type auth_plugin_t = CStruct14[
    ...
    CString,
    CString,
    CArray[CUnsignedInt, Nat._3],
    CString,
    Ptr[Byte],
    CFuncPtr4[CString, size_t, CInt, va_list, CInt],
    CFuncPtr0[CInt],
    CFuncPtr2[CString, Ptr[Byte], CInt],
    CFuncPtr2[CString, Ptr[Byte], CInt],
    CFuncPtr2[Ptr[Byte], Ptr[MYSQL], CInt],
    CFuncPtr3[Ptr[Byte], Ptr[MYSQL], Ptr[CInt], net_async_status]
  ]
  object auth_plugin_t:
    given _tag: Tag[auth_plugin_t] = Tag.materializeCStruct14Tag[
      CInt,
      CUnsignedInt,
      CString,
      CString,
    ...
    def apply()(using Zone): Ptr[auth_plugin_t] =
      scala.scalanative.unsafe.alloc[auth_plugin_t](1)
    def apply(
        `type`: CInt,
        interface_version: CUnsignedInt,
        name: CString,
        author: CString,
        desc: CString,
        version: CArray[CUnsignedInt, Nat._3],
        license: CString,
        mysql_api: Ptr[Byte],
        init: CFuncPtr4[CString, size_t, CInt, va_list, CInt],
        deinit: CFuncPtr0[CInt],
        options: CFuncPtr2[CString, Ptr[Byte], CInt],
        get_options: CFuncPtr2[CString, Ptr[Byte], CInt],
        authenticate_user: CFuncPtr2[Ptr[MYSQL_PLUGIN_VIO], Ptr[MYSQL], CInt],
        authenticate_user_nonblocking: CFuncPtr3[Ptr[MYSQL_PLUGIN_VIO], Ptr[
          MYSQL
        ], Ptr[CInt], net_async_status]
    )(using Zone): Ptr[auth_plugin_t] =
      val ____ptr = apply()
      (!____ptr).`type` = `type`
    ...
    extension (struct: auth_plugin_t)
      ...
      def version_=(value: CArray[CUnsignedInt, Nat._3]): Unit = !struct.at6 =
        value
      ...
      def init_=(value: CFuncPtr4[CString, size_t, CInt, va_list, CInt]): Unit =
        !struct.at9 = value
      ...
      def options_=(value: CFuncPtr2[CString, Ptr[Byte], CInt]): Unit =
        !struct.at11 = value
      def get_options: CFuncPtr2[CString, Ptr[Byte], CInt] = struct._12
      def get_options_=(value: CFuncPtr2[CString, Ptr[Byte], CInt]): Unit =
        !struct.at12 = value
      def authenticate_user
          : CFuncPtr2[Ptr[MYSQL_PLUGIN_VIO], Ptr[MYSQL], CInt] = struct._13
        .asInstanceOf[CFuncPtr2[Ptr[MYSQL_PLUGIN_VIO], Ptr[MYSQL], CInt]]
      def authenticate_user_=(
          value: CFuncPtr2[Ptr[MYSQL_PLUGIN_VIO], Ptr[MYSQL], CInt]
      ): Unit = !struct.at13 =
        value.asInstanceOf[CFuncPtr2[Ptr[Byte], Ptr[MYSQL], CInt]]
      def authenticate_user_nonblocking: CFuncPtr3[Ptr[MYSQL_PLUGIN_VIO], Ptr[
        MYSQL
      ], Ptr[CInt], net_async_status] = struct._14.asInstanceOf[CFuncPtr3[Ptr[
        MYSQL_PLUGIN_VIO
      ], Ptr[MYSQL], Ptr[CInt], net_async_status]]
      def authenticate_user_nonblocking_=(
          value: CFuncPtr3[Ptr[MYSQL_PLUGIN_VIO], Ptr[MYSQL], Ptr[
            CInt
          ], net_async_status]
      ): Unit = !struct.at14 = value.asInstanceOf[CFuncPtr3[Ptr[Byte], Ptr[
        MYSQL
      ], Ptr[CInt], net_async_status]]
    end extension
  end auth_plugin_t

  opaque type character_set = CStruct8[
    CUnsignedInt,
    CUnsignedInt,
    CString,
    CString,
  ...
  object character_set:
    given _tag: Tag[character_set] = Tag.materializeCStruct8Tag[
      CUnsignedInt,
      CUnsignedInt,
      CString,
      CString,
    ...
    def apply()(using Zone): Ptr[character_set] =
      scala.scalanative.unsafe.alloc[character_set](1)
    def apply(
        number: CUnsignedInt,
        state: CUnsignedInt,
        csname: CString,
  ...
  /** Compression context information. It encapsulate the context information
    * based on compression method and presents a generic struct.
    */
  opaque type mysql_compress_context =
    CStruct2[enum_compression_algorithm, mysql_compress_context.Union0]
  object mysql_compress_context:
    ...
    object Union0:
      ...
      def apply(zlib_ctx: mysql_zlib_compress_context)(using
          Zone
      ): Ptr[Union0] =
        val ___ptr = alloc[Union0](1)
        val un = !___ptr
        un.at(0)
          .asInstanceOf[Ptr[mysql_zlib_compress_context]]
          .update(0, zlib_ctx)
        ___ptr
      end apply
      @scala.annotation.targetName("apply_zstd_ctx")
      def apply(zstd_ctx: mysql_zstd_compress_context)(using
          Zone
      ): Ptr[Union0] =
        val ___ptr = alloc[Union0](1)
        val un = !___ptr
        un.at(0)
          .asInstanceOf[Ptr[mysql_zstd_compress_context]]
          .update(0, zstd_ctx)
        ___ptr
      end apply
      extension (struct: Union0)
        def zlib_ctx: mysql_zlib_compress_context =
          !struct.at(0).asInstanceOf[Ptr[mysql_zlib_compress_context]]
        def zlib_ctx_=(value: mysql_zlib_compress_context): Unit =
          !struct.at(0).asInstanceOf[Ptr[mysql_zlib_compress_context]] = value
        def zstd_ctx: mysql_zstd_compress_context =
          !struct.at(0).asInstanceOf[Ptr[mysql_zstd_compress_context]]
        def zstd_ctx_=(value: mysql_zstd_compress_context): Unit =
          !struct.at(0).asInstanceOf[Ptr[mysql_zstd_compress_context]] = value
    end Union0
    given _tag: Tag[mysql_compress_context] = Tag.materializeCStruct2Tag[
      enum_compression_algorithm,
      mysql_compress_context.Union0
    ]
    def apply()(using Zone): Ptr[mysql_compress_context] =
      scala.scalanative.unsafe.alloc[mysql_compress_context](1)
    def apply(
        algorithm: enum_compression_algorithm,
        u: mysql_compress_context.Union0
    )(using Zone): Ptr[mysql_compress_context] =
      val ____ptr = apply()
  ...
  object mysql_zlib_compress_context:
    given _tag: Tag[mysql_zlib_compress_context] =
      Tag.materializeCStruct1Tag[CUnsignedInt]
    def apply()(using Zone): Ptr[mysql_zlib_compress_context] =
      scala.scalanative.unsafe.alloc[mysql_zlib_compress_context](1)
    def apply(compression_level: CUnsignedInt)(using
        Zone
    ): Ptr[mysql_zlib_compress_context] =
      val ____ptr = apply()
  ...
  end mysql_zlib_compress_context

  /** Compress context information relating to zstd compression.
    */
  opaque type mysql_zstd_compress_context =
    CStruct3[Ptr[ZSTD_CCtx], Ptr[ZSTD_DCtx], CUnsignedInt]
  object mysql_zstd_compress_context:
    given _tag: Tag[mysql_zstd_compress_context] =
      Tag.materializeCStruct3Tag[Ptr[ZSTD_CCtx], Ptr[ZSTD_DCtx], CUnsignedInt]
    def apply()(using Zone): Ptr[mysql_zstd_compress_context] =
      scala.scalanative.unsafe.alloc[mysql_zstd_compress_context](1)
    def apply(
        cctx: Ptr[ZSTD_CCtx],
        dctx: Ptr[ZSTD_DCtx],
        compression_level: CUnsignedInt
    )(using Zone): Ptr[mysql_zstd_compress_context] =
      val ____ptr = apply()
      (!____ptr).cctx = cctx
      (!____ptr).dctx = dctx
      (!____ptr).compression_level = compression_level
  ...
  end mysql_zstd_compress_context

  opaque type rand_struct =
    CStruct4[CUnsignedLongInt, CUnsignedLongInt, CUnsignedLongInt, Double]
  object rand_struct:
    given _tag: Tag[rand_struct] = Tag.materializeCStruct4Tag[
      CUnsignedLongInt,
      CUnsignedLongInt,
      CUnsignedLongInt,
      Double
    ]
    def apply()(using Zone): Ptr[rand_struct] =
      scala.scalanative.unsafe.alloc[rand_struct](1)
    def apply(
        seed1: CUnsignedLongInt,
        seed2: CUnsignedLongInt,
        max_value: CUnsignedLongInt,
        max_value_dbl: Double
    )(using Zone): Ptr[rand_struct] =
      val ____ptr = apply()
      (!____ptr).seed1 = seed1
      (!____ptr).seed2 = seed2
  ...
  opaque type st_mysql_client_plugin = CStruct12[
    CInt,
    CUnsignedInt,
    CString,
    CString,
  ...
  object st_mysql_client_plugin:
    given _tag: Tag[st_mysql_client_plugin] = Tag.materializeCStruct12Tag[
      CInt,
      CUnsignedInt,
      CString,
      CString,
    ...
    def apply()(using Zone): Ptr[st_mysql_client_plugin] =
      scala.scalanative.unsafe.alloc[st_mysql_client_plugin](1)
    def apply(
        `type`: CInt,
        interface_version: CUnsignedInt,
        name: CString,
        ...
        options: CFuncPtr2[CString, Ptr[Byte], CInt],
        get_options: CFuncPtr2[CString, Ptr[Byte], CInt]
    )(using Zone): Ptr[st_mysql_client_plugin] =
      val ____ptr = apply()
      (!____ptr).`type` = `type`
      (!____ptr).interface_version = interface_version
      (!____ptr).name = name
  ...
  end st_mysql_client_plugin

  opaque type st_mysql_client_plugin_AUTHENTICATION = CStruct14[
    CInt,
    CUnsignedInt,
    CString,
    CString,
  ...
  object st_mysql_client_plugin_AUTHENTICATION:
    given _tag: Tag[st_mysql_client_plugin_AUTHENTICATION] =
    ...
    def apply()(using Zone): Ptr[st_mysql_client_plugin_AUTHENTICATION] =
      scala.scalanative.unsafe.alloc[st_mysql_client_plugin_AUTHENTICATION](1)
    def apply(
        `type`: CInt,
        interface_version: CUnsignedInt,
        name: CString,
    ...
    )(using Zone): Ptr[st_mysql_client_plugin_AUTHENTICATION] =
      val ____ptr = apply()
      (!____ptr).`type` = `type`
      (!____ptr).interface_version = interface_version
      (!____ptr).name = name
  ...
  end st_mysql_client_plugin_AUTHENTICATION

  opaque type st_mysql_options =
    CArray[CChar, Nat.Digit3[Nat._2, Nat._4, Nat._0]]
  object st_mysql_options:
    opaque type Struct0 = CStruct0
    object Struct0:
      given _tag: Tag[Struct0] = Tag.materializeCStruct0Tag
    given _tag: Tag[st_mysql_options] =
      Tag.CArray[CChar, Nat.Digit3[Nat._2, Nat._4, Nat._0]](
        Tag.Byte,
        Tag.Digit3[Nat._2, Nat._4, Nat._0](Tag.Nat2, Tag.Nat4, Tag.Nat0)
      )
    def apply()(using Zone): Ptr[st_mysql_options] =
      scala.scalanative.unsafe.alloc[st_mysql_options](1)
    def apply(
        connect_timeout: CUnsignedInt,
        read_timeout: CUnsignedInt,
        write_timeout: CUnsignedInt,
        port: CUnsignedInt,
        protocol: CUnsignedInt,
        client_flag: CUnsignedLongInt,
        host: CString,
        user: CString,
        password: CString,
        ...
        max_allowed_packet: CUnsignedLongInt,
        compress: Boolean,
        named_pipe: Boolean,
        bind_address: CString,
        report_data_truncation: Boolean,
        local_infile_init: CFuncPtr3[Ptr[Ptr[Byte]], CString, Ptr[Byte], CInt],
        local_infile_read: CFuncPtr3[Ptr[Byte], CString, CUnsignedInt, CInt],
        local_infile_end: CFuncPtr1[Ptr[Byte], Unit],
        local_infile_error: CFuncPtr3[Ptr[Byte], CString, CUnsignedInt, CInt],
        local_infile_userdata: Ptr[Byte],
        extension: Ptr[st_mysql_options_extention]
    )(using Zone): Ptr[st_mysql_options] =
      val ____ptr = apply()
    ...
    extension (struct: st_mysql_options)
      def connect_timeout: CUnsignedInt =
        !struct.at(offsets(0)).asInstanceOf[Ptr[CUnsignedInt]]
      def connect_timeout_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(0)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def read_timeout: CUnsignedInt =
        !struct.at(offsets(1)).asInstanceOf[Ptr[CUnsignedInt]]
      def read_timeout_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(1)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def write_timeout: CUnsignedInt =
        !struct.at(offsets(2)).asInstanceOf[Ptr[CUnsignedInt]]
      def write_timeout_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(2)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def port: CUnsignedInt =
        !struct.at(offsets(3)).asInstanceOf[Ptr[CUnsignedInt]]
      def port_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(3)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def protocol: CUnsignedInt =
        !struct.at(offsets(4)).asInstanceOf[Ptr[CUnsignedInt]]
      def protocol_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(4)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def client_flag: CUnsignedLongInt =
        !struct.at(offsets(5)).asInstanceOf[Ptr[CUnsignedLongInt]]
      def client_flag_=(value: CUnsignedLongInt): Unit =
        !struct.at(offsets(5)).asInstanceOf[Ptr[CUnsignedLongInt]] = value
      ...
      def password_=(value: CString): Unit =
        !struct.at(offsets(8)).asInstanceOf[Ptr[CString]] = value
      def unix_socket: CString =
        !struct.at(offsets(9)).asInstanceOf[Ptr[CString]]
      def unix_socket_=(value: CString): Unit =
        !struct.at(offsets(9)).asInstanceOf[Ptr[CString]] = value
      def db: CString = !struct.at(offsets(10)).asInstanceOf[Ptr[CString]]
      def db_=(value: CString): Unit =
        !struct.at(offsets(10)).asInstanceOf[Ptr[CString]] = value
      def init_commands: Ptr[Init_commands_array] =
        !struct.at(offsets(12)).asInstanceOf[Ptr[Ptr[Init_commands_array]]]
      def init_commands_=(value: Ptr[Init_commands_array]): Unit =
        !struct.at(offsets(12)).asInstanceOf[Ptr[Ptr[Init_commands_array]]] =
          value
      def my_cnf_file: CString =
        !struct.at(offsets(13)).asInstanceOf[Ptr[CString]]
      def my_cnf_file_=(value: CString): Unit =
        !struct.at(offsets(13)).asInstanceOf[Ptr[CString]] = value
      def my_cnf_group: CString =
        !struct.at(offsets(14)).asInstanceOf[Ptr[CString]]
      def my_cnf_group_=(value: CString): Unit =
        !struct.at(offsets(14)).asInstanceOf[Ptr[CString]] = value
      def charset_dir: CString =
        !struct.at(offsets(15)).asInstanceOf[Ptr[CString]]
      def charset_dir_=(value: CString): Unit =
        !struct.at(offsets(15)).asInstanceOf[Ptr[CString]] = value
      def charset_name: CString =
        !struct.at(offsets(16)).asInstanceOf[Ptr[CString]]
      def charset_name_=(value: CString): Unit =
        !struct.at(offsets(16)).asInstanceOf[Ptr[CString]] = value
      def ssl_key: CString = !struct.at(offsets(17)).asInstanceOf[Ptr[CString]]
      def ssl_key_=(value: CString): Unit =
        !struct.at(offsets(17)).asInstanceOf[Ptr[CString]] = value
      def ssl_cert: CString = !struct.at(offsets(18)).asInstanceOf[Ptr[CString]]
      def ssl_cert_=(value: CString): Unit =
        !struct.at(offsets(18)).asInstanceOf[Ptr[CString]] = value
      def ssl_ca: CString = !struct.at(offsets(19)).asInstanceOf[Ptr[CString]]
      def ssl_ca_=(value: CString): Unit =
        !struct.at(offsets(19)).asInstanceOf[Ptr[CString]] = value
      def ssl_capath: CString =
        !struct.at(offsets(20)).asInstanceOf[Ptr[CString]]
      def ssl_capath_=(value: CString): Unit =
        !struct.at(offsets(20)).asInstanceOf[Ptr[CString]] = value
      def ssl_cipher: CString =
        !struct.at(offsets(21)).asInstanceOf[Ptr[CString]]
      def ssl_cipher_=(value: CString): Unit =
        !struct.at(offsets(21)).asInstanceOf[Ptr[CString]] = value
      def shared_memory_base_name: CString =
        !struct.at(offsets(22)).asInstanceOf[Ptr[CString]]
      def shared_memory_base_name_=(value: CString): Unit =
        !struct.at(offsets(22)).asInstanceOf[Ptr[CString]] = value
      def max_allowed_packet: CUnsignedLongInt =
        !struct.at(offsets(23)).asInstanceOf[Ptr[CUnsignedLongInt]]
      def max_allowed_packet_=(value: CUnsignedLongInt): Unit =
        !struct.at(offsets(23)).asInstanceOf[Ptr[CUnsignedLongInt]] = value
      def compress: Boolean = !struct.at(offsets(24)).asInstanceOf[Ptr[Boolean]]
      def compress_=(value: Boolean): Unit =
        !struct.at(offsets(24)).asInstanceOf[Ptr[Boolean]] = value
      def named_pipe: Boolean =
        !struct.at(offsets(25)).asInstanceOf[Ptr[Boolean]]
      def named_pipe_=(value: Boolean): Unit =
        !struct.at(offsets(25)).asInstanceOf[Ptr[Boolean]] = value
      def bind_address: CString =
        !struct.at(offsets(26)).asInstanceOf[Ptr[CString]]
      def bind_address_=(value: CString): Unit =
        !struct.at(offsets(26)).asInstanceOf[Ptr[CString]] = value
      def report_data_truncation: Boolean =
        !struct.at(offsets(27)).asInstanceOf[Ptr[Boolean]]
      def report_data_truncation_=(value: Boolean): Unit =
        !struct.at(offsets(27)).asInstanceOf[Ptr[Boolean]] = value
      def local_infile_init
          : CFuncPtr3[Ptr[Ptr[Byte]], CString, Ptr[Byte], CInt] = !struct
        .at(offsets(28))
        .asInstanceOf[Ptr[CFuncPtr3[Ptr[Ptr[Byte]], CString, Ptr[Byte], CInt]]]
      def local_infile_init_=(
          value: CFuncPtr3[Ptr[Ptr[Byte]], CString, Ptr[Byte], CInt]
      ): Unit = !struct
        .at(offsets(28))
        .asInstanceOf[Ptr[
          CFuncPtr3[Ptr[Ptr[Byte]], CString, Ptr[Byte], CInt]
        ]] = value
      def local_infile_read: CFuncPtr3[Ptr[Byte], CString, CUnsignedInt, CInt] =
        !struct
          .at(offsets(29))
          .asInstanceOf[Ptr[CFuncPtr3[Ptr[Byte], CString, CUnsignedInt, CInt]]]
      def local_infile_read_=(
          value: CFuncPtr3[Ptr[Byte], CString, CUnsignedInt, CInt]
      ): Unit = !struct
        .at(offsets(29))
        .asInstanceOf[Ptr[CFuncPtr3[Ptr[Byte], CString, CUnsignedInt, CInt]]] =
        value
      def local_infile_end: CFuncPtr1[Ptr[Byte], Unit] =
        !struct.at(offsets(30)).asInstanceOf[Ptr[CFuncPtr1[Ptr[Byte], Unit]]]
      def local_infile_end_=(value: CFuncPtr1[Ptr[Byte], Unit]): Unit =
        !struct.at(offsets(30)).asInstanceOf[Ptr[CFuncPtr1[Ptr[Byte], Unit]]] =
          value
      def local_infile_error
          : CFuncPtr3[Ptr[Byte], CString, CUnsignedInt, CInt] = !struct
        .at(offsets(31))
        .asInstanceOf[Ptr[CFuncPtr3[Ptr[Byte], CString, CUnsignedInt, CInt]]]
      def local_infile_error_=(
          value: CFuncPtr3[Ptr[Byte], CString, CUnsignedInt, CInt]
      ): Unit = !struct
        .at(offsets(31))
        .asInstanceOf[Ptr[CFuncPtr3[Ptr[Byte], CString, CUnsignedInt, CInt]]] =
        value
      def local_infile_userdata: Ptr[Byte] =
        !struct.at(offsets(32)).asInstanceOf[Ptr[Ptr[Byte]]]
      def local_infile_userdata_=(value: Ptr[Byte]): Unit =
        !struct.at(offsets(32)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def extension: Ptr[st_mysql_options_extention] = !struct
        .at(offsets(33))
        .asInstanceOf[Ptr[Ptr[st_mysql_options_extention]]]
      def extension_=(value: Ptr[st_mysql_options_extention]): Unit = !struct
        .at(offsets(33))
        .asInstanceOf[Ptr[Ptr[st_mysql_options_extention]]] = value
    end extension
    val offsets: Array[Int] =
      val res = Array.ofDim[Int](34)
      def align(offset: Int, alignment: Int) =
        val alignmentMask = alignment - 1
        val padding =
          if (offset & alignmentMask) == 0 then 0
      ...
      res(0) = align(0, alignmentof[CUnsignedInt].toInt)
      res(1) = align(
        res(0) + sizeof[CUnsignedInt].toInt,
        alignmentof[CUnsignedInt].toInt
      )
      res(2) = align(
        res(1) + sizeof[CUnsignedInt].toInt,
        alignmentof[CUnsignedInt].toInt
      )
      res(3) = align(
        res(2) + sizeof[CUnsignedInt].toInt,
        alignmentof[CUnsignedInt].toInt
      )
      res(4) = align(
        res(3) + sizeof[CUnsignedInt].toInt,
        alignmentof[CUnsignedInt].toInt
      )
      res(5) = align(
        res(4) + sizeof[CUnsignedInt].toInt,
        alignmentof[CUnsignedLongInt].toInt
      )
      res(6) = align(
        res(5) + sizeof[CUnsignedLongInt].toInt,
        alignmentof[CString].toInt
      )
      res(7) = align(res(6) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(8) = align(res(7) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(9) = align(res(8) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(10) =
        align(res(9) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(11) =
        align(res(10) + sizeof[CString].toInt, alignmentof[CStruct0].toInt)
      res(12) = align(
        res(11) + sizeof[CStruct0].toInt,
        alignmentof[Ptr[Init_commands_array]].toInt
      )
      res(13) = align(
        res(12) + sizeof[Ptr[Init_commands_array]].toInt,
        alignmentof[CString].toInt
      )
      res(14) =
        align(res(13) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(15) =
        align(res(14) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(16) =
        align(res(15) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(17) =
        align(res(16) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(18) =
        align(res(17) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(19) =
        align(res(18) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(20) =
        align(res(19) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(21) =
        align(res(20) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(22) =
        align(res(21) + sizeof[CString].toInt, alignmentof[CString].toInt)
      res(23) = align(
        res(22) + sizeof[CString].toInt,
        alignmentof[CUnsignedLongInt].toInt
      )
      res(24) = align(
        res(23) + sizeof[CUnsignedLongInt].toInt,
        alignmentof[Boolean].toInt
      )
      res(25) =
        align(res(24) + sizeof[Boolean].toInt, alignmentof[Boolean].toInt)
      res(26) =
        align(res(25) + sizeof[Boolean].toInt, alignmentof[CString].toInt)
      res(27) =
        align(res(26) + sizeof[CString].toInt, alignmentof[Boolean].toInt)
      res(28) = align(
        res(27) + sizeof[Boolean].toInt,
        alignmentof[CFuncPtr3[Ptr[Ptr[Byte]], CString, Ptr[Byte], CInt]].toInt
      )
      res(29) = align(
        res(28) + sizeof[
          CFuncPtr3[Ptr[Ptr[Byte]], CString, Ptr[Byte], CInt]
        ].toInt,
        alignmentof[CFuncPtr3[Ptr[Byte], CString, CUnsignedInt, CInt]].toInt
      )
      res(30) = align(
        res(29) + sizeof[
          CFuncPtr3[Ptr[Byte], CString, CUnsignedInt, CInt]
        ].toInt,
        alignmentof[CFuncPtr1[Ptr[Byte], Unit]].toInt
      )
      res(31) = align(
        res(30) + sizeof[CFuncPtr1[Ptr[Byte], Unit]].toInt,
        alignmentof[CFuncPtr3[Ptr[Byte], CString, CUnsignedInt, CInt]].toInt
      )
      res(32) = align(
        res(31) + sizeof[
      ...
      res(33) = align(
        res(32) + sizeof[Ptr[Byte]].toInt,
        alignmentof[Ptr[st_mysql_options_extention]].toInt
      )
      res
    end offsets
  end st_mysql_options
...
private[libmysql] object extern_functions:
  ...
  def check_scramble(
      reply: Ptr[CUnsignedChar],
      message: CString,
      hash_stage2: Ptr[CUnsignedChar]
  ): Boolean = extern

  def check_scramble_323(
      reply: Ptr[CUnsignedChar],
      message: CString,
      salt: Ptr[CUnsignedLongInt]
  ): Boolean = extern

  def create_random_string(
      to: CString,
      length: CUnsignedInt,
      rand_st: Ptr[rand_struct]
  ): Unit = extern

  def finish_client_errs(): Unit = extern

  def generate_sha256_scramble(
      dst: Ptr[CUnsignedChar],
      dst_size: size_t,
      src: CString,
      src_size: size_t,
      rnd: CString,
  ...
  def get_salt_from_password(res: Ptr[CUnsignedChar], password: CString): Unit =
    extern

  def get_salt_from_password_323(
      res: Ptr[CUnsignedLongInt],
      password: CString
  ): Unit = extern
  ...
  def hash_password(
      to: Ptr[CUnsignedLongInt],
      password: CString,
      password_len: CUnsignedInt
  ): Unit = extern

  /** Error messages for MySQL clients. These are constant and use the CR_
    * prefix. <mysqlclient_ername.h> will contain auto-generated mappings
    * containing the symbolic name and the number from this file, and the
    * english error messages in libmysql/errmsg.c.
    */
  ...
  def list_walk(
      ...
      argument: Ptr[CUnsignedChar]
  ): CInt = extern

  def make_password_from_salt(
      to: CString,
      hash_stage2: Ptr[CUnsignedChar]
  ): Unit = extern

  def make_password_from_salt_323(
      to: CString,
      salt: Ptr[CUnsignedLongInt]
  ): Unit = extern
  ...
  def my_net_set_read_timeout(net: Ptr[NET], timeout: CUnsignedInt): Unit =
    extern

  def my_net_set_retry_count(net: Ptr[NET], retry_count: CUnsignedInt): Unit =
    extern

  def my_net_set_write_timeout(net: Ptr[NET], timeout: CUnsignedInt): Unit =
    extern

  def my_net_write(
      net: Ptr[NET],
      packet: Ptr[CUnsignedChar],
      len: size_t
  ): Boolean = extern
  ...
  def mysql_bind_param(
      mysql: Ptr[MYSQL],
      n_params: CUnsignedInt,
      binds: Ptr[MYSQL_BIND],
      names: Ptr[CString]
  ): Boolean = extern
  ...
  /** finds an already loaded plugin by name, or loads it, if necessary
    */
  def mysql_client_find_plugin(
      mysql: Ptr[MYSQL],
      name: CString,
      `type`: CInt
  ): Ptr[st_mysql_client_plugin] = extern

  /** adds a plugin structure to the list of loaded plugins
    */
  def mysql_client_register_plugin(
      mysql: Ptr[MYSQL],
      plugin: Ptr[st_mysql_client_plugin]
  ): Ptr[st_mysql_client_plugin] = extern
  ...
  /** Deinitialize the compression context allocated.
    */
  def mysql_compress_context_deinit(
      mysql_compress_ctx: Ptr[mysql_compress_context]
  ): Unit = extern

  /** Initialize a compress context object to be associated with a NET object.
    */
  def mysql_compress_context_init(
      cmp_ctx: Ptr[mysql_compress_context],
      algorithm: enum_compression_algorithm,
      compression_level: CUnsignedInt
  ): Unit = extern
  ...
  /** Get default compression level corresponding to a given compression method.
    */
  def mysql_default_compression_level(
      algorithm: enum_compression_algorithm
  ): CUnsignedInt = extern
  ...
  def mysql_escape_string(
      to: CString,
      from: CString,
      from_length: CUnsignedLongInt
  ): CUnsignedLongInt = extern

  def mysql_fetch_field(result: Ptr[MYSQL_RES]): Ptr[MYSQL_FIELD] = extern

  def mysql_fetch_field_direct(
      res: Ptr[MYSQL_RES],
      fieldnr: CUnsignedInt
  ): Ptr[MYSQL_FIELD] = extern

  def mysql_fetch_fields(res: Ptr[MYSQL_RES]): Ptr[MYSQL_FIELD] = extern

  def mysql_fetch_lengths(result: Ptr[MYSQL_RES]): Ptr[CUnsignedLongInt] =
    extern

  def mysql_fetch_row(result: Ptr[MYSQL_RES]): MYSQL_ROW = extern

  def mysql_fetch_row_nonblocking(
      res: Ptr[MYSQL_RES],
      row: Ptr[MYSQL_ROW]
  ): net_async_status = extern

  def mysql_field_count(mysql: Ptr[MYSQL]): CUnsignedInt = extern

  def mysql_field_seek(
      result: Ptr[MYSQL_RES],
      offset: MYSQL_FIELD_OFFSET
  ): MYSQL_FIELD_OFFSET = extern

  def mysql_field_tell(res: Ptr[MYSQL_RES]): MYSQL_FIELD_OFFSET = extern

  def mysql_free_result(result: Ptr[MYSQL_RES]): Unit = extern

  def mysql_free_result_nonblocking(result: Ptr[MYSQL_RES]): net_async_status =
    extern

  def mysql_free_ssl_session_data(mysql: Ptr[MYSQL], data: Ptr[Byte]): Boolean =
    extern

  def mysql_get_character_set_info(
      mysql: Ptr[MYSQL],
      charset: Ptr[MY_CHARSET_INFO]
  ): Unit = extern
  ...
  def mysql_get_ssl_session_data(
      mysql: Ptr[MYSQL],
      n_ticket: CUnsignedInt,
      out_len: Ptr[CUnsignedInt]
  ): Ptr[Byte] = extern

  def mysql_get_ssl_session_reused(mysql: Ptr[MYSQL]): Boolean = extern

  def mysql_hex_string(
      to: CString,
      from: CString,
      from_length: CUnsignedLongInt
  ): CUnsignedLongInt = extern
  ...
  def mysql_list_fields(
      mysql: Ptr[MYSQL],
      table: CString,
      wild: CString
  ): Ptr[MYSQL_RES] = extern

  def mysql_list_processes(mysql: Ptr[MYSQL]): Ptr[MYSQL_RES] = extern

  def mysql_list_tables(mysql: Ptr[MYSQL], wild: CString): Ptr[MYSQL_RES] =
    extern

  /** loads a plugin and initializes it
    */
  def mysql_load_plugin(
      mysql: Ptr[MYSQL],
      name: CString,
      `type`: CInt,
      argc: CInt,
  ...
  def mysql_next_result_nonblocking(mysql: Ptr[MYSQL]): net_async_status =
    extern
  ...
  def mysql_real_connect(
      ...
      port: CUnsignedInt,
      unix_socket: CString,
      clientflag: CUnsignedLongInt
  ): Ptr[MYSQL] = extern

  def mysql_real_connect_dns_srv(
      mysql: Ptr[MYSQL],
      dns_srv_name: CString,
      user: CString,
      passwd: CString,
      db: CString,
      client_flag: CUnsignedLongInt
  ...
  def mysql_real_connect_nonblocking(
      mysql: Ptr[MYSQL],
      host: CString,
      user: CString,
      passwd: CString,
  ...
  def mysql_real_escape_string_quote(
      mysql: Ptr[MYSQL],
      to: CString,
      from: CString,
      length: CUnsignedLongInt,
  ...
  def mysql_real_query(
      mysql: Ptr[MYSQL],
      q: CString,
      length: CUnsignedLongInt
  ): CInt = extern

  def mysql_real_query_nonblocking(
      mysql: Ptr[MYSQL],
      query: CString,
      length: CUnsignedLongInt
  ): net_async_status = extern

  def mysql_refresh(mysql: Ptr[MYSQL], refresh_options: CUnsignedInt): CInt =
    extern
  ...
  def mysql_result_metadata(result: Ptr[MYSQL_RES]): enum_resultset_metadata =
    extern
  ...
  def mysql_server_init(
      argc: CInt,
      argv: Ptr[CString],
      groups: Ptr[CString]
  ): CInt = extern

  def mysql_session_track_get_first(
      mysql: Ptr[MYSQL],
  ...
  def mysql_session_track_get_next(
      mysql: Ptr[MYSQL],
      `type`: enum_session_state_type,
      data: Ptr[CString],
      length: Ptr[size_t]
  ...
  def mysql_set_local_infile_handler(
      mysql: Ptr[MYSQL],
      local_infile_init: CFuncPtr3[Ptr[Ptr[Byte]], CString, Ptr[Byte], CInt],
      local_infile_read: CFuncPtr3[Ptr[Byte], CString, CUnsignedInt, CInt],
      local_infile_end: CFuncPtr1[Ptr[Byte], Unit],
  ...
  def mysql_stmt_attr_get(
      stmt: Ptr[MYSQL_STMT],
      attr_type: enum_stmt_attr_type,
      attr: Ptr[Byte]
  ): Boolean = extern

  def mysql_stmt_attr_set(
      stmt: Ptr[MYSQL_STMT],
      attr_type: enum_stmt_attr_type,
      attr: Ptr[Byte]
  ): Boolean = extern

  def mysql_stmt_bind_param(
      stmt: Ptr[MYSQL_STMT],
      bnd: Ptr[MYSQL_BIND]
  ): Boolean = extern

  def mysql_stmt_bind_result(
      stmt: Ptr[MYSQL_STMT],
      bnd: Ptr[MYSQL_BIND]
  ): Boolean = extern
  ...
  def mysql_stmt_data_seek(stmt: Ptr[MYSQL_STMT], offset: uint64_t): Unit =
    extern
  ...
  def mysql_stmt_fetch_column(
      stmt: Ptr[MYSQL_STMT],
      bind_arg: Ptr[MYSQL_BIND],
      column: CUnsignedInt,
      offset: CUnsignedLongInt
  ): CInt = extern
  ...
  def mysql_store_result_nonblocking(
      mysql: Ptr[MYSQL],
      result: Ptr[Ptr[MYSQL_RES]]
  ): net_async_status = extern
  ...
  def net_field_length(packet: Ptr[Ptr[CUnsignedChar]]): CUnsignedLongInt =
    extern

  def net_field_length_checked(
      packet: Ptr[Ptr[CUnsignedChar]],
      max_length: CUnsignedLongInt
  ): CUnsignedLongInt = extern
  ...
  def net_store_length(
      pkg: Ptr[CUnsignedChar],
      length: CUnsignedLongLong
  ): Ptr[CUnsignedChar] = extern

  def net_write_command(
      net: Ptr[NET],
      command: CUnsignedChar,
      header: Ptr[CUnsignedChar],
      head_len: size_t,
      packet: Ptr[CUnsignedChar],
      len: size_t
  ): Boolean = extern

  def net_write_packet(
      net: Ptr[NET],
      packet: Ptr[CUnsignedChar],
      length: size_t
  ): Boolean = extern
  ...
  def scramble_323(to: CString, message: CString, password: CString): Unit =
    extern
