  ...
  */
  ...
  object MYSQL_STMT:
    ...
    val offsets: Array[Int] = 
      ...
      res(19) = align(res(18) + sizeof[enum_mysql_stmt_state].toInt, alignmentof[CChar].toInt)
      res(20) = align(res(19) + sizeof[CArray[CChar, Nat.Digit3[Nat._5, Nat._1, Nat._2]]].toInt, alignmentof[CChar].toInt)
  ...
  object NET:
    ...
    val offsets: Array[Int] = 
      ...
      res(24) = align(res(23) + sizeof[CUnsignedChar].toInt, alignmentof[CChar].toInt)
      res(25) = align(res(24) + sizeof[CArray[CChar, Nat.Digit3[Nat._5, Nat._1, Nat._2]]].toInt, alignmentof[CChar].toInt)
