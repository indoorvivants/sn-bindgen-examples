...
object structs:
  ...
  opaque type uv_async_s = CStruct11[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_async_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue, CInt]
  
  object uv_async_s:
    given _tag: Tag[uv_async_s] = Tag.materializeCStruct11Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_async_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue, CInt]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_async_s.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt, async_cb : uv_async_cb, queue : uv__queue, pending : CInt)(using Zone): Ptr[uv_async_s] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
    ...
    object U:
      given _tag: Tag[U] = Tag.CArray[CChar, Nat.Digit2[Nat._3, Nat._2]](Tag.Byte, Tag.Digit2[Nat._3, Nat._2](Tag.Nat3, Tag.Nat2))
  ...
  opaque type uv_async_t = CStruct11[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_async_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue, CInt]
  
  object uv_async_t:
    given _tag: Tag[uv_async_t] = Tag.materializeCStruct11Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_async_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue, CInt]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_async_t.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt, async_cb : uv_async_cb, queue : uv__queue, pending : CInt)(using Zone): Ptr[uv_async_t] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
  ...
  opaque type uv_check_s = CStruct10[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_check_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]
  
  object uv_check_s:
    given _tag: Tag[uv_check_s] = Tag.materializeCStruct10Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_check_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_check_s.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt, check_cb : uv_check_cb, queue : uv__queue)(using Zone): Ptr[uv_check_s] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
  ...
  opaque type uv_check_t = CStruct10[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_check_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]
  
  object uv_check_t:
    given _tag: Tag[uv_check_t] = Tag.materializeCStruct10Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_check_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_check_t.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt, check_cb : uv_check_cb, queue : uv__queue)(using Zone): Ptr[uv_check_t] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
  ...
  opaque type uv_fs_event_s = CStruct19[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_fs_event_s.U, Ptr[Byte], CUnsignedInt, CString, Ptr[Byte], uv__io_t, CString, CInt, CInt, Ptr[Byte], uv__queue, uv__queue, CInt, uv_mutex_t]
  
  object uv_fs_event_s:
    given _tag: Tag[uv_fs_event_s] = Tag.materializeCStruct19Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_fs_event_s.U, Ptr[Byte], CUnsignedInt, CString, Ptr[Byte], uv__io_t, CString, CInt, CInt, Ptr[Byte], uv__queue, uv__queue, CInt, uv_mutex_t]
  ...
  opaque type uv_fs_event_t = CStruct19[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_fs_event_t.U, Ptr[Byte], CUnsignedInt, CString, Ptr[Byte], uv__io_t, CString, CInt, CInt, Ptr[Byte], uv__queue, uv__queue, CInt, uv_mutex_t]
  
  object uv_fs_event_t:
    given _tag: Tag[uv_fs_event_t] = Tag.materializeCStruct19Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_fs_event_t.U, Ptr[Byte], CUnsignedInt, CString, Ptr[Byte], uv__io_t, CString, CInt, CInt, Ptr[Byte], uv__queue, uv__queue, CInt, uv_mutex_t]
  ...
  opaque type uv_fs_poll_s = CStruct9[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_fs_poll_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte]]
  
  object uv_fs_poll_s:
    given _tag: Tag[uv_fs_poll_s] = Tag.materializeCStruct9Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_fs_poll_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte]]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_fs_poll_s.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt, poll_ctx : Ptr[Byte])(using Zone): Ptr[uv_fs_poll_s] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
  ...
  opaque type uv_fs_poll_t = CStruct9[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_fs_poll_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte]]
  
  object uv_fs_poll_t:
    given _tag: Tag[uv_fs_poll_t] = Tag.materializeCStruct9Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_fs_poll_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte]]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_fs_poll_t.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt, poll_ctx : Ptr[Byte])(using Zone): Ptr[uv_fs_poll_t] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
  ...
  opaque type uv_handle_s = CStruct8[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_handle_s.U, Ptr[Byte], CUnsignedInt]
  
  object uv_handle_s:
    given _tag: Tag[uv_handle_s] = Tag.materializeCStruct8Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_handle_s.U, Ptr[Byte], CUnsignedInt]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_handle_s.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt)(using Zone): Ptr[uv_handle_s] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
  ...
  opaque type uv_handle_t = CStruct8[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_handle_t.U, Ptr[Byte], CUnsignedInt]
  
  object uv_handle_t:
    given _tag: Tag[uv_handle_t] = Tag.materializeCStruct8Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_handle_t.U, Ptr[Byte], CUnsignedInt]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_handle_t.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt)(using Zone): Ptr[uv_handle_t] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
  ...
  opaque type uv_idle_s = CStruct10[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_idle_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]
  
  object uv_idle_s:
    given _tag: Tag[uv_idle_s] = Tag.materializeCStruct10Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_idle_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_idle_s.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt, idle_cb : uv_idle_cb, queue : uv__queue)(using Zone): Ptr[uv_idle_s] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
  ...
  opaque type uv_idle_t = CStruct10[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_idle_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]
  
  object uv_idle_t:
    given _tag: Tag[uv_idle_t] = Tag.materializeCStruct10Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_idle_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_idle_t.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt, idle_cb : uv_idle_cb, queue : uv__queue)(using Zone): Ptr[uv_idle_t] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
  ...
  opaque type uv_interface_address_s = CStruct5[CString, CArray[CChar, Nat._6], CInt, uv_interface_address_s.Address, uv_interface_address_s.Netmask]
  
  object uv_interface_address_s:
    given _tag: Tag[uv_interface_address_s] = Tag.materializeCStruct5Tag[CString, CArray[CChar, Nat._6], CInt, uv_interface_address_s.Address, uv_interface_address_s.Netmask]
    ...
    def apply(name : CString, phys_addr : CArray[CChar, Nat._6], is_internal : CInt, address : uv_interface_address_s.Address, netmask : uv_interface_address_s.Netmask)(using Zone): Ptr[uv_interface_address_s] =
      val ____ptr = apply()
      (!____ptr).name = name
    ...
    extension (struct: uv_interface_address_s)
      ...
      def address_=(value: uv_interface_address_s.Address): Unit = !struct.at4 = value
      def netmask : uv_interface_address_s.Netmask = struct._5
      def netmask_=(value: uv_interface_address_s.Netmask): Unit = !struct.at5 = value
    
    opaque type Address = CArray[Byte, Nat.Digit2[Nat._2, Nat._8]]
    object Address:
      given _tag: Tag[Address] = Tag.CArray[CChar, Nat.Digit2[Nat._2, Nat._8]](Tag.Byte, Tag.Digit2[Nat._2, Nat._8](Tag.Nat2, Tag.Nat8))
    ...
    object Netmask:
      given _tag: Tag[Netmask] = Tag.CArray[CChar, Nat.Digit2[Nat._2, Nat._8]](Tag.Byte, Tag.Digit2[Nat._2, Nat._8](Tag.Nat2, Tag.Nat8))
  ...
  opaque type uv_interface_address_t = CStruct5[CString, CArray[CChar, Nat._6], CInt, uv_interface_address_t.Address, uv_interface_address_t.Netmask]
  
  object uv_interface_address_t:
    given _tag: Tag[uv_interface_address_t] = Tag.materializeCStruct5Tag[CString, CArray[CChar, Nat._6], CInt, uv_interface_address_t.Address, uv_interface_address_t.Netmask]
    ...
    def apply(name : CString, phys_addr : CArray[CChar, Nat._6], is_internal : CInt, address : uv_interface_address_t.Address, netmask : uv_interface_address_t.Netmask)(using Zone): Ptr[uv_interface_address_t] =
      val ____ptr = apply()
      (!____ptr).name = name
      (!____ptr).phys_addr = phys_addr
      (!____ptr).is_internal = is_internal
    ...
    extension (struct: uv_interface_address_t)
      ...
      def address_=(value: uv_interface_address_t.Address): Unit = !struct.at4 = value
      def netmask : uv_interface_address_t.Netmask = struct._5
      def netmask_=(value: uv_interface_address_t.Netmask): Unit = !struct.at5 = value
  ...
  object uv_loop_s:
    ...
    def apply(data : Ptr[Byte], active_handles : CUnsignedInt, handle_queue : uv__queue, active_reqs : uv_loop_s.Active_reqs, internal_fields : Ptr[Byte], stop_flag : CUnsignedInt, flags : CUnsignedLongInt, backend_fd : CInt, pending_queue : uv__queue, watcher_queue : uv__queue, watchers : Ptr[Ptr[uv__io_t]], nwatchers : CUnsignedInt, nfds : CUnsignedInt, wq : uv__queue, wq_mutex : uv_mutex_t, wq_async : uv_async_t, cloexec_lock : uv_rwlock_t, closing_handles : Ptr[uv_handle_t], process_handles : uv__queue, prepare_handles : uv__queue, check_handles : uv__queue, idle_handles : uv__queue, async_handles : uv__queue, async_unused : CFuncPtr0[Unit], async_io_watcher : uv__io_t, async_wfd : CInt, timer_heap : uv_loop_s.Timer_heap, timer_counter : uint64_t, time : uint64_t, signal_pipefd : CArray[CInt, Nat._2], signal_io_watcher : uv__io_t, child_watcher : uv_signal_t, emfile_fd : CInt, cf_thread : uv_thread_t, _cf_reserved : Ptr[Byte], cf_state : Ptr[Byte], cf_mutex : uv_mutex_t, cf_sem : uv_sem_t, cf_signals : uv__queue)(using Zone): Ptr[uv_loop_s] =
      val ____ptr = apply()
      (!____ptr).data = data
    ...
    extension (struct: uv_loop_s)
      ...
      def active_reqs: uv_loop_s.Active_reqs = !struct.at(offsets(3)).asInstanceOf[Ptr[uv_loop_s.Active_reqs]]
      def active_reqs_=(value: uv_loop_s.Active_reqs): Unit = !struct.at(offsets(3)).asInstanceOf[Ptr[uv_loop_s.Active_reqs]] = value
      ...
      def timer_heap: uv_loop_s.Timer_heap = !struct.at(offsets(26)).asInstanceOf[Ptr[uv_loop_s.Timer_heap]]
      def timer_heap_=(value: uv_loop_s.Timer_heap): Unit = !struct.at(offsets(26)).asInstanceOf[Ptr[uv_loop_s.Timer_heap]] = value
    ...
    val offsets: Array[Int] =
      ...
      res(4) = align(res(3) + sizeof[uv_loop_s.Active_reqs].toInt, alignmentof[Ptr[Byte]].toInt)
      ...
      res(26) = align(res(25) + sizeof[CInt].toInt, alignmentof[uv_loop_s.Timer_heap].toInt)
      res(27) = align(res(26) + sizeof[uv_loop_s.Timer_heap].toInt, alignmentof[uint64_t].toInt)
    ...
    object Active_reqs:
      given _tag: Tag[Active_reqs] = Tag.CArray[CChar, Nat._8](Tag.Byte, Tag.Nat8)
    ...
    object Timer_heap:
      given _tag: Tag[Timer_heap] = Tag.materializeCStruct2Tag[Ptr[Byte], CUnsignedInt]
      
      // Allocates Timer_heap on the heap – fields are not initalised or zeroed out
      def apply()(using Zone): Ptr[Timer_heap] = scala.scalanative.unsafe.alloc[Timer_heap](1)
      def apply(min : Ptr[Byte], nelts : CUnsignedInt)(using Zone): Ptr[Timer_heap] =
        val ____ptr = apply()
        (!____ptr).min = min
        (!____ptr).nelts = nelts
        ____ptr
  ...
  object uv_loop_t:
    ...
    def apply(data : Ptr[Byte], active_handles : CUnsignedInt, handle_queue : uv__queue, active_reqs : uv_loop_t.Active_reqs, internal_fields : Ptr[Byte], stop_flag : CUnsignedInt, flags : CUnsignedLongInt, backend_fd : CInt, pending_queue : uv__queue, watcher_queue : uv__queue, watchers : Ptr[Ptr[uv__io_t]], nwatchers : CUnsignedInt, nfds : CUnsignedInt, wq : uv__queue, wq_mutex : uv_mutex_t, wq_async : uv_async_t, cloexec_lock : uv_rwlock_t, closing_handles : Ptr[uv_handle_t], process_handles : uv__queue, prepare_handles : uv__queue, check_handles : uv__queue, idle_handles : uv__queue, async_handles : uv__queue, async_unused : CFuncPtr0[Unit], async_io_watcher : uv__io_t, async_wfd : CInt, timer_heap : uv_loop_t.Timer_heap, timer_counter : uint64_t, time : uint64_t, signal_pipefd : CArray[CInt, Nat._2], signal_io_watcher : uv__io_t, child_watcher : uv_signal_t, emfile_fd : CInt, cf_thread : uv_thread_t, _cf_reserved : Ptr[Byte], cf_state : Ptr[Byte], cf_mutex : uv_mutex_t, cf_sem : uv_sem_t, cf_signals : uv__queue)(using Zone): Ptr[uv_loop_t] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).active_handles = active_handles
      (!____ptr).handle_queue = handle_queue
    ...
    extension (struct: uv_loop_t)
      ...
      def handle_queue: uv__queue = !struct.at(offsets(2)).asInstanceOf[Ptr[uv__queue]]
      def handle_queue_=(value: uv__queue): Unit = !struct.at(offsets(2)).asInstanceOf[Ptr[uv__queue]] = value
      def active_reqs: uv_loop_t.Active_reqs = !struct.at(offsets(3)).asInstanceOf[Ptr[uv_loop_t.Active_reqs]]
      def active_reqs_=(value: uv_loop_t.Active_reqs): Unit = !struct.at(offsets(3)).asInstanceOf[Ptr[uv_loop_t.Active_reqs]] = value
      def internal_fields: Ptr[Byte] = !struct.at(offsets(4)).asInstanceOf[Ptr[Ptr[Byte]]]
      def internal_fields_=(value: Ptr[Byte]): Unit = !struct.at(offsets(4)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def stop_flag: CUnsignedInt = !struct.at(offsets(5)).asInstanceOf[Ptr[CUnsignedInt]]
      def stop_flag_=(value: CUnsignedInt): Unit = !struct.at(offsets(5)).asInstanceOf[Ptr[CUnsignedInt]] = value
      ...
      def async_wfd: CInt = !struct.at(offsets(25)).asInstanceOf[Ptr[CInt]]
      def async_wfd_=(value: CInt): Unit = !struct.at(offsets(25)).asInstanceOf[Ptr[CInt]] = value
      def timer_heap: uv_loop_t.Timer_heap = !struct.at(offsets(26)).asInstanceOf[Ptr[uv_loop_t.Timer_heap]]
      def timer_heap_=(value: uv_loop_t.Timer_heap): Unit = !struct.at(offsets(26)).asInstanceOf[Ptr[uv_loop_t.Timer_heap]] = value
      def timer_counter: uint64_t = !struct.at(offsets(27)).asInstanceOf[Ptr[uint64_t]]
      def timer_counter_=(value: uint64_t): Unit = !struct.at(offsets(27)).asInstanceOf[Ptr[uint64_t]] = value
      def time: uint64_t = !struct.at(offsets(28)).asInstanceOf[Ptr[uint64_t]]
      def time_=(value: uint64_t): Unit = !struct.at(offsets(28)).asInstanceOf[Ptr[uint64_t]] = value
    ...
    val offsets: Array[Int] =
      ...
      res(2) = align(res(1) + sizeof[CUnsignedInt].toInt, alignmentof[uv__queue].toInt)
      res(3) = align(res(2) + sizeof[uv__queue].toInt, Array(alignmentof[Ptr[Byte]].toInt, alignmentof[CUnsignedInt].toInt).max)
      res(4) = align(res(3) + sizeof[uv_loop_t.Active_reqs].toInt, alignmentof[Ptr[Byte]].toInt)
      res(5) = align(res(4) + sizeof[Ptr[Byte]].toInt, alignmentof[CUnsignedInt].toInt)
      res(6) = align(res(5) + sizeof[CUnsignedInt].toInt, alignmentof[CUnsignedLongInt].toInt)
      res(7) = align(res(6) + sizeof[CUnsignedLongInt].toInt, alignmentof[CInt].toInt)
      res(8) = align(res(7) + sizeof[CInt].toInt, alignmentof[uv__queue].toInt)
      ...
      res(24) = align(res(23) + sizeof[CFuncPtr0[Unit]].toInt, alignmentof[uv__io_t].toInt)
      res(25) = align(res(24) + sizeof[uv__io_t].toInt, alignmentof[CInt].toInt)
      res(26) = align(res(25) + sizeof[CInt].toInt, alignmentof[uv_loop_t.Timer_heap].toInt)
      res(27) = align(res(26) + sizeof[uv_loop_t.Timer_heap].toInt, alignmentof[uint64_t].toInt)
      res(28) = align(res(27) + sizeof[uint64_t].toInt, alignmentof[uint64_t].toInt)
      res(29) = align(res(28) + sizeof[uint64_t].toInt, alignmentof[CInt].toInt)
      res(30) = align(res(29) + sizeof[CArray[CInt, Nat._2]].toInt, alignmentof[uv__io_t].toInt)
      res(31) = align(res(30) + sizeof[uv__io_t].toInt, alignmentof[uv_signal_t].toInt)
  ...
  object uv_pipe_s:
    ...
    extension (struct: uv_pipe_s)
      ...
      def u_=(value: uv_pipe_s.U): Unit = !struct.at(offsets(5)).asInstanceOf[Ptr[uv_pipe_s.U]] = value
    ...
    val offsets: Array[Int] =
      ...
      res(6) = align(res(5) + sizeof[uv_pipe_s.U].toInt, alignmentof[Ptr[uv_handle_t]].toInt)
  ...
  object uv_pipe_t:
    ...
    extension (struct: uv_pipe_t)
      ...
      def u_=(value: uv_pipe_t.U): Unit = !struct.at(offsets(5)).asInstanceOf[Ptr[uv_pipe_t.U]] = value
      def next_closing: Ptr[uv_handle_t] = !struct.at(offsets(6)).asInstanceOf[Ptr[Ptr[uv_handle_t]]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at(offsets(6)).asInstanceOf[Ptr[Ptr[uv_handle_t]]] = value
      def flags: CUnsignedInt = !struct.at(offsets(7)).asInstanceOf[Ptr[CUnsignedInt]]
      def flags_=(value: CUnsignedInt): Unit = !struct.at(offsets(7)).asInstanceOf[Ptr[CUnsignedInt]] = value
    ...
    val offsets: Array[Int] =
      ...
      res(4) = align(res(3) + sizeof[uv_close_cb].toInt, alignmentof[uv__queue].toInt)
      res(5) = align(res(4) + sizeof[uv__queue].toInt, Array(alignmentof[CInt].toInt, alignmentof[CArray[Ptr[Byte], Nat._4]].toInt).max)
      res(6) = align(res(5) + sizeof[uv_pipe_t.U].toInt, alignmentof[Ptr[uv_handle_t]].toInt)
      res(7) = align(res(6) + sizeof[Ptr[uv_handle_t]].toInt, alignmentof[CUnsignedInt].toInt)
      res(8) = align(res(7) + sizeof[CUnsignedInt].toInt, alignmentof[size_t].toInt)
      res(9) = align(res(8) + sizeof[size_t].toInt, alignmentof[uv_alloc_cb].toInt)
      res(10) = align(res(9) + sizeof[uv_alloc_cb].toInt, alignmentof[uv_read_cb].toInt)
  ...
  opaque type uv_poll_s = CStruct10[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_poll_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__io_t]
  
  object uv_poll_s:
    given _tag: Tag[uv_poll_s] = Tag.materializeCStruct10Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_poll_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__io_t]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_poll_s.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt, poll_cb : uv_poll_cb, io_watcher : uv__io_t)(using Zone): Ptr[uv_poll_s] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
  ...
  opaque type uv_poll_t = CStruct10[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_poll_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__io_t]
  
  object uv_poll_t:
    given _tag: Tag[uv_poll_t] = Tag.materializeCStruct10Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_poll_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__io_t]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_poll_t.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt, poll_cb : uv_poll_cb, io_watcher : uv__io_t)(using Zone): Ptr[uv_poll_t] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
  ...
  opaque type uv_prepare_s = CStruct10[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_prepare_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]
  
  object uv_prepare_s:
    given _tag: Tag[uv_prepare_s] = Tag.materializeCStruct10Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_prepare_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_prepare_s.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt, prepare_cb : uv_prepare_cb, queue : uv__queue)(using Zone): Ptr[uv_prepare_s] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
  ...
  opaque type uv_prepare_t = CStruct10[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_prepare_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]
  
  object uv_prepare_t:
    given _tag: Tag[uv_prepare_t] = Tag.materializeCStruct10Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_prepare_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_prepare_t.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt, prepare_cb : uv_prepare_cb, queue : uv__queue)(using Zone): Ptr[uv_prepare_t] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
  ...
  opaque type uv_process_s = CStruct12[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_process_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], CInt, uv__queue, CInt]
  
  object uv_process_s:
    given _tag: Tag[uv_process_s] = Tag.materializeCStruct12Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_process_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], CInt, uv__queue, CInt]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_process_s.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt, exit_cb : uv_exit_cb, pid : CInt, queue : uv__queue, status : CInt)(using Zone): Ptr[uv_process_s] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
  ...
  opaque type uv_process_t = CStruct12[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_process_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], CInt, uv__queue, CInt]
  
  object uv_process_t:
    given _tag: Tag[uv_process_t] = Tag.materializeCStruct12Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_process_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], CInt, uv__queue, CInt]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_process_t.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt, exit_cb : uv_exit_cb, pid : CInt, queue : uv__queue, status : CInt)(using Zone): Ptr[uv_process_t] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
  ...
  opaque type uv_signal_s = CStruct13[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_signal_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], CInt, uv_signal_s.Tree_entry, CUnsignedInt, CUnsignedInt]
  
  object uv_signal_s:
    given _tag: Tag[uv_signal_s] = Tag.materializeCStruct13Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_signal_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], CInt, uv_signal_s.Tree_entry, CUnsignedInt, CUnsignedInt]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_signal_s.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt, signal_cb : uv_signal_cb, signum : CInt, tree_entry : uv_signal_s.Tree_entry, caught_signals : CUnsignedInt, dispatched_signals : CUnsignedInt)(using Zone): Ptr[uv_signal_s] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
    ...
    extension (struct: uv_signal_s)
      ...
      def tree_entry_=(value: uv_signal_s.Tree_entry): Unit = !struct.at11 = value
    ...
    object Tree_entry:
      given _tag: Tag[Tree_entry] = Tag.materializeCStruct4Tag[Ptr[Byte], Ptr[Byte], Ptr[Byte], CInt]
      
      // Allocates Tree_entry on the heap – fields are not initalised or zeroed out
      def apply()(using Zone): Ptr[Tree_entry] = scala.scalanative.unsafe.alloc[Tree_entry](1)
      def apply(rbe_left : Ptr[uv_signal_s], rbe_right : Ptr[uv_signal_s], rbe_parent : Ptr[uv_signal_s], rbe_color : CInt)(using Zone): Ptr[Tree_entry] =
        val ____ptr = apply()
  ...
  opaque type uv_signal_t = CStruct13[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_signal_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], CInt, uv_signal_t.Tree_entry, CUnsignedInt, CUnsignedInt]
  
  object uv_signal_t:
    given _tag: Tag[uv_signal_t] = Tag.materializeCStruct13Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_signal_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], CInt, uv_signal_t.Tree_entry, CUnsignedInt, CUnsignedInt]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_signal_t.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt, signal_cb : uv_signal_cb, signum : CInt, tree_entry : uv_signal_t.Tree_entry, caught_signals : CUnsignedInt, dispatched_signals : CUnsignedInt)(using Zone): Ptr[uv_signal_t] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
    ...
    extension (struct: uv_signal_t)
      ...
      def tree_entry_=(value: uv_signal_t.Tree_entry): Unit = !struct.at11 = value
      def caught_signals : CUnsignedInt = struct._12
      def caught_signals_=(value: CUnsignedInt): Unit = !struct.at12 = value
      def dispatched_signals : CUnsignedInt = struct._13
      def dispatched_signals_=(value: CUnsignedInt): Unit = !struct.at13 = value
  ...
  opaque type uv_stdio_container_s = CStruct2[uv_stdio_flags, uv_stdio_container_s.Data]
  
  object uv_stdio_container_s:
    given _tag: Tag[uv_stdio_container_s] = Tag.materializeCStruct2Tag[uv_stdio_flags, uv_stdio_container_s.Data]
    ...
    def apply(flags : uv_stdio_flags, data : uv_stdio_container_s.Data)(using Zone): Ptr[uv_stdio_container_s] =
      val ____ptr = apply()
      (!____ptr).flags = flags
      (!____ptr).data = data
      ____ptr
  ...
  opaque type uv_stdio_container_t = CStruct2[uv_stdio_flags, uv_stdio_container_t.Data]
  
  object uv_stdio_container_t:
    given _tag: Tag[uv_stdio_container_t] = Tag.materializeCStruct2Tag[uv_stdio_flags, uv_stdio_container_t.Data]
    ...
    def apply(flags : uv_stdio_flags, data : uv_stdio_container_t.Data)(using Zone): Ptr[uv_stdio_container_t] =
      val ____ptr = apply()
      (!____ptr).flags = flags
      (!____ptr).data = data
      ____ptr
  ...
  opaque type uv_stream_s = CStruct21[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_stream_s.U, Ptr[Byte], CUnsignedInt, size_t, Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[Byte], uv__io_t, uv__queue, uv__queue, Ptr[Byte], CInt, CInt, Ptr[Byte], Ptr[Byte]]
  
  object uv_stream_s:
    given _tag: Tag[uv_stream_s] = Tag.materializeCStruct21Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_stream_s.U, Ptr[Byte], CUnsignedInt, size_t, Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[Byte], uv__io_t, uv__queue, uv__queue, Ptr[Byte], CInt, CInt, Ptr[Byte], Ptr[Byte]]
  ...
  opaque type uv_stream_t = CStruct21[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_stream_t.U, Ptr[Byte], CUnsignedInt, size_t, Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[Byte], uv__io_t, uv__queue, uv__queue, Ptr[Byte], CInt, CInt, Ptr[Byte], Ptr[Byte]]
  
  object uv_stream_t:
    given _tag: Tag[uv_stream_t] = Tag.materializeCStruct21Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_stream_t.U, Ptr[Byte], CUnsignedInt, size_t, Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[Byte], uv__io_t, uv__queue, uv__queue, Ptr[Byte], CInt, CInt, Ptr[Byte], Ptr[Byte]]
  ...
  opaque type uv_tcp_s = CStruct21[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_tcp_s.U, Ptr[Byte], CUnsignedInt, size_t, Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[Byte], uv__io_t, uv__queue, uv__queue, Ptr[Byte], CInt, CInt, Ptr[Byte], Ptr[Byte]]
  
  object uv_tcp_s:
    given _tag: Tag[uv_tcp_s] = Tag.materializeCStruct21Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_tcp_s.U, Ptr[Byte], CUnsignedInt, size_t, Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[Byte], uv__io_t, uv__queue, uv__queue, Ptr[Byte], CInt, CInt, Ptr[Byte], Ptr[Byte]]
  ...
  opaque type uv_tcp_t = CStruct21[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_tcp_t.U, Ptr[Byte], CUnsignedInt, size_t, Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[Byte], uv__io_t, uv__queue, uv__queue, Ptr[Byte], CInt, CInt, Ptr[Byte], Ptr[Byte]]
  
  object uv_tcp_t:
    given _tag: Tag[uv_tcp_t] = Tag.materializeCStruct21Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_tcp_t.U, Ptr[Byte], CUnsignedInt, size_t, Ptr[Byte], Ptr[Byte], Ptr[Byte], Ptr[Byte], uv__io_t, uv__queue, uv__queue, Ptr[Byte], CInt, CInt, Ptr[Byte], Ptr[Byte]]
  ...
  opaque type uv_timer_s = CStruct13[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_timer_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv_timer_s.Node, uint64_t, uint64_t, uint64_t]
  
  object uv_timer_s:
    given _tag: Tag[uv_timer_s] = Tag.materializeCStruct13Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_timer_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv_timer_s.Node, uint64_t, uint64_t, uint64_t]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_timer_s.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt, timer_cb : uv_timer_cb, node : uv_timer_s.Node, timeout : uint64_t, repeat : uint64_t, start_id : uint64_t)(using Zone): Ptr[uv_timer_s] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
    ...
    object Node:
      given _tag: Tag[Node] = Tag.CArray[CChar, Nat.Digit2[Nat._2, Nat._4]](Tag.Byte, Tag.Digit2[Nat._2, Nat._4](Tag.Nat2, Tag.Nat4))
      ...
      extension (struct: Node)
        def heap : CArray[Ptr[Byte], Nat._3] = !struct.at(0).asInstanceOf[Ptr[CArray[Ptr[Byte], Nat._3]]]
        def heap_=(value: CArray[Ptr[Byte], Nat._3]): Unit = !struct.at(0).asInstanceOf[Ptr[CArray[Ptr[Byte], Nat._3]]] = value
        def queue : uv__queue = !struct.at(0).asInstanceOf[Ptr[uv__queue]]
        def queue_=(value: uv__queue): Unit = !struct.at(0).asInstanceOf[Ptr[uv__queue]] = value

  opaque type uv_timer_t = CStruct13[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_timer_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv_timer_t.Node, uint64_t, uint64_t, uint64_t]
  
  object uv_timer_t:
    given _tag: Tag[uv_timer_t] = Tag.materializeCStruct13Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_timer_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv_timer_t.Node, uint64_t, uint64_t, uint64_t]
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_timer_t.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt, timer_cb : uv_timer_cb, node : uv_timer_t.Node, timeout : uint64_t, repeat : uint64_t, start_id : uint64_t)(using Zone): Ptr[uv_timer_t] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
  ...
  object uv_tty_s:
    ...
    extension (struct: uv_tty_s)
      ...
      def u_=(value: uv_tty_s.U): Unit = !struct.at(offsets(5)).asInstanceOf[Ptr[uv_tty_s.U]] = value
      def next_closing: Ptr[uv_handle_t] = !struct.at(offsets(6)).asInstanceOf[Ptr[Ptr[uv_handle_t]]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at(offsets(6)).asInstanceOf[Ptr[Ptr[uv_handle_t]]] = value
      def flags: CUnsignedInt = !struct.at(offsets(7)).asInstanceOf[Ptr[CUnsignedInt]]
      def flags_=(value: CUnsignedInt): Unit = !struct.at(offsets(7)).asInstanceOf[Ptr[CUnsignedInt]] = value
    ...
    val offsets: Array[Int] =
      ...
      res(4) = align(res(3) + sizeof[uv_close_cb].toInt, alignmentof[uv__queue].toInt)
      res(5) = align(res(4) + sizeof[uv__queue].toInt, Array(alignmentof[CInt].toInt, alignmentof[CArray[Ptr[Byte], Nat._4]].toInt).max)
      res(6) = align(res(5) + sizeof[uv_tty_s.U].toInt, alignmentof[Ptr[uv_handle_t]].toInt)
      res(7) = align(res(6) + sizeof[Ptr[uv_handle_t]].toInt, alignmentof[CUnsignedInt].toInt)
      res(8) = align(res(7) + sizeof[CUnsignedInt].toInt, alignmentof[size_t].toInt)
      res(9) = align(res(8) + sizeof[size_t].toInt, alignmentof[uv_alloc_cb].toInt)
      res(10) = align(res(9) + sizeof[uv_alloc_cb].toInt, alignmentof[uv_read_cb].toInt)
  ...
  object uv_tty_t:
    ...
    def apply(data : Ptr[Byte], loop : Ptr[uv_loop_t], `type` : uv_handle_type, close_cb : uv_close_cb, handle_queue : uv__queue, u : uv_tty_t.U, next_closing : Ptr[uv_handle_t], flags : CUnsignedInt, write_queue_size : size_t, alloc_cb : uv_alloc_cb, read_cb : uv_read_cb, connect_req : Ptr[uv_connect_t], shutdown_req : Ptr[uv_shutdown_t], io_watcher : uv__io_t, write_queue : uv__queue, write_completed_queue : uv__queue, connection_cb : uv_connection_cb, delayed_error : CInt, accepted_fd : CInt, queued_fds : Ptr[Byte], select : Ptr[Byte], orig_termios : termios, mode : CInt)(using Zone): Ptr[uv_tty_t] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
    ...
    extension (struct: uv_tty_t)
      ...
      def u_=(value: uv_tty_t.U): Unit = !struct.at(offsets(5)).asInstanceOf[Ptr[uv_tty_t.U]] = value
      def next_closing: Ptr[uv_handle_t] = !struct.at(offsets(6)).asInstanceOf[Ptr[Ptr[uv_handle_t]]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at(offsets(6)).asInstanceOf[Ptr[Ptr[uv_handle_t]]] = value
      def flags: CUnsignedInt = !struct.at(offsets(7)).asInstanceOf[Ptr[CUnsignedInt]]
      def flags_=(value: CUnsignedInt): Unit = !struct.at(offsets(7)).asInstanceOf[Ptr[CUnsignedInt]] = value
    ...
    val offsets: Array[Int] =
      ...
      res(4) = align(res(3) + sizeof[uv_close_cb].toInt, alignmentof[uv__queue].toInt)
      res(5) = align(res(4) + sizeof[uv__queue].toInt, Array(alignmentof[CInt].toInt, alignmentof[CArray[Ptr[Byte], Nat._4]].toInt).max)
      res(6) = align(res(5) + sizeof[uv_tty_t.U].toInt, alignmentof[Ptr[uv_handle_t]].toInt)
      res(7) = align(res(6) + sizeof[Ptr[uv_handle_t]].toInt, alignmentof[CUnsignedInt].toInt)
      res(8) = align(res(7) + sizeof[CUnsignedInt].toInt, alignmentof[size_t].toInt)
      res(9) = align(res(8) + sizeof[size_t].toInt, alignmentof[uv_alloc_cb].toInt)
      res(10) = align(res(9) + sizeof[uv_alloc_cb].toInt, alignmentof[uv_read_cb].toInt)
  ...
  opaque type uv_udp_s = CStruct15[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_udp_s.U, Ptr[Byte], CUnsignedInt, size_t, size_t, Ptr[Byte], Ptr[Byte], uv__io_t, uv__queue, uv__queue]
  
  object uv_udp_s:
    given _tag: Tag[uv_udp_s] = Tag.materializeCStruct15Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_udp_s.U, Ptr[Byte], CUnsignedInt, size_t, size_t, Ptr[Byte], Ptr[Byte], uv__io_t, uv__queue, uv__queue]
  ...
  opaque type uv_udp_send_s = CStruct12[Ptr[Byte], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[Byte], Ptr[Byte], uv__queue, uv_udp_send_s.U, CUnsignedInt, Ptr[uv_buf_t], ssize_t, Ptr[Byte], CArray[uv_buf_t, Nat._4]]
  
  object uv_udp_send_s:
    given _tag: Tag[uv_udp_send_s] = Tag.materializeCStruct12Tag[Ptr[Byte], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[Byte], Ptr[Byte], uv__queue, uv_udp_send_s.U, CUnsignedInt, Ptr[uv_buf_t], ssize_t, Ptr[Byte], CArray[uv_buf_t, Nat._4]]
    ...
    def apply(data : Ptr[Byte], `type` : uv_req_type, reserved : CArray[Ptr[Byte], Nat._6], handle : Ptr[uv_udp_t], cb : uv_udp_send_cb, queue : uv__queue, u : uv_udp_send_s.U, nbufs : CUnsignedInt, bufs : Ptr[uv_buf_t], status : ssize_t, send_cb : uv_udp_send_cb, bufsml : CArray[uv_buf_t, Nat._4])(using Zone): Ptr[uv_udp_send_s] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).`type` = `type`
      (!____ptr).reserved = reserved
    ...
    object U:
      ...
      extension (struct: U)
        ...
        def addr_=(value: sockaddr): Unit = !struct.at(0).asInstanceOf[Ptr[sockaddr]] = value
        def storage : sockaddr_storage = !struct.at(0).asInstanceOf[Ptr[sockaddr_storage]]
        def storage_=(value: sockaddr_storage): Unit = !struct.at(0).asInstanceOf[Ptr[sockaddr_storage]] = value

  opaque type uv_udp_send_t = CStruct12[Ptr[Byte], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[Byte], Ptr[Byte], uv__queue, uv_udp_send_t.U, CUnsignedInt, Ptr[uv_buf_t], ssize_t, Ptr[Byte], CArray[uv_buf_t, Nat._4]]
  
  object uv_udp_send_t:
    given _tag: Tag[uv_udp_send_t] = Tag.materializeCStruct12Tag[Ptr[Byte], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[Byte], Ptr[Byte], uv__queue, uv_udp_send_t.U, CUnsignedInt, Ptr[uv_buf_t], ssize_t, Ptr[Byte], CArray[uv_buf_t, Nat._4]]
    ...
    def apply(data : Ptr[Byte], `type` : uv_req_type, reserved : CArray[Ptr[Byte], Nat._6], handle : Ptr[uv_udp_t], cb : uv_udp_send_cb, queue : uv__queue, u : uv_udp_send_t.U, nbufs : CUnsignedInt, bufs : Ptr[uv_buf_t], status : ssize_t, send_cb : uv_udp_send_cb, bufsml : CArray[uv_buf_t, Nat._4])(using Zone): Ptr[uv_udp_send_t] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).`type` = `type`
      (!____ptr).reserved = reserved
  ...
  opaque type uv_udp_t = CStruct15[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_udp_t.U, Ptr[Byte], CUnsignedInt, size_t, size_t, Ptr[Byte], Ptr[Byte], uv__io_t, uv__queue, uv__queue]
  
  object uv_udp_t:
    given _tag: Tag[uv_udp_t] = Tag.materializeCStruct15Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[Byte], uv__queue, uv_udp_t.U, Ptr[Byte], CUnsignedInt, size_t, size_t, Ptr[Byte], Ptr[Byte], uv__io_t, uv__queue, uv__queue]
