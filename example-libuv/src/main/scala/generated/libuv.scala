...
object predef:
  ...
  private[libuv] trait _BindgenEnumCUnsignedInt[T](using
      eq: T =:= CUnsignedInt
  ):
...
object enumerations:
    ...
    def getName(value: uv_loop_option): Option[String] =
      value match
        ...
        case `UV_LOOP_USE_IO_URING_SQPOLL` =>
          Some("UV_LOOP_USE_IO_URING_SQPOLL")
        case _ => _root_.scala.None
  ...
  object uv_process_flags extends _BindgenEnumCUnsignedInt[uv_process_flags]:
    ...
    def getName(value: uv_process_flags): Option[String] =
      value match
        ...
        case `UV_PROCESS_WINDOWS_VERBATIM_ARGUMENTS` =>
          Some("UV_PROCESS_WINDOWS_VERBATIM_ARGUMENTS")
        case `UV_PROCESS_DETACHED`     => Some("UV_PROCESS_DETACHED")
        case `UV_PROCESS_WINDOWS_HIDE` => Some("UV_PROCESS_WINDOWS_HIDE")
        case `UV_PROCESS_WINDOWS_HIDE_CONSOLE` =>
          Some("UV_PROCESS_WINDOWS_HIDE_CONSOLE")
        case `UV_PROCESS_WINDOWS_HIDE_GUI` =>
          Some("UV_PROCESS_WINDOWS_HIDE_GUI")
        case `UV_PROCESS_WINDOWS_FILE_PATH_EXACT_NAME` =>
          Some("UV_PROCESS_WINDOWS_FILE_PATH_EXACT_NAME")
        case _ => _root_.scala.None
  ...
  object uv_thread_create_flags
      extends _BindgenEnumCUnsignedInt[uv_thread_create_flags]:
  ...
  object uv_tty_vtermstate_t
      extends _BindgenEnumCUnsignedInt[uv_tty_vtermstate_t]:
...
object aliases:
  ...
  object DIR:
    ...
    extension (v: DIR) inline def value: posix.dirent.DIR = v
  ...
  object __darwin_mach_port_name_t:
    ...
    inline def apply(inline o: __darwin_natural_t): __darwin_mach_port_name_t =
      o
  ...
  object __darwin_mach_port_t:
    ...
    inline def apply(
        inline o: __darwin_mach_port_name_t
    ): __darwin_mach_port_t = o
  ...
  object __darwin_natural_t:
    ...
    extension (v: __darwin_natural_t) inline def value: CUnsignedInt = v
  ...
  object __uint16_t:
    ...
    extension (v: __uint16_t) inline def value: CUnsignedShort = v
  ...
  object addrinfo:
    ...
    extension (v: addrinfo) inline def value: posix.netdb.addrinfo = v
  ...
  object gid_t:
    ...
    extension (v: gid_t) inline def value: posix.sys.types.gid_t = v
  ...
  object mach_port_t:
    ...
    extension (v: mach_port_t) inline def value: __darwin_mach_port_t = v
  ...
  object mode_t:
    ...
    extension (v: mode_t) inline def value: posix.sys.types.mode_t = v
  ...
  object pid_t:
    ...
    extension (v: pid_t) inline def value: posix.sys.types.pid_t = v
  ...
  object pthread_cond_t:
    ...
    inline def apply(inline o: posix.sys.types.pthread_cond_t): pthread_cond_t =
      o
  ...
  object pthread_mutex_t:
    val _tag: Tag[pthread_mutex_t] =
      summon[Tag[posix.sys.types.pthread_mutex_t]]
    inline def apply(
        inline o: posix.sys.types.pthread_mutex_t
    ): pthread_mutex_t = o
  ...
  object pthread_rwlock_t:
    val _tag: Tag[pthread_rwlock_t] =
      summon[Tag[posix.sys.types.pthread_rwlock_t]]
    inline def apply(
        inline o: posix.sys.types.pthread_rwlock_t
    ): pthread_rwlock_t = o
  ...
  object semaphore_t:
    ...
    extension (v: semaphore_t) inline def value: mach_port_t = v
  ...
  object sockaddr_storage:
    val _tag: Tag[sockaddr_storage] =
      summon[Tag[posix.sys.socket.sockaddr_storage]]
    inline def apply(
        inline o: posix.sys.socket.sockaddr_storage
    ): sockaddr_storage = o
  ...
  object termios:
    ...
    extension (v: termios) inline def value: posix.termios.termios = v
  ...
  object uid_t:
    ...
    extension (v: uid_t) inline def value: posix.sys.types.uid_t = v
  ...
  opaque type uv__io_cb =
    CFuncPtr3[Ptr[uv_loop_s], Ptr[uv__io_s], CUnsignedInt, Unit]
  object uv__io_cb:
    given _tag: Tag[uv__io_cb] = Tag
      .materializeCFuncPtr3[Ptr[uv_loop_s], Ptr[uv__io_s], CUnsignedInt, Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv__io_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[uv_loop_s], Ptr[uv__io_s], CUnsignedInt, Unit]
    ): uv__io_cb = o
    extension (v: uv__io_cb)
      inline def value
          : CFuncPtr3[Ptr[uv_loop_s], Ptr[uv__io_s], CUnsignedInt, Unit] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end uv__io_cb

  opaque type uv_after_work_cb = CFuncPtr2[Ptr[uv_work_t], CInt, Unit]
  object uv_after_work_cb:
    given _tag: Tag[uv_after_work_cb] =
      Tag.materializeCFuncPtr2[Ptr[uv_work_t], CInt, Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_after_work_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr2[Ptr[uv_work_t], CInt, Unit]
    ): uv_after_work_cb = o
    extension (v: uv_after_work_cb)
      inline def value: CFuncPtr2[Ptr[uv_work_t], CInt, Unit] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end uv_after_work_cb

  opaque type uv_alloc_cb =
    CFuncPtr3[Ptr[uv_handle_t], size_t, Ptr[uv_buf_t], Unit]
  object uv_alloc_cb:
    given _tag: Tag[uv_alloc_cb] =
      Tag.materializeCFuncPtr3[Ptr[uv_handle_t], size_t, Ptr[uv_buf_t], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_alloc_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[uv_handle_t], size_t, Ptr[uv_buf_t], Unit]
    ): uv_alloc_cb = o
    extension (v: uv_alloc_cb)
      inline def value
          : CFuncPtr3[Ptr[uv_handle_t], size_t, Ptr[uv_buf_t], Unit] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end uv_alloc_cb

  opaque type uv_async_cb = CFuncPtr1[Ptr[uv_async_t], Unit]
  object uv_async_cb:
    given _tag: Tag[uv_async_cb] =
      Tag.materializeCFuncPtr1[Ptr[uv_async_t], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_async_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr1[Ptr[uv_async_t], Unit]): uv_async_cb =
      o
  ...
  object uv_calloc_func:
    given _tag: Tag[uv_calloc_func] =
      Tag.materializeCFuncPtr2[size_t, size_t, Ptr[Byte]]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_calloc_func =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
  ...
  object uv_check_cb:
    given _tag: Tag[uv_check_cb] =
      Tag.materializeCFuncPtr1[Ptr[uv_check_t], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_check_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr1[Ptr[uv_check_t], Unit]): uv_check_cb =
      o
  ...
  object uv_close_cb:
    given _tag: Tag[uv_close_cb] =
      Tag.materializeCFuncPtr1[Ptr[uv_handle_t], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_close_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr1[Ptr[uv_handle_t], Unit]): uv_close_cb =
      o
  ...
  object uv_cond_t:
    ...
    extension (v: uv_cond_t) inline def value: pthread_cond_t = v

  opaque type uv_connect_cb = CFuncPtr2[Ptr[uv_connect_t], CInt, Unit]
  object uv_connect_cb:
    given _tag: Tag[uv_connect_cb] =
      Tag.materializeCFuncPtr2[Ptr[uv_connect_t], CInt, Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_connect_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr2[Ptr[uv_connect_t], CInt, Unit]
    ): uv_connect_cb = o
  ...
  object uv_connection_cb:
    given _tag: Tag[uv_connection_cb] =
      Tag.materializeCFuncPtr2[Ptr[uv_stream_t], CInt, Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_connection_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr2[Ptr[uv_stream_t], CInt, Unit]
    ): uv_connection_cb = o
    extension (v: uv_connection_cb)
      inline def value: CFuncPtr2[Ptr[uv_stream_t], CInt, Unit] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end uv_connection_cb

  opaque type uv_exit_cb = CFuncPtr3[Ptr[uv_process_t], int64_t, CInt, Unit]
  object uv_exit_cb:
    given _tag: Tag[uv_exit_cb] =
      Tag.materializeCFuncPtr3[Ptr[uv_process_t], int64_t, CInt, Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_exit_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[uv_process_t], int64_t, CInt, Unit]
    ): uv_exit_cb = o
  ...
  object uv_fs_cb:
    ...
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_fs_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
  ...
  opaque type uv_fs_event_cb =
    CFuncPtr4[Ptr[uv_fs_event_t], CString, CInt, CInt, Unit]
  object uv_fs_event_cb:
    given _tag: Tag[uv_fs_event_cb] =
      Tag.materializeCFuncPtr4[Ptr[uv_fs_event_t], CString, CInt, CInt, Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_fs_event_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[Ptr[uv_fs_event_t], CString, CInt, CInt, Unit]
    ): uv_fs_event_cb = o
    extension (v: uv_fs_event_cb)
      inline def value
          : CFuncPtr4[Ptr[uv_fs_event_t], CString, CInt, CInt, Unit] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end uv_fs_event_cb

  opaque type uv_fs_poll_cb =
    CFuncPtr4[Ptr[uv_fs_poll_t], CInt, Ptr[uv_stat_t], Ptr[uv_stat_t], Unit]
  object uv_fs_poll_cb:
    given _tag: Tag[uv_fs_poll_cb] = Tag.materializeCFuncPtr4[Ptr[
      uv_fs_poll_t
    ], CInt, Ptr[uv_stat_t], Ptr[uv_stat_t], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_fs_poll_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[Ptr[uv_fs_poll_t], CInt, Ptr[uv_stat_t], Ptr[
          uv_stat_t
        ], Unit]
    ): uv_fs_poll_cb = o
    extension (v: uv_fs_poll_cb)
      inline def value: CFuncPtr4[Ptr[uv_fs_poll_t], CInt, Ptr[uv_stat_t], Ptr[
        uv_stat_t
      ], Unit] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end uv_fs_poll_cb

  opaque type uv_getaddrinfo_cb =
    CFuncPtr3[Ptr[uv_getaddrinfo_t], CInt, Ptr[addrinfo], Unit]
  object uv_getaddrinfo_cb:
    given _tag: Tag[uv_getaddrinfo_cb] =
      Tag.materializeCFuncPtr3[Ptr[uv_getaddrinfo_t], CInt, Ptr[addrinfo], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_getaddrinfo_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[uv_getaddrinfo_t], CInt, Ptr[addrinfo], Unit]
    ): uv_getaddrinfo_cb = o
    extension (v: uv_getaddrinfo_cb)
      inline def value
          : CFuncPtr3[Ptr[uv_getaddrinfo_t], CInt, Ptr[addrinfo], Unit] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end uv_getaddrinfo_cb

  opaque type uv_getnameinfo_cb =
    CFuncPtr4[Ptr[uv_getnameinfo_t], CInt, CString, CString, Unit]
  object uv_getnameinfo_cb:
    given _tag: Tag[uv_getnameinfo_cb] = Tag
      .materializeCFuncPtr4[Ptr[uv_getnameinfo_t], CInt, CString, CString, Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_getnameinfo_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[Ptr[uv_getnameinfo_t], CInt, CString, CString, Unit]
    ): uv_getnameinfo_cb = o
    extension (v: uv_getnameinfo_cb)
      inline def value
          : CFuncPtr4[Ptr[uv_getnameinfo_t], CInt, CString, CString, Unit] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end uv_getnameinfo_cb

  type uv_gid_t = gid_t
  object uv_gid_t:
    given _tag: Tag[uv_gid_t] = gid_t._tag
    inline def apply(inline o: gid_t): uv_gid_t = o
    extension (v: uv_gid_t) inline def value: gid_t = v

  opaque type uv_idle_cb = CFuncPtr1[Ptr[uv_idle_t], Unit]
  object uv_idle_cb:
    given _tag: Tag[uv_idle_cb] = Tag.materializeCFuncPtr1[Ptr[uv_idle_t], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_idle_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
  ...
  object uv_key_t:
    ...
    extension (v: uv_key_t) inline def value: pthread_key_t = v

  opaque type uv_malloc_func = CFuncPtr1[size_t, Ptr[Byte]]
  object uv_malloc_func:
    given _tag: Tag[uv_malloc_func] =
      Tag.materializeCFuncPtr1[size_t, Ptr[Byte]]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_malloc_func =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
  ...
  object uv_mutex_t:
    ...
    extension (v: uv_mutex_t) inline def value: pthread_mutex_t = v
  ...
  object uv_once_t:
    ...
    extension (v: uv_once_t) inline def value: pthread_once_t = v

  opaque type uv_os_fd_t = CInt
  object uv_os_fd_t:
    given _tag: Tag[uv_os_fd_t] = Tag.Int
    inline def apply(inline o: CInt): uv_os_fd_t = o
    extension (v: uv_os_fd_t) inline def value: CInt = v

  opaque type uv_os_sock_t = CInt
  object uv_os_sock_t:
    given _tag: Tag[uv_os_sock_t] = Tag.Int
    inline def apply(inline o: CInt): uv_os_sock_t = o
    extension (v: uv_os_sock_t) inline def value: CInt = v

  type uv_pid_t = pid_t
  object uv_pid_t:
    given _tag: Tag[uv_pid_t] = pid_t._tag
    inline def apply(inline o: pid_t): uv_pid_t = o
    extension (v: uv_pid_t) inline def value: pid_t = v

  opaque type uv_poll_cb = CFuncPtr3[Ptr[uv_poll_t], CInt, CInt, Unit]
  object uv_poll_cb:
    given _tag: Tag[uv_poll_cb] =
      Tag.materializeCFuncPtr3[Ptr[uv_poll_t], CInt, CInt, Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_poll_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[uv_poll_t], CInt, CInt, Unit]
    ): uv_poll_cb = o
  ...
  object uv_prepare_cb:
    given _tag: Tag[uv_prepare_cb] =
      Tag.materializeCFuncPtr1[Ptr[uv_prepare_t], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_prepare_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr1[Ptr[uv_prepare_t], Unit]
    ): uv_prepare_cb = o
  ...
  opaque type uv_random_cb =
    CFuncPtr4[Ptr[uv_random_t], CInt, Ptr[Byte], size_t, Unit]
  object uv_random_cb:
    given _tag: Tag[uv_random_cb] =
      Tag.materializeCFuncPtr4[Ptr[uv_random_t], CInt, Ptr[Byte], size_t, Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_random_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr4[Ptr[uv_random_t], CInt, Ptr[Byte], size_t, Unit]
    ): uv_random_cb = o
    extension (v: uv_random_cb)
      inline def value
          : CFuncPtr4[Ptr[uv_random_t], CInt, Ptr[Byte], size_t, Unit] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end uv_random_cb

  opaque type uv_read_cb =
    CFuncPtr3[Ptr[uv_stream_t], ssize_t, Ptr[uv_buf_t], Unit]
  object uv_read_cb:
    given _tag: Tag[uv_read_cb] =
      Tag.materializeCFuncPtr3[Ptr[uv_stream_t], ssize_t, Ptr[uv_buf_t], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_read_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[Ptr[uv_stream_t], ssize_t, Ptr[uv_buf_t], Unit]
    ): uv_read_cb = o
    extension (v: uv_read_cb)
      inline def value
          : CFuncPtr3[Ptr[uv_stream_t], ssize_t, Ptr[uv_buf_t], Unit] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end uv_read_cb

  opaque type uv_realloc_func = CFuncPtr2[Ptr[Byte], size_t, Ptr[Byte]]
  object uv_realloc_func:
    given _tag: Tag[uv_realloc_func] =
      Tag.materializeCFuncPtr2[Ptr[Byte], size_t, Ptr[Byte]]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_realloc_func =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
  ...
  object uv_rwlock_t:
    ...
    extension (v: uv_rwlock_t) inline def value: pthread_rwlock_t = v

  type uv_sem_t = semaphore_t
  object uv_sem_t:
    given _tag: Tag[uv_sem_t] = semaphore_t._tag
    inline def apply(inline o: semaphore_t): uv_sem_t = o
    extension (v: uv_sem_t) inline def value: semaphore_t = v

  opaque type uv_shutdown_cb = CFuncPtr2[Ptr[uv_shutdown_t], CInt, Unit]
  object uv_shutdown_cb:
    given _tag: Tag[uv_shutdown_cb] =
      Tag.materializeCFuncPtr2[Ptr[uv_shutdown_t], CInt, Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_shutdown_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr2[Ptr[uv_shutdown_t], CInt, Unit]
    ): uv_shutdown_cb = o
  ...
  object uv_signal_cb:
    given _tag: Tag[uv_signal_cb] =
      Tag.materializeCFuncPtr2[Ptr[uv_signal_t], CInt, Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_signal_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr2[Ptr[uv_signal_t], CInt, Unit]
    ): uv_signal_cb = o
  ...
  object uv_thread_cb:
    ...
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_thread_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
  ...
  object uv_thread_t:
    ...
    extension (v: uv_thread_t) inline def value: pthread_t = v

  opaque type uv_timer_cb = CFuncPtr1[Ptr[uv_timer_t], Unit]
  object uv_timer_cb:
    given _tag: Tag[uv_timer_cb] =
      Tag.materializeCFuncPtr1[Ptr[uv_timer_t], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_timer_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr1[Ptr[uv_timer_t], Unit]): uv_timer_cb =
      o
  ...
  opaque type uv_udp_recv_cb = CFuncPtr5[Ptr[uv_udp_t], ssize_t, Ptr[
    uv_buf_t
  ], Ptr[sockaddr], CUnsignedInt, Unit]
  object uv_udp_recv_cb:
    given _tag: Tag[uv_udp_recv_cb] = Tag.materializeCFuncPtr5[Ptr[
      uv_udp_t
    ], ssize_t, Ptr[uv_buf_t], Ptr[sockaddr], CUnsignedInt, Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_udp_recv_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr5[Ptr[uv_udp_t], ssize_t, Ptr[uv_buf_t], Ptr[
          sockaddr
        ], CUnsignedInt, Unit]
    ): uv_udp_recv_cb = o
    extension (v: uv_udp_recv_cb)
      inline def value: CFuncPtr5[Ptr[uv_udp_t], ssize_t, Ptr[uv_buf_t], Ptr[
        sockaddr
      ], CUnsignedInt, Unit] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end uv_udp_recv_cb
  ...
  object uv_udp_send_cb:
    given _tag: Tag[uv_udp_send_cb] =
      Tag.materializeCFuncPtr2[Ptr[uv_udp_send_t], CInt, Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_udp_send_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr2[Ptr[uv_udp_send_t], CInt, Unit]
    ): uv_udp_send_cb = o
  ...
  object uv_uid_t:
    ...
    extension (v: uv_uid_t) inline def value: uid_t = v

  opaque type uv_walk_cb = CFuncPtr2[Ptr[uv_handle_t], Ptr[Byte], Unit]
  object uv_walk_cb:
    given _tag: Tag[uv_walk_cb] =
      Tag.materializeCFuncPtr2[Ptr[uv_handle_t], Ptr[Byte], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_walk_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr2[Ptr[uv_handle_t], Ptr[Byte], Unit]
    ): uv_walk_cb = o
  ...
  object uv_work_cb:
    ...
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_work_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
  ...
  object uv_write_cb:
    given _tag: Tag[uv_write_cb] =
      Tag.materializeCFuncPtr2[Ptr[uv_write_t], CInt, Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): uv_write_cb =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr2[Ptr[uv_write_t], CInt, Unit]
    ): uv_write_cb = o
...
object structs:
  ...
  opaque type _uv_barrier =
    CStruct5[uv_mutex_t, uv_cond_t, CUnsignedInt, CUnsignedInt, CUnsignedInt]

  object _uv_barrier:
    given _tag: Tag[_uv_barrier] = Tag.materializeCStruct5Tag[
      uv_mutex_t,
      uv_cond_t,
      CUnsignedInt,
      CUnsignedInt,
    ...
    def apply()(using Zone): Ptr[_uv_barrier] =
      scala.scalanative.unsafe.alloc[_uv_barrier](1)
    def apply(
        mutex: uv_mutex_t,
        cond: uv_cond_t,
        threshold: CUnsignedInt,
        in: CUnsignedInt,
        out: CUnsignedInt
    )(using Zone): Ptr[_uv_barrier] =
      val ____ptr = apply()
      (!____ptr).mutex = mutex
      (!____ptr).cond = cond
  ...
  opaque type uv__dirent_t = CStruct6[
    __uint64_t,
    __uint64_t,
    __uint16_t,
    __uint16_t,
  ...
  object uv__dirent_t:
    given _tag: Tag[uv__dirent_t] = Tag.materializeCStruct6Tag[
      __uint64_t,
      __uint64_t,
      __uint16_t,
      __uint16_t,
    ...
    def apply()(using Zone): Ptr[uv__dirent_t] =
      scala.scalanative.unsafe.alloc[uv__dirent_t](1)
    def apply(
        d_ino: __uint64_t,
        ...
        d_namlen: __uint16_t,
        d_type: __uint8_t,
        d_name: CArray[CChar, Nat.Digit4[Nat._1, Nat._0, Nat._2, Nat._4]]
    )(using Zone): Ptr[uv__dirent_t] =
      val ____ptr = apply()
      (!____ptr).d_ino = d_ino
    ...
    extension (struct: uv__dirent_t)
      ...
      def d_name: CArray[CChar, Nat.Digit4[Nat._1, Nat._0, Nat._2, Nat._4]] =
        struct._6
      def d_name_=(
  ...
  opaque type uv__io_s = CStruct8[Ptr[
    Byte
  ], uv__queue, uv__queue, CUnsignedInt, CUnsignedInt, CInt, CInt, CInt]

  object uv__io_s:
    given _tag: Tag[uv__io_s] = Tag.materializeCStruct8Tag[Ptr[
      Byte
    ], uv__queue, uv__queue, CUnsignedInt, CUnsignedInt, CInt, CInt, CInt]

    // Allocates uv__io_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv__io_s] =
      scala.scalanative.unsafe.alloc[uv__io_s](1)
    def apply(
        cb: uv__io_cb,
        pending_queue: uv__queue,
        watcher_queue: uv__queue,
        pevents: CUnsignedInt,
        events: CUnsignedInt,
        fd: CInt,
        rcount: CInt,
        wcount: CInt
    )(using Zone): Ptr[uv__io_s] =
      val ____ptr = apply()
      (!____ptr).cb = cb
    ...
    extension (struct: uv__io_s)
      ...
      def cb_=(value: uv__io_cb): Unit = !struct.at1 =
  ...
  opaque type uv__io_t = CStruct8[Ptr[
    Byte
  ], uv__queue, uv__queue, CUnsignedInt, CUnsignedInt, CInt, CInt, CInt]

  object uv__io_t:
    given _tag: Tag[uv__io_t] = Tag.materializeCStruct8Tag[Ptr[
      Byte
    ], uv__queue, uv__queue, CUnsignedInt, CUnsignedInt, CInt, CInt, CInt]

    // Allocates uv__io_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv__io_t] =
      scala.scalanative.unsafe.alloc[uv__io_t](1)
    def apply(
        cb: uv__io_cb,
        pending_queue: uv__queue,
        watcher_queue: uv__queue,
  ...
  object uv__queue:
    given _tag: Tag[uv__queue] =
      Tag.materializeCStruct2Tag[Ptr[Byte], Ptr[Byte]]

    // Allocates uv__queue on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv__queue] =
      scala.scalanative.unsafe.alloc[uv__queue](1)
    def apply(next: Ptr[uv__queue], prev: Ptr[uv__queue])(using
        Zone
    ): Ptr[uv__queue] =
      val ____ptr = apply()
      (!____ptr).next = next
    ...
    extension (struct: uv__queue)
      ...
      def next_=(value: Ptr[uv__queue]): Unit = !struct.at1 =
        value.asInstanceOf[Ptr[Byte]]
      def prev: Ptr[uv__queue] = struct._2.asInstanceOf[Ptr[uv__queue]]
      def prev_=(value: Ptr[uv__queue]): Unit = !struct.at2 =
        value.asInstanceOf[Ptr[Byte]]
  end uv__queue

  opaque type uv__work =
    CStruct4[CFuncPtr1[Ptr[Byte], Unit], CFuncPtr2[Ptr[Byte], CInt, Unit], Ptr[
      uv_loop_s
    ], uv__queue]

  object uv__work:
    given _tag: Tag[uv__work] = Tag.materializeCStruct4Tag[CFuncPtr1[Ptr[
      Byte
    ], Unit], CFuncPtr2[Ptr[Byte], CInt, Unit], Ptr[uv_loop_s], uv__queue]

    // Allocates uv__work on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv__work] =
      scala.scalanative.unsafe.alloc[uv__work](1)
    def apply(
        work: CFuncPtr1[Ptr[uv__work], Unit],
        done: CFuncPtr2[Ptr[uv__work], CInt, Unit],
        loop: Ptr[uv_loop_s],
        wq: uv__queue
    )(using Zone): Ptr[uv__work] =
      val ____ptr = apply()
      (!____ptr).work = work
      (!____ptr).done = done
      (!____ptr).loop = loop
    ...
    extension (struct: uv__work)
      def work: CFuncPtr1[Ptr[uv__work], Unit] =
        struct._1.asInstanceOf[CFuncPtr1[Ptr[uv__work], Unit]]
      def work_=(value: CFuncPtr1[Ptr[uv__work], Unit]): Unit = !struct.at1 =
        value.asInstanceOf[CFuncPtr1[Ptr[Byte], Unit]]
      def done: CFuncPtr2[Ptr[uv__work], CInt, Unit] =
        struct._2.asInstanceOf[CFuncPtr2[Ptr[uv__work], CInt, Unit]]
      def done_=(value: CFuncPtr2[Ptr[uv__work], CInt, Unit]): Unit =
        !struct.at2 = value.asInstanceOf[CFuncPtr2[Ptr[Byte], CInt, Unit]]
  ...
  opaque type uv_async_s = CStruct11[
    Ptr[Byte],
    Ptr[uv_loop_t],
    uv_handle_type,
    Ptr[Byte],
  ...
  object uv_async_s:
    given _tag: Tag[uv_async_s] = Tag.materializeCStruct11Tag[Ptr[Byte], Ptr[
      uv_loop_t
    ], uv_handle_type, Ptr[Byte], uv__queue, uv_async_s.U, Ptr[
      Byte
    ], CUnsignedInt, Ptr[Byte], uv__queue, CInt]

    // Allocates uv_async_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_async_s] =
      scala.scalanative.unsafe.alloc[uv_async_s](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_async_s)
      ...
      def close_cb_=(value: uv_close_cb): Unit = !struct.at4 =
        value.asInstanceOf[Ptr[Byte]]
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_async_s.U = struct._6
      def u_=(value: uv_async_s.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
      ...
      def async_cb_=(value: uv_async_cb): Unit = !struct.at9 =
        value.asInstanceOf[Ptr[Byte]]
    ...
    opaque type U = CArray[Byte, Nat.Digit2[Nat._3, Nat._2]]
    object U:
      given _tag: Tag[U] = Tag.CArray[CChar, Nat.Digit2[Nat._3, Nat._2]](
        Tag.Byte,
      ...
      def apply(fd: CInt)(using Zone): Ptr[U] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[U](1)
        val un = !___ptr
      ...
      def apply(reserved: CArray[Ptr[Byte], Nat._4])(using Zone): Ptr[U] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[U](1)
        val un = !___ptr
        un.at(0)
          .asInstanceOf[Ptr[CArray[Ptr[Byte], Nat._4]]]
          .update(0, reserved)
        ___ptr

      extension (struct: U)
        def fd: CInt = !struct.at(0).asInstanceOf[Ptr[CInt]]
        def fd_=(value: CInt): Unit = !struct.at(0).asInstanceOf[Ptr[CInt]] =
          value
        def reserved: CArray[Ptr[Byte], Nat._4] =
          !struct.at(0).asInstanceOf[Ptr[CArray[Ptr[Byte], Nat._4]]]
        def reserved_=(value: CArray[Ptr[Byte], Nat._4]): Unit =
          !struct.at(0).asInstanceOf[Ptr[CArray[Ptr[Byte], Nat._4]]] = value
    end U
  end uv_async_s

  opaque type uv_async_t = CStruct11[
    Ptr[Byte],
    Ptr[uv_loop_t],
    uv_handle_type,
    Ptr[Byte],
  ...
  object uv_async_t:
    given _tag: Tag[uv_async_t] = Tag.materializeCStruct11Tag[Ptr[Byte], Ptr[
      uv_loop_t
    ], uv_handle_type, Ptr[Byte], uv__queue, uv_async_t.U, Ptr[
      Byte
    ], CUnsignedInt, Ptr[Byte], uv__queue, CInt]

    // Allocates uv_async_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_async_t] =
      scala.scalanative.unsafe.alloc[uv_async_t](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_async_t)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_async_t.U = struct._6
      def u_=(value: uv_async_t.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  object uv_barrier_t:
    ...
    def apply()(using Zone): Ptr[uv_barrier_t] =
      scala.scalanative.unsafe.alloc[uv_barrier_t](1)
  ...
  object uv_buf_t:
    ...
    def apply()(using Zone): Ptr[uv_buf_t] =
      scala.scalanative.unsafe.alloc[uv_buf_t](1)
  ...
  opaque type uv_check_s =
    CStruct10[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
      Byte
    ], uv__queue, uv_check_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]

  object uv_check_s:
    given _tag: Tag[uv_check_s] = Tag
      .materializeCStruct10Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
        Byte
      ], uv__queue, uv_check_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]

    // Allocates uv_check_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_check_s] =
      scala.scalanative.unsafe.alloc[uv_check_s](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_check_s)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_check_s.U = struct._6
      def u_=(value: uv_check_s.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
      ...
      def check_cb_=(value: uv_check_cb): Unit = !struct.at9 =
        value.asInstanceOf[Ptr[Byte]]
      def queue: uv__queue = struct._10
      def queue_=(value: uv__queue): Unit = !struct.at10 = value
    end extension
  ...
  opaque type uv_check_t =
    CStruct10[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
      Byte
    ], uv__queue, uv_check_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]

  object uv_check_t:
    given _tag: Tag[uv_check_t] = Tag
      .materializeCStruct10Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
        Byte
      ], uv__queue, uv_check_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]

    // Allocates uv_check_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_check_t] =
      scala.scalanative.unsafe.alloc[uv_check_t](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_check_t)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_check_t.U = struct._6
      def u_=(value: uv_check_t.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_connect_s =
    CStruct6[Ptr[Byte], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[Byte], Ptr[
      Byte
    ], uv__queue]

  object uv_connect_s:
    given _tag: Tag[uv_connect_s] = Tag.materializeCStruct6Tag[Ptr[
      Byte
    ], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[Byte], Ptr[Byte], uv__queue]

    // Allocates uv_connect_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_connect_s] =
      scala.scalanative.unsafe.alloc[uv_connect_s](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6],
        cb: uv_connect_cb,
        handle: Ptr[uv_stream_t],
        queue: uv__queue
    )(using Zone): Ptr[uv_connect_s] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).`type` = `type`
    ...
    extension (struct: uv_connect_s)
      ...
      def reserved_=(value: CArray[Ptr[Byte], Nat._6]): Unit = !struct.at3 =
        value
      def cb: uv_connect_cb = struct._4.asInstanceOf[uv_connect_cb]
      def cb_=(value: uv_connect_cb): Unit = !struct.at4 =
        value.asInstanceOf[Ptr[Byte]]
      def handle: Ptr[uv_stream_t] = struct._5.asInstanceOf[Ptr[uv_stream_t]]
      def handle_=(value: Ptr[uv_stream_t]): Unit = !struct.at5 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_connect_t =
    CStruct6[Ptr[Byte], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[Byte], Ptr[
      Byte
    ], uv__queue]

  object uv_connect_t:
    given _tag: Tag[uv_connect_t] = Tag.materializeCStruct6Tag[Ptr[
      Byte
    ], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[Byte], Ptr[Byte], uv__queue]

    // Allocates uv_connect_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_connect_t] =
      scala.scalanative.unsafe.alloc[uv_connect_t](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6],
  ...
  object uv_cpu_info_s:
    given _tag: Tag[uv_cpu_info_s] =
      Tag.materializeCStruct3Tag[CString, CInt, uv_cpu_times_s]

    // Allocates uv_cpu_info_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_cpu_info_s] =
      scala.scalanative.unsafe.alloc[uv_cpu_info_s](1)
    def apply(model: CString, speed: CInt, cpu_times: uv_cpu_times_s)(using
        Zone
    ): Ptr[uv_cpu_info_s] =
      val ____ptr = apply()
      (!____ptr).model = model
  ...
  object uv_cpu_info_t:
    given _tag: Tag[uv_cpu_info_t] =
      Tag.materializeCStruct3Tag[CString, CInt, uv_cpu_times_s]

    // Allocates uv_cpu_info_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_cpu_info_t] =
      scala.scalanative.unsafe.alloc[uv_cpu_info_t](1)
    def apply(model: CString, speed: CInt, cpu_times: uv_cpu_times_s)(using
        Zone
    ): Ptr[uv_cpu_info_t] =
      val ____ptr = apply()
  ...
  opaque type uv_cpu_times_s =
    CStruct5[uint64_t, uint64_t, uint64_t, uint64_t, uint64_t]

  object uv_cpu_times_s:
    given _tag: Tag[uv_cpu_times_s] = Tag
      .materializeCStruct5Tag[uint64_t, uint64_t, uint64_t, uint64_t, uint64_t]

    // Allocates uv_cpu_times_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_cpu_times_s] =
      scala.scalanative.unsafe.alloc[uv_cpu_times_s](1)
    def apply(
        user: uint64_t,
        nice: uint64_t,
        sys: uint64_t,
  ...
  opaque type uv_dir_s =
    CStruct4[Ptr[uv_dirent_t], size_t, CArray[Ptr[Byte], Nat._4], Ptr[DIR]]

  object uv_dir_s:
    given _tag: Tag[uv_dir_s] = Tag.materializeCStruct4Tag[Ptr[
      uv_dirent_t
    ], size_t, CArray[Ptr[Byte], Nat._4], Ptr[DIR]]

    // Allocates uv_dir_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_dir_s] =
      scala.scalanative.unsafe.alloc[uv_dir_s](1)
    def apply(
        dirents: Ptr[uv_dirent_t],
        nentries: size_t,
        reserved: CArray[Ptr[Byte], Nat._4],
        dir: Ptr[DIR]
    )(using Zone): Ptr[uv_dir_s] =
      val ____ptr = apply()
    ...
    extension (struct: uv_dir_s)
      ...
      def reserved_=(value: CArray[Ptr[Byte], Nat._4]): Unit = !struct.at3 =
        value
  ...
  opaque type uv_dir_t =
    CStruct4[Ptr[uv_dirent_t], size_t, CArray[Ptr[Byte], Nat._4], Ptr[DIR]]

  object uv_dir_t:
    given _tag: Tag[uv_dir_t] = Tag.materializeCStruct4Tag[Ptr[
      uv_dirent_t
    ], size_t, CArray[Ptr[Byte], Nat._4], Ptr[DIR]]

    // Allocates uv_dir_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_dir_t] =
      scala.scalanative.unsafe.alloc[uv_dir_t](1)
    def apply(
        dirents: Ptr[uv_dirent_t],
        nentries: size_t,
        reserved: CArray[Ptr[Byte], Nat._4],
        dir: Ptr[DIR]
    )(using Zone): Ptr[uv_dir_t] =
      val ____ptr = apply()
      (!____ptr).dirents = dirents
      (!____ptr).nentries = nentries
      (!____ptr).reserved = reserved
  ...
  object uv_dirent_s:
    given _tag: Tag[uv_dirent_s] =
      Tag.materializeCStruct2Tag[CString, uv_dirent_type_t]

    // Allocates uv_dirent_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_dirent_s] =
      scala.scalanative.unsafe.alloc[uv_dirent_s](1)
    def apply(name: CString, `type`: uv_dirent_type_t)(using
        Zone
    ): Ptr[uv_dirent_s] =
      val ____ptr = apply()
      (!____ptr).name = name
  ...
  object uv_dirent_t:
    given _tag: Tag[uv_dirent_t] =
      Tag.materializeCStruct2Tag[CString, uv_dirent_type_t]

    // Allocates uv_dirent_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_dirent_t] =
      scala.scalanative.unsafe.alloc[uv_dirent_t](1)
    def apply(name: CString, `type`: uv_dirent_type_t)(using
        Zone
    ): Ptr[uv_dirent_t] =
      val ____ptr = apply()
  ...
  object uv_env_item_t:
    given _tag: Tag[uv_env_item_t] =
      Tag.materializeCStruct2Tag[CString, CString]

    // Allocates uv_env_item_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_env_item_t] =
      scala.scalanative.unsafe.alloc[uv_env_item_t](1)
  ...
  opaque type uv_fs_event_s = CStruct19[
    Ptr[Byte],
    Ptr[uv_loop_t],
    uv_handle_type,
    Ptr[Byte],
  ...
  object uv_fs_event_s:
    given _tag: Tag[uv_fs_event_s] = Tag.materializeCStruct19Tag[
      Ptr[Byte],
      Ptr[uv_loop_t],
      uv_handle_type,
      Ptr[Byte],
    ...
    def apply()(using Zone): Ptr[uv_fs_event_s] =
      scala.scalanative.unsafe.alloc[uv_fs_event_s](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
        ...
        realpath_len: CInt,
        cf_flags: CInt,
        cf_cb: Ptr[uv_async_t],
        cf_events: uv__queue,
        cf_member: uv__queue,
        cf_error: CInt,
        cf_mutex: uv_mutex_t
    )(using Zone): Ptr[uv_fs_event_s] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
    ...
    extension (struct: uv_fs_event_s)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_fs_event_s.U = struct._6
      def u_=(value: uv_fs_event_s.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
      ...
      def cb_=(value: uv_fs_event_cb): Unit = !struct.at10 =
        value.asInstanceOf[Ptr[Byte]]
      ...
      def cf_cb_=(value: Ptr[uv_async_t]): Unit = !struct.at15 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_fs_event_t = CStruct19[
    Ptr[Byte],
    Ptr[uv_loop_t],
    uv_handle_type,
    Ptr[Byte],
  ...
  object uv_fs_event_t:
    given _tag: Tag[uv_fs_event_t] = Tag.materializeCStruct19Tag[
      Ptr[Byte],
      Ptr[uv_loop_t],
      uv_handle_type,
      Ptr[Byte],
    ...
    def apply()(using Zone): Ptr[uv_fs_event_t] =
      scala.scalanative.unsafe.alloc[uv_fs_event_t](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_fs_event_t)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_fs_event_t.U = struct._6
      def u_=(value: uv_fs_event_t.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_fs_poll_s =
    CStruct9[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
      Byte
    ], uv__queue, uv_fs_poll_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte]]

  object uv_fs_poll_s:
    given _tag: Tag[uv_fs_poll_s] =
      Tag.materializeCStruct9Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
        Byte
      ], uv__queue, uv_fs_poll_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte]]

    // Allocates uv_fs_poll_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_fs_poll_s] =
      scala.scalanative.unsafe.alloc[uv_fs_poll_s](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_fs_poll_s)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_fs_poll_s.U = struct._6
      def u_=(value: uv_fs_poll_s.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_fs_poll_t =
    CStruct9[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
      Byte
    ], uv__queue, uv_fs_poll_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte]]

  object uv_fs_poll_t:
    given _tag: Tag[uv_fs_poll_t] =
      Tag.materializeCStruct9Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
        Byte
      ], uv__queue, uv_fs_poll_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte]]

    // Allocates uv_fs_poll_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_fs_poll_t] =
      scala.scalanative.unsafe.alloc[uv_fs_poll_t](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_fs_poll_t)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_fs_poll_t.U = struct._6
      def u_=(value: uv_fs_poll_t.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  object uv_fs_s:
    given _tag: Tag[uv_fs_s] =
      Tag.CArray[CChar, Nat.Digit3[Nat._4, Nat._4, Nat._0]](
        Tag.Byte,
        Tag.Digit3[Nat._4, Nat._4, Nat._0](Tag.Nat4, Tag.Nat4, Tag.Nat0)
      )

    // Allocates uv_fs_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_fs_s] =
      scala.scalanative.unsafe.alloc[uv_fs_s](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6],
        ...
        mtime: Double,
        work_req: uv__work,
        bufsml: CArray[uv_buf_t, Nat._4]
    )(using Zone): Ptr[uv_fs_s] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).`type` = `type`
      (!____ptr).reserved = reserved
    ...
    extension (struct: uv_fs_s)
      ...
      def data_=(value: Ptr[Byte]): Unit =
        !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def `type`: uv_req_type =
        !struct.at(offsets(1)).asInstanceOf[Ptr[uv_req_type]]
      def type_=(value: uv_req_type): Unit =
        !struct.at(offsets(1)).asInstanceOf[Ptr[uv_req_type]] = value
      def reserved: CArray[Ptr[Byte], Nat._6] =
        !struct.at(offsets(2)).asInstanceOf[Ptr[CArray[Ptr[Byte], Nat._6]]]
      def reserved_=(value: CArray[Ptr[Byte], Nat._6]): Unit =
        !struct.at(offsets(2)).asInstanceOf[Ptr[CArray[Ptr[Byte], Nat._6]]] =
          value
      def fs_type: uv_fs_type =
        !struct.at(offsets(3)).asInstanceOf[Ptr[uv_fs_type]]
      def fs_type_=(value: uv_fs_type): Unit =
        !struct.at(offsets(3)).asInstanceOf[Ptr[uv_fs_type]] = value
      def loop: Ptr[uv_loop_t] =
        !struct.at(offsets(4)).asInstanceOf[Ptr[Ptr[uv_loop_t]]]
      def loop_=(value: Ptr[uv_loop_t]): Unit =
        !struct.at(offsets(4)).asInstanceOf[Ptr[Ptr[uv_loop_t]]] = value
      def cb: uv_fs_cb = !struct.at(offsets(5)).asInstanceOf[Ptr[uv_fs_cb]]
      def cb_=(value: uv_fs_cb): Unit =
        !struct.at(offsets(5)).asInstanceOf[Ptr[uv_fs_cb]] = value
      def result: ssize_t = !struct.at(offsets(6)).asInstanceOf[Ptr[ssize_t]]
      def result_=(value: ssize_t): Unit =
        !struct.at(offsets(6)).asInstanceOf[Ptr[ssize_t]] = value
      def ptr: Ptr[Byte] = !struct.at(offsets(7)).asInstanceOf[Ptr[Ptr[Byte]]]
      def ptr_=(value: Ptr[Byte]): Unit =
        !struct.at(offsets(7)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def path: CString = !struct.at(offsets(8)).asInstanceOf[Ptr[CString]]
      def path_=(value: CString): Unit =
        !struct.at(offsets(8)).asInstanceOf[Ptr[CString]] = value
      def statbuf: uv_stat_t =
        !struct.at(offsets(9)).asInstanceOf[Ptr[uv_stat_t]]
      def statbuf_=(value: uv_stat_t): Unit =
        !struct.at(offsets(9)).asInstanceOf[Ptr[uv_stat_t]] = value
      def new_path: CString = !struct.at(offsets(10)).asInstanceOf[Ptr[CString]]
      def new_path_=(value: CString): Unit =
        !struct.at(offsets(10)).asInstanceOf[Ptr[CString]] = value
      def file: uv_file = !struct.at(offsets(11)).asInstanceOf[Ptr[uv_file]]
      def file_=(value: uv_file): Unit =
        !struct.at(offsets(11)).asInstanceOf[Ptr[uv_file]] = value
      ...
      def mode_=(value: mode_t): Unit =
        !struct.at(offsets(13)).asInstanceOf[Ptr[mode_t]] = value
      def nbufs: CUnsignedInt =
        !struct.at(offsets(14)).asInstanceOf[Ptr[CUnsignedInt]]
      def nbufs_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(14)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def bufs: Ptr[uv_buf_t] =
        !struct.at(offsets(15)).asInstanceOf[Ptr[Ptr[uv_buf_t]]]
      def bufs_=(value: Ptr[uv_buf_t]): Unit =
        !struct.at(offsets(15)).asInstanceOf[Ptr[Ptr[uv_buf_t]]] = value
      def off: off_t = !struct.at(offsets(16)).asInstanceOf[Ptr[off_t]]
      def off_=(value: off_t): Unit =
        !struct.at(offsets(16)).asInstanceOf[Ptr[off_t]] = value
      def uid: uv_uid_t = !struct.at(offsets(17)).asInstanceOf[Ptr[uv_uid_t]]
      def uid_=(value: uv_uid_t): Unit =
        !struct.at(offsets(17)).asInstanceOf[Ptr[uv_uid_t]] = value
      def gid: uv_gid_t = !struct.at(offsets(18)).asInstanceOf[Ptr[uv_gid_t]]
      def gid_=(value: uv_gid_t): Unit =
        !struct.at(offsets(18)).asInstanceOf[Ptr[uv_gid_t]] = value
      def atime: Double = !struct.at(offsets(19)).asInstanceOf[Ptr[Double]]
      def atime_=(value: Double): Unit =
        !struct.at(offsets(19)).asInstanceOf[Ptr[Double]] = value
      def mtime: Double = !struct.at(offsets(20)).asInstanceOf[Ptr[Double]]
      def mtime_=(value: Double): Unit =
        !struct.at(offsets(20)).asInstanceOf[Ptr[Double]] = value
      def work_req: uv__work =
        !struct.at(offsets(21)).asInstanceOf[Ptr[uv__work]]
      def work_req_=(value: uv__work): Unit =
        !struct.at(offsets(21)).asInstanceOf[Ptr[uv__work]] = value
      def bufsml: CArray[uv_buf_t, Nat._4] =
        !struct.at(offsets(22)).asInstanceOf[Ptr[CArray[uv_buf_t, Nat._4]]]
      def bufsml_=(value: CArray[uv_buf_t, Nat._4]): Unit =
        !struct.at(offsets(22)).asInstanceOf[Ptr[CArray[uv_buf_t, Nat._4]]] =
          value
    end extension
    val offsets: Array[Int] =
      ...
      res(1) =
        align(res(0) + sizeof[Ptr[Byte]].toInt, alignmentof[uv_req_type].toInt)
      res(2) =
        align(res(1) + sizeof[uv_req_type].toInt, alignmentof[Ptr[Byte]].toInt)
      res(3) = align(
        res(2) + sizeof[CArray[Ptr[Byte], Nat._6]].toInt,
        alignmentof[uv_fs_type].toInt
      )
      res(4) = align(
        res(3) + sizeof[uv_fs_type].toInt,
        alignmentof[Ptr[uv_loop_t]].toInt
      )
      res(5) = align(
        res(4) + sizeof[Ptr[uv_loop_t]].toInt,
        alignmentof[uv_fs_cb].toInt
      )
      res(6) =
        align(res(5) + sizeof[uv_fs_cb].toInt, alignmentof[ssize_t].toInt)
      res(7) =
        align(res(6) + sizeof[ssize_t].toInt, alignmentof[Ptr[Byte]].toInt)
      res(8) =
        align(res(7) + sizeof[Ptr[Byte]].toInt, alignmentof[CString].toInt)
      res(9) =
        align(res(8) + sizeof[CString].toInt, alignmentof[uv_stat_t].toInt)
      res(10) =
        align(res(9) + sizeof[uv_stat_t].toInt, alignmentof[CString].toInt)
      res(11) =
        align(res(10) + sizeof[CString].toInt, alignmentof[uv_file].toInt)
      ...
      res(14) =
        align(res(13) + sizeof[mode_t].toInt, alignmentof[CUnsignedInt].toInt)
      res(15) = align(
        res(14) + sizeof[CUnsignedInt].toInt,
        alignmentof[Ptr[uv_buf_t]].toInt
      )
      res(16) =
        align(res(15) + sizeof[Ptr[uv_buf_t]].toInt, alignmentof[off_t].toInt)
      res(17) =
        align(res(16) + sizeof[off_t].toInt, alignmentof[uv_uid_t].toInt)
      res(18) =
        align(res(17) + sizeof[uv_uid_t].toInt, alignmentof[uv_gid_t].toInt)
      res(19) =
        align(res(18) + sizeof[uv_gid_t].toInt, alignmentof[Double].toInt)
      res(20) = align(res(19) + sizeof[Double].toInt, alignmentof[Double].toInt)
      res(21) =
        align(res(20) + sizeof[Double].toInt, alignmentof[uv__work].toInt)
      res(22) =
        align(res(21) + sizeof[uv__work].toInt, alignmentof[uv_buf_t].toInt)
      res
    end offsets
  end uv_fs_s
  ...
  object uv_fs_t:
    ...
    def apply()(using Zone): Ptr[uv_fs_t] =
      scala.scalanative.unsafe.alloc[uv_fs_t](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6],
  ...
  opaque type uv_getaddrinfo_s = CStruct11[
    Ptr[Byte],
    uv_req_type,
    CArray[Ptr[Byte], Nat._6],
    Ptr[uv_loop_t],
    uv__work,
    Ptr[Byte],
    Ptr[addrinfo],
  ...
  object uv_getaddrinfo_s:
    given _tag: Tag[uv_getaddrinfo_s] = Tag.materializeCStruct11Tag[Ptr[
      Byte
    ], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[uv_loop_t], uv__work, Ptr[
      Byte
    ], Ptr[addrinfo], CString, CString, Ptr[addrinfo], CInt]

    // Allocates uv_getaddrinfo_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_getaddrinfo_s] =
      scala.scalanative.unsafe.alloc[uv_getaddrinfo_s](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6],
        ...
        retcode: CInt
    )(using Zone): Ptr[uv_getaddrinfo_s] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).`type` = `type`
      (!____ptr).reserved = reserved
    ...
    extension (struct: uv_getaddrinfo_s)
      ...
      def cb_=(value: uv_getaddrinfo_cb): Unit = !struct.at6 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  end uv_getaddrinfo_s

  opaque type uv_getaddrinfo_t = CStruct11[
    Ptr[Byte],
    uv_req_type,
    CArray[Ptr[Byte], Nat._6],
    Ptr[uv_loop_t],
  ...
  object uv_getaddrinfo_t:
    given _tag: Tag[uv_getaddrinfo_t] = Tag.materializeCStruct11Tag[Ptr[
      Byte
    ], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[uv_loop_t], uv__work, Ptr[
      Byte
    ], Ptr[addrinfo], CString, CString, Ptr[addrinfo], CInt]
    ...
    def apply()(using Zone): Ptr[uv_getaddrinfo_t] =
      scala.scalanative.unsafe.alloc[uv_getaddrinfo_t](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6],
        ...
        addrinfo: Ptr[addrinfo],
        retcode: CInt
    )(using Zone): Ptr[uv_getaddrinfo_t] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).`type` = `type`
      (!____ptr).reserved = reserved
  ...
  end uv_getaddrinfo_t

  opaque type uv_getnameinfo_s = CStruct11[
    Ptr[Byte],
    uv_req_type,
    CArray[Ptr[Byte], Nat._6],
    Ptr[uv_loop_t],
    ...
    sockaddr_storage,
    CInt,
    CArray[CChar, Nat.Digit4[Nat._1, Nat._0, Nat._2, Nat._5]],
    CArray[CChar, Nat.Digit2[Nat._3, Nat._2]],
    CInt
  ]

  object uv_getnameinfo_s:
    given _tag: Tag[uv_getnameinfo_s] = Tag.materializeCStruct11Tag[
      Ptr[Byte],
      uv_req_type,
      CArray[Ptr[Byte], Nat._6],
      Ptr[uv_loop_t],
    ...
    def apply()(using Zone): Ptr[uv_getnameinfo_s] =
      scala.scalanative.unsafe.alloc[uv_getnameinfo_s](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6],
        ...
        flags: CInt,
        host: CArray[CChar, Nat.Digit4[Nat._1, Nat._0, Nat._2, Nat._5]],
        service: CArray[CChar, Nat.Digit2[Nat._3, Nat._2]],
        retcode: CInt
    )(using Zone): Ptr[uv_getnameinfo_s] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).`type` = `type`
      (!____ptr).reserved = reserved
    ...
    extension (struct: uv_getnameinfo_s)
      ...
      def work_req: uv__work = struct._5
      def work_req_=(value: uv__work): Unit = !struct.at5 = value
      def getnameinfo_cb: uv_getnameinfo_cb =
        struct._6.asInstanceOf[uv_getnameinfo_cb]
      def getnameinfo_cb_=(value: uv_getnameinfo_cb): Unit = !struct.at6 =
        value.asInstanceOf[Ptr[Byte]]
      ...
      def host: CArray[CChar, Nat.Digit4[Nat._1, Nat._0, Nat._2, Nat._5]] =
        struct._9
      def host_=(
          value: CArray[CChar, Nat.Digit4[Nat._1, Nat._0, Nat._2, Nat._5]]
      ): Unit = !struct.at9 = value
      def service: CArray[CChar, Nat.Digit2[Nat._3, Nat._2]] = struct._10
      def service_=(value: CArray[CChar, Nat.Digit2[Nat._3, Nat._2]]): Unit =
        !struct.at10 = value
      def retcode: CInt = struct._11
      def retcode_=(value: CInt): Unit = !struct.at11 = value
    end extension
  end uv_getnameinfo_s

  opaque type uv_getnameinfo_t = CStruct11[
    Ptr[Byte],
    uv_req_type,
    CArray[Ptr[Byte], Nat._6],
    Ptr[uv_loop_t],
  ...
  object uv_getnameinfo_t:
    given _tag: Tag[uv_getnameinfo_t] = Tag.materializeCStruct11Tag[
      Ptr[Byte],
      uv_req_type,
      CArray[Ptr[Byte], Nat._6],
      Ptr[uv_loop_t],
    ...
    def apply()(using Zone): Ptr[uv_getnameinfo_t] =
      scala.scalanative.unsafe.alloc[uv_getnameinfo_t](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6],
        ...
        service: CArray[CChar, Nat.Digit2[Nat._3, Nat._2]],
        retcode: CInt
    )(using Zone): Ptr[uv_getnameinfo_t] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).`type` = `type`
      (!____ptr).reserved = reserved
  ...
  end uv_getnameinfo_t

  opaque type uv_group_s = CStruct3[CString, CUnsignedLongInt, Ptr[CString]]

  object uv_group_s:
    given _tag: Tag[uv_group_s] =
      Tag.materializeCStruct3Tag[CString, CUnsignedLongInt, Ptr[CString]]

    // Allocates uv_group_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_group_s] =
      scala.scalanative.unsafe.alloc[uv_group_s](1)
    def apply(groupname: CString, gid: CUnsignedLongInt, members: Ptr[CString])(
        using Zone
    ): Ptr[uv_group_s] =
      val ____ptr = apply()
  ...
  object uv_group_t:
    given _tag: Tag[uv_group_t] =
      Tag.materializeCStruct3Tag[CString, CUnsignedLongInt, Ptr[CString]]

    // Allocates uv_group_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_group_t] =
      scala.scalanative.unsafe.alloc[uv_group_t](1)
    def apply(groupname: CString, gid: CUnsignedLongInt, members: Ptr[CString])(
        using Zone
    ): Ptr[uv_group_t] =
      val ____ptr = apply()
  ...
  opaque type uv_handle_s =
    CStruct8[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
      Byte
    ], uv__queue, uv_handle_s.U, Ptr[Byte], CUnsignedInt]

  object uv_handle_s:
    given _tag: Tag[uv_handle_s] =
      Tag.materializeCStruct8Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
        Byte
      ], uv__queue, uv_handle_s.U, Ptr[Byte], CUnsignedInt]

    // Allocates uv_handle_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_handle_s] =
      scala.scalanative.unsafe.alloc[uv_handle_s](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_handle_s)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_handle_s.U = struct._6
      def u_=(value: uv_handle_s.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_handle_t =
    CStruct8[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
      Byte
    ], uv__queue, uv_handle_t.U, Ptr[Byte], CUnsignedInt]

  object uv_handle_t:
    given _tag: Tag[uv_handle_t] =
      Tag.materializeCStruct8Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
        Byte
      ], uv__queue, uv_handle_t.U, Ptr[Byte], CUnsignedInt]

    // Allocates uv_handle_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_handle_t] =
      scala.scalanative.unsafe.alloc[uv_handle_t](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_handle_t)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_handle_t.U = struct._6
      def u_=(value: uv_handle_t.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_idle_s =
    CStruct10[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
      Byte
    ], uv__queue, uv_idle_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]

  object uv_idle_s:
    given _tag: Tag[uv_idle_s] = Tag
      .materializeCStruct10Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
        Byte
      ], uv__queue, uv_idle_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]

    // Allocates uv_idle_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_idle_s] =
      scala.scalanative.unsafe.alloc[uv_idle_s](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_idle_s)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_idle_s.U = struct._6
      def u_=(value: uv_idle_s.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
      ...
      def idle_cb_=(value: uv_idle_cb): Unit = !struct.at9 =
        value.asInstanceOf[Ptr[Byte]]
      def queue: uv__queue = struct._10
      def queue_=(value: uv__queue): Unit = !struct.at10 = value
    end extension
  ...
  opaque type uv_idle_t =
    CStruct10[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
      Byte
    ], uv__queue, uv_idle_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]

  object uv_idle_t:
    given _tag: Tag[uv_idle_t] = Tag
      .materializeCStruct10Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
        Byte
      ], uv__queue, uv_idle_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]

    // Allocates uv_idle_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_idle_t] =
      scala.scalanative.unsafe.alloc[uv_idle_t](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_idle_t)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_idle_t.U = struct._6
      def u_=(value: uv_idle_t.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_interface_address_s = CStruct5[
    CString,
    CArray[CChar, Nat._6],
    CInt,
  ...
  object uv_interface_address_s:
    given _tag: Tag[uv_interface_address_s] =
      Tag.materializeCStruct5Tag[CString, CArray[
        CChar,
        Nat._6
      ], CInt, uv_interface_address_s.Address, uv_interface_address_s.Netmask]

    // Allocates uv_interface_address_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_interface_address_s] =
      scala.scalanative.unsafe.alloc[uv_interface_address_s](1)
    def apply(
        name: CString,
        phys_addr: CArray[CChar, Nat._6],
        is_internal: CInt,
        address: uv_interface_address_s.Address,
        netmask: uv_interface_address_s.Netmask
    )(using Zone): Ptr[uv_interface_address_s] =
      val ____ptr = apply()
      (!____ptr).name = name
    ...
    extension (struct: uv_interface_address_s)
      ...
      def address: uv_interface_address_s.Address = struct._4
      def address_=(value: uv_interface_address_s.Address): Unit = !struct.at4 =
        value
      def netmask: uv_interface_address_s.Netmask = struct._5
      def netmask_=(value: uv_interface_address_s.Netmask): Unit = !struct.at5 =
        value
    end extension

    opaque type Address = CArray[Byte, Nat.Digit2[Nat._2, Nat._8]]
    object Address:
      given _tag: Tag[Address] = Tag.CArray[CChar, Nat.Digit2[Nat._2, Nat._8]](
        Tag.Byte,
        Tag.Digit2[Nat._2, Nat._8](Tag.Nat2, Tag.Nat8)
      )

      def apply()(using Zone): Ptr[Address] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Address](1)
        ___ptr

      @scala.annotation.targetName("apply_address4")
      def apply(address4: sockaddr_in)(using Zone): Ptr[Address] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Address](1)
        val un = !___ptr
      ...
      def apply(address6: sockaddr_in6)(using Zone): Ptr[Address] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Address](1)
        val un = !___ptr
        un.at(0).asInstanceOf[Ptr[sockaddr_in6]].update(0, address6)
        ___ptr

      extension (struct: Address)
        def address4: sockaddr_in = !struct.at(0).asInstanceOf[Ptr[sockaddr_in]]
        def address4_=(value: sockaddr_in): Unit =
          !struct.at(0).asInstanceOf[Ptr[sockaddr_in]] = value
        def address6: sockaddr_in6 =
          !struct.at(0).asInstanceOf[Ptr[sockaddr_in6]]
        def address6_=(value: sockaddr_in6): Unit =
          !struct.at(0).asInstanceOf[Ptr[sockaddr_in6]] = value
    end Address

    opaque type Netmask = CArray[Byte, Nat.Digit2[Nat._2, Nat._8]]
    object Netmask:
      given _tag: Tag[Netmask] = Tag.CArray[CChar, Nat.Digit2[Nat._2, Nat._8]](
        Tag.Byte,
        Tag.Digit2[Nat._2, Nat._8](Tag.Nat2, Tag.Nat8)
      )

      def apply()(using Zone): Ptr[Netmask] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Netmask](1)
        ___ptr

      @scala.annotation.targetName("apply_netmask4")
      def apply(netmask4: sockaddr_in)(using Zone): Ptr[Netmask] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Netmask](1)
        val un = !___ptr
      ...
      def apply(netmask6: sockaddr_in6)(using Zone): Ptr[Netmask] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Netmask](1)
        val un = !___ptr
        un.at(0).asInstanceOf[Ptr[sockaddr_in6]].update(0, netmask6)
        ___ptr

      extension (struct: Netmask)
        def netmask4: sockaddr_in = !struct.at(0).asInstanceOf[Ptr[sockaddr_in]]
        def netmask4_=(value: sockaddr_in): Unit =
          !struct.at(0).asInstanceOf[Ptr[sockaddr_in]] = value
        def netmask6: sockaddr_in6 =
          !struct.at(0).asInstanceOf[Ptr[sockaddr_in6]]
        def netmask6_=(value: sockaddr_in6): Unit =
          !struct.at(0).asInstanceOf[Ptr[sockaddr_in6]] = value
    end Netmask
  end uv_interface_address_s

  opaque type uv_interface_address_t = CStruct5[
    CString,
    CArray[CChar, Nat._6],
    CInt,
    uv_interface_address_t.Address,
    uv_interface_address_t.Netmask
  ]

  object uv_interface_address_t:
    given _tag: Tag[uv_interface_address_t] =
      Tag.materializeCStruct5Tag[CString, CArray[
        CChar,
        Nat._6
      ], CInt, uv_interface_address_t.Address, uv_interface_address_t.Netmask]

    // Allocates uv_interface_address_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_interface_address_t] =
      scala.scalanative.unsafe.alloc[uv_interface_address_t](1)
    def apply(
        name: CString,
        phys_addr: CArray[CChar, Nat._6],
        is_internal: CInt,
        address: uv_interface_address_t.Address,
        netmask: uv_interface_address_t.Netmask
    )(using Zone): Ptr[uv_interface_address_t] =
      val ____ptr = apply()
      (!____ptr).name = name
      (!____ptr).phys_addr = phys_addr
      (!____ptr).is_internal = is_internal
    ...
    extension (struct: uv_interface_address_t)
      ...
      def is_internal: CInt = struct._3
      def is_internal_=(value: CInt): Unit = !struct.at3 = value
      def address: uv_interface_address_t.Address = struct._4
      def address_=(value: uv_interface_address_t.Address): Unit = !struct.at4 =
        value
      def netmask: uv_interface_address_t.Netmask = struct._5
      def netmask_=(value: uv_interface_address_t.Netmask): Unit = !struct.at5 =
        value
    end extension
  ...
  object uv_lib_t:
    ...
    def apply()(using Zone): Ptr[uv_lib_t] =
      scala.scalanative.unsafe.alloc[uv_lib_t](1)
  ...
  opaque type uv_loop_s =
    CArray[CChar, Nat.Digit4[Nat._1, Nat._0, Nat._7, Nat._2]]

  object uv_loop_s:
    given _tag: Tag[uv_loop_s] =
      Tag.CArray[CChar, Nat.Digit4[Nat._1, Nat._0, Nat._7, Nat._2]](
        Tag.Byte,
        Tag.Digit4[Nat._1, Nat._0, Nat._7, Nat._2](
          Tag.Nat1,
          Tag.Nat0,
          Tag.Nat7,
          Tag.Nat2
    ...
    def apply()(using Zone): Ptr[uv_loop_s] =
      scala.scalanative.unsafe.alloc[uv_loop_s](1)
    def apply(
        data: Ptr[Byte],
        active_handles: CUnsignedInt,
        handle_queue: uv__queue,
        active_reqs: uv_loop_s.Active_reqs,
        internal_fields: Ptr[Byte],
        stop_flag: CUnsignedInt,
        flags: CUnsignedLongInt,
        backend_fd: CInt,
        pending_queue: uv__queue,
        watcher_queue: uv__queue,
        watchers: Ptr[Ptr[uv__io_t]],
        nwatchers: CUnsignedInt,
        nfds: CUnsignedInt,
        wq: uv__queue,
        wq_mutex: uv_mutex_t,
        wq_async: uv_async_t,
        ...
        async_unused: CFuncPtr0[Unit],
        async_io_watcher: uv__io_t,
        async_wfd: CInt,
        timer_heap: uv_loop_s.Timer_heap,
        timer_counter: uint64_t,
        time: uint64_t,
        signal_pipefd: CArray[CInt, Nat._2],
        signal_io_watcher: uv__io_t,
        child_watcher: uv_signal_t,
        emfile_fd: CInt,
        cf_thread: uv_thread_t,
        _cf_reserved: Ptr[Byte],
        cf_state: Ptr[Byte],
        cf_mutex: uv_mutex_t,
        cf_sem: uv_sem_t,
        cf_signals: uv__queue
    )(using Zone): Ptr[uv_loop_s] =
      val ____ptr = apply()
      (!____ptr).data = data
    ...
    extension (struct: uv_loop_s)
      ...
      def data_=(value: Ptr[Byte]): Unit =
        !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def active_handles: CUnsignedInt =
        !struct.at(offsets(1)).asInstanceOf[Ptr[CUnsignedInt]]
      def active_handles_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(1)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def handle_queue: uv__queue =
        !struct.at(offsets(2)).asInstanceOf[Ptr[uv__queue]]
      def handle_queue_=(value: uv__queue): Unit =
        !struct.at(offsets(2)).asInstanceOf[Ptr[uv__queue]] = value
      def active_reqs: uv_loop_s.Active_reqs =
        !struct.at(offsets(3)).asInstanceOf[Ptr[uv_loop_s.Active_reqs]]
      def active_reqs_=(value: uv_loop_s.Active_reqs): Unit =
        !struct.at(offsets(3)).asInstanceOf[Ptr[uv_loop_s.Active_reqs]] = value
      def internal_fields: Ptr[Byte] =
        !struct.at(offsets(4)).asInstanceOf[Ptr[Ptr[Byte]]]
      def internal_fields_=(value: Ptr[Byte]): Unit =
        !struct.at(offsets(4)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def stop_flag: CUnsignedInt =
        !struct.at(offsets(5)).asInstanceOf[Ptr[CUnsignedInt]]
      def stop_flag_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(5)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def flags: CUnsignedLongInt =
        !struct.at(offsets(6)).asInstanceOf[Ptr[CUnsignedLongInt]]
      def flags_=(value: CUnsignedLongInt): Unit =
        !struct.at(offsets(6)).asInstanceOf[Ptr[CUnsignedLongInt]] = value
      def backend_fd: CInt = !struct.at(offsets(7)).asInstanceOf[Ptr[CInt]]
      def backend_fd_=(value: CInt): Unit =
        !struct.at(offsets(7)).asInstanceOf[Ptr[CInt]] = value
      def pending_queue: uv__queue =
        !struct.at(offsets(8)).asInstanceOf[Ptr[uv__queue]]
      def pending_queue_=(value: uv__queue): Unit =
        !struct.at(offsets(8)).asInstanceOf[Ptr[uv__queue]] = value
      def watcher_queue: uv__queue =
        !struct.at(offsets(9)).asInstanceOf[Ptr[uv__queue]]
      def watcher_queue_=(value: uv__queue): Unit =
        !struct.at(offsets(9)).asInstanceOf[Ptr[uv__queue]] = value
      def watchers: Ptr[Ptr[uv__io_t]] =
        !struct.at(offsets(10)).asInstanceOf[Ptr[Ptr[Ptr[uv__io_t]]]]
      def watchers_=(value: Ptr[Ptr[uv__io_t]]): Unit =
        !struct.at(offsets(10)).asInstanceOf[Ptr[Ptr[Ptr[uv__io_t]]]] = value
      def nwatchers: CUnsignedInt =
        !struct.at(offsets(11)).asInstanceOf[Ptr[CUnsignedInt]]
      def nwatchers_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(11)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def nfds: CUnsignedInt =
        !struct.at(offsets(12)).asInstanceOf[Ptr[CUnsignedInt]]
      def nfds_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(12)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def wq: uv__queue = !struct.at(offsets(13)).asInstanceOf[Ptr[uv__queue]]
      def wq_=(value: uv__queue): Unit =
        !struct.at(offsets(13)).asInstanceOf[Ptr[uv__queue]] = value
      def wq_mutex: uv_mutex_t =
        !struct.at(offsets(14)).asInstanceOf[Ptr[uv_mutex_t]]
      def wq_mutex_=(value: uv_mutex_t): Unit =
        !struct.at(offsets(14)).asInstanceOf[Ptr[uv_mutex_t]] = value
      def wq_async: uv_async_t =
        !struct.at(offsets(15)).asInstanceOf[Ptr[uv_async_t]]
      def wq_async_=(value: uv_async_t): Unit =
        !struct.at(offsets(15)).asInstanceOf[Ptr[uv_async_t]] = value
      def cloexec_lock: uv_rwlock_t =
        !struct.at(offsets(16)).asInstanceOf[Ptr[uv_rwlock_t]]
      def cloexec_lock_=(value: uv_rwlock_t): Unit =
        !struct.at(offsets(16)).asInstanceOf[Ptr[uv_rwlock_t]] = value
      def closing_handles: Ptr[uv_handle_t] =
        !struct.at(offsets(17)).asInstanceOf[Ptr[Ptr[uv_handle_t]]]
      def closing_handles_=(value: Ptr[uv_handle_t]): Unit =
        !struct.at(offsets(17)).asInstanceOf[Ptr[Ptr[uv_handle_t]]] = value
      def process_handles: uv__queue =
        !struct.at(offsets(18)).asInstanceOf[Ptr[uv__queue]]
      def process_handles_=(value: uv__queue): Unit =
        !struct.at(offsets(18)).asInstanceOf[Ptr[uv__queue]] = value
      def prepare_handles: uv__queue =
        !struct.at(offsets(19)).asInstanceOf[Ptr[uv__queue]]
      def prepare_handles_=(value: uv__queue): Unit =
        !struct.at(offsets(19)).asInstanceOf[Ptr[uv__queue]] = value
      def check_handles: uv__queue =
        !struct.at(offsets(20)).asInstanceOf[Ptr[uv__queue]]
      def check_handles_=(value: uv__queue): Unit =
        !struct.at(offsets(20)).asInstanceOf[Ptr[uv__queue]] = value
      def idle_handles: uv__queue =
        !struct.at(offsets(21)).asInstanceOf[Ptr[uv__queue]]
      def idle_handles_=(value: uv__queue): Unit =
        !struct.at(offsets(21)).asInstanceOf[Ptr[uv__queue]] = value
      def async_handles: uv__queue =
        !struct.at(offsets(22)).asInstanceOf[Ptr[uv__queue]]
      def async_handles_=(value: uv__queue): Unit =
        !struct.at(offsets(22)).asInstanceOf[Ptr[uv__queue]] = value
      def async_unused: CFuncPtr0[Unit] =
        !struct.at(offsets(23)).asInstanceOf[Ptr[CFuncPtr0[Unit]]]
      def async_unused_=(value: CFuncPtr0[Unit]): Unit =
        !struct.at(offsets(23)).asInstanceOf[Ptr[CFuncPtr0[Unit]]] = value
      def async_io_watcher: uv__io_t =
        !struct.at(offsets(24)).asInstanceOf[Ptr[uv__io_t]]
      def async_io_watcher_=(value: uv__io_t): Unit =
        !struct.at(offsets(24)).asInstanceOf[Ptr[uv__io_t]] = value
      def async_wfd: CInt = !struct.at(offsets(25)).asInstanceOf[Ptr[CInt]]
      def async_wfd_=(value: CInt): Unit =
        !struct.at(offsets(25)).asInstanceOf[Ptr[CInt]] = value
      def timer_heap: uv_loop_s.Timer_heap =
        !struct.at(offsets(26)).asInstanceOf[Ptr[uv_loop_s.Timer_heap]]
      def timer_heap_=(value: uv_loop_s.Timer_heap): Unit =
        !struct.at(offsets(26)).asInstanceOf[Ptr[uv_loop_s.Timer_heap]] = value
      def timer_counter: uint64_t =
        !struct.at(offsets(27)).asInstanceOf[Ptr[uint64_t]]
      def timer_counter_=(value: uint64_t): Unit =
        !struct.at(offsets(27)).asInstanceOf[Ptr[uint64_t]] = value
      def time: uint64_t = !struct.at(offsets(28)).asInstanceOf[Ptr[uint64_t]]
      def time_=(value: uint64_t): Unit =
        !struct.at(offsets(28)).asInstanceOf[Ptr[uint64_t]] = value
      def signal_pipefd: CArray[CInt, Nat._2] =
        !struct.at(offsets(29)).asInstanceOf[Ptr[CArray[CInt, Nat._2]]]
      def signal_pipefd_=(value: CArray[CInt, Nat._2]): Unit =
        !struct.at(offsets(29)).asInstanceOf[Ptr[CArray[CInt, Nat._2]]] = value
      def signal_io_watcher: uv__io_t =
        !struct.at(offsets(30)).asInstanceOf[Ptr[uv__io_t]]
      def signal_io_watcher_=(value: uv__io_t): Unit =
        !struct.at(offsets(30)).asInstanceOf[Ptr[uv__io_t]] = value
      def child_watcher: uv_signal_t =
        !struct.at(offsets(31)).asInstanceOf[Ptr[uv_signal_t]]
      def child_watcher_=(value: uv_signal_t): Unit =
        !struct.at(offsets(31)).asInstanceOf[Ptr[uv_signal_t]] = value
      def emfile_fd: CInt = !struct.at(offsets(32)).asInstanceOf[Ptr[CInt]]
      def emfile_fd_=(value: CInt): Unit =
        !struct.at(offsets(32)).asInstanceOf[Ptr[CInt]] = value
      def cf_thread: uv_thread_t =
        !struct.at(offsets(33)).asInstanceOf[Ptr[uv_thread_t]]
      def cf_thread_=(value: uv_thread_t): Unit =
        !struct.at(offsets(33)).asInstanceOf[Ptr[uv_thread_t]] = value
      def _cf_reserved: Ptr[Byte] =
        !struct.at(offsets(34)).asInstanceOf[Ptr[Ptr[Byte]]]
      def _cf_reserved_=(value: Ptr[Byte]): Unit =
        !struct.at(offsets(34)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def cf_state: Ptr[Byte] =
        !struct.at(offsets(35)).asInstanceOf[Ptr[Ptr[Byte]]]
      def cf_state_=(value: Ptr[Byte]): Unit =
        !struct.at(offsets(35)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def cf_mutex: uv_mutex_t =
        !struct.at(offsets(36)).asInstanceOf[Ptr[uv_mutex_t]]
      def cf_mutex_=(value: uv_mutex_t): Unit =
        !struct.at(offsets(36)).asInstanceOf[Ptr[uv_mutex_t]] = value
      def cf_sem: uv_sem_t = !struct.at(offsets(37)).asInstanceOf[Ptr[uv_sem_t]]
      def cf_sem_=(value: uv_sem_t): Unit =
        !struct.at(offsets(37)).asInstanceOf[Ptr[uv_sem_t]] = value
      def cf_signals: uv__queue =
        !struct.at(offsets(38)).asInstanceOf[Ptr[uv__queue]]
      def cf_signals_=(value: uv__queue): Unit =
        !struct.at(offsets(38)).asInstanceOf[Ptr[uv__queue]] = value
    end extension
    val offsets: Array[Int] =
      ...
      res(0) = align(0, alignmentof[Ptr[Byte]].toInt)
      res(1) =
        align(res(0) + sizeof[Ptr[Byte]].toInt, alignmentof[CUnsignedInt].toInt)
      res(2) =
        align(res(1) + sizeof[CUnsignedInt].toInt, alignmentof[uv__queue].toInt)
      res(3) = align(
        res(2) + sizeof[uv__queue].toInt,
        Array(alignmentof[Ptr[Byte]].toInt, alignmentof[CUnsignedInt].toInt).max
      )
      res(4) = align(
        res(3) + sizeof[uv_loop_s.Active_reqs].toInt,
        alignmentof[Ptr[Byte]].toInt
      )
      res(5) =
        align(res(4) + sizeof[Ptr[Byte]].toInt, alignmentof[CUnsignedInt].toInt)
      res(6) = align(
        res(5) + sizeof[CUnsignedInt].toInt,
        alignmentof[CUnsignedLongInt].toInt
      )
      res(7) =
        align(res(6) + sizeof[CUnsignedLongInt].toInt, alignmentof[CInt].toInt)
      res(8) = align(res(7) + sizeof[CInt].toInt, alignmentof[uv__queue].toInt)
      res(9) =
        align(res(8) + sizeof[uv__queue].toInt, alignmentof[uv__queue].toInt)
      res(10) = align(
        res(9) + sizeof[uv__queue].toInt,
        alignmentof[Ptr[Ptr[uv__io_t]]].toInt
      )
      res(11) = align(
        res(10) + sizeof[Ptr[Ptr[uv__io_t]]].toInt,
        alignmentof[CUnsignedInt].toInt
      )
      res(12) = align(
        res(11) + sizeof[CUnsignedInt].toInt,
        alignmentof[CUnsignedInt].toInt
      )
      res(13) = align(
        res(12) + sizeof[CUnsignedInt].toInt,
        alignmentof[uv__queue].toInt
      )
      res(14) =
        align(res(13) + sizeof[uv__queue].toInt, alignmentof[uv_mutex_t].toInt)
      res(15) =
        align(res(14) + sizeof[uv_mutex_t].toInt, alignmentof[uv_async_t].toInt)
      res(16) = align(
        res(15) + sizeof[uv_async_t].toInt,
        alignmentof[uv_rwlock_t].toInt
      )
      res(17) = align(
        res(16) + sizeof[uv_rwlock_t].toInt,
        alignmentof[Ptr[uv_handle_t]].toInt
      )
      res(18) = align(
        res(17) + sizeof[Ptr[uv_handle_t]].toInt,
        alignmentof[uv__queue].toInt
      )
      res(19) =
        align(res(18) + sizeof[uv__queue].toInt, alignmentof[uv__queue].toInt)
      res(20) =
        align(res(19) + sizeof[uv__queue].toInt, alignmentof[uv__queue].toInt)
      res(21) =
        align(res(20) + sizeof[uv__queue].toInt, alignmentof[uv__queue].toInt)
      res(22) =
        align(res(21) + sizeof[uv__queue].toInt, alignmentof[uv__queue].toInt)
      res(23) = align(
        res(22) + sizeof[uv__queue].toInt,
        alignmentof[CFuncPtr0[Unit]].toInt
      )
      res(24) = align(
        res(23) + sizeof[CFuncPtr0[Unit]].toInt,
        alignmentof[uv__io_t].toInt
      )
      res(25) = align(res(24) + sizeof[uv__io_t].toInt, alignmentof[CInt].toInt)
      res(26) = align(
        res(25) + sizeof[CInt].toInt,
        alignmentof[uv_loop_s.Timer_heap].toInt
      )
      res(27) = align(
        res(26) + sizeof[uv_loop_s.Timer_heap].toInt,
        alignmentof[uint64_t].toInt
      )
      res(28) =
        align(res(27) + sizeof[uint64_t].toInt, alignmentof[uint64_t].toInt)
      res(29) = align(res(28) + sizeof[uint64_t].toInt, alignmentof[CInt].toInt)
      res(30) = align(
        res(29) + sizeof[CArray[CInt, Nat._2]].toInt,
        alignmentof[uv__io_t].toInt
      )
      res(31) =
        align(res(30) + sizeof[uv__io_t].toInt, alignmentof[uv_signal_t].toInt)
      res(32) =
        align(res(31) + sizeof[uv_signal_t].toInt, alignmentof[CInt].toInt)
      res(33) =
        align(res(32) + sizeof[CInt].toInt, alignmentof[uv_thread_t].toInt)
      res(34) =
        align(res(33) + sizeof[uv_thread_t].toInt, alignmentof[Ptr[Byte]].toInt)
      res(35) =
        align(res(34) + sizeof[Ptr[Byte]].toInt, alignmentof[Ptr[Byte]].toInt)
      res(36) =
        align(res(35) + sizeof[Ptr[Byte]].toInt, alignmentof[uv_mutex_t].toInt)
      res(37) =
        align(res(36) + sizeof[uv_mutex_t].toInt, alignmentof[uv_sem_t].toInt)
      res(38) =
        align(res(37) + sizeof[uv_sem_t].toInt, alignmentof[uv__queue].toInt)
      res
    end offsets

    opaque type Active_reqs = CArray[Byte, Nat._8]
    object Active_reqs:
      given _tag: Tag[Active_reqs] =
        Tag.CArray[CChar, Nat._8](Tag.Byte, Tag.Nat8)

      def apply()(using Zone): Ptr[Active_reqs] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Active_reqs](1)
        ___ptr

      @scala.annotation.targetName("apply_unused")
      def apply(unused: Ptr[Byte])(using Zone): Ptr[Active_reqs] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Active_reqs](1)
        val un = !___ptr
      ...
      def apply(count: CUnsignedInt)(using Zone): Ptr[Active_reqs] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Active_reqs](1)
        val un = !___ptr
        un.at(0).asInstanceOf[Ptr[CUnsignedInt]].update(0, count)
        ___ptr

      extension (struct: Active_reqs)
        def unused: Ptr[Byte] = !struct.at(0).asInstanceOf[Ptr[Ptr[Byte]]]
        def unused_=(value: Ptr[Byte]): Unit =
          !struct.at(0).asInstanceOf[Ptr[Ptr[Byte]]] = value
        def count: CUnsignedInt = !struct.at(0).asInstanceOf[Ptr[CUnsignedInt]]
        def count_=(value: CUnsignedInt): Unit =
          !struct.at(0).asInstanceOf[Ptr[CUnsignedInt]] = value
    end Active_reqs

    opaque type Timer_heap = CStruct2[Ptr[Byte], CUnsignedInt]

    object Timer_heap:
      given _tag: Tag[Timer_heap] =
        Tag.materializeCStruct2Tag[Ptr[Byte], CUnsignedInt]

      // Allocates Timer_heap on the heap – fields are not initalised or zeroed out
      def apply()(using Zone): Ptr[Timer_heap] =
        scala.scalanative.unsafe.alloc[Timer_heap](1)
      def apply(min: Ptr[Byte], nelts: CUnsignedInt)(using
          Zone
      ): Ptr[Timer_heap] =
        val ____ptr = apply()
        (!____ptr).min = min
  ...
  opaque type uv_loop_t =
    CArray[CChar, Nat.Digit4[Nat._1, Nat._0, Nat._7, Nat._2]]

  object uv_loop_t:
    given _tag: Tag[uv_loop_t] =
      Tag.CArray[CChar, Nat.Digit4[Nat._1, Nat._0, Nat._7, Nat._2]](
        Tag.Byte,
        Tag.Digit4[Nat._1, Nat._0, Nat._7, Nat._2](
          Tag.Nat1,
    ...
    def apply()(using Zone): Ptr[uv_loop_t] =
      scala.scalanative.unsafe.alloc[uv_loop_t](1)
    def apply(
        data: Ptr[Byte],
        active_handles: CUnsignedInt,
        handle_queue: uv__queue,
        active_reqs: uv_loop_t.Active_reqs,
        internal_fields: Ptr[Byte],
        stop_flag: CUnsignedInt,
        flags: CUnsignedLongInt,
        backend_fd: CInt,
        ...
        async_io_watcher: uv__io_t,
        async_wfd: CInt,
        timer_heap: uv_loop_t.Timer_heap,
        timer_counter: uint64_t,
        time: uint64_t,
        signal_pipefd: CArray[CInt, Nat._2],
        signal_io_watcher: uv__io_t,
    ...
    extension (struct: uv_loop_t)
      ...
      def handle_queue_=(value: uv__queue): Unit =
        !struct.at(offsets(2)).asInstanceOf[Ptr[uv__queue]] = value
      def active_reqs: uv_loop_t.Active_reqs =
        !struct.at(offsets(3)).asInstanceOf[Ptr[uv_loop_t.Active_reqs]]
      def active_reqs_=(value: uv_loop_t.Active_reqs): Unit =
        !struct.at(offsets(3)).asInstanceOf[Ptr[uv_loop_t.Active_reqs]] = value
      def internal_fields: Ptr[Byte] =
        !struct.at(offsets(4)).asInstanceOf[Ptr[Ptr[Byte]]]
      def internal_fields_=(value: Ptr[Byte]): Unit =
        !struct.at(offsets(4)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      ...
      def async_wfd_=(value: CInt): Unit =
        !struct.at(offsets(25)).asInstanceOf[Ptr[CInt]] = value
      def timer_heap: uv_loop_t.Timer_heap =
        !struct.at(offsets(26)).asInstanceOf[Ptr[uv_loop_t.Timer_heap]]
      def timer_heap_=(value: uv_loop_t.Timer_heap): Unit =
        !struct.at(offsets(26)).asInstanceOf[Ptr[uv_loop_t.Timer_heap]] = value
      def timer_counter: uint64_t =
        !struct.at(offsets(27)).asInstanceOf[Ptr[uint64_t]]
      def timer_counter_=(value: uint64_t): Unit =
        !struct.at(offsets(27)).asInstanceOf[Ptr[uint64_t]] = value
    ...
    val offsets: Array[Int] =
      ...
      res(4) = align(
        res(3) + sizeof[uv_loop_t.Active_reqs].toInt,
        alignmentof[Ptr[Byte]].toInt
      )
      res(5) =
        align(res(4) + sizeof[Ptr[Byte]].toInt, alignmentof[CUnsignedInt].toInt)
      ...
      res(26) = align(
        res(25) + sizeof[CInt].toInt,
        alignmentof[uv_loop_t.Timer_heap].toInt
      )
      res(27) = align(
        res(26) + sizeof[uv_loop_t.Timer_heap].toInt,
        alignmentof[uint64_t].toInt
      )
      res(28) =
        align(res(27) + sizeof[uint64_t].toInt, alignmentof[uint64_t].toInt)
  ...
  opaque type uv_metrics_s = CStruct4[uint64_t, uint64_t, uint64_t, CArray[Ptr[
    uint64_t
  ], Nat.Digit2[Nat._1, Nat._3]]]

  object uv_metrics_s:
    given _tag: Tag[uv_metrics_s] =
      Tag.materializeCStruct4Tag[uint64_t, uint64_t, uint64_t, CArray[Ptr[
        uint64_t
      ], Nat.Digit2[Nat._1, Nat._3]]]

    // Allocates uv_metrics_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_metrics_s] =
      scala.scalanative.unsafe.alloc[uv_metrics_s](1)
    def apply(
        loop_count: uint64_t,
        events: uint64_t,
        events_waiting: uint64_t,
        reserved: CArray[Ptr[uint64_t], Nat.Digit2[Nat._1, Nat._3]]
    )(using Zone): Ptr[uv_metrics_s] =
      val ____ptr = apply()
    ...
    extension (struct: uv_metrics_s)
      ...
      def reserved: CArray[Ptr[uint64_t], Nat.Digit2[Nat._1, Nat._3]] =
        struct._4
      def reserved_=(
          value: CArray[Ptr[uint64_t], Nat.Digit2[Nat._1, Nat._3]]
      ): Unit = !struct.at4 = value
    end extension
  end uv_metrics_s

  opaque type uv_metrics_t = CStruct4[uint64_t, uint64_t, uint64_t, CArray[Ptr[
    uint64_t
  ], Nat.Digit2[Nat._1, Nat._3]]]

  object uv_metrics_t:
    given _tag: Tag[uv_metrics_t] =
      Tag.materializeCStruct4Tag[uint64_t, uint64_t, uint64_t, CArray[Ptr[
        uint64_t
      ], Nat.Digit2[Nat._1, Nat._3]]]

    // Allocates uv_metrics_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_metrics_t] =
      scala.scalanative.unsafe.alloc[uv_metrics_t](1)
    def apply(
        loop_count: uint64_t,
        events: uint64_t,
        events_waiting: uint64_t,
        reserved: CArray[Ptr[uint64_t], Nat.Digit2[Nat._1, Nat._3]]
    )(using Zone): Ptr[uv_metrics_t] =
      val ____ptr = apply()
      (!____ptr).loop_count = loop_count
      (!____ptr).events = events
      (!____ptr).events_waiting = events_waiting
  ...
  opaque type uv_passwd_s =
    CStruct5[CString, CUnsignedLongInt, CUnsignedLongInt, CString, CString]

  object uv_passwd_s:
    given _tag: Tag[uv_passwd_s] = Tag.materializeCStruct5Tag[
      CString,
      CUnsignedLongInt,
      CUnsignedLongInt,
      CString,
    ...
    def apply()(using Zone): Ptr[uv_passwd_s] =
      scala.scalanative.unsafe.alloc[uv_passwd_s](1)
    def apply(
        username: CString,
        uid: CUnsignedLongInt,
        gid: CUnsignedLongInt,
        shell: CString,
        homedir: CString
    )(using Zone): Ptr[uv_passwd_s] =
      val ____ptr = apply()
  ...
  opaque type uv_passwd_t =
    CStruct5[CString, CUnsignedLongInt, CUnsignedLongInt, CString, CString]

  object uv_passwd_t:
    given _tag: Tag[uv_passwd_t] = Tag.materializeCStruct5Tag[
      CString,
      CUnsignedLongInt,
      CUnsignedLongInt,
      CString,
    ...
    def apply()(using Zone): Ptr[uv_passwd_t] =
      scala.scalanative.unsafe.alloc[uv_passwd_t](1)
    def apply(
        username: CString,
        uid: CUnsignedLongInt,
        gid: CUnsignedLongInt,
  ...
  object uv_pipe_s:
    ...
    def apply()(using Zone): Ptr[uv_pipe_s] =
      scala.scalanative.unsafe.alloc[uv_pipe_s](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_pipe_s)
      ...
      def data_=(value: Ptr[Byte]): Unit =
        !struct.at(offsets(0)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def loop: Ptr[uv_loop_t] =
        !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[uv_loop_t]]]
      def loop_=(value: Ptr[uv_loop_t]): Unit =
        !struct.at(offsets(1)).asInstanceOf[Ptr[Ptr[uv_loop_t]]] = value
      def `type`: uv_handle_type =
        !struct.at(offsets(2)).asInstanceOf[Ptr[uv_handle_type]]
      def type_=(value: uv_handle_type): Unit =
        !struct.at(offsets(2)).asInstanceOf[Ptr[uv_handle_type]] = value
      def close_cb: uv_close_cb =
        !struct.at(offsets(3)).asInstanceOf[Ptr[uv_close_cb]]
      def close_cb_=(value: uv_close_cb): Unit =
        !struct.at(offsets(3)).asInstanceOf[Ptr[uv_close_cb]] = value
      def handle_queue: uv__queue =
        !struct.at(offsets(4)).asInstanceOf[Ptr[uv__queue]]
      def handle_queue_=(value: uv__queue): Unit =
        !struct.at(offsets(4)).asInstanceOf[Ptr[uv__queue]] = value
      def u: uv_pipe_s.U = !struct.at(offsets(5)).asInstanceOf[Ptr[uv_pipe_s.U]]
      def u_=(value: uv_pipe_s.U): Unit =
        !struct.at(offsets(5)).asInstanceOf[Ptr[uv_pipe_s.U]] = value
      def next_closing: Ptr[uv_handle_t] =
        !struct.at(offsets(6)).asInstanceOf[Ptr[Ptr[uv_handle_t]]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit =
        !struct.at(offsets(6)).asInstanceOf[Ptr[Ptr[uv_handle_t]]] = value
      def flags: CUnsignedInt =
        !struct.at(offsets(7)).asInstanceOf[Ptr[CUnsignedInt]]
      def flags_=(value: CUnsignedInt): Unit =
        !struct.at(offsets(7)).asInstanceOf[Ptr[CUnsignedInt]] = value
      def write_queue_size: size_t =
        !struct.at(offsets(8)).asInstanceOf[Ptr[size_t]]
      def write_queue_size_=(value: size_t): Unit =
        !struct.at(offsets(8)).asInstanceOf[Ptr[size_t]] = value
      def alloc_cb: uv_alloc_cb =
        !struct.at(offsets(9)).asInstanceOf[Ptr[uv_alloc_cb]]
      def alloc_cb_=(value: uv_alloc_cb): Unit =
        !struct.at(offsets(9)).asInstanceOf[Ptr[uv_alloc_cb]] = value
      def read_cb: uv_read_cb =
        !struct.at(offsets(10)).asInstanceOf[Ptr[uv_read_cb]]
      def read_cb_=(value: uv_read_cb): Unit =
        !struct.at(offsets(10)).asInstanceOf[Ptr[uv_read_cb]] = value
      def connect_req: Ptr[uv_connect_t] =
        !struct.at(offsets(11)).asInstanceOf[Ptr[Ptr[uv_connect_t]]]
      def connect_req_=(value: Ptr[uv_connect_t]): Unit =
        !struct.at(offsets(11)).asInstanceOf[Ptr[Ptr[uv_connect_t]]] = value
      def shutdown_req: Ptr[uv_shutdown_t] =
        !struct.at(offsets(12)).asInstanceOf[Ptr[Ptr[uv_shutdown_t]]]
      def shutdown_req_=(value: Ptr[uv_shutdown_t]): Unit =
        !struct.at(offsets(12)).asInstanceOf[Ptr[Ptr[uv_shutdown_t]]] = value
      def io_watcher: uv__io_t =
        !struct.at(offsets(13)).asInstanceOf[Ptr[uv__io_t]]
      def io_watcher_=(value: uv__io_t): Unit =
        !struct.at(offsets(13)).asInstanceOf[Ptr[uv__io_t]] = value
      def write_queue: uv__queue =
        !struct.at(offsets(14)).asInstanceOf[Ptr[uv__queue]]
      def write_queue_=(value: uv__queue): Unit =
        !struct.at(offsets(14)).asInstanceOf[Ptr[uv__queue]] = value
      def write_completed_queue: uv__queue =
        !struct.at(offsets(15)).asInstanceOf[Ptr[uv__queue]]
      def write_completed_queue_=(value: uv__queue): Unit =
        !struct.at(offsets(15)).asInstanceOf[Ptr[uv__queue]] = value
      def connection_cb: uv_connection_cb =
        !struct.at(offsets(16)).asInstanceOf[Ptr[uv_connection_cb]]
      def connection_cb_=(value: uv_connection_cb): Unit =
        !struct.at(offsets(16)).asInstanceOf[Ptr[uv_connection_cb]] = value
      def delayed_error: CInt = !struct.at(offsets(17)).asInstanceOf[Ptr[CInt]]
      def delayed_error_=(value: CInt): Unit =
        !struct.at(offsets(17)).asInstanceOf[Ptr[CInt]] = value
      def accepted_fd: CInt = !struct.at(offsets(18)).asInstanceOf[Ptr[CInt]]
      def accepted_fd_=(value: CInt): Unit =
        !struct.at(offsets(18)).asInstanceOf[Ptr[CInt]] = value
      def queued_fds: Ptr[Byte] =
        !struct.at(offsets(19)).asInstanceOf[Ptr[Ptr[Byte]]]
      def queued_fds_=(value: Ptr[Byte]): Unit =
        !struct.at(offsets(19)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def select: Ptr[Byte] =
        !struct.at(offsets(20)).asInstanceOf[Ptr[Ptr[Byte]]]
      def select_=(value: Ptr[Byte]): Unit =
        !struct.at(offsets(20)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def ipc: CInt = !struct.at(offsets(21)).asInstanceOf[Ptr[CInt]]
      def ipc_=(value: CInt): Unit =
        !struct.at(offsets(21)).asInstanceOf[Ptr[CInt]] = value
      def pipe_fname: CString =
        !struct.at(offsets(22)).asInstanceOf[Ptr[CString]]
      def pipe_fname_=(value: CString): Unit =
    ...
    val offsets: Array[Int] =
      ...
      res(2) = align(
        res(1) + sizeof[Ptr[uv_loop_t]].toInt,
        alignmentof[uv_handle_type].toInt
      )
      res(3) = align(
        res(2) + sizeof[uv_handle_type].toInt,
        alignmentof[uv_close_cb].toInt
      )
      res(4) =
        align(res(3) + sizeof[uv_close_cb].toInt, alignmentof[uv__queue].toInt)
      res(5) = align(
        res(4) + sizeof[uv__queue].toInt,
        Array(
          alignmentof[CInt].toInt,
          alignmentof[CArray[Ptr[Byte], Nat._4]].toInt
        ).max
      )
      res(6) = align(
        res(5) + sizeof[uv_pipe_s.U].toInt,
        alignmentof[Ptr[uv_handle_t]].toInt
      )
      res(7) = align(
        res(6) + sizeof[Ptr[uv_handle_t]].toInt,
        alignmentof[CUnsignedInt].toInt
      )
      res(8) =
        align(res(7) + sizeof[CUnsignedInt].toInt, alignmentof[size_t].toInt)
      res(9) =
        align(res(8) + sizeof[size_t].toInt, alignmentof[uv_alloc_cb].toInt)
      res(10) =
        align(res(9) + sizeof[uv_alloc_cb].toInt, alignmentof[uv_read_cb].toInt)
      res(11) = align(
        res(10) + sizeof[uv_read_cb].toInt,
        alignmentof[Ptr[uv_connect_t]].toInt
      )
      res(12) = align(
        res(11) + sizeof[Ptr[uv_connect_t]].toInt,
        alignmentof[Ptr[uv_shutdown_t]].toInt
      )
      res(13) = align(
        res(12) + sizeof[Ptr[uv_shutdown_t]].toInt,
        alignmentof[uv__io_t].toInt
      )
      res(14) =
        align(res(13) + sizeof[uv__io_t].toInt, alignmentof[uv__queue].toInt)
      res(15) =
        align(res(14) + sizeof[uv__queue].toInt, alignmentof[uv__queue].toInt)
      res(16) = align(
        res(15) + sizeof[uv__queue].toInt,
        alignmentof[uv_connection_cb].toInt
      )
      res(17) =
        align(res(16) + sizeof[uv_connection_cb].toInt, alignmentof[CInt].toInt)
      res(18) = align(res(17) + sizeof[CInt].toInt, alignmentof[CInt].toInt)
      res(19) =
        align(res(18) + sizeof[CInt].toInt, alignmentof[Ptr[Byte]].toInt)
      res(20) =
        align(res(19) + sizeof[Ptr[Byte]].toInt, alignmentof[Ptr[Byte]].toInt)
      res(21) =
        align(res(20) + sizeof[Ptr[Byte]].toInt, alignmentof[CInt].toInt)
  ...
  object uv_pipe_t:
    ...
    def apply()(using Zone): Ptr[uv_pipe_t] =
      scala.scalanative.unsafe.alloc[uv_pipe_t](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_pipe_t)
      ...
      def handle_queue_=(value: uv__queue): Unit =
        !struct.at(offsets(4)).asInstanceOf[Ptr[uv__queue]] = value
      def u: uv_pipe_t.U = !struct.at(offsets(5)).asInstanceOf[Ptr[uv_pipe_t.U]]
      def u_=(value: uv_pipe_t.U): Unit =
        !struct.at(offsets(5)).asInstanceOf[Ptr[uv_pipe_t.U]] = value
      def next_closing: Ptr[uv_handle_t] =
        !struct.at(offsets(6)).asInstanceOf[Ptr[Ptr[uv_handle_t]]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit =
        !struct.at(offsets(6)).asInstanceOf[Ptr[Ptr[uv_handle_t]]] = value
    ...
    val offsets: Array[Int] =
      ...
      res(6) = align(
        res(5) + sizeof[uv_pipe_t.U].toInt,
        alignmentof[Ptr[uv_handle_t]].toInt
      )
      res(7) = align(
        res(6) + sizeof[Ptr[uv_handle_t]].toInt,
  ...
  opaque type uv_poll_s =
    CStruct10[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
      Byte
    ], uv__queue, uv_poll_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__io_t]

  object uv_poll_s:
    given _tag: Tag[uv_poll_s] = Tag
      .materializeCStruct10Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
        Byte
      ], uv__queue, uv_poll_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__io_t]

    // Allocates uv_poll_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_poll_s] =
      scala.scalanative.unsafe.alloc[uv_poll_s](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_poll_s)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_poll_s.U = struct._6
      def u_=(value: uv_poll_s.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
      ...
      def poll_cb_=(value: uv_poll_cb): Unit = !struct.at9 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_poll_t =
    CStruct10[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
      Byte
    ], uv__queue, uv_poll_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__io_t]

  object uv_poll_t:
    given _tag: Tag[uv_poll_t] = Tag
      .materializeCStruct10Tag[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
        Byte
      ], uv__queue, uv_poll_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__io_t]

    // Allocates uv_poll_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_poll_t] =
      scala.scalanative.unsafe.alloc[uv_poll_t](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_poll_t)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_poll_t.U = struct._6
      def u_=(value: uv_poll_t.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_prepare_s =
    CStruct10[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
      Byte
    ], uv__queue, uv_prepare_s.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]

  object uv_prepare_s:
    given _tag: Tag[uv_prepare_s] = Tag.materializeCStruct10Tag[Ptr[Byte], Ptr[
      uv_loop_t
    ], uv_handle_type, Ptr[Byte], uv__queue, uv_prepare_s.U, Ptr[
      Byte
    ], CUnsignedInt, Ptr[Byte], uv__queue]

    // Allocates uv_prepare_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_prepare_s] =
      scala.scalanative.unsafe.alloc[uv_prepare_s](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_prepare_s)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_prepare_s.U = struct._6
      def u_=(value: uv_prepare_s.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
      ...
      def prepare_cb_=(value: uv_prepare_cb): Unit = !struct.at9 =
        value.asInstanceOf[Ptr[Byte]]
      def queue: uv__queue = struct._10
      def queue_=(value: uv__queue): Unit = !struct.at10 = value
    end extension
  ...
  opaque type uv_prepare_t =
    CStruct10[Ptr[Byte], Ptr[uv_loop_t], uv_handle_type, Ptr[
      Byte
    ], uv__queue, uv_prepare_t.U, Ptr[Byte], CUnsignedInt, Ptr[Byte], uv__queue]

  object uv_prepare_t:
    given _tag: Tag[uv_prepare_t] = Tag.materializeCStruct10Tag[Ptr[Byte], Ptr[
      uv_loop_t
    ], uv_handle_type, Ptr[Byte], uv__queue, uv_prepare_t.U, Ptr[
      Byte
    ], CUnsignedInt, Ptr[Byte], uv__queue]

    // Allocates uv_prepare_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_prepare_t] =
      scala.scalanative.unsafe.alloc[uv_prepare_t](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_prepare_t)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_prepare_t.U = struct._6
      def u_=(value: uv_prepare_t.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_process_options_s = CStruct10[
    Ptr[Byte],
    CString,
    Ptr[CString],
    Ptr[CString],
    ...
    CUnsignedInt,
    CInt,
    Ptr[uv_stdio_container_t],
    uv_uid_t,
    uv_gid_t
  ]

  object uv_process_options_s:
    given _tag: Tag[uv_process_options_s] = Tag.materializeCStruct10Tag[Ptr[
      Byte
    ], CString, Ptr[CString], Ptr[CString], CString, CUnsignedInt, CInt, Ptr[
      uv_stdio_container_t
    ], uv_uid_t, uv_gid_t]

    // Allocates uv_process_options_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_process_options_s] =
      scala.scalanative.unsafe.alloc[uv_process_options_s](1)
    def apply(
        exit_cb: uv_exit_cb,
        file: CString,
        args: Ptr[CString],
        ...
        uid: uv_uid_t,
        gid: uv_gid_t
    )(using Zone): Ptr[uv_process_options_s] =
      val ____ptr = apply()
    ...
    extension (struct: uv_process_options_s)
      ...
      def exit_cb_=(value: uv_exit_cb): Unit = !struct.at1 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  end uv_process_options_s

  opaque type uv_process_options_t = CStruct10[
    Ptr[Byte],
    CString,
    Ptr[CString],
    Ptr[CString],
  ...
  object uv_process_options_t:
    given _tag: Tag[uv_process_options_t] = Tag.materializeCStruct10Tag[Ptr[
      Byte
    ], CString, Ptr[CString], Ptr[CString], CString, CUnsignedInt, CInt, Ptr[
      uv_stdio_container_t
    ], uv_uid_t, uv_gid_t]
    ...
    def apply()(using Zone): Ptr[uv_process_options_t] =
      scala.scalanative.unsafe.alloc[uv_process_options_t](1)
    def apply(
        exit_cb: uv_exit_cb,
        file: CString,
        args: Ptr[CString],
        ...
        uid: uv_uid_t,
        gid: uv_gid_t
    )(using Zone): Ptr[uv_process_options_t] =
      val ____ptr = apply()
      (!____ptr).exit_cb = exit_cb
      (!____ptr).file = file
      (!____ptr).args = args
  ...
  end uv_process_options_t

  opaque type uv_process_s = CStruct12[
    Ptr[Byte],
    Ptr[uv_loop_t],
    uv_handle_type,
    Ptr[Byte],
  ...
  object uv_process_s:
    given _tag: Tag[uv_process_s] = Tag.materializeCStruct12Tag[Ptr[Byte], Ptr[
      uv_loop_t
    ], uv_handle_type, Ptr[Byte], uv__queue, uv_process_s.U, Ptr[
      Byte
    ], CUnsignedInt, Ptr[Byte], CInt, uv__queue, CInt]

    // Allocates uv_process_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_process_s] =
      scala.scalanative.unsafe.alloc[uv_process_s](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_process_s)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_process_s.U = struct._6
      def u_=(value: uv_process_s.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
      ...
      def exit_cb_=(value: uv_exit_cb): Unit = !struct.at9 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_process_t = CStruct12[
    Ptr[Byte],
    Ptr[uv_loop_t],
    uv_handle_type,
    Ptr[Byte],
  ...
  object uv_process_t:
    given _tag: Tag[uv_process_t] = Tag.materializeCStruct12Tag[Ptr[Byte], Ptr[
      uv_loop_t
    ], uv_handle_type, Ptr[Byte], uv__queue, uv_process_t.U, Ptr[
      Byte
    ], CUnsignedInt, Ptr[Byte], CInt, uv__queue, CInt]

    // Allocates uv_process_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_process_t] =
      scala.scalanative.unsafe.alloc[uv_process_t](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_process_t)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_process_t.U = struct._6
      def u_=(value: uv_process_t.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_random_s =
    CStruct9[Ptr[Byte], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[
      uv_loop_t
    ], CInt, Ptr[Byte], size_t, Ptr[Byte], uv__work]

  object uv_random_s:
    given _tag: Tag[uv_random_s] = Tag.materializeCStruct9Tag[Ptr[
      Byte
    ], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[uv_loop_t], CInt, Ptr[
      Byte
    ], size_t, Ptr[Byte], uv__work]

    // Allocates uv_random_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_random_s] =
      scala.scalanative.unsafe.alloc[uv_random_s](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6],
    ...
    extension (struct: uv_random_s)
      ...
      def cb_=(value: uv_random_cb): Unit = !struct.at8 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_random_t =
    CStruct9[Ptr[Byte], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[
      uv_loop_t
    ], CInt, Ptr[Byte], size_t, Ptr[Byte], uv__work]

  object uv_random_t:
    given _tag: Tag[uv_random_t] = Tag.materializeCStruct9Tag[Ptr[
      Byte
    ], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[uv_loop_t], CInt, Ptr[
      Byte
    ], size_t, Ptr[Byte], uv__work]
    ...
    def apply()(using Zone): Ptr[uv_random_t] =
      scala.scalanative.unsafe.alloc[uv_random_t](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6],
  ...
  opaque type uv_req_s =
    CStruct3[Ptr[Byte], uv_req_type, CArray[Ptr[Byte], Nat._6]]

  object uv_req_s:
    given _tag: Tag[uv_req_s] = Tag
      .materializeCStruct3Tag[Ptr[Byte], uv_req_type, CArray[Ptr[Byte], Nat._6]]

    // Allocates uv_req_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_req_s] =
      scala.scalanative.unsafe.alloc[uv_req_s](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6]
    )(using Zone): Ptr[uv_req_s] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).`type` = `type`
      (!____ptr).reserved = reserved
  ...
  opaque type uv_req_t =
    CStruct3[Ptr[Byte], uv_req_type, CArray[Ptr[Byte], Nat._6]]

  object uv_req_t:
    given _tag: Tag[uv_req_t] = Tag
      .materializeCStruct3Tag[Ptr[Byte], uv_req_type, CArray[Ptr[Byte], Nat._6]]

    // Allocates uv_req_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_req_t] =
      scala.scalanative.unsafe.alloc[uv_req_t](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6]
    )(using Zone): Ptr[uv_req_t] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).`type` = `type`
      (!____ptr).reserved = reserved
  ...
  opaque type uv_rusage_t = CStruct16[
    uv_timeval_t,
    uv_timeval_t,
    uint64_t,
    uint64_t,
  ...
  object uv_rusage_t:
    given _tag: Tag[uv_rusage_t] = Tag.materializeCStruct16Tag[
      uv_timeval_t,
      uv_timeval_t,
      uint64_t,
      uint64_t,
    ...
    def apply()(using Zone): Ptr[uv_rusage_t] =
      scala.scalanative.unsafe.alloc[uv_rusage_t](1)
    def apply(
  ...
  opaque type uv_shutdown_s =
    CStruct5[Ptr[Byte], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[Byte], Ptr[
      Byte
    ]]

  object uv_shutdown_s:
    given _tag: Tag[uv_shutdown_s] = Tag.materializeCStruct5Tag[Ptr[
      Byte
    ], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[Byte], Ptr[Byte]]

    // Allocates uv_shutdown_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_shutdown_s] =
      scala.scalanative.unsafe.alloc[uv_shutdown_s](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6],
    ...
    extension (struct: uv_shutdown_s)
      ...
      def handle_=(value: Ptr[uv_stream_t]): Unit = !struct.at4 =
        value.asInstanceOf[Ptr[Byte]]
      def cb: uv_shutdown_cb = struct._5.asInstanceOf[uv_shutdown_cb]
      def cb_=(value: uv_shutdown_cb): Unit = !struct.at5 =
        value.asInstanceOf[Ptr[Byte]]
    end extension
  end uv_shutdown_s

  opaque type uv_shutdown_t =
    CStruct5[Ptr[Byte], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[Byte], Ptr[
      Byte
    ]]

  object uv_shutdown_t:
    given _tag: Tag[uv_shutdown_t] = Tag.materializeCStruct5Tag[Ptr[
      Byte
    ], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[Byte], Ptr[Byte]]

    // Allocates uv_shutdown_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_shutdown_t] =
      scala.scalanative.unsafe.alloc[uv_shutdown_t](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6],
  ...
  opaque type uv_signal_s = CStruct13[
    Ptr[Byte],
    Ptr[uv_loop_t],
    uv_handle_type,
    Ptr[Byte],
  ...
  object uv_signal_s:
    given _tag: Tag[uv_signal_s] = Tag.materializeCStruct13Tag[
      Ptr[Byte],
      Ptr[uv_loop_t],
      uv_handle_type,
      Ptr[Byte],
    ...
    def apply()(using Zone): Ptr[uv_signal_s] =
      scala.scalanative.unsafe.alloc[uv_signal_s](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
        ...
        signum: CInt,
        tree_entry: uv_signal_s.Tree_entry,
        caught_signals: CUnsignedInt,
        dispatched_signals: CUnsignedInt
    ...
    extension (struct: uv_signal_s)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_signal_s.U = struct._6
      def u_=(value: uv_signal_s.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
      ...
      def signal_cb_=(value: uv_signal_cb): Unit = !struct.at9 =
        value.asInstanceOf[Ptr[Byte]]
      def signum: CInt = struct._10
      def signum_=(value: CInt): Unit = !struct.at10 = value
      def tree_entry: uv_signal_s.Tree_entry = struct._11
      def tree_entry_=(value: uv_signal_s.Tree_entry): Unit = !struct.at11 =
        value
    ...
    opaque type Tree_entry = CStruct4[Ptr[Byte], Ptr[Byte], Ptr[Byte], CInt]

    object Tree_entry:
      given _tag: Tag[Tree_entry] =
        Tag.materializeCStruct4Tag[Ptr[Byte], Ptr[Byte], Ptr[Byte], CInt]

      // Allocates Tree_entry on the heap – fields are not initalised or zeroed out
      def apply()(using Zone): Ptr[Tree_entry] =
        scala.scalanative.unsafe.alloc[Tree_entry](1)
      def apply(
          rbe_left: Ptr[uv_signal_s],
          rbe_right: Ptr[uv_signal_s],
          rbe_parent: Ptr[uv_signal_s],
          rbe_color: CInt
      )(using Zone): Ptr[Tree_entry] =
        val ____ptr = apply()
      ...
      extension (struct: Tree_entry)
        def rbe_left: Ptr[uv_signal_s] =
          struct._1.asInstanceOf[Ptr[uv_signal_s]]
        def rbe_left_=(value: Ptr[uv_signal_s]): Unit = !struct.at1 =
          value.asInstanceOf[Ptr[Byte]]
        def rbe_right: Ptr[uv_signal_s] =
          struct._2.asInstanceOf[Ptr[uv_signal_s]]
        def rbe_right_=(value: Ptr[uv_signal_s]): Unit = !struct.at2 =
          value.asInstanceOf[Ptr[Byte]]
        def rbe_parent: Ptr[uv_signal_s] =
          struct._3.asInstanceOf[Ptr[uv_signal_s]]
        def rbe_parent_=(value: Ptr[uv_signal_s]): Unit = !struct.at3 =
          value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_signal_t = CStruct13[
    Ptr[Byte],
    Ptr[uv_loop_t],
    uv_handle_type,
    Ptr[Byte],
    ...
    Ptr[Byte],
    CInt,
    uv_signal_t.Tree_entry,
    CUnsignedInt,
    CUnsignedInt
  ]

  object uv_signal_t:
    given _tag: Tag[uv_signal_t] = Tag.materializeCStruct13Tag[
      Ptr[Byte],
      Ptr[uv_loop_t],
      uv_handle_type,
      Ptr[Byte],
    ...
    def apply()(using Zone): Ptr[uv_signal_t] =
      scala.scalanative.unsafe.alloc[uv_signal_t](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
        ...
        signal_cb: uv_signal_cb,
        signum: CInt,
        tree_entry: uv_signal_t.Tree_entry,
        caught_signals: CUnsignedInt,
        dispatched_signals: CUnsignedInt
    ...
    extension (struct: uv_signal_t)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_signal_t.U = struct._6
      def u_=(value: uv_signal_t.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
      ...
      def signum: CInt = struct._10
      def signum_=(value: CInt): Unit = !struct.at10 = value
      def tree_entry: uv_signal_t.Tree_entry = struct._11
      def tree_entry_=(value: uv_signal_t.Tree_entry): Unit = !struct.at11 =
        value
      def caught_signals: CUnsignedInt = struct._12
      def caught_signals_=(value: CUnsignedInt): Unit = !struct.at12 = value
      def dispatched_signals: CUnsignedInt = struct._13
  ...
  opaque type uv_stat_t = CStruct16[
    uint64_t,
    uint64_t,
    uint64_t,
    uint64_t,
  ...
  object uv_stat_t:
    given _tag: Tag[uv_stat_t] = Tag.materializeCStruct16Tag[
      uint64_t,
      uint64_t,
      uint64_t,
      uint64_t,
    ...
    def apply()(using Zone): Ptr[uv_stat_t] =
      scala.scalanative.unsafe.alloc[uv_stat_t](1)
    def apply(
        st_dev: uint64_t,
        st_mode: uint64_t,
        st_nlink: uint64_t,
  ...
  opaque type uv_statfs_s = CStruct8[
    uint64_t,
    uint64_t,
    uint64_t,
    uint64_t,
  ...
  object uv_statfs_s:
    given _tag: Tag[uv_statfs_s] = Tag.materializeCStruct8Tag[
      uint64_t,
      uint64_t,
      uint64_t,
      uint64_t,
    ...
    def apply()(using Zone): Ptr[uv_statfs_s] =
      scala.scalanative.unsafe.alloc[uv_statfs_s](1)
    def apply(
        f_type: uint64_t,
        f_bsize: uint64_t,
        f_blocks: uint64_t,
        ...
        f_files: uint64_t,
        f_ffree: uint64_t,
        f_spare: CArray[uint64_t, Nat._4]
    )(using Zone): Ptr[uv_statfs_s] =
      val ____ptr = apply()
  ...
  opaque type uv_statfs_t = CStruct8[
    uint64_t,
    uint64_t,
    uint64_t,
    uint64_t,
  ...
  object uv_statfs_t:
    given _tag: Tag[uv_statfs_t] = Tag.materializeCStruct8Tag[
      uint64_t,
      uint64_t,
      uint64_t,
      uint64_t,
    ...
    def apply()(using Zone): Ptr[uv_statfs_t] =
      scala.scalanative.unsafe.alloc[uv_statfs_t](1)
    def apply(
        f_type: uint64_t,
        f_bsize: uint64_t,
        f_blocks: uint64_t,
  ...
  opaque type uv_stdio_container_s =
    CStruct2[uv_stdio_flags, uv_stdio_container_s.Data]

  object uv_stdio_container_s:
    given _tag: Tag[uv_stdio_container_s] =
      Tag.materializeCStruct2Tag[uv_stdio_flags, uv_stdio_container_s.Data]

    // Allocates uv_stdio_container_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_stdio_container_s] =
      scala.scalanative.unsafe.alloc[uv_stdio_container_s](1)
    def apply(flags: uv_stdio_flags, data: uv_stdio_container_s.Data)(using
        Zone
    ): Ptr[uv_stdio_container_s] =
      val ____ptr = apply()
      (!____ptr).flags = flags
      (!____ptr).data = data
      ____ptr
    ...
    extension (struct: uv_stdio_container_s)
      ...
      def data: uv_stdio_container_s.Data = struct._2
      def data_=(value: uv_stdio_container_s.Data): Unit = !struct.at2 = value

    opaque type Data = CArray[Byte, Nat._8]
    object Data:
      given _tag: Tag[Data] = Tag.CArray[CChar, Nat._8](Tag.Byte, Tag.Nat8)

      def apply()(using Zone): Ptr[Data] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Data](1)
        ___ptr

      @scala.annotation.targetName("apply_stream")
      def apply(stream: Ptr[uv_stream_t])(using Zone): Ptr[Data] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Data](1)
        val un = !___ptr
      ...
      @scala.annotation.targetName("apply_fd")
      def apply(fd: CInt)(using Zone): Ptr[Data] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Data](1)
        val un = !___ptr
        un.at(0).asInstanceOf[Ptr[CInt]].update(0, fd)
        ___ptr
      ...
      extension (struct: Data)
        def stream: Ptr[uv_stream_t] =
          !struct.at(0).asInstanceOf[Ptr[Ptr[uv_stream_t]]]
        def stream_=(value: Ptr[uv_stream_t]): Unit =
          !struct.at(0).asInstanceOf[Ptr[Ptr[uv_stream_t]]] = value
        def fd: CInt = !struct.at(0).asInstanceOf[Ptr[CInt]]
        def fd_=(value: CInt): Unit = !struct.at(0).asInstanceOf[Ptr[CInt]] =
          value
    end Data
  end uv_stdio_container_s

  opaque type uv_stdio_container_t =
    CStruct2[uv_stdio_flags, uv_stdio_container_t.Data]

  object uv_stdio_container_t:
    given _tag: Tag[uv_stdio_container_t] =
      Tag.materializeCStruct2Tag[uv_stdio_flags, uv_stdio_container_t.Data]

    // Allocates uv_stdio_container_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_stdio_container_t] =
      scala.scalanative.unsafe.alloc[uv_stdio_container_t](1)
    def apply(flags: uv_stdio_flags, data: uv_stdio_container_t.Data)(using
        Zone
    ): Ptr[uv_stdio_container_t] =
      val ____ptr = apply()
      (!____ptr).flags = flags
    ...
    extension (struct: uv_stdio_container_t)
      def flags: uv_stdio_flags = struct._1
      def flags_=(value: uv_stdio_flags): Unit = !struct.at1 = value
      def data: uv_stdio_container_t.Data = struct._2
      def data_=(value: uv_stdio_container_t.Data): Unit = !struct.at2 = value
  ...
  end uv_stdio_container_t

  opaque type uv_stream_s = CStruct21[
    Ptr[Byte],
    Ptr[uv_loop_t],
    uv_handle_type,
    Ptr[Byte],
  ...
  object uv_stream_s:
    given _tag: Tag[uv_stream_s] = Tag.materializeCStruct21Tag[
      Ptr[Byte],
      Ptr[uv_loop_t],
      uv_handle_type,
      Ptr[Byte],
    ...
    def apply()(using Zone): Ptr[uv_stream_s] =
      scala.scalanative.unsafe.alloc[uv_stream_s](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_stream_s)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_stream_s.U = struct._6
      def u_=(value: uv_stream_s.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
      ...
      def alloc_cb_=(value: uv_alloc_cb): Unit = !struct.at10 =
        value.asInstanceOf[Ptr[Byte]]
      def read_cb: uv_read_cb = struct._11.asInstanceOf[uv_read_cb]
      def read_cb_=(value: uv_read_cb): Unit = !struct.at11 =
        value.asInstanceOf[Ptr[Byte]]
      def connect_req: Ptr[uv_connect_t] =
        struct._12.asInstanceOf[Ptr[uv_connect_t]]
      def connect_req_=(value: Ptr[uv_connect_t]): Unit = !struct.at12 =
        value.asInstanceOf[Ptr[Byte]]
      def shutdown_req: Ptr[uv_shutdown_t] =
        struct._13.asInstanceOf[Ptr[uv_shutdown_t]]
      def shutdown_req_=(value: Ptr[uv_shutdown_t]): Unit = !struct.at13 =
        value.asInstanceOf[Ptr[Byte]]
      ...
      def connection_cb: uv_connection_cb =
        struct._17.asInstanceOf[uv_connection_cb]
      def connection_cb_=(value: uv_connection_cb): Unit = !struct.at17 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_stream_t = CStruct21[
    Ptr[Byte],
    Ptr[uv_loop_t],
    uv_handle_type,
    Ptr[Byte],
  ...
  object uv_stream_t:
    given _tag: Tag[uv_stream_t] = Tag.materializeCStruct21Tag[
      Ptr[Byte],
      Ptr[uv_loop_t],
      uv_handle_type,
      Ptr[Byte],
    ...
    def apply()(using Zone): Ptr[uv_stream_t] =
      scala.scalanative.unsafe.alloc[uv_stream_t](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_stream_t)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_stream_t.U = struct._6
      def u_=(value: uv_stream_t.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_tcp_s = CStruct21[
    Ptr[Byte],
    Ptr[uv_loop_t],
    uv_handle_type,
    Ptr[Byte],
  ...
  object uv_tcp_s:
    given _tag: Tag[uv_tcp_s] = Tag.materializeCStruct21Tag[
      Ptr[Byte],
      Ptr[uv_loop_t],
      uv_handle_type,
      Ptr[Byte],
    ...
    def apply()(using Zone): Ptr[uv_tcp_s] =
      scala.scalanative.unsafe.alloc[uv_tcp_s](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_tcp_s)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_tcp_s.U = struct._6
      def u_=(value: uv_tcp_s.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_tcp_t = CStruct21[
    Ptr[Byte],
    Ptr[uv_loop_t],
    uv_handle_type,
    Ptr[Byte],
  ...
  object uv_tcp_t:
    given _tag: Tag[uv_tcp_t] = Tag.materializeCStruct21Tag[
      Ptr[Byte],
      Ptr[uv_loop_t],
      uv_handle_type,
      Ptr[Byte],
    ...
    def apply()(using Zone): Ptr[uv_tcp_t] =
      scala.scalanative.unsafe.alloc[uv_tcp_t](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_tcp_t)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_tcp_t.U = struct._6
      def u_=(value: uv_tcp_t.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  object uv_thread_options_s:
    given _tag: Tag[uv_thread_options_s] =
      Tag.materializeCStruct2Tag[CUnsignedInt, size_t]

    // Allocates uv_thread_options_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_thread_options_s] =
      scala.scalanative.unsafe.alloc[uv_thread_options_s](1)
    def apply(flags: CUnsignedInt, stack_size: size_t)(using
        Zone
    ): Ptr[uv_thread_options_s] =
      val ____ptr = apply()
      (!____ptr).flags = flags
  ...
  end uv_thread_options_s

  opaque type uv_thread_options_t = CStruct2[CUnsignedInt, size_t]

  object uv_thread_options_t:
    given _tag: Tag[uv_thread_options_t] =
      Tag.materializeCStruct2Tag[CUnsignedInt, size_t]

    // Allocates uv_thread_options_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_thread_options_t] =
      scala.scalanative.unsafe.alloc[uv_thread_options_t](1)
    def apply(flags: CUnsignedInt, stack_size: size_t)(using
        Zone
    ): Ptr[uv_thread_options_t] =
      val ____ptr = apply()
      (!____ptr).flags = flags
      (!____ptr).stack_size = stack_size
      ____ptr
    ...
    extension (struct: uv_thread_options_t)
      ...
      def stack_size: size_t = struct._2
      def stack_size_=(value: size_t): Unit = !struct.at2 = value
  end uv_thread_options_t

  opaque type uv_timer_s = CStruct13[
    Ptr[Byte],
    Ptr[uv_loop_t],
    uv_handle_type,
    Ptr[Byte],
  ...
  object uv_timer_s:
    given _tag: Tag[uv_timer_s] = Tag.materializeCStruct13Tag[
      Ptr[Byte],
      Ptr[uv_loop_t],
      uv_handle_type,
      Ptr[Byte],
    ...
    def apply()(using Zone): Ptr[uv_timer_s] =
      scala.scalanative.unsafe.alloc[uv_timer_s](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
        ...
        node: uv_timer_s.Node,
        timeout: uint64_t,
        repeat: uint64_t,
        start_id: uint64_t
    )(using Zone): Ptr[uv_timer_s] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
    ...
    extension (struct: uv_timer_s)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_timer_s.U = struct._6
      def u_=(value: uv_timer_s.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
      ...
      def timer_cb_=(value: uv_timer_cb): Unit = !struct.at9 =
        value.asInstanceOf[Ptr[Byte]]
      def node: uv_timer_s.Node = struct._10
      def node_=(value: uv_timer_s.Node): Unit = !struct.at10 = value
    ...
    opaque type Node = CArray[Byte, Nat.Digit2[Nat._2, Nat._4]]
    object Node:
      given _tag: Tag[Node] = Tag.CArray[CChar, Nat.Digit2[Nat._2, Nat._4]](
        Tag.Byte,
        Tag.Digit2[Nat._2, Nat._4](Tag.Nat2, Tag.Nat4)
      )

      def apply()(using Zone): Ptr[Node] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Node](1)
        ___ptr

      @scala.annotation.targetName("apply_heap")
      def apply(heap: CArray[Ptr[Byte], Nat._3])(using Zone): Ptr[Node] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Node](1)
        val un = !___ptr
      ...
      def apply(queue: uv__queue)(using Zone): Ptr[Node] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Node](1)
        val un = !___ptr
      ...
      extension (struct: Node)
        def heap: CArray[Ptr[Byte], Nat._3] =
          !struct.at(0).asInstanceOf[Ptr[CArray[Ptr[Byte], Nat._3]]]
        def heap_=(value: CArray[Ptr[Byte], Nat._3]): Unit =
          !struct.at(0).asInstanceOf[Ptr[CArray[Ptr[Byte], Nat._3]]] = value
        def queue: uv__queue = !struct.at(0).asInstanceOf[Ptr[uv__queue]]
        def queue_=(value: uv__queue): Unit =
          !struct.at(0).asInstanceOf[Ptr[uv__queue]] = value
    end Node
  end uv_timer_s

  opaque type uv_timer_t = CStruct13[
    Ptr[Byte],
    Ptr[uv_loop_t],
    uv_handle_type,
    Ptr[Byte],
  ...
  object uv_timer_t:
    given _tag: Tag[uv_timer_t] = Tag.materializeCStruct13Tag[
      Ptr[Byte],
      Ptr[uv_loop_t],
      uv_handle_type,
      Ptr[Byte],
    ...
    def apply()(using Zone): Ptr[uv_timer_t] =
      scala.scalanative.unsafe.alloc[uv_timer_t](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
        ...
        flags: CUnsignedInt,
        timer_cb: uv_timer_cb,
        node: uv_timer_t.Node,
        timeout: uint64_t,
        repeat: uint64_t,
        start_id: uint64_t
    )(using Zone): Ptr[uv_timer_t] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).loop = loop
      (!____ptr).`type` = `type`
    ...
    extension (struct: uv_timer_t)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_timer_t.U = struct._6
      def u_=(value: uv_timer_t.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
      ...
      def timer_cb_=(value: uv_timer_cb): Unit = !struct.at9 =
        value.asInstanceOf[Ptr[Byte]]
      def node: uv_timer_t.Node = struct._10
      def node_=(value: uv_timer_t.Node): Unit = !struct.at10 = value
      def timeout: uint64_t = struct._11
      def timeout_=(value: uint64_t): Unit = !struct.at11 = value
      def repeat: uint64_t = struct._12
      def repeat_=(value: uint64_t): Unit = !struct.at12 = value
  ...
  object uv_timespec64_t:
    given _tag: Tag[uv_timespec64_t] =
      Tag.materializeCStruct2Tag[int64_t, int32_t]

    // Allocates uv_timespec64_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_timespec64_t] =
      scala.scalanative.unsafe.alloc[uv_timespec64_t](1)
    def apply(tv_sec: int64_t, tv_nsec: int32_t)(using
        Zone
    ): Ptr[uv_timespec64_t] =
      val ____ptr = apply()
  ...
  object uv_timespec_t:
    given _tag: Tag[uv_timespec_t] =
      Tag.materializeCStruct2Tag[CLongInt, CLongInt]

    // Allocates uv_timespec_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_timespec_t] =
      scala.scalanative.unsafe.alloc[uv_timespec_t](1)
    def apply(tv_sec: CLongInt, tv_nsec: CLongInt)(using
        Zone
    ): Ptr[uv_timespec_t] =
      val ____ptr = apply()
      (!____ptr).tv_sec = tv_sec
  ...
  object uv_timeval64_t:
    given _tag: Tag[uv_timeval64_t] =
      Tag.materializeCStruct2Tag[int64_t, int32_t]

    // Allocates uv_timeval64_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_timeval64_t] =
      scala.scalanative.unsafe.alloc[uv_timeval64_t](1)
    def apply(tv_sec: int64_t, tv_usec: int32_t)(using
        Zone
    ): Ptr[uv_timeval64_t] =
      val ____ptr = apply()
      (!____ptr).tv_sec = tv_sec
  ...
  object uv_timeval_t:
    given _tag: Tag[uv_timeval_t] =
      Tag.materializeCStruct2Tag[CLongInt, CLongInt]

    // Allocates uv_timeval_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_timeval_t] =
      scala.scalanative.unsafe.alloc[uv_timeval_t](1)
    def apply(tv_sec: CLongInt, tv_usec: CLongInt)(using
        Zone
    ): Ptr[uv_timeval_t] =
      val ____ptr = apply()
      (!____ptr).tv_sec = tv_sec
  ...
  object uv_tty_s:
    given _tag: Tag[uv_tty_s] =
      Tag.CArray[CChar, Nat.Digit3[Nat._3, Nat._4, Nat._4]](
        Tag.Byte,
        Tag.Digit3[Nat._3, Nat._4, Nat._4](Tag.Nat3, Tag.Nat4, Tag.Nat4)
      )

    // Allocates uv_tty_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_tty_s] =
      scala.scalanative.unsafe.alloc[uv_tty_s](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_tty_s)
      ...
      def handle_queue_=(value: uv__queue): Unit =
        !struct.at(offsets(4)).asInstanceOf[Ptr[uv__queue]] = value
      def u: uv_tty_s.U = !struct.at(offsets(5)).asInstanceOf[Ptr[uv_tty_s.U]]
      def u_=(value: uv_tty_s.U): Unit =
        !struct.at(offsets(5)).asInstanceOf[Ptr[uv_tty_s.U]] = value
      def next_closing: Ptr[uv_handle_t] =
        !struct.at(offsets(6)).asInstanceOf[Ptr[Ptr[uv_handle_t]]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit =
        !struct.at(offsets(6)).asInstanceOf[Ptr[Ptr[uv_handle_t]]] = value
      ...
      def select_=(value: Ptr[Byte]): Unit =
        !struct.at(offsets(20)).asInstanceOf[Ptr[Ptr[Byte]]] = value
      def orig_termios: termios =
        !struct.at(offsets(21)).asInstanceOf[Ptr[termios]]
      def orig_termios_=(value: termios): Unit =
        !struct.at(offsets(21)).asInstanceOf[Ptr[termios]] = value
      def mode: CInt = !struct.at(offsets(22)).asInstanceOf[Ptr[CInt]]
      def mode_=(value: CInt): Unit =
    ...
    val offsets: Array[Int] =
      ...
      res(20) =
        align(res(19) + sizeof[Ptr[Byte]].toInt, alignmentof[Ptr[Byte]].toInt)
      res(21) =
        align(res(20) + sizeof[Ptr[Byte]].toInt, alignmentof[termios].toInt)
  ...
  object uv_tty_t:
    ...
    def apply()(using Zone): Ptr[uv_tty_t] =
      scala.scalanative.unsafe.alloc[uv_tty_t](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_tty_t)
      ...
      def handle_queue_=(value: uv__queue): Unit =
        !struct.at(offsets(4)).asInstanceOf[Ptr[uv__queue]] = value
      def u: uv_tty_t.U = !struct.at(offsets(5)).asInstanceOf[Ptr[uv_tty_t.U]]
      def u_=(value: uv_tty_t.U): Unit =
        !struct.at(offsets(5)).asInstanceOf[Ptr[uv_tty_t.U]] = value
      def next_closing: Ptr[uv_handle_t] =
        !struct.at(offsets(6)).asInstanceOf[Ptr[Ptr[uv_handle_t]]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit =
        !struct.at(offsets(6)).asInstanceOf[Ptr[Ptr[uv_handle_t]]] = value
  ...
  opaque type uv_udp_s = CStruct15[
    Ptr[Byte],
    Ptr[uv_loop_t],
    uv_handle_type,
    Ptr[Byte],
  ...
  object uv_udp_s:
    given _tag: Tag[uv_udp_s] = Tag.materializeCStruct15Tag[
      Ptr[Byte],
      Ptr[uv_loop_t],
      uv_handle_type,
      Ptr[Byte],
    ...
    def apply()(using Zone): Ptr[uv_udp_s] =
      scala.scalanative.unsafe.alloc[uv_udp_s](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_udp_s)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_udp_s.U = struct._6
      def u_=(value: uv_udp_s.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
      ...
      def alloc_cb_=(value: uv_alloc_cb): Unit = !struct.at11 =
        value.asInstanceOf[Ptr[Byte]]
      def recv_cb: uv_udp_recv_cb = struct._12.asInstanceOf[uv_udp_recv_cb]
      def recv_cb_=(value: uv_udp_recv_cb): Unit = !struct.at12 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_udp_send_s = CStruct12[
    Ptr[Byte],
    uv_req_type,
    CArray[Ptr[Byte], Nat._6],
    Ptr[Byte],
    ...
    ssize_t,
    Ptr[Byte],
    CArray[uv_buf_t, Nat._4]
  ]

  object uv_udp_send_s:
    given _tag: Tag[uv_udp_send_s] = Tag.materializeCStruct12Tag[
      Ptr[Byte],
      uv_req_type,
      CArray[Ptr[Byte], Nat._6],
      Ptr[Byte],
    ...
    def apply()(using Zone): Ptr[uv_udp_send_s] =
      scala.scalanative.unsafe.alloc[uv_udp_send_s](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6],
    ...
    extension (struct: uv_udp_send_s)
      ...
      def handle_=(value: Ptr[uv_udp_t]): Unit = !struct.at4 =
        value.asInstanceOf[Ptr[Byte]]
      def cb: uv_udp_send_cb = struct._5.asInstanceOf[uv_udp_send_cb]
      def cb_=(value: uv_udp_send_cb): Unit = !struct.at5 =
        value.asInstanceOf[Ptr[Byte]]
      def queue: uv__queue = struct._6
      def queue_=(value: uv__queue): Unit = !struct.at6 = value
      def u: uv_udp_send_s.U = struct._7
      def u_=(value: uv_udp_send_s.U): Unit = !struct.at7 = value
      ...
      def send_cb_=(value: uv_udp_send_cb): Unit = !struct.at11 =
        value.asInstanceOf[Ptr[Byte]]
    ...
    object U:
      ...
      def apply(addr: sockaddr)(using Zone): Ptr[U] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[U](1)
        val un = !___ptr
      ...
      def apply(storage: sockaddr_storage)(using Zone): Ptr[U] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[U](1)
        val un = !___ptr
      ...
      extension (struct: U)
        def addr: sockaddr = !struct.at(0).asInstanceOf[Ptr[sockaddr]]
        def addr_=(value: sockaddr): Unit =
          !struct.at(0).asInstanceOf[Ptr[sockaddr]] = value
        def storage: sockaddr_storage =
          !struct.at(0).asInstanceOf[Ptr[sockaddr_storage]]
        def storage_=(value: sockaddr_storage): Unit =
          !struct.at(0).asInstanceOf[Ptr[sockaddr_storage]] = value
    end U
  end uv_udp_send_s

  opaque type uv_udp_send_t = CStruct12[
    Ptr[Byte],
    uv_req_type,
    CArray[Ptr[Byte], Nat._6],
    Ptr[Byte],
  ...
  object uv_udp_send_t:
    given _tag: Tag[uv_udp_send_t] = Tag.materializeCStruct12Tag[
      Ptr[Byte],
      uv_req_type,
      CArray[Ptr[Byte], Nat._6],
      Ptr[Byte],
    ...
    def apply()(using Zone): Ptr[uv_udp_send_t] =
      scala.scalanative.unsafe.alloc[uv_udp_send_t](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6],
    ...
    extension (struct: uv_udp_send_t)
      ...
      def queue: uv__queue = struct._6
      def queue_=(value: uv__queue): Unit = !struct.at6 = value
      def u: uv_udp_send_t.U = struct._7
      def u_=(value: uv_udp_send_t.U): Unit = !struct.at7 = value
      def nbufs: CUnsignedInt = struct._8
      def nbufs_=(value: CUnsignedInt): Unit = !struct.at8 = value
      def bufs: Ptr[uv_buf_t] = struct._9
      def bufs_=(value: Ptr[uv_buf_t]): Unit = !struct.at9 = value
  ...
  opaque type uv_udp_t = CStruct15[
    Ptr[Byte],
    Ptr[uv_loop_t],
    uv_handle_type,
    Ptr[Byte],
  ...
  object uv_udp_t:
    given _tag: Tag[uv_udp_t] = Tag.materializeCStruct15Tag[
      Ptr[Byte],
      Ptr[uv_loop_t],
      uv_handle_type,
      Ptr[Byte],
    ...
    def apply()(using Zone): Ptr[uv_udp_t] =
      scala.scalanative.unsafe.alloc[uv_udp_t](1)
    def apply(
        data: Ptr[Byte],
        loop: Ptr[uv_loop_t],
        `type`: uv_handle_type,
    ...
    extension (struct: uv_udp_t)
      ...
      def handle_queue: uv__queue = struct._5
      def handle_queue_=(value: uv__queue): Unit = !struct.at5 = value
      def u: uv_udp_t.U = struct._6
      def u_=(value: uv_udp_t.U): Unit = !struct.at6 = value
      def next_closing: Ptr[uv_handle_t] =
        struct._7.asInstanceOf[Ptr[uv_handle_t]]
      def next_closing_=(value: Ptr[uv_handle_t]): Unit = !struct.at7 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_utsname_s = CStruct4[
    CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]],
    CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]],
    CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]],
    CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]]
  ]
  ...
  object uv_utsname_s:
    given _tag: Tag[uv_utsname_s] = Tag.materializeCStruct4Tag[
      CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]],
      CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]],
      CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]],
      CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]]
    ...
    def apply()(using Zone): Ptr[uv_utsname_s] =
      scala.scalanative.unsafe.alloc[uv_utsname_s](1)
    def apply(
        sysname: CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]],
        release: CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]],
        version: CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]],
        machine: CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]]
    )(using Zone): Ptr[uv_utsname_s] =
      val ____ptr = apply()
    ...
    extension (struct: uv_utsname_s)
      ...
      def sysname_=(
          value: CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]]
  ...
  opaque type uv_utsname_t = CStruct4[
    CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]],
    CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]],
    CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]],
    CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]]
  ...
  object uv_utsname_t:
    given _tag: Tag[uv_utsname_t] = Tag.materializeCStruct4Tag[
      CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]],
      CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]],
      CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]],
      CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]]
    ...
    def apply()(using Zone): Ptr[uv_utsname_t] =
      scala.scalanative.unsafe.alloc[uv_utsname_t](1)
    def apply(
        sysname: CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]],
        release: CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]],
        version: CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]],
        machine: CArray[CChar, Nat.Digit3[Nat._2, Nat._5, Nat._6]]
    )(using Zone): Ptr[uv_utsname_t] =
      val ____ptr = apply()
      (!____ptr).sysname = sysname
      (!____ptr).release = release
      (!____ptr).version = version
  ...
  opaque type uv_work_s =
    CStruct7[Ptr[Byte], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[
      uv_loop_t
    ], Ptr[Byte], Ptr[Byte], uv__work]

  object uv_work_s:
    given _tag: Tag[uv_work_s] = Tag.materializeCStruct7Tag[Ptr[
      Byte
    ], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[uv_loop_t], Ptr[Byte], Ptr[
      Byte
    ], uv__work]

    // Allocates uv_work_s on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[uv_work_s] =
      scala.scalanative.unsafe.alloc[uv_work_s](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6],
    ...
    extension (struct: uv_work_s)
      ...
      def work_cb_=(value: uv_work_cb): Unit = !struct.at5 =
        value.asInstanceOf[Ptr[Byte]]
      def after_work_cb: uv_after_work_cb =
        struct._6.asInstanceOf[uv_after_work_cb]
      def after_work_cb_=(value: uv_after_work_cb): Unit = !struct.at6 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_work_t =
    CStruct7[Ptr[Byte], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[
      uv_loop_t
    ], Ptr[Byte], Ptr[Byte], uv__work]

  object uv_work_t:
    given _tag: Tag[uv_work_t] = Tag.materializeCStruct7Tag[Ptr[
      Byte
    ], uv_req_type, CArray[Ptr[Byte], Nat._6], Ptr[uv_loop_t], Ptr[Byte], Ptr[
      Byte
    ], uv__work]
    ...
    def apply()(using Zone): Ptr[uv_work_t] =
      scala.scalanative.unsafe.alloc[uv_work_t](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6],
  ...
  opaque type uv_write_s = CStruct12[
    Ptr[Byte],
    uv_req_type,
    CArray[Ptr[Byte], Nat._6],
    Ptr[Byte],
  ...
  object uv_write_s:
    given _tag: Tag[uv_write_s] = Tag.materializeCStruct12Tag[
      Ptr[Byte],
      uv_req_type,
      CArray[Ptr[Byte], Nat._6],
      Ptr[Byte],
    ...
    def apply()(using Zone): Ptr[uv_write_s] =
      scala.scalanative.unsafe.alloc[uv_write_s](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6],
        ...
        handle: Ptr[uv_stream_t],
        queue: uv__queue,
        write_index: CUnsignedInt,
        bufs: Ptr[uv_buf_t],
        nbufs: CUnsignedInt,
        error: CInt,
        bufsml: CArray[uv_buf_t, Nat._4]
    )(using Zone): Ptr[uv_write_s] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).`type` = `type`
      (!____ptr).reserved = reserved
    ...
    extension (struct: uv_write_s)
      ...
      def cb_=(value: uv_write_cb): Unit = !struct.at4 =
        value.asInstanceOf[Ptr[Byte]]
      def send_handle: Ptr[uv_stream_t] =
        struct._5.asInstanceOf[Ptr[uv_stream_t]]
      def send_handle_=(value: Ptr[uv_stream_t]): Unit = !struct.at5 =
        value.asInstanceOf[Ptr[Byte]]
      def handle: Ptr[uv_stream_t] = struct._6.asInstanceOf[Ptr[uv_stream_t]]
      def handle_=(value: Ptr[uv_stream_t]): Unit = !struct.at6 =
        value.asInstanceOf[Ptr[Byte]]
  ...
  opaque type uv_write_t = CStruct12[
    Ptr[Byte],
    uv_req_type,
    CArray[Ptr[Byte], Nat._6],
    Ptr[Byte],
  ...
  object uv_write_t:
    given _tag: Tag[uv_write_t] = Tag.materializeCStruct12Tag[
      Ptr[Byte],
      uv_req_type,
      CArray[Ptr[Byte], Nat._6],
      Ptr[Byte],
    ...
    def apply()(using Zone): Ptr[uv_write_t] =
      scala.scalanative.unsafe.alloc[uv_write_t](1)
    def apply(
        data: Ptr[Byte],
        `type`: uv_req_type,
        reserved: CArray[Ptr[Byte], Nat._6],
...
object unions:
  ...
  object uv_any_handle:
    ...
    extension (struct: uv_any_handle)
      ...
      def async_=(value: uv_async_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_async_t]] = value
      def check: uv_check_t = !struct.at(0).asInstanceOf[Ptr[uv_check_t]]
      def check_=(value: uv_check_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_check_t]] = value
      def fs_event: uv_fs_event_t =
        !struct.at(0).asInstanceOf[Ptr[uv_fs_event_t]]
      def fs_event_=(value: uv_fs_event_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_fs_event_t]] = value
      def fs_poll: uv_fs_poll_t = !struct.at(0).asInstanceOf[Ptr[uv_fs_poll_t]]
      def fs_poll_=(value: uv_fs_poll_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_fs_poll_t]] = value
      def handle: uv_handle_t = !struct.at(0).asInstanceOf[Ptr[uv_handle_t]]
      def handle_=(value: uv_handle_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_handle_t]] = value
      def idle: uv_idle_t = !struct.at(0).asInstanceOf[Ptr[uv_idle_t]]
      def idle_=(value: uv_idle_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_idle_t]] = value
      def pipe: uv_pipe_t = !struct.at(0).asInstanceOf[Ptr[uv_pipe_t]]
      def pipe_=(value: uv_pipe_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_pipe_t]] = value
      def poll: uv_poll_t = !struct.at(0).asInstanceOf[Ptr[uv_poll_t]]
      def poll_=(value: uv_poll_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_poll_t]] = value
      def prepare: uv_prepare_t = !struct.at(0).asInstanceOf[Ptr[uv_prepare_t]]
      def prepare_=(value: uv_prepare_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_prepare_t]] = value
      def process: uv_process_t = !struct.at(0).asInstanceOf[Ptr[uv_process_t]]
      def process_=(value: uv_process_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_process_t]] = value
      def stream: uv_stream_t = !struct.at(0).asInstanceOf[Ptr[uv_stream_t]]
      def stream_=(value: uv_stream_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_stream_t]] = value
      def tcp: uv_tcp_t = !struct.at(0).asInstanceOf[Ptr[uv_tcp_t]]
      def tcp_=(value: uv_tcp_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_tcp_t]] = value
      def timer: uv_timer_t = !struct.at(0).asInstanceOf[Ptr[uv_timer_t]]
      def timer_=(value: uv_timer_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_timer_t]] = value
      def tty: uv_tty_t = !struct.at(0).asInstanceOf[Ptr[uv_tty_t]]
      def tty_=(value: uv_tty_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_tty_t]] = value
      def udp: uv_udp_t = !struct.at(0).asInstanceOf[Ptr[uv_udp_t]]
      def udp_=(value: uv_udp_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_udp_t]] = value
      def signal: uv_signal_t = !struct.at(0).asInstanceOf[Ptr[uv_signal_t]]
      def signal_=(value: uv_signal_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_signal_t]] = value
    end extension
  end uv_any_handle

  opaque type uv_any_req =
    CArray[Byte, Nat.Digit4[Nat._1, Nat._3, Nat._2, Nat._0]]
  object uv_any_req:
    given _tag: Tag[uv_any_req] =
      Tag.CArray[CChar, Nat.Digit4[Nat._1, Nat._3, Nat._2, Nat._0]](
        Tag.Byte,
        Tag.Digit4[Nat._1, Nat._3, Nat._2, Nat._0](
          Tag.Nat1,
          Tag.Nat3,
          Tag.Nat2,
          Tag.Nat0
    ...
    extension (struct: uv_any_req)
      ...
      def req_=(value: uv_req_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_req_t]] = value
      def connect: uv_connect_t = !struct.at(0).asInstanceOf[Ptr[uv_connect_t]]
      def connect_=(value: uv_connect_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_connect_t]] = value
      def write: uv_write_t = !struct.at(0).asInstanceOf[Ptr[uv_write_t]]
      def write_=(value: uv_write_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_write_t]] = value
      def shutdown: uv_shutdown_t =
        !struct.at(0).asInstanceOf[Ptr[uv_shutdown_t]]
      def shutdown_=(value: uv_shutdown_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_shutdown_t]] = value
      def udp_send: uv_udp_send_t =
        !struct.at(0).asInstanceOf[Ptr[uv_udp_send_t]]
      def udp_send_=(value: uv_udp_send_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_udp_send_t]] = value
      def fs: uv_fs_t = !struct.at(0).asInstanceOf[Ptr[uv_fs_t]]
      def fs_=(value: uv_fs_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_fs_t]] = value
      def work: uv_work_t = !struct.at(0).asInstanceOf[Ptr[uv_work_t]]
      def work_=(value: uv_work_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_work_t]] = value
      def getaddrinfo: uv_getaddrinfo_t =
        !struct.at(0).asInstanceOf[Ptr[uv_getaddrinfo_t]]
      def getaddrinfo_=(value: uv_getaddrinfo_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_getaddrinfo_t]] = value
      def getnameinfo: uv_getnameinfo_t =
        !struct.at(0).asInstanceOf[Ptr[uv_getnameinfo_t]]
      def getnameinfo_=(value: uv_getnameinfo_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_getnameinfo_t]] = value
      def random: uv_random_t = !struct.at(0).asInstanceOf[Ptr[uv_random_t]]
      def random_=(value: uv_random_t): Unit =
        !struct.at(0).asInstanceOf[Ptr[uv_random_t]] = value
    end extension
  end uv_any_req
end unions
...
private[libuv] object extern_functions:
  ...
  import _root_.libuv.structs.*
  import _root_.libuv.unions.*
  private[libuv] def __sn_wrap_libuv_uv_buf_init(
      base: CString,
      len: CUnsignedInt,
      __return: Ptr[uv_buf_t]
  ): Unit = extern

  def uv_accept(server: Ptr[uv_stream_t], client: Ptr[uv_stream_t]): CInt =
    extern

  def uv_async_init(
      _0: Ptr[uv_loop_t],
      async: Ptr[uv_async_t],
      async_cb: uv_async_cb
  ): CInt = extern
  ...
  def uv_barrier_init(barrier: Ptr[uv_barrier_t], count: CUnsignedInt): CInt =
    extern
  ...
  def uv_clock_gettime(clock_id: uv_clock_id, ts: Ptr[uv_timespec64_t]): CInt =
    extern
  ...
  def uv_cond_timedwait(
      cond: Ptr[uv_cond_t],
      mutex: Ptr[uv_mutex_t],
      timeout: uint64_t
  ): CInt = extern

  def uv_cond_wait(cond: Ptr[uv_cond_t], mutex: Ptr[uv_mutex_t]): Unit = extern

  def uv_cpu_info(cpu_infos: Ptr[Ptr[uv_cpu_info_t]], count: Ptr[CInt]): CInt =
    extern
  ...
  def uv_dlsym(lib: Ptr[uv_lib_t], name: CString, ptr: Ptr[Ptr[Byte]]): CInt =
    extern
  ...
  def uv_free_cpu_info(cpu_infos: Ptr[uv_cpu_info_t], count: CInt): Unit =
    extern

  def uv_free_interface_addresses(
      addresses: Ptr[uv_interface_address_t],
      count: CInt
  ): Unit = extern
  ...
  def uv_fs_event_getpath(
      handle: Ptr[uv_fs_event_t],
      buffer: CString,
      size: Ptr[size_t]
  ): CInt = extern

  def uv_fs_event_init(loop: Ptr[uv_loop_t], handle: Ptr[uv_fs_event_t]): CInt =
    extern
  ...
  def uv_fs_poll_getpath(
      handle: Ptr[uv_fs_poll_t],
      buffer: CString,
      size: Ptr[size_t]
  ): CInt = extern

  def uv_fs_poll_init(loop: Ptr[uv_loop_t], handle: Ptr[uv_fs_poll_t]): CInt =
    extern
  ...
  def uv_fs_scandir_next(req: Ptr[uv_fs_t], ent: Ptr[uv_dirent_t]): CInt =
    extern
  ...
  def uv_handle_set_data(handle: Ptr[uv_handle_t], data: Ptr[Byte]): Unit =
    extern
  ...
  def uv_if_indextoiid(
      ifindex: CUnsignedInt,
      buffer: CString,
      size: Ptr[size_t]
  ): CInt = extern

  def uv_if_indextoname(
      ifindex: CUnsignedInt,
      buffer: CString,
      size: Ptr[size_t]
  ): CInt = extern

  def uv_inet_ntop(af: CInt, src: Ptr[Byte], dst: CString, size: size_t): CInt =
    extern

  def uv_inet_pton(af: CInt, src: CString, dst: Ptr[Byte]): CInt = extern

  def uv_interface_addresses(
      addresses: Ptr[Ptr[uv_interface_address_t]],
      count: Ptr[CInt]
  ): CInt = extern
  ...
  def uv_ip4_name(src: Ptr[sockaddr_in], dst: CString, size: size_t): CInt =
    extern

  def uv_ip6_addr(ip: CString, port: CInt, addr: Ptr[sockaddr_in6]): CInt =
    extern

  def uv_ip6_name(src: Ptr[sockaddr_in6], dst: CString, size: size_t): CInt =
    extern
  ...
  def uv_metrics_info(loop: Ptr[uv_loop_t], metrics: Ptr[uv_metrics_t]): CInt =
    extern
  ...
  def uv_os_environ(envitems: Ptr[Ptr[uv_env_item_t]], count: Ptr[CInt]): CInt =
    extern

  def uv_os_free_environ(envitems: Ptr[uv_env_item_t], count: CInt): Unit =
    extern
  ...
  def uv_os_getenv(name: CString, buffer: CString, size: Ptr[size_t]): CInt =
    extern
  ...
  def uv_pipe_pending_instances(handle: Ptr[uv_pipe_t], count: CInt): Unit =
    extern
  ...
  def uv_prepare_init(_0: Ptr[uv_loop_t], prepare: Ptr[uv_prepare_t]): CInt =
    extern

  def uv_prepare_start(prepare: Ptr[uv_prepare_t], cb: uv_prepare_cb): CInt =
    extern

  def uv_prepare_stop(prepare: Ptr[uv_prepare_t]): CInt = extern

  def uv_print_active_handles(loop: Ptr[uv_loop_t], stream: Ptr[FILE]): Unit =
    extern

  def uv_print_all_handles(loop: Ptr[uv_loop_t], stream: Ptr[FILE]): Unit =
    extern
  ...
  def uv_recv_buffer_size(handle: Ptr[uv_handle_t], value: Ptr[CInt]): CInt =
    extern

  def uv_ref(_0: Ptr[uv_handle_t]): Unit = extern

  def uv_replace_allocator(
  ...
  def uv_send_buffer_size(handle: Ptr[uv_handle_t], value: Ptr[CInt]): CInt =
    extern
  ...
  def uv_shutdown(
      req: Ptr[uv_shutdown_t],
      handle: Ptr[uv_stream_t],
      cb: uv_shutdown_cb
  ): CInt = extern

  def uv_signal_init(loop: Ptr[uv_loop_t], handle: Ptr[uv_signal_t]): CInt =
    extern

  def uv_signal_start(
      handle: Ptr[uv_signal_t],
      signal_cb: uv_signal_cb,
      signum: CInt
  ): CInt = extern

  def uv_signal_start_oneshot(
      handle: Ptr[uv_signal_t],
      signal_cb: uv_signal_cb,
      signum: CInt
  ): CInt = extern
  ...
  def uv_socketpair(
      `type`: CInt,
      protocol: CInt,
      socket_vector: CArray[uv_os_sock_t, Nat._2],
      flags0: CInt,
      flags1: CInt
  ): CInt = extern
  ...
  def uv_spawn(
      loop: Ptr[uv_loop_t],
      handle: Ptr[uv_process_t],
      options: Ptr[uv_process_options_t]
  ): CInt = extern
  ...
  def uv_stream_set_blocking(handle: Ptr[uv_stream_t], blocking: CInt): CInt =
    extern
  ...
  def uv_tcp_close_reset(handle: Ptr[uv_tcp_t], close_cb: uv_close_cb): CInt =
    extern
  ...
  def uv_tcp_simultaneous_accepts(handle: Ptr[uv_tcp_t], enable: CInt): CInt =
    extern

  def uv_thread_create(
      tid: Ptr[uv_thread_t],
      entry: uv_thread_cb,
      arg: Ptr[Byte]
  ): CInt = extern

  def uv_thread_create_ex(
      tid: Ptr[uv_thread_t],
      params: Ptr[uv_thread_options_t],
      entry: uv_thread_cb,
      arg: Ptr[Byte]
  ): CInt = extern
  ...
  def uv_thread_getname(
      tid: Ptr[uv_thread_t],
      name: CString,
      size: size_t
  ): CInt = extern

  def uv_thread_getpriority(tid: uv_thread_t, priority: Ptr[CInt]): CInt =
    extern
  ...
  def uv_timer_set_repeat(handle: Ptr[uv_timer_t], repeat: uint64_t): Unit =
    extern

  def uv_timer_start(
      handle: Ptr[uv_timer_t],
      cb: uv_timer_cb,
      timeout: uint64_t,
      repeat: uint64_t
  ): CInt = extern
  ...
  def uv_udp_try_send2(
      handle: Ptr[uv_udp_t],
      count: CUnsignedInt,
      bufs: Ptr[Ptr[uv_buf_t]],
      nbufs: Ptr[CUnsignedInt],
      addrs: Ptr[Ptr[sockaddr]],
      flags: CUnsignedInt
  ): CInt = extern
  ...
  def uv_utf16_length_as_wtf8(
      utf16: Ptr[uint16_t],
      utf16_len: ssize_t
  ): size_t = extern

  def uv_utf16_to_wtf8(
      utf16: Ptr[uint16_t],
      utf16_len: ssize_t,
      wtf8_ptr: Ptr[CString],
      wtf8_len_ptr: Ptr[size_t]
  ): CInt = extern
  ...
  def uv_walk(loop: Ptr[uv_loop_t], walk_cb: uv_walk_cb, arg: Ptr[Byte]): Unit =
    extern
...
object functions:
  ...
  def uv_buf_init(base: CString, len: CUnsignedInt)(
      __return: Ptr[uv_buf_t]
  ): Unit =
    __sn_wrap_libuv_uv_buf_init(base, len, __return)

  def uv_buf_init(base: CString, len: CUnsignedInt)(using Zone): uv_buf_t =
    val __ptr_0: Ptr[uv_buf_t] =
      _root_.scala.scalanative.unsafe.alloc[uv_buf_t](1)
