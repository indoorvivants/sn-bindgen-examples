...
object structs:
  ...
  object cJSON:
    ...
    export fields.*
    private[cjson] object fields:
      extension (struct: cJSON)
        inline def next : Ptr[cJSON] = struct._1.asInstanceOf[Ptr[cJSON]]
        inline def next_=(value: Ptr[cJSON]): Unit = (!struct.at1 = value.asInstanceOf[Ptr[Byte]])
        inline def prev : Ptr[cJSON] = struct._2.asInstanceOf[Ptr[cJSON]]
        inline def prev_=(value: Ptr[cJSON]): Unit = (!struct.at2 = value.asInstanceOf[Ptr[Byte]])
        inline def child : Ptr[cJSON] = struct._3.asInstanceOf[Ptr[cJSON]]
        inline def child_=(value: Ptr[cJSON]): Unit = (!struct.at3 = value.asInstanceOf[Ptr[Byte]])
        inline def `type` : CInt = struct._4
        inline def type_=(value: CInt): Unit = (!struct.at4 = value)
        inline def valuestring : CString = struct._5
        inline def valuestring_=(value: CString): Unit = (!struct.at5 = value)
        inline def valueint : CInt = struct._6
        inline def valueint_=(value: CInt): Unit = (!struct.at6 = value)
        inline def valuedouble : Double = struct._7
        inline def valuedouble_=(value: Double): Unit = (!struct.at7 = value)
        inline def string : CString = struct._8
        inline def string_=(value: CString): Unit = (!struct.at8 = value)
      end extension
  ...
  object cJSON_Hooks:
    ...
    private[cjson] object fields:
      extension (struct: cJSON_Hooks)
        inline def malloc_fn : CFuncPtr1[size_t, Ptr[Byte]] = struct._1
        inline def malloc_fn_=(value: CFuncPtr1[size_t, Ptr[Byte]]): Unit = (!struct.at1 = value)
        inline def free_fn : CFuncPtr1[Ptr[Byte], Unit] = struct._2
        inline def free_fn_=(value: CFuncPtr1[Ptr[Byte], Unit]): Unit = (!struct.at2 = value)
      end extension
