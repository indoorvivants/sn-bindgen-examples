...
object aliases:
  ...
  object cJSON_bool:
    ...
    extension (v: cJSON_bool) inline def value: CInt = v
...
object structs:
  import _root_.cjson.aliases.*
  import _root_.cjson.structs.*
  opaque type cJSON = CStruct8[Ptr[Byte], Ptr[Byte], Ptr[
    Byte
  ], CInt, CString, CInt, Double, CString]
  object cJSON:
    given _tag: Tag[cJSON] = Tag.materializeCStruct8Tag[Ptr[Byte], Ptr[
      Byte
    ], Ptr[Byte], CInt, CString, CInt, Double, CString]
    def apply()(using Zone): Ptr[cJSON] =
      scala.scalanative.unsafe.alloc[cJSON](1)
    def apply(
        next: Ptr[cJSON],
        prev: Ptr[cJSON],
        child: Ptr[cJSON],
  ...
  opaque type cJSON_Hooks =
    CStruct2[CFuncPtr1[size_t, Ptr[Byte]], CFuncPtr1[Ptr[Byte], Unit]]
  object cJSON_Hooks:
    given _tag: Tag[cJSON_Hooks] =
      Tag.materializeCStruct2Tag[CFuncPtr1[size_t, Ptr[Byte]], CFuncPtr1[Ptr[
        Byte
      ], Unit]]
    def apply()(using Zone): Ptr[cJSON_Hooks] =
      scala.scalanative.unsafe.alloc[cJSON_Hooks](1)
    def apply(
        malloc_fn: CFuncPtr1[size_t, Ptr[Byte]],
        free_fn: CFuncPtr1[Ptr[Byte], Unit]
    )(using Zone): Ptr[cJSON_Hooks] =
      val ____ptr = apply()
    ...
    extension (struct: cJSON_Hooks)
      ...
      def malloc_fn_=(value: CFuncPtr1[size_t, Ptr[Byte]]): Unit = !struct.at1 =
        value
      def free_fn: CFuncPtr1[Ptr[Byte], Unit] = struct._2
      def free_fn_=(value: CFuncPtr1[Ptr[Byte], Unit]): Unit = !struct.at2 =
        value
  end cJSON_Hooks
end structs
...
private[cjson] object extern_functions:
  import _root_.cjson.aliases.*
  import _root_.cjson.structs.*
  def cJSON_AddArrayToObject(`object`: Ptr[cJSON], name: CString): Ptr[cJSON] =
    extern

  def cJSON_AddBoolToObject(
      `object`: Ptr[cJSON],
      name: CString,
      boolean: cJSON_bool
  ): Ptr[cJSON] = extern

  def cJSON_AddFalseToObject(`object`: Ptr[cJSON], name: CString): Ptr[cJSON] =
    extern

  def cJSON_AddItemReferenceToArray(
      array: Ptr[cJSON],
      item: Ptr[cJSON]
  ): cJSON_bool = extern

  def cJSON_AddItemReferenceToObject(
      `object`: Ptr[cJSON],
      string: CString,
      item: Ptr[cJSON]
  ): cJSON_bool = extern

  def cJSON_AddItemToArray(array: Ptr[cJSON], item: Ptr[cJSON]): cJSON_bool =
    extern

  def cJSON_AddItemToObject(
      `object`: Ptr[cJSON],
      string: CString,
      item: Ptr[cJSON]
  ): cJSON_bool = extern

  def cJSON_AddItemToObjectCS(
      `object`: Ptr[cJSON],
      string: CString,
      item: Ptr[cJSON]
  ): cJSON_bool = extern

  def cJSON_AddNullToObject(`object`: Ptr[cJSON], name: CString): Ptr[cJSON] =
    extern
  ...
  def cJSON_AddObjectToObject(`object`: Ptr[cJSON], name: CString): Ptr[cJSON] =
    extern

  def cJSON_AddRawToObject(
      `object`: Ptr[cJSON],
      name: CString,
      raw: CString
  ): Ptr[cJSON] = extern
  ...
  def cJSON_AddTrueToObject(`object`: Ptr[cJSON], name: CString): Ptr[cJSON] =
    extern
  ...
  def cJSON_CreateDoubleArray(numbers: Ptr[Double], count: CInt): Ptr[cJSON] =
    extern

  def cJSON_CreateFalse(): Ptr[cJSON] = extern

  def cJSON_CreateFloatArray(numbers: Ptr[Float], count: CInt): Ptr[cJSON] =
    extern
  ...
  def cJSON_CreateStringArray(strings: Ptr[CString], count: CInt): Ptr[cJSON] =
    extern
  ...
  def cJSON_DeleteItemFromObject(`object`: Ptr[cJSON], string: CString): Unit =
    extern

  def cJSON_DeleteItemFromObjectCaseSensitive(
      `object`: Ptr[cJSON],
      string: CString
  ): Unit = extern

  def cJSON_DetachItemFromArray(array: Ptr[cJSON], which: CInt): Ptr[cJSON] =
    extern

  def cJSON_DetachItemFromObject(
      `object`: Ptr[cJSON],
      string: CString
  ): Ptr[cJSON] = extern

  def cJSON_DetachItemFromObjectCaseSensitive(
      `object`: Ptr[cJSON],
      string: CString
  ): Ptr[cJSON] = extern

  def cJSON_DetachItemViaPointer(
      parent: Ptr[cJSON],
      item: Ptr[cJSON]
  ): Ptr[cJSON] = extern

  def cJSON_Duplicate(item: Ptr[cJSON], recurse: cJSON_bool): Ptr[cJSON] =
    extern
  ...
  def cJSON_GetObjectItem(`object`: Ptr[cJSON], string: CString): Ptr[cJSON] =
    extern

  def cJSON_GetObjectItemCaseSensitive(
      `object`: Ptr[cJSON],
      string: CString
  ): Ptr[cJSON] = extern
  ...
  def cJSON_HasObjectItem(`object`: Ptr[cJSON], string: CString): cJSON_bool =
    extern

  def cJSON_InitHooks(hooks: Ptr[cJSON_Hooks]): Unit = extern

  def cJSON_InsertItemInArray(
      array: Ptr[cJSON],
      which: CInt,
      newitem: Ptr[cJSON]
  ): cJSON_bool = extern
  ...
  def cJSON_ParseWithLength(value: CString, buffer_length: size_t): Ptr[cJSON] =
    extern

  def cJSON_ParseWithLengthOpts(
      value: CString,
      buffer_length: size_t,
      return_parse_end: Ptr[CString],
      require_null_terminated: cJSON_bool
  ): Ptr[cJSON] = extern

  def cJSON_ParseWithOpts(
      value: CString,
      return_parse_end: Ptr[CString],
      require_null_terminated: cJSON_bool
  ): Ptr[cJSON] = extern
  ...
  def cJSON_PrintBuffered(
      item: Ptr[cJSON],
      prebuffer: CInt,
      fmt: cJSON_bool
  ): CString = extern

  def cJSON_PrintPreallocated(
      item: Ptr[cJSON],
      buffer: CString,
      length: CInt,
      format: cJSON_bool
  ...
  def cJSON_ReplaceItemInArray(
      array: Ptr[cJSON],
      which: CInt,
      newitem: Ptr[cJSON]
  ): cJSON_bool = extern

  def cJSON_ReplaceItemInObject(
      `object`: Ptr[cJSON],
      string: CString,
      newitem: Ptr[cJSON]
  ): cJSON_bool = extern

  def cJSON_ReplaceItemInObjectCaseSensitive(
      `object`: Ptr[cJSON],
      string: CString,
      newitem: Ptr[cJSON]
  ): cJSON_bool = extern

  def cJSON_ReplaceItemViaPointer(
      parent: Ptr[cJSON],
      item: Ptr[cJSON],
      replacement: Ptr[cJSON]
  ): cJSON_bool = extern

  def cJSON_SetNumberHelper(`object`: Ptr[cJSON], number: Double): Double =
    extern

  def cJSON_SetValuestring(
      `object`: Ptr[cJSON],
      valuestring: CString
  ): CString = extern
