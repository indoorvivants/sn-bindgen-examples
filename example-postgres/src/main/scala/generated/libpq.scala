...
object predef:
  private[libpq] trait _BindgenEnumCUnsignedInt[T](using
      eq: T =:= CUnsignedInt
  ):
...
object enumerations:
    ...
    inline def getName(inline value: ConnStatusType): Option[String] =
      inline value match
        ...
        case CONNECTION_AWAITING_RESPONSE =>
          Some("CONNECTION_AWAITING_RESPONSE")
  ...
  object PGContextVisibility
      extends _BindgenEnumCUnsignedInt[PGContextVisibility]:
  ...
  object PGTransactionStatusType
      extends _BindgenEnumCUnsignedInt[PGTransactionStatusType]:
  ...
  object PostgresPollingStatusType
    ...
    inline def getName(
        inline value: PostgresPollingStatusType
    ): Option[String] =
      inline value match
    ...
    extension (a: PostgresPollingStatusType)
      inline def &(b: PostgresPollingStatusType): PostgresPollingStatusType =
        a & b
      inline def |(b: PostgresPollingStatusType): PostgresPollingStatusType =
        a | b
      inline def is(b: PostgresPollingStatusType): Boolean = (a & b) == b
  end PostgresPollingStatusType
end enumerations
...
object aliases:
  ...
  object Oid:
    ...
    extension (v: Oid) inline def value: CUnsignedInt = v

  opaque type PQnoticeProcessor = CFuncPtr2[Ptr[Byte], CString, Unit]
  object PQnoticeProcessor:
    given _tag: Tag[PQnoticeProcessor] =
      Tag.materializeCFuncPtr2[Ptr[Byte], CString, Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): PQnoticeProcessor =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr2[Ptr[Byte], CString, Unit]
    ): PQnoticeProcessor = o
    extension (v: PQnoticeProcessor)
      inline def value: CFuncPtr2[Ptr[Byte], CString, Unit] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end PQnoticeProcessor

  opaque type PQnoticeReceiver = CFuncPtr2[Ptr[Byte], Ptr[PGresult], Unit]
  object PQnoticeReceiver:
    given _tag: Tag[PQnoticeReceiver] =
      Tag.materializeCFuncPtr2[Ptr[Byte], Ptr[PGresult], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): PQnoticeReceiver =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr2[Ptr[Byte], Ptr[PGresult], Unit]
    ): PQnoticeReceiver = o
    extension (v: PQnoticeReceiver)
      inline def value: CFuncPtr2[Ptr[Byte], Ptr[PGresult], Unit] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end PQnoticeReceiver

  opaque type PQsslKeyPassHook_OpenSSL_type =
    CFuncPtr3[CString, CInt, Ptr[PGconn], CInt]
  object PQsslKeyPassHook_OpenSSL_type:
    given _tag: Tag[PQsslKeyPassHook_OpenSSL_type] =
      Tag.materializeCFuncPtr3[CString, CInt, Ptr[PGconn], CInt]
    inline def fromPtr(
        ptr: Ptr[Byte] | CVoidPtr
    ): PQsslKeyPassHook_OpenSSL_type =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr3[CString, CInt, Ptr[PGconn], CInt]
    ): PQsslKeyPassHook_OpenSSL_type = o
    extension (v: PQsslKeyPassHook_OpenSSL_type)
      inline def value: CFuncPtr3[CString, CInt, Ptr[PGconn], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end PQsslKeyPassHook_OpenSSL_type

  opaque type pg_int64 = CLongInt
  object pg_int64:
    given _tag: Tag[pg_int64] = Tag.Size
    inline def apply(inline o: CLongInt): pg_int64 = o
    extension (v: pg_int64) inline def value: CLongInt = v
  ...
  object pgthreadlock_t:
    ...
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): pgthreadlock_t =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
  ...
  object pqbool:
    ...
    extension (v: pqbool) inline def value: CChar = v
...
object structs:
  ...
  object PGnotify:
    given _tag: Tag[PGnotify] =
      Tag.materializeCStruct4Tag[CString, CInt, CString, Ptr[Byte]]
    def apply()(using Zone): Ptr[PGnotify] =
      scala.scalanative.unsafe.alloc[PGnotify](1)
    def apply(
        relname: CString,
        be_pid: CInt,
        extra: CString,
        next: Ptr[pgNotify]
    )(using Zone): Ptr[PGnotify] =
      val ____ptr = apply()
    ...
    extension (struct: PGnotify)
      ...
      def next_=(value: Ptr[pgNotify]): Unit = !struct.at4 =
  ...
  object PGresAttDesc:
    given _tag: Tag[PGresAttDesc] =
      Tag.materializeCStruct7Tag[CString, Oid, CInt, CInt, Oid, CInt, CInt]
    def apply()(using Zone): Ptr[PGresAttDesc] =
      scala.scalanative.unsafe.alloc[PGresAttDesc](1)
    def apply(
        name: CString,
        tableid: Oid,
        columnid: CInt,
  ...
  object PQArgBlock:
    ...
    object Union0:
      ...
      extension (struct: Union0)
        ...
        def ptr_=(value: Ptr[CInt]): Unit =
          !struct.at(0).asInstanceOf[Ptr[Ptr[CInt]]] = value
        def integer: CInt = !struct.at(0).asInstanceOf[Ptr[CInt]]
        def integer_=(value: CInt): Unit =
          !struct.at(0).asInstanceOf[Ptr[CInt]] = value
    end Union0
    given _tag: Tag[PQArgBlock] =
      Tag.materializeCStruct3Tag[CInt, CInt, PQArgBlock.Union0]
    def apply()(using Zone): Ptr[PQArgBlock] =
      scala.scalanative.unsafe.alloc[PQArgBlock](1)
    def apply(len: CInt, isint: CInt, u: PQArgBlock.Union0)(using
        Zone
    ): Ptr[PQArgBlock] =
      val ____ptr = apply()
      (!____ptr).len = len
  ...
  opaque type PQconninfoOption =
    CStruct7[CString, CString, CString, CString, CString, CString, CInt]
  object PQconninfoOption:
    given _tag: Tag[PQconninfoOption] = Tag.materializeCStruct7Tag[
      CString,
      CString,
      CString,
      CString,
    ...
    def apply()(using Zone): Ptr[PQconninfoOption] =
      scala.scalanative.unsafe.alloc[PQconninfoOption](1)
    def apply(
        keyword: CString,
        envvar: CString,
        compiled: CString,
        ...
        dispchar: CString,
        dispsize: CInt
    )(using Zone): Ptr[PQconninfoOption] =
      val ____ptr = apply()
  ...
  end PQconninfoOption

  opaque type PQprintOpt = CStruct10[
    pqbool,
    pqbool,
    pqbool,
    pqbool,
  ...
  object PQprintOpt:
    given _tag: Tag[PQprintOpt] = Tag.materializeCStruct10Tag[
      pqbool,
      pqbool,
      pqbool,
      pqbool,
    ...
    def apply()(using Zone): Ptr[PQprintOpt] =
      scala.scalanative.unsafe.alloc[PQprintOpt](1)
    def apply(
        header: pqbool,
        align: pqbool,
        standard: pqbool,
  ...
  opaque type _PQconninfoOption =
    CStruct7[CString, CString, CString, CString, CString, CString, CInt]
  object _PQconninfoOption:
    given _tag: Tag[_PQconninfoOption] = Tag.materializeCStruct7Tag[
      CString,
      CString,
      CString,
      CString,
    ...
    def apply()(using Zone): Ptr[_PQconninfoOption] =
      scala.scalanative.unsafe.alloc[_PQconninfoOption](1)
    def apply(
        keyword: CString,
        envvar: CString,
        compiled: CString,
        ...
        dispchar: CString,
        dispsize: CInt
    )(using Zone): Ptr[_PQconninfoOption] =
      val ____ptr = apply()
      (!____ptr).keyword = keyword
      (!____ptr).envvar = envvar
      (!____ptr).compiled = compiled
  ...
  end _PQconninfoOption

  opaque type _PQprintOpt = CStruct10[
    pqbool,
    pqbool,
    pqbool,
    pqbool,
  ...
  object _PQprintOpt:
    given _tag: Tag[_PQprintOpt] = Tag.materializeCStruct10Tag[
      pqbool,
      pqbool,
      pqbool,
      pqbool,
    ...
    def apply()(using Zone): Ptr[_PQprintOpt] =
      scala.scalanative.unsafe.alloc[_PQprintOpt](1)
    def apply(
        header: pqbool,
        align: pqbool,
        standard: pqbool,
...
private[libpq] object extern_functions:
  ...
  def PQcancel(cancel: Ptr[PGcancel], errbuf: CString, errbufsize: CInt): CInt =
    extern
  ...
  def PQconnectStartParams(
      keywords: Ptr[CString],
      values: Ptr[CString],
      expand_dbname: CInt
  ): Ptr[PGconn] = extern
  ...
  def PQdefaultSSLKeyPassHook_OpenSSL(
      buf: CString,
      size: CInt,
      conn: Ptr[PGconn]
  ): CInt = extern

  def PQdescribePortal(conn: Ptr[PGconn], portal: CString): Ptr[PGresult] =
    extern

  def PQdescribePrepared(conn: Ptr[PGconn], stmt: CString): Ptr[PGresult] =
    extern
  ...
  def PQescapeBytea(
      from: Ptr[CUnsignedChar],
      from_length: size_t,
      to_length: Ptr[size_t]
  ...
  def PQescapeIdentifier(
      conn: Ptr[PGconn],
      str: CString,
      len: size_t
  ): CString = extern

  def PQescapeLiteral(conn: Ptr[PGconn], str: CString, len: size_t): CString =
    extern

  def PQescapeString(to: CString, from: CString, length: size_t): size_t =
    extern
  ...
  def PQgetisnull(res: Ptr[PGresult], tup_num: CInt, field_num: CInt): CInt =
    extern

  def PQgetlength(res: Ptr[PGresult], tup_num: CInt, field_num: CInt): CInt =
    extern

  def PQgetline(conn: Ptr[PGconn], buffer: CString, length: CInt): CInt = extern

  def PQgetlineAsync(conn: Ptr[PGconn], buffer: CString, bufsize: CInt): CInt =
    extern

  def PQgetssl(conn: Ptr[PGconn]): Ptr[Byte] = extern

  def PQgetvalue(res: Ptr[PGresult], tup_num: CInt, field_num: CInt): CString =
    extern
  ...
  def PQprint(fout: Ptr[FILE], res: Ptr[PGresult], po: Ptr[PQprintOpt]): Unit =
    extern
  ...
  def PQputCopyData(conn: Ptr[PGconn], buffer: CString, nbytes: CInt): CInt =
    extern
  ...
  def PQputnbytes(conn: Ptr[PGconn], buffer: CString, nbytes: CInt): CInt =
    extern
  ...
  def PQresultVerboseErrorMessage(
      res: Ptr[PGresult],
  ...
  def PQsetErrorContextVisibility(
      conn: Ptr[PGconn],
      show_context: PGContextVisibility
  ): PGContextVisibility = extern

  def PQsetErrorVerbosity(
      conn: Ptr[PGconn],
      verbosity: PGVerbosity
  ): PGVerbosity = extern

  def PQsetNoticeProcessor(
      conn: Ptr[PGconn],
      proc: PQnoticeProcessor,
      arg: Ptr[Byte]
  ): PQnoticeProcessor = extern

  def PQsetNoticeReceiver(
      conn: Ptr[PGconn],
      proc: PQnoticeReceiver,
      arg: Ptr[Byte]
  ): PQnoticeReceiver = extern

  def PQsetResultAttrs(
      res: Ptr[PGresult],
      numAttributes: CInt,
      attDescs: Ptr[PGresAttDesc]
  ): CInt = extern

  def PQsetSSLKeyPassHook_OpenSSL(hook: PQsslKeyPassHook_OpenSSL_type): Unit =
    extern
  ...
  def PQsslAttribute(conn: Ptr[PGconn], attribute_name: CString): CString =
    extern
  ...
  def PQunescapeBytea(
      strtext: Ptr[CUnsignedChar],
      retbuflen: Ptr[size_t]
  ): Ptr[CUnsignedChar] = extern
  ...
  def lo_export(conn: Ptr[PGconn], lobjId: Oid, filename: CString): CInt =
    extern

  def lo_import(conn: Ptr[PGconn], filename: CString): Oid = extern

  def lo_import_with_oid(
      conn: Ptr[PGconn],
      filename: CString,
      lobjId: Oid
  ): Oid = extern

  def lo_lseek(conn: Ptr[PGconn], fd: CInt, offset: CInt, whence: CInt): CInt =
    extern
  ...
  def lo_read(conn: Ptr[PGconn], fd: CInt, buf: CString, len: size_t): CInt =
    extern
  ...
  def lo_write(conn: Ptr[PGconn], fd: CInt, buf: CString, len: size_t): CInt =
    extern
