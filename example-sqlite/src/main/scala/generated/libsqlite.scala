...
object structs:
  ...
  object fts5_tokenizer:
    ...
    def apply(
        ...
        xTokenize: CFuncPtr6[Ptr[Fts5Tokenizer], Ptr[
          Byte
    ...
    extension (struct: fts5_tokenizer)
      ...
      def xTokenize_=(
          value: CFuncPtr6[Ptr[Fts5Tokenizer], Ptr[
            Byte
          ], CInt, CString, CInt, CFuncPtr6[Ptr[
            Byte
          ], CInt, CString, CInt, CInt, CInt, CInt], CInt]
  ...
  object sqlite3_module:
    ...
    extension (struct: sqlite3_module)
      def iVersion: CInt = !struct.at(0).asInstanceOf[Ptr[CInt]]
      ...
      def xDisconnect: CFuncPtr1[Ptr[sqlite3_vtab], CInt] =
        !struct.at(32).asInstanceOf[Ptr[CFuncPtr1[Ptr[sqlite3_vtab], CInt]]]
      def xDisconnect_=(value: CFuncPtr1[Ptr[sqlite3_vtab], CInt]): Unit =
        !struct.at(32).asInstanceOf[Ptr[CFuncPtr1[Ptr[sqlite3_vtab], CInt]]] =
          value
      def xDestroy: CFuncPtr1[Ptr[sqlite3_vtab], CInt] =
        !struct.at(40).asInstanceOf[Ptr[CFuncPtr1[Ptr[sqlite3_vtab], CInt]]]
      ...
      def xShadowName: CFuncPtr1[CString, CInt] =
        !struct.at(184).asInstanceOf[Ptr[CFuncPtr1[CString, CInt]]]
      def xShadowName_=(value: CFuncPtr1[CString, CInt]): Unit =
        !struct.at(184).asInstanceOf[Ptr[CFuncPtr1[CString, CInt]]] = value
    end extension
  end sqlite3_module
