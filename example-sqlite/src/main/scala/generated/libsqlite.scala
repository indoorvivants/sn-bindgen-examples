...
object aliases:
  ...
  object fts5_extension_function:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): fts5_extension_function =
  ...
  object sqlite3_callback:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): sqlite3_callback = CFuncPtr.fromPtr(ptr)
    inline def apply(
  ...
  object sqlite3_destructor_type:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): sqlite3_destructor_type =
      CFuncPtr.fromPtr(ptr)
    inline def apply(
  ...
  object sqlite3_syscall_ptr:
    ...
    inline def fromPtr(ptr: Ptr[Byte]): sqlite3_syscall_ptr =
      CFuncPtr.fromPtr(ptr)
