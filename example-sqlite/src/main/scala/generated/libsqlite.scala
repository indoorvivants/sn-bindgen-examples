...
object structs:
  ...
  opaque type Fts5ExtensionApi = CStruct20[
    CInt,
    CFuncPtr1[Ptr[Fts5Context], Ptr[Byte]],
    CFuncPtr1[Ptr[Fts5Context], CInt],
    CFuncPtr2[Ptr[Fts5Context], Ptr[sqlite3_int64], CInt],
    CFuncPtr3[Ptr[Fts5Context], CInt, Ptr[sqlite3_int64], CInt],
    CFuncPtr5[Ptr[Fts5Context], CString, CInt, Ptr[Byte], CFuncPtr6[Ptr[
      Byte
    ], CInt, CString, CInt, CInt, CInt, CInt], CInt],
    CFuncPtr1[Ptr[Fts5Context], CInt],
    CFuncPtr2[Ptr[Fts5Context], CInt, CInt],
    CFuncPtr2[Ptr[Fts5Context], Ptr[CInt], CInt],
    CFuncPtr5[Ptr[Fts5Context], CInt, Ptr[CInt], Ptr[CInt], Ptr[CInt], CInt],
    CFuncPtr1[Ptr[Fts5Context], sqlite3_int64],
    CFuncPtr4[Ptr[Fts5Context], CInt, Ptr[CString], Ptr[CInt], CInt],
    CFuncPtr3[Ptr[Fts5Context], CInt, Ptr[CInt], CInt],
    CFuncPtr4[Ptr[Fts5Context], CInt, Ptr[Byte], CFuncPtr3[Ptr[Byte], Ptr[
      Fts5Context
    ], Ptr[Byte], CInt], CInt],
    CFuncPtr3[Ptr[Fts5Context], Ptr[Byte], CFuncPtr1[Ptr[Byte], Unit], CInt],
    CFuncPtr2[Ptr[Fts5Context], CInt, Ptr[Byte]],
    CFuncPtr5[Ptr[Fts5Context], CInt, Ptr[Fts5PhraseIter], Ptr[CInt], Ptr[
      CInt
    ], CInt],
    CFuncPtr4[Ptr[Fts5Context], Ptr[Fts5PhraseIter], Ptr[CInt], Ptr[
      CInt
    ], Unit],
    CFuncPtr4[Ptr[Fts5Context], CInt, Ptr[Fts5PhraseIter], Ptr[CInt], CInt],
    CFuncPtr3[Ptr[Fts5Context], Ptr[Fts5PhraseIter], Ptr[CInt], Unit]
  ]
  object Fts5ExtensionApi:
    given _tag: Tag[Fts5ExtensionApi] = Tag.materializeCStruct20Tag[
      CInt,
      CFuncPtr1[Ptr[Fts5Context], Ptr[Byte]],
      CFuncPtr1[Ptr[Fts5Context], CInt],
      CFuncPtr2[Ptr[Fts5Context], Ptr[sqlite3_int64], CInt],
    ...
    extension (struct: Fts5ExtensionApi)
      ...
      def xQueryPhrase
        ...
        struct._14.asInstanceOf[CFuncPtr4[
          Ptr[Fts5Context],
          CInt,
          Ptr[Byte],
          CFuncPtr3[Ptr[Fts5ExtensionApi], Ptr[Fts5Context], Ptr[Byte], CInt],
  ...
  object fts5_api:
    given _tag: Tag[fts5_api] = Tag.materializeCStruct4Tag[
      CInt,
      CFuncPtr5[
        Ptr[Byte],
        CString,
  ...
  object sqlite3_file:
    ...
    given _tag: Tag[sqlite3_file] =
      Tag.materializeCStruct2Tag[CStruct0, Ptr[Byte]]
    ...
    extension (struct: sqlite3_file)
      def pMethods: Ptr[sqlite3_io_methods] =
        struct._2.asInstanceOf[Ptr[sqlite3_io_methods]]
      def pMethods_=(value: Ptr[sqlite3_io_methods]): Unit = !struct.at2 =
  ...
  opaque type sqlite3_index_info = CStruct16[
    CInt,
    CStruct4[CInt, CUnsignedChar, CUnsignedChar, CInt],
  ...
  object sqlite3_index_info:
    ...
    given _tag: Tag[sqlite3_index_info] = Tag.materializeCStruct16Tag[
      CInt,
      CStruct4[CInt, CUnsignedChar, CUnsignedChar, CInt],
      Ptr[sqlite3_index_constraint],
      CInt,
    ...
    extension (struct: sqlite3_index_info)
      ...
      def aOrderBy_=(value: Ptr[sqlite3_index_orderby]): Unit = !struct.at6 =
        value
