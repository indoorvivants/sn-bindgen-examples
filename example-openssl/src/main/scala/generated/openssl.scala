...
object structs:
  ...
  opaque type CRYPTO_EX_DATA =
    CStruct3[Ptr[OSSL_LIB_CTX], CStruct0, Ptr[stack_st_void]]
  object CRYPTO_EX_DATA:
    opaque type Struct0 = CStruct0
    object Struct0:
      given _tag: Tag[Struct0] = Tag.materializeCStruct0Tag
    given _tag: Tag[CRYPTO_EX_DATA] = Tag
      .materializeCStruct3Tag[Ptr[OSSL_LIB_CTX], CStruct0, Ptr[stack_st_void]]
  ...
  object crypto_ex_data_st:
    ...
    object Struct0:
      given _tag: Tag[Struct0] = Tag.materializeCStruct0Tag
    given _tag: Tag[crypto_ex_data_st] = Tag
      .materializeCStruct3Tag[Ptr[OSSL_LIB_CTX], CStruct0, Ptr[stack_st_void]]
