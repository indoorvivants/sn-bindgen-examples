...
object aliases:
  ...
  opaque type rocksdb_compaction_service_cancel_awaiting_jobs_cb = CFuncPtr1[Ptr[Byte], Unit]
  object rocksdb_compaction_service_cancel_awaiting_jobs_cb:
    given _tag: Tag[rocksdb_compaction_service_cancel_awaiting_jobs_cb] = Tag.materializeCFuncPtr1[Ptr[Byte], Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): rocksdb_compaction_service_cancel_awaiting_jobs_cb = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr1[Ptr[Byte], Unit]): rocksdb_compaction_service_cancel_awaiting_jobs_cb = o
    extension (v: rocksdb_compaction_service_cancel_awaiting_jobs_cb)
      inline def value: CFuncPtr1[Ptr[Byte], Unit] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type rocksdb_compaction_service_on_installation_cb = CFuncPtr3[Ptr[Byte], CString, CInt, Unit]
  object rocksdb_compaction_service_on_installation_cb:
    given _tag: Tag[rocksdb_compaction_service_on_installation_cb] = Tag.materializeCFuncPtr3[Ptr[Byte], CString, CInt, Unit]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): rocksdb_compaction_service_on_installation_cb = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr3[Ptr[Byte], CString, CInt, Unit]): rocksdb_compaction_service_on_installation_cb = o
    extension (v: rocksdb_compaction_service_on_installation_cb)
      inline def value: CFuncPtr3[Ptr[Byte], CString, CInt, Unit] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type rocksdb_compaction_service_schedule_cb = CFuncPtr4[Ptr[Byte], Ptr[rocksdb_compactionservice_jobinfo_t], CString, size_t, Ptr[rocksdb_compactionservice_scheduleresponse_t]]
  object rocksdb_compaction_service_schedule_cb:
    given _tag: Tag[rocksdb_compaction_service_schedule_cb] = Tag.materializeCFuncPtr4[Ptr[Byte], Ptr[rocksdb_compactionservice_jobinfo_t], CString, size_t, Ptr[rocksdb_compactionservice_scheduleresponse_t]]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): rocksdb_compaction_service_schedule_cb = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], Ptr[rocksdb_compactionservice_jobinfo_t], CString, size_t, Ptr[rocksdb_compactionservice_scheduleresponse_t]]): rocksdb_compaction_service_schedule_cb = o
    extension (v: rocksdb_compaction_service_schedule_cb)
      inline def value: CFuncPtr4[Ptr[Byte], Ptr[rocksdb_compactionservice_jobinfo_t], CString, size_t, Ptr[rocksdb_compactionservice_scheduleresponse_t]] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)

  opaque type rocksdb_compaction_service_wait_cb = CFuncPtr4[Ptr[Byte], CString, Ptr[CString], Ptr[size_t], CInt]
  object rocksdb_compaction_service_wait_cb:
    given _tag: Tag[rocksdb_compaction_service_wait_cb] = Tag.materializeCFuncPtr4[Ptr[Byte], CString, Ptr[CString], Ptr[size_t], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): rocksdb_compaction_service_wait_cb = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(inline o: CFuncPtr4[Ptr[Byte], CString, Ptr[CString], Ptr[size_t], CInt]): rocksdb_compaction_service_wait_cb = o
    extension (v: rocksdb_compaction_service_wait_cb)
      inline def value: CFuncPtr4[Ptr[Byte], CString, Ptr[CString], Ptr[size_t], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
...
object structs:
  ...
  opaque type rocksdb_compaction_service_options_override_t = CStruct0
  
  object rocksdb_compaction_service_options_override_t:
    given _tag: Tag[rocksdb_compaction_service_options_override_t] = Tag.materializeCStruct0Tag
  ...
  opaque type rocksdb_compactionservice_jobinfo_t = CStruct0
  
  object rocksdb_compactionservice_jobinfo_t:
    given _tag: Tag[rocksdb_compactionservice_jobinfo_t] = Tag.materializeCStruct0Tag
    

  opaque type rocksdb_compactionservice_scheduleresponse_t = CStruct0
  
  object rocksdb_compactionservice_scheduleresponse_t:
    given _tag: Tag[rocksdb_compactionservice_scheduleresponse_t] = Tag.materializeCStruct0Tag
    

  opaque type rocksdb_compactionservice_t = CStruct0
  
  object rocksdb_compactionservice_t:
    given _tag: Tag[rocksdb_compactionservice_t] = Tag.materializeCStruct0Tag
  ...
  opaque type rocksdb_export_import_files_metadata_t = CStruct0
  
  object rocksdb_export_import_files_metadata_t:
    given _tag: Tag[rocksdb_export_import_files_metadata_t] = Tag.materializeCStruct0Tag
  ...
  opaque type rocksdb_import_column_family_options_t = CStruct0
  
  object rocksdb_import_column_family_options_t:
    given _tag: Tag[rocksdb_import_column_family_options_t] = Tag.materializeCStruct0Tag
  ...
  opaque type rocksdb_livefile_t = CStruct0
  
  object rocksdb_livefile_t:
    given _tag: Tag[rocksdb_livefile_t] = Tag.materializeCStruct0Tag
  ...
  opaque type rocksdb_open_and_compact_options_t = CStruct0
  
  object rocksdb_open_and_compact_options_t:
    given _tag: Tag[rocksdb_open_and_compact_options_t] = Tag.materializeCStruct0Tag
  ...
  opaque type rocksdb_pinnable_handle_t = CStruct0
  
  object rocksdb_pinnable_handle_t:
    given _tag: Tag[rocksdb_pinnable_handle_t] = Tag.materializeCStruct0Tag
  ...
  opaque type rocksdb_slice_t = CStruct2[CString, size_t]
  
  object rocksdb_slice_t:
    given _tag: Tag[rocksdb_slice_t] = Tag.materializeCStruct2Tag[CString, size_t]
    
    export fields.*
    private[rocksdb] object fields:
      extension (struct: rocksdb_slice_t)
    ...
    // Allocates rocksdb_slice_t on the heap – fields are not initalised or zeroed out
    def apply()(using Zone): Ptr[rocksdb_slice_t] = scala.scalanative.unsafe.alloc[rocksdb_slice_t](1)
    def apply(data : CString, size : size_t)(using Zone): Ptr[rocksdb_slice_t] =
      val ____ptr = apply()
      (!____ptr).data = data
      (!____ptr).size = size
      ____ptr
...
private[rocksdb] object extern_functions:
  import _root_.rocksdb.aliases.*
  import _root_.rocksdb.structs.*
  private[rocksdb] def __sn_wrap_rocksdb_rocksdb_iter_key_slice(iter : Ptr[rocksdb_iterator_t], __return : Ptr[rocksdb_slice_t]): Unit = extern

  private[rocksdb] def __sn_wrap_rocksdb_rocksdb_iter_timestamp_slice(iter : Ptr[rocksdb_iterator_t], __return : Ptr[rocksdb_slice_t]): Unit = extern

  private[rocksdb] def __sn_wrap_rocksdb_rocksdb_iter_value_slice(iter : Ptr[rocksdb_iterator_t], __return : Ptr[rocksdb_slice_t]): Unit = extern
  ...
  def rocksdb_batched_multi_get_cf_slice(db : Ptr[rocksdb_t], options : Ptr[rocksdb_readoptions_t], column_family : Ptr[rocksdb_column_family_handle_t], num_keys : size_t, keys_list : Ptr[rocksdb_slice_t], values : Ptr[Ptr[rocksdb_pinnableslice_t]], errs : Ptr[CString], sorted_input : Boolean): Unit = extern
  ...
  def rocksdb_cache_create_hyper_clock(capacity : size_t, estimated_entry_charge : size_t): Ptr[rocksdb_cache_t] = extern

  def rocksdb_cache_create_hyper_clock_opts(_0 : Ptr[rocksdb_hyper_clock_cache_options_t]): Ptr[rocksdb_cache_t] = extern
  ...
  def rocksdb_cache_get_occupancy_count(cache : Ptr[rocksdb_cache_t]): size_t = extern

  def rocksdb_cache_get_pinned_usage(cache : Ptr[rocksdb_cache_t]): size_t = extern

  def rocksdb_cache_get_table_address_count(cache : Ptr[rocksdb_cache_t]): size_t = extern
  ...
  def rocksdb_checkpoint_export_column_family(checkpoint : Ptr[rocksdb_checkpoint_t], column_family : Ptr[rocksdb_column_family_handle_t], export_dir : CString, errptr : Ptr[CString]): Ptr[rocksdb_export_import_files_metadata_t] = extern
  ...
  */
  ...
  def rocksdb_compaction_service_options_override_create(): Ptr[rocksdb_compaction_service_options_override_t] = extern

  def rocksdb_compaction_service_options_override_destroy(override_options : Ptr[rocksdb_compaction_service_options_override_t]): Unit = extern

  def rocksdb_compaction_service_options_override_set_comparator(override_options : Ptr[rocksdb_compaction_service_options_override_t], comparator : Ptr[rocksdb_comparator_t]): Unit = extern

  def rocksdb_compaction_service_options_override_set_env(override_options : Ptr[rocksdb_compaction_service_options_override_t], env : Ptr[rocksdb_env_t]): Unit = extern
  ...
  def rocksdb_compactionservice_create(state : Ptr[Byte], destructor : CFuncPtr1[Ptr[Byte], Unit], schedule : rocksdb_compaction_service_schedule_cb, name : CString, wait : rocksdb_compaction_service_wait_cb, cancel_awaiting_jobs : rocksdb_compaction_service_cancel_awaiting_jobs_cb, on_installation : rocksdb_compaction_service_on_installation_cb): Ptr[rocksdb_compactionservice_t] = extern

  def rocksdb_compactionservice_jobinfo_t_get_base_input_level(info : Ptr[rocksdb_compactionservice_jobinfo_t]): CInt = extern

  def rocksdb_compactionservice_jobinfo_t_get_cf_id(info : Ptr[rocksdb_compactionservice_jobinfo_t]): uint32_t = extern

  def rocksdb_compactionservice_jobinfo_t_get_cf_name(info : Ptr[rocksdb_compactionservice_jobinfo_t], len : Ptr[size_t]): CString = extern

  def rocksdb_compactionservice_jobinfo_t_get_compaction_reason(info : Ptr[rocksdb_compactionservice_jobinfo_t]): CInt = extern

  def rocksdb_compactionservice_jobinfo_t_get_db_id(info : Ptr[rocksdb_compactionservice_jobinfo_t], len : Ptr[size_t]): CString = extern

  def rocksdb_compactionservice_jobinfo_t_get_db_name(info : Ptr[rocksdb_compactionservice_jobinfo_t], len : Ptr[size_t]): CString = extern

  def rocksdb_compactionservice_jobinfo_t_get_db_session_id(info : Ptr[rocksdb_compactionservice_jobinfo_t], len : Ptr[size_t]): CString = extern

  def rocksdb_compactionservice_jobinfo_t_get_job_id(info : Ptr[rocksdb_compactionservice_jobinfo_t]): uint64_t = extern

  def rocksdb_compactionservice_jobinfo_t_get_output_level(info : Ptr[rocksdb_compactionservice_jobinfo_t]): CInt = extern

  def rocksdb_compactionservice_jobinfo_t_get_priority(info : Ptr[rocksdb_compactionservice_jobinfo_t]): CInt = extern

  def rocksdb_compactionservice_jobinfo_t_is_bottommost_level(info : Ptr[rocksdb_compactionservice_jobinfo_t]): CUnsignedChar = extern

  def rocksdb_compactionservice_jobinfo_t_is_full_compaction(info : Ptr[rocksdb_compactionservice_jobinfo_t]): CUnsignedChar = extern

  def rocksdb_compactionservice_jobinfo_t_is_manual_compaction(info : Ptr[rocksdb_compactionservice_jobinfo_t]): CUnsignedChar = extern

  def rocksdb_compactionservice_scheduleresponse_create(scheduled_job_id : CString, status : CInt, errptr : Ptr[CString]): Ptr[rocksdb_compactionservice_scheduleresponse_t] = extern

  def rocksdb_compactionservice_scheduleresponse_create_with_status(status : CInt, errptr : Ptr[CString]): Ptr[rocksdb_compactionservice_scheduleresponse_t] = extern

  def rocksdb_compactionservice_scheduleresponse_get_scheduled_job_id(response : Ptr[rocksdb_compactionservice_scheduleresponse_t], len : Ptr[size_t]): CString = extern

  def rocksdb_compactionservice_scheduleresponse_getstatus(response : Ptr[rocksdb_compactionservice_scheduleresponse_t]): CInt = extern

  def rocksdb_compactionservice_scheduleresponse_t_destroy(response : Ptr[rocksdb_compactionservice_scheduleresponse_t]): Unit = extern
  ...
  def rocksdb_create_column_families(db : Ptr[rocksdb_t], column_family_options : Ptr[rocksdb_options_t], num_column_families : CInt, column_family_names : Ptr[CString], lencfs : Ptr[size_t], errptr : Ptr[CString]): Ptr[Ptr[rocksdb_column_family_handle_t]] = extern

  def rocksdb_create_column_families_destroy(list : Ptr[Ptr[rocksdb_column_family_handle_t]]): Unit = extern
  ...
  def rocksdb_create_column_family_with_import(db : Ptr[rocksdb_t], column_family_options : Ptr[rocksdb_options_t], column_family_name : CString, import_options : Ptr[rocksdb_import_column_family_options_t], metadata : Ptr[rocksdb_export_import_files_metadata_t], errptr : Ptr[CString]): Ptr[rocksdb_column_family_handle_t] = extern
  ...
  def rocksdb_export_import_files_metadata_create(): Ptr[rocksdb_export_import_files_metadata_t] = extern

  def rocksdb_export_import_files_metadata_destroy(_0 : Ptr[rocksdb_export_import_files_metadata_t]): Unit = extern

  def rocksdb_export_import_files_metadata_get_db_comparator_name(_0 : Ptr[rocksdb_export_import_files_metadata_t]): CString = extern

  def rocksdb_export_import_files_metadata_get_files(_0 : Ptr[rocksdb_export_import_files_metadata_t]): Ptr[rocksdb_livefiles_t] = extern

  def rocksdb_export_import_files_metadata_set_db_comparator_name(_0 : Ptr[rocksdb_export_import_files_metadata_t], _1 : CString): Unit = extern

  def rocksdb_export_import_files_metadata_set_files(_0 : Ptr[rocksdb_export_import_files_metadata_t], _1 : Ptr[rocksdb_livefiles_t]): Unit = extern
  ...
  def rocksdb_fifo_compaction_options_get_allow_compaction(fifo_opts : Ptr[rocksdb_fifo_compaction_options_t]): CUnsignedChar = extern
  ...
  def rocksdb_fifo_compaction_options_set_allow_compaction(fifo_opts : Ptr[rocksdb_fifo_compaction_options_t], allow_compaction : CUnsignedChar): Unit = extern
  ...
  def rocksdb_flush_cfs(db : Ptr[rocksdb_t], options : Ptr[rocksdb_flushoptions_t], column_family : Ptr[Ptr[rocksdb_column_family_handle_t]], num_column_families : CInt, errptr : Ptr[CString]): Unit = extern
  ...
  def rocksdb_flushjobinfo_flush_reason(info : Ptr[rocksdb_flushjobinfo_t]): uint32_t = extern
  ...
  */
  ...
  def rocksdb_get_into_buffer(db : Ptr[rocksdb_t], options : Ptr[rocksdb_readoptions_t], key : CString, keylen : size_t, buffer : CString, buffer_size : size_t, vallen : Ptr[size_t], found : Ptr[CUnsignedChar], errptr : Ptr[CString]): CUnsignedChar = extern

  def rocksdb_get_into_buffer_cf(db : Ptr[rocksdb_t], options : Ptr[rocksdb_readoptions_t], column_family : Ptr[rocksdb_column_family_handle_t], key : CString, keylen : size_t, buffer : CString, buffer_size : size_t, vallen : Ptr[size_t], found : Ptr[CUnsignedChar], errptr : Ptr[CString]): CUnsignedChar = extern
  ...
  def rocksdb_get_pinned_cf_v2(db : Ptr[rocksdb_t], options : Ptr[rocksdb_readoptions_t], column_family : Ptr[rocksdb_column_family_handle_t], key : CString, keylen : size_t, errptr : Ptr[CString]): Ptr[rocksdb_pinnable_handle_t] = extern

  def rocksdb_get_pinned_v2(db : Ptr[rocksdb_t], options : Ptr[rocksdb_readoptions_t], key : CString, keylen : size_t, errptr : Ptr[CString]): Ptr[rocksdb_pinnable_handle_t] = extern
  ...
  def rocksdb_hyper_clock_cache_options_create(capacity : size_t, estimated_entry_charge : size_t): Ptr[rocksdb_hyper_clock_cache_options_t] = extern

  def rocksdb_hyper_clock_cache_options_destroy(_0 : Ptr[rocksdb_hyper_clock_cache_options_t]): Unit = extern

  def rocksdb_hyper_clock_cache_options_set_capacity(_0 : Ptr[rocksdb_hyper_clock_cache_options_t], _1 : size_t): Unit = extern

  def rocksdb_hyper_clock_cache_options_set_estimated_entry_charge(_0 : Ptr[rocksdb_hyper_clock_cache_options_t], _1 : size_t): Unit = extern

  def rocksdb_hyper_clock_cache_options_set_memory_allocator(_0 : Ptr[rocksdb_hyper_clock_cache_options_t], _1 : Ptr[rocksdb_memory_allocator_t]): Unit = extern

  def rocksdb_hyper_clock_cache_options_set_num_shard_bits(_0 : Ptr[rocksdb_hyper_clock_cache_options_t], _1 : CInt): Unit = extern

  def rocksdb_import_column_family_options_create(): Ptr[rocksdb_import_column_family_options_t] = extern

  def rocksdb_import_column_family_options_destroy(_0 : Ptr[rocksdb_import_column_family_options_t]): Unit = extern

  def rocksdb_import_column_family_options_set_move_files(_0 : Ptr[rocksdb_import_column_family_options_t], _1 : CUnsignedChar): Unit = extern
  ...
  def rocksdb_ingestexternalfileoptions_set_fail_if_not_bottommost_level(opt : Ptr[rocksdb_ingestexternalfileoptions_t], fail_if_not_bottommost_level : CUnsignedChar): Unit = extern
  ...
  */
  ...
  def rocksdb_livefile_create(): Ptr[rocksdb_livefile_t] = extern

  def rocksdb_livefile_destroy(_0 : Ptr[rocksdb_livefile_t]): Unit = extern

  def rocksdb_livefile_set_column_family_name(_0 : Ptr[rocksdb_livefile_t], _1 : CString): Unit = extern

  def rocksdb_livefile_set_directory(_0 : Ptr[rocksdb_livefile_t], _1 : CString): Unit = extern

  def rocksdb_livefile_set_largest_key(_0 : Ptr[rocksdb_livefile_t], _1 : CString, _2 : size_t): Unit = extern

  def rocksdb_livefile_set_largest_seqno(_0 : Ptr[rocksdb_livefile_t], _1 : uint64_t): Unit = extern

  def rocksdb_livefile_set_level(_0 : Ptr[rocksdb_livefile_t], _1 : CInt): Unit = extern

  def rocksdb_livefile_set_name(_0 : Ptr[rocksdb_livefile_t], _1 : CString): Unit = extern

  def rocksdb_livefile_set_num_deletions(_0 : Ptr[rocksdb_livefile_t], _1 : uint64_t): Unit = extern

  def rocksdb_livefile_set_num_entries(_0 : Ptr[rocksdb_livefile_t], _1 : uint64_t): Unit = extern

  def rocksdb_livefile_set_size(_0 : Ptr[rocksdb_livefile_t], _1 : size_t): Unit = extern

  def rocksdb_livefile_set_smallest_key(_0 : Ptr[rocksdb_livefile_t], _1 : CString, _2 : size_t): Unit = extern

  def rocksdb_livefile_set_smallest_seqno(_0 : Ptr[rocksdb_livefile_t], _1 : uint64_t): Unit = extern

  def rocksdb_livefiles(db : Ptr[rocksdb_t]): Ptr[rocksdb_livefiles_t] = extern

  def rocksdb_livefiles_add(_0 : Ptr[rocksdb_livefiles_t], _1 : Ptr[rocksdb_livefile_t]): Unit = extern
  ...
  def rocksdb_livefiles_create(): Ptr[rocksdb_livefiles_t] = extern
  ...
  def rocksdb_livefiles_directory(_0 : Ptr[rocksdb_livefiles_t], index : CInt): CString = extern

  def rocksdb_livefiles_entries(_0 : Ptr[rocksdb_livefiles_t], index : CInt): uint64_t = extern

  def rocksdb_livefiles_largest_seqno(_0 : Ptr[rocksdb_livefiles_t], index : CInt): uint64_t = extern
  ...
  def rocksdb_livefiles_smallest_seqno(_0 : Ptr[rocksdb_livefiles_t], index : CInt): uint64_t = extern
  ...
  def rocksdb_open_and_compact(db_path : CString, output_directory : CString, input : CString, input_len : size_t, output_len : Ptr[size_t], override_options : Ptr[rocksdb_compaction_service_options_override_t], errptr : Ptr[CString]): CString = extern

  def rocksdb_open_and_compact_canceled_create(): Ptr[CUnsignedChar] = extern

  def rocksdb_open_and_compact_canceled_destroy(canceled : Ptr[CUnsignedChar]): Unit = extern

  def rocksdb_open_and_compact_canceled_set(canceled : Ptr[CUnsignedChar], value : CUnsignedChar): Unit = extern

  def rocksdb_open_and_compact_options_create(): Ptr[rocksdb_open_and_compact_options_t] = extern

  def rocksdb_open_and_compact_options_destroy(options : Ptr[rocksdb_open_and_compact_options_t]): Unit = extern

  def rocksdb_open_and_compact_options_set_allow_resumption(options : Ptr[rocksdb_open_and_compact_options_t], allow_resumption : CUnsignedChar): Unit = extern

  def rocksdb_open_and_compact_options_set_canceled(options : Ptr[rocksdb_open_and_compact_options_t], canceled : Ptr[CUnsignedChar]): Unit = extern

  def rocksdb_open_and_compact_with_options(options : Ptr[rocksdb_open_and_compact_options_t], db_path : CString, output_directory : CString, input : CString, input_len : size_t, output_len : Ptr[size_t], override_options : Ptr[rocksdb_compaction_service_options_override_t], errptr : Ptr[CString]): CString = extern
  ...
  def rocksdb_options_add_compact_on_deletion_collector_factory_min_file_size(_0 : Ptr[rocksdb_options_t], window_size : size_t, num_dels_trigger : size_t, deletion_ratio : Double, min_file_size : uint64_t): Unit = extern
  ...
  def rocksdb_options_get_periodic_compaction_seconds(_0 : Ptr[rocksdb_options_t]): uint64_t = extern
  ...
  def rocksdb_options_get_statistics_level(_0 : Ptr[rocksdb_options_t]): CInt = extern
  ...
  def rocksdb_options_set_cf_paths(_0 : Ptr[rocksdb_options_t], path_values : Ptr[Ptr[rocksdb_dbpath_t]], num_paths : size_t): Unit = extern
  ...
  def rocksdb_options_set_compaction_service(options : Ptr[rocksdb_options_t], service : Ptr[rocksdb_compactionservice_t]): Unit = extern
  ...
  def rocksdb_options_set_periodic_compaction_seconds(_0 : Ptr[rocksdb_options_t], _1 : uint64_t): Unit = extern

  def rocksdb_options_set_plain_table_factory(_0 : Ptr[rocksdb_options_t], _1 : uint32_t, _2 : CInt, _3 : Double, _4 : size_t, _5 : size_t, _6 : CChar, _7 : CUnsignedChar, _8 : CUnsignedChar): Unit = extern
  ...
  def rocksdb_options_set_sst_file_manager(opt : Ptr[rocksdb_options_t], sfm : Ptr[rocksdb_sst_file_manager_t]): Unit = extern

  def rocksdb_options_set_statistics_level(_0 : Ptr[rocksdb_options_t], level : CInt): Unit = extern
  ...
  def rocksdb_options_statistics_get_ticker_count(opt : Ptr[rocksdb_options_t], ticker_type : uint32_t): uint64_t = extern
  ...
  def rocksdb_pinnable_handle_destroy(handle : Ptr[rocksdb_pinnable_handle_t]): Unit = extern

  def rocksdb_pinnable_handle_get_value(handle : Ptr[rocksdb_pinnable_handle_t], vallen : Ptr[size_t]): CString = extern
  ...
  def rocksdb_readoptions_set_auto_readahead_size(_0 : Ptr[rocksdb_readoptions_t], _1 : CUnsignedChar): Unit = extern
  ...
  */
  ...
  def rocksdb_sst_file_metadata_get_directory(file_meta : Ptr[rocksdb_sst_file_metadata_t]): CString = extern
  ...
  */
  ...
  def rocksdb_statistics_histogram_data_create(): Ptr[rocksdb_statistics_histogram_data_t] = extern

  def rocksdb_statistics_histogram_data_destroy(data : Ptr[rocksdb_statistics_histogram_data_t]): Unit = extern

  def rocksdb_statistics_histogram_data_get_average(data : Ptr[rocksdb_statistics_histogram_data_t]): Double = extern

  def rocksdb_statistics_histogram_data_get_count(data : Ptr[rocksdb_statistics_histogram_data_t]): uint64_t = extern

  def rocksdb_statistics_histogram_data_get_max(data : Ptr[rocksdb_statistics_histogram_data_t]): Double = extern

  def rocksdb_statistics_histogram_data_get_median(data : Ptr[rocksdb_statistics_histogram_data_t]): Double = extern

  def rocksdb_statistics_histogram_data_get_min(data : Ptr[rocksdb_statistics_histogram_data_t]): Double = extern

  def rocksdb_statistics_histogram_data_get_p95(data : Ptr[rocksdb_statistics_histogram_data_t]): Double = extern

  def rocksdb_statistics_histogram_data_get_p99(data : Ptr[rocksdb_statistics_histogram_data_t]): Double = extern
  ...
  def rocksdb_status_ptr_get_error(status : Ptr[rocksdb_status_ptr_t], errptr : Ptr[CString]): Unit = extern
  ...
  def rocksdb_subcompactionjobinfo_compaction_reason(info : Ptr[rocksdb_subcompactionjobinfo_t]): uint32_t = extern
  ...
  def rocksdb_transaction_multi_get_for_update(txn : Ptr[rocksdb_transaction_t], options : Ptr[rocksdb_readoptions_t], num_keys : size_t, keys_list : Ptr[CString], keys_list_sizes : Ptr[size_t], values_list : Ptr[CString], values_list_sizes : Ptr[size_t], errs : Ptr[CString]): Unit = extern

  def rocksdb_transaction_multi_get_for_update_cf(txn : Ptr[rocksdb_transaction_t], options : Ptr[rocksdb_readoptions_t], column_families : Ptr[Ptr[rocksdb_column_family_handle_t]], num_keys : size_t, keys_list : Ptr[CString], keys_list_sizes : Ptr[size_t], values_list : Ptr[CString], values_list_sizes : Ptr[size_t], errs : Ptr[CString]): Unit = extern
  ...
  def rocksdb_transactiondb_close_base_db(base_db : Ptr[rocksdb_t]): Unit = extern
  ...
  def rocksdb_transactiondb_flush_cfs(txn_db : Ptr[rocksdb_transactiondb_t], options : Ptr[rocksdb_flushoptions_t], column_families : Ptr[Ptr[rocksdb_column_family_handle_t]], num_column_families : CInt, errptr : Ptr[CString]): Unit = extern
  ...
  def rocksdb_transactiondb_get_base_db(txn_db : Ptr[rocksdb_transactiondb_t]): Ptr[rocksdb_t] = extern
  ...
  def rocksdb_wait_for_compact(db : Ptr[rocksdb_t], options : Ptr[rocksdb_wait_for_compact_options_t], errptr : Ptr[CString]): Unit = extern

  def rocksdb_wait_for_compact_options_create(): Ptr[rocksdb_wait_for_compact_options_t] = extern

  def rocksdb_wait_for_compact_options_destroy(opt : Ptr[rocksdb_wait_for_compact_options_t]): Unit = extern

  def rocksdb_wait_for_compact_options_get_abort_on_pause(opt : Ptr[rocksdb_wait_for_compact_options_t]): CUnsignedChar = extern

  def rocksdb_wait_for_compact_options_get_close_db(opt : Ptr[rocksdb_wait_for_compact_options_t]): CUnsignedChar = extern

  def rocksdb_wait_for_compact_options_get_flush(opt : Ptr[rocksdb_wait_for_compact_options_t]): CUnsignedChar = extern

  def rocksdb_wait_for_compact_options_get_timeout(opt : Ptr[rocksdb_wait_for_compact_options_t]): uint64_t = extern

  def rocksdb_wait_for_compact_options_set_abort_on_pause(opt : Ptr[rocksdb_wait_for_compact_options_t], v : CUnsignedChar): Unit = extern

  def rocksdb_wait_for_compact_options_set_close_db(opt : Ptr[rocksdb_wait_for_compact_options_t], v : CUnsignedChar): Unit = extern

  def rocksdb_wait_for_compact_options_set_flush(opt : Ptr[rocksdb_wait_for_compact_options_t], v : CUnsignedChar): Unit = extern

  def rocksdb_wait_for_compact_options_set_timeout(opt : Ptr[rocksdb_wait_for_compact_options_t], microseconds : uint64_t): Unit = extern
  ...
  def rocksdb_write_buffer_manager_buffer_size(wbm : Ptr[rocksdb_write_buffer_manager_t]): size_t = extern

  def rocksdb_write_buffer_manager_cost_to_cache(wbm : Ptr[rocksdb_write_buffer_manager_t]): Boolean = extern

  def rocksdb_write_buffer_manager_create(buffer_size : size_t, allow_stall : Boolean): Ptr[rocksdb_write_buffer_manager_t] = extern

  def rocksdb_write_buffer_manager_create_with_cache(buffer_size : size_t, cache : Ptr[rocksdb_cache_t], allow_stall : Boolean): Ptr[rocksdb_write_buffer_manager_t] = extern

  def rocksdb_write_buffer_manager_destroy(wbm : Ptr[rocksdb_write_buffer_manager_t]): Unit = extern

  def rocksdb_write_buffer_manager_dummy_entries_in_cache_usage(wbm : Ptr[rocksdb_write_buffer_manager_t]): size_t = extern

  def rocksdb_write_buffer_manager_enabled(wbm : Ptr[rocksdb_write_buffer_manager_t]): Boolean = extern

  def rocksdb_write_buffer_manager_memory_usage(wbm : Ptr[rocksdb_write_buffer_manager_t]): size_t = extern

  def rocksdb_write_buffer_manager_mutable_memtable_memory_usage(wbm : Ptr[rocksdb_write_buffer_manager_t]): size_t = extern

  def rocksdb_write_buffer_manager_set_allow_stall(wbm : Ptr[rocksdb_write_buffer_manager_t], new_allow_stall : Boolean): Unit = extern

  def rocksdb_write_buffer_manager_set_buffer_size(wbm : Ptr[rocksdb_write_buffer_manager_t], new_size : size_t): Unit = extern
...
object functions:
  ...
  def rocksdb_iter_key_slice(iter : Ptr[rocksdb_iterator_t])(using Zone): rocksdb_slice_t =
    val __ptr_0: Ptr[rocksdb_slice_t] = _root_.scala.scalanative.unsafe.alloc[rocksdb_slice_t](1)
    __sn_wrap_rocksdb_rocksdb_iter_key_slice(iter, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  def rocksdb_iter_key_slice(iter : Ptr[rocksdb_iterator_t])(__return : Ptr[rocksdb_slice_t]): Unit =
    __sn_wrap_rocksdb_rocksdb_iter_key_slice(iter, __return)

  def rocksdb_iter_timestamp_slice(iter : Ptr[rocksdb_iterator_t])(__return : Ptr[rocksdb_slice_t]): Unit =
    __sn_wrap_rocksdb_rocksdb_iter_timestamp_slice(iter, __return)

  def rocksdb_iter_timestamp_slice(iter : Ptr[rocksdb_iterator_t])(using Zone): rocksdb_slice_t =
    val __ptr_0: Ptr[rocksdb_slice_t] = _root_.scala.scalanative.unsafe.alloc[rocksdb_slice_t](1)
    __sn_wrap_rocksdb_rocksdb_iter_timestamp_slice(iter, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  def rocksdb_iter_value_slice(iter : Ptr[rocksdb_iterator_t])(using Zone): rocksdb_slice_t =
    val __ptr_0: Ptr[rocksdb_slice_t] = _root_.scala.scalanative.unsafe.alloc[rocksdb_slice_t](1)
    __sn_wrap_rocksdb_rocksdb_iter_value_slice(iter, (__ptr_0 + 0))
    !(__ptr_0 + 0)

  def rocksdb_iter_value_slice(iter : Ptr[rocksdb_iterator_t])(__return : Ptr[rocksdb_slice_t]): Unit =
    __sn_wrap_rocksdb_rocksdb_iter_value_slice(iter, __return)
...
object constants:
  ...
  val rocksdb_compactionservice_jobstatus_success: CUnsignedInt = 0.toUInt
  val rocksdb_compactionservice_jobstatus_failure: CUnsignedInt = 1.toUInt
  val rocksdb_compactionservice_jobstatus_aborted: CUnsignedInt = 2.toUInt
  val rocksdb_compactionservice_jobstatus_use_local: CUnsignedInt = 3.toUInt
...
object all:
  ...
  export _root_.rocksdb.aliases.rocksdb_compaction_service_cancel_awaiting_jobs_cb
  export _root_.rocksdb.aliases.rocksdb_compaction_service_on_installation_cb
  export _root_.rocksdb.aliases.rocksdb_compaction_service_schedule_cb
  export _root_.rocksdb.aliases.rocksdb_compaction_service_wait_cb
  ...
  export _root_.rocksdb.structs.rocksdb_compaction_service_options_override_t
  ...
  export _root_.rocksdb.structs.rocksdb_compactionservice_jobinfo_t
  export _root_.rocksdb.structs.rocksdb_compactionservice_scheduleresponse_t
  export _root_.rocksdb.structs.rocksdb_compactionservice_t
  ...
  export _root_.rocksdb.structs.rocksdb_export_import_files_metadata_t
  ...
  export _root_.rocksdb.structs.rocksdb_import_column_family_options_t
  ...
  export _root_.rocksdb.structs.rocksdb_livefile_t
  ...
  export _root_.rocksdb.structs.rocksdb_open_and_compact_options_t
  ...
  export _root_.rocksdb.structs.rocksdb_pinnable_handle_t
  ...
  export _root_.rocksdb.structs.rocksdb_slice_t
  ...
  export _root_.rocksdb.functions.rocksdb_batched_multi_get_cf_slice
  ...
  export _root_.rocksdb.functions.rocksdb_checkpoint_export_column_family
  ...
  export _root_.rocksdb.functions.rocksdb_compaction_service_options_override_create
  export _root_.rocksdb.functions.rocksdb_compaction_service_options_override_destroy
  export _root_.rocksdb.functions.rocksdb_compaction_service_options_override_set_comparator
  export _root_.rocksdb.functions.rocksdb_compaction_service_options_override_set_env
  ...
  export _root_.rocksdb.functions.rocksdb_compactionservice_create
  export _root_.rocksdb.functions.rocksdb_compactionservice_jobinfo_t_get_base_input_level
  export _root_.rocksdb.functions.rocksdb_compactionservice_jobinfo_t_get_cf_id
  export _root_.rocksdb.functions.rocksdb_compactionservice_jobinfo_t_get_cf_name
  export _root_.rocksdb.functions.rocksdb_compactionservice_jobinfo_t_get_compaction_reason
  export _root_.rocksdb.functions.rocksdb_compactionservice_jobinfo_t_get_db_id
  export _root_.rocksdb.functions.rocksdb_compactionservice_jobinfo_t_get_db_name
  export _root_.rocksdb.functions.rocksdb_compactionservice_jobinfo_t_get_db_session_id
  export _root_.rocksdb.functions.rocksdb_compactionservice_jobinfo_t_get_job_id
  export _root_.rocksdb.functions.rocksdb_compactionservice_jobinfo_t_get_output_level
  export _root_.rocksdb.functions.rocksdb_compactionservice_jobinfo_t_get_priority
  export _root_.rocksdb.functions.rocksdb_compactionservice_jobinfo_t_is_bottommost_level
  export _root_.rocksdb.functions.rocksdb_compactionservice_jobinfo_t_is_full_compaction
  export _root_.rocksdb.functions.rocksdb_compactionservice_jobinfo_t_is_manual_compaction
  export _root_.rocksdb.functions.rocksdb_compactionservice_scheduleresponse_create
  export _root_.rocksdb.functions.rocksdb_compactionservice_scheduleresponse_create_with_status
  export _root_.rocksdb.functions.rocksdb_compactionservice_scheduleresponse_get_scheduled_job_id
  export _root_.rocksdb.functions.rocksdb_compactionservice_scheduleresponse_getstatus
  export _root_.rocksdb.functions.rocksdb_compactionservice_scheduleresponse_t_destroy
  ...
  export _root_.rocksdb.functions.rocksdb_create_column_family_with_import
  ...
  export _root_.rocksdb.functions.rocksdb_export_import_files_metadata_create
  export _root_.rocksdb.functions.rocksdb_export_import_files_metadata_destroy
  export _root_.rocksdb.functions.rocksdb_export_import_files_metadata_get_db_comparator_name
  export _root_.rocksdb.functions.rocksdb_export_import_files_metadata_get_files
  export _root_.rocksdb.functions.rocksdb_export_import_files_metadata_set_db_comparator_name
  export _root_.rocksdb.functions.rocksdb_export_import_files_metadata_set_files
  ...
  export _root_.rocksdb.functions.rocksdb_flushjobinfo_flush_reason
  ...
  export _root_.rocksdb.functions.rocksdb_get_into_buffer
  export _root_.rocksdb.functions.rocksdb_get_into_buffer_cf
  ...
  export _root_.rocksdb.functions.rocksdb_get_pinned_cf_v2
  export _root_.rocksdb.functions.rocksdb_get_pinned_v2
  ...
  export _root_.rocksdb.functions.rocksdb_import_column_family_options_create
  export _root_.rocksdb.functions.rocksdb_import_column_family_options_destroy
  export _root_.rocksdb.functions.rocksdb_import_column_family_options_set_move_files
  ...
  export _root_.rocksdb.functions.rocksdb_livefile_create
  export _root_.rocksdb.functions.rocksdb_livefile_destroy
  export _root_.rocksdb.functions.rocksdb_livefile_set_column_family_name
  export _root_.rocksdb.functions.rocksdb_livefile_set_directory
  export _root_.rocksdb.functions.rocksdb_livefile_set_largest_key
  export _root_.rocksdb.functions.rocksdb_livefile_set_largest_seqno
  export _root_.rocksdb.functions.rocksdb_livefile_set_level
  export _root_.rocksdb.functions.rocksdb_livefile_set_name
  export _root_.rocksdb.functions.rocksdb_livefile_set_num_deletions
  export _root_.rocksdb.functions.rocksdb_livefile_set_num_entries
  export _root_.rocksdb.functions.rocksdb_livefile_set_size
  export _root_.rocksdb.functions.rocksdb_livefile_set_smallest_key
  export _root_.rocksdb.functions.rocksdb_livefile_set_smallest_seqno
  export _root_.rocksdb.functions.rocksdb_livefiles
  export _root_.rocksdb.functions.rocksdb_livefiles_add
  ...
  export _root_.rocksdb.functions.rocksdb_livefiles_create
  export _root_.rocksdb.functions.rocksdb_livefiles_deletions
  export _root_.rocksdb.functions.rocksdb_livefiles_destroy
  export _root_.rocksdb.functions.rocksdb_livefiles_directory
  export _root_.rocksdb.functions.rocksdb_livefiles_entries
  export _root_.rocksdb.functions.rocksdb_livefiles_largest_seqno
  ...
  export _root_.rocksdb.functions.rocksdb_livefiles_smallest_seqno
  ...
  export _root_.rocksdb.functions.rocksdb_open_and_compact
  export _root_.rocksdb.functions.rocksdb_open_and_compact_canceled_create
  export _root_.rocksdb.functions.rocksdb_open_and_compact_canceled_destroy
  export _root_.rocksdb.functions.rocksdb_open_and_compact_canceled_set
  export _root_.rocksdb.functions.rocksdb_open_and_compact_options_create
  export _root_.rocksdb.functions.rocksdb_open_and_compact_options_destroy
  export _root_.rocksdb.functions.rocksdb_open_and_compact_options_set_allow_resumption
  export _root_.rocksdb.functions.rocksdb_open_and_compact_options_set_canceled
  export _root_.rocksdb.functions.rocksdb_open_and_compact_with_options
  ...
  export _root_.rocksdb.functions.rocksdb_options_add_compact_on_deletion_collector_factory_min_file_size
  ...
  export _root_.rocksdb.functions.rocksdb_options_set_compaction_service
  ...
  export _root_.rocksdb.functions.rocksdb_options_set_sst_file_manager
  ...
  export _root_.rocksdb.functions.rocksdb_pinnable_handle_destroy
  export _root_.rocksdb.functions.rocksdb_pinnable_handle_get_value
  ...
  export _root_.rocksdb.functions.rocksdb_status_ptr_get_error
  ...
  export _root_.rocksdb.functions.rocksdb_subcompactionjobinfo_compaction_reason
  ...
  export _root_.rocksdb.functions.rocksdb_iter_key_slice
  export _root_.rocksdb.functions.rocksdb_iter_timestamp_slice
  export _root_.rocksdb.functions.rocksdb_iter_value_slice
  export _root_.rocksdb.constants.rocksdb_block_based_table_data_block_index_type_binary_search
  export _root_.rocksdb.constants.rocksdb_block_based_table_data_block_index_type_binary_search_and_hash
  export _root_.rocksdb.constants.rocksdb_prepopulate_blob_disable
  export _root_.rocksdb.constants.rocksdb_prepopulate_blob_flush_only
  export _root_.rocksdb.constants.rocksdb_no_compression
  export _root_.rocksdb.constants.rocksdb_snappy_compression
  export _root_.rocksdb.constants.rocksdb_zlib_compression
  export _root_.rocksdb.constants.rocksdb_bz2_compression
  export _root_.rocksdb.constants.rocksdb_lz4_compression
  export _root_.rocksdb.constants.rocksdb_lz4hc_compression
  export _root_.rocksdb.constants.rocksdb_xpress_compression
  export _root_.rocksdb.constants.rocksdb_zstd_compression
  export _root_.rocksdb.constants.rocksdb_uninitialized
  export _root_.rocksdb.constants.rocksdb_disable
  export _root_.rocksdb.constants.rocksdb_enable_count
  export _root_.rocksdb.constants.rocksdb_enable_time_except_for_mutex
  export _root_.rocksdb.constants.rocksdb_enable_time
  export _root_.rocksdb.constants.rocksdb_out_of_bounds
  export _root_.rocksdb.constants.rocksdb_block_based_k_fallback_pinning_tier
  export _root_.rocksdb.constants.rocksdb_block_based_k_none_pinning_tier
  export _root_.rocksdb.constants.rocksdb_block_based_k_flush_and_similar_pinning_tier
  export _root_.rocksdb.constants.rocksdb_block_based_k_all_pinning_tier
  export _root_.rocksdb.constants.rocksdb_user_key_comparison_count
  export _root_.rocksdb.constants.rocksdb_block_cache_hit_count
  export _root_.rocksdb.constants.rocksdb_block_read_count
  export _root_.rocksdb.constants.rocksdb_block_read_byte
  export _root_.rocksdb.constants.rocksdb_block_read_time
  export _root_.rocksdb.constants.rocksdb_block_checksum_time
  export _root_.rocksdb.constants.rocksdb_block_decompress_time
  export _root_.rocksdb.constants.rocksdb_get_read_bytes
  export _root_.rocksdb.constants.rocksdb_multiget_read_bytes
  export _root_.rocksdb.constants.rocksdb_iter_read_bytes
  export _root_.rocksdb.constants.rocksdb_internal_key_skipped_count
  export _root_.rocksdb.constants.rocksdb_internal_delete_skipped_count
  export _root_.rocksdb.constants.rocksdb_internal_recent_skipped_count
  export _root_.rocksdb.constants.rocksdb_internal_merge_count
  export _root_.rocksdb.constants.rocksdb_get_snapshot_time
  export _root_.rocksdb.constants.rocksdb_get_from_memtable_time
  export _root_.rocksdb.constants.rocksdb_get_from_memtable_count
  export _root_.rocksdb.constants.rocksdb_get_post_process_time
  export _root_.rocksdb.constants.rocksdb_get_from_output_files_time
  export _root_.rocksdb.constants.rocksdb_seek_on_memtable_time
  export _root_.rocksdb.constants.rocksdb_seek_on_memtable_count
  export _root_.rocksdb.constants.rocksdb_next_on_memtable_count
  export _root_.rocksdb.constants.rocksdb_prev_on_memtable_count
  export _root_.rocksdb.constants.rocksdb_seek_child_seek_time
  export _root_.rocksdb.constants.rocksdb_seek_child_seek_count
  export _root_.rocksdb.constants.rocksdb_seek_min_heap_time
  export _root_.rocksdb.constants.rocksdb_seek_max_heap_time
  export _root_.rocksdb.constants.rocksdb_seek_internal_seek_time
  export _root_.rocksdb.constants.rocksdb_find_next_user_entry_time
  export _root_.rocksdb.constants.rocksdb_write_wal_time
  export _root_.rocksdb.constants.rocksdb_write_memtable_time
  export _root_.rocksdb.constants.rocksdb_write_delay_time
  export _root_.rocksdb.constants.rocksdb_write_pre_and_post_process_time
  export _root_.rocksdb.constants.rocksdb_db_mutex_lock_nanos
  export _root_.rocksdb.constants.rocksdb_db_condition_wait_nanos
  export _root_.rocksdb.constants.rocksdb_merge_operator_time_nanos
  export _root_.rocksdb.constants.rocksdb_read_index_block_nanos
  export _root_.rocksdb.constants.rocksdb_read_filter_block_nanos
  export _root_.rocksdb.constants.rocksdb_new_table_block_iter_nanos
  export _root_.rocksdb.constants.rocksdb_new_table_iterator_nanos
  export _root_.rocksdb.constants.rocksdb_block_seek_nanos
  export _root_.rocksdb.constants.rocksdb_find_table_nanos
  export _root_.rocksdb.constants.rocksdb_bloom_memtable_hit_count
  export _root_.rocksdb.constants.rocksdb_bloom_memtable_miss_count
  export _root_.rocksdb.constants.rocksdb_bloom_sst_hit_count
  export _root_.rocksdb.constants.rocksdb_bloom_sst_miss_count
  export _root_.rocksdb.constants.rocksdb_key_lock_wait_time
  export _root_.rocksdb.constants.rocksdb_key_lock_wait_count
  export _root_.rocksdb.constants.rocksdb_env_new_sequential_file_nanos
  export _root_.rocksdb.constants.rocksdb_env_new_random_access_file_nanos
  export _root_.rocksdb.constants.rocksdb_env_new_writable_file_nanos
  export _root_.rocksdb.constants.rocksdb_env_reuse_writable_file_nanos
  export _root_.rocksdb.constants.rocksdb_env_new_random_rw_file_nanos
  export _root_.rocksdb.constants.rocksdb_env_new_directory_nanos
  export _root_.rocksdb.constants.rocksdb_env_file_exists_nanos
  export _root_.rocksdb.constants.rocksdb_env_get_children_nanos
  export _root_.rocksdb.constants.rocksdb_env_get_children_file_attributes_nanos
  export _root_.rocksdb.constants.rocksdb_env_delete_file_nanos
  export _root_.rocksdb.constants.rocksdb_env_create_dir_nanos
  export _root_.rocksdb.constants.rocksdb_env_create_dir_if_missing_nanos
  export _root_.rocksdb.constants.rocksdb_env_delete_dir_nanos
  export _root_.rocksdb.constants.rocksdb_env_get_file_size_nanos
  export _root_.rocksdb.constants.rocksdb_env_get_file_modification_time_nanos
  export _root_.rocksdb.constants.rocksdb_env_rename_file_nanos
  export _root_.rocksdb.constants.rocksdb_env_link_file_nanos
  export _root_.rocksdb.constants.rocksdb_env_lock_file_nanos
  export _root_.rocksdb.constants.rocksdb_env_unlock_file_nanos
  export _root_.rocksdb.constants.rocksdb_env_new_logger_nanos
  export _root_.rocksdb.constants.rocksdb_number_async_seek
  export _root_.rocksdb.constants.rocksdb_blob_cache_hit_count
  export _root_.rocksdb.constants.rocksdb_blob_read_count
  export _root_.rocksdb.constants.rocksdb_blob_read_byte
  export _root_.rocksdb.constants.rocksdb_blob_read_time
  export _root_.rocksdb.constants.rocksdb_blob_checksum_time
  export _root_.rocksdb.constants.rocksdb_blob_decompress_time
  export _root_.rocksdb.constants.rocksdb_internal_range_del_reseek_count
  export _root_.rocksdb.constants.rocksdb_block_read_cpu_time
  export _root_.rocksdb.constants.rocksdb_internal_merge_point_lookup_count
  export _root_.rocksdb.constants.rocksdb_total_metric_count
  export _root_.rocksdb.constants.rocksdb_compactionservice_jobstatus_success
  export _root_.rocksdb.constants.rocksdb_compactionservice_jobstatus_failure
  export _root_.rocksdb.constants.rocksdb_compactionservice_jobstatus_aborted
  export _root_.rocksdb.constants.rocksdb_compactionservice_jobstatus_use_local
  export _root_.rocksdb.constants.rocksdb_k_by_compensated_size_compaction_pri
  export _root_.rocksdb.constants.rocksdb_k_oldest_largest_seq_first_compaction_pri
  export _root_.rocksdb.constants.rocksdb_k_oldest_smallest_seq_first_compaction_pri
  export _root_.rocksdb.constants.rocksdb_k_min_overlapping_ratio_compaction_pri
  export _root_.rocksdb.constants.rocksdb_k_round_robin_compaction_pri
  export _root_.rocksdb.constants.rocksdb_similar_size_compaction_stop_style
  export _root_.rocksdb.constants.rocksdb_total_size_compaction_stop_style
  export _root_.rocksdb.constants.rocksdb_block_based_table_index_type_binary_search
  export _root_.rocksdb.constants.rocksdb_block_based_table_index_type_hash_search
  export _root_.rocksdb.constants.rocksdb_block_based_table_index_type_two_level_index_search
  export _root_.rocksdb.constants.rocksdb_tolerate_corrupted_tail_records_recovery
  export _root_.rocksdb.constants.rocksdb_absolute_consistency_recovery
  export _root_.rocksdb.constants.rocksdb_point_in_time_recovery
  export _root_.rocksdb.constants.rocksdb_skip_any_corrupted_records_recovery
  export _root_.rocksdb.constants.rocksdb_size_approximation_flags_none
  export _root_.rocksdb.constants.rocksdb_size_approximation_flags_include_memtable
  export _root_.rocksdb.constants.rocksdb_size_approximation_flags_include_files
  export _root_.rocksdb.constants.rocksdb_statistics_level_disable_all
  export _root_.rocksdb.constants.rocksdb_statistics_level_except_tickers
  export _root_.rocksdb.constants.rocksdb_statistics_level_except_histogram_or_timers
  export _root_.rocksdb.constants.rocksdb_statistics_level_except_timers
  export _root_.rocksdb.constants.rocksdb_statistics_level_except_detailed_timers
  export _root_.rocksdb.constants.rocksdb_statistics_level_except_time_for_mutex
  export _root_.rocksdb.constants.rocksdb_statistics_level_all
  export _root_.rocksdb.constants.rocksdb_level_compaction
  export _root_.rocksdb.constants.rocksdb_universal_compaction
  export _root_.rocksdb.constants.rocksdb_fifo_compaction