...
private[rocksdb] object extern_functions:
  ...
  def rocksdb_options_get_access_hint_on_compaction_start(
      _0: Ptr[rocksdb_options_t]
  ): CInt = extern
  ...
  def rocksdb_options_get_max_write_buffer_number_to_maintain(
      _0: Ptr[rocksdb_options_t]
  ): CInt = extern
  ...
  def rocksdb_options_set_access_hint_on_compaction_start(
      _0: Ptr[rocksdb_options_t],
      _1: CInt
  ): Unit = extern
  ...
  def rocksdb_options_set_max_write_buffer_number_to_maintain(
      _0: Ptr[rocksdb_options_t],
      _1: CInt
  ): Unit = extern
