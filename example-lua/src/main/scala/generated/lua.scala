...
private[lua] object extern_functions:
  ...
  def luaL_alloc(ud : Ptr[Byte], ptr : Ptr[Byte], osize : size_t, nsize : size_t): Ptr[Byte] = extern
  ...
  def luaL_makeseed(L : Ptr[lua_State]): CUnsignedInt = extern

  def luaL_newmetatable(L : Ptr[lua_State], tname : CString): CInt = extern

  def luaL_newstate(): Ptr[lua_State] = extern

  def luaL_openselectedlibs(L : Ptr[lua_State], load : CInt, preload : CInt): Unit = extern
  ...
  def lua_newstate(f : lua_Alloc, ud : Ptr[Byte], seed : CUnsignedInt): Ptr[lua_State] = extern
  ...
  def lua_numbertocstring(L : Ptr[lua_State], idx : CInt, buff : CString): CUnsignedInt = extern
  ...
  def lua_pushexternalstring(L : Ptr[lua_State], s : CString, len : size_t, falloc : lua_Alloc, ud : Ptr[Byte]): CString = extern
...
object all:
  ...
  export _root_.lua.functions.luaL_alloc
  ...
  export _root_.lua.functions.luaL_makeseed
  export _root_.lua.functions.luaL_newmetatable
  export _root_.lua.functions.luaL_newstate
  export _root_.lua.functions.luaL_openselectedlibs
  ...
  export _root_.lua.functions.lua_numbertocstring
  ...
  export _root_.lua.functions.lua_pushexternalstring
