...
object aliases:
  ...
  object lua_Alloc:
    ...
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): lua_Alloc =
  ...
  object lua_CFunction:
    ...
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): lua_CFunction =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
  ...
  object lua_Hook:
    ...
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): lua_Hook =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
  ...
  object lua_KFunction:
    ...
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): lua_KFunction =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
  ...
  object lua_Reader:
    ...
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): lua_Reader =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
  ...
  object lua_WarnFunction:
    ...
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): lua_WarnFunction =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
  ...
  object lua_Writer:
    ...
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): lua_Writer =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
...
object structs:
  ...
  opaque type luaL_Buffer =
    CStruct5[CString, size_t, size_t, Ptr[lua_State], luaL_Buffer.Init]
